...
erlps__decode__1 [el] | DM.Just str <- H.erlangListToString el
  = case decode str of
      Left _ -> BIN.badarg unit
      Right u -> ErlangBinary $ u8ToBuf u
...
erlps__decode_to_string__1 [a] =
  erlang__binary_to_list [erlps__decode__1 [a]]
...
erlps__encode_to_string__1 [ErlangBinary buf] =
  make_string $ encode $ bufToU8 buf
erlps__encode_to_string__1 [el] =
  erlps__encode_to_string__1 [erlang__list_to_binary__1]
