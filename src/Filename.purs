...
erlps__rootname2__3 [(ErlangCons char_0 rest_1), ext_2, result_3]
  | isEInt char_0 =
  erlps__rootname2__3 [rest_1, ext_2, ErlangCons char_0 result_3]
...
erlps__find_src__2 [modorfile_0, rules_1] | isEList modorfile_0 =
  let    extension_2 = toErl ".erl"
  in let arg_3 = erlps__basename__2 [modorfile_0, extension_2]
  in let mod_6 = BIF.erlang__list_to_atom__1 [arg_3]
  in let
    case_7 = BIF.do_remote_fun_call "Code" "erlps__which__1" [mod_6]
  in
    case case_7 of
      possibly_rel_path_9 | isEList possibly_rel_path_9 ->
        let
          matchExpr_11 =
            BIF.do_remote_fun_call "File" "erlps__get_cwd__0" []
        in
...
erlps__filter_options__3 [base_0, (ErlangCons tuple_1 rest_2),
                          result_3]
  | onElement (toErl 1) tuple_1 (==) (ErlangAtom "d") =
  erlps__filter_options__3
    [base_0, rest_2, ErlangCons tuple_1 result_3]
erlps__filter_options__3 [base_0, (ErlangCons tuple_1 rest_2),
                          result_3]
  | onElement (toErl 1) tuple_1 (==)
      (ErlangAtom "parse_transform") =
  erlps__filter_options__3
    [base_0, rest_2, ErlangCons tuple_1 result_3]
