module Filename(erlps__absname__1, erlps__absname__2,
                ...
                erlps__nativename__1, erlps__basedir__2, erlps__basedir__3,
                erlps__validate__1, erlps__append__2) where
{-
...
erlps__absname_vr__3 [(ErlangCons (ErlangBinary binSeg_0) rest1_7),
                      (ErlangCons (ErlangBinary binSeg_8) _), absbase_12]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok x_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  ...
  in let
    case_9 =
      BIF.do_remote_fun_call "File" "erlps__get_cwd__1"
        [ErlangCons x_3 (ErlangCons head_13 ErlangEmptyList)]
  in let
    dcwd_20 =
      case case_9 of
        ...
        (ErlangTuple [(ErlangAtom "error"), _]) ->
          let    bin_el_18 = toErl 58
          in let bin_el_19 = toErl 47
          in
            ErlangBinary
              (BIN.concat
...
erlps__absname_vr__3 [(ErlangCons (ErlangCons x_0 (ErlangCons (ErlangInt num_1) (ErlangEmptyList))) name_2),
  ...
  in let
    case_4 =
      BIF.do_remote_fun_call "File" "erlps__get_cwd__1"
        [ErlangCons x_0 (ErlangCons head_8 ErlangEmptyList)]
  in let
    dcwd_17 =
      case case_4 of
...
erlps__basename__1 [name0_0] =
  ...
  in let matchExpr_5 = erlps__separators__0 []
  in
    case matchExpr_5 of
...
erlps__win_basenameb__1 [(ErlangBinary binSeg_0)]
  ...
  , BIN.empty bin_8
  , ((weakGeq letter_3 (toErl 65)) &&
       (weakLeq letter_3 (toErl 90))) ||
      ((weakGeq letter_3 (toErl 97)) &&
         (weakLeq letter_3 (toErl 122))) =
  let   
    head_12 =
      ErlangBinary (BIN.fromInts (toErl "/") (toErl 8) 1 BIN.Big)
  in let
...
erlps__basenameb__2 [bin_0, sep_1] =
  let   
    lcSrc_2 =
      BIF.binary__split__3
        [bin_0, sep_1, ErlangCons (ErlangAtom "global") ErlangEmptyList]
  in let
    parts_14 =
      flmap
        (\ lc_9 ->
  ...
  in
    case ErlangAtom "true" of
      _ | (==) parts_14 ErlangEmptyList -> ErlangBinary (BIN.concat [])
...
erlps__basename1__3 [(ErlangCons dirsep2_0 rest_1), tail_2,
  ...
  let head_5 = toErl 47
  in
    erlps__basename1__3 [ErlangCons head_5 rest_1, tail_2, dirsep2_0]
...
erlps__skip_prefix__2 [(ErlangCons l_0 (ErlangCons drvsep_1 name_2)),
                       drvsep_3]
  | drvsep_3 == drvsep_1
  , ((weakGeq l_0 (toErl 65)) && (weakLeq l_0 (toErl 90))) ||
      ((weakGeq l_0 (toErl 97)) && (weakLeq l_0 (toErl 122))) =
  name_2
...
erlps__basename__2 [name0_0, ext0_1] =
  ...
  in let matchExpr_8 = erlps__separators__0 []
  in
    case matchExpr_8 of
...
erlps__basename__4 [(ErlangCons dirsep2_0 rest_1), ext_2, tail_3,
  ...
  in
    erlps__basename__4
      [ErlangCons head_6 rest_1, ext_2, tail_3, dirsep2_0]
        ...
        let   
          slist_9 =
            case dsep_1 of
              sep_5 | isEInt sep_5 ->
                let
                  head_6 = ErlangBinary (BIN.fromInt sep_5 (toErl 8) 1 BIN.Big)
              ...
              x_11 | isEInt x_11 ->
                case name_0 of
                  (ErlangBinary binSeg_13) | (ErlangInt size_14) <- (toErl 8)
                                           , (BIN.Ok dl_16 bin_15) <-
                                               (BIN.chopInt binSeg_13 size_14 1
                                                  BIN.Big BIN.Unsigned)
                                           , (ErlangInt size_17) <- (toErl 8)
                                           , (BIN.Ok x_19 bin_18) <-
                                               (BIN.chopInt bin_15 size_17 1
                                                  BIN.Big BIN.Unsigned)
                                           , (ErlangInt size_20) <-
                                               (BIN.size bin_18)
                                           ...
                                           , BIN.empty bin_21
                                           , x_19 == x_11
                                           , ((weakGeq dl_16 (toErl 65)) &&
                                                (weakLeq dl_16 (toErl 90))) ||
                                               ((weakGeq dl_16 (toErl 97)) &&
                                                  (weakLeq dl_16
                                                     (toErl 122))) ->
                    let
                      tup_el_23 =
                        ErlangBinary
                          (BIN.concat
                             [BIN.fromInt dl_16 (toErl 8) 1 BIN.Big,
                              BIN.fromInt x_11 (toErl 8) 1 BIN.Big])
                    in ErlangTuple [tup_el_23, rest_22]
                  _ ->
                    let tup_el_27 = ErlangBinary (BIN.concat [])
                    in ErlangTuple [tup_el_27, name_0]
              _ ->
                let tup_el_29 = ErlangBinary (BIN.concat [])
                in ErlangTuple [tup_el_29, name_0]
        in
          case matchExpr_33 of
            (ErlangTuple [xpart0_31, dirs_32]) ->
              let   
                head_36 =
                  ErlangBinary (BIN.fromInts (toErl "/") (toErl 8) 1 BIN.Big)
              in let
                parts0_41 =
                  BIF.binary__split__3
                    [dirs_32, ErlangCons head_36 slist_9,
                      ...
                      let   
                        arg_45 =
                          BIF.do_remote_fun_call "Lists" "erlps__reverse__1"
                            [parts0_41]
                      in let arg_44 = BIF.erlang__tl__1 [arg_45]
                      in let arg_43 = erlps__fstrip__1 [arg_44]
                      in
                        BIF.do_remote_fun_call "Lists" "erlps__reverse__1"
                          [arg_43]
              in let case_48 = ErlangTuple [parts_47, xpart0_31]
              in let
                xpart_52 =
                  case case_48 of
                    (ErlangTuple [(ErlangEmptyList),
                                  (ErlangBinary binEnd_51)]) | BIN.empty
                                                                 binEnd_51 ->
                      ErlangBinary
              ...
              in let
                arg_55 =
                  ErlangBinary (BIN.fromInts (toErl "/") (toErl 8) 1 BIN.Big)
              in erlps__dirjoin__3 [parts_47, xpart_52, arg_55]
...
erlps__dirname__4 [(ErlangCons dirsep_0 rest_1), dir_2, file_3,
  ...
  in
    erlps__dirname__4
      [rest_1, arg_7, ErlangCons head_11 ErlangEmptyList, seps_5]
  ...
  in
    case case_4 of
      (ErlangCons (ErlangInt num_6) _) | (ErlangInt num_6) ==
        ...
        in
          ErlangCons dl_1
            (ErlangCons drvsep_0 (ErlangCons head_11 ErlangEmptyList))
...
erlps__dirjoin1__3 [(ErlangCons one_0 (ErlangEmptyList)), acc_1,
  ...
  ErlangBinary
    (BIN.concat
       [BIN.binPrefix acc_1 (BIN.packedSize acc_1) 8,
        BIN.binPrefix one_0 (BIN.packedSize one_0) 8])
  ...
  let
    arg_5 =
      ErlangBinary
        (BIN.concat
           [BIN.binPrefix acc_2 (BIN.packedSize acc_2) 8,
            BIN.binPrefix h_0 (BIN.packedSize h_0) 8,
            BIN.binPrefix sep_3 (BIN.packedSize sep_3) 8])
        ...
        in
          case case_9 of
            ...
            list_14 ->
              ...
              in
                case case_15 of
                  (ErlangTuple [(ErlangInt num_17), _]) | (ErlangInt num_17) ==
                                                            (toErl 0) ->
                    ErlangBinary (BIN.concat [])
                  (ErlangTuple [pos_18, _]) ->
                    case name_0 of
                      (ErlangBinary binSeg_19) | (ErlangInt size_20) <-
                                                   (let rop_23 = toErl 1
                                                    in
                        ...
                        in let
                          case_28 =
                            BIF.binary__match__2
                              [part_26, ErlangCons head_31 slist_8]
                        in
                          case case_28 of
                            (ErlangAtom "nomatch") ->
                              case name_0 of
...
erlps__extension__1 [name0_0] =
  ...
  in let arg_7 = erlps__major_os_type__0 []
  in
    erlps__extension__3
      [ErlangCons head_4 name_2, ErlangEmptyList, arg_7]
erlps__extension__1 [arg_8] = EXC.function_clause unit
...
erlps__extension__3 [(ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) rest_2)),
                     _result_3, ostype_4]
  | (ErlangInt num_0) == (toErl 47)
  , (ErlangInt num_1) == (toErl 46) =
  erlps__extension__3 [rest_2, ErlangEmptyList, ostype_4]
erlps__extension__3 [(ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) rest_2)),
                     _result_3, (ErlangAtom "win32")]
  | (ErlangInt num_0) == (toErl 92)
  , (ErlangInt num_1) == (toErl 46) =
  erlps__extension__3 [rest_2, ErlangEmptyList, ErlangAtom "win32"]
  ...
  in
    case case_3 of
      ...
      _other_9 ->
        ...
        in erlps__join1b__4 [name2_1, arg_11, ErlangEmptyList, ostype_2]
erlps__join__2 [name1_0, name2_1] | isEAtom name1_0 =
  let arg_2 = BIF.erlang__atom_to_list__1 [name1_0]
  in erlps__join__2 [arg_2, name2_1]
erlps__join__2 [name1_0, name2_1] | isEAtom name2_1 =
...
erlps__join1__4 [(ErlangCons ucletter_0 (ErlangCons (ErlangInt num_1) rest_2)),
  ...
  in let rop_13 = toErl 65
  in let head_9 = BIF.erlang__op_minus [lop_10, rop_13]
  in
    erlps__join1__4
...
erlps__join1__4 [(ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) rest_2)),
  ...
  in
    erlps__join1__4
      [ErlangCons head_5 (ErlangCons head_7 rest_2), relativename_3,
...
erlps__join1__4 [(ErlangCons (ErlangInt num_0) rest_1),
  ...
  in
    erlps__join1__4
      [ErlangCons head_5 rest_1, relativename_2, result_3,
       ErlangAtom "win32"]
erlps__join1__4 [(ErlangCons (ErlangInt num_0) rest_1),
                 relativename_2,
  ...
  in
    erlps__join1__4
      [rest_1, relativename_2, ErlangCons head_10 result_5, ostype_6]
erlps__join1__4 [(ErlangCons (ErlangInt num_0) rest_1),
  ...
  in
    erlps__join1__4
      [rest_1, relativename_2, ErlangCons head_9 result_4, ostype_5]
...
erlps__join1__4 [(ErlangEmptyList), relativename_0,
  ...
  in
    erlps__join1__4
      [relativename_0, ErlangEmptyList, ErlangCons head_6 rest_2,
       ErlangAtom "win32"]
erlps__join1__4 [(ErlangEmptyList), relativename_0,
  ...
  in
    erlps__join1__4
      [relativename_0, ErlangEmptyList, ErlangCons head_7 result_2,
       ostype_3]
erlps__join1__4 [(ErlangEmptyList), relativename_0,
  ...
  in
    erlps__join1__4
      [relativename_0, ErlangEmptyList, ErlangCons head_8 result_3,
       ostype_4]
erlps__join1__4 [(ErlangEmptyList), relativename_0, result_1,
  ...
  in
    erlps__join1__4
      [relativename_0, ErlangEmptyList, ErlangCons head_6 result_1,
       ostype_2]
...
erlps__join1b__4 [(ErlangBinary binSeg_0), relativename_10,
  ...
  in let rop_20 = toErl 65
  in let head_16 = BIF.erlang__op_minus [lop_17, rop_20]
  in
    erlps__join1b__4
...
erlps__join1b__4 [(ErlangBinary binSeg_0), relativename_10,
  ...
  , (BIN.Ok rest_9 bin_8) <- (BIN.chopBin bin_5 size_7 8)
  , BIN.empty bin_8 =
  let    bin_el_12 = toErl 47
  in let bin_el_13 = toErl 47
  in let
    arg_11 =
      ErlangBinary
        (BIN.concat
           [BIN.fromInt bin_el_12 (toErl 8) 1 BIN.Big,
            ...
            BIN.binPrefix rest_9 (BIN.packedSize rest_9) 8])
  in
    erlps__join1b__4
...
erlps__join1b__4 [(ErlangBinary binSeg_0), relativename_10,
  ...
  in let head_16 = toErl 47
  in
    erlps__join1b__4
      [rest_9, relativename_10,
       ErlangCons head_14 (ErlangCons head_16 ErlangEmptyList),
       ErlangAtom "win32"]
erlps__join1b__4 [(ErlangBinary binSeg_0), relativename_7,
...
erlps__join1b__4 [(ErlangBinary binSeg_0), relativename_7,
  ...
  in
    erlps__join1b__4
      [rest_6, relativename_7, ErlangCons head_15 result_10, ostype_11]
erlps__join1b__4 [(ErlangBinary binSeg_0), relativename_7,
  ...
  in
    erlps__join1b__4
      [rest_6, relativename_7, ErlangCons head_14 result_9, ostype_10]
erlps__join1b__4 [(ErlangBinary binEnd_0),
                  (ErlangBinary binEnd_1), result_2, ostype_3]
  | BIN.empty binEnd_0
  , BIN.empty binEnd_1 =
...
erlps__join1b__4 [(ErlangBinary binEnd_0), relativename_1,
  ...
  in
    erlps__join1b__4
      [relativename_1, arg_5, ErlangCons head_7 rest_3,
       ErlangAtom "win32"]
erlps__join1b__4 [(ErlangBinary binEnd_0), relativename_1,
  ...
  in
    erlps__join1b__4
      [relativename_1, arg_6,
       ErlangCons head_8 (ErlangCons head_10 result_4),
       ErlangAtom "win32"]
erlps__join1b__4 [(ErlangBinary binEnd_0), relativename_1,
  ...
  in
    erlps__join1b__4
      [relativename_1, arg_6, ErlangCons head_8 result_3, ostype_4]
erlps__join1b__4 [(ErlangBinary binEnd_0), relativename_1,
                  (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) result_4)),
                  ostype_5]
  | BIN.empty binEnd_0
  ...
  in
    erlps__join1b__4
      [relativename_1, arg_7, ErlangCons head_9 result_4, ostype_5]
erlps__join1b__4 [(ErlangBinary binEnd_0), relativename_1,
                  result_2, ostype_3]
  | BIN.empty binEnd_0 =
  let    arg_5 = ErlangBinary (BIN.concat [])
  ...
  in
    erlps__join1b__4
      [relativename_1, arg_5, ErlangCons head_7 result_2, ostype_3]
erlps__join1b__4 [(ErlangBinary binSeg_0), relativename_7,
                  result_8, ostype_9]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok char_3 bin_2) <-
...
erlps__rootname__4 [(ErlangCons (ErlangInt num_0) rest_1),
  ...
  in let
    arg_5 =
      BIF.erlang__op_append [ErlangCons head_7 ErlangEmptyList, rop_9]
  in
    erlps__rootname__4
      [rest_1, arg_5, ErlangEmptyList, ErlangAtom "win32"]
erlps__rootname__4 [(ErlangCons (ErlangInt num_0) rest_1),
                    root_3@(ErlangCons (ErlangInt num_2) _), (ErlangEmptyList),
                    ostype_4]
  | (ErlangInt num_0) == (toErl 46)
  , (ErlangInt num_2) == (toErl 47) =
  let head_7 = toErl 46
  in
    erlps__rootname__4
      [rest_1, ErlangCons head_7 root_3, ErlangEmptyList, ostype_4]
erlps__rootname__4 [(ErlangCons (ErlangInt num_0) rest_1),
                    root_2, ext_3, ostype_4]
  | (ErlangInt num_0) == (toErl 46) =
...
erlps__rootname__2 [name0_0, ext0_1] =
  let    name_3 = erlps__flatten__1 [name0_0]
  in let ext_5 = erlps__flatten__1 [ext0_1]
  in let arg_9 = erlps__major_os_type__0 []
  in erlps__rootname2__4 [name_3, ext_5, ErlangEmptyList, arg_9]
erlps__rootname__2 [arg_10, arg_11] = EXC.function_clause unit
erlps__rootname__2 args =
  EXC.badarity (ErlangFun 2 erlps__rootname__2) args

erlps__rootname2__4 :: ErlangFun
erlps__rootname2__4 [ext_0, ext_1,
                     result_3@(ErlangCons (ErlangInt num_2) _), _ostype_4]
  | (ErlangInt num_2) == (toErl 47)
  , ext_1 == ext_0 =
  BIF.lists__reverse__2 [result_3, ext_0]
erlps__rootname2__4 [ext_0, ext_1,
                     result_3@(ErlangCons (ErlangInt num_2) _),
                     (ErlangAtom "win32")]
  | (ErlangInt num_2) == (toErl 92)
  , ext_1 == ext_0 =
  BIF.lists__reverse__2 [result_3, ext_0]
erlps__rootname2__4 [ext_0, ext_1, result_2, _ostype_3]
  | ext_1 == ext_0 =
  BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [result_2]
erlps__rootname2__4 [(ErlangEmptyList), _ext_0, result_1,
                     _ostype_2]
  =
  BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [result_1]
erlps__rootname2__4 [(ErlangCons char_0 rest_1), ext_2, result_3,
                     ostype_4]
  | isEInt char_0 =
  erlps__rootname2__4
    [rest_1, ext_2, ErlangCons char_0 result_3, ostype_4]
erlps__rootname2__4 [arg_11, arg_12, arg_13, arg_14] =
  EXC.function_clause unit
erlps__rootname2__4 args =
  EXC.badarity (ErlangFun 4 erlps__rootname2__4) args
...
erlps__win32_splitb__1 [(ErlangBinary binSeg_0)]
  ...
  , BIN.empty bin_11
  , (((==) slash_9 (toErl 92)) || ((==) slash_9 (toErl 47))) &&
      (((weakGeq letter0_3 (toErl 65)) &&
          (weakLeq letter0_3 (toErl 90))) ||
         ((weakGeq letter0_3 (toErl 97)) &&
            (weakLeq letter0_3 (toErl 122)))) =
...
erlps__win32_splitb__1 [(ErlangBinary binSeg_0)]
  ...
  , BIN.empty bin_8
  , slash_6 == slash_3
  , ((==) slash_3 (toErl 92)) || ((==) slash_3 (toErl 47)) =
  let   
    head_12 =
      ErlangBinary (BIN.fromInts (toErl "/") (toErl 8) 1 BIN.Big)
  in let
...
erlps__win32_split__1 [(ErlangCons slash_0 (ErlangCons slash_1 rest_2))]
  | slash_1 == slash_0
  , ((==) slash_0 (toErl 92)) || ((==) slash_0 (toErl 47)) =
  let    head_6 = toErl 47
  in let head_8 = toErl 47
  in
    erlps__split__3
...
erlps__win32_split__1 [(ErlangCons ucletter_0 (ErlangCons (ErlangInt num_1) rest_2))]
  ...
  in let head_4 = BIF.erlang__op_minus [lop_5, rop_8]
  in let head_10 = toErl 58
  in
    erlps__win32_split__1
  ...
  in
    erlps__split__4
      [rest_2, ErlangEmptyList,
       ErlangCons
         (ErlangCons letter_0 (ErlangCons head_9 ErlangEmptyList))
         ErlangEmptyList,
       ErlangAtom "win32"]
  ...
  in
    erlps__split__4
      [rest_1, ErlangEmptyList,
       ErlangCons (ErlangCons head_8 ErlangEmptyList) components_2,
       ostype_3]
erlps__split__3 [(ErlangCons (ErlangInt num_0) rest_1),
  ...
  in
    erlps__split__4
      [rest_1, ErlangEmptyList,
       ErlangCons (ErlangCons head_7 ErlangEmptyList) components_2,
       ErlangAtom "win32"]
...
erlps__split__4 [(ErlangCons (ErlangInt num_0) rest_1), comp_2,
  ...
  in
    erlps__split__4
      [ErlangCons head_5 rest_1, comp_2, components_3,
       ErlangAtom "win32"]
...
erlps__split__4 [(ErlangEmptyList), (ErlangEmptyList),
  ...
  =
  BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [components_0]
...
erlps__separators__0 [] =
  ...
  in
    case case_0 of
      (ErlangTuple [(ErlangAtom "win32"), _]) ->
        let    tup_el_1 = toErl 92
        in let tup_el_2 = toErl 58
...
erlps__major_os_type__0 [] =
  let matchExpr_1 = BIF.do_remote_fun_call "Os" "erlps__type__0" []
  in
    case matchExpr_1 of
...
erlps__do_flatten__2 [atom_0, tail_1] | isEAtom atom_0 =
...
erlps__basedir__2 [type_0, application_1]
  | (isEAtom type_0) &&
      ((isEList application_1) || (isEBinary application_1)) =
  let arg_4 = ErlangMap Map.empty
  in erlps__basedir__3 [type_0, application_1, arg_4]
erlps__basedir__2 [arg_5, arg_6] = EXC.function_clause unit
...
erlps__basedir_name_from_opts__3 [_, app_0, (ErlangMap map_1)]
  | (DM.Just vsn_2) <- (Map.lookup (ErlangAtom "version") map_1) =
  erlps__join__1
...
erlps__basedir_linux__1 [type_0] =
  case type_0 of
    (ErlangAtom "user_data") ->
      let    arg_2 = toErl "XDG_DATA_HOME"
      in let arg_3 = toErl ".local/share"
      in erlps__getenv__3 [arg_2, arg_3, ErlangAtom "true"]
    (ErlangAtom "user_config") ->
      let    arg_5 = toErl "XDG_CONFIG_HOME"
      in let arg_6 = toErl ".config"
      in erlps__getenv__3 [arg_5, arg_6, ErlangAtom "true"]
    (ErlangAtom "user_cache") ->
      let    arg_8 = toErl "XDG_CACHE_HOME"
      in let arg_9 = toErl ".cache"
      in erlps__getenv__3 [arg_8, arg_9, ErlangAtom "true"]
    (ErlangAtom "user_log") ->
      let    arg_11 = toErl "XDG_CACHE_HOME"
      in let arg_12 = toErl ".cache"
      in erlps__getenv__3 [arg_11, arg_12, ErlangAtom "true"]
    (ErlangAtom "site_data") ->
      let    arg_14 = toErl "XDG_DATA_DIRS"
      in let arg_15 = toErl "/usr/local/share/:/usr/share/"
      in let
        base_17 = erlps__getenv__3 [arg_14, arg_15, ErlangAtom "false"]
      in let arg_19 = toErl ":"
      in
        BIF.do_remote_fun_call "String" "erlps__lexemes__2"
          [base_17, arg_19]
    (ErlangAtom "site_config") ->
      let    arg_20 = toErl "XDG_CONFIG_DIRS"
      in let arg_21 = toErl "/etc/xdg"
      in let
        base_23 = erlps__getenv__3 [arg_20, arg_21, ErlangAtom "false"]
      in let arg_25 = toErl ":"
      in
        BIF.do_remote_fun_call "String" "erlps__lexemes__2"
          [base_23, arg_25]
...
erlps__basedir_darwin__1 [type_0] =
  case type_0 of
    (ErlangAtom "user_data") ->
      let arg_2 = toErl "Library/Application Support"
      in erlps__basedir_join_home__1 [arg_2]
    (ErlangAtom "user_config") ->
      let arg_3 = toErl "Library/Application Support"
      in erlps__basedir_join_home__1 [arg_3]
    (ErlangAtom "user_cache") ->
      let arg_4 = toErl "Library/Caches"
      in erlps__basedir_join_home__1 [arg_4]
    (ErlangAtom "user_log") ->
      let arg_5 = toErl "Library/Logs"
      in erlps__basedir_join_home__1 [arg_5]
    (ErlangAtom "site_data") ->
      let head_6 = toErl "/Library/Application Support"
      in ErlangCons head_6 ErlangEmptyList
    (ErlangAtom "site_config") ->
      let head_8 = toErl "/Library/Application Support"
  ...
  in
    case case_1 of
      (ErlangAtom "noappdata") ->
        case type_0 of
          (ErlangAtom "user_data") ->
            let arg_3 = toErl "Local"
            in erlps__basedir_join_home__1 [arg_3]
          (ErlangAtom "user_config") ->
            let arg_4 = toErl "Roaming"
            in erlps__basedir_join_home__1 [arg_4]
          (ErlangAtom "user_cache") ->
            let arg_5 = toErl "Local"
            in erlps__basedir_join_home__1 [arg_5]
          (ErlangAtom "user_log") ->
            let arg_6 = toErl "Local"
...
erlps__basedir_windows_appdata__0 [] =
  let    arg_1 = toErl "APPDATA"
  in let
    case_0 = BIF.do_remote_fun_call "Os" "erlps__getenv__1" [arg_1]
  in
    case case_0 of
      invalid_2 | ((==) invalid_2 (ErlangAtom "false")) ||
                    ((==) invalid_2 ErlangEmptyList) ->
        ErlangAtom "noappdata"
      val_3 -> ErlangTuple [ErlangAtom "ok", val_3]
...
erlps__getenv__2 [k_0, def_1] =
  let case_2 = BIF.do_remote_fun_call "Os" "erlps__getenv__1" [k_0]
  in
    case case_2 of
...
erlps__validate_list__3 [filename_0, enc_1, os_2] =
  EXC.tryCatch
    (\ _ ->
       let    arg_8 = toErl 0
       in let
         lop_4 = erlps__validate_list__4 [filename_0, enc_1, os_2, arg_8]
       in let rop_9 = toErl 0
       in let match_final_3_10 = BIF.erlang__op_greater [lop_4, rop_9]
       in
...
erlps__validate_list__4 [c_0, enc_1, os_2, chars_3]
  ...
  in BIF.erlang__op_plus [chars_3, rop_8]
...
erlps__validate_list__4 [(ErlangCons h_0 t_1), enc_2, os_3,
  ...
  =
  let
    newchars_9 = erlps__validate_list__4 [h_0, enc_2, os_3, chars_4]
...
erlps__validate_bin__1 [bin_0] =
  EXC.tryCatch
    (\ _ ->
       let    arg_4 = toErl 0
       in let lop_2 = erlps__validate_bin__2 [bin_0, arg_4]
       in let rop_5 = toErl 0
       in let match_final_1_6 = BIF.erlang__op_greater [lop_2, rop_5]
       in
...
erlps__validate_bin__2 [(ErlangBinary binEnd_0), bs_1]
  | BIN.empty binEnd_0 =
  bs_1
erlps__validate_bin__2 [(ErlangBinary binSeg_0), _bs_7]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok (ErlangInt num_3) bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  ...
  , BIN.empty bin_5 =
  BIF.erlang__throw__1 [ErlangAtom "invalid"]
erlps__validate_bin__2 [(ErlangBinary binSeg_0), bs_7]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok _b_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
  ...
  , BIN.empty bin_5 =
  let    rop_11 = toErl 1
  in let arg_9 = BIF.erlang__op_plus [bs_7, rop_11]
