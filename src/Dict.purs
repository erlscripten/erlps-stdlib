...
erlps__new__0 [] =
  ...
  in
    (ErlangTuple
       [(ErlangAtom "dict"), (ErlangInt 0), (ErlangInt 16), (ErlangInt 16),
...
erlps__from_list__1 [l_0] =
  ...
  in (BIF.do_remote_fun_call "Lists" "erlps__foldl__3" [arg_1, arg_11, l_0])
...
erlps__is_empty__1 [(ErlangTuple [(ErlangAtom "dict"), n_0, _, _, _,
                                  _, _, _, _])]
  =
  (BIF.erlang__op_exactEq [n_0, (ErlangInt 0)])
...
erlps__erase_key__2 [_, ErlangEmptyList] =
  (ErlangTuple [ErlangEmptyList, (ErlangInt 0)])
...
erlps__take_key__2 [key_0,
  ...
  | (key_1 == key_0) =
  let tup_el_5 = (ErlangTuple [val_2, (ErlangInt 1)])
...
erlps__store_bkt_val__3 [key_0, new_1,
  ...
  | (key_2 == key_0) =
  (ErlangTuple
     [(ErlangCons (ErlangCons key_0 new_1) bkt_4), (ErlangInt 0)])
erlps__store_bkt_val__3 [key_0, new_1,
...
erlps__append_bkt__3 [key_0, val_1,
  ...
  in
    (ErlangTuple
       [(ErlangCons (ErlangCons key_0 head_8) bkt_4), (ErlangInt 0)])
...
erlps__update_counter__3 [key_0, incr_1, d0_2]
  | (ErlangAtom "true") <- ((BIF.erlang__is_number__1 [incr_1])) =
  let    slot_5 = (erlps__get_slot__2 [d0_2, key_0])
  in let
    arg_6 =
      (ErlangFun 1
  ...
  in
    case match_expr_17 of
      (ErlangTuple [d1_15, ic_16]) ->
        (erlps__maybe_expand__2 [d1_15, ic_16])
      _ -> (EXC.badmatch match_expr_17)
erlps__update_counter__3 [arg_21, arg_22, arg_23] =
  (EXC.function_clause unit)
...
erlps__on_bucket__3 [f_0, t_1, slot_2] =
  let    lop_4 = (BIF.erlang__op_minus [slot_2, (ErlangInt 1)])
  in let
    lop_3 = (BIF.erlang__op_div_strict [lop_4, (ErlangInt 16)])
  in let segi_9 = (BIF.erlang__op_plus [lop_3, (ErlangInt 1)])
  in let lop_11 = (BIF.erlang__op_minus [slot_2, (ErlangInt 1)])
  in let
          ...
          tup_el_32 =
            case t_1 of
              (ErlangTuple [(ErlangAtom "dict"), size_41, n_42, maxn_43, bso_44,
                ...
                (ErlangTuple
                   [(ErlangAtom "dict"), size_41, n_42, maxn_43, bso_44, exp_size_45,
                    con_size_46, empty_47, record_updt_34])
              _ -> (EXC.badrecord (ErlangAtom "dict"))
...
erlps__fold_dict__3 [f_0, acc_1,
                     (ErlangTuple [(ErlangAtom "dict"), (ErlangInt 0), _, _, _, _, _,
                                   _, _])]
...
erlps__fold_segs__4 [f_0, acc_1, _, (ErlangInt 0)]
  | (isEFunA f_0 (ErlangInt 3)) =
  acc_1
erlps__fold_segs__4 [arg_2, arg_3, arg_4, arg_5] =
  (EXC.function_clause unit)
...
erlps__fold_seg__4 [f_0, acc_1, _, (ErlangInt 0)]
  | (isEFunA f_0 (ErlangInt 3)) =
  acc_1
erlps__fold_seg__4 [arg_2, arg_3, arg_4, arg_5] =
  (EXC.function_clause unit)
...
erlps__map_dict__2 [f_0,
                    dict_1@(ErlangTuple [(ErlangAtom "dict"), (ErlangInt 0), _, _, _,
                                         _, _, _, _])]
...
erlps__filter_dict__2 [f_0,
                       dict_1@(ErlangTuple [(ErlangAtom "dict"), (ErlangInt 0), _, _,
                                            _, _, _, _, _])]
  | (isEFunA f_0 (ErlangInt 2)) =
  dict_1
          ...
          arg_14 =
            case d_1 of
              (ErlangTuple [(ErlangAtom "dict"), size_18, n_19, maxn_20, bso_21,
                ...
                (ErlangTuple
                   [(ErlangAtom "dict"), size_18, n_19, maxn_20, bso_21, exp_size_22,
                    con_size_23, empty_24, record_updt_16])
              _ -> (EXC.badrecord (ErlangAtom "dict"))
...
erlps__filter_bkt_list__4 [f_0, ErlangEmptyList, fbs_1, fc_2]
  | (isEFunA f_0 (ErlangInt 2)) =
  let tup_el_3 = (BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [fbs_1])
  in (ErlangTuple [tup_el_3, fc_2])
...
erlps__filter_bucket__4 [f_0,
  ...
  in
    case case_7 of
      ...
      (ErlangAtom "false") ->
        let arg_20 = (BIF.erlang__op_plus [fc_6, (ErlangInt 1)])
        in (erlps__filter_bucket__4 [f_0, bkt_4, fb_5, arg_20])
      something_else -> (EXC.case_clause something_else)
erlps__filter_bucket__4 [f_0, ErlangEmptyList, fb_1, fc_2]
  | (isEFunA f_0 (ErlangInt 2)) =
  let tup_el_3 = (BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [fb_1])
  in (ErlangTuple [tup_el_3, fc_2])
...
erlps__maybe_expand__2 [t_0, (ErlangInt 0)] =
  (erlps__maybe_expand_aux__2 [t_0, (ErlangInt 0)])
erlps__maybe_expand__2 [t_0, (ErlangInt 1)] =
  (erlps__maybe_expand_aux__2 [t_0, (ErlangInt 1)])
erlps__maybe_expand__2 [arg_3, arg_4] =
  (EXC.function_clause unit)
    ...
    lop_4 =
      case t_3 of
        (ErlangTuple arr_7) | (DM.Just field_6) <- ((arr_7 DA.!! 2)) ->
          field_6
        _ -> (EXC.badrecord (ErlangAtom "dict"))
  in let n_9 = (BIF.erlang__op_plus [lop_4, (ErlangInt 1)])
  in let
    segs0_13 =
      case t_3 of
        (ErlangTuple arr_12) | (DM.Just field_11) <-
  ...
  in
    case match_expr_33 of
      (ErlangCons b1_31 b2_32) ->
        ...
        in let
          record_updt_50 = (BIF.erlang__op_mult [n_9, (ErlangInt 5)])
        in let
          record_updt_53 = (BIF.erlang__op_mult [n_9, (ErlangInt 3)])
        in
          case t_3 of
...
erlps__expand_segs__2 [segs_0, empty_1] =
  ...
  in let rop_5 = (BIF.do_remote_fun_call "Lists" "erlps__duplicate__2" [arg_6, empty_1])
