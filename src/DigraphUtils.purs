...
erlps__reachable__2 [vs_0, g_1] | (isEList vs_0) =
  ...
  in let
    arg_2 = (erlps__forest__4 [g_1, arg_4, vs_0, (ErlangAtom "first")])
...
erlps__reachable_neighbours__2 [vs_0, g_1] | (isEList vs_0) =
  let    arg_4 = (ErlangFun 3 erlps__out__3)
  in let
    arg_2 = (erlps__forest__4 [g_1, arg_4, vs_0, (ErlangAtom "not_first")])
  in (BIF.do_remote_fun_call "Lists" "erlps__append__1" [arg_2])
...
erlps__topsort__1 [g_0] =
  ...
  in let arg_10 = (BIF.do_remote_fun_call "Digraph" "erlps__vertices__1" [g_0])
...
erlps__is_acyclic__1 [g_0] =
  ...
  in let lop_6 = (erlps__topsort__1 [g_0])
  in let rop_5 = (BIF.erlang__op_exactNeq [lop_6, (ErlangAtom "false")])
  in (BIF.erlang__op_andalso [lop_1, rop_5])
erlps__is_acyclic__1 [arg_9] = (EXC.function_clause unit)
erlps__is_acyclic__1 args =
  (EXC.badarity (ErlangFun 1 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)

erlps__arborescence_root__1 :: ErlangFun
erlps__arborescence_root__1 [g_0] =
  let    lop_2 = (BIF.do_remote_fun_call "Digraph" "erlps__no_edges__1" [g_0])
  in let lop_5 = (BIF.do_remote_fun_call "Digraph" "erlps__no_vertices__1" [g_0])
  in let rop_4 = (BIF.erlang__op_minus [lop_5, (ErlangInt 1)])
  ...
  in
    case case_1 of
              ...
              let   
                f_18 =
                  (ErlangFun 2
                     let
                       lambda_8 [v_11, z_12] =
                         let case_13 = (BIF.do_remote_fun_call "Digraph" "erlps__in_degree__2" [g_0, v_11])
                         in
                           case case_13 of
                             (ErlangInt 1) -> z_12
                             (ErlangInt 0) | (z_12 == ErlangEmptyList) ->
                     ...
                     in lambda_8)
              in let arg_21 = (BIF.do_remote_fun_call "Digraph" "erlps__vertices__1" [g_0])
              in let
                match_expr_24 =
                  (BIF.do_remote_fun_call "Lists" "erlps__foldl__3" [f_18, ErlangEmptyList, arg_21])
              in
                case match_expr_24 of
                  (ErlangCons root_23 ErlangEmptyList) ->
                    (ErlangTuple [(ErlangAtom "yes"), root_23])
      ...
      something_else -> (EXC.case_clause something_else)
erlps__arborescence_root__1 [arg_29] = (EXC.function_clause unit)
...
erlps__is_tree__1 [g_0] =
  ...
  in let arg_10 = (erlps__components__1 [g_0])
  in let lop_9 = (BIF.erlang__length__1 [arg_10])
  in let rop_8 = (BIF.erlang__op_exactEq [lop_9, (ErlangInt 1)])
  in (BIF.erlang__op_andalso [lop_1, rop_8])
erlps__is_tree__1 [arg_13] = (EXC.function_clause unit)
erlps__is_tree__1 args =
  (EXC.badarity (ErlangFun 1 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)

erlps__loop_vertices__1 :: ErlangFun
erlps__loop_vertices__1 [g_0] =
  let lc_src_1 = (BIF.do_remote_fun_call "Digraph" "erlps__vertices__1" [g_0])
  in
    (flmap
       (\ lc_4 ->
          case lc_4 of
...
erlps__condensation__1 [g_0] =
  ...
  in let
    v2i_5 =
      (BIF.do_remote_fun_call "Ets" "erlps__new__2" [(ErlangAtom "condensation"), ErlangEmptyList])
  in let
    i2c_8 =
      (BIF.do_remote_fun_call "Ets" "erlps__new__2" [(ErlangAtom "condensation"), ErlangEmptyList])
  in let
    cfun_33 =
      (ErlangFun 2
                 ...
                 (ErlangFun 1
                    let
                      lambda_15 [v_17] =
                        ...
                        in let
                          match_final_18_23 =
                            (BIF.do_remote_fun_call "Ets" "erlps__insert__2" [v2i_5, arg_20])
                        in
                    ...
                    in lambda_15)
             in let _ = (BIF.do_remote_fun_call "Lists" "erlps__foreach__2" [arg_14, sc_12])
             in let arg_27 = (ErlangTuple [n_13, sc_12])
             in let
               match_expr_30 = (BIF.do_remote_fun_call "Ets" "erlps__insert__2" [i2c_8, arg_27])
             in
               case match_expr_30 of
                 (ErlangAtom "true") -> (BIF.erlang__op_plus [n_13, (ErlangInt 1)])
         ...
         in lambda_9)
  in let
    _ = (BIF.do_remote_fun_call "Lists" "erlps__foldl__3" [cfun_33, (ErlangInt 1), scs_2])
  in let
    scg_40 =
  ...
  in let
    arg_41 =
      (ErlangFun 1
         ...
         in lambda_42)
  in let _ = (BIF.do_remote_fun_call "Lists" "erlps__foreach__2" [arg_41, scs_2])
  in let _ = (BIF.do_remote_fun_call "Ets" "erlps__delete__1" [v2i_5])
  in let _ = (BIF.do_remote_fun_call "Ets" "erlps__delete__1" [i2c_8])
  in scg_40
...
erlps__forest__2 [g_0, sf_1] =
  let arg_4 = (BIF.do_remote_fun_call "Digraph" "erlps__vertices__1" [g_0])
...
erlps__forest__4 [g_0, sf_1, vs_2, handlefirst_3] =
  let   
    t_8 =
      (BIF.do_remote_fun_call "Ets" "erlps__new__2"
         [(ErlangAtom "forest"), (ErlangCons (ErlangAtom "set") ErlangEmptyList)])
  in let
    f_20 =
      (ErlangFun 2
         let
  ...
  in let
    ll_24 =
      (BIF.do_remote_fun_call "Lists" "erlps__foldl__3" [f_20, ErlangEmptyList, vs_2])
  in let _ = (BIF.do_remote_fun_call "Ets" "erlps__delete__1" [t_8])
  in ll_24
...
erlps__pretraverse__6 [(ErlangAtom "not_first"), v_0, sf_1, g_2, t_3, ll_4]
  =
  let case_5 = (BIF.do_remote_fun_call "Ets" "erlps__member__2" [t_3, v_0])
  in
    case case_5 of
      (ErlangAtom "false") ->
        let
...
erlps__ptraverse__6 [(ErlangCons v_0 vs_1), sf_2, g_3, t_4, rs_5,
                     ll_6]
  =
  let case_7 = (BIF.do_remote_fun_call "Ets" "erlps__member__2" [t_4, v_0])
  in
    case case_7 of
      (ErlangAtom "false") ->
        let    arg_11 = (ErlangTuple [v_0])
        in let _ = (BIF.do_remote_fun_call "Ets" "erlps__insert__2" [t_4, arg_11])
        in let
          arg_13 =
            (BIF.erlang__apply__2
               [sf_2,
...
erlps__revpostorder__1 [g_0] =
  let   
    t_5 =
      (BIF.do_remote_fun_call "Ets" "erlps__new__2"
         [(ErlangAtom "forest"), (ErlangCons (ErlangAtom "set") ErlangEmptyList)])
  in let arg_6 = (BIF.do_remote_fun_call "Digraph" "erlps__vertices__1" [g_0])
  in let
    l_11 =
      (erlps__posttraverse__4 [arg_6, g_0, t_5, ErlangEmptyList])
  in let _ = (BIF.do_remote_fun_call "Ets" "erlps__delete__1" [t_5])
  in l_11
...
erlps__in__3 [g_0, v_1, vs_2] =
  let lop_3 = (BIF.do_remote_fun_call "Digraph" "erlps__in_neighbours__2" [g_0, v_1])
...
erlps__out__3 [g_0, v_1, vs_2] =
  let lop_3 = (BIF.do_remote_fun_call "Digraph" "erlps__out_neighbours__2" [g_0, v_1])
  in (BIF.erlang__op_append [lop_3, vs_2])
...
erlps__is_reflexive_vertex__2 [v_0, g_1] =
  let arg_3 = (BIF.do_remote_fun_call "Digraph" "erlps__out_neighbours__2" [g_1, v_0])
...
erlps__subgraph_opts__5 [(ErlangCons (ErlangTuple [(ErlangAtom "type"),
  ...
  | (ErlangAtom "true") <-
      (let   
       ...
       in let rop_14 = (BIF.erlang__is_list__1 [type_0])
       in (BIF.erlang__op_orelse [lop_11, rop_14])) =
...
erlps__subgraph_opts__5 [ErlangEmptyList, (ErlangAtom "inherit"), keep_0,
                         g_1, vs_2]
  =
  let    info_4 = (BIF.do_remote_fun_call "Digraph" "erlps__info__1" [g_1])
  in let
    match_expr_9 =
      (BIF.lists__keysearch__3 [(ErlangAtom "cyclicity"), (ErlangInt 1), info_4])
  in
    case match_expr_9 of
      (ErlangTuple [_, (ErlangTuple [_, cyclicity_8])]) ->
        let
          match_expr_14 =
            (BIF.lists__keysearch__3 [(ErlangAtom "protection"), (ErlangInt 1), info_4])
        in
...
erlps__subgraph__4 [g_0, vs_1, type_2, keep_3] =
  (EXC.tryOfCatch (\ _ -> (BIF.do_remote_fun_call "Digraph" "erlps__new__1" [type_2]))
     (\ of_5 ->
        case of_5 of
          sg_7 ->
            let   
              arg_8 =
                (ErlangFun 1
                   ...
                   in lambda_9)
            in let _ = (BIF.do_remote_fun_call "Lists" "erlps__foreach__2" [arg_8, vs_1])
            in let
              efun_31 =
                (ErlangFun 1
                   let
                       ...
                       let   
                         arg_20 =
                           (ErlangFun 1
                              ...
                              in lambda_21)
                       in let arg_28 = (BIF.do_remote_fun_call "Digraph" "erlps__out_edges__2" [g_0, v_19])
                       in (BIF.do_remote_fun_call "Lists" "erlps__foreach__2" [arg_20, arg_28])
                     lambda_17 [arg_18] = (EXC.function_clause unit)
                     lambda_17 args =
                       (EXC.badarity (ErlangFun 1 lambda_17) args)
                   in lambda_17)
            in let arg_33 = (BIF.do_remote_fun_call "Digraph" "erlps__vertices__1" [sg_7])
            in let _ = (BIF.do_remote_fun_call "Lists" "erlps__foreach__2" [efun_31, arg_33])
            in sg_7
...
erlps__subgraph_vertex__4 [v_0, g_1, sg_2, keep_3] =
  let case_4 = (BIF.do_remote_fun_call "Digraph" "erlps__vertex__2" [g_1, v_0])
  in
    case case_4 of
...
erlps__subgraph_edge__4 [e_0, g_1, sg_2, keep_3] =
  let match_expr_10 = (BIF.do_remote_fun_call "Digraph" "erlps__edge__2" [g_1, e_0])
  in
    case match_expr_10 of
      (ErlangTuple [_e_6, v1_7, v2_8, label_9]) ->
        let case_11 = (BIF.do_remote_fun_call "Digraph" "erlps__vertex__2" [sg_2, v2_8])
        in
          case case_11 of
            (ErlangAtom "false") -> (ErlangAtom "ok")
            _ | (ErlangAtom "true") <- ((BIF.erlang__not__1 [keep_3])) ->
...
erlps__condense__5 [sc_0, g_1, scg_2, v2i_3, i2c_4] =
  let   
    t_7 =
      (BIF.do_remote_fun_call "Ets" "erlps__new__2" [(ErlangAtom "condense"), ErlangEmptyList])
  in let
    nfun_19 =
      (ErlangFun 1
         let
           lambda_8 [neighbour_10] =
             let
               match_expr_15 =
                 (BIF.do_remote_fun_call "Ets" "erlps__lookup__2" [v2i_3, neighbour_10])
             in
               case match_expr_15 of
                 (ErlangCons (ErlangTuple [_v_13, i_14]) ErlangEmptyList) ->
                   let arg_17 = (ErlangTuple [i_14])
                   in (BIF.do_remote_fun_call "Ets" "erlps__insert__2" [t_7, arg_17])
  ...
  in let
    vfun_27 =
      (ErlangFun 1
         let
           lambda_20 [v_22] =
             let arg_24 = (BIF.do_remote_fun_call "Digraph" "erlps__out_neighbours__2" [g_1, v_22])
             in (BIF.do_remote_fun_call "Lists" "erlps__foreach__2" [nfun_19, arg_24])
           lambda_20 [arg_21] = (EXC.function_clause unit)
           lambda_20 args = (EXC.badarity (ErlangFun 1 lambda_20) args)
         in lambda_20)
  in let _ = (BIF.do_remote_fun_call "Lists" "erlps__foreach__2" [vfun_27, sc_0])
  in let _ = (BIF.do_remote_fun_call "Digraph" "erlps__add_vertex__2" [scg_2, sc_0])
  in let arg_32 = (BIF.do_remote_fun_call "Ets" "erlps__first__1" [t_7])
  in let
...
erlps__condense__6 [i_0, t_1, sc_2, g_3, scg_4, i2c_5] =
  let match_expr_9 = (BIF.do_remote_fun_call "Ets" "erlps__lookup__2" [i2c_5, i_0])
  in
    case match_expr_9 of
      (ErlangCons (ErlangTuple [_, c_8]) ErlangEmptyList) ->
        let    _ = (BIF.do_remote_fun_call "Digraph" "erlps__add_vertex__2" [scg_4, c_8])
        in let cond_12 = (BIF.erlang__op_exactNeq [c_8, sc_2])
        in let
          match_expr_19 =
            case cond_12 of
              (ErlangAtom "true") ->
                let lc_ret_15 = (BIF.do_remote_fun_call "Digraph" "erlps__add_edge__3" [scg_4, sc_2, c_8])
                in (ErlangCons lc_ret_15 ErlangEmptyList)
              _ -> ErlangEmptyList
        in let arg_20 = (BIF.do_remote_fun_call "Ets" "erlps__next__2" [t_1, i_0])
