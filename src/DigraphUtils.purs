...
erlps__arborescence_root__1 [g_0] =
  ...
  in let rop_4 = BIF.erlang__op_minus [lop_5, rop_7]
  ...
  in
    case lop_1 of
      ...
      (ErlangAtom "true") ->
        ...
        in BIF.erlang__op_exactEq [lop_8, rop_11]
      _ -> EXC.badarg1 lop_1
...
erlps__subgraph__3 [g_0, vs_1, opts_2] =
  EXC.tryCatch (\ _ -> erlps__subgraph_opts__3 [g_0, vs_1, opts_2])
    (\ ex_7 ->
       case ex_7 of
         (ErlangTuple [(ErlangAtom "throw"), (ErlangAtom "badarg"), _]) ->
           BIF.erlang__error__1 [ErlangAtom "badarg"]
      ...
      ErlangFun 2
        (let
           lambda_9 [sc_12, n_13] =
             ...
             in let
               matchExpr_30 =
                 BIF.do_remote_fun_call "Ets" "erlps__insert__2" [i2c_8, arg_27]
             in
               case matchExpr_30 of
                 (ErlangAtom "true") ->
                   let rop_32 = toErl 1
                   in BIF.erlang__op_plus [n_13, rop_32]
         ...
         in lambda_9)
  in let arg_35 = toErl 1
  in let
    _ =
      BIF.do_remote_fun_call "Lists" "erlps__foldl__3"
        [cfun_33, arg_35, scs_2]
  in let
    scg_40 =
...
erlps__pretraverse__6 [(ErlangAtom "first"), v_0, sf_1, g_2, t_3,
  ...
  =
  erlps__ptraverse__6
    [ErlangCons v_0 ErlangEmptyList, sf_1, g_2, t_3, ErlangEmptyList,
     ll_4]
        ...
        let
          arg_8 =
            BIF.erlang__apply__2
              [sf_1,
               ErlangCons g_2
                 (ErlangCons v_0 (ErlangCons ErlangEmptyList ErlangEmptyList))]
        in
          erlps__ptraverse__6
  ...
  in
    case case_7 of
      (ErlangAtom "false") ->
        ...
        in let
          _ = BIF.do_remote_fun_call "Ets" "erlps__insert__2" [t_4, arg_11]
        in let
          arg_13 =
            BIF.erlang__apply__2
              [sf_2,
...
erlps__revpostorder__1 [g_0] =
  ...
  in let
    arg_6 =
      BIF.do_remote_fun_call "Digraph" "erlps__vertices__1" [g_0]
  in let
    l_11 = erlps__posttraverse__4 [arg_6, g_0, t_5, ErlangEmptyList]
    ...
    l1_20 =
      case case_5 of
        (ErlangAtom "false") ->
          ...
          in let
            _ = BIF.do_remote_fun_call "Ets" "erlps__insert__2" [t_3, arg_9]
...
erlps__subgraph_opts__5 [(ErlangEmptyList),
  ...
  =
  let   
    info_4 = BIF.do_remote_fun_call "Digraph" "erlps__info__1" [g_1]
  in let arg_6 = toErl 1
  in let
    matchExpr_9 =
      BIF.lists__keysearch__3 [ErlangAtom "cyclicity", arg_6, info_4]
  in
    case matchExpr_9 of
      (ErlangTuple [_, (ErlangTuple [_, cyclicity_8])]) ->
        ...
        in let
          matchExpr_14 =
            BIF.lists__keysearch__3 [ErlangAtom "protection", arg_11, info_4]
        in
...
erlps__subgraph__4 [g_0, vs_1, type_2, keep_3] =
  EXC.tryOfCatch
    ...
    (\ of_5 ->
       ...
       in let
         _ =
           BIF.do_remote_fun_call "Lists" "erlps__foreach__2" [arg_9, vs_1]
       in let
         efun_32 =
           ErlangFun 1
             (let
                  ...
                  let   
                    arg_21 =
                      ErlangFun 1
                        (let
                           lambda_22 [e_24] =
                             erlps__subgraph_edge__4 [e_24, g_0, of_5, keep_3]
  ...
  in
    case matchExpr_10 of
      (ErlangTuple [_e_6, v1_7, v2_8, label_9]) ->
        let
          case_11 =
            BIF.do_remote_fun_call "Digraph" "erlps__vertex__2" [sg_2, v2_8]
        in
          case case_11 of
            (ErlangAtom "false") -> ErlangAtom "ok"
            _ | (ErlangAtom "true") ==
        ...
        in let
          matchExpr_19 =
            case cond_12 of
              ...
              _ -> ErlangEmptyList
        in let
          arg_20 = BIF.do_remote_fun_call "Ets" "erlps__next__2" [t_1, i_0]
