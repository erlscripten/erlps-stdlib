...
erlps__bool_option__4 [on_0, off_1, default_2, opts_3] =
  let
    arg_4 =
      ErlangFun 2
        (let
           lambda_5 [opt_8, _def_9] | (==) opt_8 on_0 = ErlangAtom "true"
...
erlps__bool_option__4 args =
  EXC.badarity (ErlangFun 4 erlps__bool_option__4) args
...
erlps__value_option__3 args =
  EXC.badarity (ErlangFun 3 erlps__value_option__3) args
...
erlps__value_option__7 args =
  EXC.badarity (ErlangFun 7 erlps__value_option__7) args
...
erlps__format_error__1 args =
  EXC.badarity (ErlangFun 1 erlps__format_error__1) args

erlps__gen_type_paren__1 :: ErlangFun
erlps__gen_type_paren__1 [arity_0]
  | (isEInt arity_0) && (weakGeq arity_0 (toErl 0)) =
  let arg_2 = toErl ")"
...
erlps__gen_type_paren__1 args =
  EXC.badarity (ErlangFun 1 erlps__gen_type_paren__1) args
...
erlps__gen_type_paren_1__2 args =
  EXC.badarity (ErlangFun 2 erlps__gen_type_paren_1__2) args
  ...
  let   
    arg_3 =
      flmap
        (\ lc_6 ->
           let    head_8 = toErl 44
           in let tail_9 = BIF.erlang__integer_to_list__1 [lc_6]
           in ErlangCons (ErlangCons head_8 tail_9) ErlangEmptyList)
        as_2
  in let
    matchExpr_13 =
...
erlps__format_mfa__1 args =
  EXC.badarity (ErlangFun 1 erlps__format_mfa__1) args
...
erlps__format_mf__3 args =
  EXC.badarity (ErlangFun 3 erlps__format_mf__3) args
...
erlps__format_where__1 args =
  EXC.badarity (ErlangFun 1 erlps__format_where__1) args

erlps__pseudolocals__0 :: ErlangFun
erlps__pseudolocals__0 [] =
  let    tup_el_2 = toErl 0
  in let head_0 = ErlangTuple [ErlangAtom "module_info", tup_el_2]
  in let tup_el_6 = toErl 1
  in let head_4 = ErlangTuple [ErlangAtom "module_info", tup_el_6]
  in let tup_el_10 = toErl 2
  in let head_8 = ErlangTuple [ErlangAtom "record_info", tup_el_10]
  in
    ErlangCons head_0
      (ErlangCons head_4 (ErlangCons head_8 ErlangEmptyList))
erlps__pseudolocals__0 args =
  EXC.badarity (ErlangFun 0 erlps__pseudolocals__0) args
  ...
  in
    case matchExpr_39 of
      (ErlangTuple [st0_37, vs_38]) ->
        ...
        in let arg_44 = toErl "nofile"
        in let arg_42 = erlps__set_file__2 [exprs_0, arg_44]
        in let matchExpr_49 = erlps__exprs__3 [arg_42, vt_41, st0_37]
        in
          case matchExpr_49 of
            (ErlangTuple [_evt_47, st_48]) -> erlps__return_status__1 [st_48]
            _ -> EXC.badmatch matchExpr_49
      _ -> EXC.badmatch matchExpr_39
erlps__exprs_opt__3 [arg_51, arg_52, arg_53] =
  EXC.function_clause unit
erlps__exprs_opt__3 args =
  EXC.badarity (ErlangFun 3 erlps__exprs_opt__3) args
...
erlps__used_vars__2 [exprs_0, bindingslist_1] =
  ...
  in let arg_27 = toErl "nofile"
  in let arg_25 = erlps__set_file__2 [exprs_0, arg_27]
  in let arg_29 = erlps__start__0 []
  in let matchExpr_32 = erlps__exprs__3 [arg_25, vt_24, arg_29]
  in
...
erlps__module__1 args =
  EXC.badarity (ErlangFun 1 erlps__module__1) args
...
erlps__module__2 args =
  EXC.badarity (ErlangFun 2 erlps__module__2) args
...
erlps__module__3 args =
  EXC.badarity (ErlangFun 3 erlps__module__3) args
...
erlps__compiler_options__1 args =
  EXC.badarity (ErlangFun 1 erlps__compiler_options__1) args

erlps__start__0 :: ErlangFun
erlps__start__0 [] =
  let arg_0 = toErl "nofile"
  in erlps__start__2 [arg_0, ErlangEmptyList]
erlps__start__0 args =
  EXC.badarity (ErlangFun 0 erlps__start__0) args
...
erlps__start__2 [file_0, opts_1] =
  let   
    tup_el_4 =
      erlps__bool_option__4
        [ErlangAtom "warn_unused_vars", ErlangAtom "nowarn_unused_vars",
         ErlangAtom "true", opts_1]
  in let head_2 = ErlangTuple [ErlangAtom "unused_vars", tup_el_4]
  in let
    tup_el_12 =
      erlps__bool_option__4
        [ErlangAtom "warn_export_all", ErlangAtom "nowarn_export_all",
         ErlangAtom "true", opts_1]
  in let head_10 = ErlangTuple [ErlangAtom "export_all", tup_el_12]
  in let
    tup_el_20 =
      erlps__bool_option__4
        [ErlangAtom "warn_export_vars", ErlangAtom "nowarn_export_vars",
         ErlangAtom "false", opts_1]
  in let
    head_18 = ErlangTuple [ErlangAtom "export_vars", tup_el_20]
  in let
    tup_el_28 =
      erlps__bool_option__4
        [ErlangAtom "warn_shadow_vars", ErlangAtom "nowarn_shadow_vars",
         ErlangAtom "true", opts_1]
  in let
    ...
    tup_el_36 =
      erlps__bool_option__4
        [ErlangAtom "warn_unused_import",
         ErlangAtom "nowarn_unused_import", ErlangAtom "false", opts_1]
  in let
    ...
    tup_el_44 =
      erlps__bool_option__4
        [ErlangAtom "warn_unused_function",
         ErlangAtom "nowarn_unused_function", ErlangAtom "true", opts_1]
  in let
    head_42 = ErlangTuple [ErlangAtom "unused_function", tup_el_44]
  in let
    tup_el_52 =
      erlps__bool_option__4
        [ErlangAtom "warn_unused_type", ErlangAtom "nowarn_unused_type",
         ErlangAtom "true", opts_1]
  in let
    ...
    tup_el_60 =
      erlps__bool_option__4
        [ErlangAtom "warn_bif_clash", ErlangAtom "nowarn_bif_clash",
         ErlangAtom "true", opts_1]
  in let head_58 = ErlangTuple [ErlangAtom "bif_clash", tup_el_60]
  in let
    tup_el_68 =
      erlps__bool_option__4
        [ErlangAtom "warn_unused_record",
         ErlangAtom "nowarn_unused_record", ErlangAtom "true", opts_1]
  in let
    ...
    tup_el_84 =
      erlps__bool_option__4
        [ErlangAtom "warn_deprecated_type",
         ErlangAtom "nowarn_deprecated_type", ErlangAtom "true", opts_1]
  in let
    head_82 = ErlangTuple [ErlangAtom "deprecated_type", tup_el_84]
  in let
    tup_el_92 =
      erlps__bool_option__4
        [ErlangAtom "warn_obsolete_guard",
         ErlangAtom "nowarn_obsolete_guard", ErlangAtom "true", opts_1]
  in let
    head_90 = ErlangTuple [ErlangAtom "obsolete_guard", tup_el_92]
  in let
    tup_el_100 =
      erlps__bool_option__4
        [ErlangAtom "warn_untyped_record",
         ErlangAtom "nowarn_untyped_record", ErlangAtom "false", opts_1]
  in let
    head_98 = ErlangTuple [ErlangAtom "untyped_record", tup_el_100]
  in let
    tup_el_108 =
      erlps__bool_option__4
        [ErlangAtom "warn_missing_spec",
         ErlangAtom "nowarn_missing_spec", ErlangAtom "false", opts_1]
  in let
    head_106 = ErlangTuple [ErlangAtom "missing_spec", tup_el_108]
  in let
    tup_el_116 =
      erlps__bool_option__4
        [ErlangAtom "warn_missing_spec_all",
         ErlangAtom "nowarn_missing_spec_all", ErlangAtom "false", opts_1]
  in let
    head_114 =
    ...
    tup_el_124 =
      erlps__bool_option__4
        [ErlangAtom "warn_removed", ErlangAtom "nowarn_removed",
         ErlangAtom "true", opts_1]
  in let head_122 = ErlangTuple [ErlangAtom "removed", tup_el_124]
  in let
    tup_el_132 =
      erlps__bool_option__4
        [ErlangAtom "warn_nif_inline", ErlangAtom "nowarn_nif_inline",
         ErlangAtom "true", opts_1]
  in let
  ...
  in let
    calls_156 =
      case case_146 of
        (ErlangAtom "true") ->
          let    tup_el_153 = toErl 1
          in let
            tup_el_151 = ErlangTuple [ErlangAtom "module_info", tup_el_153]
          in let tup_el_154 = erlps__pseudolocals__0 []
          in let head_150 = ErlangTuple [tup_el_151, tup_el_154]
          in BIF.maps__from_list__1 [ErlangCons head_150 ErlangEmptyList]
        (ErlangAtom "false") -> ErlangAtom "undefined"
        something_else -> EXC.case_clause something_else
  in let tup_el_165 = toErl 0
  in let
    head_163 = ErlangTuple [ErlangAtom "module_info", tup_el_165]
  in let tup_el_169 = toErl 1
  in let
    head_167 = ErlangTuple [ErlangAtom "module_info", tup_el_169]
  in let
    tup_el_161 =
  ...
  in let
    tup_el_176 =
      BIF.do_remote_fun_call "Gb.Sets" "erlps__from_list__1" [arg_177]
  in let arg_180 = toErl 0
  in let
    tup_el_179 =
      BIF.do_remote_fun_call "Erl.Anno" "erlps__new__1" [arg_180]
  in let
    tup_el_183 =
      BIF.do_remote_fun_call "Gb.Sets" "erlps__empty__0" []
  in let arg_187 = toErl 1
  in let arg_189 = toErl 1
  in let arg_191 = toErl 0
  in let
    tup_el_185 =
      erlps__value_option__7
        [ErlangAtom "warn_format", arg_187, ErlangAtom "warn_format",
         arg_189, ErlangAtom "nowarn_format", arg_191, opts_1]
  in let
    tup_el_194 =
      erlps__nowarn_function__2 [ErlangAtom "nowarn_bif_clash", opts_1]
  in let lcSrc_203 = erlps__pseudolocals__0 []
  in let
    tup_el_202 =
      flmap
        (\ lc_205 ->
           let    tup_el_208 = toErl 0
           in let lcRet_206 = ErlangTuple [lc_205, tup_el_208]
           in ErlangCons lcRet_206 ErlangEmptyList)
        lcSrc_203
  in let
    tup_el_213 = BIF.do_remote_fun_call "Gb.Sets" "erlps__new__0" []
  in let
  ...
  in
    ErlangTuple
      [ErlangAtom "lint", ErlangAtom "start", ErlangAtom "",
       ...
       ErlangEmptyList, file_0, ErlangAtom "false", ErlangAtom "false",
       tup_el_202, tup_el_209, tup_el_215, tup_el_216, tup_el_217,
       tup_el_218, tup_el_219, ErlangAtom "false", ErlangAtom "none",
       ErlangAtom "guard"]
erlps__start__2 [arg_223, arg_224] = EXC.function_clause unit
erlps__start__2 args =
  EXC.badarity (ErlangFun 2 erlps__start__2) args
...
erlps__is_warn_enabled__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_warn_enabled__2) args
...
erlps__return_status__1 [st_0] =
  ...
  in let
    arg_7 =
      case st_0 of
        (ErlangTuple arr_10) | (DM.Just field_9) <- (arr_10 DA.!! 20) ->
          field_9
        _ -> EXC.badrecord (ErlangAtom "lint")
...
erlps__return_status__1 args =
  EXC.badarity (ErlangFun 1 erlps__return_status__1) args
    ...
    arg_1 =
      ErlangFun 2
        (let
         ...
         in lambda_2)
  in let op_arg_17 = toErl 1
  in let arg_16 = BIF.erlang__op_neg [op_arg_17]
  in let
    matchExpr_20 =
...
erlps__pack_errors__1 args =
  EXC.badarity (ErlangFun 1 erlps__pack_errors__1) args
               ...
               (\ lc_16 ->
                  case lc_16 of
                    (ErlangTuple [f_14, w_15]) ->
                      let cond_17 = BIF.erlang__op_exactEq [f_14, lc_8]
                      in
                        case cond_17 of
                          (ErlangAtom "true") -> ErlangCons w_15 ErlangEmptyList
                          _ -> ErlangEmptyList
                    _ -> ErlangEmptyList)
               ws_0
         in let
  ...
  in let
    e_10 =
      case case_4 of
        ...
        something_else -> EXC.case_clause something_else
  in let matchExpr_15 = erlps__loc__2 [anno_0, st_3]
  in
    case matchExpr_15 of
      (ErlangTuple [file_13, location_14]) ->
        let
          arg_16 = ErlangTuple [location_14, ErlangAtom "erl_lint", e_10]
...
erlps__add_error__3 args =
  EXC.badarity (ErlangFun 3 erlps__add_error__3) args
...
erlps__add_lint_error__3 [e_0, file_1, st_2] =
  ...
  in let
    tail_8 =
      case st_2 of
        (ErlangTuple arr_11) | (DM.Just field_10) <- (arr_11 DA.!! 20) ->
          field_10
        _ -> EXC.badrecord (ErlangAtom "lint")
  in
    case st_2 of
...
erlps__add_lint_error__3 args =
  EXC.badarity (ErlangFun 3 erlps__add_lint_error__3) args
...
erlps__add_warning__2 args =
  EXC.badarity (ErlangFun 2 erlps__add_warning__2) args

erlps__add_warning__3 :: ErlangFun
erlps__add_warning__3 [fileline_0, w_1, st_2] =
  let matchExpr_7 = erlps__loc__2 [fileline_0, st_2]
  in
    case matchExpr_7 of
      (ErlangTuple [file_5, location_6]) ->
        let arg_8 = ErlangTuple [location_6, ErlangAtom "erl_lint", w_1]
...
erlps__add_warning__3 args =
  EXC.badarity (ErlangFun 3 erlps__add_warning__3) args
...
erlps__add_lint_warning__3 [w_0, file_1, st_2] =
  ...
  in let
    tail_8 =
      case st_2 of
        (ErlangTuple arr_11) | (DM.Just field_10) <- (arr_11 DA.!! 21) ->
          field_10
        _ -> EXC.badrecord (ErlangAtom "lint")
  in
    case st_2 of
...
erlps__add_lint_warning__3 args =
  EXC.badarity (ErlangFun 3 erlps__add_lint_warning__3) args
...
erlps__loc__2 args =
  EXC.badarity (ErlangFun 2 erlps__loc__2) args

erlps__forms__2 :: ErlangFun
erlps__forms__2 [forms0_0, st0_1] =
  let    forms_4 = erlps__eval_file_attribute__2 [forms0_0, st0_1]
...
erlps__forms__2 args =
  EXC.badarity (ErlangFun 2 erlps__forms__2) args
...
erlps__pre_scan__2 [(ErlangCons (ErlangTuple [(ErlangAtom "attribute"),
  ...
  =
  let   
    lop_5 = erlps__is_warn_enabled__2 [ErlangAtom "export_all", st_3]
  in let
    case_4 =
      case lop_5 of
...
erlps__pre_scan__2 args =
  EXC.badarity (ErlangFun 2 erlps__pre_scan__2) args
  ...
  let   
    qh_11 =
      flmap
        ...
        forms_0
  in let
    record_updt_13 = BIF.erlang__op_exactNeq [qh_11, ErlangEmptyList]
  in
    case st_1 of
...
erlps__includes_qlc_hrl__2 args =
  EXC.badarity (ErlangFun 2 erlps__includes_qlc_hrl__2) args
...
erlps__eval_file_attribute__2 args =
  EXC.badarity (ErlangFun 2 erlps__eval_file_attribute__2) args
...
erlps__eval_file_attr__2 args =
  EXC.badarity (ErlangFun 2 erlps__eval_file_attr__2) args
...
erlps__set_form_file__2 [(ErlangTuple [(ErlangAtom "function"),
  ...
  let
    tup_el_6 =
      BIF.do_remote_fun_call "Erl.Anno" "erlps__set_file__2"
        [file_4, l_0]
  in ErlangTuple [ErlangAtom "function", tup_el_6, n_1, a_2, c_3]
erlps__set_form_file__2 [form_0, _file_1] = form_0
erlps__set_form_file__2 [arg_2, arg_3] = EXC.function_clause unit
erlps__set_form_file__2 args =
  EXC.badarity (ErlangFun 2 erlps__set_form_file__2) args

erlps__set_file__2 :: ErlangFun
erlps__set_file__2 [ts_0, file_1] | isEList ts_0 =
  flmap
    (\ lc_4 ->
       let lcRet_5 = erlps__anno_set_file__2 [lc_4, file_1]
...
erlps__anno_set_file__2 args =
  EXC.badarity (ErlangFun 2 erlps__anno_set_file__2) args
...
erlps__form__2 args =
  EXC.badarity (ErlangFun 2 erlps__form__2) args
  ...
  let   
    anno_7 =
      case form_0 of
        ...
        _ ->
          let arg_5 = toErl 2
          in BIF.erlang__element__2 [arg_5, form_0]
  in let
    st1_11 =
      erlps__add_error__3 [anno_7, ErlangAtom "undefined_module", st_1]
  in let
    arg_13 =
      case st1_11 of
        (ErlangTuple [(ErlangAtom "lint"), state_16, module_17,
...
erlps__start_state__2 [arg_50, arg_51] = EXC.function_clause unit
erlps__start_state__2 args =
  EXC.badarity (ErlangFun 2 erlps__start_state__2) args
...
erlps__attribute_state__2 [(ErlangTuple [(ErlangAtom "attribute"),
  ...
  in let
    record_updt_4 =
      BIF.erlang__op_append [lop_5, ErlangCons head_10 ErlangEmptyList]
  in
    case st_2 of
...
erlps__attribute_state__2 [(ErlangTuple [(ErlangAtom "attribute"),
  ...
  =
  erlps__type_def__6
    [ErlangAtom "opaque", l_0, typename_1, typedef_2, args_3, st_4]
erlps__attribute_state__2 [(ErlangTuple [(ErlangAtom "attribute"),
                                         l_0, (ErlangAtom "spec"),
    ...
    arg_3 =
      case st_1 of
        (ErlangTuple [(ErlangAtom "lint"), state_6, module_7,
                      ...
                      gexpr_context_39]) ->
          ErlangTuple
            [ErlangAtom "lint", ErlangAtom "function", module_7, behaviour_8,
             exports_9, imports_10, compile_11, records_12, locals_13,
             no_auto_14, defined_15, on_load_16, on_load_line_17, clashes_18,
             not_deprecated_19, not_removed_20, func_21, warn_format_22,
             enabled_warnings_23, nowarn_bif_clash_24, errors_25, warnings_26,
             file_27, recdef_top_28, xqlc_29, called_30, usage_31, specs_32,
             callbacks_33, optional_callbacks_34, types_35, exp_types_36,
             in_try_head_37, bvt_38, gexpr_context_39]
        _ -> EXC.badrecord (ErlangAtom "lint")
...
erlps__attribute_state__2 args =
  EXC.badarity (ErlangFun 2 erlps__attribute_state__2) args
...
erlps__bif_clashes__2 [forms_0,
           ...
           case lc_8 of
             (ErlangTuple [(ErlangAtom "function"), _l_4, name_5, arity_6,
               ...
               in
                 case cond_9 of
                   (ErlangAtom "true") ->
                     let lcRet_12 = ErlangTuple [name_5, arity_6]
  ...
  in
    case st_2 of
      ...
      _ -> EXC.badrecord (ErlangAtom "lint")
erlps__bif_clashes__2 [arg_56, arg_57] = EXC.function_clause unit
erlps__bif_clashes__2 args =
  EXC.badarity (ErlangFun 2 erlps__bif_clashes__2) args
                      ...
                      case lc_12 of
                        (ErlangTuple [(ErlangAtom "nowarn_deprecated_function"),
                          ...
                          in
                            flmap
                              (\ lc_18 ->
                                 let lcRet_19 = ErlangTuple [lc_18, l_4]
        ...
        (\ lc_25 ->
           case lc_25 of
             (ErlangTuple [(ErlangAtom "nowarn_deprecated_function"),
               ...
               in flmap (\ lc_31 -> ErlangCons lc_31 ErlangEmptyList) lcSrc_26
             _ -> ErlangEmptyList)
        opts_1
  in let
    ml_45 =
           ...
           case lc_39 of
             (ErlangTuple [(ErlangTuple [m_35, _f_36, _a_37]), l_38]) ->
               ...
               in
                 case cond_40 of
                   (ErlangAtom "true") ->
                     let lcRet_42 = ErlangTuple [m_35, l_38]
...
erlps__not_deprecated__2 args =
  EXC.badarity (ErlangFun 2 erlps__not_deprecated__2) args
...
erlps__not_removed__2 [forms_0,
  ...
  in
    case st1_54 of
      ...
      _ -> EXC.badrecord (ErlangAtom "lint")
erlps__not_removed__2 [arg_92, arg_93] = EXC.function_clause unit
erlps__not_removed__2 args =
  EXC.badarity (ErlangFun 2 erlps__not_removed__2) args
                   ...
                   (\ lc_11 ->
                      case lc_11 of
                        (ErlangTuple [_, l_10]) ->
                          ...
                          in let lcRet_12 = ErlangTuple [tup_el_13, tup_el_17]
                          in ErlangCons lcRet_12 ErlangEmptyList
                        _ -> ErlangEmptyList)
                            ...
                            tup_el_37 =
                              ErlangTuple
                                [l_30, ErlangAtom "erl_lint",
                                 ErlangAtom "disallowed_nowarn_bif_clash"]
                          in let lcRet_32 = ErlangTuple [tup_el_33, tup_el_37]
...
erlps__post_traversal_check__2 [forms_0, st0_1] =
  ...
  in let
    st9_25 = erlps__check_functions_without_spec__2 [forms_0, st8_22]
  in let sta_27 = erlps__check_undefined_types__1 [st9_25]
  in let stb_30 = erlps__check_unused_types__2 [forms_0, sta_27]
  in let stc_33 = erlps__check_untyped_records__2 [forms_0, stb_30]
  in let std_35 = erlps__check_on_load__1 [stc_33]
  in let ste_38 = erlps__check_unused_records__2 [forms_0, std_35]
...
erlps__post_traversal_check__2 args =
  EXC.badarity (ErlangFun 2 erlps__post_traversal_check__2) args
...
erlps__check_behaviour__1 args =
  EXC.badarity (ErlangFun 1 erlps__check_behaviour__1) args

erlps__behaviour_check__2 :: ErlangFun
erlps__behaviour_check__2 [bs_0, st0_1] =
  let
    matchExpr_7 =
      erlps__all_behaviour_callbacks__3 [bs_0, ErlangEmptyList, st0_1]
  in
    case matchExpr_7 of
      (ErlangTuple [allbfs0_5, st1_6]) ->
        let   
          st_10 = erlps__behaviour_missing_callbacks__2 [allbfs0_5, st1_6]
            ...
            ErlangFun 2
              (let
                 lambda_13 [bfs_16, obfs_17] =
                   flmap
                     (\ lc_20 ->
                        let    op_arg_23 = BIF.lists__member__2 [lc_20, obfs_17]
                            ...
                            case lop_22 of
                              ...
                              (ErlangAtom "false") ->
                                BIF.do_remote_fun_call "Gb.Sets"
                                  "erlps__is_member__2" [lc_20, exports_12]
                              _ -> EXC.badarg1 lop_22
                        in
                          case cond_21 of
                            (ErlangAtom "true") ->
                              ErlangCons lc_20 ErlangEmptyList
                            _ -> ErlangEmptyList)
                     bfs_16
              ...
              (\ lc_34 ->
                 case lc_34 of
                   (ErlangTuple [item_31, bfs0_32, obfs0_33]) ->
                     ...
                     in let lcRet_35 = ErlangTuple [item_31, tup_el_37]
...
erlps__behaviour_check__2 args =
  EXC.badarity (ErlangFun 2 erlps__behaviour_check__2) args
...
erlps__all_behaviour_callbacks__3 [(ErlangCons (ErlangTuple [line_0,
  ...
  =
  let
    matchExpr_11 = erlps__behaviour_callbacks__3 [line_0, b_1, st0_4]
  in
...
erlps__all_behaviour_callbacks__3 args =
  EXC.badarity (ErlangFun 3 erlps__all_behaviour_callbacks__3)
    args
    ...
    (\ of_8 ->
       case of_8 of
         (ErlangAtom "undefined") ->
           let   
             arg_12 =
               ErlangTuple [ErlangAtom "undefined_behaviour_callbacks", b_1]
           in let st1_16 = erlps__add_warning__3 [line_0, arg_12, st0_2]
           in ErlangTuple [ErlangEmptyList, ErlangEmptyList, st1_16]
         funcs_20 ->
           let case_21 = erlps__is_fa_list__1 [funcs_20]
           in
             case case_21 of
               (ErlangAtom "true") ->
                 EXC.tryOfCatch
                   ...
                   (\ of_28 ->
                      case of_28 of
                        (ErlangAtom "undefined") ->
                          ErlangTuple [funcs_20, ErlangEmptyList, st0_2]
                        optfuncs_34 ->
                          let case_35 = erlps__is_fa_list__1 [optfuncs_34]
                          in
                            case case_35 of
                              (ErlangAtom "true") ->
                                ErlangTuple [funcs_20, optfuncs_34, st0_2]
                              (ErlangAtom "false") ->
                                let   
                                  w_42 =
                                    ErlangTuple
                                ...
                                in let
                                  st1_46 =
                                    erlps__add_warning__3 [line_0, w_42, st0_2]
                                in
                                  ErlangTuple
                                    [funcs_20, ErlangEmptyList, st1_46]
                              something_else -> EXC.case_clause something_else)
                   (\ ex_29 ->
                      case ex_29 of
                        (ErlangTuple [_, _, _]) ->
               ...
               (ErlangAtom "false") ->
                 ...
                 in let st1_58 = erlps__add_warning__3 [line_0, arg_54, st0_2]
                 in ErlangTuple [ErlangEmptyList, ErlangEmptyList, st1_58]
               something_else -> EXC.case_clause something_else)
    (\ ex_9 ->
       case ex_9 of
         (ErlangTuple [_, _, _]) ->
           let   
             arg_63 = ErlangTuple [ErlangAtom "undefined_behaviour", b_1]
           in let st1_67 = erlps__add_warning__3 [line_0, arg_63, st0_2]
           in let st2_71 = erlps__check_module_name__3 [b_1, line_0, st1_67]
           in ErlangTuple [ErlangEmptyList, ErlangEmptyList, st2_71]
         ex_10 -> EXC.raise ex_10)
erlps__behaviour_callbacks__3 [arg_75, arg_76, arg_77] =
  EXC.function_clause unit
erlps__behaviour_callbacks__3 args =
  EXC.badarity (ErlangFun 3 erlps__behaviour_callbacks__3) args
...
erlps__behaviour_missing_callbacks__2 args =
  EXC.badarity (ErlangFun 2 erlps__behaviour_missing_callbacks__2)
    args
      ...
      ErlangFun 1
        (let
           lambda_18 [s_20] =
             ...
             in BIF.erlang__op_greater [lop_21, rop_23]
...
erlps__behaviour_conflicting__2 args =
  EXC.badarity (ErlangFun 2 erlps__behaviour_conflicting__2) args
...
erlps__behaviour_add_conflicts__2 [(ErlangCons (ErlangTuple [cb_0,
  ...
  =
  let    arg_6 = toErl 2
  in let arg_7 = erlps__loc__2 [firstloc_1, st0_5]
  in let firstl_10 = BIF.erlang__element__2 [arg_6, arg_7]
  in let
    st_16 =
...
erlps__behaviour_add_conflicts__2 args =
  EXC.badarity (ErlangFun 2 erlps__behaviour_add_conflicts__2)
    args
...
erlps__behaviour_add_conflict__5 args =
  EXC.badarity (ErlangFun 5 erlps__behaviour_add_conflict__5) args
...
erlps__check_deprecated__2 [forms_0, st0_1] =
  let   
    arg_4 =
      case st0_1 of
        ...
        _ -> EXC.badrecord (ErlangAtom "lint")
  in let
    case_2 = BIF.lists__member__2 [ErlangAtom "export_all", arg_4]
  in let
    exports_14 =
      case case_2 of
        (ErlangAtom "true") ->
          case st0_1 of
            (ErlangTuple arr_10) | (DM.Just field_9) <- (arr_10 DA.!! 10) ->
              field_9
            _ -> EXC.badrecord (ErlangAtom "lint")
        (ErlangAtom "false") ->
          case st0_1 of
  ...
  in let
    arg_15 =
      BIF.do_remote_fun_call "Gb.Sets" "erlps__to_list__1" [exports_14]
                     ...
                     in
                       flmap
                         (\ lc_29 ->
                            let
                              lcSrc_30 =
                                erlps__depr_cat__3 [lc_29, x_17, mod_18]
                            in
                              flmap
                                (\ lc_35 ->
                                   let lcRet_36 = ErlangTuple [lc_35, l_21]
...
erlps__check_deprecated__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_deprecated__2) args
...
erlps__depr_cat__3 [d_3@(ErlangTuple [f_0, a_1, flg_2]), x_4,
  ...
  in
    case case_6 of
      (ErlangAtom "false") ->
        let head_8 = ErlangTuple [ErlangAtom "invalid_deprecated", d_3]
...
erlps__depr_cat__3 [d_0, _x_1, _mod_2] =
  let head_3 = ErlangTuple [ErlangAtom "invalid_deprecated", d_0]
  in ErlangCons head_3 ErlangEmptyList
erlps__depr_cat__3 [arg_7, arg_8, arg_9] =
  EXC.function_clause unit
erlps__depr_cat__3 args =
  EXC.badarity (ErlangFun 3 erlps__depr_cat__3) args
  ...
  in
    case case_3 of
      (ErlangEmptyList) ->
        ...
        in let
          head_11 = ErlangTuple [ErlangAtom "bad_deprecated", tup_el_13]
        in ErlangCons head_11 ErlangEmptyList
      _ -> ErlangEmptyList
erlps__depr_fa__4 [f_0, a_1, x_2, mod_3]
  | ((isEAtom f_0) && (isEInt a_1)) && (weakGeq a_1 (toErl 0)) =
        ...
        in
          case case_9 of
            ...
            (ErlangAtom "false") ->
              ...
              in let
                head_13 = ErlangTuple [ErlangAtom "bad_deprecated", tup_el_15]
...
erlps__depr_fa__4 [f_0, a_1, _x_2, _mod_3] =
  ...
  in let
    head_4 = ErlangTuple [ErlangAtom "invalid_deprecated", tup_el_6]
  in ErlangCons head_4 ErlangEmptyList
erlps__depr_fa__4 [arg_10, arg_11, arg_12, arg_13] =
  EXC.function_clause unit
erlps__depr_fa__4 args =
  EXC.badarity (ErlangFun 4 erlps__depr_fa__4) args
...
erlps__deprecated_desc__1 args =
  EXC.badarity (ErlangFun 1 erlps__deprecated_desc__1) args
                     ...
                     in
                       flmap
                         (\ lc_29 ->
                            let
                              lcSrc_30 =
                                erlps__removed_cat__3 [lc_29, x_17, mod_18]
                            in
                              flmap
                                (\ lc_35 ->
                                   let lcRet_36 = ErlangTuple [lc_35, l_21]
...
erlps__check_removed__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_removed__2) args
...
erlps__removed_cat__3 [(ErlangAtom "module"), x_0, mod_1] =
  erlps__removed_fa__4 [ErlangAtom "_", ErlangAtom "_", x_0, mod_1]
...
erlps__removed_cat__3 args =
  EXC.badarity (ErlangFun 3 erlps__removed_cat__3) args
...
erlps__removed_fa__4 [(ErlangAtom "_"), (ErlangAtom "_"), x_0,
  ...
  case x_0 of
    (ErlangCons _ _) ->
      let    tup_el_5 = ErlangTuple [ErlangAtom "_", ErlangAtom "_"]
      in let head_3 = ErlangTuple [ErlangAtom "bad_removed", tup_el_5]
      in ErlangCons head_3 ErlangEmptyList
  ...
  in
    case case_4 of
      (ErlangAtom "true") ->
        ...
        in let head_9 = ErlangTuple [ErlangAtom "bad_removed", tup_el_11]
...
erlps__removed_fa__4 args =
  EXC.badarity (ErlangFun 4 erlps__removed_fa__4) args
...
erlps__removed_desc__1 args =
  EXC.badarity (ErlangFun 1 erlps__removed_desc__1) args
...
erlps__ignore_predefined_funcs__1 args =
  EXC.badarity (ErlangFun 1 erlps__ignore_predefined_funcs__1)
    args
    ...
    case case_2 of
      ...
      (ErlangAtom "true") ->
        ...
        in let
          arg_9 =
            case st0_1 of
              (ErlangTuple arr_12) | (DM.Just field_11) <- (arr_12 DA.!! 5) ->
                field_11
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let
          arg_13 =
            case usage_8 of
              (ErlangTuple arr_16) | (DM.Just field_15) <- (arr_16 DA.!! 2) ->
                field_15
                 ...
                 case lc_22 of
                   (ErlangTuple [(ErlangAtom "attribute"), l_19,
                     ...
                     in
                       flmap
                         (\ lc_26 ->
                            let    tup_el_28 = ErlangTuple [lc_26, mod_20]
                            in let lcRet_27 = ErlangTuple [tup_el_28, l_19]
                   ...
                   (\ lc_39 ->
                      case lc_39 of
                        (ErlangTuple [fm2_37, l_38]) ->
                          let cond_40 = BIF.erlang__op_exactEq [lc_35, fm2_37]
                          in
                            case cond_40 of
                              (ErlangAtom "true") ->
                                let lcRet_43 = ErlangTuple [lc_35, l_38]
...
erlps__check_imports__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_imports__2) args

erlps__check_inlines__2 :: ErlangFun
erlps__check_inlines__2 [forms_0, st0_1] =
  erlps__check_option_functions__4
    [forms_0, ErlangAtom "inline", ErlangAtom "bad_inline", st0_1]
erlps__check_inlines__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__check_inlines__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_inlines__2) args
  ...
  in let
    opts_10 =
      case st1_6 of
        ...
        _ -> EXC.badrecord (ErlangAtom "lint")
  in let
    lop_12 = BIF.lists__member__2 [ErlangAtom "export_all", opts_10]
  in let
    case_11 =
      case lop_12 of
        (ErlangAtom "true") -> ErlangAtom "true"
        (ErlangAtom "false") ->
          let
            op_arg_15 =
              erlps__is_warn_enabled__2 [ErlangAtom "unused_function", st1_6]
    ...
    case case_11 of
      ...
      (ErlangAtom "false") ->
        ...
        in let
          usage_24 =
            case st1_6 of
              (ErlangTuple arr_23) | (DM.Just field_22) <- (arr_23 DA.!! 26) ->
                field_22
              _ -> EXC.badrecord (ErlangAtom "lint")
        ...
        in let
          arg_27 =
            case usage_24 of
              (ErlangTuple arr_30) | (DM.Just field_29) <- (arr_30 DA.!! 1) ->
                field_29
              _ -> EXC.badrecord (ErlangAtom "usage")
        ...
        in let
          arg_36 =
            case st1_6 of
              (ErlangTuple arr_39) | (DM.Just field_38) <- (arr_39 DA.!! 10) ->
                field_38
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let
          arg_35 =
              ...
              (\ lc_46 ->
                 case lc_46 of
                   (ErlangTuple [(ErlangAtom "function"), l_43, n_44, a_45,
                     ...
                     in let lcRet_47 = ErlangTuple [tup_el_48, l_43]
                   ...
                   (\ lc_59 ->
                      case lc_59 of
                        (ErlangTuple [fa2_57, l_58]) ->
                          let cond_60 = BIF.erlang__op_exactEq [lc_55, fa2_57]
                          in
                            case cond_60 of
                              (ErlangAtom "true") ->
                                let lcRet_63 = ErlangTuple [lc_55, l_58]
...
erlps__check_unused_functions__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_unused_functions__2) args
...
erlps__initially_reached__1 args =
  EXC.badarity (ErlangFun 1 erlps__initially_reached__1) args

erlps__reached_functions__2 :: ErlangFun
erlps__reached_functions__2 [root_0, ref_1] =
  let arg_5 = BIF.do_remote_fun_call "Gb.Sets" "erlps__empty__0" []
  in
...
erlps__reached_functions__2 args =
  EXC.badarity (ErlangFun 2 erlps__reached_functions__2) args
...
erlps__reached_functions__4 [(ErlangEmptyList),
  ...
  =
  BIF.do_remote_fun_call "Gb.Sets" "erlps__to_list__1" [reached_1]
erlps__reached_functions__4 [arg_3, arg_4, arg_5, arg_6] =
  EXC.function_clause unit
erlps__reached_functions__4 args =
  EXC.badarity (ErlangFun 4 erlps__reached_functions__4) args
...
erlps__check_undefined_functions__1 [st0_2@(ErlangTuple [(ErlangAtom "lint"),
  ...
  =
  let   
    head_5 = ErlangTuple [ErlangAtom "func", ErlangAtom "location"]
  in let
    called_9 =
      BIF.do_remote_fun_call "Sofs" "erlps__relation__2"
      ...
      ErlangFun 2
        (let
           lambda_21 [(ErlangTuple [na_24, l_25]), st_26] =
             let arg_28 = ErlangTuple [ErlangAtom "undefined_function", na_24]
...
erlps__check_undefined_functions__1 args =
  EXC.badarity (ErlangFun 1 erlps__check_undefined_functions__1)
    args
...
erlps__check_undefined_types__1 [st0_2@(ErlangTuple [(ErlangAtom "lint"),
  ...
  in let
    undef_24 =
      flmap
        (\ lc_11 ->
           let    op_arg_13 = BIF.erlang__is_map_key__2 [lc_11, def_1]
           in let cond_12 = BIF.erlang__not__1 [op_arg_13]
           in
             case cond_12 of
               (ErlangAtom "true") ->
                 let    op_arg_17 = erlps__is_default_type__1 [lc_11]
                 in let cond_16 = BIF.erlang__not__1 [op_arg_17]
                 in
                   case cond_16 of
                     (ErlangAtom "true") ->
                       let    tup_el_21 = BIF.erlang__map_get__2 [lc_11, used_6]
                       in let lcRet_19 = ErlangTuple [lc_11, tup_el_21]
                       in ErlangCons lcRet_19 ErlangEmptyList
                     _ -> ErlangEmptyList
               _ -> ErlangEmptyList)
        utas_8
...
erlps__check_undefined_types__1 args =
  EXC.badarity (ErlangFun 1 erlps__check_undefined_types__1) args
...
erlps__check_bif_clashes__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_bif_clashes__2) args
...
erlps__check_option_functions__4 [forms_0, tag0_1, type_2, st0_3]
                   ...
                   (\ lc_14 ->
                      case lc_14 of
                        (ErlangTuple [tag_12, fas0_13]) ->
                          let cond_15 = BIF.erlang__op_exactEq [tag0_1, tag_12]
                          in
                            case cond_15 of
                              (ErlangAtom "true") ->
                                let
                                ...
                                in
                                  flmap
                                    (\ lc_23 ->
                                       let lcRet_24 = ErlangTuple [lc_23, l_5]
  ...
  in let
    arg_30 =
      case st0_3 of
        (ErlangTuple arr_33) | (DM.Just field_32) <- (arr_33 DA.!! 10) ->
          field_32
        _ -> EXC.badrecord (ErlangAtom "lint")
  in let
    lop_29 =
  ...
  in let
    arg_37 =
      case st0_3 of
        (ErlangTuple arr_40) | (DM.Just field_39) <- (arr_40 DA.!! 5) ->
          field_39
        _ -> EXC.badrecord (ErlangAtom "lint")
  in let
    lcSrc_36 =
        ...
        (\ lc_43 ->
           case lc_43 of
             (ErlangTuple [(ErlangTuple [f_41, a_42]), _]) ->
               let lcRet_44 = ErlangTuple [f_41, a_42]
        ...
        (\ lc_51 ->
           case lc_51 of
             (ErlangTuple [fa_49, l_50]) ->
               let    op_arg_53 = BIF.lists__member__2 [fa_49, deffunctions_47]
               in let cond_52 = BIF.erlang__not__1 [op_arg_53]
               in
                 case cond_52 of
                   (ErlangAtom "true") ->
                     let lcRet_56 = ErlangTuple [fa_49, l_50]
...
erlps__check_option_functions__4 args =
  EXC.badarity (ErlangFun 4 erlps__check_option_functions__4) args
               ...
               in
                 case cond_7 of
                   (ErlangAtom "true") ->
                     ...
                     in
                       flmap (\ lc_15 -> ErlangCons lc_15 ErlangEmptyList)
                         lcSrc_10
                   _ -> ErlangEmptyList
             _ -> ErlangEmptyList)
        opts_1
  in BIF.do_remote_fun_call "Ordsets" "erlps__from_list__1" [arg_2]
erlps__nowarn_function__2 [arg_17, arg_18] =
  EXC.function_clause unit
erlps__nowarn_function__2 args =
  EXC.badarity (ErlangFun 2 erlps__nowarn_function__2) args
...
erlps__func_line_warning__3 args =
  EXC.badarity (ErlangFun 3 erlps__func_line_warning__3) args
...
erlps__func_line_error__3 args =
  EXC.badarity (ErlangFun 3 erlps__func_line_error__3) args

erlps__check_untyped_records__2 :: ErlangFun
erlps__check_untyped_records__2 [forms_0, st0_1] =
  let
    case_2 =
      erlps__is_warn_enabled__2 [ErlangAtom "untyped_record", st0_1]
  in
    case case_2 of
      (ErlangAtom "true") ->
        let   
                     ...
                     arg_28 =
                       case st0_1 of
                         (ErlangTuple arr_31) | (DM.Just field_30) <-
                           ...
                           field_30
                         _ -> EXC.badrecord (ErlangAtom "lint")
                   in let matchExpr_34 = BIF.erlang__map_get__2 [n_25, arg_28]
                   in
                       ...
                       (ErlangTuple [l_32, fields_33]) ->
                         case fields_33 of
                           ...
                           (ErlangCons _ _) ->
                             let
                               arg_37 =
                                 ErlangTuple [ErlangAtom "untyped_record", n_25]
...
erlps__check_untyped_records__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_untyped_records__2) args
    ...
    case case_9 of
      (ErlangTuple [(ErlangAtom "true"),
        ...
        let   
          usage_18 =
            case st0_1 of
              (ErlangTuple arr_17) | (DM.Just field_16) <- (arr_17 DA.!! 26) ->
                field_16
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let
          usedrecords_22 =
            case usage_18 of
              (ErlangTuple arr_21) | (DM.Just field_20) <- (arr_21 DA.!! 3) ->
                field_20
              _ -> EXC.badrecord (ErlangAtom "usage")
        in let
          arg_23 =
        ...
        in let
          arg_31 =
            case st0_1 of
              (ErlangTuple arr_34) | (DM.Just field_33) <- (arr_34 DA.!! 7) ->
                field_33
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let
          urecs_36 =
        ...
        in let lcSrc_37 = BIF.maps__to_list__1 [urecs_36]
        in let
          unused_53 =
            flmap
              (\ lc_42 ->
                 case lc_42 of
                   (ErlangTuple [name_39,
                     ...
                     let    arg_45 = toErl 1
                     in let arg_46 = erlps__loc__2 [fileline_40, st0_1]
                     in let lop_44 = BIF.erlang__element__2 [arg_45, arg_46]
                     in let
                       cond_43 = BIF.erlang__op_exactEq [lop_44, firstfile_14]
                     in
                       case cond_43 of
                         (ErlangAtom "true") ->
                           let lcRet_50 = ErlangTuple [name_39, fileline_40]
            ...
            ErlangFun 2
              (let
                 lambda_55 [(ErlangTuple [n_58, l_59]), st_60] =
                   let arg_62 = ErlangTuple [ErlangAtom "unused_record", n_58]
...
erlps__check_unused_records__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_unused_records__2) args
...
erlps__check_callback_information__1 [st0_3@(ErlangTuple [(ErlangAtom "lint"),
  ...
  in let
    arg_25 = ErlangTuple [ErlangAtom "behaviour_info", tup_el_27]
  in let
    case_24 =
  ...
  in
    case case_24 of
      ...
      (ErlangAtom "true") ->
        ...
        in
          case case_29 of
            (ErlangInt num_31) | (ErlangInt num_31) == (toErl 0) -> st1_23
            _ ->
              let
                foldfun_44 =
                  ErlangFun 3
                    (let
                       lambda_32 [fa_36, line_37, st_38] =
                         let
                           arg_40 =
                             ErlangTuple [ErlangAtom "behaviour_info", fa_36]
...
erlps__check_callback_information__1 args =
  EXC.badarity (ErlangFun 1 erlps__check_callback_information__1)
    args
          ...
          (ErlangTuple [(ErlangAtom "lint"), state_44, module_45,
            ...
            ErlangTuple
              [ErlangAtom "lint", state_44, module_45, behaviour_46, es1_37,
               ...
               enabled_warnings_61, nowarn_bif_clash_62, errors_63, warnings_64,
               file_65, recdef_top_66, xqlc_67, c1_38, usage_69, specs_70,
               callbacks_71, optional_callbacks_72, types_73, exp_types_74,
               in_try_head_75, bvt_76, gexpr_context_77]
          _ -> EXC.badrecord (ErlangAtom "lint")
      _ -> EXC.badmatch matchExpr_40
erlps__export__3 [arg_78, arg_79, arg_80] =
  EXC.function_clause unit
erlps__export__3 args =
  EXC.badarity (ErlangFun 3 erlps__export__3) args
...
erlps__export_type__3 [line_0, ets_1,
  ...
  in
    EXC.tryOfCatch
                        ...
                        case case_19 of
                          (ErlangAtom "true") ->
                            let
                              warn_24 =
                                ErlangTuple
                                  [ErlangAtom "duplicated_export_type", ta_15]
                            in erlps__add_warning__3 [line_0, warn_24, st2_18]
      ...
      (\ of_42 ->
         case of_42 of
           (ErlangTuple [ets1_45, uts1_46, st1_47]) ->
             let
               record_updt_49 =
                 case usage_2 of
                   (ErlangTuple [(ErlangAtom "usage"), calls_52, imported_53,
                                 used_records_54, used_types_55]) ->
                     ErlangTuple
                       [ErlangAtom "usage", calls_52, imported_53,
                        used_records_54, uts1_46]
                   _ -> EXC.badrecord (ErlangAtom "usage")
             in
               case st1_47 of
                 (ErlangTuple [(ErlangAtom "lint"), state_57, module_58,
                               behaviour_59, exports_60, imports_61, compile_62,
                               records_63, locals_64, no_auto_65, defined_66,
                               on_load_67, on_load_line_68, clashes_69,
                               not_deprecated_70, not_removed_71, func_72,
                               warn_format_73, enabled_warnings_74,
                               nowarn_bif_clash_75, errors_76, warnings_77,
                               file_78, recdef_top_79, xqlc_80, called_81,
                               usage_82, specs_83, callbacks_84,
                               optional_callbacks_85, types_86, exp_types_87,
                               in_try_head_88, bvt_89, gexpr_context_90]) ->
                   ErlangTuple
                     [ErlangAtom "lint", state_57, module_58, behaviour_59,
                      exports_60, imports_61, compile_62, records_63, locals_64,
                      no_auto_65, defined_66, on_load_67, on_load_line_68,
                      clashes_69, not_deprecated_70, not_removed_71, func_72,
                      warn_format_73, enabled_warnings_74, nowarn_bif_clash_75,
                      errors_76, warnings_77, file_78, recdef_top_79, xqlc_80,
                      called_81, record_updt_49, specs_83, callbacks_84,
                      optional_callbacks_85, types_86, ets1_45, in_try_head_88,
                      bvt_89, gexpr_context_90]
                 _ -> EXC.badrecord (ErlangAtom "lint")
           something_else -> EXC.try_clause something_else)
      (\ ex_43 ->
         case ex_43 of
           (ErlangTuple [(ErlangAtom "error"), _, _]) ->
             let arg_92 = ErlangTuple [ErlangAtom "bad_export_type", ets_1]
             in erlps__add_error__3 [line_0, arg_92, st0_4]
           ex_44 -> EXC.raise ex_44)
erlps__export_type__3 [arg_96, arg_97, arg_98] =
  EXC.function_clause unit
erlps__export_type__3 args =
  EXC.badarity (ErlangFun 3 erlps__export_type__3) args
...
erlps__exports__1 [(ErlangTuple [(ErlangAtom "lint"), _, _, _,
  ...
  =
  let
    case_3 = BIF.lists__member__2 [ErlangAtom "export_all", opts_1]
  in
    case case_3 of
...
erlps__exports__1 args =
  EXC.badarity (ErlangFun 1 erlps__exports__1) args

erlps__import__3 :: ErlangFun
erlps__import__3 [line_0, (ErlangTuple [mod_1, fs_2]), st00_3] =
  let    st_7 = erlps__check_module_name__3 [mod_1, line_0, st00_3]
  in let
    mfs_9 =
  ...
  in let
    arg_13 =
      case st_7 of
        (ErlangTuple arr_16) | (DM.Just field_15) <- (arr_16 DA.!! 5) ->
          field_15
        _ -> EXC.badrecord (ErlangAtom "lint")
  in let case_10 = erlps__check_imports__3 [line_0, mfs_9, arg_13]
  in
    case case_10 of
      (ErlangEmptyList) ->
        let   
          arg_21 =
            case st_7 of
              (ErlangTuple arr_24) | (DM.Just field_23) <- (arr_24 DA.!! 5) ->
                field_23
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let
      ...
      efs_59 ->
            ...
            ErlangFun 2
              (let
                 lambda_61 [(ErlangTuple [(ErlangAtom "bif"),
                   ...
                   in let
                     oldbif_87 =
                       BIF.do_remote_fun_call "Erl.Internal" "erlps__old_bif__2"
                         [f_64, a_65]
                   in let
                     tup_el_89 =
                       case ErlangAtom "true" of
                         ...
                         _ | (ErlangAtom "true") ==
                           ...
                           in let
                             arg_106 =
                               ErlangTuple
                                 [ErlangAtom "redefine_bif_import", tup_el_108]
                 ...
                 lambda_61 [ef_112, (ErlangTuple [_err_113, st0_114])] =
                   ...
                   in let
                     tup_el_116 = erlps__add_error__3 [line_0, arg_118, st0_114]
        ...
        in
          case matchExpr_128 of
            (ErlangTuple [err_126, st1_127]) ->
              case ErlangAtom "true" of
                _ | (ErlangAtom "true") ==
                      (falsifyErrors (\ _ -> BIF.erlang__not__1 [err_126])) ->
                  let   
                    arg_134 =
                      case st_7 of
                  ...
                  in
                    case st1_127 of
                      ...
                      _ -> EXC.badrecord (ErlangAtom "lint")
                _ -> st1_127
            _ -> EXC.badmatch matchExpr_128
erlps__import__3 [arg_172, arg_173, arg_174] =
  EXC.function_clause unit
erlps__import__3 args =
  EXC.badarity (ErlangFun 3 erlps__import__3) args
                         ...
                         case case_20 of
                           (ErlangAtom "true") ->
                             let
                               head_23 =
                                 ErlangTuple
                                   [ErlangAtom "bif", f_7, ErlangAtom "erlang"]
...
erlps__check_imports__3 args =
  EXC.badarity (ErlangFun 3 erlps__check_imports__3) args
...
erlps__add_imports__3 args =
  EXC.badarity (ErlangFun 3 erlps__add_imports__3) args
...
erlps__imported__3 [f_0, a_1, st_2] =
  ...
  in let
    case_3 =
      BIF.do_remote_fun_call "Orddict" "erlps__find__2" [arg_4, arg_7]
  in
    case case_3 of
...
erlps__imported__3 args =
  EXC.badarity (ErlangFun 3 erlps__imported__3) args
  ...
  in
    case st_45 of
      (ErlangTuple [(ErlangAtom "lint"), _, _, _, _, _, _, _, _, _, _,
                    ...
                    _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,
                    _, _, _]) | (ErlangInt num_47) == (toErl 0) ->
        st_45
      (ErlangTuple [(ErlangAtom "lint"), _, _, _, _, _, _, _, _, _, _,
                    (ErlangCons (ErlangTuple [_, _]) (ErlangEmptyList)), _, _,
                    _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _,
                    _]) ->
        let arg_49 = ErlangTuple [ErlangAtom "bad_on_load_arity", fa_3]
...
erlps__on_load__3 args =
  EXC.badarity (ErlangFun 3 erlps__on_load__3) args
...
erlps__check_on_load__1 [st_4@(ErlangTuple [(ErlangAtom "lint"),
  ...
  in
    case case_5 of
      ...
      (ErlangAtom "false") ->
        let arg_9 = ErlangTuple [ErlangAtom "undefined_on_load", fa_2]
...
erlps__check_on_load__1 args =
  EXC.badarity (ErlangFun 1 erlps__check_on_load__1) args
      ...
      in let
        usage_23 =
          case cs_8 of
            ...
            _ ->
              let record_updt_15 = erlps__maps_prepend__3 [func_3, na_12, cs_8]
              in
                case usage0_6 of
          ...
          (ErlangTuple [(ErlangAtom "lint"), state_34, module_35,
            ...
            ErlangTuple
              [ErlangAtom "lint", state_34, module_35, behaviour_36,
               ...
               enabled_warnings_51, nowarn_bif_clash_52, errors_53, warnings_54,
               file_55, recdef_top_56, xqlc_57, ErlangCons head_29 cd_5,
               usage_23, specs_60, callbacks_61, optional_callbacks_62,
               types_63, exp_types_64, in_try_head_65, bvt_66, gexpr_context_67]
          _ -> EXC.badrecord (ErlangAtom "lint")
    _ -> EXC.badmatch usage0_6
erlps__call_function__4 [arg_68, arg_69, arg_70, arg_71] =
  EXC.function_clause unit
erlps__call_function__4 args =
  EXC.badarity (ErlangFun 4 erlps__call_function__4) args
    ...
    st1_43 =
      case st0_4 of
        (ErlangTuple [(ErlangAtom "lint"), state_9, module_10,
                      ...
                      gexpr_context_42]) ->
          ErlangTuple
            [ErlangAtom "lint", state_9, module_10, behaviour_11, exports_12,
             imports_13, compile_14, records_15, locals_16, no_auto_17,
             defined_18, on_load_19, on_load_line_20, clashes_21,
...
erlps__function__5 args =
  EXC.badarity (ErlangFun 5 erlps__function__5) args

erlps__define_function__4 :: ErlangFun
erlps__define_function__4 [line_0, name_1, arity_2, st0_3] =
  let    st1_7 = erlps__keyword_warning__3 [line_0, name_1, st0_3]
  in let na_10 = ErlangTuple [name_1, arity_2]
  in let
    arg_13 =
      case st1_7 of
        (ErlangTuple arr_16) | (DM.Just field_15) <- (arr_16 DA.!! 10) ->
          field_15
        _ -> EXC.badrecord (ErlangAtom "lint")
  in let
    case_11 =
  ...
  in
    case case_11 of
      (ErlangAtom "true") ->
        let arg_18 = ErlangTuple [ErlangAtom "redefine_function", na_10]
      ...
      (ErlangAtom "false") ->
        ...
        in let
          arg_29 =
            case st2_25 of
              (ErlangTuple arr_32) | (DM.Just field_31) <- (arr_32 DA.!! 10) ->
                field_31
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let
          record_updt_27 =
...
erlps__define_function__4 args =
  EXC.badarity (ErlangFun 4 erlps__define_function__4) args

erlps__function_check_max_args__3 :: ErlangFun
erlps__function_check_max_args__3 [line_0, arity_1, st_2]
  | weakGt arity_1 (toErl 255) =
  let
    arg_4 = ErlangTuple [ErlangAtom "too_many_arguments", arity_1]
  in erlps__add_error__3 [line_0, arg_4, st_2]
...
erlps__function_check_max_args__3 args =
  EXC.badarity (ErlangFun 3 erlps__function_check_max_args__3)
    args
  ...
  let
    arg_2 =
      ErlangFun 2
        (let
           lambda_3 [c_6, st0_7] =
             let matchExpr_11 = erlps__clause__2 [c_6, st0_7]
             in
               case matchExpr_11 of
...
erlps__clauses__2 args =
  EXC.badarity (ErlangFun 2 erlps__clauses__2) args
...
erlps__clause__2 [(ErlangTuple [(ErlangAtom "clause"), _line_0,
                  ...
                  st0_4]
  =
  let matchExpr_12 = erlps__head__3 [h_1, ErlangEmptyList, st0_4]
  in
    case matchExpr_12 of
      (ErlangTuple [hvt_9, hnew_10, st1_11]) ->
        ...
        in let matchExpr_23 = erlps__guard__3 [g_2, vt1_17, st1_11]
        in
          case matchExpr_23 of
            (ErlangTuple [gvt_21, st2_22]) ->
              let    vt2_26 = erlps__vtupdate__2 [gvt_21, vt1_17]
              in let matchExpr_32 = erlps__exprs__3 [b_3, vt2_26, st2_22]
              in
                case matchExpr_32 of
...
erlps__clause__2 args =
  EXC.badarity (ErlangFun 2 erlps__clause__2) args
...
erlps__head__3 args =
  EXC.badarity (ErlangFun 3 erlps__head__3) args

erlps__head__4 :: ErlangFun
erlps__head__4 [(ErlangCons p_0 ps_1), vt_2, old_3, st0_4] =
  let matchExpr_12 = erlps__pattern__4 [p_0, vt_2, old_3, st0_4]
  in
    case matchExpr_12 of
      (ErlangTuple [pvt_9, pnew_10, st1_11]) ->
        let matchExpr_20 = erlps__head__4 [ps_1, vt_2, old_3, st1_11]
        in
          case matchExpr_20 of
...
erlps__head__4 [arg_6, arg_7, arg_8, arg_9] =
  EXC.function_clause unit
erlps__head__4 args =
  EXC.badarity (ErlangFun 4 erlps__head__4) args
...
erlps__pattern__3 args =
  EXC.badarity (ErlangFun 3 erlps__pattern__3) args
...
erlps__pattern__4 [(ErlangTuple [(ErlangAtom "cons"), _line_0,
                   ...
                   vt_3, old_4, st0_5]
  =
  let matchExpr_13 = erlps__pattern__4 [h_1, vt_3, old_4, st0_5]
  in
    case matchExpr_13 of
      (ErlangTuple [hvt_10, hnew_11, st1_12]) ->
        let matchExpr_21 = erlps__pattern__4 [t_2, vt_3, old_4, st1_12]
        in
...
erlps__pattern__4 [(ErlangTuple [(ErlangAtom "record"), line_0,
  ...
  let   
    arg_8 =
      case st_5 of
        (ErlangTuple arr_11) | (DM.Just field_10) <- (arr_11 DA.!! 7) ->
          field_10
        _ -> EXC.badrecord (ErlangAtom "lint")
...
erlps__pattern__4 [(ErlangTuple [(ErlangAtom "op"), _line_0,
  ...
  let
    arg_9 =
      ErlangTuple [ErlangAtom "op", li_1, ErlangAtom "++", t_4, r_5]
...
erlps__pattern__4 [(ErlangTuple [(ErlangAtom "match"), _line_0,
                   ...
                   vt_3, old_4, st0_5]
  =
  let matchExpr_13 = erlps__pattern__4 [pat1_1, vt_3, old_4, st0_5]
  in
    case matchExpr_13 of
      (ErlangTuple [lvt_10, lnew_11, st1_12]) ->
        let
          matchExpr_21 = erlps__pattern__4 [pat2_2, vt_3, old_4, st1_12]
        in
          case matchExpr_21 of
            (ErlangTuple [rvt_18, rnew_19, st2_20]) ->
              let   
                st3_26 =
                  erlps__reject_invalid_alias__4 [pat1_1, pat2_2, vt_3, st2_20]
...
erlps__pattern__4 [pat_0, _vt_1, _old_2, st_3] =
  ...
  in
    case case_4 of
      ...
      (ErlangAtom "false") ->
        let    arg_13 = toErl 2
        in let arg_12 = BIF.erlang__element__2 [arg_13, pat_0]
        in let
          tup_el_11 =
            erlps__add_error__3 [arg_12, ErlangAtom "illegal_pattern", st_3]
...
erlps__pattern__4 args =
  EXC.badarity (ErlangFun 4 erlps__pattern__4) args
      ...
      ErlangFun 2
        (let
           lambda_5 [p_8, (ErlangTuple [psvt_9, psnew_10, st0_11])] =
             let matchExpr_19 = erlps__pattern__4 [p_8, vt_1, old_2, st0_11]
             in
               case matchExpr_19 of
                 (ErlangTuple [pvt_16, pnew_17, st1_18]) ->
                   let    tup_el_20 = erlps__vtmerge_pat__2 [pvt_16, psvt_9]
                   in let tup_el_23 = erlps__vtmerge_pat__2 [psnew_10, pnew_17]
...
erlps__pattern_list__4 args =
  EXC.badarity (ErlangFun 4 erlps__pattern_list__4) args
...
erlps__check_multi_field_init__4 args =
  EXC.badarity (ErlangFun 4 erlps__check_multi_field_init__4) args
...
erlps__reject_invalid_alias_expr__4 args =
  EXC.badarity (ErlangFun 4 erlps__reject_invalid_alias_expr__4)
    args
...
erlps__reject_invalid_alias__4 [(ErlangTuple [(ErlangAtom "cons"),
  ...
  =
  let
    st_10 = erlps__reject_invalid_alias__4 [h1_0, h2_2, vt_4, st0_5]
...
erlps__reject_invalid_alias__4 args =
  EXC.badarity (ErlangFun 4 erlps__reject_invalid_alias__4) args
...
erlps__reject_invalid_alias_list__4 [(ErlangCons e1_0 es1_1),
  ...
  =
  let
    st_10 = erlps__reject_invalid_alias__4 [e1_0, e2_2, vt_4, st0_5]
  in
...
erlps__reject_invalid_alias_list__4 args =
  EXC.badarity (ErlangFun 4 erlps__reject_invalid_alias_list__4)
    args
...
erlps__reject_invalid_alias_rec__6 [pfsa0_0, pfsb0_1, fieldsa0_2,
  ...
  in let
    fieldsa1_14 =
      erlps__rbia_fields__3 [arg_10, arg_12, ErlangEmptyList]
  in let
    arg_15 =
  ...
  in let
    fieldsb1_19 =
      erlps__rbia_fields__3 [arg_15, arg_17, ErlangEmptyList]
  in let
    fieldsa_21 =
      BIF.do_remote_fun_call "Sofs" "erlps__relation__1" [fieldsa1_14]
  in let
    pfsa_23 =
      BIF.do_remote_fun_call "Sofs" "erlps__relation__1" [pfsa1_7]
  in let arg_25 = toErl 1
  in let arg_27 = toErl 1
  in let
    a_28 =
      BIF.do_remote_fun_call "Sofs" "erlps__join__4"
        [fieldsa_21, arg_25, pfsa_23, arg_27]
  in let
    fieldsb_30 =
      BIF.do_remote_fun_call "Sofs" "erlps__relation__1" [fieldsb1_19]
  in let
    pfsb_32 =
      BIF.do_remote_fun_call "Sofs" "erlps__relation__1" [pfsb1_9]
  in let arg_34 = toErl 1
  in let arg_36 = toErl 1
  in let
    b_37 =
      BIF.do_remote_fun_call "Sofs" "erlps__join__4"
        [fieldsb_30, arg_34, pfsb_32, arg_36]
  in let arg_39 = toErl 2
  in let arg_41 = toErl 2
  in let
    c_42 =
      BIF.do_remote_fun_call "Sofs" "erlps__join__4"
        [a_28, arg_39, b_37, arg_41]
  in let
    tup_el_45 =
      ErlangFun 1
        (let
         ...
         in lambda_46)
  in let arg_43 = ErlangTuple [ErlangAtom "external", tup_el_45]
  in let
    d_53 =
  ...
  in
    case matchExpr_59 of
      (ErlangTuple [ps1_57, ps2_58]) ->
        erlps__reject_invalid_alias_list__4 [ps1_57, ps2_58, vt_4, st_5]
      _ -> EXC.badmatch matchExpr_59
erlps__reject_invalid_alias_rec__6 [arg_64, arg_65, arg_66,
                                    arg_67, arg_68, arg_69]
  =
  EXC.function_clause unit
erlps__reject_invalid_alias_rec__6 args =
  EXC.badarity (ErlangFun 6 erlps__reject_invalid_alias_rec__6)
    args
    ...
    (\ lc_4 ->
       case lc_4 of
         (ErlangTuple [(ErlangAtom "record_field"), _,
                       ...
                       pat_3]) ->
           let lcRet_5 = ErlangTuple [name_2, pat_3]
           in ErlangCons lcRet_5 ErlangEmptyList
         _ -> ErlangEmptyList)
    fs_0
erlps__rbia_field_vars__1 [arg_8] = EXC.function_clause unit
erlps__rbia_field_vars__1 args =
  EXC.badarity (ErlangFun 1 erlps__rbia_field_vars__1) args
...
erlps__rbia_fields__3 [(ErlangCons (ErlangTuple [(ErlangAtom "record_field"),
  ...
  =
  let    rop_7 = toErl 1
  in let arg_5 = BIF.erlang__op_plus [i_2, rop_7]
  in let head_9 = ErlangTuple [name_0, i_2]
  in erlps__rbia_fields__3 [fs_1, arg_5, ErlangCons head_9 acc_3]
erlps__rbia_fields__3 [(ErlangCons _ fs_0), i_1, acc_2] =
  let    rop_6 = toErl 1
  in let arg_4 = BIF.erlang__op_plus [i_1, rop_6]
...
erlps__rbia_fields__3 args =
  EXC.badarity (ErlangFun 3 erlps__rbia_fields__3) args
  ...
  in
    case case_1 of
      ...
      (ErlangAtom "true") ->
        ...
        in
          case case_3 of
            (ErlangTuple [(ErlangAtom "integer"), _, _]) -> ErlangAtom "true"
...
erlps__is_pattern_expr__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_pattern_expr__1) args
...
erlps__is_pattern_expr_1__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_pattern_expr_1__1) args
      ...
      ErlangFun 2
        (let
           lambda_5 [(ErlangTuple [(ErlangAtom "map_field_assoc"), l_8, _,
             ...
             let
               tup_el_14 =
                 erlps__add_error__3 [l_8, ErlangAtom "illegal_pattern", st0_11]
                   ...
                   (ErlangTuple [(ErlangAtom "lint"), state_26, module_27,
                     ...
                     ErlangTuple
                       [ErlangAtom "lint", state_26, module_27, behaviour_28,
                        ...
                        warnings_46, file_47, recdef_top_48, xqlc_49, called_50,
                        usage_51, specs_52, callbacks_53, optional_callbacks_54,
                        types_55, exp_types_56, in_try_head_57, bvt_58,
                        ErlangAtom "map_key"]
                   _ -> EXC.badrecord (ErlangAtom "lint")
             in let matchExpr_66 = erlps__gexpr__3 [k_19, vt_1, st1_60]
             in
               case matchExpr_66 of
                 (ErlangTuple [kvt_64, st2_65]) ->
                   ...
                   in
                     case matchExpr_74 of
                       (ErlangTuple [vvt_71, vnew_72, st3_73]) ->
                         let    arg_76 = erlps__vtmerge_pat__2 [kvt_64, vvt_71]
                         in let
                           tup_el_75 = erlps__vtmerge_pat__2 [arg_76, psvt_21]
                         in let
                           tup_el_80 = erlps__vtmerge_pat__2 [psnew_22, vnew_72]
                         in ErlangTuple [tup_el_75, tup_el_80, st3_73]
                       _ -> EXC.badmatch matchExpr_74
...
erlps__pattern_map__4 args =
  EXC.badarity (ErlangFun 4 erlps__pattern_map__4) args
...
erlps__pattern_bin__4 [es_0, vt_1, old_2, st0_3] =
  ...
  in let
    arg_14 =
      ErlangTuple [tup_el_15, ErlangEmptyList, ErlangEmptyList, st0_3]
  in let
    matchExpr_24 =
      BIF.do_remote_fun_call "Lists" "erlps__foldl__3"
        [arg_4, arg_14, es_0]
...
erlps__pattern_bin__4 args =
  EXC.badarity (ErlangFun 4 erlps__pattern_bin__4) args
...
erlps__pattern_element__4 args =
  EXC.badarity (ErlangFun 4 erlps__pattern_element__4) args
        ...
        in
          case matchExpr_26 of
            (ErlangTuple [sz1_22, szvt_23, sznew_24, st2_25]) ->
              let
                matchExpr_34 = erlps__bit_type__4 [line_0, sz1_22, ts_3, st2_25]
              in
                case matchExpr_34 of
                  (ErlangTuple [sz2_31, bt_32, st3_33]) ->
                    let
                      matchExpr_41 =
                        erlps__bit_size_check__4 [line_0, sz2_31, bt_32, st3_33]
                    in
                            ...
                            sz4_49 =
                              case case_42 of
                                (ErlangTuple [(ErlangTuple [(ErlangAtom "string"),
                                              ...
                                              (ErlangAtom "all")]) ->
                                  let    lop_46 = toErl 8
                                  in let rop_47 = BIF.erlang__length__1 [s_45]
                                  in BIF.erlang__op_mult [lop_46, rop_47]
                          ...
                          in
                            case matchExpr_57 of
                              (ErlangTuple [size1_55, st5_56]) ->
                                ...
                                in let
                                  arg_66 = erlps__vtmerge__2 [esnew_8, penew_15]
                                in let
                                  tup_el_64 =
...
erlps__pattern_element_1__4 args =
  EXC.badarity (ErlangFun 4 erlps__pattern_element_1__4) args
...
erlps__good_string_size_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__good_string_size_type__2) args
...
erlps__pat_bit_expr__4 args =
  EXC.badarity (ErlangFun 4 erlps__pat_bit_expr__4) args
...
erlps__pat_bit_size__4 [size_0, vt0_1, new0_2, st0_3] =
  let    arg_4 = toErl 2
  in let line_6 = BIF.erlang__element__2 [arg_4, size_0]
  in let
    case_7 =
      BIF.do_remote_fun_call "Erl.Eval" "erlps__partial_eval__1"
        [size_0]
        ...
        let   
          st1_53 =
            case st0_3 of
              ...
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let matchExpr_60 = erlps__gexpr__3 [size_0, vt0_1, st1_53]
        in
                ...
                st3_101 =
                  case st2_59 of
                    (ErlangTuple [(ErlangAtom "lint"), state_67, module_68,
                      ...
                      ErlangTuple
                        [ErlangAtom "lint", state_67, module_68, behaviour_69,
                         exports_70, imports_71, compile_72, records_73,
                         locals_74, no_auto_75, defined_76, on_load_77,
                         on_load_line_78, clashes_79, not_deprecated_80,
                         not_removed_81, func_82, warn_format_83,
                         enabled_warnings_84, nowarn_bif_clash_85, errors_86,
                         warnings_87, file_88, recdef_top_89, xqlc_90,
                         called_91, usage_92, specs_93, callbacks_94,
                         optional_callbacks_95, types_96, exp_types_97,
                         in_try_head_98, ErlangAtom "none", record_updt_63]
                    _ -> EXC.badrecord (ErlangAtom "lint")
...
erlps__pat_bit_size__4 args =
  EXC.badarity (ErlangFun 4 erlps__pat_bit_size__4) args
...
erlps__is_bit_size_illegal__1 [arg_0] = EXC.function_clause unit
erlps__is_bit_size_illegal__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_bit_size_illegal__1) args
    ...
    arg_4 =
      ErlangFun 2
        (let
         ...
         in lambda_5)
  in let tup_el_15 = toErl 0
  in let arg_14 = ErlangTuple [tup_el_15, ErlangEmptyList, st0_2]
  in let
    matchExpr_22 =
      BIF.do_remote_fun_call "Lists" "erlps__foldl__3"
        [arg_4, arg_14, es_0]
...
erlps__expr_bin__4 args =
  EXC.badarity (ErlangFun 4 erlps__expr_bin__4) args
  ...
  in
    case matchExpr_15 of
      (ErlangTuple [vt1_13, st1_14]) ->
        let
          matchExpr_23 = erlps__bit_size__4 [sz0_2, vt_4, st1_14, check_8]
        in
          case matchExpr_23 of
            (ErlangTuple [sz1_20, vt2_21, st2_22]) ->
              let
                matchExpr_31 = erlps__bit_type__4 [line_0, sz1_20, ts_3, st2_22]
              in
                case matchExpr_31 of
                  (ErlangTuple [sz2_28, bt_29, st3_30]) ->
                    let
                      matchExpr_38 =
                        erlps__bit_size_check__4 [line_0, sz2_28, bt_29, st3_30]
                    in
...
erlps__bin_element__4 args =
  EXC.badarity (ErlangFun 4 erlps__bin_element__4) args
...
erlps__bit_size__4 args =
  EXC.badarity (ErlangFun 4 erlps__bit_size__4) args
...
erlps__bit_type__4 args =
  EXC.badarity (ErlangFun 4 erlps__bit_type__4) args
...
erlps__bit_size_check__4 [_line_0, (ErlangAtom "undefined"),
                          ...
                          st_2]
  =
  let    lop_4 = BIF.erlang__op_exactEq [type_1, ErlangAtom "utf8"]
  in let
  ...
  in let matchExpr_13 = BIF.erlang__op_or [lop_3, rop_10]
  in
    case matchExpr_13 of
      (ErlangAtom "true") -> ErlangTuple [ErlangAtom "undefined", st_2]
      _ -> EXC.badmatch matchExpr_13
erlps__bit_size_check__4 [line_0, (ErlangAtom "all"),
  ...
  case type_1 of
    ...
    _ ->
      let
        tup_el_7 =
          erlps__add_error__3 [line_0, ErlangAtom "illegal_bitsize", st_2]
...
erlps__bit_size_check__4 args =
  EXC.badarity (ErlangFun 4 erlps__bit_size_check__4) args
...
erlps__elemtype_check__4 [line_0, (ErlangAtom "float"), _size_1,
                          st_2]
  =
  let    tup_el_6 = toErl "float"
  in let arg_4 = ErlangTuple [ErlangAtom "bad_bitsize", tup_el_6]
...
erlps__elemtype_check__4 args =
  EXC.badarity (ErlangFun 4 erlps__elemtype_check__4) args
...
erlps__add_bit_size__5 args =
  EXC.badarity (ErlangFun 5 erlps__add_bit_size__5) args

erlps__guard__3 :: ErlangFun
erlps__guard__3 [(ErlangCons l_0 r_1), vt_2, st0_3]
  | isEList l_0 =
  let matchExpr_9 = erlps__guard_tests__3 [l_0, vt_2, st0_3]
  in
    case matchExpr_9 of
      (ErlangTuple [gvt_7, st1_8]) ->
        let    arg_11 = erlps__vtupdate__2 [gvt_7, vt_2]
        in let matchExpr_17 = erlps__guard__3 [r_1, arg_11, st1_8]
        in
          case matchExpr_17 of
...
erlps__guard__3 [arg_6, arg_7, arg_8] = EXC.function_clause unit
erlps__guard__3 args =
  EXC.badarity (ErlangFun 3 erlps__guard__3) args

erlps__guard_tests__3 :: ErlangFun
erlps__guard_tests__3 [(ErlangCons g_0 gs_1), vt_2, st0_3] =
  let matchExpr_9 = erlps__guard_test__3 [g_0, vt_2, st0_3]
  in
    case matchExpr_9 of
      (ErlangTuple [gvt_7, st1_8]) ->
        let    arg_11 = erlps__vtupdate__2 [gvt_7, vt_2]
        in let matchExpr_17 = erlps__guard_tests__3 [gs_1, arg_11, st1_8]
        in
          case matchExpr_17 of
            (ErlangTuple [gsvt_15, st2_16]) ->
              let tup_el_18 = erlps__vtupdate__2 [gvt_7, gsvt_15]
...
erlps__guard_tests__3 args =
  EXC.badarity (ErlangFun 3 erlps__guard_tests__3) args
...
erlps__guard_test__3 args =
  EXC.badarity (ErlangFun 3 erlps__guard_test__3) args
...
erlps__guard_test2__3 [(ErlangTuple [(ErlangAtom "call"), line_0,
  ...
  let   
    tup_el_9 =
      ErlangTuple [ErlangAtom "atom", lr_1, ErlangAtom "is_record"]
  in let
    arg_6 =
      ErlangTuple
...
erlps__guard_test2__3 [g_4@(ErlangTuple [(ErlangAtom "call"),
                       ...
                       vt_5, st0_6]
  =
  let matchExpr_12 = erlps__gexpr_list__3 [as_3, vt_5, st0_6]
  in
    case matchExpr_12 of
...
erlps__guard_test2__3 args =
  EXC.badarity (ErlangFun 3 erlps__guard_test2__3) args
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "map"), _line_0,
                 ...
                 vt_3, st_4]
  =
  let matchExpr_10 = erlps__gexpr__3 [src_1, vt_3, st_4]
  in
    case matchExpr_10 of
      (ErlangTuple [svt_8, st1_9]) ->
        let    arg_14 = ErlangFun 3 erlps__gexpr_list__3
        in let
          matchExpr_17 = erlps__map_fields__4 [es_2, vt_3, st1_9, arg_14]
        in
          case matchExpr_17 of
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "record_field"),
                 ...
                 vt_4, st0_5]
  =
  let matchExpr_11 = erlps__gexpr__3 [rec_1, vt_4, st0_5]
  in
    case matchExpr_11 of
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "call"), _line_0,
                 ...
                 vt_5, st0_6]
  =
  let matchExpr_12 = erlps__gexpr__3 [e_2, vt_5, st0_6]
  in
    case matchExpr_12 of
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "call"), line_0,
  ...
  let   
    tup_el_11 =
      ErlangTuple [ErlangAtom "atom", lf_3, ErlangAtom "is_record"]
  in let
    arg_8 =
      ErlangTuple
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "call"), line_0,
                 ...
                 vt_4, st0_5]
  =
  let matchExpr_11 = erlps__gexpr__3 [e0_2, vt_4, st0_5]
  in
    case matchExpr_11 of
      (ErlangTuple [e_9, st1_10]) ->
        let    tup_el_16 = toErl 3
        in let arg_14 = ErlangTuple [ErlangAtom "is_record", tup_el_16]
        in let case_12 = erlps__no_guard_bif_clash__2 [st0_5, arg_14]
        in
          case case_12 of
            (ErlangAtom "true") -> ErlangTuple [e_9, st1_10]
            (ErlangAtom "false") ->
              let    tup_el_26 = toErl 3
              in let
                tup_el_24 = ErlangTuple [ErlangAtom "is_record", tup_el_26]
              in let
                arg_22 =
                  ErlangTuple [ErlangAtom "illegal_guard_local_call", tup_el_24]
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "call"), line_0,
                 ...
                 vt_3, st0_4]
  =
  let matchExpr_10 = erlps__gexpr_list__3 [asvt0_2, vt_3, st0_4]
  in
    case matchExpr_10 of
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "call"), line_0,
  ...
  =
  let
    arg_5 = ErlangTuple [ErlangAtom "call", line_0, isr_1, args_2]
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "call"), line_0,
                 ...
                 vt_4, st0_5]
  =
  let matchExpr_11 = erlps__gexpr_list__3 [as_3, vt_4, st0_5]
  in
    case matchExpr_11 of
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "call"), line_0,
                 ...
                 vt_6, st0_7]
  =
  let matchExpr_13 = erlps__gexpr_list__3 [as_5, vt_6, st0_7]
  in
    case matchExpr_13 of
...
erlps__gexpr__3 [(ErlangTuple [(ErlangAtom "op"), line_0, op_1,
                 ...
                 vt_3, st0_4]
  =
  let matchExpr_10 = erlps__gexpr__3 [a_2, vt_3, st0_4]
  in
    case matchExpr_10 of
      (ErlangTuple [avt_8, st1_9]) ->
        let    arg_13 = toErl 1
        in let case_11 = erlps__is_gexpr_op__2 [op_1, arg_13]
        in
          case case_11 of
  ...
  in
    case matchExpr_15 of
      (ErlangTuple [avt_13, st1_14]) ->
        let    arg_18 = toErl 2
        in let case_16 = erlps__is_gexpr_op__2 [op_1, arg_18]
        in
          case case_16 of
...
erlps__gexpr__3 [e_0, _vt_1, st_2] =
  let    arg_6 = toErl 2
  in let arg_5 = BIF.erlang__element__2 [arg_6, e_0]
  in let
    tup_el_4 =
      erlps__add_error__3
...
erlps__gexpr__3 args =
  EXC.badarity (ErlangFun 3 erlps__gexpr__3) args
      ...
      ErlangFun 2
        (let
           lambda_4 [e_7, (ErlangTuple [esvt_8, st0_9])] =
             let matchExpr_15 = erlps__gexpr__3 [e_7, vt_1, st0_9]
             in
               case matchExpr_15 of
...
erlps__gexpr_list__3 args =
  EXC.badarity (ErlangFun 3 erlps__gexpr_list__3) args
...
erlps__is_guard_test__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_guard_test__1) args
...
erlps__is_guard_test__2 [arg_7, arg_8] = EXC.function_clause unit
erlps__is_guard_test__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_guard_test__2) args
...
erlps__is_guard_test__3 [expression_0, forms_1, isoverridden_2] =
  ...
  in let arg_25 = toErl "nofile"
  in let arg_23 = erlps__set_file__2 [expression_0, arg_25]
  in let
    tup_el_27 =
      case st0_22 of
        (ErlangTuple arr_30) | (DM.Just field_29) <- (arr_30 DA.!! 7) ->
          field_29
        _ -> EXC.badrecord (ErlangAtom "lint")
...
erlps__is_guard_test__3 args =
  EXC.badarity (ErlangFun 3 erlps__is_guard_test__3) args
...
erlps__is_guard_test2__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_guard_test2__2) args
...
erlps__is_guard_expr__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_guard_expr__1) args
...
erlps__is_gexpr__2 [(ErlangTuple [(ErlangAtom "record_field"),
  ...
  =
  erlps__is_gexpr_list__2
    [ErlangCons rec_1 (ErlangCons field_3 ErlangEmptyList), info_4]
...
erlps__is_gexpr__2 [(ErlangTuple [(ErlangAtom "op"), _l_0, op_1,
  ...
  =
  let    arg_6 = toErl 1
  in let lop_4 = erlps__is_gexpr_op__2 [op_1, arg_6]
  in
    case lop_4 of
      (ErlangAtom "false") -> ErlangAtom "false"
...
erlps__is_gexpr__2 [(ErlangTuple [(ErlangAtom "op"), _l_0, op_1,
  ...
  =
  let    arg_7 = toErl 2
  in let lop_5 = erlps__is_gexpr_op__2 [op_1, arg_7]
  in
    case lop_5 of
      (ErlangAtom "false") -> ErlangAtom "false"
      (ErlangAtom "true") ->
...
erlps__is_gexpr__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_gexpr__2) args
  ...
  EXC.tryOfCatch
    ...
    (\ ex_5 ->
       case ex_5 of
         ...
         ex_6 -> EXC.raise ex_6)
erlps__is_gexpr_op__2 [arg_7, arg_8] = EXC.function_clause unit
erlps__is_gexpr_op__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_gexpr_op__2) args
...
erlps__is_gexpr_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_gexpr_list__2) args
...
erlps__is_map_fields__2 [arg_2, arg_3] = EXC.function_clause unit
erlps__is_map_fields__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_map_fields__2) args
...
erlps__is_gexpr_fields__4 args =
  EXC.badarity (ErlangFun 4 erlps__is_gexpr_fields__4) args

erlps__exprs__3 :: ErlangFun
erlps__exprs__3 [(ErlangCons e_0 es_1), vt_2, st0_3] =
  let matchExpr_9 = erlps__expr__3 [e_0, vt_2, st0_3]
  in
    case matchExpr_9 of
      (ErlangTuple [evt_7, st1_8]) ->
        let    arg_11 = erlps__vtupdate__2 [evt_7, vt_2]
        in let matchExpr_17 = erlps__exprs__3 [es_1, arg_11, st1_8]
        in
          case matchExpr_17 of
...
erlps__exprs__3 [(ErlangEmptyList), _vt_0, st_1] =
  ErlangTuple [ErlangEmptyList, st_1]
erlps__exprs__3 [arg_4, arg_5, arg_6] = EXC.function_clause unit
...
erlps__expr__3 [(ErlangTuple [(ErlangAtom "map"), _line_0, src_1,
                ...
                vt_3, st_4]
  =
  let matchExpr_10 = erlps__expr__3 [src_1, vt_3, st_4]
  in
    case matchExpr_10 of
      (ErlangTuple [svt_8, st1_9]) ->
...
erlps__expr__3 [(ErlangTuple [(ErlangAtom "record_field"),
  ...
  =
  let
    matchExpr_12 = erlps__record_expr__4 [line_0, rec_1, vt_4, st0_5]
  in
    case matchExpr_12 of
      (ErlangTuple [rvt_10, st1_11]) ->
        let   
        ...
        let   
          arg_16 =
            ErlangFun 2
              (let
                 lambda_17 [dfs_20, st_21] =
                   erlps__update_fields__5 [upds_3, name_2, dfs_20, vt_4, st_21]
                 lambda_17 [arg_18, arg_19] = EXC.function_clause unit
                 lambda_17 args = EXC.badarity (ErlangFun 2 lambda_17) args
               in lambda_17)
        in let
              ...
              in
                case case_30 of
                  (ErlangAtom "true") ->
                    let   
                      arg_35 =
                        ErlangTuple [ErlangAtom "wildcard_in_update", name_2]
                    in let
...
erlps__expr__3 [(ErlangTuple [(ErlangAtom "case"), line_0, e_1,
                ...
                vt_3, st0_4]
  =
  let matchExpr_10 = erlps__expr__3 [e_1, vt_3, st0_4]
  in
    case matchExpr_10 of
...
erlps__expr__3 [(ErlangTuple [(ErlangAtom "receive"), line_0,
                ...
                vt_4, st0_5]
  =
  let matchExpr_11 = erlps__expr__3 [to_2, vt_4, st0_5]
  in
    case matchExpr_11 of
      (ErlangTuple [tvt_9, st1_10]) ->
        let matchExpr_17 = erlps__exprs__3 [toes_3, vt_4, st1_10]
        in
          case matchExpr_17 of
            (ErlangTuple [tevt_15, st2_16]) ->
              let matchExpr_23 = erlps__icrt_clauses__3 [cs_1, vt_4, st2_16]
              in
                case matchExpr_23 of
                  (ErlangTuple [cvt_21, st3_22]) ->
                    let    arg_29 = ErlangTuple [ErlangAtom "receive", line_0]
                    in let
                      rvt_33 =
  ...
  case body_1 of
    ...
    (ErlangTuple [(ErlangAtom "function"), f_15, a_16]) ->
      let   
        arg_20 =
          case st_3 of
            (ErlangTuple arr_23) | (DM.Just field_22) <- (arr_23 DA.!! 8) ->
              field_22
            _ -> EXC.badrecord (ErlangAtom "lint")
  ...
  in let
    st1_19 =
      erlps__shadow_vars__4
        [ErlangCons head_5 ErlangEmptyList, vt_3, ErlangAtom "named fun",
         st0_4]
  in let
    arg_20 =
      erlps__vtsubtract__2 [vt_3, ErlangCons head_5 ErlangEmptyList]
  in let
    nvt1_24 =
      erlps__vtupdate__2 [arg_20, ErlangCons head_5 ErlangEmptyList]
  in let
    matchExpr_30 = erlps__fun_clauses__3 [cs_2, nvt1_24, st1_19]
  in
    case matchExpr_30 of
      (ErlangTuple [csvt_28, st2_29]) ->
        let   
          arg_31 =
            erlps__vtupdate__2 [csvt_28, ErlangCons head_5 ErlangEmptyList]
        in let
          matchExpr_37 =
...
erlps__expr__3 [(ErlangTuple [(ErlangAtom "call"), _line_0,
                ...
                vt_5, st0_6]
  =
  let matchExpr_12 = erlps__expr__3 [e_2, vt_5, st0_6]
  in
    case matchExpr_12 of
      (ErlangTuple [rvt_10, st1_11]) ->
        let tup_el_14 = erlps__exist_record__3 [ln_3, name_4, st1_11]
...
erlps__expr__3 [(ErlangTuple [(ErlangAtom "call"), line_0,
  ...
  in let
    st2_18 =
      erlps__check_remote_function__5 [line_0, m_3, f_5, as_6, st1_12]
  in let st3_22 = erlps__check_module_name__3 [m_3, line_0, st2_18]
  in erlps__expr_list__3 [as_6, vt_7, st3_22]
erlps__expr__3 [a_0, b_1, c_2] = erlps__expr1__3 [a_0, b_1, c_2]
...
erlps__expr1__3 [(ErlangTuple [(ErlangAtom "call"), line_0,
  ...
  in let matchExpr_15 = erlps__expr_list__3 [as_3, vt_4, st1_9]
  in
    case matchExpr_15 of
      (ErlangTuple [asvt_13, st2_14]) ->
        ...
        in let
          arg_18 =
            case st2_14 of
              (ErlangTuple arr_21) | (DM.Just field_20) <- (arr_21 DA.!! 8) ->
                field_20
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let arg_22 = ErlangTuple [f_2, a_17]
        in let islocal_25 = erlps__is_local_function__2 [arg_18, arg_22]
        in let
          isautobif_28 =
            BIF.do_remote_fun_call "Erl.Internal" "erlps__bif__2" [f_2, a_17]
        in let
          arg_29 =
            case st2_14 of
              (ErlangTuple arr_32) | (DM.Just field_31) <- (arr_32 DA.!! 9) ->
                field_31
              _ -> EXC.badrecord (ErlangAtom "lint")
        ...
        in let
          case_51 =
            case lop_52 of
              ...
              (ErlangAtom "true") ->
                let
                  lop_54 = BIF.erlang__op_exactEq [imported_50, ErlangAtom "no"]
                in
                  case lop_54 of
                    (ErlangAtom "false") -> ErlangAtom "false"
                    (ErlangAtom "true") ->
                          ...
                          (ErlangTuple [(ErlangAtom "lint"), state_99,
                            ...
                            ErlangTuple
                              [ErlangAtom "lint", state_99, module_100,
                               ...
                               optional_callbacks_127, types_128, exp_types_129,
                               in_try_head_130, bvt_131, gexpr_context_132]
                          _ -> EXC.badrecord (ErlangAtom "lint")
                    (ErlangAtom "no") ->
                                  ...
                                  _ | (ErlangAtom "true") ==
                                    ...
                                    in
                                      case case_145 of
                                        (ErlangAtom "true") ->
                                          let   
                                            tup_el_151 = ErlangTuple [f_2, a_17]
                                          in let
                                            arg_149 =
                                              ErlangTuple
                                                [ErlangAtom
                                        ...
                                        (ErlangAtom "false") ->
                                          let   
                                            tup_el_158 = ErlangTuple [f_2, a_17]
                                          in let
                                            arg_156 =
                                              ErlangTuple
                                                [ErlangAtom
...
erlps__expr1__3 [(ErlangTuple [(ErlangAtom "try"), line_0, es_1,
                 ...
                 vt_5, st0_6]
  =
  let matchExpr_12 = erlps__exprs__3 [es_1, vt_5, st0_6]
  in
    case matchExpr_12 of
        ...
        in
          case matchExpr_30 of
            (ErlangTuple [sccs_28, st2_29]) ->
              ...
              in let matchExpr_51 = erlps__exprs__3 [as_4, arg_45, st2_29]
              in
                case matchExpr_51 of
...
erlps__expr1__3 [(ErlangTuple [(ErlangAtom "catch"), line_0,
                 ...
                 vt_2, st0_3]
  =
  let matchExpr_9 = erlps__expr__3 [e_1, vt_2, st0_3]
  in
    case matchExpr_9 of
...
erlps__expr1__3 [(ErlangTuple [(ErlangAtom "match"), _line_0,
                 ...
                 vt_3, st0_4]
  =
  let matchExpr_10 = erlps__expr__3 [e_2, vt_3, st0_4]
  in
    case matchExpr_10 of
      (ErlangTuple [evt_8, st1_9]) ->
        let    arg_12 = erlps__vtupdate__2 [evt_8, vt_3]
        in let matchExpr_19 = erlps__pattern__3 [p_1, arg_12, st1_9]
        in
          case matchExpr_19 of
  ...
  in
    case matchExpr_11 of
      (ErlangTuple [evt1_9, st1_10]) ->
        ...
        in let matchExpr_20 = erlps__expr__3 [r_3, vt1_14, st1_10]
        in
          case matchExpr_20 of
...
erlps__expr1__3 args =
  EXC.badarity (ErlangFun 3 erlps__expr1__3) args
  ...
  let   
    arg_3 =
      ErlangFun 2
        (let
           lambda_4 [e_7, (ErlangTuple [esvt_8, st0_9])] =
             let matchExpr_15 = erlps__expr__3 [e_7, vt_1, st0_9]
             in
               case matchExpr_15 of
                 (ErlangTuple [evt_13, st1_14]) ->
...
erlps__record_expr__4 [line_0, rec_1, vt_2, st0_3] =
  let st1_7 = erlps__warn_invalid_record__3 [line_0, rec_1, st0_3]
  in erlps__expr__3 [rec_1, vt_2, st1_7]
erlps__record_expr__4 [arg_11, arg_12, arg_13, arg_14] =
  EXC.function_clause unit
erlps__record_expr__4 args =
  EXC.badarity (ErlangFun 4 erlps__record_expr__4) args
...
erlps__check_assoc_fields__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_assoc_fields__2) args
  ...
  in
    case matchExpr_17 of
      (ErlangTuple [pvt_15, st2_16]) ->
        let matchExpr_24 = erlps__map_fields__4 [fs_3, vt_4, st2_16, f_6]
        in
          case matchExpr_24 of
...
erlps__map_fields__4 args =
  EXC.badarity (ErlangFun 4 erlps__map_fields__4) args
...
erlps__warn_invalid_record__3 [line_0, r_1, st_2] =
  ...
  in
    case case_3 of
      (ErlangAtom "true") -> st_2
      (ErlangAtom "false") ->
        erlps__add_warning__3 [line_0, ErlangAtom "invalid_record", st_2]
      something_else -> EXC.case_clause something_else
erlps__warn_invalid_record__3 [arg_8, arg_9, arg_10] =
  EXC.function_clause unit
erlps__warn_invalid_record__3 args =
  EXC.badarity (ErlangFun 3 erlps__warn_invalid_record__3) args
...
erlps__is_valid_record__1 [rec_0] =
  case rec_0 of
    ...
    (ErlangTuple [(ErlangAtom "integer"), _, _]) ->
      ErlangAtom "false"
    (ErlangTuple [(ErlangAtom "float"), _, _]) -> ErlangAtom "false"
    (ErlangTuple [(ErlangAtom "atom"), _, _]) -> ErlangAtom "false"
    (ErlangTuple [(ErlangAtom "string"), _, _]) -> ErlangAtom "false"
    (ErlangTuple [(ErlangAtom "cons"), _, _, _]) ->
      ErlangAtom "false"
    (ErlangTuple [(ErlangAtom "nil"), _]) -> ErlangAtom "false"
    (ErlangTuple [(ErlangAtom "lc"), _, _, _]) -> ErlangAtom "false"
...
erlps__is_valid_record__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_valid_record__1) args
...
erlps__warn_invalid_call__3 [line_0, f_1, st_2] =
  ...
  in
    case case_3 of
      (ErlangAtom "true") -> st_2
      (ErlangAtom "false") ->
        erlps__add_warning__3 [line_0, ErlangAtom "invalid_call", st_2]
      something_else -> EXC.case_clause something_else
erlps__warn_invalid_call__3 [arg_8, arg_9, arg_10] =
  EXC.function_clause unit
erlps__warn_invalid_call__3 args =
  EXC.badarity (ErlangFun 3 erlps__warn_invalid_call__3) args
...
erlps__is_valid_call__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_valid_call__1) args
...
erlps__record_def__4 [line_0, name_1, fs0_2, st0_3] =
  ...
  in
    case case_4 of
      (ErlangAtom "true") ->
        let arg_11 = ErlangTuple [ErlangAtom "redefine_record", name_1]
        in erlps__add_error__3 [line_0, arg_11, st0_3]
      (ErlangAtom "false") ->
        let    arg_15 = erlps__normalise_fields__1 [fs0_2]
        in let
          matchExpr_21 = erlps__def_fields__3 [arg_15, name_1, st0_3]
        in
          case matchExpr_21 of
                ...
                arg_28 =
                  case st1_20 of
                    (ErlangTuple arr_31) | (DM.Just field_30) <-
                      ...
                      field_30
                    _ -> EXC.badrecord (ErlangAtom "lint")
              in let record_updt_23 = BIF.maps__put__3 [name_1, arg_25, arg_28]
              in let
                st2_66 =
                  case st1_20 of
                    (ErlangTuple [(ErlangAtom "lint"), state_32, module_33,
                      ...
                      ErlangTuple
                        [ErlangAtom "lint", state_32, module_33, behaviour_34,
                         exports_35, imports_36, compile_37, record_updt_23,
                         locals_39, no_auto_40, defined_41, on_load_42,
                         on_load_line_43, clashes_44, not_deprecated_45,
                         not_removed_46, func_47, warn_format_48,
                         enabled_warnings_49, nowarn_bif_clash_50, errors_51,
                         warnings_52, file_53, recdef_top_54, xqlc_55,
                         called_56, usage_57, specs_58, callbacks_59,
                         optional_callbacks_60, types_61, exp_types_62,
                         in_try_head_63, bvt_64, gexpr_context_65]
                    _ -> EXC.badrecord (ErlangAtom "lint")
              in let
...
erlps__record_def__4 args =
  EXC.badarity (ErlangFun 4 erlps__record_def__4) args
             ...
             in
               case case_13 of
                 (ErlangAtom "true") ->
                   let   
                     arg_19 =
                       ErlangTuple [ErlangAtom "redefine_field", name_1, f_9]
                   in let tup_el_17 = erlps__add_error__3 [lf_7, arg_19, st_12]
                         ...
                         in let
                           rop_120 =
                             case st1_60 of
                               ...
                               _ -> EXC.badrecord (ErlangAtom "lint")
                         in let
                           case_115 = BIF.erlang__op_exactEq [lop_116, rop_120]
                         in let
                           nv_127 =
                             case case_115 of
...
erlps__def_fields__3 args =
  EXC.badarity (ErlangFun 3 erlps__def_fields__3) args
      ...
      ErlangFun 1
        (let
           lambda_2 [(ErlangTuple [(ErlangAtom "record_field"), lf_4,
             ...
             let
               tup_el_9 =
                 ErlangTuple [ErlangAtom "atom", lf_4, ErlangAtom "undefined"]
             in
               ErlangTuple [ErlangAtom "record_field", lf_4, field_5, tup_el_9]
           lambda_2 [(ErlangTuple [(ErlangAtom "typed_record_field"),
             ...
             let
               tup_el_19 =
                 ErlangTuple [ErlangAtom "atom", lf_13, ErlangAtom "undefined"]
             in
               ErlangTuple
...
erlps__normalise_fields__1 args =
  EXC.badarity (ErlangFun 1 erlps__normalise_fields__1) args
...
erlps__check_record__4 args =
  EXC.badarity (ErlangFun 4 erlps__check_record__4) args
...
erlps__used_record__2 [name_0,
  ...
  in
    case st_2 of
      ...
      _ -> EXC.badrecord (ErlangAtom "lint")
erlps__used_record__2 [arg_51, arg_52] = EXC.function_clause unit
erlps__used_record__2 args =
  EXC.badarity (ErlangFun 2 erlps__used_record__2) args
...
erlps__check_fields__6 args =
  EXC.badarity (ErlangFun 6 erlps__check_fields__6) args
...
erlps__check_field__7 [(ErlangTuple [(ErlangAtom "record_field"),
  ...
  in
    case case_10 of
      (ErlangAtom "true") ->
        let   
          arg_18 = ErlangTuple [ErlangAtom "redefine_field", name_4, f_2]
...
erlps__check_field__7 [(ErlangTuple [(ErlangAtom "record_field"),
  ...
  let   
    arg_15 =
      ErlangTuple [ErlangAtom "field_name_is_variable", name_4, v_2]
...
erlps__check_field__7 args =
  EXC.badarity (ErlangFun 7 erlps__check_field__7) args
...
erlps__pattern_field__4 [(ErlangTuple [(ErlangAtom "atom"), la_0,
  ...
  in
    case case_5 of
      ...
      (ErlangAtom "error") ->
        let   
          arg_14 = ErlangTuple [ErlangAtom "undefined_field", name_2, f_1]
...
erlps__pattern_field__4 args =
  EXC.badarity (ErlangFun 4 erlps__pattern_field__4) args
             ...
             in
               case case_27 of
                 (ErlangTuple [sfsb_35, (ErlangTuple [vtb_36, stb_37])]) ->
                   ...
                   in ErlangTuple [sfsb_35, tup_el_39, ErlangEmptyList, stb_37]
                 (ErlangTuple [sfsb_44,
...
erlps__pattern_fields__6 args =
  EXC.badarity (ErlangFun 6 erlps__pattern_fields__6) args
...
erlps__record_field__4 args =
  EXC.badarity (ErlangFun 4 erlps__record_field__4) args
                ...
                tup_el_28 =
                  case st1_13 of
                    (ErlangTuple [(ErlangAtom "lint"), state_34, module_35,
                      ...
                      ErlangTuple
                        [ErlangAtom "lint", state_34, module_35, behaviour_36,
                         exports_37, imports_38, compile_39, records_40,
                         locals_41, no_auto_42, defined_43, on_load_44,
                         on_load_line_45, clashes_46, not_deprecated_47,
                         not_removed_48, func_49, warn_format_50,
                         enabled_warnings_51, nowarn_bif_clash_52, errors_53,
                         warnings_54, file_55, recdef_top_56, xqlc_57,
                         called_58, record_updt_30, specs_60, callbacks_61,
                         optional_callbacks_62, types_63, exp_types_64,
                         in_try_head_65, bvt_66, gexpr_context_67]
                    _ -> EXC.badrecord (ErlangAtom "lint")
...
erlps__init_fields__6 args =
  EXC.badarity (ErlangFun 6 erlps__init_fields__6) args
                  ...
                  in let
                    rop_78 =
                      case st1_13 of
                        ...
                        _ -> EXC.badrecord (ErlangAtom "lint")
                  in let
                    record_updt_76 = BIF.erlang__op_append [illerrs_73, rop_78]
                  in let
                    st4_116 =
                      case st1_13 of
                        (ErlangTuple [(ErlangAtom "lint"), state_82, module_83,
                          ...
                          ErlangTuple
                            [ErlangAtom "lint", state_82, module_83,
                             ...
                             nowarn_bif_clash_100, record_updt_76, warnings_102,
                             file_103, recdef_top_104, xqlc_105, called_106,
                             usage_65, specs_108, callbacks_109,
...
erlps__ginit_fields__6 args =
  EXC.badarity (ErlangFun 6 erlps__ginit_fields__6) args
    ...
    (\ lc_8 ->
       case lc_8 of
         (ErlangTuple [(ErlangAtom "record_field"), lf_4,
                       (ErlangTuple [(ErlangAtom "atom"), la_5, f_6]), di_7]) ->
           let    op_arg_10 = erlps__exist_field__2 [f_6, ifs_0]
           in let cond_9 = BIF.erlang__not__1 [op_arg_10]
           in
             case cond_9 of
               (ErlangAtom "true") ->
                 let    tup_el_16 = ErlangTuple [ErlangAtom "atom", la_5, f_6]
                 in let tup_el_20 = erlps__copy_expr__2 [di_7, line_1]
                 in let
                   lcRet_13 =
                     ErlangTuple
                       [ErlangAtom "record_field", lf_4, tup_el_16, tup_el_20]
...
erlps__init_fields__3 args =
  EXC.badarity (ErlangFun 3 erlps__init_fields__3) args
...
erlps__update_fields__5 [ufs_0, name_1, dfs_2, vt_3, st_4] =
  ...
  in
    erlps__check_fields__6 [ufs_0, name_1, dfs_2, vt_3, st_4, arg_10]
erlps__update_fields__5 [arg_11, arg_12, arg_13, arg_14, arg_15]
  =
  EXC.function_clause unit
erlps__update_fields__5 args =
  EXC.badarity (ErlangFun 5 erlps__update_fields__5) args
...
erlps__exist_field__2 args =
  EXC.badarity (ErlangFun 2 erlps__exist_field__2) args
...
erlps__find_field__2 args =
  EXC.badarity (ErlangFun 2 erlps__find_field__2) args
    ...
    storetype_71 =
      ErlangFun 1
        (let
           lambda_19 [st_21] =
             let   
               newdefs_25 = BIF.maps__put__3 [typepair_14, info_18, typedefs_9]
                   ...
                   (ErlangTuple [(ErlangAtom "lint"), state_37, module_38,
                     ...
                     ErlangTuple
                       [ErlangAtom "lint", state_37, module_38, behaviour_39,
                        ...
                        warnings_57, file_58, recdef_top_59, xqlc_60, called_61,
                        usage_62, specs_63, callbacks_64, optional_callbacks_65,
                        newdefs_25, exp_types_67, in_try_head_68, bvt_69,
                        gexpr_context_70]
                   _ -> EXC.badrecord (ErlangAtom "lint")
      ...
      (ErlangAtom "true") ->
        ...
        in
          case case_74 of
              ...
              in
                case case_78 of
                  (ErlangAtom "true") ->
                    let   
                      warn_82 =
                        ErlangTuple [ErlangAtom "new_builtin_type", typepair_14]
                    in let
            ...
            something_else -> EXC.case_clause something_else
      (ErlangAtom "false") ->
        let case_94 = BIF.erlang__is_map_key__2 [typepair_14, typedefs_9]
        in
          case case_94 of
            (ErlangAtom "true") ->
              let
                arg_98 = ErlangTuple [ErlangAtom "redefine_type", typepair_14]
              in erlps__add_error__3 [line_1, arg_98, st0_5]
            (ErlangAtom "false") ->
              let   
                lop_103 = BIF.erlang__op_exactEq [attr_0, ErlangAtom "opaque"]
              in let
                case_102 =
                  case lop_103 of
                    (ErlangAtom "false") -> ErlangAtom "false"
                  ...
                  case case_102 of
                    (ErlangAtom "true") ->
                      let
                        warn_110 =
                          ErlangTuple
                            [ErlangAtom "underspecified_opaque", typepair_14]
...
erlps__type_def__6 args =
  EXC.badarity (ErlangFun 6 erlps__type_def__6) args
...
erlps__is_underspecified__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_underspecified__2) args

erlps__check_type__2 :: ErlangFun
erlps__check_type__2 [types_0, st_1] =
  let    arg_3 = BIF.do_remote_fun_call "Maps" "erlps__new__0" []
  in let matchExpr_7 = erlps__check_type__3 [types_0, arg_3, st_1]
  in
    case matchExpr_7 of
            ...
            ErlangFun 3
              (let
                 lambda_9 [var_13,
                   ...
                   in
                     case case_16 of
                       (ErlangCons (ErlangInt num_18) _) | (ErlangInt num_18) ==
                                                             (toErl 95) ->
                         accst_15
                       _ ->
                         let
      ...
      _ -> EXC.badmatch matchExpr_7
erlps__check_type__2 [arg_28, arg_29] = EXC.function_clause unit
...
erlps__check_type__3 [(ErlangTuple [(ErlangAtom "remote_type"),
  ...
  in let
    currentmod_19 =
      case st_15 of
        (ErlangTuple arr_18) | (DM.Just field_17) <- (arr_18 DA.!! 2) ->
          field_17
        _ -> EXC.badrecord (ErlangAtom "lint")
    ...
    newseenvars_15 =
      case case_4 of
        (ErlangTuple [(ErlangAtom "ok"),
          ...
          BIF.maps__put__3 [name_1, ErlangAtom "seen_multiple", seenvars_2]
        (ErlangTuple [(ErlangAtom "ok"),
  ...
  let   
    st1_11 =
      case dom_1 of
        ...
        _ ->
          let
            arg_7 = ErlangTuple [ErlangAtom "type_syntax", ErlangAtom "fun"]
...
erlps__check_type__3 [(ErlangTuple [(ErlangAtom "type"), l_0,
  ...
  in let
    tup_el_8 =
      BIF.do_remote_fun_call "Erl.Eval" "erlps__partial_eval__1" [to_2]
  in let case_5 = ErlangTuple [tup_el_6, tup_el_8]
  in let
    st1_17 =
      case case_5 of
        (ErlangTuple [(ErlangTuple [(ErlangAtom "integer"), _, x_10]),
                      (ErlangTuple [(ErlangAtom "integer"), _, y_11])]) | weakLt
                                                                            x_10
                                                                            y_11 ->
          st_4
        _ ->
...
erlps__check_type__3 [(ErlangTuple [(ErlangAtom "type"), la_0,
  ...
  case st_4 of
    (ErlangTuple [(ErlangAtom "lint"), _, module_5, _, _, _, _, _, _,
      ...
      in let
        lop_13 =
          erlps__is_warn_enabled__2 [ErlangAtom "deprecated_type", st_4]
      in let
        obsolete_17 =
          case lop_13 of
            (ErlangAtom "false") -> ErlangAtom "false"
...
erlps__check_type__3 [(ErlangCons (ErlangTuple [(ErlangAtom "typed_record_field"),
  ...
  =
  let    arg_7 = toErl 2
  in let arg_6 = BIF.erlang__element__2 [arg_7, field_0]
  in let
    tup_el_5 =
      erlps__add_error__3 [arg_6, ErlangAtom "old_abstract_code", st_3]
  in ErlangTuple [seenvars_2, tup_el_5]
erlps__check_type__3 [i_0, seenvars_1, st_2] =
  let
    case_3 =
      BIF.do_remote_fun_call "Erl.Eval" "erlps__partial_eval__1" [i_0]
  in
    case case_3 of
      ...
      _other_9 ->
        let    arg_13 = toErl 2
        in let arg_12 = BIF.erlang__element__2 [arg_13, i_0]
        in let
          arg_15 =
            ErlangTuple [ErlangAtom "type_syntax", ErlangAtom "integer"]
  ...
  in
    case case_5 of
      (ErlangTuple [(ErlangAtom "ok"),
        ...
        in let
          case_13 =
            BIF.do_remote_fun_call "Lists" "erlps__all__2" [arg_14, fields_2]
        in
          case case_13 of
            (ErlangAtom "true") ->
...
erlps__check_record_types__5 args =
  EXC.badarity (ErlangFun 5 erlps__check_record_types__5) args
  ...
  in let
    st2_28 =
      case case_19 of
        ...
        something_else -> EXC.case_clause something_else
  in let
    matchExpr_34 = erlps__check_type__3 [type_2, seenvars_6, st2_28]
  in
    case matchExpr_34 of
...
erlps__check_record_types__6 args =
  EXC.badarity (ErlangFun 6 erlps__check_record_types__6) args
...
erlps__used_type__3 args =
  EXC.badarity (ErlangFun 3 erlps__used_type__3) args
...
erlps__is_default_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_default_type__1) args
...
erlps__is_newly_introduced_builtin_type__1 args =
  EXC.badarity
    (ErlangFun 1 erlps__is_newly_introduced_builtin_type__1) args
...
erlps__is_obsolete_builtin_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_obsolete_builtin_type__1)
    args
...
erlps__obsolete_builtin_type__1 [(ErlangTuple [(ErlangInt num_0),
                                               (ErlangInt num_1)])]
  | (ErlangInt num_0) == (toErl 1)
  , (ErlangInt num_1) == (toErl 255) =
  let    tup_el_4 = toErl 2
  in let tup_el_5 = toErl 255
  in let tup_el_3 = ErlangTuple [tup_el_4, tup_el_5]
  in let tup_el_6 = toErl ""
...
erlps__obsolete_builtin_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__obsolete_builtin_type__1) args
  ...
  in
    case matchExpr_16 of
      (ErlangTuple [_, _, arity_15]) ->
        let    arg_19 = toErl 1
        in let arg_18 = BIF.erlang__element__2 [arg_19, matchExpr_16]
        in let
          st0_23 = erlps__check_module_name__3 [arg_18, line_0, st00_5]
        in let
          record_updt_25 = BIF.maps__put__3 [matchExpr_16, line_0, specs_4]
        in let
          st1_63 =
            case st0_23 of
              ...
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let
          case_64 = BIF.erlang__is_map_key__2 [matchExpr_16, specs_4]
        in
          case case_64 of
            (ErlangAtom "true") ->
            ...
            (ErlangAtom "false") ->
              case matchExpr_16 of
                ...
                _ ->
                  let
                    arg_79 = ErlangTuple [ErlangAtom "bad_module", matchExpr_16]
...
erlps__spec_decl__4 args =
  EXC.badarity (ErlangFun 4 erlps__spec_decl__4) args
...
erlps__callback_decl__4 [line_0, mfa0_1, typespecs_2,
  ...
  case mfa0_1 of
    (ErlangTuple [m_7, _f_8, _a_9]) ->
      let    st1_13 = erlps__check_module_name__3 [m_7, line_0, st0_5]
      in let arg_15 = ErlangTuple [ErlangAtom "bad_callback", mfa0_1]
      ...
      in let
        st1_64 =
          case st0_5 of
            ...
            _ -> EXC.badrecord (ErlangAtom "lint")
      in let case_65 = BIF.erlang__is_map_key__2 [mfa_24, callbacks_4]
      in
        case case_65 of
          (ErlangAtom "true") ->
            let arg_69 = ErlangTuple [ErlangAtom "redefine_callback", mfa0_1]
...
erlps__callback_decl__4 args =
  EXC.badarity (ErlangFun 4 erlps__callback_decl__4) args

erlps__optional_callbacks__3 :: ErlangFun
erlps__optional_callbacks__3 [line_0, term_1, st0_2] =
  EXC.tryOfCatch
    (\ _ ->
       let matchExpr_4 = erlps__is_fa_list__1 [term_1]
       in
         case matchExpr_4 of
           (ErlangAtom "true") -> term_1
           _ -> EXC.badmatch matchExpr_4)
    (\ of_5 -> erlps__optional_cbs__3 [line_0, of_5, st0_2])
    (\ ex_6 ->
       case ex_6 of
         (ErlangTuple [_, _, _]) -> st0_2
         ex_7 -> EXC.raise ex_7)
erlps__optional_callbacks__3 [arg_12, arg_13, arg_14] =
  EXC.function_clause unit
erlps__optional_callbacks__3 args =
  EXC.badarity (ErlangFun 3 erlps__optional_callbacks__3) args
...
erlps__optional_cbs__3 [line_0,
  ...
  case st0_4 of
    (ErlangTuple [(ErlangAtom "lint"), _, mod_5, _, _, _, _, _, _, _,
      ...
      in let
        record_updt_13 = BIF.maps__put__3 [mfa_11, line_0, optionalcbs_6]
      in let
        st1_51 =
          case st0_4 of
            (ErlangTuple [(ErlangAtom "lint"), state_17, module_18,
...
erlps__optional_cbs__3 args =
  EXC.badarity (ErlangFun 3 erlps__optional_cbs__3) args
...
erlps__is_fa__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_fa__1) args
...
erlps__check_module_name__3 args =
  EXC.badarity (ErlangFun 3 erlps__check_module_name__3) args
...
erlps__is_latin1_name__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_latin1_name__1) args
...
erlps__check_specs__4 args =
  EXC.badarity (ErlangFun 4 erlps__check_specs__4) args

erlps__nowarn__0 :: ErlangFun
erlps__nowarn__0 [] =
  let    arg_0 = toErl 0
  in let
    a0_1 = BIF.do_remote_fun_call "Erl.Anno" "erlps__new__1" [arg_0]
  in let
    a1_4 =
...
erlps__nowarn__0 args =
  EXC.badarity (ErlangFun 0 erlps__nowarn__0) args
...
erlps__check_specs_without_function__1 args =
  EXC.badarity (ErlangFun 1 erlps__check_specs_without_function__1)
    args
...
erlps__check_functions_without_spec__2 [forms_0, st0_1] =
  let
    case_2 =
      erlps__is_warn_enabled__2 [ErlangAtom "missing_spec_all", st0_1]
  in
    case case_2 of
      (ErlangAtom "true") ->
...
erlps__check_functions_without_spec__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_functions_without_spec__2)
    args
    ...
    arg_4 =
      case st0_1 of
        (ErlangTuple arr_7) | (DM.Just field_6) <- (arr_7 DA.!! 27) ->
          field_6
        _ -> EXC.badrecord (ErlangAtom "lint")
  in let lcSrc_3 = BIF.maps__keys__1 [arg_4]
  in let
    specs_15 =
      flmap
        (\ lc_11 ->
           case lc_11 of
             (ErlangTuple [_m_8, f_9, a_10]) ->
               let lcRet_12 = ErlangTuple [f_9, a_10]
               in ErlangCons lcRet_12 ErlangEmptyList
             _ -> ErlangEmptyList)
        lcSrc_3
  in let
      ...
      case type_2 of
        (ErlangAtom "all") ->
          flmap
            (\ lc_21 ->
               case lc_21 of
                 (ErlangTuple [(ErlangAtom "function"), l_18, f_19, a_20, _]) ->
                   ...
                   in
                     case cond_22 of
                       (ErlangAtom "true") ->
                         let lcRet_29 = ErlangTuple [fa_27, l_18]
        ...
        (ErlangAtom "exported") ->
          let   
            arg_33 =
              case st0_1 of
                (ErlangTuple arr_36) | (DM.Just field_35) <- (arr_36 DA.!! 4) ->
                  field_35
                _ -> EXC.badrecord (ErlangAtom "lint")
          in let
            lop_32 =
                 ...
                 case lc_46 of
                   (ErlangTuple [(ErlangAtom "function"), l_43, f_44, a_45,
                     ...
                     in
                       case cond_47 of
                         (ErlangAtom "true") ->
                           let lcRet_53 = ErlangTuple [fa_51, l_43]
...
erlps__add_missing_spec_warnings__3 args =
  EXC.badarity (ErlangFun 3 erlps__add_missing_spec_warnings__3)
    args
...
erlps__check_unused_types__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_unused_types__2) args
    ...
    case case_5 of
      (ErlangCons firstfile_12 _) ->
        let   
          d_16 =
            case usage_1 of
              (ErlangTuple arr_15) | (DM.Just field_14) <- (arr_15 DA.!! 4) ->
                field_14
              _ -> EXC.badrecord (ErlangAtom "usage")
        in let
          lop_17 =
...
erlps__check_unused_types_1__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_unused_types_1__2) args
                 ...
                 in
                   case case_13 of
                     ...
                     (ErlangAtom "false") ->
                       ...
                       in erlps__add_warning__3 [fileline_11, warn_18, accst_12]
                     something_else -> EXC.case_clause something_else
               lambda_4 [arg_5, arg_6, arg_7] = EXC.function_clause unit
               lambda_4 args = EXC.badarity (ErlangFun 3 lambda_4) args
             in lambda_4)
...
erlps__check_local_opaque_types__1 args =
  EXC.badarity (ErlangFun 1 erlps__check_local_opaque_types__1)
    args
                 ...
                 flmap
                   (\ lc_11 ->
                                  ...
                                  (\ lc_21 ->
                                     let
                                       lcSrc_22 =
                                         BIF.do_remote_fun_call "Lists"
                                           "erlps__flatten__1"
                                           [ErlangCons f_15 ErlangEmptyList]
                                     in
                                       flmap
                                         (\ lc_27 ->
                                            let
                                              lcRet_28 =
                                                ErlangTuple [lc_21, lc_27]
                                            in
                                              ErlangCons lcRet_28
                                                ErlangEmptyList)
                                         lcSrc_22)
                      ...
                      in
                        flmap
                          (\ lc_35 ->
                             let lcRet_36 = ErlangTuple [l_3, lc_35]
                             in ErlangCons lcRet_36 ErlangEmptyList)
                          lcSrc_12)
                   lcSrc_6
             _ -> ErlangEmptyList)
    ...
    case matchExpr_50 of
      (ErlangTuple [wellformed_48, bad_49]) ->
        ...
        in let
          arg_67 =
            case st0_1 of
              (ErlangTuple arr_70) | (DM.Just field_69) <- (arr_70 DA.!! 10) ->
                field_69
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let
          lop_66 =
        ...
        in let deffunctions_72 = BIF.erlang__op_unAppend [lop_66, rop_71]
        in let
          fun_105 =
            ErlangFun 2
              (let
                 lambda_73 [(ErlangTuple [l_76,
                   ...
                   =
                   let
                     case_80 = erlps__is_function_dialyzer_option__1 [option_77]
                   in
                     case case_80 of
                       (ErlangAtom "true") ->
                         let
                           ...
                           case case_82 of
                             ...
                             (ErlangAtom "false") ->
                               let
                                 arg_86 =
                                   ErlangTuple
                                     [ErlangAtom "undefined_function", fa_78]
                 ...
                 lambda_73 [(ErlangTuple [l_95, option_96]), st_97] =
                   let case_98 = erlps__is_module_dialyzer_option__1 [option_96]
                   in
                     case case_98 of
...
erlps__check_dialyzer_attribute__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_dialyzer_attribute__2)
    args
...
erlps__is_function_dialyzer_option__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_function_dialyzer_option__1)
    args
                      ...
                      (ErlangCons (ErlangAtom "no_fail_call")
                         (ErlangCons (ErlangAtom "no_contracts")
                            (ErlangCons (ErlangAtom "no_behaviours")
                               (ErlangCons (ErlangAtom "no_undefined_callbacks")
...
erlps__is_module_dialyzer_option__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_module_dialyzer_option__1)
    args

erlps__try_clauses__6 :: ErlangFun
erlps__try_clauses__6 [scs_0, ccs_1, in_2, vt_3, uvt_4, st0_5] =
  let matchExpr_11 = erlps__icrt_clauses__3 [scs_0, vt_3, st0_5]
  in
    case matchExpr_11 of
      (ErlangTuple [csvt0_9, st1_10]) ->
        ...
        in let
          matchExpr_56 = erlps__icrt_clauses__3 [ccs_1, arg_50, st2_48]
        in
                ...
                tup_el_66 =
                  case st3_55 of
                    (ErlangTuple [(ErlangAtom "lint"), state_69, module_70,
                                  ...
                                  gexpr_context_102]) ->
                      ErlangTuple
                        [ErlangAtom "lint", state_69, module_70, behaviour_71,
                         exports_72, imports_73, compile_74, records_75,
                         locals_76, no_auto_77, defined_78, on_load_79,
                         on_load_line_80, clashes_81, not_deprecated_82,
                         not_removed_83, func_84, warn_format_85,
                         enabled_warnings_86, nowarn_bif_clash_87, errors_88,
                         warnings_89, file_90, recdef_top_91, xqlc_92,
                         called_93, usage_94, specs_95, callbacks_96,
                         optional_callbacks_97, types_98, exp_types_99,
                         ErlangAtom "false", bvt_101, gexpr_context_102]
                    _ -> EXC.badrecord (ErlangAtom "lint")
...
erlps__try_clauses__6 args =
  EXC.badarity (ErlangFun 6 erlps__try_clauses__6) args

erlps__icrt_clauses__4 :: ErlangFun
erlps__icrt_clauses__4 [cs_0, in_1, vt_2, st0_3] =
  let matchExpr_9 = erlps__icrt_clauses__3 [cs_0, vt_2, st0_3]
  in
    case matchExpr_9 of
      (ErlangTuple [csvt_7, st1_8]) ->
        let updvt_14 = erlps__icrt_export__4 [csvt_7, vt_2, in_1, st1_8]
        in ErlangTuple [updvt_14, st1_8]
      _ -> EXC.badmatch matchExpr_9
erlps__icrt_clauses__4 [arg_17, arg_18, arg_19, arg_20] =
  EXC.function_clause unit
erlps__icrt_clauses__4 args =
  EXC.badarity (ErlangFun 4 erlps__icrt_clauses__4) args
...
erlps__icrt_clauses__3 [cs_0, vt_1, st_2] =
  let
    arg_3 =
      ErlangFun 2
        (let
           lambda_4 [c_7, st0_8] = erlps__icrt_clause__3 [c_7, vt_1, st0_8]
           lambda_4 [arg_5, arg_6] = EXC.function_clause unit
           lambda_4 args = EXC.badarity (ErlangFun 2 lambda_4) args
         in lambda_4)
  in
...
erlps__icrt_clauses__3 args =
  EXC.badarity (ErlangFun 3 erlps__icrt_clauses__3) args
...
erlps__icrt_clause__3 [(ErlangTuple [(ErlangAtom "clause"),
  ...
  in let matchExpr_16 = erlps__head__3 [h_1, vt1_9, st0_5]
  in
    case matchExpr_16 of
        ...
        in let
          arg_28 =
            case st1_15 of
              ...
              _ -> EXC.badrecord (ErlangAtom "lint")
        in let matchExpr_67 = erlps__guard__3 [g_2, arg_25, arg_28]
        in
          case matchExpr_67 of
            (ErlangTuple [gvt_65, st2_66]) ->
              let    vt4_70 = erlps__vtupdate__2 [gvt_65, vt2_19]
              in let arg_72 = erlps__vtupdate__2 [vt4_70, vt0_4]
              in let matchExpr_78 = erlps__exprs__3 [b_3, arg_72, st2_66]
              in
            ...
            _ -> EXC.badmatch matchExpr_67
      _ -> EXC.badmatch matchExpr_16
erlps__icrt_clause__3 [arg_83, arg_84, arg_85] =
  EXC.function_clause unit
erlps__icrt_clause__3 args =
  EXC.badarity (ErlangFun 3 erlps__icrt_clause__3) args
              ...
              ErlangFun 1
                (let
                   lambda_6 [(ErlangTuple [v_8,
                     ...
                     let
                       tup_el_12 =
                         ErlangTuple [ErlangAtom "stacktrace", used_9, lines_10]
...
erlps__taint_stack_var__3 args =
  EXC.badarity (ErlangFun 3 erlps__taint_stack_var__3) args

erlps__icrt_export__4 :: ErlangFun
erlps__icrt_export__4 [vts_0, vt_1,
                       (ErlangTuple [tag_2, attrs_3]), st_4]
  =
  let matchExpr_9 = erlps__loc__2 [attrs_3, st_4]
  in
    case matchExpr_9 of
      (ErlangTuple [_file_7, loc_8]) ->
        let   
          arg_10 = BIF.do_remote_fun_call "Lists" "erlps__merge__1" [vts_0]
...
erlps__icrt_export__4 args =
  EXC.badarity (ErlangFun 4 erlps__icrt_export__4) args
      ...
      (ErlangTuple [vvs_16, vs_17]) ->
        ...
        in let
          s_29 =
            BIF.do_remote_fun_call "Lists" "erlps__foldl__3"
              [arg_19, s0_3, vvs_16]
        in let tup_el_37 = ErlangTuple [s_29, ErlangAtom "used", ls_4]
            ...
            ErlangFun 2
              (let
                 lambda_16 [(ErlangTuple [_,
                   ...
                   in let tup_el_35 = BIF.erlang__op_plus [acci_22, rop_37]
                   in ErlangTuple [tup_el_35, accs_30, accls_34]
                 lambda_16 [arg_17, arg_18] = EXC.function_clause unit
                 lambda_16 args = EXC.badarity (ErlangFun 2 lambda_16) args
               in lambda_16)
        in let tup_el_43 = toErl 0
        in let tup_el_44 = ErlangTuple [ErlangAtom "export", in_3]
        in let
          arg_42 = ErlangTuple [tup_el_43, tup_el_44, ErlangEmptyList]
        in let
          matchExpr_52 =
            BIF.do_remote_fun_call "Lists" "erlps__foldl__3"
              [f_40, arg_42, vvs_13]
...
erlps__icrt_export__5 args =
  EXC.badarity (ErlangFun 5 erlps__icrt_export__5) args

erlps__handle_comprehension__4 :: ErlangFun
erlps__handle_comprehension__4 [e_0, qs_1, vt0_2, st0_3] =
  let matchExpr_10 = erlps__lc_quals__3 [qs_1, vt0_2, st0_3]
  in
    case matchExpr_10 of
      (ErlangTuple [vt1_7, uvt_8, st1_9]) ->
        let matchExpr_16 = erlps__expr__3 [e_0, vt1_7, st1_9]
        in
          case matchExpr_16 of
                        ...
                        (ErlangTuple [_, st4_28]) ->
                          ...
                          in
                            case matchExpr_34 of
                              (ErlangTuple [_, st_33]) ->
                                let   
                                  arg_35 = erlps__vtsubtract__2 [vt2_19, uvt_8]
                                in let
                                  vt3_39 = erlps__vtmerge__2 [arg_35, uvt_8]
                                in let vt4_42 = erlps__vtold__2 [vt3_39, vt0_2]
                                in let arg_43 = erlps__vt_no_unused__1 [vt4_42]
...
erlps__handle_comprehension__4 args =
  EXC.badarity (ErlangFun 4 erlps__handle_comprehension__4) args
...
erlps__lc_quals__3 args =
  EXC.badarity (ErlangFun 3 erlps__lc_quals__3) args
...
erlps__lc_quals__4 args =
  EXC.badarity (ErlangFun 4 erlps__lc_quals__4) args
...
erlps__is_guard_test2_info__1 [arg_13] = EXC.function_clause unit
erlps__is_guard_test2_info__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_guard_test2_info__1) args

erlps__handle_generator__5 :: ErlangFun
erlps__handle_generator__5 [p_0, e_1, vt_2, uvt_3, st0_4] =
  let matchExpr_10 = erlps__expr__3 [e_1, vt_2, st0_4]
  in
    case matchExpr_10 of
      (ErlangTuple [evt_8, st1_9]) ->
        ...
        in let
          matchExpr_20 = erlps__check_unused_vars__3 [evt_8, vt_2, st1_9]
        in
          case matchExpr_20 of
              ...
              in
                case matchExpr_28 of
                  (ErlangTuple [pvt_25, pnew_26, st3_27]) ->
                    ...
                    in let
                      matchExpr_44 =
                        erlps__check_old_unused_vars__3 [svt_39, uvt_3, st4_36]
                    in
                      case matchExpr_44 of
                        (ErlangTuple [_, st5_43]) ->
                          ...
                          in let arg_50 = erlps__vtsubtract__2 [vt2_31, pnew_26]
...
erlps__handle_generator__5 args =
  EXC.badarity (ErlangFun 5 erlps__handle_generator__5) args
      ...
      (ErlangTuple [(ErlangAtom "bin_element"), line_4, _,
        ...
        in let
          case_6 =
            case lop_7 of
              (ErlangAtom "true") -> ErlangAtom "true"
              (ErlangAtom "false") ->
                let lop_10 = BIF.lists__member__2 [ErlangAtom "bytes", flags_5]
                in
                  case lop_10 of
                    (ErlangAtom "true") -> ErlangAtom "true"
                    (ErlangAtom "false") ->
        ...
        in
          case case_6 of
            (ErlangAtom "true") ->
              erlps__add_error__3
                [line_4, ErlangAtom "unsized_binary_in_bin_gen_pattern", st_1]
            (ErlangAtom "false") -> st_1
            something_else -> EXC.case_clause something_else
      _ -> st_1
...
erlps__handle_bitstring_gen_pat__2 args =
  EXC.badarity (ErlangFun 2 erlps__handle_bitstring_gen_pat__2)
    args
      ...
      ErlangFun 2
        (let
           lambda_8 [c_11, (ErlangTuple [bvt0_12, st0_13])] =
             let matchExpr_19 = erlps__fun_clause__3 [c_11, vt_1, st0_13]
             in
               case matchExpr_19 of
...
erlps__fun_clauses__3 args =
  EXC.badarity (ErlangFun 3 erlps__fun_clauses__3) args
                          ...
                          in
                            case matchExpr_57 of
                              (ErlangTuple [_, st6_56]) ->
                                let   
                                  arg_59 = erlps__vtsubtract__2 [cvt_44, svt_52]
                                in let
...
erlps__fun_clause__3 args =
  EXC.badarity (ErlangFun 3 erlps__fun_clause__3) args
        ...
        in
          case case_20 of
            (ErlangTuple [(ErlangAtom "ok"),
              ...
              let   
                tup_el_28 =
                  ErlangTuple [ErlangAtom "bound", ErlangAtom "used", ls_24]
              in let head_26 = ErlangTuple [v_0, tup_el_28]
              in
                ErlangTuple
                  [ErlangCons head_26 ErlangEmptyList, ErlangEmptyList, st_4]
            (ErlangTuple [(ErlangAtom "ok"),
              ...
              let   
                tup_el_41 =
                  ErlangTuple [ErlangAtom "bound", ErlangAtom "used", ls_37]
              in let head_39 = ErlangTuple [v_0, tup_el_41]
              in let arg_49 = ErlangTuple [ErlangAtom "unsafe_var", v_0, in_35]
            ...
            (ErlangTuple [(ErlangAtom "ok"),
              ...
              let   
                tup_el_60 =
                  ErlangTuple [ErlangAtom "bound", ErlangAtom "used", ls_56]
              in let head_58 = ErlangTuple [v_0, tup_el_60]
              in let
                arg_68 = ErlangTuple [ErlangAtom "exported_var", v_0, from_54]
            ...
            (ErlangTuple [(ErlangAtom "ok"),
              ...
              let   
                tup_el_78 =
                  ErlangTuple [ErlangAtom "bound", ErlangAtom "used", ls_74]
              in let head_76 = ErlangTuple [v_0, tup_el_78]
              in let arg_86 = ErlangTuple [ErlangAtom "stacktrace_bound", v_0]
            ...
            (ErlangAtom "error") | (ErlangAtom "true") ==
              ...
              in let
                arg_106 = ErlangTuple [ErlangAtom "variable_in_record_def", v_0]
            ...
            (ErlangAtom "error") ->
              ...
              in
                ErlangTuple
                  [ErlangEmptyList, ErlangCons head_112 ErlangEmptyList, st_4]
            something_else -> EXC.case_clause something_else
      something_else -> EXC.case_clause something_else
erlps__pat_var__5 [arg_122, arg_123, arg_124, arg_125, arg_126] =
  EXC.function_clause unit
erlps__pat_var__5 args =
  EXC.badarity (ErlangFun 5 erlps__pat_var__5) args
        ...
        in
          case case_20 of
            ...
            (ErlangTuple [(ErlangAtom "ok"),
              ...
              in let head_58 = ErlangTuple [v_0, tup_el_60]
              in let
                tup_el_66 = erlps__exported_var__4 [line_1, v_0, from_54, st_4]
              in
                ErlangTuple
                  [ErlangCons head_58 ErlangEmptyList, ErlangEmptyList,
                   tup_el_66]
...
erlps__pat_binsize_var__5 args =
  EXC.badarity (ErlangFun 5 erlps__pat_binsize_var__5) args
...
erlps__expr_var__4 args =
  EXC.badarity (ErlangFun 4 erlps__expr_var__4) args
  ...
  in
    case case_4 of
      ...
      (ErlangTuple [(ErlangAtom "ok"),
        ...
        in let arg_31 = ErlangTuple [ErlangAtom "unsafe_var", v_0, in_18]
        in let tup_el_29 = erlps__add_error__3 [line_1, arg_31, st_3]
        in ErlangTuple [ErlangCons head_22 ErlangEmptyList, tup_el_29]
      (ErlangTuple [(ErlangAtom "ok"),
                    (ErlangTuple [(ErlangTuple [(ErlangAtom "export"),
                                                from_36]),
                                  _usage_37, ls_38])]) ->
        ...
        in
          case case_39 of
            (ErlangAtom "true") ->
              let   
                tup_el_45 =
                  ErlangTuple [ErlangAtom "bound", ErlangAtom "used", ls_38]
              in let head_43 = ErlangTuple [v_0, tup_el_45]
              in let
                arg_52 = ErlangTuple [ErlangAtom "exported_var", v_0, from_36]
              in let tup_el_50 = erlps__add_warning__3 [line_1, arg_52, st_3]
              in ErlangTuple [ErlangCons head_43 ErlangEmptyList, tup_el_50]
            (ErlangAtom "false") ->
              let    tup_el_61 = ErlangTuple [ErlangAtom "export", from_36]
              in let
                tup_el_60 = ErlangTuple [tup_el_61, ErlangAtom "used", ls_38]
              in let head_58 = ErlangTuple [v_0, tup_el_60]
      ...
      (ErlangTuple [(ErlangAtom "ok"),
        ...
        in let arg_80 = ErlangTuple [ErlangAtom "stacktrace_guard", v_0]
        in let tup_el_78 = erlps__add_error__3 [line_1, arg_80, st_3]
        in ErlangTuple [ErlangCons head_71 ErlangEmptyList, tup_el_78]
      (ErlangAtom "error") ->
        let   
          tup_el_87 =
            ErlangTuple
        ...
        in ErlangTuple [ErlangCons head_85 ErlangEmptyList, tup_el_94]
      something_else -> EXC.case_clause something_else
erlps__do_expr_var__4 [arg_100, arg_101, arg_102, arg_103] =
  EXC.function_clause unit
erlps__do_expr_var__4 args =
  EXC.badarity (ErlangFun 4 erlps__do_expr_var__4) args
...
erlps__exported_var__4 [line_0, v_1, from_2, st_3] =
  ...
  in
    case case_4 of
      (ErlangAtom "true") ->
        let arg_8 = ErlangTuple [ErlangAtom "exported_var", v_1, from_2]
...
erlps__exported_var__4 args =
  EXC.badarity (ErlangFun 4 erlps__exported_var__4) args
...
erlps__shadow_vars__4 args =
  EXC.badarity (ErlangFun 4 erlps__shadow_vars__4) args
...
erlps__check_unused_vars__3 args =
  EXC.badarity (ErlangFun 3 erlps__check_unused_vars__3) args
...
erlps__check_old_unused_vars__3 args =
  EXC.badarity (ErlangFun 3 erlps__check_old_unused_vars__3) args
...
erlps__unused_vars__3 [vt_0, vt0_1, _st0_2] =
  ...
  in let
    u0_16 =
      BIF.do_remote_fun_call "Orddict" "erlps__filter__2" [arg_3, vt_0]
  in erlps__vtnew__2 [u0_16, vt0_1]
erlps__unused_vars__3 [arg_19, arg_20, arg_21] =
  EXC.function_clause unit
erlps__unused_vars__3 args =
  EXC.badarity (ErlangFun 3 erlps__unused_vars__3) args
                         ...
                         ErlangFun 2
                           (let
                              lambda_14 [l_17, st2_18] =
                                let
                                  arg_20 =
                                    ErlangTuple [ErlangAtom "unused_var", v_10]
                                in erlps__add_warning__3 [l_17, arg_20, st2_18]
      ...
      ErlangFun 1
        (let
           lambda_30 [(ErlangTuple [v_32,
             ...
             =
             let tup_el_36 = ErlangTuple [state_33, ErlangAtom "used", ls_34]
...
erlps__warn_unused_vars__3 args =
  EXC.badarity (ErlangFun 3 erlps__warn_unused_vars__3) args
  ...
  in
    case case_2 of
      (ErlangTuple [(ErlangAtom "ok"),
        ...
        ErlangAtom "true"
      _ -> ErlangAtom "false"
erlps__is_var_bound__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__is_var_bound__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_var_bound__2) args
...
erlps__vtupdate__2 args =
  EXC.badarity (ErlangFun 2 erlps__vtupdate__2) args
  ...
  let   
    line_5 =
      BIF.do_remote_fun_call "Erl.Anno" "erlps__location__1"
        [fileline_1]
  in let lcSrc_6 = erlps__vtnew__2 [uvt_2, vt_3]
  in
    flmap
      (\ lc_12 ->
         case lc_12 of
           (ErlangTuple [v_9, (ErlangTuple [_, u_10, ls_11])]) ->
             ...
             in let tup_el_16 = ErlangTuple [ErlangAtom "unsafe", tup_el_18]
             in let tup_el_15 = ErlangTuple [tup_el_16, u_10, ls_11]
             in let lcRet_13 = ErlangTuple [v_9, tup_el_15]
             in ErlangCons lcRet_13 ErlangEmptyList
           _ -> ErlangEmptyList)
      lcSrc_6
...
erlps__vtunsafe__3 args =
  EXC.badarity (ErlangFun 3 erlps__vtunsafe__3) args
...
erlps__vtmerge__2 args =
  EXC.badarity (ErlangFun 2 erlps__vtmerge__2) args
...
erlps__vtmerge__1 args =
  EXC.badarity (ErlangFun 1 erlps__vtmerge__1) args
...
erlps__vtmerge_pat__2 [vt1_0, vt2_1] =
  ...
  in
    BIF.do_remote_fun_call "Orddict" "erlps__merge__3"
      [arg_2, vt1_0, vt2_1]
erlps__vtmerge_pat__2 [arg_23, arg_24] = EXC.function_clause unit
erlps__vtmerge_pat__2 args =
  EXC.badarity (ErlangFun 2 erlps__vtmerge_pat__2) args

erlps__merge_lines__2 :: ErlangFun
erlps__merge_lines__2 [ls1_0, ls2_1] =
  BIF.do_remote_fun_call "Ordsets" "erlps__union__2" [ls1_0, ls2_1]
erlps__merge_lines__2 [arg_4, arg_5] = EXC.function_clause unit
erlps__merge_lines__2 args =
  EXC.badarity (ErlangFun 2 erlps__merge_lines__2) args
...
erlps__merge_state__2 args =
  EXC.badarity (ErlangFun 2 erlps__merge_state__2) args
...
erlps__merge_used__2 args =
  EXC.badarity (ErlangFun 2 erlps__merge_used__2) args
...
erlps__vtnew__2 args =
  EXC.badarity (ErlangFun 2 erlps__vtnew__2) args
...
erlps__vtsubtract__2 args =
  EXC.badarity (ErlangFun 2 erlps__vtsubtract__2) args
  ...
  let
    arg_2 =
      ErlangFun 2
        (let
           lambda_3 [v_6, _how_7] =
             BIF.do_remote_fun_call "Orddict" "erlps__is_key__2" [v_6, old_1]
           lambda_3 [arg_4, arg_5] = EXC.function_clause unit
           lambda_3 args = EXC.badarity (ErlangFun 2 lambda_3) args
         in lambda_3)
  in
...
erlps__vtold__2 args =
  EXC.badarity (ErlangFun 2 erlps__vtold__2) args
       ...
       case lc_6 of
         v_5@(ErlangTuple [_, (ErlangTuple [s_2, _u_3, _l_4])]) ->
           let
             cond_7 =
               case s_2 of
                 (ErlangTuple [(ErlangAtom "unsafe"), _]) -> ErlangAtom "false"
                 _ -> ErlangAtom "true"
           in
             case cond_7 of
...
erlps__vt_no_unsafe__1 args =
  EXC.badarity (ErlangFun 1 erlps__vt_no_unsafe__1) args
    ...
    (\ lc_5 ->
       case lc_5 of
         v_4@(ErlangTuple [_, (ErlangTuple [_, u_2, _l_3])]) ->
           let cond_6 = BIF.erlang__op_exactNeq [u_2, ErlangAtom "unused"]
           in
             case cond_6 of
...
erlps__vt_no_unused__1 args =
  EXC.badarity (ErlangFun 1 erlps__vt_no_unused__1) args
...
erlps__copy_expr__2 args =
  EXC.badarity (ErlangFun 2 erlps__copy_expr__2) args
...
erlps__check_record_info_call__4 args =
  EXC.badarity (ErlangFun 4 erlps__check_record_info_call__4) args
...
erlps__has_wildcard_field__1 args =
  EXC.badarity (ErlangFun 1 erlps__has_wildcard_field__1) args
...
erlps__check_remote_function__5 [line_0, m_1, f_2, as_3, st0_4] =
  ...
  in let
    st2_16 = erlps__check_qlc_hrl__5 [line_0, m_1, f_2, as_3, st1_10]
  in let
    st3_22 =
...
erlps__check_remote_function__5 args =
  EXC.badarity (ErlangFun 5 erlps__check_remote_function__5) args
...
erlps__check_load_nif__5 [line_0, (ErlangAtom "erlang"),
  ...
  in
    case case_2 of
      (ErlangAtom "true") -> erlps__check_nif_inline__2 [line_0, st_1]
      (ErlangAtom "false") -> st_1
      something_else -> EXC.case_clause something_else
...
erlps__check_load_nif__5 args =
  EXC.badarity (ErlangFun 5 erlps__check_load_nif__5) args
...
erlps__check_nif_inline__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_nif_inline__2) args
...
erlps__is_inline_opt__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_inline_opt__1) args
                                                      ...
                                                      in
                                                        case lop_11 of
                                                          ...
                                                          _ ->
                                                            EXC.badarg1
                                                              lop_11)) ->
        let arg_25 = ErlangTuple [ErlangAtom "missing_qlc_hrl", arity_6]
...
erlps__check_qlc_hrl__5 args =
  EXC.badarity (ErlangFun 5 erlps__check_qlc_hrl__5) args
          ...
          case case_34 of
            ...
            (ErlangAtom "false") ->
              let
                arg_45 =
                  ErlangTuple
                    [ErlangAtom "deprecated", mfa_10, replacement_32, rel_33]
              in erlps__add_warning__3 [line_0, arg_45, st_4]
            something_else -> EXC.case_clause something_else
      (ErlangTuple [(ErlangAtom "removed"), string_51]) | isEList
                                                            string_51 ->
        let
          arg_54 = ErlangTuple [ErlangAtom "removed", mfa_10, string_51]
...
erlps__deprecated_function__5 args =
  EXC.badarity (ErlangFun 5 erlps__deprecated_function__5) args
...
erlps__add_removed_warning__4 [line_0,
  ...
  =
  let   
    lop_7 = erlps__is_warn_enabled__2 [ErlangAtom "removed", st_5]
  in let
    case_6 =
      case lop_7 of
        (ErlangAtom "false") -> ErlangAtom "false"
...
erlps__add_removed_warning__4 args =
  EXC.badarity (ErlangFun 4 erlps__add_removed_warning__4) args
...
erlps__deprecated_type__5 args =
  EXC.badarity (ErlangFun 5 erlps__deprecated_type__5) args
  ...
  in
    case case_7 of
      ...
      (ErlangAtom "true") ->
        let   
          case_15 =
            erlps__is_warn_enabled__2 [ErlangAtom "obsolete_guard", st0_4]
        in let
          st_25 =
            case case_15 of
              (ErlangAtom "true") ->
...
erlps__test_overriden_by_local__4 [line_0, oldtest_1, arity_2,
  ...
  in let
    arg_10 =
      case st_3 of
        (ErlangTuple arr_13) | (DM.Just field_12) <- (arr_13 DA.!! 8) ->
          field_12
        _ -> EXC.badrecord (ErlangAtom "lint")
  ...
  in
    case case_9 of
      (ErlangAtom "true") ->
        let
          arg_18 =
            ErlangTuple [ErlangAtom "obsolete_guard_overridden", oldtest_1]
...
erlps__test_overriden_by_local__4 args =
  EXC.badarity (ErlangFun 4 erlps__test_overriden_by_local__4)
    args
...
erlps__keyword_warning__3 args =
  EXC.badarity (ErlangFun 3 erlps__keyword_warning__3) args
    ...
    case case_5 of
      (ErlangAtom "true") ->
        let
          case_8 =
            case st_4 of
              (ErlangTuple arr_11) | (DM.Just field_10) <- (arr_11 DA.!! 17) ->
                field_10
              _ -> EXC.badrecord (ErlangAtom "lint")
        in
          case case_8 of
            lev_12 | weakGt lev_12 (toErl 0) ->
...
erlps__format_function__5 args =
  EXC.badarity (ErlangFun 5 erlps__format_function__5) args
...
erlps__check_format_1__1 [_as_0] =
  ...
  in let
    tup_el_3 = toErl "format call with wrong number of arguments"
  in
    ErlangTuple
      [ErlangAtom "warn", tup_el_2, tup_el_3, ErlangEmptyList]
erlps__check_format_1__1 [arg_5] = EXC.function_clause unit
erlps__check_format_1__1 args =
  EXC.badarity (ErlangFun 1 erlps__check_format_1__1) args
  ...
  let   
    arg_2 =
      ErlangFun 2
        (let
           lambda_3 [c_6, t_7] =
             let tup_el_10 = ErlangTuple [ErlangAtom "integer", line_0, c_6]
...
erlps__canonicalize_string__1 [arg_1] = EXC.function_clause unit
erlps__canonicalize_string__1 args =
  EXC.badarity (ErlangFun 1 erlps__canonicalize_string__1) args
...
erlps__check_format_2__2 [fmt_0, as_1] =
  case fmt_0 of
    ...
    _ ->
      ...
      in let tup_el_14 = toErl "format string not a textual constant"
      in
        ErlangTuple
          [ErlangAtom "warn", tup_el_13, tup_el_14, ErlangEmptyList]
erlps__check_format_2__2 [arg_16, arg_17] =
  EXC.function_clause unit
erlps__check_format_2__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_format_2__2) args
...
erlps__check_format_2a__2 [fmt_0, as_1] =
  ...
  in
    case case_2 of
      ...
      (ErlangAtom "false") ->
        let    tup_el_7 = toErl 1
        in let tup_el_8 = toErl "format arguments not a list"
        in
          ErlangTuple
            [ErlangAtom "warn", tup_el_7, tup_el_8, ErlangEmptyList]
      (ErlangAtom "maybe") ->
        let    tup_el_11 = toErl 2
        in let tup_el_12 = toErl "format arguments perhaps not a list"
        in
          ErlangTuple
            [ErlangAtom "warn", tup_el_11, tup_el_12, ErlangEmptyList]
      something_else -> EXC.case_clause something_else
erlps__check_format_2a__2 [arg_14, arg_15] =
  EXC.function_clause unit
erlps__check_format_2a__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_format_2a__2) args
        ...
        in
          case case_5 of
            ...
            _len_11 ->
              ...
              in let
                tup_el_14 = toErl "wrong number of arguments in format call"
              in
                ErlangTuple
                  [ErlangAtom "warn", tup_el_13, tup_el_14, ErlangEmptyList]
      (ErlangTuple [(ErlangAtom "error"), s_16]) ->
        let    tup_el_18 = toErl 1
        in let tup_el_19 = toErl "format string invalid (~ts)"
        in
          ErlangTuple
            [ErlangAtom "warn", tup_el_18, tup_el_19,
             ErlangCons s_16 ErlangEmptyList]
      something_else -> EXC.case_clause something_else
erlps__check_format_3__2 [arg_23, arg_24] =
  EXC.function_clause unit
erlps__check_format_3__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_format_3__2) args
...
erlps__args_list__1 args =
  EXC.badarity (ErlangFun 1 erlps__args_list__1) args
...
erlps__args_length__1 [(ErlangTuple [(ErlangAtom "cons"), _l_0,
  ...
  =
  let    lop_3 = toErl 1
  in let rop_4 = erlps__args_length__1 [t_2]
  in BIF.erlang__op_plus [lop_3, rop_4]
...
erlps__args_length__1 args =
  EXC.badarity (ErlangFun 1 erlps__args_length__1) args
...
erlps__check_format_string__1 [arg_3] = EXC.function_clause unit
erlps__check_format_string__1 args =
  EXC.badarity (ErlangFun 1 erlps__check_format_string__1) args

erlps__extract_sequences__2 :: ErlangFun
erlps__extract_sequences__2 [fmt_0, need0_1] =
  let    head_5 = toErl 126
  in let
    case_2 =
      BIF.do_remote_fun_call "String" "erlps__find__2"
        [fmt_0, ErlangCons head_5 ErlangEmptyList]
  in
    case case_2 of
      (ErlangAtom "nomatch") ->
        let
      ...
      (ErlangCons (ErlangInt num_10) fmt1_11) | (ErlangInt num_10) ==
        ...
        let    arg_13 = toErl 1
        in let
          case_12 = erlps__extract_sequence__3 [arg_13, fmt1_11, need0_1]
        in
          case case_12 of
...
erlps__extract_sequences__2 args =
  EXC.badarity (ErlangFun 2 erlps__extract_sequences__2) args
...
erlps__extract_sequence__3 [(ErlangInt num_0),
  ...
  , (weakGeq c_2 (toErl 48)) && (weakLeq c_2 (toErl 57)) =
  let arg_5 = toErl 1
  in erlps__extract_sequence_digits__3 [arg_5, fmt_3, need_4]
erlps__extract_sequence__3 [(ErlangInt num_0),
                            (ErlangCons c_1 fmt_2), need_3]
  | (ErlangInt num_0) == (toErl 1)
  , (weakGeq c_1 (toErl 48)) && (weakLeq c_1 (toErl 57)) =
  let arg_4 = toErl 1
  in erlps__extract_sequence_digits__3 [arg_4, fmt_2, need_3]
erlps__extract_sequence__3 [(ErlangInt num_0),
                            (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) fmt_3)),
                            need_4]
  | (ErlangInt num_0) == (toErl 1)
  , (ErlangInt num_1) == (toErl 45)
  , (ErlangInt num_2) == (toErl 42) =
  let arg_5 = toErl 2
  in
    erlps__extract_sequence__3
      [arg_5, fmt_3, ErlangCons (ErlangAtom "int") need_4]
erlps__extract_sequence__3 [(ErlangInt num_0),
  ...
  in
    erlps__extract_sequence__3
      [arg_4, fmt_2, ErlangCons (ErlangAtom "int") need_3]
...
erlps__extract_sequence__3 [(ErlangInt num_0),
  ...
  , (ErlangInt num_1) == (toErl 46) =
  let arg_4 = toErl 3
  in erlps__extract_sequence__3 [arg_4, fmt_2, need_3]
erlps__extract_sequence__3 [(ErlangInt num_0), fmt_1, need_2]
  | (ErlangInt num_0) == (toErl 2) =
  let arg_3 = toErl 4
  in erlps__extract_sequence__3 [arg_3, fmt_1, need_2]
...
erlps__extract_sequence__3__p1 [(ErlangInt num_0),
  ...
  let    arg_5 = toErl 4
  in let head_7 = toErl 108
  in let head_9 = toErl 116
  in
    erlps__extract_sequence__3
      [arg_5, ErlangCons head_7 (ErlangCons head_9 fmt_3), need_4]
erlps__extract_sequence__3__p1 [(ErlangInt num_0),
                                (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) fmt_3)),
                                need_4]
  | (ErlangInt num_0) == (toErl 4)
  , (ErlangInt num_1) == (toErl 116)
  , (ErlangInt num_2) == (toErl 99) =
  let    arg_5 = toErl 5
  in let head_7 = toErl 99
  in
    erlps__extract_sequence__3
      [arg_5, ErlangCons head_7 fmt_3, need_4]
erlps__extract_sequence__3__p1 [(ErlangInt num_0),
                                (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) fmt_3)),
                                need_4]
  | (ErlangInt num_0) == (toErl 4)
...
erlps__extract_sequence__3__p1 [(ErlangInt num_0),
  ...
  | (ErlangInt num_0) == (toErl 4)
  , (ErlangInt num_1) == (toErl 116)
  , (ErlangInt num_2) == (toErl 80) =
  let    arg_5 = toErl 5
  in let head_7 = toErl 80
  in
    erlps__extract_sequence__3
      [arg_5, ErlangCons head_7 fmt_3, need_4]
erlps__extract_sequence__3__p1 [(ErlangInt num_0),
  ...
  | (ErlangInt num_0) == (toErl 4)
  , (ErlangInt num_1) == (toErl 116)
  , (ErlangInt num_2) == (toErl 119) =
  let    arg_5 = toErl 5
  in let head_7 = toErl 119
  in
    erlps__extract_sequence__3
      [arg_5, ErlangCons head_7 fmt_3, need_4]
erlps__extract_sequence__3__p1 [(ErlangInt num_0),
  ...
  | (ErlangInt num_0) == (toErl 4)
  , (ErlangInt num_1) == (toErl 116)
  , (ErlangInt num_2) == (toErl 87) =
  let    arg_5 = toErl 5
  in let head_7 = toErl 87
  in
    erlps__extract_sequence__3
      [arg_5, ErlangCons head_7 fmt_3, need_4]
erlps__extract_sequence__3__p1 [(ErlangInt num_0),
  ...
  | (ErlangInt num_0) == (toErl 4)
  , (ErlangInt num_1) == (toErl 116) =
  let    lop_7 = toErl "invalid control ~t"
  in let
    tup_el_6 =
...
erlps__extract_sequence__3__p2 [(ErlangInt num_0),
  ...
  let    arg_6 = toErl 5
  in let head_8 = toErl 112
  in
    erlps__extract_sequence__3
      [arg_6, ErlangCons head_8 fmt_4, need_5]
erlps__extract_sequence__3__p2 [(ErlangInt num_0),
                                (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) fmt_3)),
                                need_4]
  | (ErlangInt num_0) == (toErl 4)
...
erlps__extract_sequence__3__p2 [(ErlangInt num_0),
  ...
  , (ErlangInt num_1) == (toErl 108)
  , (ErlangInt num_2) == (toErl 116) =
  let    lop_8 = toErl "invalid control ~lt"
  in let
    tup_el_7 =
...
erlps__extract_sequence__3__p2 [(ErlangInt num_0),
  ...
  | (ErlangInt num_0) == (toErl 4)
  , (ErlangInt num_1) == (toErl 108) =
  let    lop_7 = toErl "invalid control ~l"
  in let
    tup_el_6 =
      BIF.erlang__op_append [lop_7, ErlangCons c_2 ErlangEmptyList]
  in ErlangTuple [ErlangAtom "error", tup_el_6]
...
erlps__extract_sequence__3__p2 [(ErlangInt num_0),
  ...
  in
    case case_4 of
      (ErlangAtom "error") ->
        let    lop_9 = toErl "invalid control ~"
        in let
          tup_el_8 =
...
erlps__extract_sequence_digits__3 [fld_0, fmt_1, need_2] =
  let    rop_5 = toErl 1
  in let arg_3 = BIF.erlang__op_plus [fld_0, rop_5]
  in erlps__extract_sequence__3 [arg_3, fmt_1, need_2]
erlps__extract_sequence_digits__3 [arg_8, arg_9, arg_10] =
  EXC.function_clause unit
erlps__extract_sequence_digits__3 args =
  EXC.badarity (ErlangFun 3 erlps__extract_sequence_digits__3)
    args
...
erlps__control_type__2 [arg_2, arg_3] = EXC.function_clause unit
erlps__control_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__control_type__2) args
        ...
        (\ lc_5 ->
           case lc_5 of
             (ErlangTuple [(ErlangAtom "function"), _, func_3, arity_4, _]) ->
               let lcRet_6 = ErlangTuple [func_3, arity_4]
               in ErlangCons lcRet_6 ErlangEmptyList
             _ -> ErlangEmptyList)
        forms_0
  in BIF.do_remote_fun_call "Gb.Sets" "erlps__from_list__1" [arg_1]
erlps__local_functions__1 [arg_9] = EXC.function_clause unit
erlps__local_functions__1 args =
  EXC.badarity (ErlangFun 1 erlps__local_functions__1) args
...
erlps__is_local_function__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_local_function__2) args
...
erlps__is_imported_function__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_imported_function__2) args
...
erlps__is_imported_from_erlang__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_imported_from_erlang__2)
    args
                       ...
                       case cond_14 of
                         (ErlangAtom "true") ->
                           ...
                           in
                             case cond_16 of
                               (ErlangAtom "true") ->
                                 let lcRet_18 = ErlangTuple [y_11, z_12]
                                 in ErlangCons lcRet_18 ErlangEmptyList
                               _ -> ErlangEmptyList
                         _ -> ErlangEmptyList
                   _ -> ErlangEmptyList)
              lcSrc_9
        in BIF.do_remote_fun_call "Gb.Sets" "erlps__from_list__1" [l1_21]
      something_else -> EXC.case_clause something_else
erlps__auto_import_suppressed__1 [arg_23] =
  EXC.function_clause unit
erlps__auto_import_suppressed__1 args =
  EXC.badarity (ErlangFun 1 erlps__auto_import_suppressed__1) args
...
erlps__is_autoimport_suppressed__2 args =
  EXC.badarity (ErlangFun 2 erlps__is_autoimport_suppressed__2)
    args
...
erlps__bif_clash_specifically_disabled__2 args =
  EXC.badarity
    (ErlangFun 2 erlps__bif_clash_specifically_disabled__2) args
    ...
    case lop_3 of
      ...
      (ErlangAtom "true") ->
        let   
          arg_15 =
            case st_0 of
              (ErlangTuple arr_18) | (DM.Just field_17) <- (arr_18 DA.!! 5) ->
                field_17
              _ -> EXC.badrecord (ErlangAtom "lint")
        ...
        in
          case lop_12 of
            ...
            (ErlangAtom "true") ->
              ...
              in let
                op_arg_30 = erlps__is_autoimport_suppressed__2 [arg_31, arg_35]
...
erlps__no_guard_bif_clash__2 args =
  EXC.badarity (ErlangFun 2 erlps__no_guard_bif_clash__2) args
