...
erlps__exprs__3 [arg_8, arg_9, arg_10] = EXC.function_clause unit
...
erlps__exprs__4 [exprs_0, bs_1, lf_2, ef_3] =
  erlps__exprs__5 [exprs_0, bs_1, lf_2, ef_3, ErlangAtom "none"]
...
erlps__exprs__5 args =
  EXC.badarity (ErlangFun 5 erlps__exprs__5) args
...
erlps__expr__5 [(ErlangTuple [(ErlangAtom "tuple"), _, es_0]),
  ...
  =
  let matchExpr_11 = erlps__expr_list__4 [es_0, bs0_1, lf_2, ef_3]
  in
...
erlps__expr__5 [(ErlangTuple [(ErlangAtom "record_field"), _, _,
  ...
  =
  let    arg_6 = ErlangTuple [ErlangAtom "undef_record", name_0]
...
erlps__expr__5 [(ErlangTuple [(ErlangAtom "map"), _, binding_0,
  ...
  let
    matchExpr_13 =
      erlps__expr__5 [binding_0, bs0_2, lf_3, ef_4, ErlangAtom "none"]
  in
    case matchExpr_13 of
        ...
        in
          case matchExpr_20 of
            (ErlangTuple [vs_18, bs2_19]) ->
              let   
                matchExpr_24 =
                  BIF.maps__put__3 [ErlangAtom "k", ErlangAtom "v", map0_11]
              in let
                arg_25 =
                  ErlangFun 2
                    (let
          ...
          arg_13 =
            ErlangFun 2
              (let
               ...
               in lambda_14)
        in let arg_23 = BIF.do_remote_fun_call "Maps" "erlps__new__0" []
        in let
          arg_12 =
            BIF.do_remote_fun_call "Lists" "erlps__foldl__3"
              [arg_13, arg_23, vs_9]
...
erlps__expr__5 [ex_2@(ErlangTuple [(ErlangAtom "fun"), line_0,
  ...
  =
  let    arg_8 = toErl 0
  in let matchExpr_10 = erlps__hide_calls__2 [ex_2, arg_8]
  in
                ...
                f_977 =
                  case case_32 of
                    (ErlangInt num_37) | (ErlangInt num_37) == (toErl 0) ->
                      ErlangFun 0
                        (let
                         ...
                         in lambda_38)
                    (ErlangInt num_41) | (ErlangInt num_41) == (toErl 1) ->
                      ErlangFun 1
                        (let
                           lambda_42 [a_44] =
                             erlps__eval_fun__2
                         ...
                         in lambda_42)
                    (ErlangInt num_49) | (ErlangInt num_49) == (toErl 2) ->
                      ErlangFun 2
                        (let
                           lambda_50 [a_53, b_54] =
                             erlps__eval_fun__2
                               [ErlangCons a_53
                                ...
                                info_31]
                           lambda_50 [arg_51, arg_52] = EXC.function_clause unit
                           lambda_50 args =
                             EXC.badarity (ErlangFun 2 lambda_50) args
                         in lambda_50)
                    (ErlangInt num_61) | (ErlangInt num_61) == (toErl 3) ->
                      ErlangFun 3
                        (let
                         ...
                         in lambda_62)
                    (ErlangInt num_77) | (ErlangInt num_77) == (toErl 4) ->
                      ErlangFun 4
                        (let
                         ...
                         in lambda_78)
                    (ErlangInt num_97) | (ErlangInt num_97) == (toErl 5) ->
                      ErlangFun 5
                        (let
                         ...
                         in lambda_98)
                    (ErlangInt num_121) | (ErlangInt num_121) == (toErl 6) ->
                      ErlangFun 6
                        (let
                         ...
                         in lambda_122)
                    (ErlangInt num_149) | (ErlangInt num_149) == (toErl 7) ->
                      ErlangFun 7
                        (let
                    ...
                    (ErlangInt num_181) | (ErlangInt num_181) == (toErl 8) ->
                      ErlangFun 8
                        (let
                         ...
                         in lambda_182)
                    (ErlangInt num_217) | (ErlangInt num_217) == (toErl 9) ->
                      ErlangFun 9
                        (let
                         ...
                         in lambda_218)
                    (ErlangInt num_257) | (ErlangInt num_257) == (toErl 10) ->
                      ErlangFun 10
                        (let
                         ...
                         in lambda_258)
                    (ErlangInt num_301) | (ErlangInt num_301) == (toErl 11) ->
                      ErlangFun 11
                        (let
                         ...
                         in lambda_302)
                    (ErlangInt num_349) | (ErlangInt num_349) == (toErl 12) ->
                      ErlangFun 12
                        (let
                         ...
                         in lambda_350)
                    (ErlangInt num_401) | (ErlangInt num_401) == (toErl 13) ->
                      ErlangFun 13
                        (let
                         ...
                         in lambda_402)
                    (ErlangInt num_457) | (ErlangInt num_457) == (toErl 14) ->
                      ErlangFun 14
                        (let
                         ...
                         in lambda_458)
                    (ErlangInt num_517) | (ErlangInt num_517) == (toErl 15) ->
                      ErlangFun 15
                        (let
                         ...
                         in lambda_518)
                    (ErlangInt num_581) | (ErlangInt num_581) == (toErl 16) ->
                      ErlangFun 16
                        (let
                         ...
                         in lambda_582)
                    (ErlangInt num_649) | (ErlangInt num_649) == (toErl 17) ->
                      ErlangFun 17
                        (let
                         ...
                         in lambda_650)
                    (ErlangInt num_721) | (ErlangInt num_721) == (toErl 18) ->
                      ErlangFun 18
                        (let
                         ...
                         in lambda_722)
                    (ErlangInt num_797) | (ErlangInt num_797) == (toErl 19) ->
                      ErlangFun 19
                        (let
                         ...
                         in lambda_798)
                    (ErlangInt num_877) | (ErlangInt num_877) == (toErl 20) ->
                      ErlangFun 20
                        (let
                    ...
                    _other_961 ->
                      ...
                      in let
                        arg_965 =
                          ErlangTuple [ErlangAtom "argument_limit", tup_el_967]
                      in let arg_973 = toErl 2
                      in let arg_975 = BIF.erlang__self__0 []
                      in let
                        arg_974 =
                          BIF.erlang__process_info__2
                            [arg_975, ErlangAtom "current_stacktrace"]
                      in let arg_972 = BIF.erlang__element__2 [arg_973, arg_974]
                      in
                        BIF.erlang__raise__3
...
erlps__expr__5 [ex_3@(ErlangTuple [(ErlangAtom "named_fun"),
  ...
  =
  let    arg_9 = toErl 0
  in let matchExpr_11 = erlps__hide_calls__2 [ex_3, arg_9]
  in
    case matchExpr_11 of
          ...
          case matchExpr_17 of
            (ErlangTuple [(ErlangAtom "ok"), used_16]) ->
              ...
              in let
                f_1001 =
                  case case_34 of
                    (ErlangInt num_39) | (ErlangInt num_39) == (toErl 0) ->
                      ErlangFun 0
                        (let
                           rf_40 [] =
                           ...
                           rf_40 args = EXC.badarity (ErlangFun 0 rf_40) args
                         in rf_40)
                    (ErlangInt num_44) | (ErlangInt num_44) == (toErl 1) ->
                      ErlangFun 1
                        (let
                           rf_45 [a_47] =
                           ...
                           rf_45 args = EXC.badarity (ErlangFun 1 rf_45) args
                         in rf_45)
                    (ErlangInt num_53) | (ErlangInt num_53) == (toErl 2) ->
                      ErlangFun 2
                        (let
                           rf_54 [a_57, b_58] =
                           ...
                           rf_54 args = EXC.badarity (ErlangFun 2 rf_54) args
                         in rf_54)
                    (ErlangInt num_66) | (ErlangInt num_66) == (toErl 3) ->
                      ErlangFun 3
                        (let
                           ...
                           rf_67 [arg_68, arg_69, arg_70] =
                             EXC.function_clause unit
                           rf_67 args = EXC.badarity (ErlangFun 3 rf_67) args
                         in rf_67)
                    (ErlangInt num_83) | (ErlangInt num_83) == (toErl 4) ->
                      ErlangFun 4
                        (let
                             ...
                             in
                               erlps__eval_named_fun__3
                                 [ErlangCons a_89
                                    (ErlangCons b_90
                                       (ErlangCons c_91
                                          (ErlangCons d_92 ErlangEmptyList))),
                                  arg_102, info_33]
                           rf_84 [arg_85, arg_86, arg_87, arg_88] =
                             EXC.function_clause unit
                           rf_84 args = EXC.badarity (ErlangFun 4 rf_84) args
                         in rf_84)
                    (ErlangInt num_104) | (ErlangInt num_104) == (toErl 5) ->
                      ErlangFun 5
                        (let
                           ...
                           rf_105 [arg_106, arg_107, arg_108, arg_109, arg_110]
                             =
                             EXC.function_clause unit
                           rf_105 args = EXC.badarity (ErlangFun 5 rf_105) args
                         in rf_105)
                    (ErlangInt num_129) | (ErlangInt num_129) == (toErl 6) ->
                      ErlangFun 6
                        (let
                           ...
                           rf_130 [arg_131, arg_132, arg_133, arg_134, arg_135,
                             ...
                             =
                             EXC.function_clause unit
                           rf_130 args = EXC.badarity (ErlangFun 6 rf_130) args
                         in rf_130)
                    (ErlangInt num_158) | (ErlangInt num_158) == (toErl 7) ->
                      ErlangFun 7
                        (let
                           ...
                           rf_159 [arg_160, arg_161, arg_162, arg_163, arg_164,
                             ...
                             =
                             EXC.function_clause unit
                           rf_159 args = EXC.badarity (ErlangFun 7 rf_159) args
                         in rf_159)
                    (ErlangInt num_191) | (ErlangInt num_191) == (toErl 8) ->
                      ErlangFun 8
                        (let
                           ...
                           rf_192 [arg_193, arg_194, arg_195, arg_196, arg_197,
                             ...
                             =
                             EXC.function_clause unit
                           rf_192 args = EXC.badarity (ErlangFun 8 rf_192) args
                         in rf_192)
                    (ErlangInt num_228) | (ErlangInt num_228) == (toErl 9) ->
                      ErlangFun 9
                        (let
                           ...
                           rf_229 [arg_230, arg_231, arg_232, arg_233, arg_234,
                             ...
                             =
                             EXC.function_clause unit
                           rf_229 args = EXC.badarity (ErlangFun 9 rf_229) args
                         in rf_229)
                    (ErlangInt num_269) | (ErlangInt num_269) == (toErl 10) ->
                      ErlangFun 10
                        (let
                           ...
                           rf_270 [arg_271, arg_272, arg_273, arg_274, arg_275,
                             ...
                             =
                             EXC.function_clause unit
                           rf_270 args = EXC.badarity (ErlangFun 10 rf_270) args
                         in rf_270)
                    (ErlangInt num_314) | (ErlangInt num_314) == (toErl 11) ->
                      ErlangFun 11
                        (let
                           ...
                           rf_315 [arg_316, arg_317, arg_318, arg_319, arg_320,
                             ...
                             =
                             EXC.function_clause unit
                           rf_315 args = EXC.badarity (ErlangFun 11 rf_315) args
                         in rf_315)
                    (ErlangInt num_363) | (ErlangInt num_363) == (toErl 12) ->
                      ErlangFun 12
                        (let
                           ...
                           rf_364 [arg_365, arg_366, arg_367, arg_368, arg_369,
                             ...
                             =
                             EXC.function_clause unit
                           rf_364 args = EXC.badarity (ErlangFun 12 rf_364) args
                         in rf_364)
                    (ErlangInt num_416) | (ErlangInt num_416) == (toErl 13) ->
                      ErlangFun 13
                        (let
                           ...
                           rf_417 [arg_418, arg_419, arg_420, arg_421, arg_422,
                             ...
                             =
                             EXC.function_clause unit
                           rf_417 args = EXC.badarity (ErlangFun 13 rf_417) args
                         in rf_417)
                    (ErlangInt num_473) | (ErlangInt num_473) == (toErl 14) ->
                      ErlangFun 14
                        (let
                           ...
                           rf_474 [arg_475, arg_476, arg_477, arg_478, arg_479,
                             ...
                             =
                             EXC.function_clause unit
                           rf_474 args = EXC.badarity (ErlangFun 14 rf_474) args
                         in rf_474)
                    (ErlangInt num_534) | (ErlangInt num_534) == (toErl 15) ->
                      ErlangFun 15
                        (let
                           ...
                           rf_535 [arg_536, arg_537, arg_538, arg_539, arg_540,
                             ...
                             =
                             EXC.function_clause unit
                           rf_535 args = EXC.badarity (ErlangFun 15 rf_535) args
                         in rf_535)
                    (ErlangInt num_599) | (ErlangInt num_599) == (toErl 16) ->
                      ErlangFun 16
                        (let
                           ...
                           rf_600 [arg_601, arg_602, arg_603, arg_604, arg_605,
                             ...
                             =
                             EXC.function_clause unit
                           rf_600 args = EXC.badarity (ErlangFun 16 rf_600) args
                         in rf_600)
                    (ErlangInt num_668) | (ErlangInt num_668) == (toErl 17) ->
                      ErlangFun 17
                        (let
                           ...
                           rf_669 [arg_670, arg_671, arg_672, arg_673, arg_674,
                             ...
                             =
                             EXC.function_clause unit
                           rf_669 args = EXC.badarity (ErlangFun 17 rf_669) args
                         in rf_669)
                    (ErlangInt num_741) | (ErlangInt num_741) == (toErl 18) ->
                      ErlangFun 18
                        (let
                           ...
                           rf_742 [arg_743, arg_744, arg_745, arg_746, arg_747,
                             ...
                             =
                             EXC.function_clause unit
                           rf_742 args = EXC.badarity (ErlangFun 18 rf_742) args
                         in rf_742)
                    (ErlangInt num_818) | (ErlangInt num_818) == (toErl 19) ->
                      ErlangFun 19
                        (let
                           ...
                           rf_819 [arg_820, arg_821, arg_822, arg_823, arg_824,
                             ...
                             =
                             EXC.function_clause unit
                           rf_819 args = EXC.badarity (ErlangFun 19 rf_819) args
                         in rf_819)
                    (ErlangInt num_899) | (ErlangInt num_899) == (toErl 20) ->
                      ErlangFun 20
                        (let
                           ...
                           rf_900 [arg_901, arg_902, arg_903, arg_904, arg_905,
                             ...
                             =
                             EXC.function_clause unit
                           rf_900 args = EXC.badarity (ErlangFun 20 rf_900) args
                         in rf_900)
                    _other_984 ->
                      let   
                        l_986 =
                      ...
                      in let
                        tup_el_990 =
                          ErlangTuple
                            [ErlangAtom "named_fun", l_986, name_1, tup_el_994]
                      in let
                        arg_988 =
                          ErlangTuple [ErlangAtom "argument_limit", tup_el_990]
                      in let arg_997 = toErl 2
                      in let arg_999 = BIF.erlang__self__0 []
                      in let
                        arg_998 =
                          BIF.erlang__process_info__2
                            [arg_999, ErlangAtom "current_stacktrace"]
                      in let arg_996 = BIF.erlang__element__2 [arg_997, arg_998]
                      in
                        BIF.erlang__raise__3
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            ...
            in BIF.erlang__op_lesserEq [lop_40, rop_42])) =
  let    maxline_9 = erlps__find_maxline__1 [lc_2]
  in let matchExpr_14 = erlps__hide_calls__2 [lc_2, maxline_9]
  in
    case matchExpr_14 of
        ...
        in
          case case_15 of
            (ErlangTuple [(ErlangAtom "ok"),
              ...
              let    qlc1_24 = erlps__unhide_calls__3 [qlc_20, maxline_9, d_13]
              in let
                arg_25 =
                  ErlangTuple
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            ...
            in BIF.erlang__op_lesserEq [lop_25, rop_27])) =
  let   
    tup_el_15 =
      ErlangTuple [ErlangAtom "remote", l2_1, mod_2, func_3]
  in let
    arg_12 = ErlangTuple [ErlangAtom "call", l1_0, tup_el_15, as_7]
        ...
        in
          case matchExpr_22 of
            (ErlangTuple [(ErlangAtom "value"), f_20, bs2_21]) ->
              ...
              in let
                matchExpr_31 = erlps__expr_list__4 [as0_2, arg_24, lf_4, ef_5]
              in
...
erlps__expr__5 [(ErlangTuple [(ErlangAtom "call"), _,
  ...
  in
    case case_6 of
      (ErlangAtom "true") ->
        let matchExpr_16 = erlps__expr_list__4 [as0_1, bs0_2, lf_3, ef_4]
        in
          case matchExpr_16 of
...
erlps__expr__5 [(ErlangTuple [(ErlangAtom "call"), _, func0_0,
  ...
  let
    matchExpr_13 =
      erlps__expr__5 [func0_0, bs0_2, lf_3, ef_4, ErlangAtom "none"]
  in
    case matchExpr_13 of
      (ErlangTuple [(ErlangAtom "value"), func_11, bs1_12]) ->
        let
          matchExpr_20 = erlps__expr_list__4 [as0_1, bs1_12, lf_3, ef_4]
        in
          case matchExpr_20 of
            (ErlangTuple [as_18, bs2_19]) ->
              case func_11 of
                (ErlangTuple [m_22, f_23]) | (isEAtom m_22) && (isEAtom f_23) ->
                  ...
                  in let arg_28 = BIF.erlang__element__2 [arg_29, arg_30]
                  in BIF.erlang__raise__3 [ErlangAtom "error", arg_25, arg_28]
...
erlps__expr__5 [(ErlangTuple [(ErlangAtom "catch"), _, expr_0]),
  ...
  EXC.tryOfCatch
    (\ _ ->
       erlps__expr__5 [expr_0, bs0_1, lf_2, ef_3, ErlangAtom "none"])
    (\ of_10 ->
       case of_10 of
         (ErlangTuple [(ErlangAtom "value"), v_13, bs_14]) ->
           erlps__ret_expr__3 [v_13, bs_14, rbs_4]
         something_else -> EXC.try_clause something_else)
    (\ ex_11 ->
       case ex_11 of
         (ErlangTuple [(ErlangAtom "throw"), term_18, _]) ->
           erlps__ret_expr__3 [term_18, bs0_1, rbs_4]
         (ErlangTuple [(ErlangAtom "exit"), reason_22, _]) ->
           let arg_23 = ErlangTuple [ErlangAtom "EXIT", reason_22]
           in erlps__ret_expr__3 [arg_23, bs0_1, rbs_4]
         (ErlangTuple [(ErlangAtom "error"), reason_28, stacktrace_29]) ->
           let    tup_el_32 = ErlangTuple [reason_28, stacktrace_29]
           in let arg_30 = ErlangTuple [ErlangAtom "EXIT", tup_el_32]
           in erlps__ret_expr__3 [arg_30, bs0_1, rbs_4]
        ...
        in
          case case_14 of
            ...
            (ErlangAtom "nomatch") ->
              ...
              in let arg_26 = BIF.erlang__element__2 [arg_27, arg_28]
          ...
          v_31 =
            case l_11 of
              (ErlangAtom "true") ->
                let
                  matchExpr_21 =
                    erlps__expr__5 [r0_1, bs1_12, lf_3, ef_4, ErlangAtom "none"]
                in
                  case matchExpr_21 of
...
erlps__expr__5 [(ErlangTuple [(ErlangAtom "remote"), _, _, _]),
  ...
  =
  let    arg_5 = ErlangTuple [ErlangAtom "badexpr", ErlangAtom ":"]
  ...
  in let arg_8 = BIF.erlang__element__2 [arg_9, arg_10]
...
erlps__hide__3 [(ErlangTuple [(ErlangAtom "value"), l_0, v_1]),
  ...
  in let
    tup_el_6 = ErlangTuple [ErlangAtom "atom", a_5, ErlangAtom "ok"]
  in let rop_12 = toErl 1
  in let tup_el_10 = BIF.erlang__op_plus [id_2, rop_12]
          ...
          c_37 =
            case case_13 of
              ...
              (ErlangAtom "false") ->
                ...
                in let
                  tup_el_25 =
                    ErlangTuple [ErlangAtom "remote", l_0, tup_el_28, tup_el_32]
...
erlps__unhide_calls__3 [(ErlangTuple [(ErlangAtom "call"), a_0,
  ...
  , l_3 == l_1 =
  let
    line_9 = BIF.do_remote_fun_call "Erl.Anno" "erlps__line__1" [a_0]
  in
    case ErlangAtom "true" of
...
erlps__local_func__6 [func_0, as0_1, bs0_2,
  ...
  in let
    matchExpr_13 = erlps__expr_list__4 [as0_1, bs0_2, arg_7, ef_4]
  in
    case matchExpr_13 of
...
erlps__local_func__6 [func_0, as0_1, bs0_2,
  ...
  in let
    matchExpr_14 = erlps__expr_list__4 [as0_1, bs0_2, arg_8, ef_4]
  in
    case matchExpr_14 of
...
erlps__local_func__6 [func_0, as0_1, bs0_2,
  ...
  in
    erlps__local_func__6 [func_0, as0_1, bs0_2, arg_22, ef_5, rbs_6]
...
erlps__local_func__6 [func_0, as0_1, bs0_2,
  ...
  in let
    matchExpr_15 = erlps__expr_list__4 [as0_1, bs0_2, arg_9, ef_5]
  in
        ...
        let
          arg_16 =
            BIF.erlang__apply__3
              [m_3, f_4, ErlangCons func_0 (ErlangCons as1_13 ErlangEmptyList)]
...
erlps__local_func__6 [func_0, as0_1, _bs0_2, (ErlangAtom "none"),
  ...
  in let
    head_8 = ErlangTuple [ErlangAtom "erl_eval", func_0, tup_el_11]
...
erlps__local_func__6 args =
  EXC.badarity (ErlangFun 6 erlps__local_func__6) args
...
erlps__local_func2__2 [(ErlangTuple [(ErlangAtom "eval"), f_0,
                       ...
                       rbs_3]
  =
  erlps__do_apply__5 [f_0, as_1, bs_2, ErlangAtom "none", rbs_3]
erlps__local_func2__2 [arg_9, arg_10] = EXC.function_clause unit
erlps__local_func2__2 args =
  EXC.badarity (ErlangFun 2 erlps__local_func2__2) args
...
erlps__bif__5 [arg_11, arg_12, arg_13, arg_14, arg_15] =
  EXC.function_clause unit
erlps__bif__5 args =
  EXC.badarity (ErlangFun 5 erlps__bif__5) args
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            ...
            in let lop_29 = BIF.erlang__op_greaterEq [lop_30, rop_32]
            in let
              lop_28 =
                case lop_29 of
                  (ErlangAtom "false") -> ErlangAtom "false"
                  (ErlangAtom "true") ->
                    let    arg_34 = toErl 1
                    in let arg_33 = BIF.erlang__element__2 [arg_34, m_0]
  ...
  let   
    env_15 =
      case ErlangAtom "true" of
        _ | isEFun func_0 ->
          let   
            tup_el_6 = BIF.erlang__fun_info__2 [func_0, ErlangAtom "module"]
          in let
        ...
        let   
          nrbs_23 =
            case ErlangAtom "true" of
              ...
              _ -> rbs_4
        in let
          tup_el_25 = BIF.erlang__fun_info__2 [func_0, ErlangAtom "arity"]
        ...
        in
          case case_24 of
            ...
            _ ->
              ...
              in let arg_39 = ErlangTuple [ErlangAtom "badarity", tup_el_41]
              in let arg_45 = toErl 2
              in let arg_47 = BIF.erlang__self__0 []
              in let
                arg_46 =
                  BIF.erlang__process_info__2
                    [arg_47, ErlangAtom "current_stacktrace"]
              in let arg_44 = BIF.erlang__element__2 [arg_45, arg_46]
        ...
        let   
          nrbs_54 =
            case ErlangAtom "true" of
              ...
              _ -> rbs_4
        in let
          tup_el_56 = BIF.erlang__fun_info__2 [func_0, ErlangAtom "arity"]
        ...
        in
          case case_55 of
            ...
            _ ->
              ...
              in let arg_72 = ErlangTuple [ErlangAtom "badarity", tup_el_74]
              in let arg_78 = toErl 2
              in let arg_80 = BIF.erlang__self__0 []
              in let
                arg_79 =
                  BIF.erlang__process_info__2
                    [arg_80, ErlangAtom "current_stacktrace"]
              in let arg_77 = BIF.erlang__element__2 [arg_78, arg_79]
...
erlps__do_apply__5 args =
  EXC.badarity (ErlangFun 5 erlps__do_apply__5) args
...
erlps__eval_lc__6 [e_0, qs_1, bs_2, lf_3, ef_4, rbs_5] =
  let   
    arg_7 =
      erlps__eval_lc1__6 [e_0, qs_1, bs_2, lf_3, ef_4, ErlangEmptyList]
  in let
    arg_6 =
...
erlps__eval_lc__6 args =
  EXC.badarity (ErlangFun 6 erlps__eval_lc__6) args
    ...
    compfun_16 =
      ErlangFun 1
        (let
         ...
         in lambda_7)
  in
    erlps__eval_filter__6 [f_1, bs0_3, lf_4, ef_5, compfun_16, acc_6]
...
erlps__eval_lc1__6 args =
  EXC.badarity (ErlangFun 6 erlps__eval_lc1__6) args

erlps__eval_bc__6 :: ErlangFun
erlps__eval_bc__6 [e_0, qs_1, bs_2, lf_3, ef_4, rbs_5] =
  let    arg_12 = ErlangBinary (BIN.concat [])
  in let
    arg_6 = erlps__eval_bc1__6 [e_0, qs_1, bs_2, lf_3, ef_4, arg_12]
  in erlps__ret_expr__3 [arg_6, bs_2, rbs_5]
...
erlps__eval_bc__6 args =
  EXC.badarity (ErlangFun 6 erlps__eval_bc__6) args
  ...
  in
    case matchExpr_11 of
      (ErlangTuple [(ErlangAtom "value"), v_10, _]) ->
        ErlangBinary
          (BIN.concat
             [BIN.binPrefix acc_4 (BIN.packedSize acc_4) 1,
              BIN.binPrefix v_10 (BIN.packedSize v_10) 1])
      _ -> EXC.badmatch matchExpr_11
...
erlps__eval_bc1__6 args =
  EXC.badarity (ErlangFun 6 erlps__eval_bc1__6) args
    ...
    case case_8 of
      (ErlangTuple [(ErlangAtom "match"), bsn_13]) ->
        ...
        in let
          newacc_20 =
            BIF.erlang__apply__2
              [compfun_6, ErlangCons bs2_16 (ErlangCons acc_7 ErlangEmptyList)]
        in
          erlps__eval_generate__7
...
erlps__eval_generate__7 args =
  EXC.badarity (ErlangFun 7 erlps__eval_generate__7) args

erlps__eval_b_generate__7 :: ErlangFun
erlps__eval_b_generate__7 [bin_1@(ErlangBinary binSeg_0), p_2,
    ...
    case case_21 of
      (ErlangTuple [(ErlangAtom "match"), rest_28, bs1_29]) ->
        ...
        in let
          newacc_36 =
            BIF.erlang__apply__2
              [compfun_6, ErlangCons bs2_32 (ErlangCons acc_7 ErlangEmptyList)]
        in
          erlps__eval_b_generate__7
...
erlps__eval_b_generate__7 args =
  EXC.badarity (ErlangFun 7 erlps__eval_b_generate__7) args
...
erlps__eval_filter__6 args =
  EXC.badarity (ErlangFun 6 erlps__eval_filter__6) args
...
erlps__eval_map_fields__4 args =
  EXC.badarity (ErlangFun 4 erlps__eval_map_fields__4) args
        ...
        in
          case matchExpr_22 of
            (ErlangTuple [(ErlangAtom "value"), v1_20, bs2_21]) ->
              let head_28 = ErlangTuple [ErlangAtom "map_assoc", k1_12, v1_20]
              in
                erlps__eval_map_fields__5
    ...
    case matchExpr_14 of
      (ErlangTuple [(ErlangAtom "value"), k1_12, bs1_13]) ->
        ...
        in
          case matchExpr_22 of
            (ErlangTuple [(ErlangAtom "value"), v1_20, bs2_21]) ->
              let head_28 = ErlangTuple [ErlangAtom "map_exact", k1_12, v1_20]
              in
                erlps__eval_map_fields__5
                  [fs_2, bs2_21, lf_4, ef_5, ErlangCons head_28 acc_6]
            _ -> EXC.badmatch matchExpr_22
...
erlps__eval_fun__6 [(ErlangEmptyList), as_0, _bs_1, _lf_2, _ef_3,
  ...
  in let tail_12 = BIF.erlang__element__2 [arg_13, arg_14]
  in
    BIF.erlang__raise__3
...
erlps__eval_fun__6 args =
  EXC.badarity (ErlangFun 6 erlps__eval_fun__6) args
...
erlps__eval_named_fun__8 [(ErlangCons (ErlangTuple [(ErlangAtom "clause"),
  ...
  in let case_15 = erlps__match_list__4 [h_0, as_4, arg_18, bs1_14]
  in
    case case_15 of
...
erlps__eval_named_fun__8 args =
  EXC.badarity (ErlangFun 8 erlps__eval_named_fun__8) args
...
erlps__expr_list__6 args =
  EXC.badarity (ErlangFun 6 erlps__expr_list__6) args
...
erlps__eval_op__5 args =
  EXC.badarity (ErlangFun 5 erlps__eval_op__5) args
...
erlps__if_clauses__5 [(ErlangEmptyList), _bs_0, _lf_1, _ef_2,
  ...
  =
  let    arg_7 = toErl 2
  in let arg_9 = BIF.erlang__self__0 []
  in let
    arg_8 =
      BIF.erlang__process_info__2
        [arg_9, ErlangAtom "current_stacktrace"]
  in let arg_6 = BIF.erlang__element__2 [arg_7, arg_8]
  in
    BIF.erlang__raise__3
...
erlps__if_clauses__5 args =
  EXC.badarity (ErlangFun 5 erlps__if_clauses__5) args
...
erlps__try_clauses__8 [b_0, cases_1, catches_2, ab_3, bs_4, lf_5,
  ...
  in
    EXC.tryOfCatchFinally
      ...
      (\ of_15 ->
         case of_15 of
           (ErlangTuple [(ErlangAtom "value"), v_18, bs1_19]) | (==) cases_1
                                                                  ErlangEmptyList ->
             erlps__ret_expr__3 [v_18, bs1_19, rbs_7]
           (ErlangTuple [(ErlangAtom "value"), v_23, bs1_24]) ->
             let
               case_25 =
                 erlps__match_clause__5
                   [cases_1, ErlangCons v_23 ErlangEmptyList, bs1_24, lf_5,
                    ef_6]
             in
               case case_25 of
                 (ErlangTuple [b2_33, bs2_34]) ->
                   erlps__exprs__5 [b2_33, bs2_34, lf_5, ef_6, rbs_7]
                 (ErlangAtom "nomatch") ->
                   let    arg_41 = ErlangTuple [ErlangAtom "try_clause", v_23]
                   in let arg_45 = toErl 2
                   in let arg_47 = BIF.erlang__self__0 []
                   in let
                     arg_46 =
                       BIF.erlang__process_info__2
                         [arg_47, ErlangAtom "current_stacktrace"]
                   in let arg_44 = BIF.erlang__element__2 [arg_45, arg_46]
                   in BIF.erlang__raise__3 [ErlangAtom "error", arg_41, arg_44]
                 something_else -> EXC.case_clause something_else
           something_else -> EXC.try_clause something_else)
      (\ ex_16 ->
         case ex_16 of
           (ErlangTuple [class_49, reason_50, stacktrace_51]) | (==)
                                                                  catches_2
                                                                  ErlangEmptyList ->
             BIF.erlang__raise__3 [class_49, reason_50, stacktrace_51]
           (ErlangTuple [class_55, reason_56, stacktrace_57]) ->
             let    v_61 = ErlangTuple [class_55, reason_56, stacktrace_57]
             in let
               case_62 =
                 erlps__match_clause__5
                   [catches_2, ErlangCons v_61 ErlangEmptyList, bs_4, lf_5,
                    ef_6]
             in
               case case_62 of
                 (ErlangTuple [b2_70, bs2_71]) ->
                   erlps__exprs__5 [b2_70, bs2_71, lf_5, ef_6, rbs_7]
                 (ErlangAtom "nomatch") ->
                   BIF.erlang__raise__3 [class_55, reason_56, stacktrace_57]
                 something_else -> EXC.case_clause something_else
           ex_17 -> EXC.raise ex_17)
      (\ _ ->
         case ErlangAtom "true" of
           _ | (==) ab_3 ErlangEmptyList -> bs_4
           _ -> erlps__exprs__5 [ab_3, bs_4, lf_5, ef_6, ErlangAtom "none"])
erlps__try_clauses__8 [arg_85, arg_86, arg_87, arg_88, arg_89,
                       arg_90, arg_91, arg_92]
  =
  EXC.function_clause unit
erlps__try_clauses__8 args =
  EXC.badarity (ErlangFun 8 erlps__try_clauses__8) args
...
erlps__check_stacktrace_vars__2 [(ErlangCons (ErlangTuple [(ErlangAtom "clause"),
  ...
  case stv_0 of
      ...
      in
        case case_5 of
          (ErlangTuple [(ErlangAtom "value"), _]) ->
            ...
            in
              BIF.erlang__raise__3
                [ErlangAtom "error", ErlangAtom "stacktrace_bound", arg_10]
          (ErlangAtom "unbound") ->
    ...
    _ ->
      ...
      in let arg_21 = BIF.erlang__element__2 [arg_22, arg_23]
...
erlps__check_stacktrace_vars__2 args =
  EXC.badarity (ErlangFun 2 erlps__check_stacktrace_vars__2) args
...
erlps__case_clauses__6 args =
  EXC.badarity (ErlangFun 6 erlps__case_clauses__6) args
...
erlps__receive_clauses__5 args =
  EXC.badarity (ErlangFun 5 erlps__receive_clauses__5) args
...
erlps__receive_clauses__7 args =
  EXC.badarity (ErlangFun 7 erlps__receive_clauses__7) args
...
erlps__guard_test__4 [(ErlangTuple [(ErlangAtom "call"), l_0,
  ...
  in let tup_el_20 = ErlangTuple [ErlangAtom "atom", lf_3, tt_10]
  in let
    tup_el_13 =
...
erlps__match__3 [arg_7, arg_8, arg_9] = EXC.function_clause unit
erlps__match__3 args =
  EXC.badarity (ErlangFun 3 erlps__match__3) args
...
erlps__match__4 [pat_0, term_1, bs_2, bbs_3] =
  ...
  in
    case case_4 of
      (ErlangAtom "invalid") ->
        let    tup_el_25 = erlps__to_term__1 [pat_0]
        in let
          arg_23 = ErlangTuple [ErlangAtom "illegal_pattern", tup_el_25]
        ...
        in BIF.erlang__raise__3 [ErlangAtom "error", arg_23, arg_27]
      other_32 -> other_32
erlps__match__4 [arg_33, arg_34, arg_35, arg_36] =
  EXC.function_clause unit
erlps__match__4 args =
  EXC.badarity (ErlangFun 4 erlps__match__4) args
...
erlps__string_to_conses__3 [(ErlangCons e_0 rest_1), line_2,
                            tail_3]
  =
  let    tup_el_6 = ErlangTuple [ErlangAtom "integer", line_2, e_0]
  in let
    tup_el_10 = erlps__string_to_conses__3 [rest_1, line_2, tail_3]
  in ErlangTuple [ErlangAtom "cons", line_2, tup_el_6, tup_el_10]
...
erlps__match1__4 [(ErlangTuple [(ErlangAtom "atom"), _, a0_0]),
  ...
  =
  case a_1 of
    a0_5 | a0_5 == a0_0 -> ErlangTuple [ErlangAtom "match", bs_2]
...
erlps__match1__4 [(ErlangTuple [(ErlangAtom "integer"), _,
  ...
  =
  case i_1 of
    i0_5 | i0_5 == i0_0 -> ErlangTuple [ErlangAtom "match", bs_2]
    _ -> BIF.erlang__throw__1 [ErlangAtom "nomatch"]
erlps__match1__4 [(ErlangTuple [(ErlangAtom "float"), _, f0_0]),
                  f_1, bs_2, _bbs_3]
  =
  case f_1 of
    f0_5 | f0_5 == f0_0 -> ErlangTuple [ErlangAtom "match", bs_2]
    _ -> BIF.erlang__throw__1 [ErlangAtom "nomatch"]
erlps__match1__4 [(ErlangTuple [(ErlangAtom "char"), _, c0_0]),
                  c_1, bs_2, _bbs_3]
  =
  case c_1 of
    c0_5 | c0_5 == c0_0 -> ErlangTuple [ErlangAtom "match", bs_2]
    _ -> BIF.erlang__throw__1 [ErlangAtom "nomatch"]
...
erlps__match1__4 [(ErlangTuple [(ErlangAtom "match"), _, pat1_0,
  ...
  =
  let
    matchExpr_10 = erlps__match1__4 [pat1_0, term_2, bs0_3, bbs_4]
  in
    case matchExpr_10 of
...
erlps__match1__4 [(ErlangTuple [(ErlangAtom "string"), _, s0_0]),
  ...
  =
  case s_1 of
    s0_5 | s0_5 == s0_0 -> ErlangTuple [ErlangAtom "match", bs_2]
    _ -> BIF.erlang__throw__1 [ErlangAtom "nomatch"]
...
erlps__match1__4 [(ErlangTuple [(ErlangAtom "cons"), _, h_0,
  ...
  =
  let matchExpr_11 = erlps__match1__4 [h_0, h1_2, bs0_4, bbs_5]
  in
    case matchExpr_11 of
...
erlps__match1__4 [(ErlangTuple [(ErlangAtom "tuple"), _,
  ...
  let arg_6 = toErl 1
  in erlps__match_tuple__5 [elts_0, tuple_1, arg_6, bs_2, bbs_3]
...
erlps__match1__4 [(ErlangTuple [(ErlangAtom "bin"), _, fs_0]),
                  b_2@(ErlangBinary binSeg_1), bs0_3, bbs_4]
  =
  let   
    evalfun_22 =
      ErlangFun 2
...
erlps__match1__4 [(ErlangTuple [(ErlangAtom "op"), _,
                  ...
                  term_5, bs_6, bbs_7]
  =
  let    tup_el_11 = ErlangTuple [ErlangAtom "integer", l2_1, i_2]
  in let
    tup_el_15 =
      ErlangTuple [ErlangAtom "op", li_0, ErlangAtom "++", t_3, r_4]
  in let
    arg_8 =
...
erlps__match1__4 [(ErlangTuple [(ErlangAtom "op"), line_0, op_1,
                  ...
                  term_3, bs_4, bbs_5]
  =
  let    arg_7 = ErlangTuple [ErlangAtom "op", line_0, op_1, a_2]
...
erlps__match1__4 args =
  EXC.badarity (ErlangFun 4 erlps__match1__4) args
...
erlps__match_fun__1 args =
  EXC.badarity (ErlangFun 1 erlps__match_fun__1) args
...
erlps__match_tuple__5 [(ErlangCons e_0 es_1), tuple_2, i_3,
  ...
  in let matchExpr_13 = erlps__match1__4 [e_0, arg_7, bs0_4, bbs_5]
  in
    case matchExpr_13 of
      (ErlangTuple [(ErlangAtom "match"), bs_12]) ->
        let    rop_18 = toErl 1
        in let arg_16 = BIF.erlang__op_plus [i_3, rop_18]
...
erlps__match_map__4 [(ErlangCons (ErlangTuple [(ErlangAtom "map_field_exact"),
  ...
  let   
    vm_16 =
      EXC.tryCatch
        (\ _ ->
           let matchExpr_9 = erlps__expr__2 [k_0, bbs_5]
           in
             case matchExpr_9 of
        ...
        (\ ex_13 ->
           case ex_13 of
             (ErlangTuple [(ErlangAtom "error"), _, _]) ->
               BIF.erlang__throw__1 [ErlangAtom "nomatch"]
             ex_14 -> EXC.raise ex_14)
  in let matchExpr_22 = erlps__match1__4 [v_1, vm_16, bs0_4, bbs_5]
  in
    case matchExpr_22 of
      (ErlangTuple [(ErlangAtom "match"), bs_21]) ->
        erlps__match_map__4 [fs_2, map_3, bs_21, bbs_5]
      _ -> EXC.badmatch matchExpr_22
...
erlps__match_map__4 args =
  EXC.badarity (ErlangFun 4 erlps__match_map__4) args
...
erlps__match_list__3 args =
  EXC.badarity (ErlangFun 3 erlps__match_list__3) args
...
erlps__match_list__4 [(ErlangEmptyList), (ErlangEmptyList), bs_0,
  ...
  =
  ErlangTuple [ErlangAtom "match", bs_0]
erlps__match_list__4 [_, _, _bs_0, _bbs_1] = ErlangAtom "nomatch"
erlps__match_list__4 [arg_2, arg_3, arg_4, arg_5] =
  EXC.function_clause unit
erlps__match_list__4 args =
  EXC.badarity (ErlangFun 4 erlps__match_list__4) args
      ...
      ErlangFun 2
        (let
           lambda_3 [(ErlangTuple [name_6, val_7]), bs_8] =
             ...
             in
               case case_9 of
                 (ErlangTuple [(ErlangAtom "ok"), val_12]) | val_12 == val_7 ->
                   bs_8
                 (ErlangTuple [(ErlangAtom "ok"), v1_13]) ->
                   let    arg_15 = ErlangTuple [ErlangAtom "badmatch", v1_13]
                   ...
                   in BIF.erlang__raise__3 [ErlangAtom "error", arg_15, arg_18]
                 (ErlangAtom "error") ->
                   BIF.do_remote_fun_call "Orddict" "erlps__store__3"
                     [name_6, val_7, bs_8]
                 something_else -> EXC.case_clause something_else
...
erlps__merge_bindings__2 args =
  EXC.badarity (ErlangFun 2 erlps__merge_bindings__2) args
...
erlps__subst_values_for_vars__2 [l_0, bs_1] | isEList l_0 =
  flmap
    (\ lc_4 ->
       let lcRet_5 = erlps__subst_values_for_vars__2 [lc_4, bs_1]
...
erlps__subst_values_for_vars__2 args =
  EXC.badarity (ErlangFun 2 erlps__subst_values_for_vars__2) args
  ...
  in
    case case_3 of
      (ErlangTuple [(ErlangAtom "ok"), exprs0_5]) ->
        let matchExpr_9 = erlps__expr_fixup__1 [exprs0_5]
        in
          case matchExpr_9 of
...
erlps__expr_fixup__1 [expr0_0] =
  ...
  in let arg_3 = toErl 1
  in let matchExpr_6 = erlps__expr_fixup__3 [expr0_0, arg_2, arg_3]
  in
    case matchExpr_6 of
...
erlps__expr_fixup__3 [t_2@(ErlangTuple [(ErlangAtom "string"),
  ...
  EXC.tryOfCatch (\ _ -> erlps__string_fixup__2 [a_0, s_1])
    (\ of_7 ->
       let    var_12 = erlps__new_var__1 [i_4]
       in let bs_16 = erlps__add_binding__3 [var_12, of_7, bs0_3]
       in let tup_el_17 = ErlangTuple [ErlangAtom "var", a_0, var_12]
       in let rop_24 = toErl 1
       in let tup_el_22 = BIF.erlang__op_plus [i_4, rop_24]
       in ErlangTuple [tup_el_17, bs_16, tup_el_22])
    (\ ex_8 ->
       case ex_8 of
         (ErlangTuple [_, _, _]) -> ErlangTuple [t_2, bs0_3, i_4]
         ex_9 -> EXC.raise ex_9)
erlps__expr_fixup__3 [tuple_0, bs0_1, i0_2] | isETuple tuple_0 =
  let    arg_3 = BIF.erlang__tuple_to_list__1 [tuple_0]
  in let matchExpr_10 = erlps__expr_fixup__3 [arg_3, bs0_1, i0_2]
  in
    case matchExpr_10 of
...
erlps__expr_fixup__3 [(ErlangCons e0_0 es0_1), bs0_2, i0_3] =
  let matchExpr_10 = erlps__expr_fixup__3 [e0_0, bs0_2, i0_3]
  in
    case matchExpr_10 of
      (ErlangTuple [e_7, bs1_8, i1_9]) ->
        let matchExpr_17 = erlps__expr_fixup__3 [es0_1, bs1_8, i1_9]
        in
          case matchExpr_17 of
...
erlps__expr_fixup__3 args =
  EXC.badarity (ErlangFun 3 erlps__expr_fixup__3) args

erlps__string_fixup__2 :: ErlangFun
erlps__string_fixup__2 [a_0, s_1] =
  let   
    text_3 = BIF.do_remote_fun_call "Erl.Anno" "erlps__text__1" [a_0]
  in let fixuptag_6 = erlps__fixup_tag__2 [text_3, s_1]
  in let fun_8 = erlps__fixup_fun__1 [fixuptag_6]
  in BIF.erlang__apply__2 [fun_8, ErlangCons s_1 ErlangEmptyList]
erlps__string_fixup__2 [arg_10, arg_11] =
  EXC.function_clause unit
erlps__string_fixup__2 args =
  EXC.badarity (ErlangFun 2 erlps__string_fixup__2) args
...
erlps__fixup_fun__1 [(ErlangAtom "pid")] =
  ...
  in
    BIF.erlang__make_fun__3
      [ErlangAtom "erlang", ErlangAtom "list_to_pid", arg_2]
erlps__fixup_fun__1 [(ErlangAtom "port")] =
  let arg_2 = toErl 1
  in
    BIF.erlang__make_fun__3
      [ErlangAtom "erlang", ErlangAtom "list_to_port", arg_2]
erlps__fixup_fun__1 [(ErlangAtom "reference")] =
  let arg_2 = toErl 1
  in
    BIF.erlang__make_fun__3
      [ErlangAtom "erlang", ErlangAtom "list_to_ref", arg_2]
erlps__fixup_fun__1 [arg_3] = EXC.function_clause unit
erlps__fixup_fun__1 args =
  EXC.badarity (ErlangFun 1 erlps__fixup_fun__1) args
  ...
  in
    case case_1 of
      (ErlangTuple [(ErlangAtom "ok"),
        ...
        EXC.tryOfCatch (\ _ -> erlps__normalise__2 [expr_3, bindings_4])
          (\ of_7 -> ErlangTuple [ErlangAtom "ok", of_7])
          (\ ex_8 ->
             case ex_8 of
               (ErlangTuple [_, _, _]) ->
                 let    arg_14 = toErl 2
                 in let arg_13 = BIF.erlang__element__2 [arg_14, expr_3]
                 in let
                   loc_16 =
                     BIF.do_remote_fun_call "Erl.Anno" "erlps__location__1"
                       [arg_13]
                 in let tup_el_21 = toErl "bad term"
                 in let
                   tup_el_18 =
                     ErlangTuple [loc_16, ErlangAtom "erl_eval", tup_el_21]
                 in ErlangTuple [ErlangAtom "error", tup_el_18]
               ex_9 -> EXC.raise ex_9)
      (ErlangTuple [(ErlangAtom "ok"),
                    (ErlangCons _ (ErlangCons expr_22 _)), _bindings_23]) ->
        let    arg_25 = toErl 2
        in let arg_24 = BIF.erlang__element__2 [arg_25, expr_22]
        in let
          loc_27 =
            BIF.do_remote_fun_call "Erl.Anno" "erlps__location__1" [arg_24]
        in let tup_el_32 = toErl "bad term"
        in let
          tup_el_29 =
            ErlangTuple [loc_27, ErlangAtom "erl_eval", tup_el_32]
        in ErlangTuple [ErlangAtom "error", tup_el_29]
      error_33@(ErlangTuple [(ErlangAtom "error"), _]) -> error_33
      something_else -> EXC.case_clause something_else
erlps__extended_parse_term__1 [arg_34] = EXC.function_clause unit
...
erlps__normalise__2 [(ErlangTuple [(ErlangAtom "var"), _, v_0]),
                     bs_1]
  =
  let matchExpr_5 = erlps__binding__2 [v_0, bs_1]
  in
    case matchExpr_5 of
      ...
      ErlangFun 2
        (let
           lambda_5 [e_8, _] =
             ...
             in ErlangTuple [ErlangAtom "value", tup_el_10, ErlangEmptyList]
           lambda_5 [arg_6, arg_7] = EXC.function_clause unit
           lambda_5 args = EXC.badarity (ErlangFun 2 lambda_5) args
         in lambda_5)
  in let
...
erlps__normalise__2 args =
  EXC.badarity (ErlangFun 2 erlps__normalise__2) args
...
erlps__normalise_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__normalise_list__2) args
...
erlps__partial_eval__1 [expr_0] =
  ...
  in
    case case_3 of
      x_18 | isEInt x_18 ->
        let arg_20 = ErlangTuple [ErlangAtom "integer", line_2, x_18]
        in erlps__ret_expr__2 [expr_0, arg_20]
      x_24 | isEFloat x_24 ->
        let arg_26 = ErlangTuple [ErlangAtom "float", line_2, x_24]
        in erlps__ret_expr__2 [expr_0, arg_26]
      x_30 | isEAtom x_30 ->
        let arg_32 = ErlangTuple [ErlangAtom "atom", line_2, x_30]
            ...
            (ErlangAtom "true") ->
              ...
              in
                case case_11 of
                  ...
                  (ErlangTuple [(ErlangAtom "error"),
                                (ErlangTuple [_line_41, mod_42, args_43])]) ->
                    let    arg_45 = toErl "*** ~ts"
                    in let
                      head_47 =
                        BIF.erlang__apply__3
