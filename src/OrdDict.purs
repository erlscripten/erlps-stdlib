...
erlps__from_list__1 [pairs_0] =
  let    arg_1 = toErl 1
  in let arg_2 = erlps__reverse_pairs__2 [pairs_0, ErlangEmptyList]
  in
...
erlps__take_1__3 [arg_0, arg_1, arg_2] = EXC.function_clause unit
erlps__take_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__take_1__3) args
...
erlps__store__3 [arg_6, arg_7, arg_8] = EXC.function_clause unit
...
erlps__append__3 [key_0, new_1,
  ...
  | weakLt key_0 k_2 =
  let
    head_4 = ErlangTuple [key_0, ErlangCons new_1 ErlangEmptyList]
  in ErlangCons head_4 dict_3
erlps__append__3 [key_0, new_1,
                  (ErlangCons e_3@(ErlangTuple [k_2, _]) dict_4)]
  | weakGt key_0 k_2 =
...
erlps__append__3 [key_0, new_1,
  ...
  let   
    tup_el_7 =
      BIF.erlang__op_append [old_3, ErlangCons new_1 ErlangEmptyList]
  in let head_5 = ErlangTuple [key_0, tup_el_7]
  in ErlangCons head_5 dict_4
erlps__append__3 [key_0, new_1, (ErlangEmptyList)] =
  let
    head_2 = ErlangTuple [key_0, ErlangCons new_1 ErlangEmptyList]
  in ErlangCons head_2 ErlangEmptyList
...
erlps__update__3 [key_0, fun_1,
  ...
  let   
    tup_el_7 =
      BIF.erlang__apply__2 [fun_1, ErlangCons val_3 ErlangEmptyList]
  in let head_5 = ErlangTuple [key_0, tup_el_7]
  in ErlangCons head_5 dict_4
...
erlps__update__4 [key_0, fun_1, _init_2,
  ...
  let   
    tup_el_8 =
      BIF.erlang__apply__2 [fun_1, ErlangCons val_4 ErlangEmptyList]
...
erlps__map__2 [f_0, (ErlangEmptyList)] | isEFunA f_0 (toErl 2) =
  ErlangEmptyList
...
erlps__merge__3 [f_0,
  ...
  | weakLt k1_1 k2_4 =
  let tail_8 = erlps__merge__3 [f_0, d1_3, ErlangCons e2_5 d2_6]
  in ErlangCons e1_2 tail_8
erlps__merge__3 [f_0,
                 (ErlangCons e1_2@(ErlangTuple [k1_1, _]) d1_3),
                 (ErlangCons e2_5@(ErlangTuple [k2_4, _]) d2_6)]
  | weakGt k1_1 k2_4 =
  let tail_8 = erlps__merge__3 [f_0, ErlangCons e1_2 d1_3, d2_6]
...
erlps__reverse_pairs__2 [arg_1, arg_2] = EXC.function_clause unit
erlps__reverse_pairs__2 args =
  EXC.badarity (ErlangFun 2 erlps__reverse_pairs__2) args