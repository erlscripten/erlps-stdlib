...
erlps__fwrite__3 [arg_7, arg_8, arg_9] = EXC.function_clause unit
erlps__fwrite__3 args =
  EXC.badarity (ErlangFun 3 erlps__fwrite__3) args

erlps__build__1 :: ErlangFun
erlps__build__1 [cs_0] = erlps__build__2 [cs_0, ErlangEmptyList]
erlps__build__1 [arg_3] = EXC.function_clause unit
erlps__build__1 args =
  EXC.badarity (ErlangFun 1 erlps__build__1) args
...
erlps__build__2 [cs_0, options_1] =
  ...
  in let
    charslimit_6 =
      erlps__get_option__3 [ErlangAtom "chars_limit", options_1, arg_4]
  in let res1_8 = erlps__build_small__1 [cs_0]
  in let matchExpr_14 = erlps__count_small__1 [res1_8]
  in
...
erlps__scan__2 [format_0, args_1] | isEBinary format_0 =
...
erlps__scan__2 args =
  EXC.badarity (ErlangFun 2 erlps__scan__2) args
...
erlps__unscan__1 args =
  EXC.badarity (ErlangFun 1 erlps__unscan__1) args
...
erlps__print__7 [c_0, f_1, ad_2, p_3, pad_4, encoding_5,
                 strings_6]
  =
  let    head_8 = toErl 126
  in let lop_11 = erlps__print_field_width__2 [f_1, ad_2]
  ...
  in let
    rop_24 =
      BIF.erlang__op_append [lop_25, ErlangCons c_0 ErlangEmptyList]
  ...
  in
    BIF.erlang__op_append [ErlangCons head_8 ErlangEmptyList, rop_10]
erlps__print__7 [arg_30, arg_31, arg_32, arg_33, arg_34, arg_35,
                 arg_36]
  =
  EXC.function_clause unit
erlps__print__7 args =
  EXC.badarity (ErlangFun 7 erlps__print__7) args
...
erlps__print_field_width__2 args =
  EXC.badarity (ErlangFun 2 erlps__print_field_width__2) args
...
erlps__print_precision__2 [p_0, _pad_1] =
  let    head_2 = toErl 46
  in let tail_3 = BIF.erlang__integer_to_list__1 [p_0]
  in ErlangCons head_2 tail_3
erlps__print_precision__2 [arg_5, arg_6] =
  EXC.function_clause unit
erlps__print_precision__2 args =
  EXC.badarity (ErlangFun 2 erlps__print_precision__2) args
...
erlps__print_pad_char__1 [pad_0] =
  let head_1 = toErl 46
  in ErlangCons head_1 (ErlangCons pad_0 ErlangEmptyList)
erlps__print_pad_char__1 [arg_5] = EXC.function_clause unit
erlps__print_pad_char__1 args =
  EXC.badarity (ErlangFun 1 erlps__print_pad_char__1) args

erlps__print_encoding__1 :: ErlangFun
erlps__print_encoding__1 [(ErlangAtom "unicode")] = toErl "t"
erlps__print_encoding__1 [(ErlangAtom "latin1")] = toErl ""
erlps__print_encoding__1 [arg_0] = EXC.function_clause unit
erlps__print_encoding__1 args =
  EXC.badarity (ErlangFun 1 erlps__print_encoding__1) args

erlps__print_strings__1 :: ErlangFun
erlps__print_strings__1 [(ErlangAtom "false")] = toErl "l"
erlps__print_strings__1 [(ErlangAtom "true")] = toErl ""
erlps__print_strings__1 [arg_0] = EXC.function_clause unit
erlps__print_strings__1 args =
  EXC.badarity (ErlangFun 1 erlps__print_strings__1) args

erlps__collect__2 :: ErlangFun
erlps__collect__2 [(ErlangCons (ErlangInt num_0) fmt0_1),
                   args0_2]
  | (ErlangInt num_0) == (toErl 126) =
  let matchExpr_8 = erlps__collect_cseq__2 [fmt0_1, args0_2]
  in
    case matchExpr_8 of
...
erlps__collect__2 args =
  EXC.badarity (ErlangFun 2 erlps__collect__2) args

erlps__collect_cseq__2 :: ErlangFun
erlps__collect_cseq__2 [fmt0_0, args0_1] =
  let matchExpr_8 = erlps__field_width__2 [fmt0_0, args0_1]
  in
    case matchExpr_8 of
      (ErlangTuple [f_4, ad_5, fmt1_6, args1_7]) ->
        let matchExpr_14 = erlps__precision__2 [fmt1_6, args1_7]
        in
          case matchExpr_14 of
            (ErlangTuple [p_11, fmt2_12, args2_13]) ->
              let matchExpr_20 = erlps__pad_char__2 [fmt2_12, args2_13]
              in
                  ...
                  (ErlangTuple [pad_17, fmt3_18, args3_19]) ->
                    let   
                      spec0_33 =
                        ErlangMap
                          (Map.fromFoldable
                             [DT.Tuple (ErlangAtom "width") f_4,
                              DT.Tuple (ErlangAtom "adjust") ad_5,
                              DT.Tuple (ErlangAtom "precision") p_11,
                              DT.Tuple (ErlangAtom "pad_char") pad_17,
                              DT.Tuple (ErlangAtom "encoding")
                                (ErlangAtom "latin1"),
                              DT.Tuple (ErlangAtom "strings")
                                (ErlangAtom "true")])
                    in let
                      matchExpr_38 = erlps__modifiers__2 [fmt3_18, spec0_33]
                    in
                              ...
                              (ErlangTuple [c_41, as_42, fmt5_43, args4_44]) ->
                                let   
                                  mapExt_51 =
                                    ErlangMap
                                      (Map.fromFoldable
                                         [DT.Tuple (ErlangAtom "control_char")
                                            c_41,
                                          DT.Tuple (ErlangAtom "args") as_42])
                                in let
                                  spec2_53 =
                                    BIF.maps__merge__2 [spec1_36, mapExt_51]
...
erlps__collect_cseq__2 args =
  EXC.badarity (ErlangFun 2 erlps__collect_cseq__2) args
...
erlps__modifiers__2 [(ErlangCons (ErlangInt num_0) fmt_1),
  ...
  in let arg_4 = BIF.maps__merge__2 [spec_2, mapExt_8]
...
erlps__field_width__2 [fmt0_0, args0_1] =
  let matchExpr_7 = erlps__field_value__2 [fmt0_0, args0_1]
  in
    case matchExpr_7 of
      (ErlangTuple [f_4, fmt_5, args_6]) ->
        erlps__field_width__3 [f_4, fmt_5, args_6]
      _ -> EXC.badmatch matchExpr_7
erlps__field_width__2 [arg_11, arg_12] = EXC.function_clause unit
erlps__field_width__2 args =
  EXC.badarity (ErlangFun 2 erlps__field_width__2) args
...
erlps__field_width__3 args =
  EXC.badarity (ErlangFun 3 erlps__field_width__3) args
...
erlps__precision__2 args =
  EXC.badarity (ErlangFun 2 erlps__precision__2) args
...
erlps__field_value__2 [(ErlangCons c_0 fmt_1), args_2]
  | ((isEInt c_0) && (weakGeq c_0 (toErl 48))) &&
      (weakLeq c_0 (toErl 57)) =
  let arg_7 = toErl 0
  in erlps__field_value__3 [ErlangCons c_0 fmt_1, args_2, arg_7]
...
erlps__field_value__3 [(ErlangCons c_0 fmt_1), args_2, f_3]
  | ((isEInt c_0) && (weakGeq c_0 (toErl 48))) &&
      (weakLeq c_0 (toErl 57)) =
  let    lop_8 = toErl 10
  in let lop_7 = BIF.erlang__op_mult [lop_8, f_3]
  in let rop_12 = toErl 48
  in let rop_10 = BIF.erlang__op_minus [c_0, rop_12]
...
erlps__field_value__3 args =
  EXC.badarity (ErlangFun 3 erlps__field_value__3) args
...
erlps__pad_char__2 [fmt_0, args_1] =
  let tup_el_2 = toErl 32
  in ErlangTuple [tup_el_2, fmt_0, args_1]
erlps__pad_char__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__pad_char__2 args =
  EXC.badarity (ErlangFun 2 erlps__pad_char__2) args
...
erlps__collect_cc__2 [(ErlangCons (ErlangInt num_0) fmt_1),
  ...
  in
    ErlangTuple
      [tup_el_4, ErlangCons a_2 ErlangEmptyList, fmt_1, args_3]
erlps__collect_cc__2 [(ErlangCons (ErlangInt num_0) fmt_1),
                      (ErlangCons a_2 args_3)]
...
erlps__collect_cc__2 [(ErlangCons (ErlangInt num_0) fmt_1),
  ...
  let tup_el_5 = toErl 87
  in
    ErlangTuple
      [tup_el_5, ErlangCons a_2 (ErlangCons depth_3 ErlangEmptyList),
       fmt_1, args_4]
erlps__collect_cc__2 [(ErlangCons (ErlangInt num_0) fmt_1),
                      (ErlangCons a_2 (ErlangCons depth_3 args_4))]
  | (ErlangInt num_0) == (toErl 80) =
  let tup_el_5 = toErl 80
  in
    ErlangTuple
      [tup_el_5, ErlangCons a_2 (ErlangCons depth_3 ErlangEmptyList),
       fmt_1, args_4]
...
erlps__collect_cc__2 [(ErlangCons (ErlangInt num_0) fmt_1),
  ...
  let tup_el_5 = toErl 120
  in
    ErlangTuple
      [tup_el_5, ErlangCons a_2 (ErlangCons prefix_3 ErlangEmptyList),
       fmt_1, args_4]
erlps__collect_cc__2 [(ErlangCons (ErlangInt num_0) fmt_1),
                      (ErlangCons a_2 (ErlangCons prefix_3 args_4))]
  | (ErlangInt num_0) == (toErl 88) =
  let tup_el_5 = toErl 88
  in
    ErlangTuple
      [tup_el_5, ErlangCons a_2 (ErlangCons prefix_3 ErlangEmptyList),
       fmt_1, args_4]
...
erlps__collect_cc__2 [(ErlangCons (ErlangInt num_0) fmt_1),
  ...
  | (ErlangInt num_0) == (toErl 126)
  , isEList args_2 =
  let tup_el_3 = toErl 126
  in ErlangTuple [tup_el_3, ErlangEmptyList, fmt_1, args_2]
erlps__collect_cc__2 [(ErlangCons (ErlangInt num_0) fmt_1),
                      args_2]
  | (ErlangInt num_0) == (toErl 110)
  , isEList args_2 =
  let tup_el_3 = toErl 110
  in ErlangTuple [tup_el_3, ErlangEmptyList, fmt_1, args_2]
erlps__collect_cc__2 [(ErlangCons (ErlangInt num_0) fmt_1),
                      (ErlangCons a_2 args_3)]
  ...
  in
    ErlangTuple
      [tup_el_4, ErlangCons a_2 ErlangEmptyList, fmt_1, args_3]
erlps__collect_cc__2 [arg_10, arg_11] = EXC.function_clause unit
erlps__collect_cc__2 args =
  EXC.badarity (ErlangFun 2 erlps__collect_cc__2) args

erlps__count_small__1 :: ErlangFun
erlps__count_small__1 [cs_0] =
  let    val_7 = toErl 0
  in let val_8 = toErl 0
  in let val_9 = toErl 0
  in let val_10 = toErl 0
  in let
    arg_2 =
      ErlangMap
        (Map.fromFoldable
           [DT.Tuple (ErlangAtom "p") val_7,
            DT.Tuple (ErlangAtom "s") val_8, DT.Tuple (ErlangAtom "w") val_9,
            DT.Tuple (ErlangAtom "other") val_10])
  in erlps__count_small__2 [cs_0, arg_2]
erlps__count_small__1 [arg_11] = EXC.function_clause unit
erlps__count_small__1 args =
  EXC.badarity (ErlangFun 1 erlps__count_small__1) args
...
erlps__count_small__2 [(ErlangCons (ErlangMap map_0) cs_2),
  ...
  let    rop_12 = toErl 1
  in let val_10 = BIF.erlang__op_plus [p_4, rop_12]
  in let
    mapExt_13 = ErlangMap (Map.singleton (ErlangAtom "p") val_10)
  in let
    arg_7 =
      case findMissingKey cnts_5 [ErlangAtom "p"] of
        (DM.Nothing) -> BIF.maps__merge__2 [cnts_5, mapExt_13]
...
erlps__count_small__2 [(ErlangCons (ErlangMap map_0) cs_2),
  ...
  | (DM.Just (ErlangInt num_1)) <-
      (Map.lookup (ErlangAtom "control_char") map_0)
  , (ErlangInt num_1) == (toErl 119)
  , (DM.Just w_4) <- (Map.lookup (ErlangAtom "w") map_3) =
  let    rop_12 = toErl 1
  in let val_10 = BIF.erlang__op_plus [w_4, rop_12]
  in let
    mapExt_13 = ErlangMap (Map.singleton (ErlangAtom "w") val_10)
  in let
    arg_7 =
...
erlps__count_small__2 [(ErlangCons c_0 cs_1),
  ...
  in let val_9 = BIF.erlang__op_plus [other_3, rop_11]
  in let
    mapExt_12 = ErlangMap (Map.singleton (ErlangAtom "other") val_9)
  in let
    arg_6 =
      case findMissingKey cnts_4 [ErlangAtom "other"] of
        (DM.Nothing) -> BIF.maps__merge__2 [cnts_4, mapExt_12]
...
erlps__count_small__2 [arg_9, arg_10] = EXC.function_clause unit
erlps__count_small__2 args =
  EXC.badarity (ErlangFun 2 erlps__count_small__2) args
...
erlps__build_small__1 [(ErlangCons cc_8@(ErlangMap map_0) cs_9)]
  ...
  let
    case_10 =
      erlps__control_small__7 [c_1, as_2, f_3, ad_4, p_5, pad_6, enc_7]
  in
    case case_10 of
...
erlps__build_small__1 args =
  EXC.badarity (ErlangFun 1 erlps__build_small__1) args
...
erlps__build_limited__5 [(ErlangCons (ErlangMap map_0) cs_9),
  ...
  let   
    maxchars_16 =
      case ErlangAtom "true" of
        _ | weakLt maxlen0_12 (toErl 0) -> maxlen0_12
  ...
  in let count_33 = BIF.erlang__op_minus [count0_11, rop_32]
  in let
    maxlen_38 =
      case ErlangAtom "true" of
        _ | weakLt maxlen0_12 (toErl 0) -> maxlen0_12
...
erlps__build_limited__5 [(ErlangCons (ErlangInt num_0) cs_1),
  ...
  in ErlangCons head_6 tail_7
erlps__build_limited__5 [(ErlangCons (ErlangInt num_0) cs_1),
                         numofps_2, count_3, maxlen_4, i_5]
  | (ErlangInt num_0) == (toErl 9) =
  let    head_6 = toErl 9
  in let rop_16 = toErl 8
  in let lop_14 = BIF.erlang__op_plus [i_5, rop_16]
  in let rop_17 = toErl 8
  in let lop_13 = BIF.erlang__op_div_strict [lop_14, rop_17]
  in let rop_18 = toErl 8
  in let arg_12 = BIF.erlang__op_mult [lop_13, rop_18]
  in let
    tail_7 =
      erlps__build_limited__5
        [cs_1, numofps_2, count_3, maxlen_4, arg_12]
...
erlps__build_limited__5 [(ErlangCons c_0 cs_1), numofps_2,
  ...
  =
  let    rop_14 = toErl 1
  in let arg_12 = BIF.erlang__op_plus [i_5, rop_14]
  in let
    tail_7 =
      erlps__build_limited__5
        [cs_1, numofps_2, count_3, maxlen_4, arg_12]
...
erlps__build_limited__5 args =
  EXC.badarity (ErlangFun 5 erlps__build_limited__5) args

erlps__decr_pc__2 :: ErlangFun
erlps__decr_pc__2 [(ErlangInt num_0), pc_1]
  | (ErlangInt num_0) == (toErl 112) =
  let rop_3 = toErl 1
  in BIF.erlang__op_minus [pc_1, rop_3]
erlps__decr_pc__2 [(ErlangInt num_0), pc_1]
  | (ErlangInt num_0) == (toErl 80) =
  let rop_3 = toErl 1
  in BIF.erlang__op_minus [pc_1, rop_3]
...
erlps__decr_pc__2 args =
  EXC.badarity (ErlangFun 2 erlps__decr_pc__2) args
...
erlps__indentation__2 [(ErlangCons (ErlangInt num_0) cs_1), i_2]
  | (ErlangInt num_0) == (toErl 9) =
  let    rop_8 = toErl 8
  in let lop_6 = BIF.erlang__op_plus [i_2, rop_8]
  in let rop_9 = toErl 8
  in let lop_5 = BIF.erlang__op_div_strict [lop_6, rop_9]
  in let rop_10 = toErl 8
  in let arg_4 = BIF.erlang__op_mult [lop_5, rop_10]
  in erlps__indentation__2 [cs_1, arg_4]
erlps__indentation__2 [(ErlangCons c_0 cs_1), i_2] | isEInt c_0 =
  let    rop_6 = toErl 1
  in let arg_4 = BIF.erlang__op_plus [i_2, rop_6]
  in erlps__indentation__2 [cs_1, arg_4]
...
erlps__control_small__7 [(ErlangInt num_0),
  ...
  , isEInt a_1 =
  let    rop_9 = toErl 255
  in let arg_7 = BIF.erlang__band__2 [a_1, rop_9]
...
erlps__control_small__7 [(ErlangInt num_0), (ErlangEmptyList),
  ...
  | (ErlangInt num_0) == (toErl 126) =
  let arg_6 = toErl 126
  in erlps__char__5 [arg_6, f_1, adj_2, p_3, pad_4]
erlps__control_small__7 [(ErlangInt num_0), (ErlangEmptyList),
                         f_1, adj_2, p_3, pad_4, _enc_5]
  | (ErlangInt num_0) == (toErl 110) =
...
erlps__control_small__7 args =
  EXC.badarity (ErlangFun 7 erlps__control_small__7) args
...
erlps__control_limited__10 [(ErlangInt num_0),
  ...
  | (ErlangInt num_0) == (toErl 119) =
  let    op_arg_15 = toErl 1
  in let tup_el_14 = BIF.erlang__op_neg [op_arg_15]
...
erlps__control_limited__10 [(ErlangInt num_0),
  ...
  in let arg_11 = BIF.erlang__op_neg [op_arg_12]
  in
    erlps__print__10
...
erlps__control_limited__10 args =
  EXC.badarity (ErlangFun 10 erlps__control_limited__10) args
...
erlps__uniconv__1 args =
  EXC.badarity (ErlangFun 1 erlps__uniconv__1) args

erlps__base__1 :: ErlangFun
erlps__base__1 [(ErlangAtom "none")] = toErl 10
erlps__base__1 [b_0] | isEInt b_0 = b_0
erlps__base__1 [arg_1] = EXC.function_clause unit
erlps__base__1 args =
  EXC.badarity (ErlangFun 1 erlps__base__1) args
...
erlps__term__5 [t_0, f_1, adj_2, p0_3, pad_4] =
  ...
  in
    case ErlangAtom "true" of
      _ | weakGt l_6 p_12 ->
        let    arg_14 = toErl 42
        in let arg_13 = erlps__chars__2 [arg_14, p_12]
...
erlps__term__5 [arg_29, arg_30, arg_31, arg_32, arg_33] =
  EXC.function_clause unit
erlps__term__5 args =
  EXC.badarity (ErlangFun 5 erlps__term__5) args
...
erlps__print__10 [t_0, d_1, (ErlangAtom "none"), adj_2, p_3,
  ...
  in
    erlps__print__10
      [t_0, d_1, arg_11, adj_2, p_3, pad_4, e_5, str_6, chlim_7, i_8]
erlps__print__10 [t_0, d_1, f_2, adj_3, (ErlangAtom "none"),
                  pad_4, e_5, str_6, chlim_7, i_8]
  =
  let    rop_15 = toErl 1
  in let arg_13 = BIF.erlang__op_plus [i_8, rop_15]
  in
    erlps__print__10
...
erlps__print__10 [t_0, d_1, f_2, (ErlangAtom "right"), p_3,
  ...
  =
  let    head_9 = ErlangTuple [ErlangAtom "chars_limit", chlim_7]
...
erlps__print__10 args =
  EXC.badarity (ErlangFun 10 erlps__print__10) args
...
erlps__fwrite_e__5 [fl_0, (ErlangAtom "none"), adj_1,
  ...
  let arg_6 = toErl 6
  in
    erlps__fwrite_e__5 [fl_0, ErlangAtom "none", adj_1, arg_6, pad_2]
...
erlps__fwrite_e__5 [fl_0, f_1, adj_2, (ErlangAtom "none"), pad_3]
  =
  let arg_7 = toErl 6
  in erlps__fwrite_e__5 [fl_0, f_1, adj_2, arg_7, pad_3]
...
erlps__fwrite_e__5 args =
  EXC.badarity (ErlangFun 5 erlps__fwrite_e__5) args
...
erlps__float_e__3 [fl_0, fd_1, p_2]
  ...
  let    head_3 = toErl 45
  in let arg_5 = BIF.erlang__op_neg [fl_0]
...
erlps__float_e__3 [_fl_0, (ErlangTuple [ds_1, e_2]), p_3] =
  ...
  in let arg_7 = BIF.erlang__op_minus [p_3, rop_9]
  in let case_4 = erlps__float_man__3 [ds_1, arg_6, arg_7]
  in
    case case_4 of
      (ErlangTuple [(ErlangCons (ErlangInt num_10) fs_11),
                    (ErlangAtom "true")]) | (ErlangInt num_10) == (toErl 48) ->
        let    head_13 = toErl 49
        in let tail_15 = erlps__float_exp__1 [e_2]
        in ErlangCons (ErlangCons head_13 fs_11) tail_15
      (ErlangTuple [fs_17, (ErlangAtom "false")]) ->
        let    rop_22 = toErl 1
        in let arg_20 = BIF.erlang__op_minus [e_2, rop_22]
...
erlps__float_e__3 args =
  EXC.badarity (ErlangFun 3 erlps__float_e__3) args

erlps__float_man__3 :: ErlangFun
erlps__float_man__3 [ds_0, (ErlangInt num_1), dc_2]
  | (ErlangInt num_1) == (toErl 0) =
  let matchExpr_7 = erlps__float_man__2 [ds_0, dc_2]
  in
    case matchExpr_7 of
      (ErlangTuple [cs_5, c_6]) ->
        let head_9 = toErl 46
        in ErlangTuple [ErlangCons head_9 cs_5, c_6]
      _ -> EXC.badmatch matchExpr_7
erlps__float_man__3 [(ErlangCons d_0 ds_1), i_2, dc_3] =
  let    rop_8 = toErl 1
  in let arg_6 = BIF.erlang__op_minus [i_2, rop_8]
  in let case_4 = erlps__float_man__3 [ds_1, arg_6, dc_3]
  in
    case case_4 of
      (ErlangTuple [cs_10, (ErlangAtom "true")]) | (==) d_0
                                                     (toErl 57) ->
        let head_12 = toErl 48
        in ErlangTuple [ErlangCons head_12 cs_10, ErlangAtom "true"]
      (ErlangTuple [cs_15, (ErlangAtom "true")]) ->
        let    rop_19 = toErl 1
        in let head_17 = BIF.erlang__op_plus [d_0, rop_19]
        in ErlangTuple [ErlangCons head_17 cs_15, ErlangAtom "false"]
...
erlps__float_man__3 [(ErlangEmptyList), i_0, dc_1] =
  ...
  in let
    lop_3 =
      BIF.do_remote_fun_call "Lists" "erlps__duplicate__2" [i_0, arg_5]
  in let head_7 = toErl 46
  in let arg_10 = toErl 48
  in let
    tail_8 =
...
erlps__float_man__2 [(ErlangCons d_0 ds_1), dc_2] =
  let    rop_7 = toErl 1
  in let arg_5 = BIF.erlang__op_minus [dc_2, rop_7]
  in let case_3 = erlps__float_man__2 [ds_1, arg_5]
  in
    case case_3 of
      (ErlangTuple [cs_8, (ErlangAtom "true")]) | (==) d_0
                                                    (toErl 57) ->
        let head_10 = toErl 48
        in ErlangTuple [ErlangCons head_10 cs_8, ErlangAtom "true"]
      (ErlangTuple [cs_13, (ErlangAtom "true")]) ->
        let    rop_17 = toErl 1
        in let head_15 = BIF.erlang__op_plus [d_0, rop_17]
        in ErlangTuple [ErlangCons head_15 cs_13, ErlangAtom "false"]
...
erlps__float_man__2 args =
  EXC.badarity (ErlangFun 2 erlps__float_man__2) args

erlps__float_exp__1 :: ErlangFun
erlps__float_exp__1 [e_0] | weakGeq e_0 (toErl 0) =
  let    head_1 = toErl 101
  in let head_3 = toErl 43
  in let tail_4 = BIF.erlang__integer_to_list__1 [e_0]
  in ErlangCons head_1 (ErlangCons head_3 tail_4)
erlps__float_exp__1 [e_0] =
  let    head_1 = toErl 101
  in let tail_2 = BIF.erlang__integer_to_list__1 [e_0]
  in ErlangCons head_1 tail_2
erlps__float_exp__1 [arg_4] = EXC.function_clause unit
erlps__float_exp__1 args =
  EXC.badarity (ErlangFun 1 erlps__float_exp__1) args
...
erlps__fwrite_f__5 [fl_0, (ErlangAtom "none"), adj_1,
  ...
  let arg_6 = toErl 6
  in
    erlps__fwrite_f__5 [fl_0, ErlangAtom "none", adj_1, arg_6, pad_2]
...
erlps__fwrite_f__5 [fl_0, f_1, adj_2, (ErlangAtom "none"), pad_3]
  =
  let arg_7 = toErl 6
  in erlps__fwrite_f__5 [fl_0, f_1, adj_2, arg_7, pad_3]
...
erlps__fwrite_f__5 args =
  EXC.badarity (ErlangFun 5 erlps__fwrite_f__5) args
...
erlps__float_f__3 [fl_0, (ErlangTuple [ds_1, e_2]), p_3]
  ...
  in let arg_8 = BIF.erlang__op_plus [lop_9, rop_11]
  in let arg_12 = toErl 48
  in let
    lop_7 =
      BIF.do_remote_fun_call "Lists" "erlps__duplicate__2"
        [arg_8, arg_12]
  in let tup_el_6 = BIF.erlang__op_append [lop_7, ds_1]
  in let tup_el_14 = toErl 1
  in let arg_5 = ErlangTuple [tup_el_6, tup_el_14]
...
erlps__float_f__3 args =
  EXC.badarity (ErlangFun 3 erlps__float_f__3) args
...
erlps__float_data__1 args =
  EXC.badarity (ErlangFun 1 erlps__float_data__1) args
...
erlps__float_data__2 [(ErlangCons (ErlangInt num_0) e_1), ds_2]
  ...
  in let tup_el_5 = BIF.erlang__op_plus [lop_6, rop_8]
  in ErlangTuple [tup_el_3, tup_el_5]
erlps__float_data__2 [(ErlangCons d_0 cs_1), ds_2]
  | (weakGeq d_0 (toErl 48)) && (weakLeq d_0 (toErl 57)) =
...
erlps__float_data__2 args =
  EXC.badarity (ErlangFun 2 erlps__float_data__2) args

erlps__fwrite_g__1 :: ErlangFun
erlps__fwrite_g__1 [(ErlangFloat 0.00000000000000000000e+0)] = toErl "0.0"
erlps__fwrite_g__1 [float_0] | isEFloat float_0 =
  let matchExpr_4 = erlps__mantissa_exponent__1 [float_0]
  in
    case matchExpr_4 of
      (ErlangTuple [frac_2, exp_3]) ->
        let matchExpr_10 = erlps__fwrite_g_1__3 [float_0, exp_3, frac_2]
        in
              ...
              let   
                arg_12 =
                  flmap
                    (\ lc_15 ->
                       let    lop_17 = toErl 48
                       in let lcRet_16 = BIF.erlang__op_plus [lop_17, lc_15]
...
erlps__fwrite_g__1 args =
  EXC.badarity (ErlangFun 1 erlps__fwrite_g__1) args

erlps__mantissa_exponent__1 :: ErlangFun
erlps__mantissa_exponent__1 [f_0] =
  let
    case_1 = ErlangBinary (BIN.fromFloat f_0 (toErl 64) 1 BIN.Big)
  in
    case case_1 of
      (ErlangBinary binSeg_3) | (ErlangInt size_4) <- (toErl 1)
        ...
        in let lop_18 = toErl 53
        in let rop_17 = BIF.erlang__op_minus [lop_18, e_14]
        in let tup_el_15 = BIF.erlang__bsl__2 [m_12, rop_17]
        in let rop_23 = toErl 52
        in let lop_21 = BIF.erlang__op_minus [e_14, rop_23]
        in let rop_24 = toErl 1075
        in let tup_el_20 = BIF.erlang__op_minus [lop_21, rop_24]
        in ErlangTuple [tup_el_15, tup_el_20]
      (ErlangBinary binSeg_25) | (ErlangInt size_26) <- (toErl 1)
                               , (BIN.Ok _s_28 bin_27) <-
                                   (BIN.chopInt binSeg_25 size_26 1 BIN.Big
                                      BIN.Unsigned)
                               , (ErlangInt size_29) <- (toErl 11)
                               , (BIN.Ok be_31 bin_30) <-
                                   (BIN.chopInt bin_27 size_29 1 BIN.Big
                                      BIN.Unsigned)
                               , (ErlangInt size_32) <- (toErl 52)
                               , (BIN.Ok m_34 bin_33) <-
                                   (BIN.chopInt bin_30 size_32 1 BIN.Big
                                      BIN.Unsigned)
                               , BIN.empty bin_33
                               , weakLt be_31 (toErl 2047) ->
        let    lop_38 = toErl 1
        in let rop_39 = toErl 52
        in let rop_37 = BIF.erlang__bsl__2 [lop_38, rop_39]
        in let tup_el_35 = BIF.erlang__op_plus [m_34, rop_37]
        in let rop_42 = toErl 1075
        in let tup_el_40 = BIF.erlang__op_minus [be_31, rop_42]
...
erlps__mantissa_exponent__1 args =
  EXC.badarity (ErlangFun 1 erlps__mantissa_exponent__1) args

erlps__fwrite_g_1__3 :: ErlangFun
erlps__fwrite_g_1__3 [float_0, exp_1, frac_2] =
  let    rop_5 = toErl 1
  in let lop_3 = BIF.erlang__band__2 [frac_2, rop_5]
  in let rop_6 = toErl 0
  in let round_7 = BIF.erlang__op_exactEq [lop_3, rop_6]
  in
    case ErlangAtom "true" of
      _ | weakGeq exp_1 (toErl 0) ->
        let    lop_8 = toErl 1
        in let bexp_10 = BIF.erlang__bsl__2 [lop_8, exp_1]
        in
          case ErlangAtom "true" of
            _ | (ErlangAtom "true") ==
                  (falsifyErrors
              ...
              in let arg_15 = BIF.erlang__op_mult [lop_16, rop_19]
              in let arg_20 = toErl 4
              in let rop_23 = toErl 2
              in let arg_21 = BIF.erlang__op_mult [bexp_10, rop_23]
              in
                erlps__scale__7
                  [arg_15, arg_20, arg_21, bexp_10, round_7, round_7, float_0]
            _ ->
              let    lop_29 = BIF.erlang__op_mult [frac_2, bexp_10]
              in let rop_32 = toErl 2
              in let arg_28 = BIF.erlang__op_mult [lop_29, rop_32]
              in let arg_33 = toErl 2
              in
                erlps__scale__7
                  [arg_28, arg_33, bexp_10, bexp_10, round_7, round_7, float_0]
      _ | weakLt exp_1 (toErl (-1074)) ->
        let    lop_39 = toErl 1
        in let op_arg_42 = toErl 1074
        in let lop_41 = BIF.erlang__op_neg [op_arg_42]
        in let rop_40 = BIF.erlang__op_minus [lop_41, exp_1]
        in let bexp_44 = BIF.erlang__bsl__2 [lop_39, rop_40]
        in let rop_47 = toErl 2
        in let arg_45 = BIF.erlang__op_mult [frac_2, rop_47]
        in let lop_49 = toErl 1
        in let lop_51 = toErl 1
        in let rop_50 = BIF.erlang__op_minus [lop_51, exp_1]
        in let arg_48 = BIF.erlang__bsl__2 [lop_49, rop_50]
        in
          erlps__scale__7
            [arg_45, arg_48, bexp_44, bexp_44, round_7, round_7, float_0]
      _ | (ErlangAtom "true") ==
            (falsifyErrors
               (\ _ ->
                  let    op_arg_61 = toErl 1074
                  in let rop_60 = BIF.erlang__op_neg [op_arg_61]
                  in let lop_58 = BIF.erlang__op_greater [exp_1, rop_60]
                  in
                    case lop_58 of
                      (ErlangAtom "false") -> ErlangAtom "false"
                      (ErlangAtom "true") ->
                        let    lop_64 = toErl 1
                        in let rop_65 = toErl 52
                        in let rop_63 = BIF.erlang__bsl__2 [lop_64, rop_65]
                        in BIF.erlang__op_exactEq [frac_2, rop_63]
                      _ -> EXC.badarg1 lop_58)) ->
        let    rop_68 = toErl 4
        in let arg_66 = BIF.erlang__op_mult [frac_2, rop_68]
        in let lop_70 = toErl 1
        in let lop_72 = toErl 2
        in let rop_71 = BIF.erlang__op_minus [lop_72, exp_1]
        in let arg_69 = BIF.erlang__bsl__2 [lop_70, rop_71]
        in let arg_74 = toErl 2
        in let arg_75 = toErl 1
        in
          erlps__scale__7
            [arg_66, arg_69, arg_74, arg_75, round_7, round_7, float_0]
      _ ->
        let    rop_81 = toErl 2
        in let arg_79 = BIF.erlang__op_mult [frac_2, rop_81]
        in let lop_83 = toErl 1
        in let lop_85 = toErl 1
        in let rop_84 = BIF.erlang__op_minus [lop_85, exp_1]
        in let arg_82 = BIF.erlang__bsl__2 [lop_83, rop_84]
        in let arg_87 = toErl 1
        in let arg_88 = toErl 1
        in
          erlps__scale__7
            [arg_79, arg_82, arg_87, arg_88, round_7, round_7, float_0]
erlps__fwrite_g_1__3 [arg_92, arg_93, arg_94] =
  EXC.function_clause unit
erlps__fwrite_g_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__fwrite_g_1__3) args
...
erlps__scale__7 [r_0, s_1, mplus_2, mminus_3, lowok_4, highok_5,
  ...
  in
    case ErlangAtom "true" of
      _ | weakGeq est_12 (toErl 0) ->
        let    arg_17 = toErl 10
        in let rop_16 = erlps__int_pow__2 [arg_17, est_12]
      ...
      _ ->
        let    arg_24 = toErl 10
        in let arg_25 = BIF.erlang__op_neg [est_12]
        in let scale_27 = erlps__int_pow__2 [arg_24, arg_25]
...
erlps__scale__7 args =
  EXC.badarity (ErlangFun 7 erlps__scale__7) args
...
erlps__fixup__7 [r_0, s_1, mplus_2, mminus_3, k_4, lowok_5,
  ...
  in
    case toolow_15 of
      (ErlangAtom "true") ->
        let    rop_19 = toErl 1
        in let tup_el_17 = BIF.erlang__op_plus [k_4, rop_19]
        in let
          tup_el_20 =
            erlps__generate__6
      ...
      (ErlangAtom "false") ->
        let    rop_31 = toErl 10
        in let arg_29 = BIF.erlang__op_mult [r_0, rop_31]
        in let rop_35 = toErl 10
        in let arg_33 = BIF.erlang__op_mult [mplus_2, rop_35]
        in let rop_38 = toErl 10
        in let arg_36 = BIF.erlang__op_mult [mminus_3, rop_38]
        in let
          tup_el_28 =
            erlps__generate__6
...
erlps__fixup__7 args =
  EXC.badarity (ErlangFun 7 erlps__fixup__7) args
  ...
  in
    case case_26 of
      (ErlangTuple [(ErlangAtom "false"), (ErlangAtom "false")]) ->
        let    rop_33 = toErl 10
        in let arg_31 = BIF.erlang__op_mult [r_11, rop_33]
        in let rop_37 = toErl 10
        in let arg_35 = BIF.erlang__op_mult [mplus_2, rop_37]
        in let rop_40 = toErl 10
        in let arg_38 = BIF.erlang__op_mult [mminus_3, rop_40]
        in let
          tail_30 =
            erlps__generate__6
      ...
      (ErlangTuple [(ErlangAtom "false"), (ErlangAtom "true")]) ->
        let    rop_45 = toErl 1
        in let head_43 = BIF.erlang__op_plus [d_8, rop_45]
      ...
      (ErlangTuple [(ErlangAtom "true"), (ErlangAtom "true")]) ->
        let    rop_57 = toErl 1
        in let head_55 = BIF.erlang__op_plus [d_8, rop_57]
...
erlps__generate__6 args =
  EXC.badarity (ErlangFun 6 erlps__generate__6) args
...
erlps__insert_decimal__2 [place_0, s_1] =
  ...
  in
    case ErlangAtom "true" of
      _ | (weakLt place_0 (toErl 0)) || (weakGeq place_0 l_3) ->
        let    rop_6 = toErl 1
        in let arg_4 = BIF.erlang__op_minus [place_0, rop_6]
        in let expl_7 = BIF.erlang__integer_to_list__1 [arg_4]
        in let
          expdot_8 =
            case ErlangAtom "true" of
              _ | (==) l_3 (toErl 1) -> toErl 2
              _ -> toErl 1
        in let lop_10 = BIF.erlang__length__1 [expl_7]
        in let rop_12 = toErl 1
        in let lop_9 = BIF.erlang__op_plus [lop_10, rop_12]
        in let expcost_14 = BIF.erlang__op_plus [lop_9, expdot_8]
        in
          case ErlangAtom "true" of
            _ | weakLt place_0 (toErl 0) ->
              case ErlangAtom "true" of
                _ | (ErlangAtom "true") ==
                      (falsifyErrors
                         (\ _ ->
                            let    lop_16 = toErl 2
                            in let
                              lop_15 = BIF.erlang__op_minus [lop_16, place_0]
                            in BIF.erlang__op_lesserEq [lop_15, expcost_14])) ->
                  let    lop_19 = toErl "0."
                  in let arg_22 = BIF.erlang__op_neg [place_0]
                  in let arg_24 = toErl 48
                  in let
                    lop_21 =
                      BIF.do_remote_fun_call "Lists" "erlps__duplicate__2"
                        [arg_22, arg_24]
                  in let rop_20 = BIF.erlang__op_append [lop_21, s_1]
                  in BIF.erlang__op_append [lop_19, rop_20]
                _ -> erlps__insert_exp__2 [expl_7, s_1]
            _ ->
              case ErlangAtom "true" of
                _ | (ErlangAtom "true") ==
                      (falsifyErrors
                         (\ _ ->
                            let    lop_29 = BIF.erlang__op_minus [place_0, l_3]
                            in let rop_32 = toErl 2
                            in let lop_28 = BIF.erlang__op_plus [lop_29, rop_32]
                            in BIF.erlang__op_lesserEq [lop_28, expcost_14])) ->
                  let    arg_37 = BIF.erlang__op_minus [place_0, l_3]
                  in let arg_40 = toErl 48
                  in let
                    lop_36 =
                      BIF.do_remote_fun_call "Lists" "erlps__duplicate__2"
                        [arg_37, arg_40]
                  in let rop_41 = toErl ".0"
                  in let rop_35 = BIF.erlang__op_append [lop_36, rop_41]
                  in BIF.erlang__op_append [s_1, rop_35]
                _ -> erlps__insert_exp__2 [expl_7, s_1]
      _ ->
        let
          matchExpr_48 =
        ...
        in
          case matchExpr_48 of
            (ErlangTuple [s0_46, s1_47]) ->
              let    lop_51 = toErl "."
              in let rop_50 = BIF.erlang__op_append [lop_51, s1_47]
              in BIF.erlang__op_append [s0_46, rop_50]
            _ -> EXC.badmatch matchExpr_48
erlps__insert_decimal__2 [arg_53, arg_54] =
  EXC.function_clause unit
erlps__insert_decimal__2 args =
  EXC.badarity (ErlangFun 2 erlps__insert_decimal__2) args
...
erlps__insert_exp__2 [expl_0, (ErlangCons c_1 (ErlangEmptyList))]
  ...
  in BIF.erlang__op_append [ErlangCons c_1 ErlangEmptyList, rop_5]
erlps__insert_exp__2 [expl_0, (ErlangCons c_1 s_2)] =
  let    lop_7 = toErl "."
  in let lop_11 = toErl "e"
  ...
  in BIF.erlang__op_append [ErlangCons c_1 ErlangEmptyList, rop_6]
erlps__insert_exp__2 [arg_13, arg_14] = EXC.function_clause unit
erlps__insert_exp__2 args =
  EXC.badarity (ErlangFun 2 erlps__insert_exp__2) args
...
erlps__int_ceil__1 [x_0] | isEFloat x_0 =
  ...
  in
    case case_3 of
      neg_6 | weakLt neg_6 (toErl 0) -> t_2
      pos_7 | weakGt pos_7 (toErl 0) ->
        let rop_9 = toErl 1
        in BIF.erlang__op_plus [t_2, rop_9]
      _ -> t_2
erlps__int_ceil__1 [arg_10] = EXC.function_clause unit
erlps__int_ceil__1 args =
  EXC.badarity (ErlangFun 1 erlps__int_ceil__1) args
...
erlps__int_pow__2 [x_0, n_1]
  | ((isEInt x_0) && (isEInt n_1)) && (weakGt n_1 (toErl 0)) =
  let arg_4 = toErl 1
  in erlps__int_pow__3 [x_0, n_1, arg_4]
erlps__int_pow__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__int_pow__2 args =
  EXC.badarity (ErlangFun 2 erlps__int_pow__2) args

erlps__int_pow__3 :: ErlangFun
erlps__int_pow__3 [x_0, n_1, r_2] | weakLt n_1 (toErl 2) =
  BIF.erlang__op_mult [r_2, x_0]
erlps__int_pow__3 [x_0, n_1, r_2] =
  let    arg_3 = BIF.erlang__op_mult [x_0, x_0]
  in let rop_8 = toErl 1
  in let arg_6 = BIF.erlang__bsr__2 [n_1, rop_8]
  in let rop_12 = toErl 1
  in let case_10 = BIF.erlang__band__2 [n_1, rop_12]
  in let
    arg_9 =
      case case_10 of
        (ErlangInt num_13) | (ErlangInt num_13) == (toErl 1) ->
          BIF.erlang__op_mult [r_2, x_0]
        (ErlangInt num_16) | (ErlangInt num_16) == (toErl 0) -> r_2
        something_else -> EXC.case_clause something_else
  in erlps__int_pow__3 [arg_3, arg_6, arg_9]
erlps__int_pow__3 [arg_17, arg_18, arg_19] =
  EXC.function_clause unit
erlps__int_pow__3 args =
  EXC.badarity (ErlangFun 3 erlps__int_pow__3) args

erlps__log2floor__1 :: ErlangFun
erlps__log2floor__1 [int_0]
  | (isEInt int_0) && (weakGt int_0 (toErl 0)) =
  let arg_2 = toErl 0
  in erlps__log2floor__2 [int_0, arg_2]
erlps__log2floor__1 [arg_3] = EXC.function_clause unit
erlps__log2floor__1 args =
  EXC.badarity (ErlangFun 1 erlps__log2floor__1) args
...
erlps__fwrite_g__5 [fl_0, f_1, adj_2, p_3, pad_4]
    ...
    e_21 =
      case ErlangAtom "true" of
        _ | (ErlangAtom "true") ==
          ...
          let op_arg_9 = toErl 2
          in BIF.erlang__op_neg [op_arg_9]
        _ | (ErlangAtom "true") ==
              (falsifyErrors
                 (\ _ ->
          ...
          let op_arg_12 = toErl 1
          in BIF.erlang__op_neg [op_arg_12]
        _ | (ErlangAtom "true") ==
              (falsifyErrors
                 (\ _ ->
  ...
  in
    case ErlangAtom "true" of
      _ | ((weakLeq p_3 (toErl 1)) && ((==) e_21 (toErl (-1)))) ||
            ((ErlangAtom "true") ==
               (falsifyErrors
                  (\ _ ->
                     let    rop_25 = toErl 1
                     in let lop_23 = BIF.erlang__op_minus [p_3, rop_25]
                     in let lop_22 = BIF.erlang__op_greater [lop_23, e_21]
                     in
                       case lop_22 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           let    op_arg_29 = toErl 1
                           in let rop_28 = BIF.erlang__op_neg [op_arg_29]
                           in BIF.erlang__op_greaterEq [e_21, rop_28]
                         _ -> EXC.badarg1 lop_22))) ->
        let    rop_36 = toErl 1
        in let lop_34 = BIF.erlang__op_minus [p_3, rop_36]
        in let arg_33 = BIF.erlang__op_minus [lop_34, e_21]
        in erlps__fwrite_f__5 [fl_0, f_1, adj_2, arg_33, pad_4]
      _ | weakLeq p_3 (toErl 1) ->
        let arg_42 = toErl 2
        in erlps__fwrite_e__5 [fl_0, f_1, adj_2, arg_42, pad_4]
      _ -> erlps__fwrite_e__5 [fl_0, f_1, adj_2, p_3, pad_4]
erlps__fwrite_g__5 [arg_49, arg_50, arg_51, arg_52, arg_53] =
  EXC.function_clause unit
erlps__fwrite_g__5 args =
  EXC.badarity (ErlangFun 5 erlps__fwrite_g__5) args

erlps__iolist_to_chars__3 :: ErlangFun
erlps__iolist_to_chars__3 [cs_0, f_1, charslimit_2]
  | (weakLt charslimit_2 (toErl 0)) || (weakGeq charslimit_2 f_1) =
  erlps__iolist_to_chars__1 [cs_0]
erlps__iolist_to_chars__3 [cs_0, _, charslimit_1] =
  let    arg_5 = toErl 3
  in let arg_3 = erlps__sub__2 [charslimit_1, arg_5]
  in
...
erlps__iolist_to_chars__3 args =
  EXC.badarity (ErlangFun 3 erlps__iolist_to_chars__3) args
...
erlps__iolist_to_chars__1 [b_0] | isEBinary b_0 =
  BIF.erlang__binary_to_list__1 [b_0]
erlps__iolist_to_chars__1 [arg_2] = EXC.function_clause unit
erlps__iolist_to_chars__1 args =
  EXC.badarity (ErlangFun 1 erlps__iolist_to_chars__1) args
...
erlps__limit_iolist_to_chars__4 [cs_0, (ErlangInt num_1), s_2,
  ...
  in let
    l_7 =
      erlps__limit_iolist_to_chars__4
        [cs_0, arg_4, s_2, ErlangAtom "final"]
  in let case_8 = BIF.erlang__iolist_size__1 [l_7]
  in
    case case_8 of
      n_10 | weakLt n_10 (toErl 4) -> l_7
      (ErlangInt num_11) | (ErlangInt num_11) == (toErl 4) ->
        toErl "..."
      something_else -> EXC.case_clause something_else
...
erlps__limit_iolist_to_chars__4 [(ErlangCons c_0 cs_1), limit_2,
  ...
  let    rop_10 = toErl 1
  in let arg_8 = BIF.erlang__op_minus [limit_2, rop_10]
  in let
    tail_6 =
  ...
  in
    case case_4 of
      sz_6 | weakGt sz_6 limit_1 ->
        let matchExpr_11 = BIF.erlang__split_binary__2 [b_0, limit_1]
        in
          case matchExpr_11 of
            (ErlangTuple [b1_9, b2_10]) ->
              ...
              in let
                tail_14 =
                  erlps__limit_iolist_to_chars__4 [b2_10, arg_16, s_2, mode_3]
...
erlps__limit_iolist_to_chars__4 [arg_29, arg_30, arg_31, arg_32]
  =
  EXC.function_clause unit
erlps__limit_iolist_to_chars__4 args =
  EXC.badarity (ErlangFun 4 erlps__limit_iolist_to_chars__4) args
...
erlps__cdata_to_chars__3 [cs_0, _, charslimit_1] =
  ...
  in let arg_3 = erlps__sub__2 [charslimit_1, arg_5]
  in
    erlps__limit_cdata_to_chars__3 [cs_0, arg_3, ErlangAtom "normal"]
erlps__cdata_to_chars__3 [arg_7, arg_8, arg_9] =
  EXC.function_clause unit
erlps__cdata_to_chars__3 args =
  EXC.badarity (ErlangFun 3 erlps__cdata_to_chars__3) args
...
erlps__cdata_to_chars__1 [b_0] | isEBinary b_0 =
  let
    case_1 =
      EXC.tryCatch
        (\ _ ->
...
erlps__limit_cdata_to_chars__3 [cs_0, (ErlangInt num_1),
  ...
  in let
    l_5 =
      erlps__limit_cdata_to_chars__3 [cs_0, arg_3, ErlangAtom "final"]
  in let
    case_6 = BIF.do_remote_fun_call "String" "erlps__length__1" [l_5]
  in
    case case_6 of
      n_8 | weakLt n_8 (toErl 4) -> l_5
      (ErlangInt num_9) | (ErlangInt num_9) == (toErl 4) -> toErl "..."
      something_else -> EXC.case_clause something_else
...
erlps__limit_cdata_to_chars__3 [cs_0, limit_1, mode_2] =
  let
    case_3 =
      BIF.do_remote_fun_call "String" "erlps__next_grapheme__1" [cs_0]
  in
    case case_3 of
      (ErlangTuple [(ErlangAtom "error"),
                    (ErlangBinary binSeg_5)]) | (ErlangInt size_6) <- (toErl 8)
                                              , (BIN.Ok c_8 bin_7) <-
                                                  (BIN.chopInt binSeg_5 size_6 1
                                                     BIN.Big BIN.Unsigned)
                                              , (ErlangInt size_9) <-
                                                  (BIN.size bin_7)
                                              , (BIN.Ok cs1_11 bin_10) <-
                                                  (BIN.chopBin bin_7 size_9 8)
                                              , BIN.empty bin_10 ->
        let    rop_17 = toErl 1
        in let arg_15 = BIF.erlang__op_minus [limit_1, rop_17]
        in let
          tail_13 = erlps__limit_cdata_to_chars__3 [cs1_11, arg_15, mode_2]
        in ErlangCons c_8 tail_13
      (ErlangTuple [(ErlangAtom "error"), (ErlangCons c_19 cs1_20)]) ->
        let    rop_26 = toErl 1
        in let arg_24 = BIF.erlang__op_minus [limit_1, rop_26]
        in let
          tail_22 = erlps__limit_cdata_to_chars__3 [cs1_20, arg_24, mode_2]
        in ErlangCons c_19 tail_22
      (ErlangEmptyList) -> ErlangEmptyList
      (ErlangCons gc_28 cs1_29) ->
        let    rop_35 = toErl 1
        in let arg_33 = BIF.erlang__op_minus [limit_1, rop_35]
        in let
          tail_31 = erlps__limit_cdata_to_chars__3 [cs1_29, arg_33, mode_2]
        in ErlangCons gc_28 tail_31
      something_else -> EXC.case_clause something_else
erlps__limit_cdata_to_chars__3 [arg_37, arg_38, arg_39] =
  EXC.function_clause unit
erlps__limit_cdata_to_chars__3 args =
  EXC.badarity (ErlangFun 3 erlps__limit_cdata_to_chars__3) args

erlps__limit_field__2 :: ErlangFun
erlps__limit_field__2 [f_0, charslimit_1]
  | (weakLt charslimit_1 (toErl 0)) ||
      ((==) f_0 (ErlangAtom "none")) =
  f_0
erlps__limit_field__2 [f_0, charslimit_1] =
  let    arg_2 = toErl 3
  in let arg_3 = BIF.erlang__min__2 [f_0, charslimit_1]
  in BIF.erlang__max__2 [arg_2, arg_3]
erlps__limit_field__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__limit_field__2 args =
  EXC.badarity (ErlangFun 2 erlps__limit_field__2) args
...
erlps__string__6 [s_0, f_1, adj_2, (ErlangAtom "none"), pad_3,
  ...
  let
    arg_8 =
      BIF.do_remote_fun_call "Io.Lib" "erlps__chars_length__1" [s_0]
  in erlps__string_field__6 [s_0, f_1, adj_2, arg_8, pad_3, enc_4]
...
erlps__string__6 [s_0, f_1, adj_2, p_3, pad_4, enc_5]
  ...
  in
    case ErlangAtom "true" of
      ...
      _ -> erlps__string_field__6 [s_0, f_1, adj_2, n_7, pad_4, enc_5]
erlps__string__6 [arg_44, arg_45, arg_46, arg_47, arg_48, arg_49]
  =
  EXC.function_clause unit
erlps__string__6 args =
  EXC.badarity (ErlangFun 6 erlps__string__6) args
...
erlps__string_field__6 args =
  EXC.badarity (ErlangFun 6 erlps__string_field__6) args
...
erlps__unprefixed_integer__6 [int_0, f_1, adj_2, base_3, pad_4,
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            let    rop_31 = toErl 2
            in let lop_29 = BIF.erlang__op_greaterEq [base_3, rop_31]
            in
              case lop_29 of
                (ErlangAtom "false") -> ErlangAtom "false"
                (ErlangAtom "true") ->
                  ...
                  in let lop_34 = BIF.erlang__op_minus [lop_35, rop_38]
...
erlps__prefixed_integer__7 [int_0, f_1, adj_2, base_3, pad_4,
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            let    rop_36 = toErl 2
            in let lop_34 = BIF.erlang__op_greaterEq [base_3, rop_36]
            in
              case lop_34 of
                (ErlangAtom "false") -> ErlangAtom "false"
                (ErlangAtom "true") ->
                  let    lop_41 = toErl 1
                  in let rop_42 = toErl 90
                  in let lop_40 = BIF.erlang__op_plus [lop_41, rop_42]
                  in let rop_43 = toErl 65
                  in let lop_39 = BIF.erlang__op_minus [lop_40, rop_43]
                  in let rop_44 = toErl 10
                  in let rop_38 = BIF.erlang__op_plus [lop_39, rop_44]
  ...
  case ErlangAtom "true" of
    _ | weakLt int_0 (toErl 0) ->
      ...
      in let head_14 = toErl 45
      in
        erlps__term__5
          [ErlangCons head_14 (ErlangCons prefix_5 s_12), f_1, adj_2,
    ...
    _ ->
      ...
      in
        erlps__term__5
          [ErlangCons prefix_5 s_26, f_1, adj_2, ErlangAtom "none", pad_4]
erlps__prefixed_integer__7 [arg_45, arg_46, arg_47, arg_48,
                            arg_49, arg_50, arg_51]
  =
  EXC.function_clause unit
erlps__prefixed_integer__7 args =
  EXC.badarity (ErlangFun 7 erlps__prefixed_integer__7) args
...
erlps__char__5 [c_0, f_1, adj_2, p_3, pad_4] | weakGeq f_1 p_3 =
...
erlps__char__5 [arg_14, arg_15, arg_16, arg_17, arg_18] =
  EXC.function_clause unit
erlps__char__5 args =
  EXC.badarity (ErlangFun 5 erlps__char__5) args
...
erlps__newline__4 [f_0, (ErlangAtom "right"), _p_1, _pad_2] =
  let arg_3 = toErl 10
  in erlps__chars__2 [arg_3, f_0]
erlps__newline__4 [arg_5, arg_6, arg_7, arg_8] =
  EXC.function_clause unit
erlps__newline__4 args =
  EXC.badarity (ErlangFun 4 erlps__newline__4) args
...
erlps__adjust__3 [arg_4, arg_5, arg_6] = EXC.function_clause unit
erlps__adjust__3 args =
  EXC.badarity (ErlangFun 3 erlps__adjust__3) args
...
erlps__flat_trunc__3 args =
  EXC.badarity (ErlangFun 3 erlps__flat_trunc__3) args
         ...
         (\ _ ->
            ...
            in
              case lop_9 of
                ...
                (ErlangAtom "true") ->
                  let    rop_13 = toErl 1
                  in let lop_11 = BIF.erlang__band__2 [n_1, rop_13]
...
erlps__cond_lowercase__2 args =
  EXC.badarity (ErlangFun 2 erlps__cond_lowercase__2) args

erlps__lowercase__1 :: ErlangFun
erlps__lowercase__1 [(ErlangCons h_0 t_1)]
  | ((isEInt h_0) && (weakGeq h_0 (toErl 65))) &&
      (weakLeq h_0 (toErl 90)) =
  let    rop_5 = toErl 65
  in let lop_3 = BIF.erlang__op_minus [h_0, rop_5]
  in let rop_6 = toErl 97
  in let head_2 = BIF.erlang__op_plus [lop_3, rop_6]
