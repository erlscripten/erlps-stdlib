...
erlps__obsolete__3 [(ErlangAtom "auth"), (ErlangAtom "cookie"),
  ...
  let tup_el_2 = (H.make_string "use erlang:get_cookie/0 instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "auth"), (ErlangAtom "cookie"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use erlang:set_cookie/2 instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "auth"), (ErlangAtom "is_auth"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use net_adm:ping/1 instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
...
erlps__obsolete__3 [(ErlangAtom "code"), (ErlangAtom "rehash"),
  ...
  let
    tup_el_2 =
      (H.make_string "the code path cache feature has been removed")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
...
erlps__obsolete__3 [(ErlangAtom "crypto"), (ErlangAtom "cmac"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let    tup_el_2 = (H.make_string "use crypto:mac/4 instead")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "crypto"), (ErlangAtom "cmac"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let    tup_el_2 = (H.make_string "use crypto:macN/5 instead")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let   
    tup_el_2 = (H.make_string "use crypto:mac_final/1 instead")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  let   
    tup_el_2 = (H.make_string "use crypto:mac_finalN/2 instead")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "hmac_init"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let    tup_el_2 = (H.make_string "use crypto:mac_init/3 instead")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let   
    tup_el_2 = (H.make_string "use crypto:mac_update/2 instead")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "poly1305"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let    tup_el_2 = (H.make_string "use crypto:mac/3 instead")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "filename"),
  ...
  let   
    tup_el_2 =
      (H.make_string "use filelib:safe_relative_path/2 instead")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "http_uri"),
                    (ErlangAtom "decode"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let   
    tup_el_2 = (H.make_string "use uri_string functions instead")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "http_uri"),
...
erlps__obsolete__3 [(ErlangAtom "httpd"),
  ...
  let
    tup_el_2 =
      (H.make_string "use uri_string:dissect_query/1 instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "megaco"),
  ...
  let   
    tup_el_2 =
      (H.make_string "use megaco:print_version_info/0,1 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "net"), (ErlangAtom "broadcast"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let
    tup_el_2 = (H.make_string "use rpc:eval_everywhere/3 instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "net"), (ErlangAtom "call"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let tup_el_2 = (H.make_string "use rpc:call/4 instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "net"), (ErlangAtom "cast"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let tup_el_2 = (H.make_string "use rpc:cast/4 instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
...
erlps__obsolete__3 [(ErlangAtom "net"), (ErlangAtom "relay"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use slave:relay/1 instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "net"), (ErlangAtom "sleep"),
  ...
  let
    tup_el_2 =
      (H.make_string "use \'receive after T -> ok end\' instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "queue"), (ErlangAtom "lait"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use queue:liat/1 instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "add_agent_caps"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:add_agent_caps/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
...
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:change_log_size/1 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
...
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:current_address/0 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:current_community/0 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:current_context/0 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:current_net_if_data/0 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:current_request_id/0 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:del_agent_caps/1 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:dump_mibs/0 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "dump_mibs"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:dump_mibs/1 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:enum_to_int/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "enum_to_int"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:enum_to_int/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"), (ErlangAtom "get"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let    tup_el_2 = (H.make_string "use snmpa:get/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:get_agent_caps/0 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:get_symbolic_store_db/0 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"), (ErlangAtom "info"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let    tup_el_2 = (H.make_string "use snmpa:info/1 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:int_to_enum/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "int_to_enum"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:int_to_enum/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
...
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:load_mibs/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:log_to_txt/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "log_to_txt"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:log_to_txt/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "log_to_txt"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:log_to_txt/4 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
...
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:name_to_oid/1 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "name_to_oid"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:name_to_oid/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:oid_to_name/1 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "oid_to_name"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:oid_to_name/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:register_subagent/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:send_notification/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "send_notification"), (ErlangInt num_0)]
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:send_notification/4 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "send_notification"), (ErlangInt num_0)]
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:send_notification/5 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "send_notification"), (ErlangInt num_0)]
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:send_notification/6 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:send_trap/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
                    (ErlangAtom "send_trap"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:send_trap/4 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let   
    tup_el_2 = (H.make_string "use snmpa:unload_mibs/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmp"),
  ...
  let   
    tup_el_2 =
      (H.make_string "use snmpa:unregister_subagent/2 instead.")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpa"),
                    (ErlangAtom "old_info_format"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let    tup_el_2 = (H.make_string "use \"new\" format instead")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:async_get2/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "async_get"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:async_get2/4 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "async_get"), (ErlangInt num_0)]
...
erlps__obsolete__3 [(ErlangAtom "snmpm"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 5))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:async_get_bulk2/5 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "async_get_bulk"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 6))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:async_get_bulk2/6 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "async_get_bulk"), (ErlangInt num_0)]
...
erlps__obsolete__3 [(ErlangAtom "snmpm"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:async_get_next2/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "async_get_next"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:async_get_next2/4 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "async_get_next"), (ErlangInt num_0)]
...
erlps__obsolete__3 [(ErlangAtom "snmpm"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:async_set2/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "async_set"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:async_set2/4 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "async_set"), (ErlangInt num_0)]
...
erlps__obsolete__3 [(ErlangAtom "snmpm"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:sync_get2/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "sync_get"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:sync_get2/4 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "sync_get"), (ErlangInt num_0)]
...
erlps__obsolete__3 [(ErlangAtom "snmpm"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 5))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:sync_get_bulk2/5 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "sync_get_bulk"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 6))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:sync_get_bulk2/6 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "sync_get_bulk"), (ErlangInt num_0)]
...
erlps__obsolete__3 [(ErlangAtom "snmpm"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:sync_get_next2/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "sync_get_next"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:sync_get_next2/4 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "sync_get_next"), (ErlangInt num_0)]
...
erlps__obsolete__3 [(ErlangAtom "snmpm"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:sync_set2/3 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "sync_set"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 4))) =
  let   
    tup_el_2 = (H.make_string "use snmpm:sync_set2/4 instead.")
  in let tup_el_3 = (H.make_string "OTP 25")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "snmpm"),
                    (ErlangAtom "sync_set"), (ErlangInt num_0)]
...
erlps__obsolete__3 [(ErlangAtom "ssl"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let    tup_el_2 = (H.make_string "use cipher_suites/2,3 instead")
  in let tup_el_3 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2, tup_el_3])
erlps__obsolete__3 [(ErlangAtom "ssl"),
                    (ErlangAtom "cipher_suites"), (ErlangInt num_0)]
...
erlps__obsolete__3 [(ErlangAtom "wxCalendarCtrl"),
  ...
  let
    tup_el_2 =
      (H.make_string "not available in wxWidgets-2.9 and later")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "wxCalendarCtrl"),
                    (ErlangAtom "enableYearChange"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
...
erlps__obsolete__3 [(ErlangAtom "core_lib"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use cerl:get_ann/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "core_lib"),
                    (ErlangAtom "is_literal"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use cerl:is_literal/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "core_lib"),
                    (ErlangAtom "is_literal_list"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let
    tup_el_2 = (H.make_string "use cerl:is_literal_list/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "core_lib"),
                    (ErlangAtom "literal_value"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use cerl:concrete/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "core_lib"),
                    (ErlangAtom "set_anno"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use cerl:set_ann/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "aes_cbc_128_decrypt"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let
    tup_el_2 = (H.make_string "use crypto:block_decrypt/4 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "aes_cbc_128_encrypt"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let
    tup_el_2 = (H.make_string "use crypto:block_encrypt/4 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use crypto:next_iv/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let
    tup_el_2 = (H.make_string "use crypto:stream_decrypt/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "aes_ctr_encrypt"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let
    tup_el_2 = (H.make_string "use crypto:stream_encrypt/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use crypto:stream_init/3 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let
    tup_el_2 = (H.make_string "use crypto:block_decrypt/3 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "blowfish_ecb_encrypt"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let
    tup_el_2 = (H.make_string "use crypto:block_encrypt/3 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use crypto:next_iv/3 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let tup_el_2 = (H.make_string "use crypto:compute_key/4 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "dh_generate_key"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let
    tup_el_2 = (H.make_string "use crypto:generate_key/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "dh_generate_key"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let
    tup_el_2 = (H.make_string "use crypto:generate_key/3 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"), (ErlangAtom "erlint"),
  ...
  let
    tup_el_2 =
      (H.make_string "only needed by other removed functions")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"), (ErlangAtom "info"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let tup_el_2 = (H.make_string "use crypto:module_info/0 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"), (ErlangAtom "md4"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use crypto:hash/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "md4_final"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use crypto:hash_final/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "md4_init"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let tup_el_2 = (H.make_string "use crypto:hash_init/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "md4_update"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use crypto:hash_update/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use crypto:hmac/3 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "md5_mac_96"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use crypto:hmac/4 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let tup_el_2 = (H.make_string "use crypto:mod_pow/3 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  let
    tup_el_2 =
      (H.make_string "use crypto:strong_rand_bytes/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use crypto:stream_init/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
...
erlps__obsolete__3 [(ErlangAtom "erl_lint"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use erl_parse:map_anno/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "erl_parse"),
  ...
  let
    tup_el_2 =
      (H.make_string "erl_anno:{column,line,location,text}/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "erl_parse"),
...
erlps__obsolete__3 [(ErlangAtom "erl_parse"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use erl_anno:set_line/2")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "erl_scan"),
                    (ErlangAtom "set_attribute"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let tup_el_2 = (H.make_string "use erl_anno:set_line/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "erlang"), (ErlangAtom "hash"),
                    (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use erlang:phash2/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "httpd_conf"),
                    (ErlangAtom "check_enum"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let tup_el_2 = (H.make_string "use lists:member/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "httpd_conf"),
...
erlps__obsolete__3 [(ErlangAtom "httpd_conf"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use filelib:is_dir/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "httpd_conf"),
                    (ErlangAtom "is_file"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let tup_el_2 = (H.make_string "use filelib:is_file/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "httpd_conf"),
                    (ErlangAtom "make_integer"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 1))) =
  let
    tup_el_2 = (H.make_string "use erlang:list_to_integer/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "rpc"),
                    (ErlangAtom "safe_multi_server_call"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 2))) =
  let
    tup_el_2 = (H.make_string "use rpc:multi_server_call/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "rpc"),
                    (ErlangAtom "safe_multi_server_call"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 3))) =
  let
    tup_el_2 = (H.make_string "use rpc:multi_server_call/3 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "ssl"),
  ...
  let
    tup_el_2 =
      (H.make_string "use ssl:connection_information/[1,2] instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete__3 [(ErlangAtom "ssl"),
  ...
  let
    tup_el_2 =
      (H.make_string "use ssl:negotiated_protocol/1 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
...
erlps__obsolete__3 [(ErlangAtom "filename"),
  ...
  =
  let   
    tup_el_1 = (H.make_string "use filelib:find_source/1,3 instead")
  in let tup_el_2 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_1, tup_el_2])
erlps__obsolete__3 [(ErlangAtom "ssl"),
  ...
  =
  let   
    tup_el_1 = (H.make_string "use ssl_handshake/1,2,3 instead")
  in let tup_el_2 = (H.make_string "OTP 24")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_1, tup_el_2])
erlps__obsolete__3 [(ErlangAtom "asn1ct"), (ErlangAtom "decode"),
                    _]
  =
  let tup_el_1 = (H.make_string "use Mod:decode/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_1])
erlps__obsolete__3 [(ErlangAtom "asn1ct"), (ErlangAtom "encode"),
                    _]
  =
  let tup_el_1 = (H.make_string "use Mod:encode/2 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_1])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "dss_sign"), _]
  =
  let tup_el_1 = (H.make_string "use crypto:sign/4 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_1])
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "dss_verify"), _]
  =
  let tup_el_1 = (H.make_string "use crypto:verify/5 instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_1])
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "random"), _, _] =
  let tup_el_1 = (H.make_string "use the \'rand\' module instead")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_1])
erlps__obsolete__3 [(ErlangAtom "os_mon_mib"), _, _] =
  let
    tup_el_1 = (H.make_string "this module was removed in OTP 22.0")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_1])
...
erlps__obsolete_type__3 [(ErlangAtom "crypto"),
                         ...
                         (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let tup_el_2 = (H.make_string "Use aes_*_cbc or des_ede3_cbc")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete_type__3 [(ErlangAtom "crypto"),
  ...
  let
    tup_el_2 =
      (H.make_string "Use aes_*_cfb8, aes_*_cfb128 or des_ede3_cfb")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete_type__3 [(ErlangAtom "crypto"),
                         (ErlangAtom "retired_ctr_cipher_aliases"),
                         (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let tup_el_2 = (H.make_string "Use aes_*_ctr")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete_type__3 [(ErlangAtom "crypto"),
                         (ErlangAtom "retired_ecb_cipher_aliases"),
                         (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let tup_el_2 = (H.make_string "Use aes_*_ecb")
  in (ErlangTuple [(ErlangAtom "deprecated"), tup_el_2])
erlps__obsolete_type__3 [(ErlangAtom "erl_scan"),
                         (ErlangAtom "column"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let tup_el_2 = (H.make_string "use erl_anno:column() instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete_type__3 [(ErlangAtom "erl_scan"),
                         (ErlangAtom "line"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let tup_el_2 = (H.make_string "use erl_anno:line() instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
erlps__obsolete_type__3 [(ErlangAtom "erl_scan"),
                         (ErlangAtom "location"), (ErlangInt num_0)]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 0))) =
  let tup_el_2 = (H.make_string "use erl_anno:location() instead")
  in (ErlangTuple [(ErlangAtom "removed"), tup_el_2])
