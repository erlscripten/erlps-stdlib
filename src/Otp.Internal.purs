...
erlps__obsolete__3 [(ErlangAtom "crypto"),
  ...
  =
  let tup_el_1 = toErl "use crypto:sign/4 instead"
  in ErlangTuple [ErlangAtom "removed", tup_el_1]
erlps__obsolete__3 [(ErlangAtom "crypto"),
                    (ErlangAtom "dss_verify"), _]
  =
  let tup_el_1 = toErl "use crypto:verify/5 instead"
  in ErlangTuple [ErlangAtom "removed", tup_el_1]
erlps__obsolete__3 [(ErlangAtom "crypto"),
...
erlps__obsolete__3 [(ErlangAtom "erl_scan"),
  ...
  =
  let
    tup_el_1 = toErl "erl_anno:{column,line,location,text}/1 instead"
  in ErlangTuple [ErlangAtom "removed", tup_el_1]
erlps__obsolete__3 [(ErlangAtom "erl_scan"),
...
erlps__obsolete__3 [(ErlangAtom "igor"), _, _] =
  let    tup_el_1 = toErl "use https://github.com/richcarl/igor"
  in let tup_el_2 = toErl "OTP 24"
  in ErlangTuple [ErlangAtom "deprecated", tup_el_1, tup_el_2]
erlps__obsolete__3 [(ErlangAtom "pg2"), _, _] =
  let    tup_el_1 = toErl "use \'pg\' instead"
  in let tup_el_2 = toErl "OTP 24"
  in ErlangTuple [ErlangAtom "deprecated", tup_el_1, tup_el_2]
