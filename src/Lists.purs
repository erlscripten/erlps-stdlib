...
erlps__map__2 [f_0, (ErlangEmptyList)] | isEFunA f_0 (toErl 1) =
  ErlangEmptyList
...
erlps__foldl__3 [f_0, accu_1, (ErlangEmptyList)]
  | isEFunA f_0 (toErl 2) =
  accu_1
erlps__foldl__3 [arg_2, arg_3, arg_4] = EXC.function_clause unit
...
erlps__foldr__3 [f_0, accu_1, (ErlangEmptyList)]
  | isEFunA f_0 (toErl 2) =
  accu_1
erlps__foldr__3 [arg_2, arg_3, arg_4] = EXC.function_clause unit
...
erlps__partition__4 args =
  EXC.badarity (ErlangFun 4 erlps__partition__4) args
  ...
  in
    case matchExpr_9 of
      (ErlangTuple [r_7, accu1_8]) ->
        let matchExpr_15 = erlps__mapfoldl__3 [f_0, accu1_8, tail_3]
        in
...
erlps__mapfoldr__3 [f_0, accu0_1, (ErlangCons hd_2 tail_3)] =
  let matchExpr_9 = erlps__mapfoldr__3 [f_0, accu0_1, tail_3]
  in
    case matchExpr_9 of
...
erlps__splitwith__3 args =
  EXC.badarity (ErlangFun 3 erlps__splitwith__3) args
