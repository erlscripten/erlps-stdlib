...
erlps__is_empty__1 [(ErlangCons l_0 r_1)] =
  ...
  in let rop_4 = (erlps__is_empty__1 [r_1])
  in (BIF.erlang__op_andalso [lop_2, rop_4])
...
erlps__length__1 [(ErlangBinary bin_c_0)]
  | (BIN.Ok cp1_3 bin_2) <-
      ((BIN.chop_int bin_c_0 8 1 BIN.Big BIN.Unsigned))
  , (ErlangInt size_4) <- ((BIN.size bin_2))
  , (BIN.Ok bin_6 bin_5) <- ((BIN.chop_bin bin_2 size_4 8))
  , (BIN.empty bin_5) =
  (erlps__length_b__3 [bin_6, cp1_3, (ErlangInt 0)])
erlps__length__1 [cd_0] =
  (erlps__length_1__2 [cd_0, (ErlangInt 0)])
...
erlps__to_graphemes__1 [cd0_0] =
  let case_1 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cd0_0])
  in
    case case_1 of
      (ErlangCons gc_3 cd_4) ->
        let head_6 = (erlps__to_graphemes__1 [cd_4])
        in (ErlangCons gc_3 head_6)
...
erlps__equal__2 [a_0, b_1]
  | (ErlangAtom "true") <-
      (let    lop_4 = (BIF.erlang__is_binary__1 [a_0])
       in let rop_6 = (BIF.erlang__is_binary__1 [b_1])
       in (BIF.erlang__op_andalso [lop_4, rop_6])) =
  ...
  in
    case case_2 of
      ErlangEmptyList | (ErlangAtom "true") <-
        ...
        (ErlangBinary (BIN.concat []))
      res_6 -> res_6
erlps__slice__3 [cd_0, _, (ErlangInt 0)] =
  let case_1 = (BIF.erlang__is_binary__1 [cd_0])
  in
    case case_1 of
      (ErlangAtom "true") -> (ErlangBinary (BIN.concat []))
      (ErlangAtom "false") -> ErlangEmptyList
      something_else -> (EXC.case_clause something_else)
erlps__slice__3 [arg_3, arg_4, arg_5] =
  (EXC.function_clause unit)
...
erlps__pad__2 [cd_0, length_1] =
  (erlps__pad__4 [cd_0, length_1, (ErlangAtom "trailing"), (ErlangInt 32)])
...
erlps__pad__3 [cd_0, length_1, dir_2] =
  (erlps__pad__4 [cd_0, length_1, dir_2, (ErlangInt 32)])
...
erlps__pad__4 [cd_0, length_1, (ErlangAtom "leading"), char_2]
  ...
  in let arg_6 = (BIF.erlang__max__2 [(ErlangInt 0), arg_8])
  in let tail_5 = (BIF.do_remote_fun_call "Lists" "erlps__duplicate__2" [arg_6, char_2])
  in (ErlangCons tail_5 (ErlangCons cd_0 ErlangEmptyList))
erlps__pad__4 [cd_0, length_1, (ErlangAtom "trailing"), char_2]
  | (isENum length_1) =
  let    len_4 = (BIF.erlang__length__1 [cd_0])
  in let arg_9 = (BIF.erlang__op_minus [length_1, len_4])
  in let arg_7 = (BIF.erlang__max__2 [(ErlangInt 0), arg_9])
  in let head_6 = (BIF.do_remote_fun_call "Lists" "erlps__duplicate__2" [arg_7, char_2])
  in (ErlangCons cd_0 head_6)
erlps__pad__4 [cd_0, length_1, (ErlangAtom "both"), char_2]
  | (isENum length_1) =
  let    len_4 = (BIF.erlang__length__1 [cd_0])
  in let arg_6 = (BIF.erlang__op_minus [length_1, len_4])
  in let size_9 = (BIF.erlang__max__2 [(ErlangInt 0), arg_6])
  in let
    arg_10 = (BIF.erlang__op_div_strict [size_9, (ErlangInt 2)])
  in let pre_14 = (BIF.do_remote_fun_call "Lists" "erlps__duplicate__2" [arg_10, char_2])
  in let
    case_15 = (BIF.erlang__op_rem_strict [size_9, (ErlangInt 2)])
  in let
    post_20 =
      case case_15 of
        (ErlangInt 1) -> (ErlangCons char_2 ErlangEmptyList)
        _ -> ErlangEmptyList
        something_else -> (EXC.case_clause something_else)
  in
    (ErlangCons pre_14 (ErlangCons cd_0 (ErlangCons pre_14 post_20)))
erlps__pad__4 [arg_27, arg_28, arg_29, arg_30] =
  (EXC.function_clause unit)
erlps__pad__4 args =
  (EXC.badarity (ErlangFun 4 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)
...
erlps__trim__1 [str_0] =
  let arg_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__whitespace__0" [])
...
erlps__trim__2 [str_0, dir_1] =
  let arg_4 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__whitespace__0" [])
...
erlps__trim__3 [str_0, (ErlangAtom "leading"),
  ...
  | ((isEList str_0) && (sep_1 < (ErlangInt 256))) =
...
erlps__trim__3 [str_0, (ErlangAtom "trailing"), seps0_1]
  ...
  in (erlps__trim_t__3 [str_0, (ErlangInt 0), seps_3])
erlps__trim__3 [str_0, (ErlangAtom "both"), sep_1] | (isEList sep_1) =
  let arg_2 = (erlps__trim__3 [str_0, (ErlangAtom "leading"), sep_1])
...
erlps__chomp__1 [str_0] =
  (erlps__trim__3
     [str_0, (ErlangAtom "trailing"),
      (ErlangCons
         (ErlangCons (ErlangInt 13)
            (ErlangCons (ErlangInt 10) ErlangEmptyList))
         (ErlangCons (ErlangInt 10) ErlangEmptyList))])
...
erlps__take__3 [str_0, sep_1, complement_2] =
  (erlps__take__4 [str_0, sep_1, complement_2, (ErlangAtom "leading")])
...
erlps__take__4 [str_0, sep0_1, (ErlangAtom "false"), (ErlangAtom "trailing")] =
  let sep_3 = (erlps__search_pattern__1 [sep0_1])
  in (erlps__take_t__3 [str_0, (ErlangInt 0), sep_3])
erlps__take__4 [str_0, sep0_1, (ErlangAtom "true"), (ErlangAtom "trailing")] =
  let sep_3 = (erlps__search_pattern__1 [sep0_1])
  in (erlps__take_tc__3 [str_0, (ErlangInt 0), sep_3])
...
erlps__uppercase__1 [orig_7@(ErlangBinary bin_c_0)]
  ...
  (EXC.tryOfCatch
     ...
     (\ of_11 ->
        case of_11 of
          list_13 -> (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_binary__1" [list_13])
...
erlps__titlecase__1 [cd_0] | (isEList cd_0) =
  let case_1 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__titlecase__1" [cd_0])
  in
    case case_1 of
      (ErlangCons gc_3 tail_4) ->
        (BIF.erlang__append__2 [gc_3, tail_4])
      empty_7 -> empty_7
erlps__titlecase__1 [cd_0]
  | (ErlangAtom "true") <- ((BIF.erlang__is_binary__1 [cd_0])) =
  let case_1 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__titlecase__1" [cd_0])
  in
    case case_1 of
      (ErlangCons cp_3 chars_4) | (isENum cp_3) ->
        (ErlangBinary
           (BIN.concat
              [(BIN.from_int cp_3 (ErlangInt 8) 1 BIN.Big),
                     ...
                     case lc_12 of
                       cp_11 ->
                         let
                           lc_ret_13 =
                             (ErlangBinary
                                (BIN.from_int cp_11 (ErlangInt 8) 1 BIN.Big))
...
erlps__casefold__1 [orig_7@(ErlangBinary bin_c_0)]
  ...
  , (BIN.empty bin_5) =
  (EXC.tryOfCatch
     (\ _ -> (erlps__casefold_bin__3 [cp1_3, rest_6, (ErlangAtom "false")]))
     (\ of_11 ->
        case of_11 of
          list_13 -> (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_binary__1" [list_13])
          something_else -> (EXC.try_clause something_else))
     ...
     (\ of_3 ->
        case of_3 of
          (ErlangTuple [head_5, tail_6]) ->
            ...
            in
              case case_7 of
                (ErlangAtom "true") -> (ErlangTuple [(ErlangAtom "error"), (ErlangAtom "no_integer")])
                (ErlangAtom "false") ->
                  let    list_12 = (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_list__1" [head_5])
     ...
     (\ of_3 ->
        case of_3 of
          (ErlangTuple [head_5, tail_6]) ->
            ...
            in
              case case_7 of
                (ErlangAtom "true") -> (ErlangTuple [(ErlangAtom "error"), (ErlangAtom "no_float")])
                (ErlangAtom "false") ->
                  let    list_12 = (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_list__1" [head_5])
...
erlps__to_number__5 [string_0, number_1, rest_2, list_3, _tail_4]
  | (ErlangAtom "true") <- ((BIF.erlang__is_binary__1 [string_0])) =
...
erlps__prefix__2 [str_0, prefix0_1] =
  let    case_2 = (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_list__1" [prefix0_1])
  in let
    result_7 =
      case case_2 of
  ...
  in
    case result_7 of
      ErlangEmptyList | (ErlangAtom "true") <-
                          ((BIF.erlang__is_binary__1 [str_0])) ->
        (ErlangBinary (BIN.concat []))
      res_10 -> res_10
...
erlps__split__2 [string_0, searchpattern_1] =
  (erlps__split__3 [string_0, searchpattern_1, (ErlangAtom "leading")])
  ...
  in
    case case_3 of
      ...
      (ErlangAtom "false") ->
        let   
          searchpatterncps_8 =
            (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_list__1" [searchpattern_1])
        in let
          case_9 =
            (erlps__split_1__6
               [string_0, searchpatterncps_8, (ErlangInt 0), where_2,
                ErlangEmptyList, ErlangEmptyList])
        in
          case case_9 of
            (ErlangTuple [_curr_16, ErlangEmptyList]) ->
              (ErlangCons string_0 ErlangEmptyList)
            (ErlangTuple [_curr_19, acc_20]) | (where_2 == (ErlangAtom "trailing")) ->
              acc_20
            (ErlangTuple [curr_21, acc_22]) | (where_2 == (ErlangAtom "all")) ->
              (BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [(ErlangCons curr_21 acc_22)])
...
erlps__replace__3 [string_0, searchpattern_1, replacement_2] =
  ...
  in (BIF.do_remote_fun_call "Lists" "erlps__join__2" [replacement_2, arg_4])
...
erlps__replace__4 [string_0, searchpattern_1, replacement_2,
  ...
  in (BIF.do_remote_fun_call "Lists" "erlps__join__2" [replacement_2, arg_5])
...
erlps__nth_lexeme__3 [str_0, (ErlangInt 1), ErlangEmptyList] =
  str_0
erlps__nth_lexeme__3 [str_0, n_1, seps0_2]
  | (((isEList seps0_2) && (isENum n_1)) &&
       (n_1 > (ErlangInt 0))) =
...
erlps__find__3 [string_0, (ErlangBinary bin_e_1), _]
  ...
  string_0
erlps__find__3 [string_0, searchpattern_1, (ErlangAtom "leading")] =
  let arg_3 = (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_list__1" [searchpattern_1])
...
erlps__length_1__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                    n_3]
  | (ErlangAtom "true") <-
      (let    lop_9 = (BIF.erlang__op_lesser [cp1_0, (ErlangInt 256)])
       in let rop_12 = (BIF.erlang__op_lesser [cp2_1, (ErlangInt 256)])
       in let lop_8 = (BIF.erlang__op_andalso [lop_9, rop_12])
       in let rop_15 = (BIF.erlang__op_exactNeq [cp1_0, (ErlangInt 13)])
       in (BIF.erlang__op_andalso [lop_8, rop_15])) =
  let arg_5 = (BIF.erlang__op_plus [n_3, (ErlangInt 1)])
  in (erlps__length_1__2 [cont_2, arg_5])
erlps__length_1__2 [str_0, n_1] =
  let case_2 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [str_0])
  in
    case case_2 of
      ErlangEmptyList -> n_1
      (ErlangCons _ rest_4) ->
        let arg_6 = (BIF.erlang__op_plus [n_1, (ErlangInt 1)])
...
erlps__length_b__3 [(ErlangBinary bin_c_0), cp1_7, n_8]
  ...
  , (BIN.empty bin_5)
  , (ErlangAtom "true") <-
      (let    lop_15 = (BIF.erlang__op_lesser [cp1_7, (ErlangInt 256)])
       in let rop_18 = (BIF.erlang__op_lesser [cp2_3, (ErlangInt 256)])
       in let lop_14 = (BIF.erlang__op_andalso [lop_15, rop_18])
       in let rop_21 = (BIF.erlang__op_exactNeq [cp1_7, (ErlangInt 13)])
       in (BIF.erlang__op_andalso [lop_14, rop_21])) =
  let arg_11 = (BIF.erlang__op_plus [n_8, (ErlangInt 1)])
  in (erlps__length_b__3 [rest_6, cp2_3, arg_11])
erlps__length_b__3 [bin0_0, cp1_1, n_2] =
  let
    match_expr_7 =
      (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [(ErlangCons cp1_1 bin0_0)])
  in
    case match_expr_7 of
      (ErlangCons _ bin1_6) ->
        let case_8 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [bin1_6])
        in
          case case_8 of
            ErlangEmptyList -> (BIF.erlang__op_plus [n_2, (ErlangInt 1)])
            (ErlangCons cp3_12 bin_13) ->
              let arg_16 = (BIF.erlang__op_plus [n_2, (ErlangInt 1)])
...
erlps__equal_1__2 [(ErlangCons a_0 ar_1), (ErlangCons b_2 br_3)]
  | ((isENum a_0) && (isENum b_2)) =
  let    lop_4 = (BIF.erlang__op_exactEq [a_0, b_2])
  in let rop_7 = (erlps__equal_1__2 [ar_1, br_3])
  in (BIF.erlang__op_andalso [lop_4, rop_7])
erlps__equal_1__2 [ErlangEmptyList, br_0] =
  (erlps__is_empty__1 [br_0])
erlps__equal_1__2 [a0_0, b0_1] =
  let    tup_el_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [a0_0])
  in let tup_el_5 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [b0_1])
...
erlps__equal_nocase__2 [a_0, a_1] | (a_1 == a_0) = (ErlangAtom "true")
erlps__equal_nocase__2 [a0_0, b0_1] =
  let    arg_4 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__casefold__1" [a0_0])
  in let tup_el_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [arg_4])
  in let arg_7 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__casefold__1" [b0_1])
  in let tup_el_6 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [arg_7])
  ...
  let   
    arg_5 =
      (BIF.erlang__apply__3
         [(ErlangAtom "unicode_util"), norm_2, (ErlangCons a0_0 ErlangEmptyList)])
  in let tup_el_4 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [arg_5])
  in let
    arg_12 =
      (BIF.erlang__apply__3
         [(ErlangAtom "unicode_util"), norm_2, (ErlangCons b0_1 ErlangEmptyList)])
  in let tup_el_11 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [arg_12])
...
erlps__equal_norm_nocase__3 [a0_0, b0_1, norm_2] =
  let   
    arg_6 =
      (BIF.erlang__apply__3
         [(ErlangAtom "unicode_util"), norm_2, (ErlangCons a0_0 ErlangEmptyList)])
  in let arg_5 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__casefold__1" [arg_6])
  in let tup_el_4 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [arg_5])
  in let
    arg_14 =
      (BIF.erlang__apply__3
         [(ErlangAtom "unicode_util"), norm_2, (ErlangCons b0_1 ErlangEmptyList)])
  in let arg_13 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__casefold__1" [arg_14])
  in let tup_el_12 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [arg_13])
...
erlps__reverse_1__2 [cd_0, acc_1] =
  let case_2 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cd_0])
  in
    case case_2 of
  ...
  in
    case match_expr_8 of
      (ErlangCons gc_6 bin1_7) ->
        let case_9 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [bin1_7])
        in
          case case_9 of
...
erlps__slice_l__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                   n_3]
  | (ErlangAtom "true") <-
      (let    lop_10 = (BIF.erlang__op_lesser [cp1_0, (ErlangInt 256)])
       in let rop_13 = (BIF.erlang__op_lesser [cp2_1, (ErlangInt 256)])
       in let lop_9 = (BIF.erlang__op_andalso [lop_10, rop_13])
       in let rop_16 = (BIF.erlang__op_exactNeq [cp1_0, (ErlangInt 13)])
       in let lop_8 = (BIF.erlang__op_andalso [lop_9, rop_16])
       in let rop_19 = (BIF.erlang__op_greater [n_3, (ErlangInt 0)])
       in (BIF.erlang__op_andalso [lop_8, rop_19])) =
  let arg_5 = (BIF.erlang__op_minus [n_3, (ErlangInt 1)])
  in (erlps__slice_l__2 [cont_2, arg_5])
erlps__slice_l__2 [cd_0, n_1] | (n_1 > (ErlangInt 0)) =
  let case_2 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cd_0])
  in
    case case_2 of
      (ErlangCons _ cont_4) ->
        let arg_6 = (BIF.erlang__op_minus [n_1, (ErlangInt 1)])
      ...
      (ErlangTuple [(ErlangAtom "error"), err_9]) ->
        ...
        in (BIF.erlang__error__1 [arg_10])
      something_else -> (EXC.case_clause something_else)
erlps__slice_l__2 [cont_0, (ErlangInt 0)] = cont_0
erlps__slice_l__2 [arg_1, arg_2] = (EXC.function_clause unit)
...
erlps__slice_lb__3 [(ErlangBinary bin_c_0), cp1_7, n_8]
  ...
  , (BIN.empty bin_5)
  , (ErlangAtom "true") <-
      (let    lop_16 = (BIF.erlang__op_lesser [cp1_7, (ErlangInt 256)])
       in let rop_19 = (BIF.erlang__op_lesser [cp2_3, (ErlangInt 256)])
       in let lop_15 = (BIF.erlang__op_andalso [lop_16, rop_19])
       in let rop_22 = (BIF.erlang__op_exactNeq [cp1_7, (ErlangInt 13)])
       in let lop_14 = (BIF.erlang__op_andalso [lop_15, rop_22])
       in let rop_25 = (BIF.erlang__op_greater [n_8, (ErlangInt 1)])
       in (BIF.erlang__op_andalso [lop_14, rop_25])) =
  let arg_11 = (BIF.erlang__op_minus [n_8, (ErlangInt 1)])
  in (erlps__slice_lb__3 [bin_6, cp2_3, arg_11])
erlps__slice_lb__3 [bin_0, cp1_1, n_2] =
  let
    match_expr_7 =
      (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [(ErlangCons cp1_1 bin_0)])
  in
    case match_expr_7 of
      (ErlangCons _ rest_6) ->
        case (ErlangAtom "true") of
          _ | (n_2 > (ErlangInt 1)) ->
            let case_8 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [rest_6])
            in
              case case_8 of
                (ErlangCons cp2_10 cont_11) ->
                  let arg_14 = (BIF.erlang__op_minus [n_2, (ErlangInt 1)])
...
erlps__slice_trail__2 [orig_0, n_1]
  | (ErlangAtom "true") <- ((BIF.erlang__is_binary__1 [orig_0])) =
  case orig_0 of
    (ErlangBinary bin_c_3) | (BIN.Ok cp1_6 bin_5) <-
                               ((BIN.chop_int bin_c_3 8 1 BIN.Big BIN.Unsigned))
    ...
    (ErlangBinary bin_c_25) | (BIN.Ok _ bin_27) <-
                                ((BIN.chop_int bin_c_25 8 1 BIN.Big
                                    BIN.Unsigned))
...
erlps__slice_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                      n_3]
  | (ErlangAtom "true") <-
      (let    lop_12 = (BIF.erlang__op_lesser [cp1_0, (ErlangInt 256)])
       in let rop_15 = (BIF.erlang__op_lesser [cp2_1, (ErlangInt 256)])
       in let lop_11 = (BIF.erlang__op_andalso [lop_12, rop_15])
       in let rop_18 = (BIF.erlang__op_exactNeq [cp1_0, (ErlangInt 13)])
       in let lop_10 = (BIF.erlang__op_andalso [lop_11, rop_18])
       in let rop_21 = (BIF.erlang__op_greater [n_3, (ErlangInt 0)])
       in (BIF.erlang__op_andalso [lop_10, rop_21])) =
  let    arg_7 = (BIF.erlang__op_minus [n_3, (ErlangInt 1)])
  in let head_5 = (erlps__slice_list__2 [cont_2, arg_7])
  in (ErlangCons cp1_0 head_5)
erlps__slice_list__2 [cd_0, n_1] | (n_1 > (ErlangInt 0)) =
  let case_2 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cd_0])
  in
    case case_2 of
      (ErlangCons gc_4 cont_5) ->
        let    arg_9 = (BIF.erlang__op_minus [n_1, (ErlangInt 1)])
        in let arg_7 = (erlps__slice_list__2 [cont_5, arg_9])
        in (BIF.erlang__append__2 [gc_4, arg_7])
      ErlangEmptyList -> ErlangEmptyList
      (ErlangTuple [(ErlangAtom "error"), err_12]) ->
        let arg_13 = (ErlangTuple [(ErlangAtom "badarg"), err_12])
        in (BIF.erlang__error__1 [arg_13])
      something_else -> (EXC.case_clause something_else)
erlps__slice_list__2 [_, (ErlangInt 0)] = ErlangEmptyList
erlps__slice_list__2 [arg_0, arg_1] = (EXC.function_clause unit)
...
erlps__slice_bin__3 [(ErlangBinary bin_c_0), cp1_7, n_8]
  ...
  , (ErlangAtom "true") <-
      (let    lop_16 = (BIF.erlang__op_lesser [cp1_7, (ErlangInt 256)])
       ...
       in let rop_22 = (BIF.erlang__op_exactNeq [cp1_7, (ErlangInt 13)])
       in let lop_14 = (BIF.erlang__op_andalso [lop_15, rop_22])
       in let rop_25 = (BIF.erlang__op_greater [n_8, (ErlangInt 0)])
       in (BIF.erlang__op_andalso [lop_14, rop_25])) =
  let arg_11 = (BIF.erlang__op_minus [n_8, (ErlangInt 1)])
  in (erlps__slice_bin__3 [bin_6, cp2_3, arg_11])
erlps__slice_bin__3 [cd_0, cp1_1, n_2] | (n_2 > (ErlangInt 0)) =
  let
    match_expr_7 =
      (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [(ErlangCons cp1_1 cd_0)])
  in
    case match_expr_7 of
      (ErlangCons _ bin_6) ->
        let case_8 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [bin_6])
        in
          case case_8 of
            (ErlangCons cp2_10 cont_11) ->
              let arg_14 = (BIF.erlang__op_minus [n_2, (ErlangInt 1)])
              in (erlps__slice_bin__3 [cont_11, cp2_10, arg_14])
            ErlangEmptyList -> (ErlangInt 0)
            (ErlangTuple [(ErlangAtom "error"), err_17]) ->
              let arg_18 = (ErlangTuple [(ErlangAtom "badarg"), err_17])
              in (BIF.erlang__error__1 [arg_18])
            something_else -> (EXC.case_clause something_else)
      _ -> (EXC.badmatch match_expr_7)
erlps__slice_bin__3 [cd_0, cp1_1, (ErlangInt 0)] =
  let    lop_2 = (BIF.erlang__byte_size__1 [cd_0])
  in let
    arg_5 =
      (ErlangBinary (BIN.from_int cp1_1 (ErlangInt 8) 1 BIN.Big))
  in let rop_4 = (BIF.erlang__byte_size__1 [arg_5])
  in (BIF.erlang__op_plus [lop_2, rop_4])
erlps__slice_bin__3 [arg_7, arg_8, arg_9] =
  (EXC.function_clause unit)
...
erlps__uppercase_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
  ...
  | (ErlangAtom "true") <-
      (let   
         lop_11 = (BIF.erlang__op_lesserEq [(ErlangInt 97), cp1_0])
       in let
         rop_14 = (BIF.erlang__op_lesserEq [cp1_0, (ErlangInt 122)])
       in let lop_10 = (BIF.erlang__op_andalso [lop_11, rop_14])
       in let rop_17 = (BIF.erlang__op_lesser [cp2_1, (ErlangInt 256)])
       in (BIF.erlang__op_andalso [lop_10, rop_17])) =
  let    tail_4 = (BIF.erlang__op_minus [cp1_0, (ErlangInt 32)])
  in let
    head_7 = (erlps__uppercase_list__2 [cont_2, (ErlangAtom "true")])
  in (ErlangCons tail_4 head_7)
erlps__uppercase_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                          changed_3]
  | ((cp1_0 < (ErlangInt 128)) && (cp2_1 < (ErlangInt 256))) =
  let head_5 = (erlps__uppercase_list__2 [cont_2, changed_3])
  in (ErlangCons cp1_0 head_5)
...
erlps__uppercase_list__2 [cps0_0, changed_1] =
  let case_2 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__uppercase__1" [cps0_0])
  in
    case case_2 of
      (ErlangCons char_4 cps_5) | (ErlangAtom "true") <-
                                    (let rop_7 = (BIF.erlang__hd__1 [cps0_0])
                                     in
                                       (BIF.erlang__op_exactEq
                                          [char_4, rop_7])) ->
        let head_10 = (erlps__uppercase_list__2 [cps_5, changed_1])
        in (ErlangCons char_4 head_10)
      (ErlangCons char_13 cps_14) ->
        let arg_16 = (erlps__uppercase_list__2 [cps_14, (ErlangAtom "true")])
        in (BIF.erlang__append__2 [char_13, arg_16])
      ErlangEmptyList ->
...
erlps__uppercase_bin__3 [cp1_0, (ErlangBinary bin_c_1),
                         _changed_8]
  | (BIN.Ok cp2_4 bin_3) <-
      ((BIN.chop_int bin_c_1 8 1 BIN.Big BIN.Unsigned))
  , (ErlangInt size_5) <- ((BIN.size bin_3))
  , (BIN.Ok bin_7 bin_6) <- ((BIN.chop_bin bin_3 size_5 8))
  , (BIN.empty bin_6)
  , (ErlangAtom "true") <-
      (let   
         lop_17 = (BIF.erlang__op_lesserEq [(ErlangInt 97), cp1_0])
       in let
         rop_20 = (BIF.erlang__op_lesserEq [cp1_0, (ErlangInt 122)])
       in let lop_16 = (BIF.erlang__op_andalso [lop_17, rop_20])
       in let rop_23 = (BIF.erlang__op_lesser [cp2_4, (ErlangInt 256)])
       in (BIF.erlang__op_andalso [lop_16, rop_23])) =
  let    tail_9 = (BIF.erlang__op_minus [cp1_0, (ErlangInt 32)])
  in let
    head_12 =
      (erlps__uppercase_bin__3 [cp2_4, bin_7, (ErlangAtom "true")])
  in (ErlangCons tail_9 head_12)
erlps__uppercase_bin__3 [cp1_0, (ErlangBinary bin_c_1),
                         changed_8]
  | (BIN.Ok cp2_4 bin_3) <-
      ((BIN.chop_int bin_c_1 8 1 BIN.Big BIN.Unsigned))
  ...
  , (BIN.Ok bin_7 bin_6) <- ((BIN.chop_bin bin_3 size_5 8))
  , (BIN.empty bin_6)
  , ((cp1_0 < (ErlangInt 128)) && (cp2_4 < (ErlangInt 256))) =
  let head_10 = (erlps__uppercase_bin__3 [cp2_4, bin_7, changed_8])
  in (ErlangCons cp1_0 head_10)
erlps__uppercase_bin__3 [cp1_0, bin_1, changed_2] =
  let
    case_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__uppercase__1" [(ErlangCons cp1_0 bin_1)])
  in
    case case_3 of
      (ErlangCons cp1_7 cps_8) | (cp1_7 == cp1_0) ->
        let case_9 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [cps_8])
        in
          case case_9 of
            (ErlangCons next_11 rest_12) ->
              ...
              in (ErlangCons cp1_0 head_14)
            ErlangEmptyList | (ErlangAtom "true") <- (changed_2) ->
              (ErlangCons cp1_0 ErlangEmptyList)
            ErlangEmptyList -> (BIF.erlang__throw__1 [(ErlangAtom "unchanged")])
      ...
      (ErlangCons char_25 cps_26) ->
        let case_27 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [cps_26])
        in
          case case_27 of
            (ErlangCons next_29 rest_30) ->
              let
                head_32 =
                  (erlps__uppercase_bin__3 [next_29, rest_30, (ErlangAtom "true")])
              in (ErlangCons char_25 head_32)
...
erlps__lowercase_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
  ...
  | (ErlangAtom "true") <-
      (let   
         lop_11 = (BIF.erlang__op_lesserEq [(ErlangInt 65), cp1_0])
       in let rop_14 = (BIF.erlang__op_lesserEq [cp1_0, (ErlangInt 90)])
       in let lop_10 = (BIF.erlang__op_andalso [lop_11, rop_14])
       in let rop_17 = (BIF.erlang__op_lesser [cp2_1, (ErlangInt 256)])
       in (BIF.erlang__op_andalso [lop_10, rop_17])) =
  let    tail_4 = (BIF.erlang__op_plus [cp1_0, (ErlangInt 32)])
  in let
    head_7 = (erlps__lowercase_list__2 [cont_2, (ErlangAtom "true")])
  in (ErlangCons tail_4 head_7)
erlps__lowercase_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                          changed_3]
  | ((cp1_0 < (ErlangInt 128)) && (cp2_1 < (ErlangInt 256))) =
  let head_5 = (erlps__lowercase_list__2 [cont_2, changed_3])
  in (ErlangCons cp1_0 head_5)
...
erlps__lowercase_list__2 [cps0_0, changed_1] =
  let case_2 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__lowercase__1" [cps0_0])
  in
    case case_2 of
      (ErlangCons char_4 cps_5) | (ErlangAtom "true") <-
                                    (let rop_7 = (BIF.erlang__hd__1 [cps0_0])
                                     in
                                       (BIF.erlang__op_exactEq
                                          [char_4, rop_7])) ->
        let head_10 = (erlps__lowercase_list__2 [cps_5, changed_1])
        in (ErlangCons char_4 head_10)
      (ErlangCons char_13 cps_14) ->
        let arg_16 = (erlps__lowercase_list__2 [cps_14, (ErlangAtom "true")])
        in (BIF.erlang__append__2 [char_13, arg_16])
      ErlangEmptyList ->
...
erlps__lowercase_bin__3 [cp1_0, (ErlangBinary bin_c_1),
  ...
  , (ErlangAtom "true") <-
      (let   
         lop_17 = (BIF.erlang__op_lesserEq [(ErlangInt 65), cp1_0])
       in let rop_20 = (BIF.erlang__op_lesserEq [cp1_0, (ErlangInt 90)])
       in let lop_16 = (BIF.erlang__op_andalso [lop_17, rop_20])
       in let rop_23 = (BIF.erlang__op_lesser [cp2_4, (ErlangInt 256)])
       in (BIF.erlang__op_andalso [lop_16, rop_23])) =
  let    tail_9 = (BIF.erlang__op_plus [cp1_0, (ErlangInt 32)])
  in let
    head_12 =
...
erlps__lowercase_bin__3 [cp1_0, (ErlangBinary bin_c_1),
  ...
  , (BIN.empty bin_6)
  , ((cp1_0 < (ErlangInt 128)) && (cp2_4 < (ErlangInt 256))) =
  let head_10 = (erlps__lowercase_bin__3 [cp2_4, bin_7, changed_8])
  in (ErlangCons cp1_0 head_10)
erlps__lowercase_bin__3 [cp1_0, bin_1, changed_2] =
  let
    case_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__lowercase__1" [(ErlangCons cp1_0 bin_1)])
  in
    case case_3 of
      (ErlangCons cp1_7 cps_8) | (cp1_7 == cp1_0) ->
        let case_9 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [cps_8])
        ...
        in
          case case_27 of
            (ErlangCons next_29 rest_30) ->
              let
                head_32 =
                  (erlps__lowercase_bin__3 [next_29, rest_30, (ErlangAtom "true")])
              in (ErlangCons char_25 head_32)
            ErlangEmptyList -> (ErlangCons char_25 ErlangEmptyList)
            (ErlangTuple [(ErlangAtom "error"), err_38]) ->
              let arg_39 = (ErlangTuple [(ErlangAtom "badarg"), err_38])
...
erlps__casefold_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
  ...
  let    tail_4 = (BIF.erlang__op_plus [cp1_0, (ErlangInt 32)])
  in let
    head_7 = (erlps__casefold_list__2 [cont_2, (ErlangAtom "true")])
  in (ErlangCons tail_4 head_7)
erlps__casefold_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                         changed_3]
  | ((cp1_0 < (ErlangInt 128)) && (cp2_1 < (ErlangInt 256))) =
  let head_5 = (erlps__casefold_list__2 [cont_2, changed_3])
  in (ErlangCons cp1_0 head_5)
...
erlps__casefold_list__2 [cps0_0, changed_1] =
  let case_2 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__casefold__1" [cps0_0])
  in
    case case_2 of
      (ErlangCons char_4 cps_5) | (ErlangAtom "true") <-
                                    (let rop_7 = (BIF.erlang__hd__1 [cps0_0])
                                     in
                                       (BIF.erlang__op_exactEq
                                          [char_4, rop_7])) ->
        let head_10 = (erlps__casefold_list__2 [cps_5, changed_1])
        in (ErlangCons char_4 head_10)
      (ErlangCons char_13 cps_14) ->
        let arg_16 = (erlps__casefold_list__2 [cps_14, (ErlangAtom "true")])
        in (BIF.erlang__append__2 [char_13, arg_16])
      ErlangEmptyList ->
...
erlps__casefold_bin__3 [cp1_0, (ErlangBinary bin_c_1),
  ...
  let    tail_9 = (BIF.erlang__op_plus [cp1_0, (ErlangInt 32)])
  in let
    head_12 = (erlps__casefold_bin__3 [cp2_4, bin_7, (ErlangAtom "true")])
  in (ErlangCons tail_9 head_12)
erlps__casefold_bin__3 [cp1_0, (ErlangBinary bin_c_1), changed_8]
  ...
  , (BIN.empty bin_6)
  , ((cp1_0 < (ErlangInt 128)) && (cp2_4 < (ErlangInt 256))) =
  let head_10 = (erlps__casefold_bin__3 [cp2_4, bin_7, changed_8])
  in (ErlangCons cp1_0 head_10)
erlps__casefold_bin__3 [cp1_0, bin_1, changed_2] =
  let
    case_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__casefold__1" [(ErlangCons cp1_0 bin_1)])
  in
    case case_3 of
      (ErlangCons cp1_7 cps_8) | (cp1_7 == cp1_0) ->
        let case_9 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [cps_8])
        in
          case case_9 of
            (ErlangCons next_11 rest_12) ->
              let
                head_14 = (erlps__casefold_bin__3 [next_11, rest_12, changed_2])
              in (ErlangCons cp1_0 head_14)
            ErlangEmptyList | (ErlangAtom "true") <- (changed_2) ->
              (ErlangCons cp1_0 ErlangEmptyList)
            ErlangEmptyList -> (BIF.erlang__throw__1 [(ErlangAtom "unchanged")])
        ...
        in
          case case_27 of
            (ErlangCons next_29 rest_30) ->
              let
                head_32 =
                  (erlps__casefold_bin__3 [next_29, rest_30, (ErlangAtom "true")])
              in (ErlangCons char_25 head_32)
            ErlangEmptyList -> (ErlangCons char_25 ErlangEmptyList)
            (ErlangTuple [(ErlangAtom "error"), err_38]) ->
              let arg_39 = (ErlangTuple [(ErlangAtom "badarg"), err_38])
...
erlps__trim_ls__2 [str_3@(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
  ...
  | (ErlangAtom "true") <-
      (let    lop_10 = (BIF.erlang__op_lesser [cp1_0, (ErlangInt 256)])
       ...
       in let lop_9 = (BIF.erlang__op_andalso [lop_10, rop_13])
       in let rop_16 = (BIF.erlang__op_exactNeq [cp1_0, (ErlangInt 13)])
       in (BIF.erlang__op_andalso [lop_9, rop_16])) =
  case sep_4 of
...
erlps__trim_l__2 [str_3@(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                  sep_4]
  | (ErlangAtom "true") <-
      (let    lop_11 = (BIF.erlang__op_lesser [cp1_0, (ErlangInt 256)])
       in let rop_14 = (BIF.erlang__op_lesser [cp2_1, (ErlangInt 256)])
       in let lop_10 = (BIF.erlang__op_andalso [lop_11, rop_14])
       in let rop_17 = (BIF.erlang__op_exactNeq [cp1_0, (ErlangInt 13)])
       in (BIF.erlang__op_andalso [lop_10, rop_17])) =
...
erlps__trim_ts__2 [(ErlangCons cp_0 cont_1), sep_2]
  | (isENum cp_0) =
  let head_4 = (erlps__trim_ts__2 [cont_1, sep_2])
  in (ErlangCons cp_0 head_4)
erlps__trim_ts__2 [str_0, sep_1] =
  let
    arg_4 =
      (erlps__search_pattern__1 [(ErlangCons sep_1 ErlangEmptyList)])
  in (erlps__trim_t__3 [str_0, (ErlangInt 0), arg_4])
...
erlps__trim_t__3 [cs0_2@(ErlangCons cp1_0 cont_1), _,
  ...
  in
    case case_6 of
      (ErlangAtom "true") ->
        let match_expr_12 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs0_2])
        in
              ...
              in
                case case_13 of
                  (ErlangAtom "true") ->
                    let   
                      tail_19 =
                        (erlps__trim_t__3 [cs1_11, (ErlangInt 0), seps_5])
                    in let case_20 = (erlps__is_empty__1 [tail_19])
                    in
                      case case_20 of
                        (ErlangAtom "true") -> ErlangEmptyList
                        (ErlangAtom "false") ->
                          (BIF.erlang__append__2 [gc_10, tail_19])
                        something_else -> (EXC.case_clause something_else)
                  (ErlangAtom "false") ->
                    let
                      arg_25 =
                        (erlps__trim_t__3 [cs1_11, (ErlangInt 0), seps_5])
                    in (BIF.erlang__append__2 [gc_10, arg_25])
                  something_else -> (EXC.case_clause something_else)
            _ -> (EXC.badmatch match_expr_12)
      (ErlangAtom "false") ->
        let head_30 = (erlps__trim_t__3 [cont_1, (ErlangInt 0), seps_5])
        in (ErlangCons cp1_0 head_30)
      something_else -> (EXC.case_clause something_else)
  ...
  case bin_0 of
    (ErlangBinary bin_c_5) | (ErlangInt size_6) <- (n_2)
      ...
      in
        case case_14 of
          (ErlangTuple [(ErlangAtom "nomatch"), _]) ->
            let arg_19 = (erlps__trim_t__3 [cont0_1, (ErlangInt 0), seps_13])
            ...
            in
              case case_25 of
                (ErlangTuple [(ErlangAtom "nomatch"), cont_29]) ->
                  let   
                    tail_33 =
                      (erlps__trim_t__3 [cont_29, (ErlangInt 0), seps_13])
          ...
          something_else -> (EXC.case_clause something_else)
    _ -> (EXC.badmatch bin_0)
erlps__trim_t__3 [str_0, (ErlangInt 0),
                  seps_2@(ErlangTuple [gcs_1, _, _])]
  | (isEList str_0) =
  let case_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [str_0])
  in
    case case_3 of
      (ErlangCons gc_5 cs1_6) ->
        let case_7 = (BIF.lists__member__2 [gc_5, gcs_1])
        in
          case case_7 of
            (ErlangAtom "true") ->
              let   
                tail_13 = (erlps__trim_t__3 [cs1_6, (ErlangInt 0), seps_2])
              in let case_14 = (erlps__is_empty__1 [tail_13])
              in
                case case_14 of
                  (ErlangAtom "true") -> ErlangEmptyList
                  (ErlangAtom "false") -> (BIF.erlang__append__2 [gc_5, tail_13])
                  something_else -> (EXC.case_clause something_else)
            (ErlangAtom "false") ->
              let arg_19 = (erlps__trim_t__3 [cs1_6, (ErlangInt 0), seps_2])
              in (BIF.erlang__append__2 [gc_5, arg_19])
            something_else -> (EXC.case_clause something_else)
      ErlangEmptyList -> ErlangEmptyList
      something_else -> (EXC.case_clause something_else)
...
erlps__take_l__3 [str_3@(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                  seps_4, acc_5]
  | (ErlangAtom "true") <-
      (let    lop_18 = (BIF.erlang__op_lesser [cp1_0, (ErlangInt 256)])
       in let rop_21 = (BIF.erlang__op_lesser [cp2_1, (ErlangInt 256)])
       in let lop_17 = (BIF.erlang__op_andalso [lop_18, rop_21])
       in let rop_24 = (BIF.erlang__op_exactNeq [cp1_0, (ErlangInt 13)])
       in (BIF.erlang__op_andalso [lop_17, rop_24])) =
  ...
  in
    case case_4 of
      (ErlangTuple [(ErlangAtom "nomatch"), cont_8]) ->
        ...
        in let
          tail_15 =
            (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_binary__1" [(ErlangCons bin_0 used_11)])
        in
          (erlps__take_l__3 [cont_8, seps_2, (ErlangCons tail_15 acc_3)])
        ...
        in
          case case_7 of
            (ErlangAtom "true") ->
              ...
              in let arg_12 = (BIF.erlang__append__2 [arg_13, acc_2])
...
erlps__take_lc__3 [str0_2@(ErlangCons cp1_0 cont_1),
  ...
  in
    case case_7 of
      (ErlangAtom "true") ->
        let match_expr_13 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [str0_2])
        in
              ...
              in
                case case_14 of
                  (ErlangAtom "false") ->
                    ...
                    in let arg_19 = (BIF.erlang__append__2 [arg_20, acc_6])
      ...
      (ErlangAtom "false") ->
        let arg_28 = (BIF.erlang__append__2 [cp1_0, acc_6])
  ...
  in
    case case_6 of
      (ErlangTuple [(ErlangAtom "nomatch"), cont_10]) ->
        ...
        in let
          tail_17 =
            (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_binary__1" [(ErlangCons bin_0 used_13)])
        in
          (erlps__take_lc__3 [cont_10, seps_5, (ErlangCons tail_17 acc_3)])
...
erlps__take_lc__3 [str_0, seps_2@(ErlangTuple [gcs_1, _, _]),
                   acc_3]
  | (isEList str_0) =
  let case_4 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [str_0])
  in
    case case_4 of
      (ErlangCons c_6 cs_7) ->
        ...
        in
          case case_8 of
            (ErlangAtom "false") ->
              ...
              in let arg_13 = (BIF.erlang__append__2 [arg_14, acc_3])
...
erlps__take_t__3 [str0_2@(ErlangCons cp1_0 cont_1), _,
  ...
  in
    case case_6 of
      (ErlangAtom "true") ->
        let match_expr_12 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [str0_2])
        in
          case match_expr_12 of
              ...
              in
                case case_13 of
                  (ErlangAtom "true") ->
                    let
                      match_expr_21 =
                        (erlps__take_t__3 [str_11, (ErlangInt 0), seps_5])
                    in
                          ...
                          in
                            case case_22 of
                              (ErlangAtom "true") ->
                                let
                                  tup_el_25 =
                                    (BIF.erlang__append__2 [gc_10, tail_20])
                                in (ErlangTuple [head_19, tup_el_25])
                              (ErlangAtom "false") ->
                                let
                                  tup_el_28 =
                                    (BIF.erlang__append__2 [gc_10, head_19])
                    ...
                    in
                      case match_expr_37 of
                        (ErlangTuple [head_35, tail_36]) ->
                          let
                            tup_el_38 = (BIF.erlang__append__2 [gc_10, head_35])
      ...
      (ErlangAtom "false") ->
        let
          match_expr_47 =
            (erlps__take_t__3 [cont_1, (ErlangInt 0), seps_5])
        in
      ...
      in
        case case_14 of
          (ErlangTuple [(ErlangAtom "nomatch"), cont_18]) ->
            ...
            in let
              match_expr_27 =
                (erlps__take_t__3 [cont_18, (ErlangInt 0), seps_13])
            in
              case match_expr_27 of
                (ErlangTuple [head_25, tail_26]) ->
                  let   
                    arg_29 =
                      (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_binary__1" [(ErlangCons bin_0 used_21)])
            ...
            in
              case case_37 of
                (ErlangTuple [(ErlangAtom "nomatch"), cont_41]) ->
                  let
                    match_expr_47 =
                      (erlps__take_t__3 [cont_41, (ErlangInt 0), seps_13])
                  in
                    case match_expr_47 of
                      (ErlangTuple [head_45, tail_46]) ->
                        let   
                        ...
                        in
                          case case_51 of
                            ...
                            (ErlangAtom "false") ->
                              let   
                                arg_73 =
                                  (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_binary__1"
          ...
          something_else -> (EXC.case_clause something_else)
    _ -> (EXC.badmatch bin_0)
erlps__take_t__3 [str_0, (ErlangInt 0),
                  seps_2@(ErlangTuple [gcs_1, _, _])]
  | (isEList str_0) =
  let case_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [str_0])
  in
        ...
        in
          case case_7 of
            (ErlangAtom "true") ->
              let
                match_expr_15 =
                  (erlps__take_t__3 [cs1_6, (ErlangInt 0), seps_2])
              in
                case match_expr_15 of
                  (ErlangTuple [head_13, tail_14]) ->
                    let case_16 = (erlps__is_empty__1 [head_13])
                    in
                      case case_16 of
                        (ErlangAtom "true") ->
                          let
                            tup_el_19 = (BIF.erlang__append__2 [gc_5, tail_14])
                          in (ErlangTuple [head_13, tup_el_19])
                        (ErlangAtom "false") ->
                          let
                            tup_el_22 = (BIF.erlang__append__2 [gc_5, head_13])
                          in (ErlangTuple [tup_el_22, tail_14])
                        something_else -> (EXC.case_clause something_else)
            ...
            (ErlangAtom "false") ->
              ...
              in
                case match_expr_31 of
                  (ErlangTuple [head_29, tail_30]) ->
                    let tup_el_32 = (BIF.erlang__append__2 [gc_5, head_29])
                    in (ErlangTuple [tup_el_32, tail_30])
...
erlps__take_tc__3 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
  ...
  | (ErlangAtom "true") <-
      (let    lop_35 = (BIF.erlang__op_lesser [cp1_0, (ErlangInt 256)])
       in let rop_38 = (BIF.erlang__op_lesser [cp2_1, (ErlangInt 256)])
       in let lop_34 = (BIF.erlang__op_andalso [lop_35, rop_38])
       in let rop_41 = (BIF.erlang__op_exactNeq [cp1_0, (ErlangInt 13)])
       in (BIF.erlang__op_andalso [lop_34, rop_41])) =
  ...
  in
    case case_5 of
      (ErlangAtom "false") ->
        let
          match_expr_13 =
            (erlps__take_tc__3 [cont_2, (ErlangInt 0), seps_4])
        in
          case match_expr_13 of
            (ErlangTuple [head_11, tail_12]) ->
              ...
              in
                case case_14 of
                  (ErlangAtom "true") ->
                    let tup_el_17 = (BIF.erlang__append__2 [cp1_0, tail_12])
                    in (ErlangTuple [head_11, tup_el_17])
                  (ErlangAtom "false") ->
                    let tup_el_20 = (BIF.erlang__append__2 [cp1_0, head_11])
        ...
        in
          case match_expr_29 of
            (ErlangTuple [head_27, tail_28]) ->
              let tup_el_30 = (BIF.erlang__append__2 [cp1_0, head_27])
      ...
      in
        case case_12 of
          (ErlangTuple [(ErlangAtom "nomatch"), cont_16]) ->
            ...
            in let
              match_expr_25 =
                (erlps__take_tc__3 [cont_16, (ErlangInt 0), seps0_4])
            in
              case match_expr_25 of
                (ErlangTuple [head_23, tail_24]) ->
                  let   
                    arg_27 =
                      (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_binary__1" [(ErlangCons bin_0 used_19)])
            ...
            in
              case case_37 of
                (ErlangTuple [(ErlangAtom "nomatch"), cont_41]) ->
                  let
                    match_expr_47 =
                      (erlps__take_tc__3 [cont_41, (ErlangInt 0), seps_36])
                  in
                    case match_expr_47 of
                      (ErlangTuple [head_45, tail_46]) ->
                        let   
          ...
          something_else -> (EXC.case_clause something_else)
    _ -> (EXC.badmatch bin_0)
erlps__take_tc__3 [str_0, (ErlangInt 0),
                   seps_2@(ErlangTuple [gcs_1, _, _])]
  | (isEList str_0) =
  let case_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [str_0])
  in
        ...
        in
          case case_7 of
            (ErlangAtom "false") ->
              let
                match_expr_15 =
                  (erlps__take_tc__3 [cs1_6, (ErlangInt 0), seps_2])
              in
                case match_expr_15 of
                  (ErlangTuple [head_13, tail_14]) ->
                    let case_16 = (erlps__is_empty__1 [head_13])
...
erlps__prefix_1__2 [cs0_0, (ErlangCons gc_1 ErlangEmptyList)] =
  let case_2 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs0_0])
  in
    case case_2 of
...
erlps__prefix_1__2 [cs0_0, (ErlangCons pre_1 prer_2)] =
  let case_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [cs0_0])
  in
    case case_3 of
    ...
    case case_8 of
      (ErlangAtom "true") ->
        ...
        in
          case case_11 of
            (ErlangAtom "nomatch") ->
              let arg_18 = (BIF.erlang__append__2 [c_3, curr_6])
              in
                (erlps__split_1__6
                   [cs_1, needle_4, (ErlangInt 0), where_5, arg_18, acc_7])
            rest_22 | (where_5 == (ErlangAtom "leading")) ->
              let tail_23 = (erlps__rev__1 [curr_6])
              in (ErlangCons tail_23 (ErlangCons rest_22 ErlangEmptyList))
            rest_28 | (where_5 == (ErlangAtom "trailing")) ->
              let tail_37 = (erlps__rev__1 [curr_6])
              in
                (erlps__split_1__6
                   [cs_1, needle_4, (ErlangInt 0), where_5,
                    (ErlangCons c_3 curr_6),
                    (ErlangCons tail_37 (ErlangCons rest_28 ErlangEmptyList))])
            rest_42 | (where_5 == (ErlangAtom "all")) ->
              let tail_49 = (erlps__rev__1 [curr_6])
              in
                (erlps__split_1__6
                   [rest_42, needle_4, (ErlangInt 0), where_5, ErlangEmptyList,
                    (ErlangCons tail_49 acc_7)])
            something_else -> (EXC.case_clause something_else)
      (ErlangAtom "false") ->
        let arg_56 = (BIF.erlang__append__2 [cp1_0, curr_6])
        in
          (erlps__split_1__6
             [cs_1, needle_4, (ErlangInt 0), where_5, arg_56, acc_7])
      something_else -> (EXC.case_clause something_else)
    ...
    case case_7 of
      (ErlangTuple [(ErlangAtom "nomatch"), sz_12, cont_13]) ->
        case bin_0 of
          (ErlangBinary bin_c_14) | (ErlangInt size_15) <- (sz_12)
                                  ...
                                  , (BIN.empty bin_19) ->
            (erlps__split_1__6
               [cont_13, needle_2, (ErlangInt 0), where_4,
      ...
      (ErlangTuple [before_29, (ErlangCons cs0_30 cont_31),
        ...
        in
          case where_4 of
            (ErlangAtom "leading") ->
              let tail_37 = (erlps__rev__1 [curr_35])
              in (ErlangCons tail_37 (ErlangCons after_32 ErlangEmptyList))
            (ErlangAtom "trailing") ->
              case cs0_30 of
                (ErlangBinary bin_c_42) | (BIN.Ok _ bin_44) <-
                                            ((BIN.chop_int bin_c_42 8 1 BIN.Big
                                                BIN.Unsigned))
                                        , (ErlangInt size_45) <-
                                            ((BIN.size bin_44))
                                        , (BIN.Ok cs_47 bin_46) <-
                  ...
                  in let tail_62 = (erlps__rev__1 [curr_35])
                  in
                    (erlps__split_1__6
            ...
            (ErlangAtom "all") ->
              let tail_73 = (erlps__rev__1 [curr_35])
              in
                (erlps__split_1__6
                   [after_32, needle_2, (ErlangInt 0), where_4, ErlangEmptyList,
                    (ErlangCons tail_73 acc_6)])
            something_else -> (EXC.case_clause something_else)
      something_else -> (EXC.case_clause something_else)
erlps__split_1__6 [cs0_0, needle_2@(ErlangCons c_1 _), _,
                   where_3, curr_4, acc_5]
  | (isEList cs0_0) =
  let case_6 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [cs0_0])
  in
    case case_6 of
      (ErlangCons c_8 cs_9) | (c_8 == c_1) ->
        ...
        in
          case case_10 of
            (ErlangAtom "nomatch") ->
              let arg_17 = (BIF.erlang__append__2 [c_1, curr_4])
              in
                (erlps__split_1__6
                   [cs_9, needle_2, (ErlangInt 0), where_3, arg_17, acc_5])
            rest_21 | (where_3 == (ErlangAtom "leading")) ->
              let tail_22 = (erlps__rev__1 [curr_4])
              in (ErlangCons tail_22 (ErlangCons rest_21 ErlangEmptyList))
            rest_27 | (where_3 == (ErlangAtom "trailing")) ->
              let tail_36 = (erlps__rev__1 [curr_4])
              in
                (erlps__split_1__6
                   [cs_9, needle_2, (ErlangInt 0), where_3,
                    (ErlangCons c_1 curr_4),
                    (ErlangCons tail_36 (ErlangCons rest_27 ErlangEmptyList))])
            rest_41 | (where_3 == (ErlangAtom "all")) ->
              let tail_48 = (erlps__rev__1 [curr_4])
              in
                (erlps__split_1__6
                   [rest_41, needle_2, (ErlangInt 0), where_3, ErlangEmptyList,
                    (ErlangCons tail_48 acc_5)])
            something_else -> (EXC.case_clause something_else)
      (ErlangCons other_51 cs_52) ->
        let arg_57 = (BIF.erlang__append__2 [other_51, curr_4])
        in
          (erlps__split_1__6
             [cs_52, needle_2, (ErlangInt 0), where_3, arg_57, acc_5])
      ErlangEmptyList ->
  ...
  in
    case case_7 of
      ...
      (ErlangTuple [before_24, (ErlangCons cs0_25 ErlangEmptyList),
        ...
        case where_4 of
          (ErlangAtom "leading") ->
            let tail_28 = (erlps__rev__1 [(ErlangCons before_24 curr0_5)])
            in (ErlangCons tail_28 (ErlangCons after_26 ErlangEmptyList))
          (ErlangAtom "trailing") ->
            case cs0_25 of
              (ErlangBinary bin_c_35) | (BIN.Ok _ bin_37) <-
                                          ((BIN.chop_int bin_c_35 8 1 BIN.Big
                                              BIN.Unsigned))
                                      , (ErlangInt size_38) <-
                                          ((BIN.size bin_37))
                                      , (BIN.Ok cs_40 bin_39) <-
                ...
                in let tail_53 = (erlps__btoken__2 [before_24, curr0_5])
                in
                  (erlps__split_1__6
            ...
            in
              case before_24 of
                (ErlangBinary bin_c_64) | (ErlangInt size_65) <- (start_3)
                                        ...
                                        , (BIN.empty bin_68) ->
                  let tail_80 = (erlps__rev__1 [(ErlangCons keep_69 curr0_5)])
                  in
                    (erlps__split_1__6
                       [bin_0, needle_2, next_63, where_4, ErlangEmptyList,
                        (ErlangCons tail_80 acc_6)])
...
erlps__lexemes_m__3 [cs0_1@(ErlangCons cp_0 _),
  ...
  in
    case case_6 of
      (ErlangAtom "true") ->
        let match_expr_12 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs0_1])
        in
          case match_expr_12 of
...
erlps__lexemes_m__3 [cs0_0, seps0_2@(ErlangTuple [gcs_1, _, _]),
                     ts_3]
  | (isEList cs0_0) =
  let case_4 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs0_0])
  in
    case case_4 of
      (ErlangCons c_6 cs_7) ->
        let case_8 = (BIF.lists__member__2 [c_6, gcs_1])
            ...
            (ErlangAtom "false") ->
              ...
              in
                case match_expr_21 of
                  ...
                  _ -> (EXC.badmatch match_expr_21)
            something_else -> (EXC.case_clause something_else)
      ErlangEmptyList -> (BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [ts_3])
      something_else -> (EXC.case_clause something_else)
...
erlps__lexeme_pick__3 [cs0_2@(ErlangCons cp_0 cs1_1),
  ...
  in
    case case_7 of
      (ErlangAtom "true") ->
        let match_expr_13 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs0_2])
        in
          case match_expr_13 of
              ...
              in
                case case_14 of
                  ...
                  (ErlangAtom "false") ->
                    ...
                    in let arg_22 = (BIF.erlang__append__2 [arg_23, tkn_6])
...
erlps__lexeme_pick__3 [cs0_0,
  ...
  | (isEList cs0_0) =
  let case_5 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [cs0_0])
  in
    case case_5 of
      (ErlangCons cp_7 cs_8) ->
        ...
        in
          case case_9 of
            (ErlangAtom "true") ->
              let match_expr_15 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs0_0])
              in
                case match_expr_15 of
                    ...
                    in
                      case case_16 of
                        ...
                        (ErlangAtom "false") ->
                          ...
                          in let
                            arg_24 = (BIF.erlang__append__2 [arg_25, tkn_4])
                          in (erlps__lexeme_pick__3 [cs2_14, seps_3, arg_24])
                        something_else -> (EXC.case_clause something_else)
                  _ -> (EXC.badmatch match_expr_15)
            (ErlangAtom "false") ->
              let arg_30 = (BIF.erlang__append__2 [cp_7, tkn_4])
...
erlps__nth_lexeme_m__3 [(ErlangCons bin_0 cont0_1),
  ...
  in
    case case_5 of
      ...
      cs_13 | (n_4 > (ErlangInt 1)) ->
        let    rest_16 = (erlps__lexeme_skip__2 [cs_13, seps0_3])
        in let arg_19 = (BIF.erlang__op_minus [n_4, (ErlangInt 1)])
      ...
      (ErlangCons c_6 cs_7) ->
        ...
        in
          case case_8 of
            ...
            (ErlangAtom "false") | (n_3 > (ErlangInt 1)) ->
              let    cs1_16 = (erlps__lexeme_skip__2 [cs_7, seps0_2])
              in let arg_19 = (BIF.erlang__op_minus [n_3, (ErlangInt 1)])
...
erlps__nth_lexeme_m__3 [bin_0,
  ...
  in
    case case_6 of
      (ErlangCons cs_10 ErlangEmptyList) | (n_3 > (ErlangInt 1)) ->
        let    cs1_13 = (erlps__lexeme_skip__2 [cs_10, seps_5])
        in let arg_16 = (BIF.erlang__op_minus [n_3, (ErlangInt 1)])
...
erlps__lexeme_skip__2 [(ErlangCons bin_0 cont0_1), seps0_2]
  ...
  in
    case case_5 of
      ...
      cs_11 ->
        let arg_12 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs_11])
        in (BIF.erlang__tl__1 [arg_12])
erlps__lexeme_skip__2 [cs0_0,
                       seps_3@(ErlangTuple [gcs_1, cps_2, _])]
  | (isEList cs0_0) =
  let case_4 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [cs0_0])
  in
    case case_4 of
      (ErlangCons cp_6 cs_7) ->
        ...
        in
          case case_8 of
            (ErlangAtom "true") ->
              let match_expr_14 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs0_0])
              in
  ...
  in
    case case_4 of
      ...
      (ErlangCons left_8 ErlangEmptyList) ->
        let arg_9 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [left_8])
...
erlps__find_l__2 [(ErlangCons bin_0 cont0_1), needle_2]
  ...
  let
    case_3 =
      (erlps__bin_search_str__4
         [bin_0, (ErlangInt 0), cont0_1, needle_2])
  in
    case case_3 of
...
erlps__find_l__2 [bin_0, needle_1] =
  let
    case_2 =
      (erlps__bin_search_str__4
         [bin_0, (ErlangInt 0), ErlangEmptyList, needle_1])
  in
    case case_2 of
  ...
  in
    case case_4 of
      ...
      (ErlangTuple [_, cs0_13, _]) ->
        let match_expr_16 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs0_13])
        in
  ...
  in
    case case_3 of
      ...
      (ErlangTuple [_before_8, (ErlangCons cs0_9 ErlangEmptyList),
                    _after_10]) ->
        case cs0_9 of
          (ErlangBinary bin_c_11) | (BIN.Ok _ bin_13) <-
                                      ((BIN.chop_int bin_c_11 8 1 BIN.Big
                                          BIN.Unsigned))
...
erlps__btoken__2 [binpart_0, (ErlangCons c_1 ErlangEmptyList)]
  ...
  (ErlangBinary
     (BIN.concat
        [(BIN.from_int c_1 (ErlangInt 8) 1 BIN.Big),
...
erlps__btoken__2 [binpart_0, cs_1] =
  let tail_2 = (BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [cs_1])
  in (ErlangCons tail_2 (ErlangCons binpart_0 ErlangEmptyList))
...
erlps__append__2 [char_0, bin_1]
  | (ErlangAtom "true") <- ((BIF.erlang__is_binary__1 [bin_1])) =
  (ErlangCons char_0 (ErlangCons bin_1 ErlangEmptyList))
erlps__append__2 [char_0, str_1] | (isENum char_0) =
...
erlps__cp_prefix__2 [orig_0, cont_1] =
  let case_2 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [cont_1])
  in
    case case_2 of
...
erlps__cp_prefix_1__3 [orig_0, until_1, cont_2] =
  let case_3 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [orig_0])
  in
    case case_3 of
      (ErlangCons until_5 rest_6) | (until_5 == until_1) ->
        ...
        in
          case case_7 of
            (ErlangAtom "true") -> ErlangEmptyList
            (ErlangAtom "false") ->
              let head_11 = (erlps__cp_prefix_1__3 [rest_6, until_1, cont_2])
              in (ErlangCons until_1 head_11)
            something_else -> (EXC.case_clause something_else)
      (ErlangCons cp_15 rest_16) ->
        let head_18 = (erlps__cp_prefix_1__3 [rest_16, until_1, cont_2])
        in (ErlangCons cp_15 head_18)
      something_else -> (EXC.case_clause something_else)
...
erlps__bin_search__3 [bin_0, cont_1,
  ...
  (erlps__bin_search_loop__5
     [bin_0, (ErlangInt 0), bp_3, cont_1, seps_2])
...
erlps__search_compile__1 [(ErlangTuple [sep_0, cps_1,
  ...
  in let tup_el_4 = (BIF.do_remote_fun_call "Binary" "erlps__compile_pattern__1" [arg_5])
...
erlps__search_cp__1 [(ErlangCons cp_0 seps_1)] | (isENum cp_0) =
  let head_3 = (erlps__search_cp__1 [seps_1])
  in (ErlangCons cp_0 head_3)
erlps__search_cp__1 [(ErlangCons pattern_0 seps_1)] =
  let match_expr_4 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [pattern_0])
  in
    case match_expr_4 of
      (ErlangCons cp_3 _) ->
        let head_6 = (erlps__search_cp__1 [seps_1])
        in (ErlangCons cp_3 head_6)
...
erlps__bin_pattern__1 [(ErlangCons cp_0 seps_1)] =
  let   
    tail_2 =
      (ErlangBinary (BIN.from_int cp_0 (ErlangInt 8) 1 BIN.Big))
  in let head_4 = (erlps__bin_pattern__1 [seps_1])
  in (ErlangCons tail_2 head_4)
...
erlps__bin_search_loop__5 [bin0_0, start_1, _, cont_2, _seps_3]
  | (ErlangAtom "true") <-
      (let    lop_7 = (BIF.erlang__byte_size__1 [bin0_0])
       ...
       in let rop_10 = (BIF.erlang__op_lesser [start_1, (ErlangInt 0)])
       in (BIF.erlang__op_orelse [lop_6, rop_10])) =
  ...
  case bin0_0 of
    (ErlangBinary bin_c_5) | (ErlangInt size_6) <- (start_1)
                           ...
                           , (BIN.Ok bin_10 bin_9) <-
                               ((BIN.chop_bin bin_7 size_8 8))
                           , (BIN.empty bin_9) ->
      let case_12 = (BIF.do_remote_fun_call "Binary" "erlps__match__2" [bin_10, binseps_2])
      in
        case case_12 of
          (ErlangAtom "nomatch") -> (ErlangTuple [(ErlangAtom "nomatch"), cont_3])
          (ErlangTuple [where_17, _cl_18]) | (cont_3 == ErlangEmptyList) ->
            case bin_10 of
              (ErlangBinary bin_c_19) | (ErlangInt size_20) <- (where_17)
                                      ...
                                      , (BIN.empty bin_23) ->
                let match_expr_29 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cont1_24])
                in
                  case match_expr_29 of
                      ...
                      in
                        case case_30 of
                          (ErlangAtom "false") | (cont2_28 == ErlangEmptyList) ->
                            (ErlangTuple [(ErlangAtom "nomatch"), ErlangEmptyList])
                          (ErlangAtom "false") ->
          ...
          (ErlangTuple [where_47, _cl_48]) ->
            case bin_10 of
              (ErlangBinary bin_c_49) | (ErlangInt size_50) <- (where_47)
                ...
                let
                  match_expr_62 =
                    (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [(ErlangCons cont0_54 cont_3)])
                in
...
erlps__bin_search_inv_1__3 [bin0_7@(ErlangBinary bin_c_0),
  ...
  , (BIN.empty bin_5) =
  case binrest_6 of
    (ErlangBinary bin_c_11) | (BIN.Ok cp2_14 bin_13) <-
                                ((BIN.chop_int bin_c_11 8 1 BIN.Big
                                    BIN.Unsigned))
                            ...
                            , (ErlangAtom "true") <-
                                (let   
                                 ...
                                 in let
                                   rop_21 =
                                     (BIF.erlang__op_lesser
                                        [cp2_14, (ErlangInt 256)])
                                 in let
                                   lop_17 =
                                     (BIF.erlang__op_andalso [lop_18, rop_21])
                                 in let
                                   rop_24 =
                                     (BIF.erlang__op_exactNeq
                                        [cp1_3, (ErlangInt 13)])
                                 in
                                   (BIF.erlang__op_andalso [lop_17, rop_24])) ->
      case cp1_3 of
        sep_28 | (sep_28 == sep_9) ->
    ...
    _ | (cont_8 == ErlangEmptyList) ->
      let case_34 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [bin0_7])
      in
        case case_34 of
          (ErlangCons sep_36 bin_37) | (sep_36 == sep_9) ->
            (erlps__bin_search_inv_1__3 [bin_37, cont_8, sep_9])
          _ -> (ErlangCons bin0_7 cont_8)
          something_else -> (EXC.case_clause something_else)
    _ ->
      let
        case_43 =
          (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [(ErlangCons bin0_7 cont_8)])
      in
        case case_43 of
          (ErlangCons sep_47 (ErlangCons bin_48 cont_49)) | (sep_47 ==
                                                               sep_9)
                                                          , (cont_49 == cont_8)
                                                          , (ErlangAtom "true") <-
                                                              ((BIF.erlang__is_binary__1
                                                                  [bin_48])) ->
            (erlps__bin_search_inv_1__3 [bin_48, cont_8, sep_9])
          (ErlangCons sep_54 cs_55) | (sep_54 == sep_9) ->
            (ErlangTuple [(ErlangAtom "nomatch"), cs_55])
          _ -> (ErlangCons bin0_7 cont_8)
          something_else -> (EXC.case_clause something_else)
    something_else -> (EXC.case_clause something_else)
    ...
    (ErlangBinary bin_c_11) | (BIN.Ok cp2_14 bin_13) <-
                            ...
                            , (ErlangAtom "true") <-
                                (let   
                                 ...
                                 in
                                   (BIF.erlang__op_andalso [lop_17, rop_24])) ->
      let case_27 = (BIF.lists__member__2 [cp1_3, seps_9])
      in
        case case_27 of
          (ErlangAtom "true") ->
          ...
          something_else -> (EXC.case_clause something_else)
    _ | (cont_8 == ErlangEmptyList) ->
      let match_expr_38 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [bin0_7])
      in
        case match_expr_38 of
          (ErlangCons gc_36 bin_37) ->
            let case_39 = (BIF.lists__member__2 [gc_36, seps_9])
            in
              case case_39 of
                (ErlangAtom "true") ->
                  (erlps__bin_search_inv_n__3 [bin_37, cont_8, seps_9])
                (ErlangAtom "false") -> (ErlangCons bin0_7 cont_8)
                something_else -> (EXC.case_clause something_else)
    ...
    _ ->
      ...
      in
        case match_expr_52 of
          (ErlangCons gc_50 cs0_51) ->
            let case_53 = (BIF.lists__member__2 [gc_50, seps_9])
            in
              case case_53 of
                (ErlangAtom "false") -> (ErlangCons bin0_7 cont_8)
                (ErlangAtom "true") ->
                  case cs0_51 of
                    (ErlangCons bin_59 cont_60) | (cont_60 == cont_8)
                                                , (ErlangAtom "true") <-
                                                    ((BIF.erlang__is_binary__1
                                                        [bin_59])) ->
                      (erlps__bin_search_inv_n__3 [bin_59, cont_8, seps_9])
                    _ -> (ErlangTuple [(ErlangAtom "nomatch"), cs0_51])
                    something_else -> (EXC.case_clause something_else)
                something_else -> (EXC.case_clause something_else)
...
erlps__bin_search_str__4 [bin0_0, start_1, ErlangEmptyList,
                          searchcps_2]
  =
  let    arg_3 = (BIF.do_remote_fun_call "Erlang.Unicode" "erlps__characters_to_binary__1" [searchcps_2])
  in let compiled_5 = (BIF.do_remote_fun_call "Binary" "erlps__compile_pattern__1" [arg_3])
  in
...
erlps__bin_search_str__4 [bin0_0, start_1, cont_2,
  ...
  let   
    arg_5 =
      (ErlangBinary (BIN.from_int cp_3 (ErlangInt 8) 1 BIN.Big))
  in let first_7 = (BIF.do_remote_fun_call "Binary" "erlps__compile_pattern__1" [arg_5])
  in
  ...
  case bin0_0 of
    (ErlangBinary bin_c_4) | (ErlangInt size_5) <- (start_1)
                           ...
                           , (BIN.Ok bin_9 bin_8) <-
                               ((BIN.chop_bin bin_6 size_7 8))
                           , (BIN.empty bin_8) ->
      let case_11 = (BIF.do_remote_fun_call "Binary" "erlps__match__2" [bin_9, first_2])
      in
        case case_11 of
          (ErlangAtom "nomatch") ->
            let tup_el_15 = (BIF.erlang__byte_size__1 [bin0_0])
            in (ErlangTuple [(ErlangAtom "nomatch"), tup_el_15, ErlangEmptyList])
                ...
                (ErlangBinary bin_c_22) | (ErlangInt size_23) <- (where_21)
                  ...
                  in
                    case case_30 of
                      (ErlangAtom "nomatch") ->
                        case cs0_28 of
                          (ErlangBinary bin_c_33) | (BIN.Ok _ bin_35) <-
                                                      ((BIN.chop_int bin_c_33 8
                                                          1 BIN.Big
                                                          BIN.Unsigned))
                                                  , (ErlangInt size_36) <-
                                                      ((BIN.size bin_35))
  ...
  case bin0_0 of
    (ErlangBinary bin_c_5) | (ErlangInt size_6) <- (start_1)
                           ...
                           , (BIN.Ok bin_10 bin_9) <-
                               ((BIN.chop_bin bin_7 size_8 8))
                           , (BIN.empty bin_9) ->
      let case_12 = (BIF.do_remote_fun_call "Binary" "erlps__match__2" [bin_10, first_3])
      in
        case case_12 of
          (ErlangAtom "nomatch") ->
            ...
            in
              case bin0_0 of
                (ErlangBinary bin_c_23) | (ErlangInt size_24) <- (where_22)
                                        ...
                                        , (BIN.empty bin_28) ->
                  let match_expr_34 = (BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cs0_29])
                  in
...
erlps__chr__2 [s_0, c_1] | (isENum c_1) =
  (erlps__chr__3 [s_0, c_1, (ErlangInt 1)])
...
erlps__chr__3 [(ErlangCons _ cs_0), c_1, i_2] =
  let arg_5 = (BIF.erlang__op_plus [i_2, (ErlangInt 1)])
  in (erlps__chr__3 [cs_0, c_1, arg_5])
erlps__chr__3 [ErlangEmptyList, _c_0, _i_1] = (ErlangInt 0)
erlps__chr__3 [arg_2, arg_3, arg_4] = (EXC.function_clause unit)
erlps__chr__3 args =
  (EXC.badarity (ErlangFun 3 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)

erlps__rchr__2 :: ErlangFun
erlps__rchr__2 [s_0, c_1] | (isENum c_1) =
  (erlps__rchr__4 [s_0, c_1, (ErlangInt 1), (ErlangInt 0)])
...
erlps__rchr__4 [(ErlangCons c_0 cs_1), c_2, i_3, _l_4]
  | (c_2 == c_0) =
  let arg_7 = (BIF.erlang__op_plus [i_3, (ErlangInt 1)])
  in (erlps__rchr__4 [cs_1, c_0, arg_7, i_3])
erlps__rchr__4 [(ErlangCons _ cs_0), c_1, i_2, l_3] =
  let arg_6 = (BIF.erlang__op_plus [i_2, (ErlangInt 1)])
...
erlps__str__2 [s_0, sub_1] | (isEList sub_1) =
  (erlps__str__3 [s_0, sub_1, (ErlangInt 1)])
...
erlps__rstr__2 [s_0, sub_1] | (isEList sub_1) =
  (erlps__rstr__4 [s_0, sub_1, (ErlangInt 1), (ErlangInt 0)])
...
erlps__rstr__4 [(ErlangCons c_0 s_1), (ErlangCons c_2 sub_3),
  ...
  in
    case case_6 of
      (ErlangAtom "true") ->
        let arg_13 = (BIF.erlang__op_plus [i_4, (ErlangInt 1)])
        in (erlps__rstr__4 [s_1, (ErlangCons c_0 sub_3), arg_13, i_4])
      (ErlangAtom "false") ->
        let arg_21 = (BIF.erlang__op_plus [i_4, (ErlangInt 1)])
...
erlps__span__2 [s_0, cs_1] | (isEList cs_1) =
  (erlps__span__3 [s_0, cs_1, (ErlangInt 0)])
...
erlps__span__3 [(ErlangCons c_0 s_1), cs_2, i_3] =
  ...
  in
    case case_4 of
      (ErlangAtom "true") ->
        let arg_9 = (BIF.erlang__op_plus [i_3, (ErlangInt 1)])
...
erlps__cspan__2 [s_0, cs_1] | (isEList cs_1) =
  (erlps__cspan__3 [s_0, cs_1, (ErlangInt 0)])
...
erlps__substr__2 [string_0, (ErlangInt 1)] | (isEList string_0) =
  string_0
erlps__substr__2 [string_0, s_1]
  | ((isENum s_1) && (s_1 > (ErlangInt 1))) =
...
erlps__substr__3 [string_0, s_1, l_2]
  | ((((isENum s_1) && (s_1 >= (ErlangInt 1))) && (isENum l_2)) &&
       (l_2 >= (ErlangInt 0))) =
...
erlps__substr1__2 [(ErlangCons c_0 string_1), l_2]
  | (l_2 > (ErlangInt 0)) =
  let    arg_6 = (BIF.erlang__op_minus [l_2, (ErlangInt 1)])
  in let head_4 = (erlps__substr1__2 [string_1, arg_6])
  in (ErlangCons c_0 head_4)
...
erlps__substr2__2 [string_0, (ErlangInt 1)]
  | (isEList string_0) =
  string_0
erlps__substr2__2 [(ErlangCons _ string_0), s_1] =
  let arg_3 = (BIF.erlang__op_minus [s_1, (ErlangInt 1)])
...
erlps__tokens__2 [s_0, seps_1] =
  case seps_1 of
    ...
    (ErlangCons c_6 ErlangEmptyList) ->
      let arg_7 = (BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [s_0])
      in (erlps__tokens_single_1__3 [arg_7, c_6, ErlangEmptyList])
    (ErlangCons _ _) ->
      let arg_11 = (BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [s_0])
      in
...
erlps__chars__3 [c_0, n_1, tail_2] | (n_1 > (ErlangInt 0)) =
  let arg_4 = (BIF.erlang__op_minus [n_1, (ErlangInt 1)])
  in (erlps__chars__3 [c_0, arg_4, (ErlangCons c_0 tail_2)])
erlps__chars__3 [c_0, (ErlangInt 0), tail_1] | (isENum c_0) =
  tail_1
erlps__chars__3 [arg_2, arg_3, arg_4] =
  (EXC.function_clause unit)
...
erlps__copies__2 [charlist_0, num_1]
  | (((isEList charlist_0) && (isENum num_1)) &&
       (num_1 >= (ErlangInt 0))) =
...
erlps__copies__3 [_charlist_0, (ErlangInt 0), r_1] = r_1
erlps__copies__3 [charlist_0, num_1, r_2] =
  let    arg_4 = (BIF.erlang__op_minus [num_1, (ErlangInt 1)])
...
erlps__words__1 [string_0] =
  (erlps__words__2 [string_0, (ErlangInt 32)])
erlps__words__1 [arg_3] = (EXC.function_clause unit)
erlps__words__1 args =
  (EXC.badarity (ErlangFun 1 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)

erlps__words__2 :: ErlangFun
erlps__words__2 [string_0, char_1] | (isENum char_1) =
  let arg_2 = (erlps__strip__3 [string_0, (ErlangAtom "both"), char_1])
  in (erlps__w_count__3 [arg_2, char_1, (ErlangInt 0)])
...
erlps__sub_word__2 [string_0, index_1] =
  (erlps__sub_word__3 [string_0, index_1, (ErlangInt 32)])
...
erlps__sub_word__3 [string_0, index_1, char_2]
  | ((isENum index_1) && (isENum char_2)) =
  let case_3 = (erlps__words__2 [string_0, char_2])
  in
    case case_3 of
      num_6 | (num_6 < index_1) -> ErlangEmptyList
      _num_7 ->
        let arg_8 = (erlps__strip__3 [string_0, (ErlangAtom "left"), char_2])
        in
          (erlps__s_word__5
             [arg_8, index_1, char_2, (ErlangInt 1), ErlangEmptyList])
...
erlps__s_word__5 [(ErlangCons char_0 t_1), stop_2, char_3,
  ...
  | (char_3 == char_0)
  , (index_4 < stop_2) =
  let    arg_6 = (erlps__strip__3 [t_1, (ErlangAtom "left"), char_0])
  in let arg_12 = (BIF.erlang__op_plus [index_4, (ErlangInt 1)])
...
erlps__strip__2 [string_0, (ErlangAtom "left")] =
  (erlps__strip_left__2 [string_0, (ErlangInt 32)])
erlps__strip__2 [string_0, (ErlangAtom "right")] =
  (erlps__strip_right__2 [string_0, (ErlangInt 32)])
erlps__strip__2 [string_0, (ErlangAtom "both")] =
  let arg_1 = (erlps__strip_left__2 [string_0, (ErlangInt 32)])
  in (erlps__strip_right__2 [arg_1, (ErlangInt 32)])
...
erlps__strip_left__2 [s_0@(ErlangCons _ _), sc_1]
  | (isENum sc_1) =
  s_0
erlps__strip_left__2 [ErlangEmptyList, sc_0] | (isENum sc_0) =
  ErlangEmptyList
...
erlps__strip_right__2 [(ErlangCons c_0 s_1), sc_2] =
  let head_4 = (erlps__strip_right__2 [s_1, sc_2])
  in (ErlangCons c_0 head_4)
erlps__strip_right__2 [ErlangEmptyList, sc_0] | (isENum sc_0) =
  ErlangEmptyList
...
erlps__left__2 [string_0, len_1] | (isENum len_1) =
  (erlps__left__3 [string_0, len_1, (ErlangInt 32)])
erlps__left__2 [arg_5, arg_6] = (EXC.function_clause unit)
erlps__left__2 args =
  (EXC.badarity (ErlangFun 2 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)

erlps__left__3 :: ErlangFun
erlps__left__3 [string_0, len_1, char_2] | (isENum char_2) =
  let slen_4 = (BIF.erlang__length__1 [string_0])
  in
    case (ErlangAtom "true") of
      _ | (slen_4 > len_1) ->
        (erlps__substr__3 [string_0, (ErlangInt 1), len_1])
      _ | (slen_4 < len_1) ->
...
erlps__right__2 [string_0, len_1] | (isENum len_1) =
  (erlps__right__3 [string_0, len_1, (ErlangInt 32)])
erlps__right__2 [arg_5, arg_6] = (EXC.function_clause unit)
erlps__right__2 args =
  (EXC.badarity (ErlangFun 2 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)

erlps__right__3 :: ErlangFun
erlps__right__3 [string_0, len_1, char_2] | (isENum char_2) =
  let slen_4 = (BIF.erlang__length__1 [string_0])
  in
    case (ErlangAtom "true") of
      _ | (slen_4 > len_1) ->
        let    lop_7 = (BIF.erlang__op_minus [slen_4, len_1])
        in let arg_6 = (BIF.erlang__op_plus [lop_7, (ErlangInt 1)])
...
erlps__centre__2 [string_0, len_1] | (isENum len_1) =
  (erlps__centre__3 [string_0, len_1, (ErlangInt 32)])
erlps__centre__2 [arg_5, arg_6] = (EXC.function_clause unit)
erlps__centre__2 args =
  (EXC.badarity (ErlangFun 2 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)

erlps__centre__3 :: ErlangFun
erlps__centre__3 [string_0, (ErlangInt 0), char_1]
  | ((isEList string_0) && (isENum char_1)) =
  ErlangEmptyList
erlps__centre__3 [string_0, len_1, char_2] | (isENum char_2) =
  let slen_4 = (BIF.erlang__length__1 [string_0])
  in
    case (ErlangAtom "true") of
      _ | (slen_4 > len_1) ->
        let    lop_8 = (BIF.erlang__op_minus [slen_4, len_1])
        in let lop_7 = (BIF.erlang__op_div_strict [lop_8, (ErlangInt 2)])
        in let arg_6 = (BIF.erlang__op_plus [lop_7, (ErlangInt 1)])
        in (erlps__substr__3 [string_0, arg_6, len_1])
      _ | (slen_4 < len_1) ->
        let    lop_14 = (BIF.erlang__op_minus [len_1, slen_4])
        in let n_18 = (BIF.erlang__op_div_strict [lop_14, (ErlangInt 2)])
...
erlps__sub_string__3 [string_0, start_1, stop_2] =
  ...
  in let arg_5 = (BIF.erlang__op_plus [lop_6, (ErlangInt 1)])
...
erlps__to_lower_char__1 [c_0]
  | (ErlangAtom "true") <-
      (let    lop_4 = (BIF.erlang__is_integer__1 [c_0])
       in let rop_6 = (BIF.erlang__op_lesserEq [(ErlangInt 65), c_0])
       in let lop_3 = (BIF.erlang__op_andalso [lop_4, rop_6])
       in let rop_9 = (BIF.erlang__op_lesserEq [c_0, (ErlangInt 90)])
       in (BIF.erlang__op_andalso [lop_3, rop_9])) =
  (BIF.erlang__op_plus [c_0, (ErlangInt 32)])
erlps__to_lower_char__1 [c_0]
  | (((isENum c_0) && ((ErlangInt 192) <= c_0)) &&
       (c_0 <= (ErlangInt 214))) =
  (BIF.erlang__op_plus [c_0, (ErlangInt 32)])
erlps__to_lower_char__1 [c_0]
  | (((isENum c_0) && ((ErlangInt 216) <= c_0)) &&
       (c_0 <= (ErlangInt 222))) =
  (BIF.erlang__op_plus [c_0, (ErlangInt 32)])
...
erlps__to_upper_char__1 [c_0]
  | (ErlangAtom "true") <-
      (let    lop_4 = (BIF.erlang__is_integer__1 [c_0])
       in let rop_6 = (BIF.erlang__op_lesserEq [(ErlangInt 97), c_0])
       in let lop_3 = (BIF.erlang__op_andalso [lop_4, rop_6])
       in let rop_9 = (BIF.erlang__op_lesserEq [c_0, (ErlangInt 122)])
       in (BIF.erlang__op_andalso [lop_3, rop_9])) =
  (BIF.erlang__op_minus [c_0, (ErlangInt 32)])
erlps__to_upper_char__1 [c_0]
  | (((isENum c_0) && ((ErlangInt 224) <= c_0)) &&
       (c_0 <= (ErlangInt 246))) =
  (BIF.erlang__op_minus [c_0, (ErlangInt 32)])
erlps__to_upper_char__1 [c_0]
  | (((isENum c_0) && ((ErlangInt 248) <= c_0)) &&
       (c_0 <= (ErlangInt 254))) =
  (BIF.erlang__op_minus [c_0, (ErlangInt 32)])
  ...
  (flmap
     (\ lc_3 ->
        case lc_3 of
          ...
          _ -> ErlangEmptyList)
     s_0)
erlps__to_lower__1 [c_0] | (isENum c_0) =
  (erlps__to_lower_char__1 [c_0])
  ...
  (flmap
     (\ lc_3 ->
        case lc_3 of
          ...
          _ -> ErlangEmptyList)
     s_0)
erlps__to_upper__1 [c_0] | (isENum c_0) =
  (erlps__to_upper_char__1 [c_0])
      ...
      (flmap
         (\ lc_8 ->
            case lc_8 of
              ...
              _ -> ErlangEmptyList)
         t_1)
  in let rop_4 = (BIF.do_remote_fun_call "Lists" "erlps__append__1" [arg_5])
