...
erlps__list_to_float__1 args =
  EXC.badarity (ErlangFun 1 erlps__list_to_float__1) args
...
erlps__list_to_integer__1 args =
  EXC.badarity (ErlangFun 1 erlps__list_to_integer__1) args

erlps__is_empty__1 :: ErlangFun
erlps__is_empty__1 [(ErlangEmptyList)] = ErlangAtom "true"
erlps__is_empty__1 [(ErlangBinary binEnd_0)]
  | BIN.empty binEnd_0 =
  ErlangAtom "true"
...
erlps__length__1 [(ErlangBinary binSeg_0)]
  ...
  , BIN.empty bin_5 =
  let arg_9 = toErl 0
  in erlps__length_b__3 [bin_6, cp1_3, arg_9]
erlps__length__1 [cd_0] =
  let arg_2 = toErl 0
  in erlps__length_1__2 [cd_0, arg_2]
erlps__length__1 [arg_3] = EXC.function_clause unit
erlps__length__1 args =
  EXC.badarity (ErlangFun 1 erlps__length__1) args
...
erlps__equal__2 args =
  EXC.badarity (ErlangFun 2 erlps__equal__2) args
...
erlps__equal__3 [arg_4, arg_5, arg_6] = EXC.function_clause unit
erlps__equal__3 args =
  EXC.badarity (ErlangFun 3 erlps__equal__3) args
...
erlps__equal__4 args =
  EXC.badarity (ErlangFun 4 erlps__equal__4) args

erlps__reverse__1 :: ErlangFun
erlps__reverse__1 [(ErlangBinary binSeg_0)]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp1_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
...
erlps__slice__2 [cd_0, n_1]
  | (isEInt n_1) && (weakGeq n_1 (toErl 0)) =
...
erlps__slice__3 [cd_0, _, (ErlangInt num_1)]
  ...
  in
    case case_2 of
      ...
      something_else -> EXC.case_clause something_else
erlps__slice__3 [arg_4, arg_5, arg_6] = EXC.function_clause unit
erlps__slice__3 args =
  EXC.badarity (ErlangFun 3 erlps__slice__3) args

erlps__pad__2 :: ErlangFun
erlps__pad__2 [cd_0, length_1] =
  let arg_5 = toErl 32
  in erlps__pad__4 [cd_0, length_1, ErlangAtom "trailing", arg_5]
erlps__pad__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__pad__2 args =
  EXC.badarity (ErlangFun 2 erlps__pad__2) args

erlps__pad__3 :: ErlangFun
erlps__pad__3 [cd_0, length_1, dir_2] =
  let arg_6 = toErl 32
  in erlps__pad__4 [cd_0, length_1, dir_2, arg_6]
erlps__pad__3 [arg_7, arg_8, arg_9] = EXC.function_clause unit
erlps__pad__3 args =
  EXC.badarity (ErlangFun 3 erlps__pad__3) args
...
erlps__pad__4 [cd_0, length_1, (ErlangAtom "leading"), char_2]
  ...
  in let arg_6 = BIF.erlang__max__2 [arg_7, arg_8]
  in let
    head_5 =
...
erlps__pad__4 [cd_0, length_1, (ErlangAtom "trailing"), char_2]
  ...
  in let arg_7 = BIF.erlang__max__2 [arg_8, arg_9]
  in let
    tail_6 =
      BIF.do_remote_fun_call "Lists" "erlps__duplicate__2"
        [arg_7, char_2]
...
erlps__pad__4 [cd_0, length_1, (ErlangAtom "both"), char_2]
  ...
  in let size_9 = BIF.erlang__max__2 [arg_5, arg_6]
  in let rop_12 = toErl 2
  in let arg_10 = BIF.erlang__op_div_strict [size_9, rop_12]
  in let
    pre_14 =
      BIF.do_remote_fun_call "Lists" "erlps__duplicate__2"
        [arg_10, char_2]
  in let rop_17 = toErl 2
  in let case_15 = BIF.erlang__op_rem_strict [size_9, rop_17]
  in let
    post_21 =
      case case_15 of
...
erlps__pad__4 [arg_28, arg_29, arg_30, arg_31] =
  EXC.function_clause unit
erlps__pad__4 args =
  EXC.badarity (ErlangFun 4 erlps__pad__4) args
...
erlps__trim__1 args =
  EXC.badarity (ErlangFun 1 erlps__trim__1) args
...
erlps__trim__2 args =
  EXC.badarity (ErlangFun 2 erlps__trim__2) args
...
erlps__trim__3 [str_0, (ErlangAtom "leading"),
  ...
  | (isEList str_0) && (weakLt sep_1 (toErl 256)) =
...
erlps__trim__3 [str_0, (ErlangAtom "trailing"), seps0_1]
  ...
  in let arg_5 = toErl 0
  in erlps__trim_t__3 [str_0, arg_5, seps_3]
...
erlps__trim__3 [arg_8, arg_9, arg_10] = EXC.function_clause unit
erlps__trim__3 args =
  EXC.badarity (ErlangFun 3 erlps__trim__3) args

erlps__chomp__1 :: ErlangFun
erlps__chomp__1 [str_0] =
  let    head_5 = toErl 13
  in let head_7 = toErl 10
...
erlps__chomp__1 args =
  EXC.badarity (ErlangFun 1 erlps__chomp__1) args
...
erlps__take__4 [str_0, sep0_1, (ErlangAtom "false"),
  ...
  let    sep_3 = erlps__search_pattern__1 [sep0_1]
  in let arg_5 = toErl 0
  in erlps__take_t__3 [str_0, arg_5, sep_3]
erlps__take__4 [str_0, sep0_1, (ErlangAtom "true"),
                (ErlangAtom "trailing")]
  =
  let    sep_3 = erlps__search_pattern__1 [sep0_1]
  in let arg_5 = toErl 0
  in erlps__take_tc__3 [str_0, arg_5, sep_3]
erlps__take__4 [arg_7, arg_8, arg_9, arg_10] =
  EXC.function_clause unit
erlps__take__4 args =
  EXC.badarity (ErlangFun 4 erlps__take__4) args
    ...
    (\ ex_4 ->
       case ex_4 of
         (ErlangTuple [(ErlangAtom "throw"), (ErlangAtom "unchanged"),
           ...
           cd_0
         ex_5 -> EXC.raise ex_5)
erlps__uppercase__1 [orig_7@(ErlangBinary binSeg_0)]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp1_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
  ...
  EXC.tryOfCatch
    ...
    (\ of_11 ->
       BIF.do_remote_fun_call "Erlang.Unicode"
         "erlps__characters_to_binary__1" [of_11])
    (\ ex_12 ->
       case ex_12 of
         (ErlangTuple [(ErlangAtom "throw"), (ErlangAtom "unchanged"),
                       _]) ->
...
erlps__uppercase__1 [(ErlangBinary binEnd_0)]
  | BIN.empty binEnd_0 =
  ErlangBinary (BIN.concat [])
    ...
    (\ ex_4 ->
       case ex_4 of
         (ErlangTuple [(ErlangAtom "throw"), (ErlangAtom "unchanged"),
           ...
           cd_0
         ex_5 -> EXC.raise ex_5)
erlps__lowercase__1 [orig_7@(ErlangBinary binSeg_0)]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp1_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
    ...
    (\ ex_12 ->
       case ex_12 of
         (ErlangTuple [(ErlangAtom "throw"), (ErlangAtom "unchanged"),
           ...
           orig_7
         ex_13 -> EXC.raise ex_13)
erlps__lowercase__1 [(ErlangBinary binEnd_0)]
  | BIN.empty binEnd_0 =
  ErlangBinary (BIN.concat [])
  ...
  in
    case case_1 of
      (ErlangCons cp_3 chars_4) | isEInt cp_3 ->
        ErlangBinary
          (BIN.concat
             [BIN.fromInt cp_3 (toErl 8) 1 BIN.Big,
              BIN.binPrefix chars_4 (BIN.packedSize chars_4) 8])
            ...
            BIN.concatErl
              (flmap
                 (\ lc_12 ->
                    let
                      lcRet_13 =
                        ErlangBinary (BIN.fromInt lc_12 (toErl 8) 1 BIN.Big)
    ...
    (\ ex_4 ->
       case ex_4 of
         (ErlangTuple [(ErlangAtom "throw"), (ErlangAtom "unchanged"),
           ...
           cd_0
         ex_5 -> EXC.raise ex_5)
erlps__casefold__1 [orig_7@(ErlangBinary binSeg_0)]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp1_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
    ...
    (\ ex_12 ->
       case ex_12 of
         (ErlangTuple [(ErlangAtom "throw"), (ErlangAtom "unchanged"),
           ...
           orig_7
         ex_13 -> EXC.raise ex_13)
erlps__casefold__1 [(ErlangBinary binEnd_0)]
  | BIN.empty binEnd_0 =
  ErlangBinary (BIN.concat [])
...
erlps__to_integer__1 [string_0] =
  EXC.tryOfCatch
    (\ _ ->
       let arg_2 = toErl "+-0123456789"
       in erlps__take__2 [string_0, arg_2])
    (\ of_3 ->
       case of_3 of
         (ErlangTuple [head_6, tail_7]) ->
           let case_8 = erlps__is_empty__1 [head_6]
           in
             case case_8 of
               (ErlangAtom "true") ->
                 ErlangTuple [ErlangAtom "error", ErlangAtom "no_integer"]
               (ErlangAtom "false") ->
                 let   
                   list_13 =
                     BIF.do_remote_fun_call "Erlang.Unicode"
                       "erlps__characters_to_list__1" [head_6]
                 in let case_14 = erlps__list_to_integer__1 [list_13]
                 in
                   case case_14 of
                     err_16@(ErlangTuple [(ErlangAtom "error"), _]) -> err_16
                     (ErlangTuple [int_17, rest_18]) ->
                       erlps__to_number__5
                         [string_0, int_17, rest_18, list_13, tail_7]
                     something_else -> EXC.case_clause something_else
               something_else -> EXC.case_clause something_else
    ...
    (\ ex_4 ->
       case ex_4 of
         ...
         ex_5 -> EXC.raise ex_5)
erlps__to_integer__1 [arg_26] = EXC.function_clause unit
erlps__to_integer__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_integer__1) args

erlps__to_float__1 :: ErlangFun
erlps__to_float__1 [string_0] =
  EXC.tryOfCatch
    (\ _ ->
       let arg_2 = toErl "+-0123456789eE.,"
       in erlps__take__2 [string_0, arg_2])
    (\ of_3 ->
       case of_3 of
         (ErlangTuple [head_6, tail_7]) ->
               ...
               (ErlangAtom "false") ->
                 let   
                   list_13 =
                     BIF.do_remote_fun_call "Erlang.Unicode"
                       "erlps__characters_to_list__1" [head_6]
                 in let case_14 = erlps__list_to_float__1 [list_13]
                 in
                   case case_14 of
                     err_16@(ErlangTuple [(ErlangAtom "error"), _]) -> err_16
                     (ErlangTuple [float_17, rest_18]) ->
                       erlps__to_number__5
                         [string_0, float_17, rest_18, list_13, tail_7]
                     something_else -> EXC.case_clause something_else
               something_else -> EXC.case_clause something_else
         something_else -> EXC.try_clause something_else)
    (\ ex_4 ->
       case ex_4 of
         (ErlangTuple [_, _, _]) ->
           ErlangTuple [ErlangAtom "error", ErlangAtom "badarg"]
         ex_5 -> EXC.raise ex_5)
erlps__to_float__1 [arg_26] = EXC.function_clause unit
erlps__to_float__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_float__1) args
...
erlps__to_number__5 [string_0, number_1, rest_2, list_3, _tail_4]
  ...
  in
    case string_0 of
      (ErlangBinary binSeg_10) | (ErlangInt size_11) <- (bsz_9)
                               , (BIN.Ok _ bin_12) <-
...
erlps__to_number__5 args =
  EXC.badarity (ErlangFun 5 erlps__to_number__5) args
    ...
    case case_3 of
      ...
      (ErlangAtom "false") ->
        ...
        in let
          case_9 =
            erlps__split_1__6
              [string_0, searchpatterncps_8, arg_12, where_2, ErlangEmptyList,
               ErlangEmptyList]
        in
          case case_9 of
...
erlps__replace__4 [string_0, searchpattern_1, replacement_2,
                   where_3]
  =
  let arg_5 = erlps__split__3 [string_0, searchpattern_1, where_3]
  in
    BIF.do_remote_fun_call "Lists" "erlps__join__2"
      [replacement_2, arg_5]
...
erlps__replace__4 args =
  EXC.badarity (ErlangFun 4 erlps__replace__4) args
...
erlps__lexemes__2 args =
  EXC.badarity (ErlangFun 2 erlps__lexemes__2) args
...
erlps__nth_lexeme__3 [str_0, n_1, seps0_2]
  | ((isEList seps0_2) && (isEInt n_1)) && (weakGt n_1 (toErl 0)) =
...
erlps__nth_lexeme__3 args =
  EXC.badarity (ErlangFun 3 erlps__nth_lexeme__3) args
...
erlps__find__3 [string_0, (ErlangBinary binEnd_1), _]
  | BIN.empty binEnd_1 =
  string_0
...
erlps__find__3 args =
  EXC.badarity (ErlangFun 3 erlps__find__3) args
...
erlps__next_grapheme__1 args =
  EXC.badarity (ErlangFun 1 erlps__next_grapheme__1) args
...
erlps__next_codepoint__1 args =
  EXC.badarity (ErlangFun 1 erlps__next_codepoint__1) args

erlps__length_1__2 :: ErlangFun
erlps__length_1__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                    n_3]
  | ((weakLt cp1_0 (toErl 256)) && (weakLt cp2_1 (toErl 256))) &&
      ((/=) cp1_0 (toErl 13)) =
  let    rop_7 = toErl 1
  in let arg_5 = BIF.erlang__op_plus [n_3, rop_7]
...
erlps__length_1__2 [str_0, n_1] =
  ...
  in
    case case_2 of
      ...
      (ErlangCons _ rest_4) ->
        let    rop_8 = toErl 1
        in let arg_6 = BIF.erlang__op_plus [n_1, rop_8]
...
erlps__length_1__2 args =
  EXC.badarity (ErlangFun 2 erlps__length_1__2) args

erlps__length_b__3 :: ErlangFun
erlps__length_b__3 [(ErlangBinary binSeg_0), cp1_7, n_8]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp2_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
  , (BIN.Ok rest_6 bin_5) <- (BIN.chopBin bin_2 size_4 8)
  , BIN.empty bin_5
  , ((weakLt cp1_7 (toErl 256)) && (weakLt cp2_3 (toErl 256))) &&
      ((/=) cp1_7 (toErl 13)) =
  let    rop_13 = toErl 1
  in let arg_11 = BIF.erlang__op_plus [n_8, rop_13]
      ...
      (ErlangCons _ bin1_6) ->
        ...
        in
          case case_8 of
            (ErlangEmptyList) ->
              let rop_11 = toErl 1
              in BIF.erlang__op_plus [n_2, rop_11]
            (ErlangCons cp3_12 bin_13) ->
              let    rop_18 = toErl 1
              in let arg_16 = BIF.erlang__op_plus [n_2, rop_18]
...
erlps__length_b__3 args =
  EXC.badarity (ErlangFun 3 erlps__length_b__3) args
...
erlps__equal_1__2 args =
  EXC.badarity (ErlangFun 2 erlps__equal_1__2) args
...
erlps__equal_nocase__2 [a0_0, b0_1] =
  let   
    arg_4 =
      BIF.do_remote_fun_call "Unicode.Util" "erlps__casefold__1" [a0_0]
  in let
    tup_el_3 =
      BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [arg_4]
  in let
    arg_7 =
      BIF.do_remote_fun_call "Unicode.Util" "erlps__casefold__1" [b0_1]
  in let
    tup_el_6 =
...
erlps__equal_nocase__2 args =
  EXC.badarity (ErlangFun 2 erlps__equal_nocase__2) args
...
erlps__equal_norm__3 args =
  EXC.badarity (ErlangFun 3 erlps__equal_norm__3) args
...
erlps__equal_norm_nocase__3 args =
  EXC.badarity (ErlangFun 3 erlps__equal_norm_nocase__3) args
...
erlps__reverse_1__2 args =
  EXC.badarity (ErlangFun 2 erlps__reverse_1__2) args

erlps__reverse_b__3 :: ErlangFun
erlps__reverse_b__3 [(ErlangBinary binSeg_0), cp1_7, acc_8]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp2_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
...
erlps__reverse_b__3 args =
  EXC.badarity (ErlangFun 3 erlps__reverse_b__3) args

erlps__slice_l0__2 :: ErlangFun
erlps__slice_l0__2 [(ErlangBinary binSeg_0), n_7]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp1_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
...
erlps__slice_l0__2 args =
  EXC.badarity (ErlangFun 2 erlps__slice_l0__2) args
...
erlps__slice_l__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
  ...
  | (((weakLt cp1_0 (toErl 256)) && (weakLt cp2_1 (toErl 256))) &&
      ...
      (weakGt n_3 (toErl 0)) =
  let    rop_7 = toErl 1
  in let arg_5 = BIF.erlang__op_minus [n_3, rop_7]
  in erlps__slice_l__2 [cont_2, arg_5]
erlps__slice_l__2 [cd_0, n_1] | weakGt n_1 (toErl 0) =
  let
    case_2 =
      BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cd_0]
  in
    case case_2 of
      (ErlangCons _ cont_4) ->
        let    rop_8 = toErl 1
        in let arg_6 = BIF.erlang__op_minus [n_1, rop_8]
...
erlps__slice_l__2 args =
  EXC.badarity (ErlangFun 2 erlps__slice_l__2) args

erlps__slice_lb__3 :: ErlangFun
erlps__slice_lb__3 [(ErlangBinary binSeg_0), cp1_7, n_8]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp2_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
  ...
  , (((weakLt cp1_7 (toErl 256)) && (weakLt cp2_3 (toErl 256))) &&
      ...
      (weakGt n_8 (toErl 1)) =
  let    rop_13 = toErl 1
  in let arg_11 = BIF.erlang__op_minus [n_8, rop_13]
            ...
            in
              case case_8 of
                (ErlangCons cp2_10 cont_11) ->
                  let    rop_16 = toErl 1
                  in let arg_14 = BIF.erlang__op_minus [n_2, rop_16]
...
erlps__slice_trail__2 [orig_0, n_1] | isEBinary orig_0 =
  case orig_0 of
    (ErlangBinary binSeg_3) | (ErlangInt size_4) <- (toErl 8)
      ...
      in
        case orig_0 of
          (ErlangBinary binSeg_18) | (ErlangInt size_19) <- (sz_17)
                                   , (BIN.Ok keep_21 bin_20) <-
                                       (BIN.chopBin binSeg_18 size_19 8) ->
            keep_21
          _ -> EXC.badmatch orig_0
    (ErlangBinary binSeg_23) | (ErlangInt size_24) <- (toErl 8)
                             , (BIN.Ok _ bin_25) <-
                                 (BIN.chopInt binSeg_23 size_24 1 BIN.Big
                                    BIN.Unsigned)
                             , weakGt n_1 (toErl 0) ->
      let arg_26 = ErlangTuple [ErlangAtom "badarg", orig_0]
...
erlps__slice_trail__2 args =
  EXC.badarity (ErlangFun 2 erlps__slice_trail__2) args
...
erlps__slice_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
  ...
  | (((weakLt cp1_0 (toErl 256)) && (weakLt cp2_1 (toErl 256))) &&
      ...
      (weakGt n_3 (toErl 0)) =
  let    rop_9 = toErl 1
  in let arg_7 = BIF.erlang__op_minus [n_3, rop_9]
  in let tail_5 = erlps__slice_list__2 [cont_2, arg_7]
  in ErlangCons cp1_0 tail_5
erlps__slice_list__2 [cd_0, n_1] | weakGt n_1 (toErl 0) =
  let
    case_2 =
      BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1" [cd_0]
  in
    case case_2 of
      (ErlangCons gc_4 cont_5) ->
        let    rop_11 = toErl 1
        in let arg_9 = BIF.erlang__op_minus [n_1, rop_11]
...
erlps__slice_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__slice_list__2) args

erlps__slice_bin__3 :: ErlangFun
erlps__slice_bin__3 [(ErlangBinary binSeg_0), cp1_7, n_8]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp2_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
...
erlps__slice_bin__3 [cd_0, cp1_1, n_2] | weakGt n_2 (toErl 0) =
  let
    matchExpr_7 =
      BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1"
...
erlps__slice_bin__3 [cd_0, cp1_1, (ErlangInt num_2)]
  ...
  in let
    arg_6 = ErlangBinary (BIN.fromInt cp1_1 (toErl 8) 1 BIN.Big)
...
erlps__slice_bin__3 args =
  EXC.badarity (ErlangFun 3 erlps__slice_bin__3) args

erlps__uppercase_list__2 :: ErlangFun
erlps__uppercase_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                          _changed_3]
  | ((weakLeq (toErl 97) cp1_0) && (weakLeq cp1_0 (toErl 122))) &&
      (weakLt cp2_1 (toErl 256)) =
  let    rop_6 = toErl 32
  in let head_4 = BIF.erlang__op_minus [cp1_0, rop_6]
  in let
    tail_7 = erlps__uppercase_list__2 [cont_2, ErlangAtom "true"]
  in ErlangCons head_4 tail_7
erlps__uppercase_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                          changed_3]
  | (weakLt cp1_0 (toErl 128)) && (weakLt cp2_1 (toErl 256)) =
...
erlps__uppercase_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__uppercase_list__2) args

erlps__uppercase_bin__3 :: ErlangFun
erlps__uppercase_bin__3 [cp1_0, (ErlangBinary binSeg_1),
                         _changed_8]
  | (ErlangInt size_2) <- (toErl 8)
  , (BIN.Ok cp2_4 bin_3) <-
      (BIN.chopInt binSeg_1 size_2 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_5) <- (BIN.size bin_3)
  , (BIN.Ok bin_7 bin_6) <- (BIN.chopBin bin_3 size_5 8)
  , BIN.empty bin_6
  , ((weakLeq (toErl 97) cp1_0) && (weakLeq cp1_0 (toErl 122))) &&
      (weakLt cp2_4 (toErl 256)) =
  let    rop_11 = toErl 32
  in let head_9 = BIF.erlang__op_minus [cp1_0, rop_11]
  in let
    tail_12 =
...
erlps__uppercase_bin__3 [cp1_0, (ErlangBinary binSeg_1),
  ...
  , (BIN.Ok bin_7 bin_6) <- (BIN.chopBin bin_3 size_5 8)
  , BIN.empty bin_6
  , (weakLt cp1_0 (toErl 128)) && (weakLt cp2_4 (toErl 256)) =
...
erlps__uppercase_bin__3 args =
  EXC.badarity (ErlangFun 3 erlps__uppercase_bin__3) args

erlps__lowercase_list__2 :: ErlangFun
erlps__lowercase_list__2 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
                          _changed_3]
  | ((weakLeq (toErl 65) cp1_0) && (weakLeq cp1_0 (toErl 90))) &&
      (weakLt cp2_1 (toErl 256)) =
  let    rop_6 = toErl 32
  in let head_4 = BIF.erlang__op_plus [cp1_0, rop_6]
  in let
...
erlps__lowercase_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__lowercase_list__2) args

erlps__lowercase_bin__3 :: ErlangFun
erlps__lowercase_bin__3 [cp1_0, (ErlangBinary binSeg_1),
                         _changed_8]
  | (ErlangInt size_2) <- (toErl 8)
  , (BIN.Ok cp2_4 bin_3) <-
      (BIN.chopInt binSeg_1 size_2 1 BIN.Big BIN.Unsigned)
  ...
  , ((weakLeq (toErl 65) cp1_0) && (weakLeq cp1_0 (toErl 90))) &&
      (weakLt cp2_4 (toErl 256)) =
  let    rop_11 = toErl 32
  in let head_9 = BIF.erlang__op_plus [cp1_0, rop_11]
  in let
    tail_12 =
...
erlps__lowercase_bin__3 args =
  EXC.badarity (ErlangFun 3 erlps__lowercase_bin__3) args
...
erlps__casefold_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__casefold_list__2) args

erlps__casefold_bin__3 :: ErlangFun
erlps__casefold_bin__3 [cp1_0, (ErlangBinary binSeg_1),
                        _changed_8]
  | (ErlangInt size_2) <- (toErl 8)
  , (BIN.Ok cp2_4 bin_3) <-
      (BIN.chopInt binSeg_1 size_2 1 BIN.Big BIN.Unsigned)
...
erlps__casefold_bin__3 args =
  EXC.badarity (ErlangFun 3 erlps__casefold_bin__3) args
...
erlps__trim_ls__2 args =
  EXC.badarity (ErlangFun 2 erlps__trim_ls__2) args
...
erlps__trim_ts__2 [str_2@(ErlangCons sep_0 cs1_1), sep_3]
  ...
  case cs1_1 of
    (ErlangEmptyList) -> ErlangEmptyList
    (ErlangCons cp2_5 _) | ((weakLt sep_0 (toErl 256)) &&
                              (weakLt cp2_5 (toErl 256))) &&
                             ((/=) sep_0 (toErl 13)) ->
    ...
    _ ->
      ...
      in erlps__trim_t__3 [str_2, arg_14, arg_15]
...
erlps__trim_ts__2 [str_0, sep_1] =
  ...
  in erlps__trim_t__3 [str_0, arg_3, arg_4]
erlps__trim_ts__2 [arg_8, arg_9] = EXC.function_clause unit
erlps__trim_ts__2 args =
  EXC.badarity (ErlangFun 2 erlps__trim_ts__2) args
            ...
            (ErlangCons gc_10 cs1_11) ->
              ...
              in
                case case_13 of
                  (ErlangAtom "true") ->
                    let    arg_17 = toErl 0
                    in let tail_19 = erlps__trim_t__3 [cs1_11, arg_17, seps_5]
                  ...
                  (ErlangAtom "false") ->
                    let    arg_27 = toErl 0
                    in let arg_25 = erlps__trim_t__3 [cs1_11, arg_27, seps_5]
                    in erlps__append__2 [gc_10, arg_25]
                  something_else -> EXC.case_clause something_else
            _ -> EXC.badmatch matchExpr_12
      (ErlangAtom "false") ->
        let    arg_32 = toErl 0
        in let tail_30 = erlps__trim_t__3 [cont_1, arg_32, seps_5]
...
erlps__trim_t__3 [(ErlangCons bin_0 cont0_1), n_2,
  ...
  case bin_0 of
    (ErlangBinary binSeg_5) | (ErlangInt size_6) <- (n_2)
                            , (BIN.Ok _ bin_7) <-
                                (BIN.chopBin binSeg_5 size_6 8)
                            , (ErlangInt size_8) <- (BIN.size bin_7)
                            , (BIN.Ok rest_10 bin_9) <-
                                (BIN.chopBin bin_7 size_8 8)
                            , BIN.empty bin_9 ->
      let    seps_13 = erlps__search_compile__1 [seps0_4]
      in let case_14 = erlps__bin_search__3 [rest_10, cont0_1, seps_13]
      in
        case case_14 of
          (ErlangTuple [(ErlangAtom "nomatch"), _]) ->
            let    arg_21 = toErl 0
            in let arg_19 = erlps__trim_t__3 [cont0_1, arg_21, seps_13]
            in erlps__stack__2 [bin_0, arg_19]
          (ErlangCons sepstart_23 cont1_24) ->
            let
              case_25 = erlps__bin_search_inv__3 [sepstart_23, cont1_24, gcs_3]
            in
              case case_25 of
                (ErlangTuple [(ErlangAtom "nomatch"), cont_29]) ->
                  let    arg_31 = toErl 0
                  in let tail_33 = erlps__trim_t__3 [cont_29, arg_31, seps_13]
                  ...
                  in
                    case case_34 of
                      (ErlangAtom "true") ->
                        ...
                        in let keepsz_40 = BIF.erlang__op_minus [lop_36, rop_38]
                        in
                          case bin_0 of
                            (ErlangBinary binSeg_41) | (ErlangInt size_42) <-
                                                         (keepsz_40)
                                                     , (BIN.Ok keep_44 bin_43) <-
                                                         (BIN.chopBin binSeg_41
                                                            size_42 8) ->
                              keep_44
                            _ -> EXC.badmatch bin_0
                      (ErlangAtom "false") ->
                        let    used_48 = erlps__cp_prefix__2 [cont0_1, cont_29]
      ...
      (ErlangCons gc_6 cs1_7) ->
        ...
        in
          case case_8 of
            (ErlangAtom "true") ->
              let    arg_12 = toErl 0
              in let tail_14 = erlps__trim_t__3 [cs1_7, arg_12, seps_3]
            ...
            (ErlangAtom "false") ->
              let    arg_22 = toErl 0
              in let arg_20 = erlps__trim_t__3 [cs1_7, arg_22, seps_3]
...
erlps__trim_t__3 [bin_0, n_1,
  ...
  case bin_0 of
    (ErlangBinary binSeg_4) | (ErlangInt size_5) <- (n_1)
                            , (BIN.Ok _ bin_6) <-
                                (BIN.chopBin binSeg_4 size_5 8)
                            , (ErlangInt size_7) <- (BIN.size bin_6)
                            , (BIN.Ok rest_9 bin_8) <-
                                (BIN.chopBin bin_6 size_7 8)
                            , BIN.empty bin_8 ->
      let    seps_12 = erlps__search_compile__1 [seps0_3]
      in let
        case_13 = erlps__bin_search__3 [rest_9, ErlangEmptyList, seps_12]
      in
        case case_13 of
            ...
            in
              case case_18 of
                (ErlangTuple [(ErlangAtom "nomatch"), _]) ->
                  ...
                  in
                    case bin_0 of
                      (ErlangBinary binSeg_27) | (ErlangInt size_28) <-
                                                   (keepsz_26)
                                               , (BIN.Ok keep_30 bin_29) <-
                                                   (BIN.chopBin binSeg_27
                                                      size_28 8) ->
                        keep_30
                      _ -> EXC.badmatch bin_0
                (ErlangCons nonsep_32 (ErlangEmptyList)) ->
                  let    lop_33 = BIF.erlang__byte_size__1 [bin_0]
                  in let rop_35 = BIF.erlang__byte_size__1 [nonsep_32]
                  in let keepsz_37 = BIF.erlang__op_minus [lop_33, rop_35]
                  in erlps__trim_t__3 [bin_0, keepsz_37, seps_12]
                something_else -> EXC.case_clause something_else
          something_else -> EXC.case_clause something_else
    _ -> EXC.badmatch bin_0
  ...
  in
    case case_3 of
      ...
      (ErlangCons after_11 (ErlangEmptyList)) ->
        ...
        in
          case bin_0 of
            (ErlangBinary binSeg_17) | (ErlangInt size_18) <- (first_16)
                                     , (BIN.Ok keep_20 bin_19) <-
                                         (BIN.chopBin binSeg_17 size_18 8) ->
              let tup_el_22 = erlps__btoken__2 [keep_20, acc_2]
  ...
  in
    case case_5 of
      ...
      (ErlangCons after_13 (ErlangEmptyList)) ->
        ...
        in
          case bin_0 of
            (ErlangBinary binSeg_19) | (ErlangInt size_20) <- (first_18)
                                     , (BIN.Ok keep_22 bin_21) <-
                                         (BIN.chopBin binSeg_19 size_20 8) ->
              let tup_el_24 = erlps__btoken__2 [keep_22, acc_2]
...
erlps__take_t__3 [str0_2@(ErlangCons cp1_0 cont_1), _,
  ...
  in
    case case_6 of
              ...
              in
                case case_13 of
                  (ErlangAtom "true") ->
                    let    arg_17 = toErl 0
                    in let
                      matchExpr_21 = erlps__take_t__3 [str_11, arg_17, seps_5]
                    in
                        ...
                        (ErlangTuple [head_19, tail_20]) ->
                          ...
                          in
                            case case_22 of
                              (ErlangAtom "true") ->
                                let
                                  tup_el_25 = erlps__append__2 [gc_10, tail_20]
                                in ErlangTuple [head_19, tup_el_25]
                              (ErlangAtom "false") ->
                                let
                                  tup_el_28 = erlps__append__2 [gc_10, head_19]
                  ...
                  (ErlangAtom "false") ->
                    let    arg_33 = toErl 0
                    in let
                      matchExpr_37 = erlps__take_t__3 [str_11, arg_33, seps_5]
                    in
      ...
      (ErlangAtom "false") ->
        let    arg_43 = toErl 0
        in let matchExpr_47 = erlps__take_t__3 [cont_1, arg_43, seps_5]
        in
      ...
      in
        case case_14 of
          (ErlangTuple [(ErlangAtom "nomatch"), cont_18]) ->
            ...
            in let matchExpr_27 = erlps__take_t__3 [cont_18, arg_23, seps_13]
            in
          ...
          (ErlangCons sepstart_35 cont1_36) ->
            let
              case_37 = erlps__bin_search_inv__3 [sepstart_35, cont1_36, gcs_3]
            in
              case case_37 of
                (ErlangTuple [(ErlangAtom "nomatch"), cont_41]) ->
                  let    arg_43 = toErl 0
                  in let
                    matchExpr_47 = erlps__take_t__3 [cont_41, arg_43, seps_13]
                  in
                    case matchExpr_47 of
                      (ErlangTuple [head_45, tail_46]) ->
                        let    used_50 = erlps__cp_prefix__2 [cont0_1, cont_41]
                        ...
                        in
                          case case_51 of
                            (ErlangAtom "true") ->
                              ...
                              in let
                                rop_55 = BIF.erlang__byte_size__1 [sepstart_35]
                              in let
                                keepsz_57 =
                                  BIF.erlang__op_minus [lop_53, rop_55]
                              in
                                case bin_0 of
                                  (ErlangBinary binSeg_58) | (ErlangInt size_59) <-
                                                               (keepsz_57)
                                                           ...
                                                           , BIN.empty bin_63 ->
                                    let   
                                      arg_68 = erlps__stack__2 [end_64, used_50]
                                    in let
                                      tup_el_67 =
      ...
      (ErlangCons gc_6 cs1_7) ->
        ...
        in
          case case_8 of
            (ErlangAtom "true") ->
              let    arg_12 = toErl 0
              in let matchExpr_16 = erlps__take_t__3 [cs1_7, arg_12, seps_3]
              in
            ...
            (ErlangAtom "false") ->
              let    arg_28 = toErl 0
              in let matchExpr_32 = erlps__take_t__3 [cs1_7, arg_28, seps_3]
              in
            ...
            in
              case case_20 of
                (ErlangTuple [(ErlangAtom "nomatch"), _]) ->
                  ...
                  in
                    case bin_0 of
                      (ErlangBinary binSeg_29) | (ErlangInt size_30) <-
                                                   (keepsz_28)
                                               , (BIN.Ok before_32 bin_31) <-
                                                   (BIN.chopBin binSeg_29
                                                      size_30 8)
                                               , (ErlangInt size_33) <-
                                                   (BIN.size bin_31)
                                               , (BIN.Ok end_35 bin_34) <-
                                                   (BIN.chopBin bin_31 size_33
                                                      8)
                                               , BIN.empty bin_34 ->
...
erlps__take_tc__3 [(ErlangCons cp1_0 cont_2@(ErlangCons cp2_1 _)),
  ...
  in
    case case_5 of
      (ErlangAtom "false") ->
        let    arg_9 = toErl 0
        in let matchExpr_13 = erlps__take_tc__3 [cont_2, arg_9, seps_4]
        in
          case matchExpr_13 of
      ...
      (ErlangAtom "true") ->
        let    arg_25 = toErl 0
        in let matchExpr_29 = erlps__take_tc__3 [cont_2, arg_25, seps_4]
        in
  ...
  case bin_0 of
    (ErlangBinary binSeg_5) | (ErlangInt size_6) <- (n_2)
                            ...
                            , (BIN.Ok rest_10 bin_9) <-
                                (BIN.chopBin bin_7 size_8 8)
                            , BIN.empty bin_9 ->
      let case_12 = erlps__bin_search_inv__3 [rest_10, cont0_1, gcs_3]
      in
        case case_12 of
          (ErlangTuple [(ErlangAtom "nomatch"), cont_16]) ->
            let    used_19 = erlps__cp_prefix__2 [cont0_1, cont_16]
            in let arg_21 = toErl 0
            in let
              matchExpr_25 = erlps__take_tc__3 [cont_16, arg_21, seps0_4]
            in
            ...
            in
              case case_37 of
                (ErlangTuple [(ErlangAtom "nomatch"), cont_41]) ->
                  let    arg_43 = toErl 0
                  in let
                    matchExpr_47 = erlps__take_tc__3 [cont_41, arg_43, seps_36]
                  in
                    case matchExpr_47 of
                      (ErlangTuple [head_45, tail_46]) ->
                        let    used_50 = erlps__cp_prefix__2 [cont0_1, cont_41]
                        ...
                        in
                          case case_51 of
                            (ErlangAtom "true") ->
                              let    lop_53 = BIF.erlang__byte_size__1 [bin_0]
                              in let
                                rop_55 = BIF.erlang__byte_size__1 [sepstart_33]
                              in let
                                keepsz_57 =
                                  BIF.erlang__op_minus [lop_53, rop_55]
                              in
      ...
      (ErlangCons gc_6 cs1_7) ->
        ...
        in
          case case_8 of
            (ErlangAtom "false") ->
              let    arg_12 = toErl 0
              in let matchExpr_16 = erlps__take_tc__3 [cs1_7, arg_12, seps_3]
              in
                case matchExpr_16 of
                  (ErlangTuple [head_14, tail_15]) ->
                    let case_17 = erlps__is_empty__1 [head_14]
            ...
            (ErlangAtom "true") ->
              let    arg_28 = toErl 0
              in let matchExpr_32 = erlps__take_tc__3 [cs1_7, arg_28, seps_3]
              in
                case matchExpr_32 of
                  (ErlangTuple [head_30, tail_31]) ->
                    let tup_el_33 = erlps__append__2 [gc_6, head_30]
...
erlps__prefix_1__2 [(ErlangCons cp_0 cs_1),
  ...
  in
    case case_4 of
      ...
      something_else -> EXC.case_clause something_else
erlps__prefix_1__2 [(ErlangBinary binSeg_0),
                    (ErlangCons pre_7 prer_8)]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
  , (BIN.Ok cs_6 bin_5) <- (BIN.chopBin bin_2 size_4 8)
  , BIN.empty bin_5 =
...
erlps__prefix_1__2 args =
  EXC.badarity (ErlangFun 2 erlps__prefix_1__2) args
      ...
      (ErlangAtom "true") ->
        ...
        in
          case case_11 of
            (ErlangAtom "nomatch") ->
              let    arg_16 = toErl 0
              in let arg_18 = erlps__append__2 [c_3, curr_6]
              in
                erlps__split_1__6
                  [cs_1, needle_4, arg_16, where_5, arg_18, acc_7]
            ...
            rest_28 | (==) where_5 (ErlangAtom "trailing") ->
              let    arg_31 = toErl 0
              in let head_37 = erlps__rev__1 [curr_6]
              in
                erlps__split_1__6
                  [cs_1, needle_4, arg_31, where_5, ErlangCons c_3 curr_6,
                   ErlangCons head_37 (ErlangCons rest_28 ErlangEmptyList)]
            rest_42 | (==) where_5 (ErlangAtom "all") ->
              let    arg_45 = toErl 0
              in let head_49 = erlps__rev__1 [curr_6]
              in
                erlps__split_1__6
                  [rest_42, needle_4, arg_45, where_5, ErlangEmptyList,
                   ErlangCons head_49 acc_7]
            something_else -> EXC.case_clause something_else
      (ErlangAtom "false") ->
        let    arg_54 = toErl 0
        in let arg_56 = erlps__append__2 [cp1_0, curr_6]
        in
          erlps__split_1__6
            [cs_1, needle_4, arg_54, where_5, arg_56, acc_7]
      something_else -> EXC.case_clause something_else
  ...
  in
    case case_7 of
      (ErlangTuple [(ErlangAtom "nomatch"), sz_12, cont_13]) ->
        case bin_0 of
          (ErlangBinary binSeg_14) | (ErlangInt size_15) <- (sz_12)
                                   , (BIN.Ok keep_17 bin_16) <-
                                       (BIN.chopBin binSeg_14 size_15 8) ->
            let arg_21 = toErl 0
            in
              erlps__split_1__6
                [cont_13, needle_2, arg_21, where_4, ErlangCons keep_17 curr0_5,
                 acc_6]
          _ -> EXC.badmatch bin_0
      (ErlangTuple [before_27, (ErlangCons cs0_28 cont_29),
                    after_30]) ->
        let curr_33 = erlps__add_non_empty__2 [before_27, curr0_5]
        in
          case where_4 of
            (ErlangAtom "leading") ->
              let head_35 = erlps__rev__1 [curr_33]
              in ErlangCons head_35 (ErlangCons after_30 ErlangEmptyList)
            (ErlangAtom "trailing") ->
              case cs0_28 of
                (ErlangBinary binSeg_40) | (ErlangInt size_41) <- (toErl 8)
                                         , (BIN.Ok _ bin_42) <-
                                             (BIN.chopInt binSeg_40 size_41 1
                                                BIN.Big BIN.Unsigned)
                                         , (ErlangInt size_43) <-
                                             (BIN.size bin_42)
                                         , (BIN.Ok cs_45 bin_44) <-
                                             (BIN.chopBin bin_42 size_43 8)
                                         , BIN.empty bin_44 ->
                  let    lop_47 = BIF.erlang__byte_size__1 [bin_0]
                  in let rop_49 = BIF.erlang__byte_size__1 [cs_45]
                  in let next_51 = BIF.erlang__op_minus [lop_47, rop_49]
                  in let head_60 = erlps__rev__1 [curr_33]
                  in
                    erlps__split_1__6
                      [ErlangCons bin_0 cont_29, needle_2, next_51, where_4,
                       curr0_5,
                       ErlangCons head_60 (ErlangCons after_30 ErlangEmptyList)]
                _ -> EXC.badmatch cs0_28
            (ErlangAtom "all") ->
              let    arg_67 = toErl 0
              in let head_71 = erlps__rev__1 [curr_33]
              in
                erlps__split_1__6
                  [after_30, needle_2, arg_67, where_4, ErlangEmptyList,
                   ErlangCons head_71 acc_6]
            something_else -> EXC.case_clause something_else
      something_else -> EXC.case_clause something_else
      ...
      (ErlangCons c_8 cs_9) | c_8 == c_1 ->
        ...
        in
          case case_10 of
            (ErlangAtom "nomatch") ->
              let    arg_15 = toErl 0
              in let arg_17 = erlps__append__2 [c_1, curr_4]
              in
                erlps__split_1__6
                  [cs_9, needle_2, arg_15, where_3, arg_17, acc_5]
            ...
            rest_27 | (==) where_3 (ErlangAtom "trailing") ->
              let    arg_30 = toErl 0
              in let head_36 = erlps__rev__1 [curr_4]
              in
                erlps__split_1__6
                  [cs_9, needle_2, arg_30, where_3, ErlangCons c_1 curr_4,
                   ErlangCons head_36 (ErlangCons rest_27 ErlangEmptyList)]
            rest_41 | (==) where_3 (ErlangAtom "all") ->
              let    arg_44 = toErl 0
              in let head_48 = erlps__rev__1 [curr_4]
              in
                erlps__split_1__6
                  [rest_41, needle_2, arg_44, where_3, ErlangEmptyList,
                   ErlangCons head_48 acc_5]
            something_else -> EXC.case_clause something_else
      (ErlangCons other_51 cs_52) ->
        let    arg_55 = toErl 0
        in let arg_57 = erlps__append__2 [other_51, curr_4]
        in
          erlps__split_1__6
            [cs_52, needle_2, arg_55, where_3, arg_57, acc_5]
      (ErlangEmptyList) ->
  ...
  in
    case case_7 of
      (ErlangTuple [(ErlangAtom "nomatch"), _, _]) ->
        case bin_0 of
          (ErlangBinary binSeg_12) | (ErlangInt size_13) <- (start_3)
                                   , (BIN.Ok _ bin_14) <-
                                       (BIN.chopBin binSeg_12 size_13 8)
                                   , (ErlangInt size_15) <- (BIN.size bin_14)
                                   , (BIN.Ok keep_17 bin_16) <-
                                       (BIN.chopBin bin_14 size_15 8)
                                   , BIN.empty bin_16 ->
      ...
      (ErlangTuple [before_24, (ErlangCons cs0_25 (ErlangEmptyList)),
        ...
        case where_4 of
          ...
          (ErlangAtom "trailing") ->
            case cs0_25 of
              (ErlangBinary binSeg_35) | (ErlangInt size_36) <- (toErl 8)
                                       , (BIN.Ok _ bin_37) <-
                                           (BIN.chopInt binSeg_35 size_36 1
                                              BIN.Big BIN.Unsigned)
                                       , (ErlangInt size_38) <-
                                           (BIN.size bin_37)
                                       , (BIN.Ok cs_40 bin_39) <-
                                           (BIN.chopBin bin_37 size_38 8)
                                       , BIN.empty bin_39 ->
                ...
                in
                  erlps__split_1__6
                    [bin_0, needle_2, next_46, where_4, curr0_5,
                     ErlangCons head_53 (ErlangCons after_26 ErlangEmptyList)]
          ...
          (ErlangAtom "all") ->
            ...
            in
              case before_24 of
                (ErlangBinary binSeg_64) | (ErlangInt size_65) <- (start_3)
                                         , (BIN.Ok _ bin_66) <-
                                             (BIN.chopBin binSeg_64 size_65 8)
                                         , (ErlangInt size_67) <-
                                             (BIN.size bin_66)
                                         , (BIN.Ok keep_69 bin_68) <-
                                             (BIN.chopBin bin_66 size_67 8)
                                         , BIN.empty bin_68 ->
...
erlps__split_1__6 args =
  EXC.badarity (ErlangFun 6 erlps__split_1__6) args
              ...
              in
                case case_13 of
                  ...
                  (ErlangAtom "false") ->
                    ...
                    in let
                      matchExpr_26 =
                        erlps__lexeme_pick__3 [cs0_1, seps_20, ErlangEmptyList]
                    in
        ...
        in
          case matchExpr_39 of
            (ErlangTuple [lexeme_37, rest_38]) ->
              erlps__lexemes_m__3 [rest_38, seps_33, ErlangCons lexeme_37 ts_5]
        ...
        in
          case matchExpr_21 of
            (ErlangTuple [lexeme_19, rest_20]) ->
              erlps__lexemes_m__3 [rest_20, seps_15, ErlangCons lexeme_19 ts_4]
            _ -> EXC.badmatch matchExpr_21
...
erlps__lexeme_pick__3 [(ErlangCons bin_0 cont0_1), seps_2, tkn_3]
  ...
  in
    case case_4 of
      (ErlangTuple [(ErlangAtom "nomatch"), _]) ->
        erlps__lexeme_pick__3 [cont0_1, seps_2, ErlangCons bin_0 tkn_3]
      cs_15@(ErlangCons left_13 _cont_14) ->
        ...
        in
          case bin_0 of
            (ErlangBinary binSeg_21) | (ErlangInt size_22) <- (bytes_20)
                                     , (BIN.Ok lexeme_24 bin_23) <-
                                         (BIN.chopBin binSeg_21 size_22 8) ->
              let tup_el_26 = erlps__btoken__2 [lexeme_24, tkn_3]
              in ErlangTuple [tup_el_26, cs_15]
            _ -> EXC.badmatch bin_0
      something_else -> EXC.case_clause something_else
  ...
  in
    case case_3 of
      ...
      (ErlangCons left_11 (ErlangEmptyList)) ->
        ...
        in
          case bin_0 of
            (ErlangBinary binSeg_17) | (ErlangInt size_18) <- (bytes_16)
                                     , (BIN.Ok lexeme_20 bin_19) <-
                                         (BIN.chopBin binSeg_17 size_18 8) ->
              let tup_el_22 = erlps__btoken__2 [lexeme_20, tkn_2]
...
erlps__nth_lexeme_m__3 [(ErlangCons bin_0 cont0_1),
  ...
  in
    case case_5 of
      ...
      cs_13 | weakGt n_4 (toErl 1) ->
        let    rest_16 = erlps__lexeme_skip__2 [cs_13, seps0_3]
        in let rop_21 = toErl 1
        in let arg_19 = BIF.erlang__op_minus [n_4, rop_21]
      ...
      (ErlangCons c_6 cs_7) ->
        ...
        in
          case case_8 of
            ...
            (ErlangAtom "false") | weakGt n_3 (toErl 1) ->
              let    cs1_16 = erlps__lexeme_skip__2 [cs_7, seps0_2]
              in let rop_21 = toErl 1
              in let arg_19 = BIF.erlang__op_minus [n_3, rop_21]
...
erlps__nth_lexeme_m__3 [bin_0,
  ...
  in
    case case_6 of
      (ErlangCons cs_10 (ErlangEmptyList)) | weakGt n_3 (toErl 1) ->
        let    cs1_13 = erlps__lexeme_skip__2 [cs_10, seps_5]
        in let rop_18 = toErl 1
        in let arg_16 = BIF.erlang__op_minus [n_3, rop_18]
...
erlps__find_l__2 [(ErlangCons bin_0 cont0_1), needle_2]
  ...
  in let
    case_3 =
      erlps__bin_search_str__4 [bin_0, arg_5, cont0_1, needle_2]
  in
    case case_3 of
...
erlps__find_l__2 [bin_0, needle_1] =
  ...
  in let
    case_2 =
      erlps__bin_search_str__4
        [bin_0, arg_4, ErlangEmptyList, needle_1]
  in
    case case_2 of
      (ErlangTuple [(ErlangAtom "nomatch"), _, _]) ->
        ErlangAtom "nomatch"
...
erlps__find_l__2 args =
  EXC.badarity (ErlangFun 2 erlps__find_l__2) args
...
erlps__find_r__3 [(ErlangCons bin_0 cont0_1), needle_2, res_3]
  ...
  in let
    case_4 =
      erlps__bin_search_str__4 [bin_0, arg_6, cont0_1, needle_2]
  in
    case case_4 of
...
erlps__find_r__3 [bin_0, needle_1, res_2] =
  ...
  in let
    case_3 =
      erlps__bin_search_str__4
        [bin_0, arg_5, ErlangEmptyList, needle_1]
  in
    case case_3 of
...
erlps__find_r__3 args =
  EXC.badarity (ErlangFun 3 erlps__find_r__3) args
...
erlps__btoken__2 [binpart_0, (ErlangCons c_1 (ErlangEmptyList))]
  ...
  ErlangBinary
    (BIN.concat
       [BIN.fromInt c_1 (toErl 8) 1 BIN.Big,
        BIN.binPrefix binpart_0 (BIN.packedSize binpart_0) 8])
erlps__btoken__2 [(ErlangBinary binEnd_0), tkn_1]
  | BIN.empty binEnd_0 =
...
erlps__btoken__2 args =
  EXC.badarity (ErlangFun 2 erlps__btoken__2) args
...
erlps__rev__1 args =
  EXC.badarity (ErlangFun 1 erlps__rev__1) args

erlps__append__2 :: ErlangFun
erlps__append__2 [char_0, (ErlangBinary binEnd_1)]
  | BIN.empty binEnd_1
  , isEInt char_0 =
...
erlps__stack__2 [(ErlangBinary binEnd_0), st_1]
  | BIN.empty binEnd_0 =
  st_1
...
erlps__stack__2 args =
  EXC.badarity (ErlangFun 2 erlps__stack__2) args

erlps__add_non_empty__2 :: ErlangFun
erlps__add_non_empty__2 [(ErlangBinary binEnd_0), l_1]
  | BIN.empty binEnd_0 =
  l_1
erlps__add_non_empty__2 [token_0, l_1] = ErlangCons token_0 l_1
erlps__add_non_empty__2 [arg_4, arg_5] = EXC.function_clause unit
erlps__add_non_empty__2 args =
  EXC.badarity (ErlangFun 2 erlps__add_non_empty__2) args
...
erlps__cp_prefix__2 args =
  EXC.badarity (ErlangFun 2 erlps__cp_prefix__2) args
...
erlps__cp_prefix_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__cp_prefix_1__3) args
...
erlps__bin_search__3 [bin_0, cont_1,
  ...
  =
  let arg_5 = toErl 0
  in erlps__bin_search_loop__5 [bin_0, arg_5, bp_3, cont_1, seps_2]
erlps__bin_search__3 [arg_9, arg_10, arg_11] =
  EXC.function_clause unit
erlps__bin_search__3 args =
  EXC.badarity (ErlangFun 3 erlps__bin_search__3) args
...
erlps__search_pattern__1 args =
  EXC.badarity (ErlangFun 1 erlps__search_pattern__1) args
...
erlps__search_compile__1 args =
  EXC.badarity (ErlangFun 1 erlps__search_compile__1) args
...
erlps__search_cp__1 [(ErlangCons pattern_0 seps_1)] =
  let
    matchExpr_4 =
      BIF.do_remote_fun_call "Unicode.Util" "erlps__cp__1" [pattern_0]
  in
    case matchExpr_4 of
      (ErlangCons cp_3 _) ->
...
erlps__search_cp__1 args =
  EXC.badarity (ErlangFun 1 erlps__search_cp__1) args

erlps__bin_pattern__1 :: ErlangFun
erlps__bin_pattern__1 [(ErlangCons cp_0 seps_1)] =
  let   
    head_2 = ErlangBinary (BIN.fromInt cp_0 (toErl 8) 1 BIN.Big)
...
erlps__bin_pattern__1 args =
  EXC.badarity (ErlangFun 1 erlps__bin_pattern__1) args
...
erlps__bin_search_loop__5 [bin0_0, start_1, binseps_2, cont_3,
  ...
  =
  case bin0_0 of
    (ErlangBinary binSeg_5) | (ErlangInt size_6) <- (start_1)
                            , (BIN.Ok _ bin_7) <-
                                (BIN.chopBin binSeg_5 size_6 8)
                            , (ErlangInt size_8) <- (BIN.size bin_7)
                            , (BIN.Ok bin_10 bin_9) <-
      ...
      in
        case case_12 of
          ...
          (ErlangTuple [where_17, _cl_18]) | (==) cont_3 ErlangEmptyList ->
            case bin_10 of
              (ErlangBinary binSeg_19) | (ErlangInt size_20) <- (where_17)
                                       , (BIN.Ok _ bin_21) <-
                                           (BIN.chopBin binSeg_19 size_20 8)
                                       , (ErlangInt size_22) <-
                                           (BIN.size bin_21)
                                       , (BIN.Ok cont1_24 bin_23) <-
                                           (BIN.chopBin bin_21 size_22 8)
                                       , BIN.empty bin_23 ->
                let
                  matchExpr_29 =
                    BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1"
                      ...
                      in
                        case case_30 of
                          ...
                          (ErlangAtom "false") ->
                            ...
                            in let rop_37 = BIF.erlang__byte_size__1 [cont2_28]
                            in let
          ...
          (ErlangTuple [where_47, _cl_48]) ->
            case bin_10 of
              (ErlangBinary binSeg_49) | (ErlangInt size_50) <- (where_47)
                                       , (BIN.Ok _ bin_51) <-
                                           (BIN.chopBin binSeg_49 size_50 8)
                                       , (ErlangInt size_52) <-
                                           (BIN.size bin_51)
                                       , (BIN.Ok cont0_54 bin_53) <-
                                           (BIN.chopBin bin_51 size_52 8)
                                       , BIN.empty bin_53 ->
                let
                  matchExpr_62 =
                    BIF.do_remote_fun_call "Unicode.Util" "erlps__gc__1"
...
erlps__bin_search_loop__5 args =
  EXC.badarity (ErlangFun 5 erlps__bin_search_loop__5) args

erlps__bin_search_inv__3 :: ErlangFun
erlps__bin_search_inv__3 [(ErlangBinary binEnd_0), cont_1, _]
  | BIN.empty binEnd_0 =
...
erlps__bin_search_inv__3 args =
  EXC.badarity (ErlangFun 3 erlps__bin_search_inv__3) args

erlps__bin_search_inv_1__3 :: ErlangFun
erlps__bin_search_inv_1__3 [bin0_7@(ErlangBinary binSeg_0),
                            cont_8, sep_9]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp1_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_4) <- (BIN.size bin_2)
  , (BIN.Ok binrest_6 bin_5) <- (BIN.chopBin bin_2 size_4 8)
  , BIN.empty bin_5 =
  case binrest_6 of
    (ErlangBinary binSeg_11) | (ErlangInt size_12) <- (toErl 8)
                             , (BIN.Ok cp2_14 bin_13) <-
                                 (BIN.chopInt binSeg_11 size_12 1 BIN.Big
                                    BIN.Unsigned)
                             , ((weakLt cp1_3 (toErl 256)) &&
                                  (weakLt cp2_14 (toErl 256))) &&
                                 ((/=) cp1_3 (toErl 13)) ->
      case cp1_3 of
        sep_16 | sep_16 == sep_9 ->
    ...
    _ | (==) cont_8 ErlangEmptyList ->
      ...
      in
        case case_22 of
          (ErlangCons sep_24 bin_25) | sep_24 == sep_9 ->
            erlps__bin_search_inv_1__3 [bin_25, cont_8, sep_9]
          _ -> ErlangCons bin0_7 cont_8
    _ ->
      let
        case_31 =
...
erlps__bin_search_inv_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__bin_search_inv_1__3) args

erlps__bin_search_inv_n__3 :: ErlangFun
erlps__bin_search_inv_n__3 [bin0_7@(ErlangBinary binSeg_0),
                            cont_8, seps_9]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok cp1_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  ...
  case binrest_6 of
    (ErlangBinary binSeg_11) | (ErlangInt size_12) <- (toErl 8)
                             ...
                             , ((weakLt cp1_3 (toErl 256)) &&
                                  (weakLt cp2_14 (toErl 256))) &&
                                 ((/=) cp1_3 (toErl 13)) ->
      let case_15 = BIF.lists__member__2 [cp1_3, seps_9]
      in
        case case_15 of
          (ErlangAtom "true") ->
    ...
    _ | (==) cont_8 ErlangEmptyList ->
      ...
      in
        case matchExpr_26 of
          (ErlangCons gc_24 bin_25) ->
            let case_27 = BIF.lists__member__2 [gc_24, seps_9]
            in
              case case_27 of
                (ErlangAtom "true") ->
                  erlps__bin_search_inv_n__3 [bin_25, cont_8, seps_9]
                (ErlangAtom "false") -> ErlangCons bin0_7 cont_8
                something_else -> EXC.case_clause something_else
          _ -> EXC.badmatch matchExpr_26
    _ ->
      ...
      in
        case matchExpr_40 of
          (ErlangCons gc_38 cs0_39) ->
            let case_41 = BIF.lists__member__2 [gc_38, seps_9]
            in
              case case_41 of
                (ErlangAtom "false") -> ErlangCons bin0_7 cont_8
                (ErlangAtom "true") ->
...
erlps__bin_search_inv_n__3 [(ErlangBinary binEnd_0), cont_1,
                            _sep_2]
  | BIN.empty binEnd_0 =
  ErlangTuple [ErlangAtom "nomatch", cont_1]
...
erlps__bin_search_inv_n__3 args =
  EXC.badarity (ErlangFun 3 erlps__bin_search_inv_n__3) args
...
erlps__bin_search_str__4 [bin0_0, start_1, cont_2,
  ...
  =
  let   
    arg_5 = ErlangBinary (BIN.fromInt cp_3 (toErl 8) 1 BIN.Big)
...
erlps__bin_search_str__4 args =
  EXC.badarity (ErlangFun 4 erlps__bin_search_str__4) args
...
erlps__bin_search_str_1__4 [bin0_0, start_1, first_2,
  ...
  =
  case bin0_0 of
    (ErlangBinary binSeg_4) | (ErlangInt size_5) <- (start_1)
                            , (BIN.Ok _ bin_6) <-
                                (BIN.chopBin binSeg_4 size_5 8)
                            , (ErlangInt size_7) <- (BIN.size bin_6)
                            , (BIN.Ok bin_9 bin_8) <-
      ...
      in
        case case_11 of
          ...
          (ErlangTuple [where0_18, _]) ->
            ...
            in
              case bin0_0 of
                (ErlangBinary binSeg_22) | (ErlangInt size_23) <- (where_21)
                                         , (BIN.Ok keep_25 bin_24) <-
                                             (BIN.chopBin binSeg_22 size_23 8)
                                         , (ErlangInt size_26) <-
                                             (BIN.size bin_24)
                                         , (BIN.Ok cs0_28 bin_27) <-
                                             (BIN.chopBin bin_24 size_26 8)
                                         , BIN.empty bin_27 ->
                  ...
                  in
                    case case_30 of
                      (ErlangAtom "nomatch") ->
                        case cs0_28 of
                          (ErlangBinary binSeg_33) | (ErlangInt size_34) <-
                                                       (toErl 8)
                                                   , (BIN.Ok _ bin_35) <-
                                                       (BIN.chopInt binSeg_33
                                                          size_34 1 BIN.Big
                                                          BIN.Unsigned)
                                                   , (ErlangInt size_36) <-
                                                       (BIN.size bin_35)
                            ...
                            in let
                              keepsz_44 = BIF.erlang__op_minus [lop_40, rop_42]
                            in
                              erlps__bin_search_str_1__4
                      ...
                      rest_54 ->
                        ErlangTuple
                          [keep_25, ErlangCons cs0_28 ErlangEmptyList, rest_54]
                _ -> EXC.badmatch bin0_0
          something_else -> EXC.case_clause something_else
    _ -> EXC.badmatch bin0_0
...
erlps__bin_search_str_1__4 args =
  EXC.badarity (ErlangFun 4 erlps__bin_search_str_1__4) args
      ...
      in
        case case_12 of
          ...
          (ErlangTuple [where0_19, _]) ->
            ...
            in
              case bin0_0 of
                (ErlangBinary binSeg_23) | (ErlangInt size_24) <- (where_22)
                                         , (BIN.Ok keep_26 bin_25) <-
                                             (BIN.chopBin binSeg_23 size_24 8)
                                         , (ErlangInt size_27) <-
                                             (BIN.size bin_25)
...
erlps__concat__2 args =
  EXC.badarity (ErlangFun 2 erlps__concat__2) args

erlps__chr__2 :: ErlangFun
erlps__chr__2 [s_0, c_1] | isEInt c_1 =
  let arg_4 = toErl 1
  in erlps__chr__3 [s_0, c_1, arg_4]
erlps__chr__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__chr__2 args =
  EXC.badarity (ErlangFun 2 erlps__chr__2) args
...
erlps__rchr__4 [arg_3, arg_4, arg_5, arg_6] =
  EXC.function_clause unit
erlps__rchr__4 args =
  EXC.badarity (ErlangFun 4 erlps__rchr__4) args

erlps__str__2 :: ErlangFun
erlps__str__2 [s_0, sub_1] | isEList sub_1 =
  let arg_4 = toErl 1
  in erlps__str__3 [s_0, sub_1, arg_4]
erlps__str__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__str__2 args =
  EXC.badarity (ErlangFun 2 erlps__str__2) args
...
erlps__str__3 [(ErlangCons c_0 s_1), (ErlangCons c_2 sub_3), i_4]
  ...
  in
    case case_5 of
      ...
      (ErlangAtom "false") ->
        let    rop_14 = toErl 1
        in let arg_12 = BIF.erlang__op_plus [i_4, rop_14]
...
erlps__str__3 [(ErlangEmptyList), _sub_0, _i_1] = toErl 0
erlps__str__3 [arg_2, arg_3, arg_4] = EXC.function_clause unit
erlps__str__3 args =
  EXC.badarity (ErlangFun 3 erlps__str__3) args

erlps__rstr__2 :: ErlangFun
erlps__rstr__2 [s_0, sub_1] | isEList sub_1 =
  let    arg_4 = toErl 1
  in let arg_5 = toErl 0
  in erlps__rstr__4 [s_0, sub_1, arg_4, arg_5]
erlps__rstr__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__rstr__2 args =
  EXC.badarity (ErlangFun 2 erlps__rstr__2) args
...
erlps__rstr__4 [(ErlangCons c_0 s_1), (ErlangCons c_2 sub_3),
  ...
  in
    case case_6 of
      (ErlangAtom "true") ->
        let    rop_15 = toErl 1
        in let arg_13 = BIF.erlang__op_plus [i_4, rop_15]
        in erlps__rstr__4 [s_1, ErlangCons c_0 sub_3, arg_13, i_4]
      (ErlangAtom "false") ->
        let    rop_23 = toErl 1
        in let arg_21 = BIF.erlang__op_plus [i_4, rop_23]
...
erlps__rstr__4 [arg_3, arg_4, arg_5, arg_6] =
  EXC.function_clause unit
erlps__rstr__4 args =
  EXC.badarity (ErlangFun 4 erlps__rstr__4) args
...
erlps__l_prefix__2 args =
  EXC.badarity (ErlangFun 2 erlps__l_prefix__2) args

erlps__span__2 :: ErlangFun
erlps__span__2 [s_0, cs_1] | isEList cs_1 =
  let arg_4 = toErl 0
  in erlps__span__3 [s_0, cs_1, arg_4]
erlps__span__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__span__2 args =
  EXC.badarity (ErlangFun 2 erlps__span__2) args
...
erlps__span__3 [(ErlangCons c_0 s_1), cs_2, i_3] =
  ...
  in
    case case_4 of
      (ErlangAtom "true") ->
        let    rop_11 = toErl 1
        in let arg_9 = BIF.erlang__op_plus [i_3, rop_11]
...
erlps__cspan__3 [arg_2, arg_3, arg_4] = EXC.function_clause unit
erlps__cspan__3 args =
  EXC.badarity (ErlangFun 3 erlps__cspan__3) args
...
erlps__substr1__2 args =
  EXC.badarity (ErlangFun 2 erlps__substr1__2) args
...
erlps__tokens__2 [s_0, seps_1] =
  case seps_1 of
    ...
    (ErlangCons c_6 (ErlangEmptyList)) ->
      let
        arg_7 = BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [s_0]
      in erlps__tokens_single_1__3 [arg_7, c_6, ErlangEmptyList]
    (ErlangCons _ _) ->
      let
        arg_11 = BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [s_0]
      in erlps__tokens_multiple_1__3 [arg_11, seps_1, ErlangEmptyList]
    something_else -> EXC.case_clause something_else
erlps__tokens__2 [arg_15, arg_16] = EXC.function_clause unit
erlps__tokens__2 args =
  EXC.badarity (ErlangFun 2 erlps__tokens__2) args
...
erlps__tokens_single_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__tokens_single_1__3) args

erlps__tokens_single_2__4 :: ErlangFun
erlps__tokens_single_2__4 [(ErlangCons sep_0 s_1), sep_2, toks_3,
                           tok_4]
  | sep_2 == sep_0 =
  erlps__tokens_single_1__3 [s_1, sep_0, ErlangCons tok_4 toks_3]
...
erlps__tokens_single_2__4 args =
  EXC.badarity (ErlangFun 4 erlps__tokens_single_2__4) args
...
erlps__tokens_multiple_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__tokens_multiple_1__3) args
...
erlps__tokens_multiple_2__4 args =
  EXC.badarity (ErlangFun 4 erlps__tokens_multiple_2__4) args
...
erlps__chars__3 [c_0, n_1, tail_2] | weakGt n_1 (toErl 0) =
  let    rop_6 = toErl 1
  in let arg_4 = BIF.erlang__op_minus [n_1, rop_6]
  in erlps__chars__3 [c_0, arg_4, ErlangCons c_0 tail_2]
erlps__chars__3 [c_0, (ErlangInt num_1), tail_2]
  | (ErlangInt num_1) == (toErl 0)
  , isEInt c_0 =
  tail_2
erlps__chars__3 [arg_3, arg_4, arg_5] = EXC.function_clause unit
erlps__chars__3 args =
  EXC.badarity (ErlangFun 3 erlps__chars__3) args

erlps__copies__2 :: ErlangFun
erlps__copies__2 [charlist_0, num_1]
  | ((isEList charlist_0) && (isEInt num_1)) &&
      (weakGeq num_1 (toErl 0)) =
...
erlps__copies__2 args =
  EXC.badarity (ErlangFun 2 erlps__copies__2) args
...
erlps__copies__3 [charlist_0, num_1, r_2] =
  let    rop_6 = toErl 1
  in let arg_4 = BIF.erlang__op_minus [num_1, rop_6]
...
erlps__copies__3 args =
  EXC.badarity (ErlangFun 3 erlps__copies__3) args

erlps__words__1 :: ErlangFun
erlps__words__1 [string_0] =
  let arg_2 = toErl 32
  in erlps__words__2 [string_0, arg_2]
erlps__words__1 [arg_3] = EXC.function_clause unit
erlps__words__1 args =
  EXC.badarity (ErlangFun 1 erlps__words__1) args
  ...
  in
    case case_3 of
      ...
      _num_7 ->
        ...
        in
          erlps__s_word__5
            [arg_8, index_1, char_2, arg_14, ErlangEmptyList]
erlps__sub_word__3 [arg_16, arg_17, arg_18] =
  EXC.function_clause unit
erlps__sub_word__3 args =
  EXC.badarity (ErlangFun 3 erlps__sub_word__3) args
...
erlps__s_word__5 [(ErlangCons char_0 t_1), stop_2, char_3,
  ...
  in let arg_12 = BIF.erlang__op_plus [index_4, rop_14]
...
erlps__s_word__5 args =
  EXC.badarity (ErlangFun 5 erlps__s_word__5) args
...
erlps__strip__1 args =
  EXC.badarity (ErlangFun 1 erlps__strip__1) args

erlps__strip__2 :: ErlangFun
erlps__strip__2 [string_0, (ErlangAtom "left")] =
  let arg_2 = toErl 32
  in erlps__strip_left__2 [string_0, arg_2]
erlps__strip__2 [string_0, (ErlangAtom "right")] =
  let arg_2 = toErl 32
  in erlps__strip_right__2 [string_0, arg_2]
erlps__strip__2 [string_0, (ErlangAtom "both")] =
  let    arg_3 = toErl 32
  in let arg_1 = erlps__strip_left__2 [string_0, arg_3]
  in let arg_4 = toErl 32
  in erlps__strip_right__2 [arg_1, arg_4]
erlps__strip__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__strip__2 args =
  EXC.badarity (ErlangFun 2 erlps__strip__2) args
...
erlps__strip__3 [arg_6, arg_7, arg_8] = EXC.function_clause unit
erlps__strip__3 args =
  EXC.badarity (ErlangFun 3 erlps__strip__3) args

erlps__strip_left__2 :: ErlangFun
erlps__strip_left__2 [(ErlangCons sc_0 s_1), sc_2]
  | sc_2 == sc_0 =
  erlps__strip_left__2 [s_1, sc_0]
erlps__strip_left__2 [s_0@(ErlangCons _ _), sc_1] | isEInt sc_1 =
  s_0
...
erlps__strip_left__2 args =
  EXC.badarity (ErlangFun 2 erlps__strip_left__2) args
...
erlps__strip_right__2 args =
  EXC.badarity (ErlangFun 2 erlps__strip_right__2) args

erlps__left__2 :: ErlangFun
erlps__left__2 [string_0, len_1] | isEInt len_1 =
  let arg_4 = toErl 32
  in erlps__left__3 [string_0, len_1, arg_4]
...
erlps__left__3 [arg_13, arg_14, arg_15] =
  EXC.function_clause unit
erlps__left__3 args =
  EXC.badarity (ErlangFun 3 erlps__left__3) args
...
erlps__l_pad__3 [arg_7, arg_8, arg_9] = EXC.function_clause unit
erlps__l_pad__3 args =
  EXC.badarity (ErlangFun 3 erlps__l_pad__3) args

erlps__right__2 :: ErlangFun
erlps__right__2 [string_0, len_1] | isEInt len_1 =
  let arg_4 = toErl 32
  in erlps__right__3 [string_0, len_1, arg_4]
  ...
  in
    case ErlangAtom "true" of
      _ | weakGt slen_4 len_1 ->
        ...
        in let lop_7 = BIF.erlang__op_div_strict [lop_8, rop_11]
        in let rop_12 = toErl 1
        in let arg_6 = BIF.erlang__op_plus [lop_7, rop_12]
        in erlps__substr__3 [string_0, arg_6, len_1]
      _ | weakLt slen_4 len_1 ->
        let    lop_14 = BIF.erlang__op_minus [len_1, slen_4]
        in let rop_17 = toErl 2
        in let n_18 = BIF.erlang__op_div_strict [lop_14, rop_17]
...
erlps__centre__3 args =
  EXC.badarity (ErlangFun 3 erlps__centre__3) args
...
erlps__sub_string__2 args =
  EXC.badarity (ErlangFun 2 erlps__sub_string__2) args
...
erlps__sub_string__3 [string_0, start_1, stop_2] =
  ...
  in let arg_5 = BIF.erlang__op_plus [lop_6, rop_9]
  in erlps__substr__3 [string_0, start_1, arg_5]
erlps__sub_string__3 [arg_10, arg_11, arg_12] =
  EXC.function_clause unit
erlps__sub_string__3 args =
  EXC.badarity (ErlangFun 3 erlps__sub_string__3) args

erlps__to_lower_char__1 :: ErlangFun
erlps__to_lower_char__1 [c_0]
  | ((isEInt c_0) && (weakLeq (toErl 65) c_0)) &&
      (weakLeq c_0 (toErl 90)) =
  let rop_2 = toErl 32
  in BIF.erlang__op_plus [c_0, rop_2]
erlps__to_lower_char__1 [c_0]
  | ((isEInt c_0) && (weakLeq (toErl 192) c_0)) &&
      (weakLeq c_0 (toErl 214)) =
  let rop_2 = toErl 32
  in BIF.erlang__op_plus [c_0, rop_2]
erlps__to_lower_char__1 [c_0]
  | ((isEInt c_0) && (weakLeq (toErl 216) c_0)) &&
      (weakLeq c_0 (toErl 222)) =
  let rop_2 = toErl 32
  in BIF.erlang__op_plus [c_0, rop_2]
erlps__to_lower_char__1 [c_0] = c_0
erlps__to_lower_char__1 [arg_1] = EXC.function_clause unit
erlps__to_lower_char__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_lower_char__1) args

erlps__to_upper_char__1 :: ErlangFun
erlps__to_upper_char__1 [c_0]
  | ((isEInt c_0) && (weakLeq (toErl 97) c_0)) &&
      (weakLeq c_0 (toErl 122)) =
  let rop_2 = toErl 32
  in BIF.erlang__op_minus [c_0, rop_2]
erlps__to_upper_char__1 [c_0]
  | ((isEInt c_0) && (weakLeq (toErl 224) c_0)) &&
      (weakLeq c_0 (toErl 246)) =
  let rop_2 = toErl 32
  in BIF.erlang__op_minus [c_0, rop_2]
erlps__to_upper_char__1 [c_0]
  | ((isEInt c_0) && (weakLeq (toErl 248) c_0)) &&
      (weakLeq c_0 (toErl 254)) =
  let rop_2 = toErl 32
  in BIF.erlang__op_minus [c_0, rop_2]
erlps__to_upper_char__1 [c_0] = c_0
erlps__to_upper_char__1 [arg_1] = EXC.function_clause unit
erlps__to_upper_char__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_upper_char__1) args

erlps__to_lower__1 :: ErlangFun
erlps__to_lower__1 [s_0] | isEList s_0 =
  flmap
    (\ lc_3 ->
       let lcRet_4 = erlps__to_lower_char__1 [lc_3]
...
erlps__to_lower__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_lower__1) args

erlps__to_upper__1 :: ErlangFun
erlps__to_upper__1 [s_0] | isEList s_0 =
  flmap
    (\ lc_3 ->
       let lcRet_4 = erlps__to_upper_char__1 [lc_3]
       in ErlangCons lcRet_4 ErlangEmptyList)
    s_0
...
erlps__to_upper__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_upper__1) args
...
erlps__join__2 [(ErlangCons h_0 t_1), sep_2] =
  let   
    arg_5 =
      flmap
        (\ lc_8 ->
           let lcRet_9 = BIF.erlang__op_append [sep_2, lc_8]
           in ErlangCons lcRet_9 ErlangEmptyList)
        t_1
  in let
    rop_4 = BIF.do_remote_fun_call "Lists" "erlps__append__1" [arg_5]
