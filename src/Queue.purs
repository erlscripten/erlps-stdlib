...
erlps__r2f__1 [(ErlangCons x_0 (ErlangCons y_1 (ErlangEmptyList)))]
  =
  ErlangTuple
    [ErlangCons x_0 ErlangEmptyList, ErlangCons y_1 ErlangEmptyList]
erlps__r2f__1 [list_0] =
  let    lop_3 = BIF.erlang__length__1 [list_0]
  in let rop_5 = toErl 2
  in let lop_2 = BIF.erlang__op_div_strict [lop_3, rop_5]
  in let rop_6 = toErl 1
  in let arg_1 = BIF.erlang__op_plus [lop_2, rop_6]
  in let
    matchExpr_10 =
