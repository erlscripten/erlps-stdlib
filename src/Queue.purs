module Queue(erlps__new__0, erlps__is_queue__1,
             ...
             erlps__filtermap__2, erlps__fold__3, erlps__any__2,
             erlps__all__2, erlps__delete__2, erlps__delete_r__2,
             erlps__delete_with__2, erlps__delete_with_r__2, erlps__cons__2,
             erlps__head__1, erlps__tail__1, erlps__snoc__2, erlps__last__1,
             erlps__daeh__1, erlps__init__1, erlps__liat__1,
...
erlps__new__0 [] = ErlangTuple [ErlangEmptyList, ErlangEmptyList]
erlps__new__0 args =
...
erlps__is_queue__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_queue__1) args
...
erlps__in__2 args = EXC.badarity (ErlangFun 2 erlps__in__2) args
...
erlps__in_r__2 args =
  EXC.badarity (ErlangFun 2 erlps__in_r__2) args
...
erlps__out__1 [(ErlangTuple [(ErlangCons v_0 (ErlangEmptyList)),
  ...
  in let tup_el_4 = ErlangTuple [ErlangEmptyList, ErlangEmptyList]
  in ErlangTuple [tup_el_1, tup_el_4]
erlps__out__1 [(ErlangTuple [(ErlangCons y_0 in_1),
                             (ErlangEmptyList)])]
  =
  let matchExpr_6 = BIF.lists__reverse__2 [in_1, ErlangEmptyList]
  in
    case matchExpr_6 of
      (ErlangCons v_4 out_5) ->
        let    tup_el_7 = ErlangTuple [ErlangAtom "value", v_4]
        in let
          tup_el_10 = ErlangTuple [ErlangCons y_0 ErlangEmptyList, out_5]
...
erlps__out__1 args =
  EXC.badarity (ErlangFun 1 erlps__out__1) args
...
erlps__out_r__1 [(ErlangTuple [(ErlangEmptyList),
  ...
  =
  let matchExpr_6 = BIF.lists__reverse__2 [out_1, ErlangEmptyList]
  in
    case matchExpr_6 of
      (ErlangCons v_4 in_5) ->
        let    tup_el_7 = ErlangTuple [ErlangAtom "value", v_4]
        in let
          tup_el_10 = ErlangTuple [in_5, ErlangCons y_0 ErlangEmptyList]
        in ErlangTuple [tup_el_7, tup_el_10]
      _ -> EXC.badmatch matchExpr_6
...
erlps__out_r__1 args =
  EXC.badarity (ErlangFun 1 erlps__out_r__1) args
...
erlps__get__1 args =
  EXC.badarity (ErlangFun 1 erlps__get__1) args
...
erlps__get_r__1 args =
  EXC.badarity (ErlangFun 1 erlps__get_r__1) args
...
erlps__peek__1 [(ErlangTuple [(ErlangCons _ r_0),
  ...
  =
  let
    tup_el_2 = BIF.do_remote_fun_call "Lists" "erlps__last__1" [r_0]
...
erlps__peek__1 args =
  EXC.badarity (ErlangFun 1 erlps__peek__1) args
...
erlps__peek_r__1 args =
  EXC.badarity (ErlangFun 1 erlps__peek_r__1) args
...
erlps__drop__1 [(ErlangTuple [(ErlangCons y_0 r_1),
                              (ErlangEmptyList)])]
  =
  let matchExpr_5 = BIF.lists__reverse__2 [r_1, ErlangEmptyList]
  in
    case matchExpr_5 of
      (ErlangCons _ f_4) ->
...
erlps__drop__1 args =
  EXC.badarity (ErlangFun 1 erlps__drop__1) args
...
erlps__drop_r__1 [(ErlangTuple [(ErlangEmptyList),
                                (ErlangCons y_0 f_1)])]
  =
  let matchExpr_5 = BIF.lists__reverse__2 [f_1, ErlangEmptyList]
  in
    case matchExpr_5 of
      (ErlangCons _ r_4) ->
...
erlps__drop_r__1 args =
  EXC.badarity (ErlangFun 1 erlps__drop_r__1) args
...
erlps__split__2 [n_0, q_3@(ErlangTuple [r_1, f_2])]
  | (((isEInt n_0) && (weakGeq n_0 (toErl 1))) && (isEList r_1)) &&
      (isEList f_2) =
  ...
  in
    case ErlangAtom "true" of
      ...
      _ | weakGt n_0 lf_5 ->
        ...
        in
          case ErlangAtom "true" of
            _ | weakLt m_24 (toErl 0) ->
              BIF.erlang__error__2
                [ErlangAtom "badarg",
                 ErlangCons n_0 (ErlangCons q_3 ErlangEmptyList)]
            _ | weakGt m_24 (toErl 0) ->
              case r_1 of
                (ErlangCons x_31 r1_32) ->
                  let    rop_36 = toErl 1
                  in let arg_34 = BIF.erlang__op_minus [m_24, rop_36]
                  in
...
erlps__split_f1_to_r2__5 args =
  EXC.badarity (ErlangFun 5 erlps__split_f1_to_r2__5) args
...
erlps__split_r1_to_f2__5 args =
  EXC.badarity (ErlangFun 5 erlps__split_r1_to_f2__5) args

erlps__filter__2 :: ErlangFun
erlps__filter__2 [fun_0, (ErlangTuple [r0_1, f0_2])]
  | ((isEFunA fun_0 (toErl 1)) && (isEList r0_1)) &&
      (isEList f0_2) =
...
erlps__filter_f__2 [fun_0, (ErlangCons x_1 f_2)] =
  ...
  in
    case case_3 of
      ...
      (ErlangCons y_10 (ErlangEmptyList)) ->
        let tail_12 = erlps__filter_f__2 [fun_0, f_2]
        in ErlangCons y_10 tail_12
      (ErlangAtom "false") -> erlps__filter_f__2 [fun_0, f_2]
      (ErlangEmptyList) -> erlps__filter_f__2 [fun_0, f_2]
      l_19 | isEList l_19 ->
        let rop_21 = erlps__filter_f__2 [fun_0, f_2]
        in BIF.erlang__op_append [l_19, rop_21]
      something_else -> EXC.case_clause something_else
erlps__filter_f__2 [arg_24, arg_25] = EXC.function_clause unit
erlps__filter_f__2 args =
  EXC.badarity (ErlangFun 2 erlps__filter_f__2) args
...
erlps__filter_r__2 [fun_0, (ErlangCons x_1 r0_2)] =
  ...
  in
    case case_6 of
      ...
      (ErlangCons y_11 (ErlangEmptyList)) -> ErlangCons y_11 r_5
      (ErlangAtom "false") -> r_5
      (ErlangEmptyList) -> r_5
      l_14 | isEList l_14 -> BIF.lists__reverse__2 [l_14, r_5]
      something_else -> EXC.case_clause something_else
erlps__filter_r__2 [arg_17, arg_18] = EXC.function_clause unit
erlps__filter_r__2 args =
  EXC.badarity (ErlangFun 2 erlps__filter_r__2) args

erlps__filtermap__2 :: ErlangFun
erlps__filtermap__2 [fun_0, (ErlangTuple [r0_1, f0_2])]
  | ((isEFunA fun_0 (toErl 1)) && (isEList r0_1)) &&
      (isEList f0_2) =
  let   
    f_5 =
      BIF.do_remote_fun_call "Lists" "erlps__filtermap__2"
        [fun_0, f0_2]
  in let r_8 = erlps__filtermap_r__2 [fun_0, r0_1]
  in
    case ErlangAtom "true" of
      _ | (==) r_8 ErlangEmptyList -> erlps__f2r__1 [f_5]
      _ | (==) f_5 ErlangEmptyList -> erlps__r2f__1 [r_8]
      _ -> ErlangTuple [r_8, f_5]
erlps__filtermap__2 [fun_0, q_1] =
  BIF.erlang__error__2
    [ErlangAtom "badarg",
     ErlangCons fun_0 (ErlangCons q_1 ErlangEmptyList)]
erlps__filtermap__2 [arg_8, arg_9] = EXC.function_clause unit
erlps__filtermap__2 args =
  EXC.badarity (ErlangFun 2 erlps__filtermap__2) args

erlps__filtermap_r__2 :: ErlangFun
erlps__filtermap_r__2 [_, (ErlangEmptyList)] = ErlangEmptyList
erlps__filtermap_r__2 [fun_0, (ErlangCons x_1 r0_2)] =
  let    r_5 = erlps__filtermap_r__2 [fun_0, r0_2]
  in let
    case_6 =
      BIF.erlang__apply__2 [fun_0, ErlangCons x_1 ErlangEmptyList]
  in
    case case_6 of
      (ErlangAtom "true") -> ErlangCons x_1 r_5
      (ErlangTuple [(ErlangAtom "true"), y_11]) -> ErlangCons y_11 r_5
      (ErlangAtom "false") -> r_5
      something_else -> EXC.case_clause something_else
erlps__filtermap_r__2 [arg_14, arg_15] = EXC.function_clause unit
erlps__filtermap_r__2 args =
  EXC.badarity (ErlangFun 2 erlps__filtermap_r__2) args

erlps__fold__3 :: ErlangFun
erlps__fold__3 [fun_0, acc0_1, (ErlangTuple [r_2, f_3])]
  | ((isEFunA fun_0 (toErl 2)) && (isEList r_2)) && (isEList f_3) =
  let
    acc1_7 =
  ...
  in
    BIF.do_remote_fun_call "Lists" "erlps__foldr__3"
      [fun_0, acc1_7, r_2]
erlps__fold__3 [fun_0, acc0_1, q_2] =
  BIF.erlang__error__2
    [ErlangAtom "badarg",
     ErlangCons fun_0
       (ErlangCons acc0_1 (ErlangCons q_2 ErlangEmptyList))]
erlps__fold__3 [arg_11, arg_12, arg_13] =
  EXC.function_clause unit
erlps__fold__3 args =
  EXC.badarity (ErlangFun 3 erlps__fold__3) args

erlps__any__2 :: ErlangFun
erlps__any__2 [pred_0, (ErlangTuple [r_1, f_2])]
  | ((isEFunA pred_0 (toErl 1)) && (isEList r_1)) &&
      (isEList f_2) =
  let
    lop_3 =
      BIF.do_remote_fun_call "Lists" "erlps__any__2" [pred_0, f_2]
  in
    case lop_3 of
      (ErlangAtom "true") -> ErlangAtom "true"
      (ErlangAtom "false") ->
        BIF.do_remote_fun_call "Lists" "erlps__any__2" [pred_0, r_1]
      _ -> EXC.badarg1 lop_3
erlps__any__2 [pred_0, q_1] =
  BIF.erlang__error__2
    [ErlangAtom "badarg",
     ErlangCons pred_0 (ErlangCons q_1 ErlangEmptyList)]
erlps__any__2 [arg_8, arg_9] = EXC.function_clause unit
erlps__any__2 args =
  EXC.badarity (ErlangFun 2 erlps__any__2) args

erlps__all__2 :: ErlangFun
erlps__all__2 [pred_0, (ErlangTuple [r_1, f_2])]
  | ((isEFunA pred_0 (toErl 1)) && (isEList r_1)) &&
      (isEList f_2) =
  let
    lop_3 =
      BIF.do_remote_fun_call "Lists" "erlps__all__2" [pred_0, f_2]
  in
    case lop_3 of
      (ErlangAtom "false") -> ErlangAtom "false"
      (ErlangAtom "true") ->
        BIF.do_remote_fun_call "Lists" "erlps__all__2" [pred_0, r_1]
      _ -> EXC.badarg1 lop_3
erlps__all__2 [pred_0, q_1] =
  BIF.erlang__error__2
    [ErlangAtom "badarg",
     ErlangCons pred_0 (ErlangCons q_1 ErlangEmptyList)]
erlps__all__2 [arg_8, arg_9] = EXC.function_clause unit
erlps__all__2 args =
  EXC.badarity (ErlangFun 2 erlps__all__2) args

erlps__delete__2 :: ErlangFun
erlps__delete__2 [item_0, q_3@(ErlangTuple [r0_1, f0_2])]
  | (isEList r0_1) && (isEList f0_2) =
  let case_4 = erlps__delete_front__2 [item_0, f0_2]
  in
    case case_4 of
      (ErlangAtom "false") ->
        let case_7 = erlps__delete_rear__2 [item_0, r0_1]
        in
          case case_7 of
            (ErlangAtom "false") -> q_3
            (ErlangEmptyList) -> erlps__f2r__1 [f0_2]
            r1_11 -> ErlangTuple [r1_11, f0_2]
      (ErlangEmptyList) -> erlps__r2f__1 [r0_1]
      f1_15 -> ErlangTuple [r0_1, f1_15]
erlps__delete__2 [item_0, q_1] =
  BIF.erlang__error__2
    [ErlangAtom "badarg",
     ErlangCons item_0 (ErlangCons q_1 ErlangEmptyList)]
erlps__delete__2 [arg_8, arg_9] = EXC.function_clause unit
erlps__delete__2 args =
  EXC.badarity (ErlangFun 2 erlps__delete__2) args

erlps__delete_r__2 :: ErlangFun
erlps__delete_r__2 [item_0, (ErlangTuple [r0_1, f0_2])]
  | (isEList r0_1) && (isEList f0_2) =
  let    arg_4 = ErlangTuple [f0_2, r0_1]
  in let matchExpr_9 = erlps__delete__2 [item_0, arg_4]
  in
    case matchExpr_9 of
      (ErlangTuple [f1_7, r1_8]) -> ErlangTuple [r1_8, f1_7]
      _ -> EXC.badmatch matchExpr_9
erlps__delete_r__2 [item_0, q_1] =
  BIF.erlang__error__2
    [ErlangAtom "badarg",
     ErlangCons item_0 (ErlangCons q_1 ErlangEmptyList)]
erlps__delete_r__2 [arg_8, arg_9] = EXC.function_clause unit
erlps__delete_r__2 args =
  EXC.badarity (ErlangFun 2 erlps__delete_r__2) args

erlps__delete_front__2 :: ErlangFun
erlps__delete_front__2 [item_0, (ErlangCons item_1 rest_2)]
  | item_1 == item_0 =
  rest_2
erlps__delete_front__2 [item_0, (ErlangCons x_1 rest_2)] =
  let case_3 = erlps__delete_front__2 [item_0, rest_2]
  in
    case case_3 of
      (ErlangAtom "false") -> ErlangAtom "false"
      f_6 -> ErlangCons x_1 f_6
erlps__delete_front__2 [_, (ErlangEmptyList)] =
  ErlangAtom "false"
erlps__delete_front__2 [arg_0, arg_1] = EXC.function_clause unit
erlps__delete_front__2 args =
  EXC.badarity (ErlangFun 2 erlps__delete_front__2) args

erlps__delete_rear__2 :: ErlangFun
erlps__delete_rear__2 [item_0, (ErlangCons x_1 rest_2)] =
  let case_3 = erlps__delete_rear__2 [item_0, rest_2]
  in
    case case_3 of
      (ErlangAtom "false") | (==) x_1 item_0 -> rest_2
      (ErlangAtom "false") -> ErlangAtom "false"
      r_6 -> ErlangCons x_1 r_6
erlps__delete_rear__2 [_, (ErlangEmptyList)] = ErlangAtom "false"
erlps__delete_rear__2 [arg_0, arg_1] = EXC.function_clause unit
erlps__delete_rear__2 args =
  EXC.badarity (ErlangFun 2 erlps__delete_rear__2) args

erlps__delete_with__2 :: ErlangFun
erlps__delete_with__2 [pred_0, q_3@(ErlangTuple [r0_1, f0_2])]
  | ((isEFunA pred_0 (toErl 1)) && (isEList r0_1)) &&
      (isEList f0_2) =
  let case_4 = erlps__delete_with_front__2 [pred_0, f0_2]
  in
    case case_4 of
      (ErlangAtom "false") ->
        let case_7 = erlps__delete_with_rear__2 [pred_0, r0_1]
        in
          case case_7 of
            (ErlangAtom "false") -> q_3
            (ErlangEmptyList) -> erlps__f2r__1 [f0_2]
      ...
      (ErlangEmptyList) -> erlps__r2f__1 [r0_1]
      f1_15 -> ErlangTuple [r0_1, f1_15]
erlps__delete_with__2 [pred_0, q_1] =
  BIF.erlang__error__2
    [ErlangAtom "badarg",
     ErlangCons pred_0 (ErlangCons q_1 ErlangEmptyList)]
erlps__delete_with__2 [arg_8, arg_9] = EXC.function_clause unit
erlps__delete_with__2 args =
  EXC.badarity (ErlangFun 2 erlps__delete_with__2) args

erlps__delete_with_r__2 :: ErlangFun
erlps__delete_with_r__2 [pred_0, (ErlangTuple [r0_1, f0_2])]
  | ((isEFunA pred_0 (toErl 1)) && (isEList r0_1)) &&
      (isEList f0_2) =
  let    arg_4 = ErlangTuple [f0_2, r0_1]
  in let matchExpr_9 = erlps__delete_with__2 [pred_0, arg_4]
  in
    case matchExpr_9 of
      (ErlangTuple [f1_7, r1_8]) -> ErlangTuple [r1_8, f1_7]
      _ -> EXC.badmatch matchExpr_9
erlps__delete_with_r__2 [pred_0, q_1] =
  BIF.erlang__error__2
    [ErlangAtom "badarg",
     ErlangCons pred_0 (ErlangCons q_1 ErlangEmptyList)]
erlps__delete_with_r__2 [arg_8, arg_9] = EXC.function_clause unit
erlps__delete_with_r__2 args =
  EXC.badarity (ErlangFun 2 erlps__delete_with_r__2) args

erlps__delete_with_front__2 :: ErlangFun
erlps__delete_with_front__2 [pred_0, (ErlangCons x_1 rest_2)] =
  let
    case_3 =
      BIF.erlang__apply__2 [pred_0, ErlangCons x_1 ErlangEmptyList]
  in
    case case_3 of
      (ErlangAtom "true") -> rest_2
      (ErlangAtom "false") ->
        let case_6 = erlps__delete_with_front__2 [pred_0, rest_2]
        in
          case case_6 of
            (ErlangAtom "false") -> ErlangAtom "false"
            f_9 -> ErlangCons x_1 f_9
      something_else -> EXC.case_clause something_else
erlps__delete_with_front__2 [_, (ErlangEmptyList)] =
  ErlangAtom "false"
erlps__delete_with_front__2 [arg_0, arg_1] =
  EXC.function_clause unit
erlps__delete_with_front__2 args =
  EXC.badarity (ErlangFun 2 erlps__delete_with_front__2) args

erlps__delete_with_rear__2 :: ErlangFun
erlps__delete_with_rear__2 [pred_0, (ErlangCons x_1 rest_2)] =
  let case_3 = erlps__delete_with_rear__2 [pred_0, rest_2]
  in
    case case_3 of
      (ErlangAtom "false") ->
        let
        ...
        in
          case case_6 of
            ...
            (ErlangAtom "false") -> ErlangAtom "false"
            something_else -> EXC.case_clause something_else
      r_9 -> ErlangCons x_1 r_9
erlps__delete_with_rear__2 [_, (ErlangEmptyList)] =
  ErlangAtom "false"
erlps__delete_with_rear__2 [arg_0, arg_1] =
  EXC.function_clause unit
erlps__delete_with_rear__2 args =
  EXC.badarity (ErlangFun 2 erlps__delete_with_rear__2) args

erlps__cons__2 :: ErlangFun
erlps__cons__2 [x_0, q_1] = erlps__in_r__2 [x_0, q_1]
erlps__cons__2 [arg_4, arg_5] = EXC.function_clause unit
erlps__cons__2 args =
  EXC.badarity (ErlangFun 2 erlps__cons__2) args
...
erlps__r2f__1 [(ErlangCons y_0 (ErlangCons x_1 (ErlangEmptyList)))]
  =
  ErlangTuple
    [ErlangCons y_0 ErlangEmptyList, ErlangCons x_1 ErlangEmptyList]
erlps__r2f__1 [list_0] =
  let    lop_2 = BIF.erlang__length__1 [list_0]
  in let rop_4 = toErl 2
  in let arg_1 = BIF.erlang__op_div_strict [lop_2, rop_4]
  in let
    matchExpr_8 =
      BIF.do_remote_fun_call "Lists" "erlps__split__2" [arg_1, list_0]
  in
    case matchExpr_8 of
      (ErlangTuple [rr_6, ff_7]) ->
        let tup_el_10 = BIF.lists__reverse__2 [ff_7, ErlangEmptyList]
        in ErlangTuple [rr_6, tup_el_10]
      _ -> EXC.badmatch matchExpr_8
erlps__r2f__1 [arg_13] = EXC.function_clause unit
erlps__r2f__1 args =
  EXC.badarity (ErlangFun 1 erlps__r2f__1) args
...
erlps__f2r__1 [(ErlangCons x_0 (ErlangCons y_1 (ErlangEmptyList)))]
  =
  ErlangTuple
    [ErlangCons y_1 ErlangEmptyList, ErlangCons x_0 ErlangEmptyList]
erlps__f2r__1 [list_0] =
  ...
  in
    case matchExpr_8 of
      (ErlangTuple [ff_6, rr_7]) ->
        let tup_el_9 = BIF.lists__reverse__2 [rr_7, ErlangEmptyList]
        in ErlangTuple [tup_el_9, ff_6]
      _ -> EXC.badmatch matchExpr_8
erlps__f2r__1 [arg_13] = EXC.function_clause unit
erlps__f2r__1 args =
  EXC.badarity (ErlangFun 1 erlps__f2r__1) args