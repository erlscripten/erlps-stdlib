...
erlps__lattribute__3 [(ErlangAtom "file"),
  ...
  in let
    head_10 = ErlangTuple [ErlangAtom "integer", tup_el_12, line_1]
  in
    erlps__attr__2
      [ErlangAtom "file",
...
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "type"), line_0,
  ...
  =
  let
    arg_1 = ErlangTuple [ErlangAtom "atom", line_0, ErlangAtom "map"]
...
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "remote_type"),
                 ...
                 _]
  =
  let arg_4 = ErlangTuple [ErlangAtom "remote", line_0, m_1, f_2]
...
erlps__func_clause__3 [name_0,
                       ...
                       opts_5]
  =
  let    arg_6 = ErlangTuple [ErlangAtom "atom", line_1, name_0]
  in let arg_11 = toErl 0
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "lc"), _, e_0, qs_1]),
  ...
  in let
    head_25 =
      ErlangTuple
        [ErlangAtom "seq", tup_el_27, ErlangEmptyList,
         ErlangCons ErlangEmptyList ErlangEmptyList,
         ErlangCons head_33 ErlangEmptyList]
  in let head_42 = toErl 93
  in
    ErlangTuple
      [ErlangAtom "list",
       ErlangCons head_25 (ErlangCons head_42 ErlangEmptyList)]
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "fun"), l_0,
  ...
  in let arg_12 = ErlangTuple [ErlangAtom "fun", l_0, tup_el_15]
...
erlps__wordtable__0 [] =
  ...
  in let
    l_48 =
      flmap
        (\ lc_40 ->
           let matchExpr_45 = erlps__leaf__1 [lc_40]
           in
             case matchExpr_45 of
               (ErlangTuple [(ErlangAtom "leaf"), sz_43, s_44]) ->
                 let lcRet_41 = ErlangTuple [s_44, sz_43]
                 in ErlangCons lcRet_41 ErlangEmptyList
               _ -> EXC.badmatch matchExpr_45)
        (ErlangCons head_1
           (ErlangCons head_3
              (ErlangCons head_5
                 (ErlangCons head_7
