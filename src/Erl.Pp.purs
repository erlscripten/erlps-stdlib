module Erl.Pp(erlps__form__1, erlps__form__2,
              ...
              erlps__expr__1, erlps__expr__2, erlps__expr__3, erlps__expr__4,
              erlps__legalize_vars__1) where
{-
...
erlps__form__1 args =
  EXC.badarity (ErlangFun 1 erlps__form__1) args
...
erlps__attribute__1 args =
  EXC.badarity (ErlangFun 1 erlps__attribute__1) args
...
erlps__attribute__2 args =
  EXC.badarity (ErlangFun 2 erlps__attribute__2) args
...
erlps__function__1 args =
  EXC.badarity (ErlangFun 1 erlps__function__1) args
...
erlps__function__2 args =
  EXC.badarity (ErlangFun 2 erlps__function__2) args
...
erlps__guard__1 args =
  EXC.badarity (ErlangFun 1 erlps__guard__1) args
...
erlps__guard__2 args =
  EXC.badarity (ErlangFun 2 erlps__guard__2) args

erlps__exprs__1 :: ErlangFun
erlps__exprs__1 [es_0] =
  let arg_2 = toErl 0
  in erlps__exprs__3 [es_0, arg_2, ErlangAtom "none"]
erlps__exprs__1 [arg_4] = EXC.function_clause unit
erlps__exprs__1 args =
  EXC.badarity (ErlangFun 1 erlps__exprs__1) args

erlps__exprs__2 :: ErlangFun
erlps__exprs__2 [es_0, options_1] =
  let arg_3 = toErl 0
  in erlps__exprs__3 [es_0, arg_3, options_1]
...
erlps__expr__1 [e_0] =
  ...
  in let arg_1 = erlps__lexpr__3 [e_0, arg_3, arg_4]
...
erlps__expr__2 [e_0, options_1] =
  let    arg_4 = toErl 0
  in let arg_5 = erlps__options__1 [options_1]
  in let arg_2 = erlps__lexpr__3 [e_0, arg_4, arg_5]
...
erlps__expr__3 [e_0, i_1, options_2] =
  let    arg_5 = toErl 0
  in let arg_6 = erlps__options__1 [options_2]
  in let arg_3 = erlps__lexpr__3 [e_0, arg_5, arg_6]
...
erlps__legalize_vars__1 :: ErlangFun
erlps__legalize_vars__1 [(ErlangTuple [(ErlangAtom "function"),
                                       anno_0, name0_1, arity_2, clauses0_3])]
  =
  let   
    f_31 =
      ErlangFun 2
        (let
           lambda_4 [(ErlangTuple [(ErlangAtom "var"), _anno_7, name_8]),
                     (ErlangTuple [valid_9, invalid_10])]
             =
             let matchExpr_13 = BIF.erlang__atom_to_list__1 [name_8]
             in
               case matchExpr_13 of
                 (ErlangCons first_12 _) ->
                   case first_12 of
                     x_16 | (weakGeq x_16 (toErl 97)) &&
                              (weakLeq x_16 (toErl 122)) ->
                       let   
                         mapExt_22 =
                           ErlangMap (Map.singleton name_8 matchExpr_13)
                       in let
                         tup_el_18 = BIF.maps__merge__2 [invalid_10, mapExt_22]
                       in ErlangTuple [valid_9, tup_el_18]
                     _ ->
                       let   
                         mapExt_28 = ErlangMap (Map.singleton name_8 name_8)
                       in let
                         tup_el_24 = BIF.maps__merge__2 [valid_9, mapExt_28]
                       in ErlangTuple [tup_el_24, invalid_10]
         ...
         in lambda_4)
  in let tup_el_34 = ErlangMap Map.empty
  in let tup_el_35 = ErlangMap Map.empty
  in let arg_33 = ErlangTuple [tup_el_34, tup_el_35]
  in let
    matchExpr_39 = erlps__fold_vars__3 [f_31, arg_33, clauses0_3]
  in
    case matchExpr_39 of
      (ErlangTuple [valid_37, invalid_38]) ->
        let    arg_40 = ErlangFun 3 erlps__legalize_name__3
        in let
          mapping_43 =
            BIF.do_remote_fun_call "Maps" "erlps__fold__3"
              [arg_40, valid_37, invalid_38]
        in let
          subs_53 =
            ErlangFun 1
              (let
                 lambda_44 [(ErlangTuple [(ErlangAtom "var"), anno_46,
                                          name_47])]
                   =
                   let tup_el_50 = BIF.erlang__map_get__2 [name_47, mapping_43]
                   in ErlangTuple [ErlangAtom "var", anno_46, tup_el_50]
                 lambda_44 [arg_45] = EXC.function_clause unit
                 lambda_44 args = EXC.badarity (ErlangFun 1 lambda_44) args
               in lambda_44)
        in let clauses_56 = erlps__map_vars__2 [subs_53, clauses0_3]
        in
          ErlangTuple
            [ErlangAtom "function", anno_0, name0_1, arity_2, clauses_56]
      _ -> EXC.badmatch matchExpr_39
erlps__legalize_vars__1 [form_0] =
  BIF.erlang__error__2
    [ErlangAtom "badarg", ErlangCons form_0 ErlangEmptyList]
erlps__legalize_vars__1 [arg_5] = EXC.function_clause unit
erlps__legalize_vars__1 args =
  EXC.badarity (ErlangFun 1 erlps__legalize_vars__1) args
...
erlps__options__1 [options_0] | isEList options_0 =
  ...
  in
    ErlangTuple [ErlangAtom "options", hook_4, encoding_6, options_0]
erlps__options__1 [hook_0] =
  let tup_el_3 = erlps__encoding__1 [ErlangEmptyList]
  in ErlangTuple [ErlangAtom "options", hook_0, tup_el_3, hook_0]
erlps__options__1 [arg_6] = EXC.function_clause unit
erlps__options__1 args =
  EXC.badarity (ErlangFun 1 erlps__options__1) args
...
erlps__state__1 [options_0] | isEList options_0 =
  ...
  in let
    indent_12 =
      BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
        [ErlangAtom "indent", options_0, arg_11]
  in let arg_15 = toErl 72
  in let
    linewidth_16 =
      BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
        [ErlangAtom "linewidth", options_0, arg_15]
  in
    case state_8 of
...
erlps__state__1 args =
  EXC.badarity (ErlangFun 1 erlps__state__1) args

erlps__latin1_state__1 :: ErlangFun
erlps__latin1_state__1 [quote_0] =
  let   
    head_1 = ErlangTuple [ErlangAtom "encoding", ErlangAtom "latin1"]
  in let
    valuefun_11 =
      ErlangFun 1
        (let
          ...
          ErlangFun 1
            (let
               lambda_13 [a_15] =
                 ...
                 in let arg_18 = toErl 39
                 in
                   BIF.do_remote_fun_call "Io.Lib"
                     "erlps__write_string_as_latin1__2" [arg_16, arg_18]
  ...
  in let
    tup_el_27 =
      BIF.erlang__make_fun__3
        [ErlangAtom "io_lib", ErlangAtom "write_char_as_latin1", arg_30]
  in let tup_el_31 = toErl 72
  in let tup_el_32 = toErl 4
  in
    ErlangTuple
      [ErlangAtom "pp", valuefun_11, singletonfun_19, tup_el_23,
       tup_el_27, tup_el_31, tup_el_32]
erlps__latin1_state__1 [arg_33] = EXC.function_clause unit
erlps__latin1_state__1 args =
  EXC.badarity (ErlangFun 1 erlps__latin1_state__1) args
...
erlps__unicode_state__1 [quote_0] =
  ...
  in let
    tup_el_23 =
      BIF.erlang__make_fun__3
        [ErlangAtom "io_lib", ErlangAtom "write_string", arg_26]
  in let arg_30 = toErl 1
  in let
    tup_el_27 =
      BIF.erlang__make_fun__3
        [ErlangAtom "io_lib", ErlangAtom "write_char", arg_30]
  in let tup_el_31 = toErl 72
  in let tup_el_32 = toErl 4
  in
    ErlangTuple
...
erlps__unicode_state__1 args =
  EXC.badarity (ErlangFun 1 erlps__unicode_state__1) args
...
erlps__encoding__1 args =
  EXC.badarity (ErlangFun 1 erlps__encoding__1) args

erlps__lform__2 :: ErlangFun
erlps__lform__2 [(ErlangTuple [(ErlangAtom "attribute"), anno_0,
                               name_1, arg_2]),
                 opts_3]
  =
  let
    arg_4 =
      ErlangTuple [ErlangAtom "attribute", anno_0, name_1, arg_2]
  in erlps__lattribute__2 [arg_4, opts_3]
erlps__lform__2 [(ErlangTuple [(ErlangAtom "function"), anno_0,
  ...
  let
    arg_5 =
      ErlangTuple
        [ErlangAtom "function", anno_0, name_1, arity_2, clauses_3]
...
erlps__lform__2 [(ErlangTuple [(ErlangAtom "eof"), _location_0]),
                 _opts_1]
  =
  toErl 10
erlps__lform__2 [arg_2, arg_3] = EXC.function_clause unit
erlps__lform__2 args =
  EXC.badarity (ErlangFun 2 erlps__lform__2) args
...
erlps__message__2 [m_0,
  ...
  let   
    f_3 =
      case encoding_1 of
        (ErlangAtom "latin1") -> toErl "~p\n"
        (ErlangAtom "unicode") -> toErl "~tp\n"
        something_else -> EXC.case_clause something_else
  in let
    arg_4 =
...
erlps__message__2 args =
  EXC.badarity (ErlangFun 2 erlps__message__2) args

erlps__lattribute__2 :: ErlangFun
erlps__lattribute__2 [(ErlangTuple [(ErlangAtom "attribute"),
                                    _anno_0, (ErlangAtom "type"), type_1]),
                      opts_2]
  =
  let   
    head_3 = erlps__typeattr__3 [ErlangAtom "type", type_1, opts_2]
  in let arg_9 = toErl ".\n"
  in let head_8 = erlps__leaf__1 [arg_9]
  in ErlangCons head_3 (ErlangCons head_8 ErlangEmptyList)
erlps__lattribute__2 [(ErlangTuple [(ErlangAtom "attribute"),
                                    _anno_0, (ErlangAtom "opaque"), type_1]),
                      opts_2]
  =
  let   
    head_3 = erlps__typeattr__3 [ErlangAtom "opaque", type_1, opts_2]
  in let arg_9 = toErl ".\n"
  in let head_8 = erlps__leaf__1 [arg_9]
  in ErlangCons head_3 (ErlangCons head_8 ErlangEmptyList)
erlps__lattribute__2 [(ErlangTuple [(ErlangAtom "attribute"),
                                    _anno_0, (ErlangAtom "spec"), arg_1]),
                      _opts_2]
  =
...
erlps__lattribute__2 [(ErlangTuple [(ErlangAtom "attribute"),
                                    _anno_0, (ErlangAtom "callback"), arg_1]),
                      _opts_2]
  =
  let    head_3 = erlps__specattr__2 [ErlangAtom "callback", arg_1]
  in let arg_8 = toErl ".\n"
  in let head_7 = erlps__leaf__1 [arg_8]
  in ErlangCons head_3 (ErlangCons head_7 ErlangEmptyList)
erlps__lattribute__2 [(ErlangTuple [(ErlangAtom "attribute"),
                                    _anno_0, name_1, arg_2]),
                      opts_3]
  =
...
erlps__lattribute__2 [arg_12, arg_13] = EXC.function_clause unit
erlps__lattribute__2 args =
  EXC.badarity (ErlangFun 2 erlps__lattribute__2) args
...
erlps__lattribute__3 [(ErlangAtom "optional_callbacks"),
  ...
  EXC.tryCatch
    ...
    (\ ex_6 ->
       case ex_6 of
         (ErlangTuple [_, _, _]) ->
           let head_10 = erlps__abstract__2 [falist_0, opts_1]
           in
             erlps__attr__2
...
erlps__lattribute__3 [(ErlangAtom "file"),
                      (ErlangTuple [name_0, anno_1]), _opts_2]
  =
  ...
  in let
    head_10 = ErlangTuple [ErlangAtom "integer", tup_el_12, anno_1]
  in
    erlps__attr__2
      [ErlangAtom "file",
...
erlps__lattribute__3 args =
  EXC.badarity (ErlangFun 3 erlps__lattribute__3) args
...
erlps__abstract__2 args =
  EXC.badarity (ErlangFun 2 erlps__abstract__2) args
...
erlps__typeattr__3 [tag_0,
  ...
  in let
    arg_15 = ErlangTuple [ErlangAtom "atom", tup_el_17, typename_1]
  in let arg_20 = toErl 0
  in let arg_21 = erlps__options__1 [ErlangAtom "none"]
  in let arg_14 = erlps__call__4 [arg_15, args_3, arg_20, arg_21]
...
erlps__typeattr__3 args =
  EXC.badarity (ErlangFun 3 erlps__typeattr__3) args

erlps__ltype__1 :: ErlangFun
erlps__ltype__1 [t_0] =
  let arg_2 = toErl 0
  in erlps__ltype__2 [t_0, arg_2]
erlps__ltype__1 [arg_3] = EXC.function_clause unit
erlps__ltype__1 args =
  EXC.badarity (ErlangFun 1 erlps__ltype__1) args

erlps__ltype__2 :: ErlangFun
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "ann_type"), _anno_0,
      ...
      (ErlangTuple [l_5, p_6, r_7]) ->
        ...
        in let
          head_17 =
            ErlangTuple
              [ErlangAtom "cstep",
               ErlangCons vl_11 (ErlangCons (ErlangAtom " ::") ErlangEmptyList),
               tr_14]
        in let
          el_26 =
            ErlangTuple
...
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "paren_type"),
                               _anno_0, (ErlangCons t_1 (ErlangEmptyList))]),
                 p_2]
  =
  erlps__ltype__2 [t_1, p_2]
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "type"), _anno_0,
...
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "type"), _anno_0,
                 ...
                 _]
  =
  let    tup_el_3 = toErl 91
  in let tup_el_4 = toErl 93
  in let tup_el_5 = toErl 44
  in let head_7 = erlps__ltype__1 [t_1]
  in
    ErlangTuple
      [ErlangAtom "seq", tup_el_3, tup_el_4, tup_el_5,
...
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "type"), _anno_0,
  ...
  let    tup_el_3 = toErl 91
  in let tup_el_4 = toErl 93
  in let head_6 = toErl 44
  in let head_9 = erlps__ltype__1 [t_1]
  in let arg_13 = toErl "..."
  in let head_12 = erlps__leaf__1 [arg_13]
  in
    ErlangTuple
      [ErlangAtom "seq", tup_el_3, tup_el_4,
       ErlangCons head_6 ErlangEmptyList,
       ErlangCons head_9 (ErlangCons head_12 ErlangEmptyList)]
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "type"), anno_0,
                               (ErlangAtom "nil"), (ErlangEmptyList)]),
                 _]
  =
  let    arg_1 = ErlangTuple [ErlangAtom "nil", anno_0]
  in let arg_4 = erlps__options__1 [ErlangAtom "none"]
...
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "type"), anno_0,
  ...
  =
  let
    arg_1 = ErlangTuple [ErlangAtom "atom", anno_0, ErlangAtom "map"]
...
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "type"), anno_0,
  ...
  let
    arg_1 =
      ErlangTuple [ErlangAtom "atom", anno_0, ErlangAtom "tuple"]
  in erlps__simple_type__2 [arg_1, ErlangEmptyList]
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "type"), _anno_0,
  ...
  in
    case matchExpr_9 of
      (ErlangTuple [_l_6, p_7, r_8]) ->
        ...
        in let
          e_24 = erlps__expr_list__4 [es_3, ErlangAtom "..", f_18, arg_22]
    ...
    head_1 =
      erlps__fun_type__2
        [ErlangCons (ErlangAtom "fun")
         ...
         funtype_0]
  in let head_9 = toErl 41
  in ErlangCons head_1 (ErlangCons head_9 ErlangEmptyList)
erlps__ltype__2 [funtype_1@(ErlangTuple [(ErlangAtom "type"),
                                         _anno_0, (ErlangAtom "fun"),
                                         (ErlangCons (ErlangTuple [(ErlangAtom "type"),
                                                                   _,
                                                                   (ErlangAtom "product"),
  ...
  in ErlangCons head_2 (ErlangCons head_10 ErlangEmptyList)
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "type"), anno_0, t_1,
                               ts_2]),
                 _]
  =
  let arg_3 = ErlangTuple [ErlangAtom "atom", anno_0, t_1]
  in erlps__simple_type__2 [arg_3, ts_2]
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "user_type"), anno_0,
                               t_1, ts_2]),
                 _]
  =
  let arg_3 = ErlangTuple [ErlangAtom "atom", anno_0, t_1]
...
erlps__ltype__2 [(ErlangTuple [(ErlangAtom "remote_type"),
                 ...
                 _]
  =
  let arg_4 = ErlangTuple [ErlangAtom "remote", anno_0, m_1, f_2]
...
erlps__ltype__2 args =
  EXC.badarity (ErlangFun 2 erlps__ltype__2) args
...
erlps__binary_type__2 [i1_0, i2_1] =
  ...
  in let
    p_20 = BIF.do_remote_fun_call "Erl.Parse" "erlps__max_prec__0" []
  in let
    e1_32 =
      case b_10 of
        (ErlangAtom "true") ->
  ...
  in
    case case_45 of
      ...
      es_49 ->
        let head_54 = toErl 44
        in
          ErlangTuple
            [ErlangAtom "seq", ErlangAtom "<<", ErlangAtom ">>",
             ErlangCons head_54 ErlangEmptyList, es_49]
erlps__binary_type__2 [arg_57, arg_58] = EXC.function_clause unit
erlps__binary_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__binary_type__2) args

erlps__map_type__1 :: ErlangFun
erlps__map_type__1 [fs_0] =
  let    head_3 = toErl 35
  in let tup_el_5 = erlps__map_pair_types__1 [fs_0]
  in
    ErlangTuple
      [ErlangAtom "first", ErlangCons head_3 ErlangEmptyList, tup_el_5]
erlps__map_type__1 [arg_7] = EXC.function_clause unit
erlps__map_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__map_type__1) args
...
erlps__map_pair_types__1 args =
  EXC.badarity (ErlangFun 1 erlps__map_pair_types__1) args

erlps__map_pair_type__2 :: ErlangFun
erlps__map_pair_type__2 [(ErlangTuple [(ErlangAtom "type"),
                                       _anno_0, (ErlangAtom "map_field_assoc"),
...
erlps__map_pair_type__2 [(ErlangTuple [(ErlangAtom "type"),
                                       _anno_0, (ErlangAtom "map_field_exact"),
                                       (ErlangCons ktype_1 (ErlangCons vtype_2 (ErlangEmptyList)))]),
                         prec_3]
  =
  let    head_9 = erlps__ltype__2 [ktype_1, prec_3]
...
erlps__map_pair_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__map_pair_type__2) args
...
erlps__record_type__2 [name_0, fields_1] =
  ...
  in
    ErlangTuple
      [ErlangAtom "first", ErlangCons head_4 ErlangEmptyList, tup_el_7]
erlps__record_type__2 [arg_9, arg_10] = EXC.function_clause unit
erlps__record_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__record_type__2) args
...
erlps__field_types__1 args =
  EXC.badarity (ErlangFun 1 erlps__field_types__1) args

erlps__field_type__2 :: ErlangFun
erlps__field_type__2 [(ErlangTuple [(ErlangAtom "type"), _anno_0,
...
erlps__field_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__field_type__2) args
...
erlps__tuple_type__2 [ts_0, f_1] =
  let    tup_el_3 = toErl 123
  in let tup_el_4 = toErl 125
  in let head_6 = toErl 44
  in let arg_11 = toErl 0
  in let tup_el_8 = erlps__ltypes__3 [ts_0, f_1, arg_11]
  in
    ErlangTuple
      [ErlangAtom "seq", tup_el_3, tup_el_4,
       ErlangCons head_6 ErlangEmptyList, tup_el_8]
erlps__tuple_type__2 [arg_12, arg_13] = EXC.function_clause unit
erlps__tuple_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__tuple_type__2) args
...
erlps__specattr__2 [speckind_0,
  ...
  let   
    func_21 =
      case funcspec_1 of
        (ErlangTuple [f_4, _a_5]) -> ErlangTuple [ErlangAtom "atom", f_4]
        (ErlangTuple [m_8, f_9, _a_10]) ->
          let    head_11 = ErlangTuple [ErlangAtom "atom", m_8]
          in let head_15 = toErl 58
  ...
  in let
    head_35 = ErlangTuple [ErlangAtom "first", func_21, tup_el_38]
  in let
    tup_el_32 =
      ErlangTuple
...
erlps__specattr__2 args =
  EXC.badarity (ErlangFun 2 erlps__specattr__2) args
...
erlps__spec_clauses__1 [typespecs_0] =
  ...
  in let
    tup_el_5 =
      flmap
        (\ lc_8 ->
           let lcRet_9 = erlps__sig_type__1 [lc_8]
           in ErlangCons lcRet_9 ErlangEmptyList)
        typespecs_0
  in
    ErlangTuple
      [ErlangAtom "prefer_nl", ErlangCons head_3 ErlangEmptyList,
       tup_el_5]
erlps__spec_clauses__1 [arg_11] = EXC.function_clause unit
erlps__spec_clauses__1 args =
  EXC.badarity (ErlangFun 1 erlps__spec_clauses__1) args

erlps__sig_type__1 :: ErlangFun
erlps__sig_type__1 [(ErlangTuple [(ErlangAtom "type"), _anno_0,
...
erlps__sig_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__sig_type__1) args

erlps__guard_type__2 :: ErlangFun
erlps__guard_type__2 [before_0, gs_1] =
  let    opts_3 = erlps__options__1 [ErlangAtom "none"]
  in let head_12 = toErl 44
  in let arg_14 = ErlangFun 2 erlps__constraint__2
  in let
    tup_el_9 =
      erlps__expr_list__4
        [gs_1, ErlangCons head_12 ErlangEmptyList, arg_14, opts_3]
  in let
    head_6 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "when", tup_el_9]
  in let
    gl_17 =
      ErlangTuple
        [ErlangAtom "list", ErlangCons head_6 ErlangEmptyList]
  in let head_20 = ErlangTuple [ErlangAtom "step", before_0, gl_17]
  in
    ErlangTuple
      [ErlangAtom "list", ErlangCons head_20 ErlangEmptyList]
erlps__guard_type__2 [arg_25, arg_26] = EXC.function_clause unit
erlps__guard_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__guard_type__2) args

erlps__constraint__2 :: ErlangFun
erlps__constraint__2 [(ErlangTuple [(ErlangAtom "type"), _anno_0,
...
erlps__constraint__2 args =
  EXC.badarity (ErlangFun 2 erlps__constraint__2) args
...
erlps__fun_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__fun_type__2) args

erlps__type_args__1 :: ErlangFun
erlps__type_args__1 [(ErlangTuple [(ErlangAtom "type"), _anno_0,
                                   (ErlangAtom "any")])]
  =
  let arg_1 = toErl "(...)"
  in erlps__leaf__1 [arg_1]
...
erlps__type_args__1 args =
  EXC.badarity (ErlangFun 1 erlps__type_args__1) args
...
erlps__simple_type__2 [arg_9, arg_10] = EXC.function_clause unit
erlps__simple_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__simple_type__2) args

erlps__targs__1 :: ErlangFun
erlps__targs__1 [ts_0] =
  let    tup_el_2 = toErl 40
  in let tup_el_3 = toErl 41
  in let head_5 = toErl 44
  in let arg_9 = toErl 0
  in let tup_el_7 = erlps__ltypes__2 [ts_0, arg_9]
  in
    ErlangTuple
      [ErlangAtom "seq", tup_el_2, tup_el_3,
       ErlangCons head_5 ErlangEmptyList, tup_el_7]
erlps__targs__1 [arg_10] = EXC.function_clause unit
erlps__targs__1 args =
  EXC.badarity (ErlangFun 1 erlps__targs__1) args
...
erlps__ltypes__2 args =
  EXC.badarity (ErlangFun 2 erlps__ltypes__2) args
       ...
       let
         lcRet_6 =
           BIF.erlang__apply__2
             [f_1, ErlangCons lc_5 (ErlangCons prec_2 ErlangEmptyList)]
       in ErlangCons lcRet_6 ErlangEmptyList)
    ts_0
erlps__ltypes__3 [arg_10, arg_11, arg_12] =
  EXC.function_clause unit
erlps__ltypes__3 args =
  EXC.badarity (ErlangFun 3 erlps__ltypes__3) args
...
erlps__attr__2 [name_0, args_1] =
  ...
  in
    ErlangTuple
      [ErlangAtom "first",
       ErlangCons head_4 (ErlangCons head_6 ErlangEmptyList), tup_el_10]
erlps__attr__2 [arg_14, arg_15] = EXC.function_clause unit
erlps__attr__2 args =
  EXC.badarity (ErlangFun 2 erlps__attr__2) args

erlps__attrib__2 :: ErlangFun
erlps__attrib__2 [name_0, args_1] =
  let    head_4 = toErl 45
  in let head_6 = ErlangTuple [ErlangAtom "atom", name_0]
  in let tup_el_13 = toErl 40
  in let tup_el_14 = toErl 41
  in let head_16 = toErl 44
  in let
    head_11 =
      ErlangTuple
        [ErlangAtom "seq", tup_el_13, tup_el_14,
         ErlangCons head_16 ErlangEmptyList, args_1]
  in
    ErlangTuple
      [ErlangAtom "first",
       ErlangCons head_4 (ErlangCons head_6 ErlangEmptyList),
       ErlangCons head_11 ErlangEmptyList]
erlps__attrib__2 [arg_20, arg_21] = EXC.function_clause unit
erlps__attrib__2 args =
  EXC.badarity (ErlangFun 2 erlps__attrib__2) args

erlps__pname__1 :: ErlangFun
erlps__pname__1 [(ErlangCons (ErlangAtom "") as_0)] =
  let    head_1 = toErl 46
  in let tail_2 = erlps__pname__1 [as_0]
...
erlps__pname__1 [(ErlangCons a_0 as_1)] =
  let   
    head_2 = BIF.do_remote_fun_call "Io.Lib" "erlps__write__1" [a_0]
  in let head_5 = toErl 46
...
erlps__pname__1 args =
  EXC.badarity (ErlangFun 1 erlps__pname__1) args
      ...
      flmap
        (\ lc_3 ->
           case lc_3 of
             ...
             _ -> EXC.badmatch lc_3)
        falist_0
  in let tup_el_22 = toErl 91
  in let tup_el_23 = toErl 93
  in let tup_el_24 = toErl 44
  in let
    head_20 =
      ErlangTuple
        [ErlangAtom "seq", tup_el_22, tup_el_23, tup_el_24, l_19]
  in ErlangCons head_20 ErlangEmptyList
erlps__falist__1 [arg_27] = EXC.function_clause unit
erlps__falist__1 args =
  EXC.badarity (ErlangFun 1 erlps__falist__1) args

erlps__lfunction__2 :: ErlangFun
erlps__lfunction__2 [(ErlangTuple [(ErlangAtom "function"),
                                   _anno_0, name_1, _arity_2, cs_3]),
                     opts_4]
  =
  let   
    arg_5 =
      ErlangFun 2
        (let
           lambda_6 [c_9, h_10] = erlps__func_clause__3 [name_1, c_9, h_10]
           lambda_6 [arg_7, arg_8] = EXC.function_clause unit
           lambda_6 args = EXC.badarity (ErlangFun 2 lambda_6) args
         in lambda_6)
  in let arg_14 = toErl 59
  in let
    cll_17 = erlps__nl_clauses__4 [arg_5, arg_14, opts_4, cs_3]
  in let arg_21 = toErl ".\n"
...
erlps__lfunction__2 args =
  EXC.badarity (ErlangFun 2 erlps__lfunction__2) args

erlps__func_clause__3 :: ErlangFun
erlps__func_clause__3 [name_0,
                       (ErlangTuple [(ErlangAtom "clause"), anno_1, head_2,
                                     guard_3, body_4]),
                       opts_5]
  =
  let    arg_6 = ErlangTuple [ErlangAtom "atom", anno_1, name_0]
  in let arg_11 = toErl 0
  in let hl_13 = erlps__call__4 [arg_6, head_2, arg_11, opts_5]
...
erlps__func_clause__3 args =
  EXC.badarity (ErlangFun 3 erlps__func_clause__3) args
...
erlps__guard_when__3 args =
  EXC.badarity (ErlangFun 3 erlps__guard_when__3) args
...
erlps__guard_when__4 [before_0, guard_1, opts_2, after_3] =
  ...
  in let head_10 = ErlangTuple [ErlangAtom "step", before_0, gl_6]
  in let
    head_7 =
      ErlangTuple
...
erlps__guard_when__4 args =
  EXC.badarity (ErlangFun 4 erlps__guard_when__4) args

erlps__lguard__2 :: ErlangFun
erlps__lguard__2 [(ErlangCons e_0 es_1), opts_2] | isEList e_0 =
  let    head_13 = toErl 59
  in let arg_15 = ErlangFun 2 erlps__guard0__2
  in let
    tup_el_8 =
      erlps__expr_list__4
        [ErlangCons e_0 es_1, ErlangCons head_13 ErlangEmptyList, arg_15,
         opts_2]
  in let
    head_5 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "when", tup_el_8]
  in
    ErlangTuple
...
erlps__lguard__2 args =
  EXC.badarity (ErlangFun 2 erlps__lguard__2) args

erlps__guard0__2 :: ErlangFun
erlps__guard0__2 [es_0, opts_1] =
  let    head_4 = toErl 44
  in let arg_6 = ErlangFun 2 erlps__lexpr__2
  in
    erlps__expr_list__4
      [es_0, ErlangCons head_4 ErlangEmptyList, arg_6, opts_1]
erlps__guard0__2 [arg_8, arg_9] = EXC.function_clause unit
erlps__guard0__2 args =
  EXC.badarity (ErlangFun 2 erlps__guard0__2) args
...
erlps__body__2 [es_0, opts_1] =
  let    head_4 = toErl 44
  in let tup_el_6 = erlps__lexprs__2 [es_0, opts_1]
  in
    ErlangTuple
      [ErlangAtom "prefer_nl", ErlangCons head_4 ErlangEmptyList,
       tup_el_6]
erlps__body__2 [arg_9, arg_10] = EXC.function_clause unit
erlps__body__2 args =
  EXC.badarity (ErlangFun 2 erlps__body__2) args

erlps__lexpr__2 :: ErlangFun
erlps__lexpr__2 [e_0, opts_1] =
  let arg_3 = toErl 0
  in erlps__lexpr__3 [e_0, arg_3, opts_1]
erlps__lexpr__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__lexpr__2 args =
  EXC.badarity (ErlangFun 2 erlps__lexpr__2) args
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "lc"), _, e_0, qs_1]),
                 _prec_2, opts_3]
  =
  let    head_9 = erlps__lexpr__2 [e_0, opts_3]
  in let arg_14 = toErl " ||"
  in let head_13 = erlps__leaf__1 [arg_14]
  in let tup_el_16 = erlps__lc_quals__2 [qs_1, opts_3]
  in let
    head_6 =
      ErlangTuple
        [ErlangAtom "step",
  ...
  in let
    lcl_20 =
      ErlangTuple
        [ErlangAtom "list", ErlangCons head_6 ErlangEmptyList]
  in let tup_el_25 = toErl 91
  in let arg_34 = toErl " "
  in let tup_el_33 = erlps__leaf__1 [arg_34]
  in let
    head_31 =
      ErlangTuple
        [ErlangAtom "force_nl", tup_el_33,
         ErlangCons lcl_20 ErlangEmptyList]
  in let
    head_23 =
      ErlangTuple
        [ErlangAtom "seq", tup_el_25, ErlangEmptyList,
         ErlangCons ErlangEmptyList ErlangEmptyList,
         ErlangCons head_31 ErlangEmptyList]
  in let head_40 = toErl 93
  in
    ErlangTuple
      [ErlangAtom "list",
       ErlangCons head_23 (ErlangCons head_40 ErlangEmptyList)]
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "bc"), _, e_0, qs_1]),
                 _prec_2, opts_3]
  =
  let   
    p_4 = BIF.do_remote_fun_call "Erl.Parse" "erlps__max_prec__0" []
  ...
  in
    case matchExpr_7 of
      (ErlangTuple [p_5, _r_6]) ->
        ...
        in let el_15 = ErlangTuple [ErlangAtom "first", nl_9, tup_el_12]
  ...
  in
    case matchExpr_9 of
      (ErlangTuple [l_6, p_7, r_8]) ->
        ...
        in let head_16 = toErl 35
        in let
          sep_18 =
            erlps__hash_after_integer__2
              [rec_0, ErlangCons head_16 ErlangEmptyList]
        in let head_21 = ErlangTuple [ErlangAtom "atom", name_1]
        in let head_25 = toErl 46
          ...
          erlps__maybe_paren__3
            [p_7, prec_3,
             ErlangCons rl_13
               (ErlangCons
                  (ErlangCons sep_18
                     (ErlangCons head_21 (ErlangCons head_25 ErlangEmptyList)))
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "record_field"), _,
  ...
  in
    case matchExpr_7 of
      (ErlangTuple [_l_4, p_5, r_6]) ->
        let    head_8 = toErl 46
        in let head_10 = erlps__lexpr__3 [f_0, r_6, opts_2]
        in
          erlps__maybe_paren__3
            [p_5, prec_1,
  ...
  in
    case matchExpr_8 of
      (ErlangTuple [l_5, p_6, r_7]) ->
        ...
        in let head_14 = toErl 46
        in let head_16 = erlps__lexpr__3 [f_1, r_7, opts_3]
        in
          erlps__maybe_paren__3
            [p_6, prec_2,
             ErlangCons head_9
               (ErlangCons head_14 (ErlangCons head_16 ErlangEmptyList))]
      _ -> EXC.badmatch matchExpr_8
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "map"), _, fs_0]),
  ...
  in
    case matchExpr_6 of
      (ErlangTuple [p_4, _r_5]) ->
        let    tup_el_8 = toErl 35
        in let tup_el_9 = erlps__map_fields__2 [fs_0, opts_2]
        in let
          el_12 = ErlangTuple [ErlangAtom "first", tup_el_8, tup_el_9]
  ...
  in
    case matchExpr_8 of
      (ErlangTuple [l_5, p_6, _r_7]) ->
        ...
        in let head_15 = toErl 35
        in let
          sep_17 =
            erlps__hash_after_integer__2
              [map_0, ErlangCons head_15 ErlangEmptyList]
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "block"), _, es_0]),
  ...
  in let
    head_4 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "begin", tup_el_7]
  in let
    head_11 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in
    ErlangTuple
      [ErlangAtom "list",
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "case"), _, expr_0,
  ...
  in let
    head_10 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "case", tup_el_13]
  in let
    head_17 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "of"]
  in let
    tup_el_7 =
      ErlangTuple
        [ErlangAtom "list",
  ...
  in let
    head_25 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in
    ErlangTuple
      [ErlangAtom "list",
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "receive"), _, cs_0]),
  ...
  in let
    head_4 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "receive", tup_el_7]
  in let
    head_11 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in
    ErlangTuple
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "receive"), _, cs_0,
  ...
  in let
    head_22 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "receive", tup_el_25]
  in let
    head_29 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "after", al_19]
  in let
    head_34 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in
    ErlangTuple
      [ErlangAtom "list",
       ErlangCons head_22
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "fun"), a_0,
  ...
  in let arg_9 = ErlangTuple [ErlangAtom "fun", a_0, func_1]
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "fun"), _,
  ...
  in let head_14 = toErl "fun "
  in let head_18 = toErl 58
  in let head_22 = toErl 47
  in
    ErlangCons head_14
      (ErlangCons nameitem_7
         (ErlangCons head_18
            (ErlangCons callitem_10
               (ErlangCons head_22 (ErlangCons arityitem_13 ErlangEmptyList)))))
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "fun"), _,
  ...
  in let
    head_5 =
      ErlangTuple [ErlangAtom "first", ErlangAtom "fun", tup_el_8]
  in let
    head_13 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in
    ErlangTuple
      [ErlangAtom "list",
    ...
    head_6 =
      ErlangTuple
        [ErlangAtom "first",
         ...
         tup_el_13]
  in let
    head_20 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in
    ErlangTuple
      [ErlangAtom "list",
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "fun"), _,
  ...
  in let
    head_10 =
      ErlangTuple [ErlangAtom "first", ErlangAtom "fun", tup_el_13]
  in let
    head_18 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in let
    tup_el_7 =
      ErlangTuple
        [ErlangAtom "list",
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "try"), _, es_0,
    ...
    head_8 =
      case ErlangAtom "true" of
        _ | (==) scs_1 ErlangEmptyList ->
          ...
          in ErlangTuple [ErlangAtom "step", ErlangAtom "try", tup_el_11]
        _ ->
          let    tup_el_21 = erlps__body__2 [es_0, opts_4]
          in let
            head_18 =
              ErlangTuple [ErlangAtom "step", ErlangAtom "try", tup_el_21]
          in let
            head_25 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "of"]
          in let
            tup_el_15 =
              ErlangTuple
                [ErlangAtom "list",
    ...
    lop_34 =
      case ErlangAtom "true" of
        ...
        _ ->
          ...
          in let
            head_35 =
              ErlangTuple [ErlangAtom "step", ErlangAtom "catch", tup_el_38]
    ...
    lop_43 =
      case ErlangAtom "true" of
        ...
        _ ->
          ...
          in let
            head_44 =
              ErlangTuple [ErlangAtom "step", ErlangAtom "after", tup_el_47]
          in ErlangCons head_44 ErlangEmptyList
  in let
    head_52 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in let
    rop_42 =
  ...
  in let
    tup_el_6 =
      BIF.erlang__op_append [ErlangCons head_8 ErlangEmptyList, rop_33]
  ...
  in
    case matchExpr_6 of
      (ErlangTuple [p_4, r_5]) ->
        ...
        in let
          head_9 =
            ErlangTuple [ErlangAtom "step", ErlangAtom "catch", tup_el_12]
        in let
          el_17 =
            ErlangTuple
      ...
      _ -> EXC.badmatch matchExpr_6
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "maybe"), _, es_0]),
                 _, opts_1]
  =
  let    tup_el_7 = erlps__body__2 [es_0, opts_1]
  in let
    head_4 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "maybe", tup_el_7]
  in let
    head_11 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in
    ErlangTuple
      [ErlangAtom "list",
       ErlangCons head_4 (ErlangCons head_11 ErlangEmptyList)]
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "maybe"), _, es_0,
                               (ErlangTuple [(ErlangAtom "else"), _, cs_1])]),
                 _, opts_2]
  =
  let    tup_el_8 = erlps__body__2 [es_0, opts_2]
  in let
    head_5 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "maybe", tup_el_8]
  in let tup_el_15 = erlps__cr_clauses__2 [cs_1, opts_2]
  in let
    head_12 =
      ErlangTuple [ErlangAtom "step", ErlangAtom "else", tup_el_15]
  in let
    head_19 = ErlangTuple [ErlangAtom "reserved", ErlangAtom "end"]
  in
    ErlangTuple
      [ErlangAtom "list",
       ErlangCons head_5
         (ErlangCons head_12 (ErlangCons head_19 ErlangEmptyList))]
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "maybe_match"), _,
                               lhs_0, rhs_1]),
                 _, opts_2]
  =
  let    arg_4 = toErl 0
  in let pl_6 = erlps__lexpr__3 [lhs_0, arg_4, opts_2]
  in let arg_8 = toErl 0
  in let rl_10 = erlps__lexpr__3 [rhs_1, arg_8, opts_2]
  in let arg_19 = toErl " ?="
  in let head_18 = erlps__leaf__1 [arg_19]
  in let
    head_13 =
      ErlangTuple
        [ErlangAtom "cstep",
         ErlangCons pl_6 (ErlangCons head_18 ErlangEmptyList), rl_10]
  in
    ErlangTuple
      [ErlangAtom "list", ErlangCons head_13 ErlangEmptyList]
      ...
      (ErlangTuple [l_5, p_6, r_7]) ->
        ...
        in let
          head_19 =
            ErlangTuple
              [ErlangAtom "cstep",
               ErlangCons pl_12 (ErlangCons (ErlangAtom " =") ErlangEmptyList),
               rl_16]
        in let
          el_28 =
            ErlangTuple
...
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "op"), _, op_0,
                               arg_1]),
                 prec_2, opts_3]
  | ((==) op_0 (ErlangAtom "+")) || ((==) op_0 (ErlangAtom "-")) =
  let
    matchExpr_7 =
      BIF.do_remote_fun_call "Erl.Parse" "erlps__preop_prec__1" [op_0]
  in
    case matchExpr_7 of
      (ErlangTuple [p_5, r_6]) ->
        let    arg_10 = BIF.erlang__atom_to_list__1 [op_0]
        in let tup_el_9 = erlps__leaf__1 [arg_10]
        in let ol_12 = ErlangTuple [ErlangAtom "reserved", tup_el_9]
        in let head_15 = erlps__lexpr__3 [arg_1, r_6, opts_3]
        in
          erlps__maybe_paren__3
            [p_5, prec_2,
             ErlangCons ol_12 (ErlangCons head_15 ErlangEmptyList)]
      _ -> EXC.badmatch matchExpr_7
erlps__lexpr__3 [(ErlangTuple [(ErlangAtom "op"), _, op_0,
                               arg_1]),
                 prec_2, opts_3]
  ...
  in
    case matchExpr_8 of
      (ErlangTuple [l_5, p_6, r_7]) ->
        ...
        in let head_22 = toErl 58
        in
          erlps__maybe_paren__3
            [p_6, prec_2,
             ErlangCons nameitem_12
               (ErlangCons head_22 (ErlangCons callitem_16 ErlangEmptyList))]
      _ -> EXC.badmatch matchExpr_8
...
erlps__lexpr__3 [other_0, _precedence_1,
                 (ErlangTuple [(ErlangAtom "options"), (ErlangAtom "none"), _,
                               _])]
  =
  let    arg_3 = toErl "INVALID-FORM:~w:"
  in let
    arg_2 =
      BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__lexpr__3 [hookexpr_0, precedence_1,
  ...
  =
  ErlangTuple
    [ErlangAtom "hook", hookexpr_0, precedence_1, func_2, options_3]
erlps__lexpr__3 [arg_9, arg_10, arg_11] =
  EXC.function_clause unit
erlps__lexpr__3 args =
  EXC.badarity (ErlangFun 3 erlps__lexpr__3) args
...
erlps__hash_after_integer__2 args =
  EXC.badarity (ErlangFun 2 erlps__hash_after_integer__2) args
...
erlps__fun_info__1 args =
  EXC.badarity (ErlangFun 1 erlps__fun_info__1) args
...
erlps__bit_grp__2 args =
  EXC.badarity (ErlangFun 2 erlps__bit_grp__2) args

erlps__bit_elems__2 :: ErlangFun
erlps__bit_elems__2 [es_0, opts_1] =
  let    arg_3 = toErl 44
  in let arg_4 = ErlangFun 2 erlps__bit_elem__2
  in erlps__expr_list__4 [es_0, arg_3, arg_4, opts_1]
erlps__bit_elems__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__bit_elems__2 args =
  EXC.badarity (ErlangFun 2 erlps__bit_elems__2) args
    ...
    schars_18 =
      case ErlangAtom "true" of
        _ | (/=) sz_1 (ErlangAtom "default") ->
          let    head_11 = toErl 58
          in let head_13 = erlps__lexpr__3 [sz_1, p_4, opts_3]
          in
            ErlangCons vchars_8
  ...
  in
    case ErlangAtom "true" of
      _ | (/=) types_2 (ErlangAtom "default") ->
        let    head_21 = toErl 47
        in let tail_22 = erlps__bit_elem_types__1 [types_2]
        in ErlangCons schars_18 (ErlangCons head_21 tail_22)
      _ -> schars_18
erlps__bit_elem__2 [arg_24, arg_25] = EXC.function_clause unit
erlps__bit_elem__2 args =
  EXC.badarity (ErlangFun 2 erlps__bit_elem__2) args
...
erlps__bit_elem_types__1 args =
  EXC.badarity (ErlangFun 1 erlps__bit_elem_types__1) args
...
erlps__bit_elem_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__bit_elem_type__1) args

erlps__record_name__1 :: ErlangFun
erlps__record_name__1 [name_0] =
  let    head_1 = toErl 35
  in let head_3 = ErlangTuple [ErlangAtom "atom", name_0]
...
erlps__record_name__1 args =
  EXC.badarity (ErlangFun 1 erlps__record_name__1) args
...
erlps__record_fields__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__record_fields__2 args =
  EXC.badarity (ErlangFun 2 erlps__record_fields__2) args
      ...
      (ErlangTuple [l_4, _p_5, r_6]) ->
        ...
        in let
          head_18 =
            ErlangTuple
              [ErlangAtom "cstep",
               ErlangCons fl_11 (ErlangCons (ErlangAtom " =") ErlangEmptyList),
               vl_15]
        in
          ErlangTuple
      ...
      (ErlangTuple [l_5, _p_6, r_7]) ->
        ...
        in let
          head_21 =
            ErlangTuple
              [ErlangAtom "cstep",
               ErlangCons fl_12 (ErlangCons (ErlangAtom " =") ErlangEmptyList),
               vl_18]
        in
          ErlangTuple
...
erlps__record_field__2 [(ErlangTuple [(ErlangAtom "record_field"),
  ...
  =
  let arg_3 = toErl 0
  in erlps__lexpr__3 [f_0, arg_3, opts_1]
erlps__record_field__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__record_field__2 args =
  EXC.badarity (ErlangFun 2 erlps__record_field__2) args
...
erlps__map_fields__2 args =
  EXC.badarity (ErlangFun 2 erlps__map_fields__2) args
...
erlps__map_field__2 [(ErlangTuple [(ErlangAtom "map_field_assoc"),
  ...
  =
  let    arg_4 = toErl 0
  in let pl_6 = erlps__lexpr__3 [k_0, arg_4, opts_2]
  in let arg_15 = toErl " =>"
  in let head_14 = erlps__leaf__1 [arg_15]
  in let arg_19 = toErl 0
  in let tup_el_17 = erlps__lexpr__3 [v_1, arg_19, opts_2]
  in let
    head_9 =
      ErlangTuple
        [ErlangAtom "step",
         ErlangCons pl_6 (ErlangCons head_14 ErlangEmptyList), tup_el_17]
  in
    ErlangTuple
      [ErlangAtom "list", ErlangCons head_9 ErlangEmptyList]
...
erlps__map_field__2 args =
  EXC.badarity (ErlangFun 2 erlps__map_field__2) args
...
erlps__list__3 [(ErlangTuple [(ErlangAtom "nil"), _]), es_0,
  ...
  =
  let
    arg_2 = BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [es_0]
  in erlps__proper_list__2 [arg_2, opts_1]
erlps__list__3 [other_0, es_1, opts_2] =
  let
    arg_3 =
      BIF.lists__reverse__2 [es_1, ErlangCons other_0 ErlangEmptyList]
  in erlps__improper_list__2 [arg_3, opts_2]
erlps__list__3 [arg_9, arg_10, arg_11] = EXC.function_clause unit
erlps__list__3 args =
  EXC.badarity (ErlangFun 3 erlps__list__3) args
...
erlps__if_clauses__2 args =
  EXC.badarity (ErlangFun 2 erlps__if_clauses__2) args
...
erlps__if_clause__2 args =
  EXC.badarity (ErlangFun 2 erlps__if_clause__2) args

erlps__guard_no_when__2 :: ErlangFun
erlps__guard_no_when__2 [(ErlangCons e_0 es_1), opts_2]
  | isEList e_0 =
  let    arg_6 = toErl 59
  in let arg_7 = ErlangFun 2 erlps__guard0__2
  in
    erlps__expr_list__4 [ErlangCons e_0 es_1, arg_6, arg_7, opts_2]
erlps__guard_no_when__2 [(ErlangCons e_0 es_1), opts_2] =
  erlps__guard_no_when__2
    [ErlangCons (ErlangCons e_0 es_1) ErlangEmptyList, opts_2]
erlps__guard_no_when__2 [(ErlangEmptyList), _] =
  let arg_0 = toErl "true"
  in erlps__leaf__1 [arg_0]
erlps__guard_no_when__2 [arg_1, arg_2] = EXC.function_clause unit
erlps__guard_no_when__2 args =
  EXC.badarity (ErlangFun 2 erlps__guard_no_when__2) args
...
erlps__cr_clauses__2 args =
  EXC.badarity (ErlangFun 2 erlps__cr_clauses__2) args
...
erlps__cr_clause__2 [(ErlangTuple [(ErlangAtom "clause"), _,
  ...
  =
  let    arg_5 = toErl 0
  in let el_7 = erlps__lexpr__3 [t_0, arg_5, opts_3]
...
erlps__cr_clause__2 args =
  EXC.badarity (ErlangFun 2 erlps__cr_clause__2) args
...
erlps__try_clauses__2 args =
  EXC.badarity (ErlangFun 2 erlps__try_clauses__2) args
...
erlps__try_clause__2 [(ErlangTuple [(ErlangAtom "clause"), _,
  ...
  =
  let    arg_7 = toErl 0
  in let cs_9 = erlps__lexpr__3 [c_0, arg_7, opts_5]
  in let arg_11 = toErl 0
  in let el_13 = erlps__lexpr__3 [v_1, arg_11, opts_5]
  in let head_16 = toErl 58
  in let
    sl_24 =
      erlps__stack_backtrace__3
        [s_2,
         ErlangCons cs_9
           (ErlangCons head_16 (ErlangCons el_13 ErlangEmptyList)),
         opts_5]
...
erlps__try_clause__2 [arg_35, arg_36] = EXC.function_clause unit
erlps__try_clause__2 args =
  EXC.badarity (ErlangFun 2 erlps__try_clause__2) args
...
erlps__stack_backtrace__3 [s_0, el_1, opts_2] =
  let    head_5 = toErl 58
  in let arg_9 = toErl 0
  in let head_7 = erlps__lexpr__3 [s_0, arg_9, opts_2]
  in
    BIF.erlang__op_append
      [el_1, ErlangCons head_5 (ErlangCons head_7 ErlangEmptyList)]
erlps__stack_backtrace__3 [arg_12, arg_13, arg_14] =
  EXC.function_clause unit
erlps__stack_backtrace__3 args =
  EXC.badarity (ErlangFun 3 erlps__stack_backtrace__3) args
...
erlps__fun_clauses__3 [cs_0, opts_1, (ErlangAtom "unnamed")] =
  ...
  in let head_4 = toErl 59
  in
    erlps__nl_clauses__4
      [arg_2, ErlangCons head_4 ErlangEmptyList, opts_1, cs_0]
  ...
  let   
    arg_3 =
      ErlangFun 2
        (let
           lambda_4 [c_7, h_8] =
             let matchExpr_13 = erlps__fun_clause__2 [c_7, h_8]
             in
               case matchExpr_13 of
                 (ErlangTuple [(ErlangAtom "step"), gl_11, bl_12]) ->
                   ...
                   in
                     ErlangTuple
                       [ErlangAtom "step",
                        ErlangCons head_16 (ErlangCons gl_11 ErlangEmptyList),
                        bl_12]
                 _ -> EXC.badmatch matchExpr_13
           lambda_4 [arg_5, arg_6] = EXC.function_clause unit
           lambda_4 args = EXC.badarity (ErlangFun 2 lambda_4) args
         in lambda_4)
  in let head_23 = toErl 59
  in
    erlps__nl_clauses__4
      [arg_3, ErlangCons head_23 ErlangEmptyList, opts_1, cs_0]
...
erlps__fun_clause__2 [arg_17, arg_18] = EXC.function_clause unit
erlps__fun_clause__2 args =
  EXC.badarity (ErlangFun 2 erlps__fun_clause__2) args

erlps__cond_clauses__2 :: ErlangFun
erlps__cond_clauses__2 [cs_0, opts_1] =
  let arg_2 = ErlangFun 2 erlps__cond_clause__2
  in erlps__clauses__3 [arg_2, opts_1, cs_0]
erlps__cond_clauses__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__cond_clauses__2 args =
  EXC.badarity (ErlangFun 2 erlps__cond_clauses__2) args
    ...
    ErlangTuple
      [ErlangAtom "step",
       ErlangCons head_5
         (ErlangCons (ErlangAtom " ->") ErlangEmptyList),
       tup_el_11]
erlps__cond_clause__2 [arg_14, arg_15] = EXC.function_clause unit
erlps__cond_clause__2 args =
  EXC.badarity (ErlangFun 2 erlps__cond_clause__2) args
...
erlps__nl_clauses__4 args =
  EXC.badarity (ErlangFun 4 erlps__nl_clauses__4) args

erlps__clauses__3 :: ErlangFun
erlps__clauses__3 [type_0, opts_1, cs_2] =
  let    head_5 = toErl 59
  in let tup_el_7 = erlps__lexprs__3 [cs_2, type_0, opts_1]
  in
    ErlangTuple
      [ErlangAtom "prefer_nl", ErlangCons head_5 ErlangEmptyList,
       tup_el_7]
erlps__clauses__3 [arg_11, arg_12, arg_13] =
  EXC.function_clause unit
erlps__clauses__3 args =
  EXC.badarity (ErlangFun 3 erlps__clauses__3) args

erlps__lc_quals__2 :: ErlangFun
erlps__lc_quals__2 [qs_0, opts_1] =
  let    head_4 = toErl 44
  in let arg_8 = ErlangFun 2 erlps__lc_qual__2
...
erlps__lc_quals__2 args =
  EXC.badarity (ErlangFun 2 erlps__lc_quals__2) args
...
erlps__lc_qual__2 [(ErlangTuple [(ErlangAtom "b_generate"), _,
  ...
  =
  let    arg_4 = toErl 0
  in let pl_6 = erlps__lexpr__3 [pat_0, arg_4, opts_2]
  in let arg_15 = toErl " <="
  in let head_14 = erlps__leaf__1 [arg_15]
  in let arg_19 = toErl 0
  in let tup_el_17 = erlps__lexpr__3 [e_1, arg_19, opts_2]
  in let
    head_9 =
      ErlangTuple
        [ErlangAtom "step",
...
erlps__lc_qual__2 [q_0, opts_1] =
  let arg_3 = toErl 0
  in erlps__lexpr__3 [q_0, arg_3, opts_1]
erlps__lc_qual__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__lc_qual__2 args =
  EXC.badarity (ErlangFun 2 erlps__lc_qual__2) args
...
erlps__proper_list__2 [es_0, opts_1] =
  ...
  in let tup_el_4 = toErl 93
  in let head_6 = toErl 44
  in let tup_el_8 = erlps__lexprs__2 [es_0, opts_1]
  in
    ErlangTuple
      [ErlangAtom "seq", tup_el_3, tup_el_4,
       ErlangCons head_6 ErlangEmptyList, tup_el_8]
erlps__proper_list__2 [arg_11, arg_12] = EXC.function_clause unit
erlps__proper_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__proper_list__2) args

erlps__improper_list__2 :: ErlangFun
erlps__improper_list__2 [es_0, opts_1] =
  let    tup_el_3 = toErl 91
  in let tup_el_4 = toErl 93
  in let tup_el_7 = toErl 44
  in let head_6 = ErlangTuple [tup_el_7, ErlangAtom " |"]
...
erlps__improper_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__improper_list__2) args
...
erlps__tuple__2 args =
  EXC.badarity (ErlangFun 2 erlps__tuple__2) args
...
erlps__tuple__3 [es_0, f_1, opts_2] =
  ...
  in let tup_el_5 = toErl 125
  in let head_7 = toErl 44
  in let tup_el_9 = erlps__lexprs__3 [es_0, f_1, opts_2]
  in
    ErlangTuple
      [ErlangAtom "seq", tup_el_4, tup_el_5,
       ErlangCons head_7 ErlangEmptyList, tup_el_9]
erlps__tuple__3 [arg_13, arg_14, arg_15] =
  EXC.function_clause unit
erlps__tuple__3 args =
  EXC.badarity (ErlangFun 3 erlps__tuple__3) args

erlps__args__2 :: ErlangFun
erlps__args__2 [as_0, opts_1] =
  let    tup_el_3 = toErl 40
  in let tup_el_4 = toErl 41
  in let head_6 = toErl 44
  in let tup_el_8 = erlps__lexprs__2 [as_0, opts_1]
  in
    ErlangTuple
      [ErlangAtom "seq", tup_el_3, tup_el_4,
       ErlangCons head_6 ErlangEmptyList, tup_el_8]
...
erlps__args__2 args =
  EXC.badarity (ErlangFun 2 erlps__args__2) args
...
erlps__lexprs__2 args =
  EXC.badarity (ErlangFun 2 erlps__lexprs__2) args
  ...
  flmap
    (\ lc_5 ->
       let
         lcRet_6 =
           BIF.erlang__apply__2
             [f_1, ErlangCons lc_5 (ErlangCons opts_2 ErlangEmptyList)]
       in ErlangCons lcRet_6 ErlangEmptyList)
    es_0
erlps__lexprs__3 [arg_10, arg_11, arg_12] =
  EXC.function_clause unit
erlps__lexprs__3 args =
  EXC.badarity (ErlangFun 3 erlps__lexprs__3) args

erlps__maybe_paren__3 :: ErlangFun
erlps__maybe_paren__3 [p_0, prec_1, expr_2] | weakLt p_0 prec_1 =
  let    head_3 = toErl 40
  in let head_7 = toErl 41
  in
    ErlangCons head_3
      (ErlangCons expr_2 (ErlangCons head_7 ErlangEmptyList))
erlps__maybe_paren__3 [_p_0, _prec_1, expr_2] = expr_2
erlps__maybe_paren__3 [arg_3, arg_4, arg_5] =
  EXC.function_clause unit
erlps__maybe_paren__3 args =
  EXC.badarity (ErlangFun 3 erlps__maybe_paren__3) args
...
erlps__f__5 [(ErlangCons item_0 items_1), i0_2, st_3, wt_4, pp_5]
  ...
  in erlps__consecutive__6 [items_1, arg_7, i0_2, st_3, wt_4, pp_5]
...
erlps__f__5 [(ErlangTuple [(ErlangAtom "seq"), before_0, after_1,
  ...
  in let matchExpr_28 = erlps__unz__1 [charssizel_24]
  in
                ...
                nsepchars_43 =
                  case ErlangAtom "true" of
                    _ | (isEList sep_2) && ((/=) sep_2 ErlangEmptyList) ->
                      let    arg_38 = toErl 0
                      in let lop_40 = BIF.erlang__length__1 [charsl_26]
                      in let rop_42 = toErl 1
                      in let arg_39 = BIF.erlang__op_minus [lop_40, rop_42]
                      in BIF.erlang__max__2 [arg_38, arg_39]
                    _ -> toErl 0
              in let
                case_44 =
                ...
                case case_44 of
                  (ErlangTuple [(ErlangAtom "yes"), size_49]) ->
                    let   
                      chars_52 =
                        case ErlangAtom "true" of
                          _ | weakGt nsepchars_43 (toErl 0) ->
                            let arg_51 = toErl 32
                            in erlps__insert_sep__2 [charsl_26, arg_51]
                          _ -> charsl_26
                    in let
                  ...
                  (ErlangAtom "no") ->
                    let   
                      charslist_61 =
                        erlps__handle_step__4 [charssizel_24, i_16, st_5, pp_7]
                    in let
                      matchExpr_70 =
    ...
    arg_6 =
      ErlangTuple
        [ErlangAtom "prefer_nl", ErlangEmptyList,
         ErlangCons extrainfoitem_0 (ErlangCons item_1 ErlangEmptyList)]
...
erlps__f__5 [(ErlangTuple [(ErlangAtom "prefer_nl"), sep_0,
  ...
  in let matchExpr_17 = erlps__unz__1 [charssize2l_13]
  in
      ...
      (ErlangTuple [_charsl_15, sizes_16]) ->
        case ErlangAtom "true" of
          _ | (==) sizes_16 ErlangEmptyList ->
            ...
            in ErlangTuple [ErlangEmptyList, tup_el_19]
          _ ->
            let   
              tup_el_20 =
...
erlps__f__5 [arg_7, arg_8, arg_9, arg_10, arg_11] =
  EXC.function_clause unit
erlps__f__5 args = EXC.badarity (ErlangFun 5 erlps__f__5) args
...
erlps__fl__7 [(ErlangEmptyList), _sep_0, i0_1, after_2, st_3,
  ...
  in let head_14 = ErlangTuple [ErlangEmptyList, tup_el_16]
  in
    ErlangCons
      ...
      ErlangFun 2
        (let
           ...
           lambda_7 [(ErlangTuple [(ErlangAtom "cstep"), item1_36,
                     ...
                     s_38]
             =
             let charsize1_44 = erlps__f__5 [item1_36, i0_2, st_4, wt_5, pp_6]
             in
                 ...
                 (ErlangTuple [_, sz1_45]) ->
                   case ErlangAtom "true" of
                     _ | (ErlangAtom "true") ==
                           (falsifyErrors
                              (\ _ ->
                                 let lop_47 = BIF.erlang__is_integer__1 [sz1_45]
                                 in
                                   case lop_47 of
                                         ...
                                         rop_50 =
                                           case pp_6 of
                                             (ErlangTuple arr_53) | (DM.Just field_52) <-
                                               ...
                                               field_52
                                             _ ->
                                               EXC.badrecord (ErlangAtom "pp")
                                       in BIF.erlang__op_lesser [sz1_45, rop_50]
                       ...
                       in let head_70 = ErlangTuple [ErlangEmptyList, tup_el_72]
                       in
                         ErlangCons head_62 (ErlangCons head_70 ErlangEmptyList)
                     _ ->
                       let   
                         arg_84 =
                           case pp_6 of
           ...
           lambda_7 [(ErlangTuple [(ErlangAtom "reserved"), word_92]), s_93]
             ...
             let   
               head_94 =
                 erlps__f__5
                   [ErlangCons word_92 (ErlangCons s_93 ErlangEmptyList), i0_2,
                    st_4, wt_5, pp_6]
             in let tup_el_107 = toErl 0
             in let head_105 = ErlangTuple [ErlangEmptyList, tup_el_107]
               ...
               head_111 =
                 erlps__f__5
                   [ErlangCons item_109 (ErlangCons s_110 ErlangEmptyList),
                    i0_2, st_4, wt_5, pp_6]
             in let tup_el_124 = toErl 0
             in let head_122 = ErlangTuple [ErlangEmptyList, tup_el_124]
         ...
         in lambda_7)
  in let matchExpr_130 = erlps__sep__1 [sep0_1]
  in
    case matchExpr_130 of
      (ErlangTuple [sep_128, lastsep_129]) ->
        erlps__fl1__5 [citems_0, f_126, sep_128, lastsep_129, after_3]
      _ -> EXC.badmatch matchExpr_130
erlps__fl__7 [arg_136, arg_137, arg_138, arg_139, arg_140,
              arg_141, arg_142]
  =
  EXC.function_clause unit
erlps__fl__7 args = EXC.badarity (ErlangFun 7 erlps__fl__7) args
...
erlps__sep__1 [(ErlangCons (ErlangTuple [s_0,
  ...
  =
  ErlangTuple
    [ErlangCons s_0 ErlangEmptyList, ErlangCons ls_1 ErlangEmptyList]
...
erlps__sep__1 args =
  EXC.badarity (ErlangFun 1 erlps__sep__1) args
...
erlps__fl1__5 [(ErlangCons citem1_0 (ErlangCons citem2_1 (ErlangEmptyList))),
  ...
  let   
    head_6 =
      BIF.erlang__apply__2
        [f_2, ErlangCons citem1_0 (ErlangCons lastsep_4 ErlangEmptyList)]
  in let
    head_11 =
      BIF.erlang__apply__2
        [f_2, ErlangCons citem2_1 (ErlangCons after_5 ErlangEmptyList)]
...
erlps__fl1__5 [arg_16, arg_17, arg_18, arg_19, arg_20] =
  EXC.function_clause unit
erlps__fl1__5 args =
  EXC.badarity (ErlangFun 5 erlps__fl1__5) args
...
erlps__consecutive__6 args =
  EXC.badarity (ErlangFun 6 erlps__consecutive__6) args

erlps__unz__1 :: ErlangFun
erlps__unz__1 [charssizesl_0] =
  let
    arg_1 =
      BIF.do_remote_fun_call "Lists" "erlps__append__1" [charssizesl_0]
  in erlps__unz1__1 [arg_1]
erlps__unz__1 [arg_3] = EXC.function_clause unit
erlps__unz__1 args =
  EXC.badarity (ErlangFun 1 erlps__unz__1) args
...
erlps__unz1__1 args =
  EXC.badarity (ErlangFun 1 erlps__unz1__1) args
      ...
      ErlangFun 1
        (let
           lambda_2 [(ErlangTuple [_, sz_4])] =
             let rop_6 = toErl 0
             in BIF.erlang__op_exactNeq [sz_4, rop_6]
...
erlps__nonzero__1 args =
  EXC.badarity (ErlangFun 1 erlps__nonzero__1) args
...
erlps__maybe_newlines__6 args =
  EXC.badarity (ErlangFun 6 erlps__maybe_newlines__6) args
    ...
    i1_18 =
      case case_9 of
        ...
        _ ->
          ...
          in BIF.erlang__op_plus [lop_13, rop_17]
  in
...
erlps__maybe_sep__6 args =
  EXC.badarity (ErlangFun 6 erlps__maybe_sep__6) args
  ...
  in
    case case_12 of
      (ErlangAtom "atomic") | isEInt size_1 ->
        let    rop_15 = toErl 1
        in let size1_16 = BIF.erlang__op_plus [size_1, rop_15]
          ...
          case ErlangAtom "true" of
            _ | (ErlangAtom "true") ==
              ...
              let   
                a1_31 =
                  case ErlangAtom "true" of
                    _ | weakGt nsepchars_8 (toErl 0) ->
                      let head_27 = toErl 32
                      in ErlangCons chars_0 (ErlangCons head_27 a_10)
              ...
              in
                erlps__maybe_sep1__9
                  [charssizel_2, items_4, i0_5, arg_51, sep_7, nsepchars_8,
                   size1_16, ErlangCons chars_0 (ErlangCons sep_7 a_10), pp_11]
      _ ->
        let   
          lop_68 =
            case pp_11 of
              (ErlangTuple arr_71) | (DM.Just field_70) <- (arr_71 DA.!! 5) ->
                field_70
              _ -> EXC.badrecord (ErlangAtom "pp")
        in let rop_72 = toErl 1
        in let arg_67 = BIF.erlang__op_plus [lop_68, rop_72]
        in let arg_75 = toErl 0
        in
          erlps__maybe_sep1__9
            [charssizel_2, items_4, i0_5, arg_67, sep_7, nsepchars_8, arg_75,
...
erlps__maybe_sep1__9 args =
  EXC.badarity (ErlangFun 9 erlps__maybe_sep1__9) args
...
erlps__insert_newlines__4 [charssizesl_0, i_1, st_2, pp_3]
  ...
  in let matchExpr_10 = erlps__unz1__1 [arg_4]
  in
...
erlps__insert_newlines__4 args =
  EXC.badarity (ErlangFun 4 erlps__insert_newlines__4) args
        ...
        (let
           ...
           lambda_5 [(ErlangCons (ErlangTuple [c1_19,
             ...
             in let
               tup_el_23 =
                 erlps__insert_nl__3
                   [ErlangCons c1_19 (ErlangCons c2_21 ErlangEmptyList), arg_29,
                    st_2]
             in let
               tup_el_36 =
                 erlps__line_size__1
...
erlps__handle_step__4 args =
  EXC.badarity (ErlangFun 4 erlps__handle_step__4) args
...
erlps__insert_nl__3 args =
  EXC.badarity (ErlangFun 3 erlps__insert_nl__3) args
...
erlps__insert_sep__2 [(ErlangCons chars1_0 charsl_1), sep_2] =
  let
    tail_4 =
      flmap
        (\ lc_7 ->
           ErlangCons (ErlangCons sep_2 (ErlangCons lc_7 ErlangEmptyList))
             ErlangEmptyList)
        charsl_1
  in ErlangCons chars1_0 tail_4
erlps__insert_sep__2 [arg_13, arg_14] = EXC.function_clause unit
erlps__insert_sep__2 args =
  EXC.badarity (ErlangFun 2 erlps__insert_sep__2) args

erlps__nl_indent__2 :: ErlangFun
erlps__nl_indent__2 [(ErlangInt num_0), _t_1]
  | (ErlangInt num_0) == (toErl 0) =
  toErl 10
erlps__nl_indent__2 [i_0, t_1] | weakGt i_0 (toErl 0) =
  let    head_2 = toErl 10
  in let tail_3 = erlps__spaces__2 [i_0, t_1]
  in ErlangCons head_2 tail_3
erlps__nl_indent__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__nl_indent__2 args =
  EXC.badarity (ErlangFun 2 erlps__nl_indent__2) args
...
erlps__classify_item__1 args =
  EXC.badarity (ErlangFun 1 erlps__classify_item__1) args
...
erlps__same_line__4 [i0_0, sizel_1, nsepchars_2, pp_3] =
  EXC.tryCatch
    (\ _ ->
       let   
         lop_4 = BIF.do_remote_fun_call "Lists" "erlps__sum__1" [sizel_1]
       in let size_7 = BIF.erlang__op_plus [lop_4, nsepchars_2]
       in let lop_8 = erlps__incr__2 [i0_0, size_7]
       in let
         rop_11 =
           case pp_3 of
             (ErlangTuple arr_14) | (DM.Just field_13) <- (arr_14 DA.!! 5) ->
               field_13
             _ -> EXC.badrecord (ErlangAtom "pp")
       in let matchExpr_15 = BIF.erlang__op_lesserEq [lop_8, rop_11]
       in
...
erlps__same_line__4 [arg_21, arg_22, arg_23, arg_24] =
  EXC.function_clause unit
erlps__same_line__4 args =
  EXC.badarity (ErlangFun 4 erlps__same_line__4) args

erlps__line_size__1 :: ErlangFun
erlps__line_size__1 [sizel_0] =
  let arg_2 = toErl 0
  in erlps__line_size__3 [sizel_0, arg_2, ErlangAtom "false"]
erlps__line_size__1 [arg_4] = EXC.function_clause unit
erlps__line_size__1 args =
  EXC.badarity (ErlangFun 1 erlps__line_size__1) args
...
erlps__line_size__3 args =
  EXC.badarity (ErlangFun 3 erlps__line_size__3) args
...
erlps__nsz__2 [sz_1@(ErlangTuple [(ErlangAtom "line"), _len_0]),
  ...
  =
  sz_1
erlps__nsz__2 [size_0, i_1] | weakGeq i_1 (toErl 0) =
...
erlps__nsz__2 args =
  EXC.badarity (ErlangFun 2 erlps__nsz__2) args
...
erlps__incr__2 [i_0, _incr_1] | weakLt i_0 (toErl 0) = i_0
erlps__incr__2 [i_0, incr_1] = BIF.erlang__op_plus [i_0, incr_1]
erlps__incr__2 [arg_4, arg_5] = EXC.function_clause unit
erlps__incr__2 args =
  EXC.badarity (ErlangFun 2 erlps__incr__2) args

erlps__indentation__2 :: ErlangFun
erlps__indentation__2 [e_0, i_1] | weakLt i_1 (toErl 0) =
...
erlps__indentation__2 [e_0, i0_1] =
  ...
  in
    case case_5 of
      ...
      something_else -> EXC.case_clause something_else
erlps__indentation__2 [arg_9, arg_10] = EXC.function_clause unit
erlps__indentation__2 args =
  EXC.badarity (ErlangFun 2 erlps__indentation__2) args
...
erlps__has_nl__1 args =
  EXC.badarity (ErlangFun 1 erlps__has_nl__1) args
...
erlps__write_a_value__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__write_a_value__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_a_value__2) args

erlps__write_an_atom__2 :: ErlangFun
erlps__write_an_atom__2 [a_0, pp_1] =
  let arg_2 = erlps__write_atom__2 [a_0, pp_1]
  in erlps__flat_leaf__1 [arg_2]
erlps__write_an_atom__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__write_an_atom__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_an_atom__2) args
...
erlps__write_a_singleton_atom_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_a_singleton_atom_type__2)
    args
...
erlps__write_a_char__2 [c_0, pp_1] =
  ...
  in erlps__flat_leaf__1 [arg_2]
erlps__write_a_char__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__write_a_char__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_a_char__2) args
...
erlps__write_a_string__3 [s_0, i_1, pp_2] =
  ...
  in let arg_9 = toErl 5
  in let len_10 = BIF.erlang__max__2 [arg_3, arg_9]
  in let
    tup_el_12 = erlps__write_a_string__4 [s_0, len_10, len_10, pp_2]
  in ErlangTuple [ErlangAtom "list", tup_el_12]
erlps__write_a_string__3 [arg_17, arg_18, arg_19] =
  EXC.function_clause unit
erlps__write_a_string__3 args =
  EXC.badarity (ErlangFun 3 erlps__write_a_string__3) args
...
erlps__write_a_string__4 [s_0, n_1, len_2, pp_3] =
  ...
  in let rop_18 = toErl 5
  in let rop_16 = BIF.erlang__op_greater [n_1, rop_18]
  in let case_11 = BIF.erlang__op_and [lop_12, rop_16]
  in
    case case_11 of
      (ErlangAtom "true") ->
        let    rop_22 = toErl 1
        in let arg_20 = BIF.erlang__op_minus [n_1, rop_22]
...
erlps__write_a_string__4 args =
  EXC.badarity (ErlangFun 4 erlps__write_a_string__4) args
...
erlps__flat_leaf__1 args =
  EXC.badarity (ErlangFun 1 erlps__flat_leaf__1) args
    ...
    fun_3 =
      case pp_1 of
        (ErlangTuple arr_6) | (DM.Just field_5) <- (arr_6 DA.!! 1) ->
          field_5
        _ -> EXC.badrecord (ErlangAtom "pp")
  in BIF.erlang__apply__2 [fun_3, ErlangCons v_0 ErlangEmptyList]
erlps__write_value__2 [arg_7, arg_8] = EXC.function_clause unit
erlps__write_value__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_value__2) args
    ...
    fun_3 =
      case pp_1 of
        (ErlangTuple arr_6) | (DM.Just field_5) <- (arr_6 DA.!! 1) ->
          field_5
        _ -> EXC.badrecord (ErlangAtom "pp")
  in BIF.erlang__apply__2 [fun_3, ErlangCons a_0 ErlangEmptyList]
...
erlps__write_singleton_atom_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_singleton_atom_type__2)
    args
    ...
    fun_3 =
      case pp_1 of
        (ErlangTuple arr_6) | (DM.Just field_5) <- (arr_6 DA.!! 3) ->
          field_5
        _ -> EXC.badrecord (ErlangAtom "pp")
  in BIF.erlang__apply__2 [fun_3, ErlangCons s_0 ErlangEmptyList]
erlps__write_string__2 [arg_7, arg_8] = EXC.function_clause unit
    ...
    fun_3 =
      case pp_1 of
        (ErlangTuple arr_6) | (DM.Just field_5) <- (arr_6 DA.!! 4) ->
          field_5
        _ -> EXC.badrecord (ErlangAtom "pp")
  in BIF.erlang__apply__2 [fun_3, ErlangCons c_0 ErlangEmptyList]
erlps__write_char__2 [arg_7, arg_8] = EXC.function_clause unit
erlps__write_char__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_char__2) args

erlps__a0__0 :: ErlangFun
erlps__a0__0 [] =
  let arg_0 = toErl 0
  in BIF.do_remote_fun_call "Erl.Anno" "erlps__new__1" [arg_0]
erlps__a0__0 args = EXC.badarity (ErlangFun 0 erlps__a0__0) args
    ...
    arg_0 =
      ErlangFun 2
        (let
           lambda_1 [_, a_4] =
             let head_7 = toErl 32
             in ErlangTuple [a_4, ErlangCons head_7 a_4]
           lambda_1 [arg_2, arg_3] = EXC.function_clause unit
           lambda_1 args = EXC.badarity (ErlangFun 2 lambda_1) args
         in lambda_1)
  in let arg_11 = toErl 0
  in let arg_12 = toErl 30
  in let
    arg_10 =
      BIF.do_remote_fun_call "Lists" "erlps__seq__2" [arg_11, arg_12]
  in let
    matchExpr_14 =
      BIF.do_remote_fun_call "Lists" "erlps__mapfoldl__3"
...
erlps__spacetab__0 args =
  EXC.badarity (ErlangFun 0 erlps__spacetab__0) args

erlps__spaces__2 :: ErlangFun
erlps__spaces__2 [n_0, t_1] | weakLeq n_0 (toErl 30) =
  BIF.erlang__element__2 [n_0, t_1]
erlps__spaces__2 [n_0, t_1] =
  let    arg_3 = toErl 30
  in let head_2 = BIF.erlang__element__2 [arg_3, t_1]
  in let rop_8 = toErl 30
...
erlps__spaces__2 args =
  EXC.badarity (ErlangFun 2 erlps__spaces__2) args
...
erlps__wordtable__0 [] =
  ...
  in let head_7 = toErl ">>"
  in let head_9 = toErl "[]"
  in let head_11 = toErl "after"
  in let head_13 = toErl "begin"
  in let head_15 = toErl "case"
  in let head_17 = toErl "catch"
  in let head_19 = toErl "end"
  in let head_21 = toErl "fun"
  in let head_23 = toErl "if"
  in let head_25 = toErl "of"
  in let head_27 = toErl "receive"
  in let head_29 = toErl "try"
  in let head_31 = toErl "when"
  in let head_33 = toErl " ::"
  in let head_35 = toErl ".."
  in let head_37 = toErl " |"
  in let head_39 = toErl "maybe"
  in let head_41 = toErl "else"
  in let
    l_52 =
      flmap
        (\ lc_44 ->
           let matchExpr_49 = erlps__leaf__1 [lc_44]
           in
             case matchExpr_49 of
               (ErlangTuple [(ErlangAtom "leaf"), sz_47, s_48]) ->
                 let lcRet_45 = ErlangTuple [s_48, sz_47]
                                                              ...
                                                              (ErlangCons
                                                                 ...
                                                                 (ErlangCons
                                                                    ...
                                                                    (ErlangCons
                                                                       head_41
                                                                       ErlangEmptyList)))))))))))))))))))))
  in BIF.erlang__list_to_tuple__1 [l_52]
erlps__wordtable__0 args =
  EXC.badarity (ErlangFun 0 erlps__wordtable__0) args

erlps__word__2 :: ErlangFun
erlps__word__2 [(ErlangAtom " ->"), wt_0] =
  let arg_1 = toErl 1
  in BIF.erlang__element__2 [arg_1, wt_0]
erlps__word__2 [(ErlangAtom " ="), wt_0] =
  let arg_1 = toErl 2
  in BIF.erlang__element__2 [arg_1, wt_0]
erlps__word__2 [(ErlangAtom "<<"), wt_0] =
...
erlps__word__2 [(ErlangAtom " |"), wt_0] =
  let arg_1 = toErl 19
  in BIF.erlang__element__2 [arg_1, wt_0]
erlps__word__2 [(ErlangAtom "maybe"), wt_0] =
  let arg_1 = toErl 20
  in BIF.erlang__element__2 [arg_1, wt_0]
erlps__word__2 [(ErlangAtom "else"), wt_0] =
  let arg_1 = toErl 21
  in BIF.erlang__element__2 [arg_1, wt_0]
erlps__word__2 [arg_3, arg_4] = EXC.function_clause unit
erlps__word__2 args =
  EXC.badarity (ErlangFun 2 erlps__word__2) args

erlps__legalize_name__3 :: ErlangFun
erlps__legalize_name__3 [invalidname_0, stringname_1, used_2] =
  let   
    upper_4 =
      BIF.do_remote_fun_call "String" "erlps__to_upper__1"
        [stringname_1]
  in let newname_6 = BIF.erlang__list_to_atom__1 [upper_4]
  in
    case used_2 of
      (ErlangMap map_8) | (DM.Just _) <-
                            (Map.lookup newname_6 map_8) ->
        let head_11 = toErl 88
        in
          erlps__legalize_name__3
            [invalidname_0, ErlangCons head_11 stringname_1, used_2]
      (ErlangMap map_14) ->
        let mapExt_18 = ErlangMap (Map.singleton invalidname_0 newname_6)
        in BIF.maps__merge__2 [used_2, mapExt_18]
      something_else -> EXC.case_clause something_else
erlps__legalize_name__3 [arg_20, arg_21, arg_22] =
  EXC.function_clause unit
erlps__legalize_name__3 args =
  EXC.badarity (ErlangFun 3 erlps__legalize_name__3) args

erlps__fold_vars__3 :: ErlangFun
erlps__fold_vars__3 [f_0, acc0_1, forms_2] | isEList forms_2 =
  let
    arg_3 =
      ErlangFun 2
        (let
           lambda_4 [elem_7, acc_8] =
             erlps__fold_vars__3 [f_0, acc_8, elem_7]
           lambda_4 [arg_5, arg_6] = EXC.function_clause unit
           lambda_4 args = EXC.badarity (ErlangFun 2 lambda_4) args
         in lambda_4)
  in
    BIF.do_remote_fun_call "Lists" "erlps__foldl__3"
      [arg_3, acc0_1, forms_2]
erlps__fold_vars__3 [f_0, acc0_1,
                     v_2@(ErlangTuple [(ErlangAtom "var"), _, _])]
  =
  BIF.erlang__apply__2
    [f_0, ErlangCons v_2 (ErlangCons acc0_1 ErlangEmptyList)]
erlps__fold_vars__3 [f_0, acc0_1, form_2] | isETuple form_2 =
  let   
    arg_3 =
      ErlangFun 2
        (let
           ...
           lambda_4 args = EXC.badarity (ErlangFun 2 lambda_4) args
         in lambda_4)
  in let arg_13 = BIF.erlang__tuple_to_list__1 [form_2]
  in
    BIF.do_remote_fun_call "Lists" "erlps__foldl__3"
      [arg_3, acc0_1, arg_13]
erlps__fold_vars__3 [_, acc_0, _] = acc_0
erlps__fold_vars__3 [arg_1, arg_2, arg_3] =
  EXC.function_clause unit
erlps__fold_vars__3 args =
  EXC.badarity (ErlangFun 3 erlps__fold_vars__3) args

erlps__map_vars__2 :: ErlangFun
erlps__map_vars__2 [f_0, forms_1] | isEList forms_1 =
  flmap
    (\ lc_4 ->
       let lcRet_5 = erlps__map_vars__2 [f_0, lc_4]
       in ErlangCons lcRet_5 ErlangEmptyList)
    forms_1
erlps__map_vars__2 [f_0,
                    v_1@(ErlangTuple [(ErlangAtom "var"), _, _])]
  =
  BIF.erlang__apply__2 [f_0, ErlangCons v_1 ErlangEmptyList]
erlps__map_vars__2 [f_0, form_1] | isETuple form_1 =
  let    lcSrc_3 = BIF.erlang__tuple_to_list__1 [form_1]
  in let
    arg_2 =
      flmap
        (\ lc_6 ->
           let lcRet_7 = erlps__map_vars__2 [f_0, lc_6]
           in ErlangCons lcRet_7 ErlangEmptyList)
        lcSrc_3
  in BIF.erlang__list_to_tuple__1 [arg_2]
erlps__map_vars__2 [_, form_0] = form_0
erlps__map_vars__2 [arg_1, arg_2] = EXC.function_clause unit
erlps__map_vars__2 args =
  EXC.badarity (ErlangFun 2 erlps__map_vars__2) args