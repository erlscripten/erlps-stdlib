...
erlps__print__2 [term_0, options_1] | isEList options_1 =
  ...
  in let
    col_5 =
      erlps__get_option__3 [ErlangAtom "column", options_1, arg_4]
  in let arg_8 = toErl 80
  in let
    ll_9 =
      erlps__get_option__3 [ErlangAtom "line_length", options_1, arg_8]
  in let op_arg_13 = toErl 1
  in let arg_12 = BIF.erlang__op_neg [op_arg_13]
  in let
    d_14 =
      erlps__get_option__3 [ErlangAtom "depth", options_1, arg_12]
  in let op_arg_18 = toErl 1
  in let arg_17 = BIF.erlang__op_neg [op_arg_18]
  in let
    m_19 =
      erlps__get_option__3
        [ErlangAtom "line_max_chars", options_1, arg_17]
  in let op_arg_23 = toErl 1
  in let arg_22 = BIF.erlang__op_neg [op_arg_23]
  in let
    t_24 =
      erlps__get_option__3
  ...
  in let
    recdeffun_28 =
      erlps__get_option__3
        [ErlangAtom "record_print_fun", options_1, ErlangAtom "no_fun"]
  in let
    arg_31 =
      BIF.do_remote_fun_call "Epp" "erlps__default_encoding__0" []
  in let
    encoding_32 =
      erlps__get_option__3 [ErlangAtom "encoding", options_1, arg_31]
  in let
    strings_36 =
      erlps__get_option__3
...
erlps__print__2 [term_0, recdeffun_1] =
  let    op_arg_4 = toErl 1
  in let arg_3 = BIF.erlang__op_neg [op_arg_4]
  in erlps__print__3 [term_0, arg_3, recdeffun_1]
erlps__print__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__print__2 args =
  EXC.badarity (ErlangFun 2 erlps__print__2) args

erlps__print__3 :: ErlangFun
erlps__print__3 [term_0, depth_1, recdeffun_2] =
  let    arg_4 = toErl 1
  in let arg_5 = toErl 80
  in erlps__print__5 [term_0, arg_4, arg_5, depth_1, recdeffun_2]
erlps__print__3 [arg_8, arg_9, arg_10] = EXC.function_clause unit
erlps__print__3 args =
  EXC.badarity (ErlangFun 3 erlps__print__3) args

erlps__print__4 :: ErlangFun
erlps__print__4 [term_0, col_1, ll_2, d_3] =
  let    op_arg_9 = toErl 1
  in let _m_10 = BIF.erlang__op_neg [op_arg_9]
  in let op_arg_12 = toErl 1
  in let _t_13 = BIF.erlang__op_neg [op_arg_12]
  in
    erlps__print__9
...
erlps__print__6 args =
  EXC.badarity (ErlangFun 6 erlps__print__6) args
...
erlps__print__9 [term_0, col_1, ll_2, d_3, m_4, t_5, recdeffun_6,
                 enc_7, str_8]
  | weakLeq col_1 (toErl 0) =
  let arg_10 = toErl 1
  in
    erlps__print__9
      [term_0, arg_10, ll_2, d_3, m_4, t_5, recdeffun_6, enc_7, str_8]
...
erlps__print__9 [term_0, col_1, ll_2, d_3, m0_4, t_5,
  ...
  | (((isETuple term_0) || (isEList term_0)) || (isEMap term_0)) ||
      (isEBinary term_0) =
  let    rop_11 = toErl 0
  in let case_9 = BIF.erlang__op_lesser [t_5, rop_11]
  in let
    if_24 =
      case case_9 of
        (ErlangAtom "true") ->
      ...
      (ErlangTuple [_, len_25, _dots_26, _]) ->
        ...
        in
          case ErlangAtom "true" of
            _ | (==) ll_2 (toErl 0) -> erlps__write__1 [if_24]
            _ | (ErlangAtom "true") ==
                  (falsifyErrors
                     (\ _ ->
                        let    rop_34 = BIF.erlang__op_minus [ll_2, col_1]
                        in let lop_32 = BIF.erlang__op_lesser [len_25, rop_34]
                        in
                          case lop_32 of
            ...
            _ ->
              let    op_arg_42 = toErl 1
              in let head_41 = BIF.erlang__op_neg [op_arg_42]
              in let head_44 = toErl 4
              in let
                arg_46 =
                  ErlangFun 1
                    (let
                       lambda_47 [i_49] =
                         let    arg_55 = toErl 0
                         in let arg_56 = toErl 0
                         in
                           erlps__cind__7
                             [if_24, col_1, ll_2, m_30, i_49, arg_55, arg_56]
                       lambda_47 [arg_48] = EXC.function_clause unit
                       lambda_47 args =
                         EXC.badarity (ErlangFun 1 lambda_47) args
                     in lambda_47)
              in let arg_57 = toErl 1
              in let
                tind_58 =
                  erlps__while_fail__3
                    [ErlangCons head_41 (ErlangCons head_44 ErlangEmptyList),
                     arg_46, arg_57]
              in let arg_64 = erlps__indent__1 [col_1]
              in let arg_66 = toErl 0
              in let arg_67 = toErl 0
              in
                erlps__pp__8
                  [if_24, col_1, ll_2, m_30, tind_58, arg_64, arg_66, arg_67]
...
erlps__print__9 args =
  EXC.badarity (ErlangFun 9 erlps__print__9) args

erlps__max_cs__2 :: ErlangFun
erlps__max_cs__2 [m_0, len_1] | weakLt m_0 (toErl 0) = len_1
erlps__max_cs__2 [m_0, _len_1] = m_0
erlps__max_cs__2 [arg_2, arg_3] = EXC.function_clause unit
erlps__max_cs__2 args =
  EXC.badarity (ErlangFun 2 erlps__max_cs__2) args
...
erlps__pp__8 [(ErlangTuple [(ErlangTuple [(ErlangAtom "list"),
  ...
  in let arg_13 = BIF.erlang__op_plus [col_2, rop_15]
  in let arg_20 = toErl 1
  in let arg_19 = erlps__indent__2 [arg_20, ind_6]
  in let arg_23 = toErl 124
  in let rop_26 = toErl 1
  in let arg_24 = BIF.erlang__op_plus [w_8, rop_26]
  in let
    head_11 =
      erlps__pp_list__9
        [l_0, arg_13, ll_3, m_4, tind_5, arg_19, ld_7, arg_23, arg_24]
  in let head_28 = toErl 93
  in
    ErlangCons head_9
      (ErlangCons head_11 (ErlangCons head_28 ErlangEmptyList))
erlps__pp__8 [(ErlangTuple [(ErlangTuple [(ErlangAtom "tuple"),
                                          (ErlangAtom "true"), l_0]),
                            _len_1, _, _]),
              col_2, ll_3, m_4, tind_5, ind_6, ld_7, w_8]
  =
  let    head_9 = toErl 123
  in let rop_21 = toErl 1
  in let arg_19 = BIF.erlang__op_plus [w_8, rop_21]
  in let
    head_11 =
      erlps__pp_tag_tuple__8
        [l_0, col_2, ll_3, m_4, tind_5, ind_6, ld_7, arg_19]
  in let head_23 = toErl 125
  in
    ErlangCons head_9
      (ErlangCons head_11 (ErlangCons head_23 ErlangEmptyList))
erlps__pp__8 [(ErlangTuple [(ErlangTuple [(ErlangAtom "tuple"),
...
erlps__pp__8 [(ErlangTuple [(ErlangTuple [(ErlangAtom "map"),
  ...
  =
  let    head_9 = toErl 35
  in let head_11 = toErl 123
  in let rop_17 = toErl 2
  in let arg_15 = BIF.erlang__op_plus [col_2, rop_17]
  in let arg_22 = toErl 2
  in let arg_21 = erlps__indent__2 [arg_22, ind_6]
  in let rop_27 = toErl 1
  in let arg_25 = BIF.erlang__op_plus [w_8, rop_27]
  in let
    head_13 =
      erlps__pp_map__8
        [pairs_0, arg_15, ll_3, m_4, tind_5, arg_21, ld_7, arg_25]
  in let head_29 = toErl 125
  in
    ErlangCons head_9
      (ErlangCons head_11
         (ErlangCons head_13 (ErlangCons head_29 ErlangEmptyList)))
erlps__pp__8 [(ErlangTuple [(ErlangTuple [(ErlangAtom "record"),
  ...
  =
  let    head_13 = toErl 123
  in let lop_25 = BIF.erlang__op_plus [w_10, nlen_1]
  in let rop_28 = toErl 1
  in let arg_24 = BIF.erlang__op_plus [lop_25, rop_28]
  in let
    head_15 =
      erlps__pp_record__9
        [l_2, nlen_1, col_4, ll_5, m_6, tind_7, ind_8, ld_9, arg_24]
  in let head_30 = toErl 125
  in
    ErlangCons name_0
      (ErlangCons head_13
         (ErlangCons head_15 (ErlangCons head_30 ErlangEmptyList)))
erlps__pp__8 [(ErlangTuple [(ErlangTuple [(ErlangAtom "bin"),
  ...
  =
  let    rop_12 = toErl 2
  in let arg_10 = BIF.erlang__op_plus [col_2, rop_12]
  in let arg_16 = toErl 2
  in let arg_15 = erlps__indent__2 [arg_16, ind_6]
  in
...
erlps__pp_tag_tuple__8 [(ErlangCons (ErlangTuple [tag_0, tlen_1,
  ...
  =
  let    rop_11 = toErl 2
  in let tagind_12 = BIF.erlang__op_plus [tlen_1, rop_11]
  in let tcol_15 = BIF.erlang__op_plus [col_3, tagind_12]
  in let s_16 = toErl 44
  in
    case ErlangAtom "true" of
      _ | (weakGt tind_6 (toErl 0)) && (weakGt tagind_12 tind_6) ->
        ...
        in let
          tail_24 =
            erlps__pp_tail__10
              [l_2, col1_19, tcol_15, ll_4, m_5, tind_6, indent_22, ld_8, s_16,
               arg_34]
        in ErlangCons tag_0 tail_24
      _ ->
        let    indent_39 = erlps__indent__2 [tagind_12, ind_7]
        in let lop_53 = BIF.erlang__op_plus [w_9, tlen_1]
        in let rop_56 = toErl 1
        in let arg_52 = BIF.erlang__op_plus [lop_53, rop_56]
        in let
          tail_43 =
            erlps__pp_list__9
              [l_2, tcol_15, ll_4, m_5, tind_6, indent_39, ld_8, s_16, arg_52]
        in ErlangCons tag_0 (ErlangCons s_16 tail_43)
erlps__pp_tag_tuple__8 [arg_57, arg_58, arg_59, arg_60, arg_61,
                        arg_62, arg_63, arg_64]
  =
  EXC.function_clause unit
erlps__pp_tag_tuple__8 args =
  EXC.badarity (ErlangFun 8 erlps__pp_tag_tuple__8) args
...
erlps__pp_map__8 args =
  EXC.badarity (ErlangFun 8 erlps__pp_map__8) args
...
erlps__pp_pairs_tail__9 [(ErlangCons p_1@(ErlangTuple [_, len_0,
  ...
  in let elen_16 = BIF.erlang__op_plus [lop_14, len_0]
  in
    case ErlangAtom "true" of
      _ | ((ErlangAtom "true") ==
             (falsifyErrors
                (\ _ ->
                   let    rop_21 = toErl 0
                   in let lop_19 = BIF.erlang__op_exactEq [ld1_13, rop_21]
                   in let
                     lop_18 =
                       case lop_19 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           let    rop_24 = toErl 1
                           in let lop_22 = BIF.erlang__op_plus [elen_16, rop_24]
                   ...
                   in let
                     lop_17 =
                       case lop_18 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           let    lop_29 = BIF.erlang__op_plus [w_10, elen_16]
                   ...
                   in
                     case lop_17 of
                       ...
                       (ErlangAtom "true") ->
                         ...
                         in let arg_39 = BIF.erlang__element__2 [arg_40, p_1]
                         in let arg_37 = BIF.erlang__element__2 [arg_38, arg_39]
                         in let arg_35 = BIF.erlang__element__2 [arg_36, arg_37]
                         ...
                         in
                           case lop_34 of
                             ...
                             (ErlangAtom "true") ->
                               let    arg_43 = toErl 1
                               in let arg_45 = toErl 3
                               in let arg_47 = toErl 1
                               in let
                                 arg_46 = BIF.erlang__element__2 [arg_47, p_1]
                               in let
                                 arg_44 =
                                   BIF.erlang__element__2 [arg_45, arg_46]
                               in let
                                 arg_42 =
                                   BIF.erlang__element__2 [arg_43, arg_44]
            ...
            ((ErlangAtom "true") ==
               (falsifyErrors
                  (\ _ ->
                     let    rop_53 = toErl 0
                     in let lop_51 = BIF.erlang__op_greater [ld1_13, rop_53]
                     in let
                       lop_50 =
                         case lop_51 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_56 = BIF.erlang__op_minus [ll_5, col_4]
                             in let
                               rop_55 = BIF.erlang__op_minus [lop_56, ld1_13]
                             in BIF.erlang__op_lesser [elen_16, rop_55]
                     ...
                     in let
                       lop_49 =
                         case lop_50 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_61 = BIF.erlang__op_plus [w_10, elen_16]
                             in let
                               lop_60 = BIF.erlang__op_plus [lop_61, ld1_13]
                     ...
                     in
                       case lop_49 of
                         ...
                         (ErlangAtom "true") ->
                           let    arg_68 = toErl 1
                           in let arg_70 = toErl 2
                           in let arg_72 = toErl 1
                           in let arg_71 = BIF.erlang__element__2 [arg_72, p_1]
                           in let
                             arg_69 = BIF.erlang__element__2 [arg_70, arg_71]
                           in let
                             arg_67 = BIF.erlang__element__2 [arg_68, arg_69]
                           ...
                           in
                             case lop_66 of
                               ...
                               (ErlangAtom "true") ->
                                 let    arg_75 = toErl 1
                                 in let arg_77 = toErl 3
                                 in let arg_79 = toErl 1
                                 in let
                                   arg_78 = BIF.erlang__element__2 [arg_79, p_1]
                                 in let
                                   arg_76 =
                                     BIF.erlang__element__2 [arg_77, arg_78]
                                 in let
                                   arg_74 =
                                     BIF.erlang__element__2 [arg_75, arg_76]
                                 in BIF.erlang__is_list__1 [arg_74]
                               _ -> EXC.badarg1 lop_66
                         _ -> EXC.badarg1 lop_49))) ->
        let    head_81 = toErl 44
        in let head_83 = erlps__write_pair__1 [p_1]
        in let arg_88 = BIF.erlang__op_plus [col_4, elen_16]
        in let arg_96 = BIF.erlang__op_plus [w_10, elen_16]
        in let
          tail_85 =
            erlps__pp_pairs_tail__9
              [ps_2, col0_3, arg_88, ll_5, m_6, tind_7, ind_8, ld_9, arg_96]
        in ErlangCons head_81 (ErlangCons head_83 tail_85)
      _ ->
        let    arg_106 = toErl 0
        in let
          matchExpr_109 =
            erlps__pp_pair__8
              [p_1, col0_3, ll_5, m_6, tind_7, ind_8, ld1_13, arg_106]
        in
          case matchExpr_109 of
            (ErlangTuple [ps_107, pw_108]) ->
              let    head_110 = toErl 44
              in let head_112 = toErl 10
              in let arg_120 = BIF.erlang__op_plus [col0_3, pw_108]
              in let
                tail_117 =
                  erlps__pp_pairs_tail__9
                    [ps_2, col0_3, arg_120, ll_5, m_6, tind_7, ind_8, ld_9,
                     pw_108]
              in
                ErlangCons head_110
                  (ErlangCons head_112
                     (ErlangCons ind_8 (ErlangCons ps_107 tail_117)))
            _ -> EXC.badmatch matchExpr_109
erlps__pp_pairs_tail__9 [arg_129, arg_130, arg_131, arg_132,
                         arg_133, arg_134, arg_135, arg_136, arg_137]
  =
  EXC.function_clause unit
erlps__pp_pairs_tail__9 args =
  EXC.badarity (ErlangFun 9 erlps__pp_pairs_tail__9) args
        ...
        _ | (ErlangAtom "true") ==
              (falsifyErrors
                 (\ _ ->
                    ...
                    in let arg_17 = BIF.erlang__element__2 [arg_18, pair_1]
                    in let arg_15 = BIF.erlang__element__2 [arg_16, arg_17]
                    in let arg_13 = BIF.erlang__element__2 [arg_14, arg_15]
                    ...
                    in
                      case lop_12 of
                        ...
                        (ErlangAtom "true") ->
                          ...
                          in let
                            arg_24 = BIF.erlang__element__2 [arg_25, pair_1]
                          in let
                            arg_22 = BIF.erlang__element__2 [arg_23, arg_24]
                          in let
                            arg_20 = BIF.erlang__element__2 [arg_21, arg_22]
...
erlps__pp_pair__8 [(ErlangTuple [(ErlangTuple [(ErlangAtom "map_pair"),
  ...
  in let
    head_16 =
      erlps__pp__8 [k_0, col0_3, ll_4, m_5, tind_6, ind0_7, ld_8, w_9]
  in let head_26 = toErl " =>\n"
  in let arg_31 = BIF.erlang__op_plus [col0_3, i_11]
  in let arg_39 = toErl 0
  in let
    tail_29 =
      erlps__pp__8
        [v_1, arg_31, ll_4, m_5, tind_6, ind_14, ld_8, arg_39]
  in
    ErlangTuple
      [ErlangCons head_16
...
erlps__pp_pair__8 args =
  EXC.badarity (ErlangFun 8 erlps__pp_pair__8) args
...
erlps__pp_record__9 [(ErlangCons f_0 fs_1), nlen_2, col0_3, ll_4,
  ...
  =
  let    rop_11 = toErl 1
  in let nind_12 = BIF.erlang__op_plus [nlen_2, rop_11]
  in let
    matchExpr_22 =
...
erlps__pp_record__9 args =
  EXC.badarity (ErlangFun 9 erlps__pp_record__9) args
      ...
      _ | ((ErlangAtom "true") ==
                ...
                (\ _ ->
                   ...
                   in
                     case lop_17 of
                       ...
                       (ErlangAtom "true") ->
                         let    arg_35 = toErl 1
                         in let arg_37 = toErl 4
                         in let arg_39 = toErl 1
                         in let arg_38 = BIF.erlang__element__2 [arg_39, f_1]
                         in let arg_36 = BIF.erlang__element__2 [arg_37, arg_38]
                         in let arg_34 = BIF.erlang__element__2 [arg_35, arg_36]
            ...
            ((ErlangAtom "true") ==
               (falsifyErrors
                  (\ _ ->
                     let    rop_45 = toErl 0
                     in let lop_43 = BIF.erlang__op_greater [ld1_13, rop_45]
                     in let
                       lop_42 =
                         case lop_43 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_48 = BIF.erlang__op_minus [ll_5, col_4]
                             in let
                               rop_47 = BIF.erlang__op_minus [lop_48, ld1_13]
                             in BIF.erlang__op_lesser [elen_16, rop_47]
                     ...
                     in let
                       lop_41 =
                         case lop_42 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_53 = BIF.erlang__op_plus [w_10, elen_16]
                             in let
                               lop_52 = BIF.erlang__op_plus [lop_53, ld1_13]
                     ...
                     in
                       case lop_41 of
                         ...
                         (ErlangAtom "true") ->
                           let    arg_59 = toErl 1
                           in let arg_61 = toErl 4
                           in let arg_63 = toErl 1
                           in let arg_62 = BIF.erlang__element__2 [arg_63, f_1]
                           in let
                             arg_60 = BIF.erlang__element__2 [arg_61, arg_62]
                           in let
                             arg_58 = BIF.erlang__element__2 [arg_59, arg_60]
                           in BIF.erlang__is_list__1 [arg_58]
                         _ -> EXC.badarg1 lop_41))) ->
        let    head_65 = toErl 44
        in let head_67 = erlps__write_field__1 [f_1]
        in let arg_72 = BIF.erlang__op_plus [col_4, elen_16]
        in let arg_80 = BIF.erlang__op_plus [w_10, elen_16]
        in let
          tail_69 =
            erlps__pp_fields_tail__9
              [fs_2, col0_3, arg_72, ll_5, m_6, tind_7, ind_8, ld_9, arg_80]
        in ErlangCons head_65 (ErlangCons head_67 tail_69)
      _ ->
        let    arg_90 = toErl 0
        in let
          matchExpr_93 =
            erlps__pp_field__8
              [f_1, col0_3, ll_5, m_6, tind_7, ind_8, ld1_13, arg_90]
        in
          case matchExpr_93 of
            (ErlangTuple [fs_91, fw_92]) ->
              let    head_94 = toErl 44
              in let head_96 = toErl 10
              in let arg_104 = BIF.erlang__op_plus [col0_3, fw_92]
              in let
                tail_101 =
                  erlps__pp_fields_tail__9
                    [fs_2, col0_3, arg_104, ll_5, m_6, tind_7, ind_8, ld_9,
                     fw_92]
              in
                ErlangCons head_94
                  (ErlangCons head_96
                     (ErlangCons ind_8 (ErlangCons fs_91 tail_101)))
            _ -> EXC.badmatch matchExpr_93
erlps__pp_fields_tail__9 [arg_113, arg_114, arg_115, arg_116,
                          arg_117, arg_118, arg_119, arg_120, arg_121]
  =
  EXC.function_clause unit
erlps__pp_fields_tail__9 args =
  EXC.badarity (ErlangFun 9 erlps__pp_fields_tail__9) args
      ...
      case ErlangAtom "true" of
        _ | (ErlangAtom "true") ==
              (falsifyErrors
                 (\ _ ->
                    let    arg_13 = toErl 1
                    in let arg_15 = toErl 4
                    in let arg_17 = toErl 1
                    in let arg_16 = BIF.erlang__element__2 [arg_17, fl_1]
                    in let arg_14 = BIF.erlang__element__2 [arg_15, arg_16]
  ...
  in
    case matchExpr_21 of
      (ErlangTuple [col_17, ind_18, s_19, w_20]) ->
        ...
        in let
          tail_31 =
            erlps__pp__8 [f_2, col_17, ll_4, m_5, tind_6, ind_18, ld_8, w_20]
        in
          ErlangTuple
            [ErlangCons name_0 (ErlangCons sep_24 (ErlangCons s_19 tail_31)),
             ll_4]
      _ -> EXC.badmatch matchExpr_21
...
erlps__pp_field__8 args =
  EXC.badarity (ErlangFun 8 erlps__pp_field__8) args

erlps__rec_indent__5 :: ErlangFun
erlps__rec_indent__5 [rind_0, tind_1, col0_2, ind0_3, w0_4] =
  let    rop_7 = toErl 0
  in let lop_5 = BIF.erlang__op_greater [tind_1, rop_7]
  ...
  in let
    s_23 =
      case nl_11 of
        (ErlangAtom "true") ->
          let head_21 = toErl 10
          in ErlangCons head_21 ind_19
        (ErlangAtom "false") -> toErl ""
        something_else -> EXC.case_clause something_else
  in let
    w_25 =
      case nl_11 of
        (ErlangAtom "true") -> toErl 0
...
erlps__rec_indent__5 args =
  EXC.badarity (ErlangFun 5 erlps__rec_indent__5) args
...
erlps__pp_list__9 args =
  EXC.badarity (ErlangFun 9 erlps__pp_list__9) args
...
erlps__pp_tail__10 [(ErlangCons e_1@(ErlangTuple [_, len_0, _,
  ...
  in let elen_17 = BIF.erlang__op_plus [lop_15, len_0]
  in
    case ErlangAtom "true" of
      _ | ((ErlangAtom "true") ==
             (falsifyErrors
                (\ _ ->
                   let    rop_22 = toErl 0
                   in let lop_20 = BIF.erlang__op_exactEq [ld1_14, rop_22]
                   in let
                     lop_19 =
                       case lop_20 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           let    rop_25 = toErl 1
                           in let lop_23 = BIF.erlang__op_plus [elen_17, rop_25]
                   ...
                   in let
                     lop_18 =
                       case lop_19 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           let    lop_30 = BIF.erlang__op_plus [w_11, elen_17]
                           in let rop_33 = toErl 1
                           in let lop_29 = BIF.erlang__op_plus [lop_30, rop_33]
                   ...
                   in
                     case lop_18 of
                       ...
                       (ErlangAtom "true") ->
                         let    arg_36 = toErl 1
                         in let arg_35 = BIF.erlang__element__2 [arg_36, e_1]
            ...
            ((ErlangAtom "true") ==
               (falsifyErrors
                  (\ _ ->
                     let    rop_42 = toErl 0
                     in let lop_40 = BIF.erlang__op_greater [ld1_14, rop_42]
                     in let
                       lop_39 =
                         case lop_40 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_45 = BIF.erlang__op_minus [ll_5, col_4]
                             in let
                               rop_44 = BIF.erlang__op_minus [lop_45, ld1_14]
                             in BIF.erlang__op_lesser [elen_17, rop_44]
                     ...
                     in let
                       lop_38 =
                         case lop_39 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_50 = BIF.erlang__op_plus [w_11, elen_17]
                             in let
                               lop_49 = BIF.erlang__op_plus [lop_50, ld1_14]
                             in BIF.erlang__op_lesserEq [lop_49, m_6]
                     ...
                     in
                       case lop_38 of
                         ...
                         (ErlangAtom "true") ->
                           let    arg_56 = toErl 1
                           in let arg_55 = BIF.erlang__element__2 [arg_56, e_1]
                           in BIF.erlang__is_list__1 [arg_55]
                         _ -> EXC.badarg1 lop_38))) ->
        let    head_58 = toErl 44
        in let head_60 = erlps__write__1 [e_1]
        in let arg_65 = BIF.erlang__op_plus [col_4, elen_17]
        in let arg_74 = BIF.erlang__op_plus [w_11, elen_17]
        in let
          tail_62 =
            erlps__pp_tail__10
              [es_2, col0_3, arg_65, ll_5, m_6, tind_7, ind_8, ld_9, s_10,
               arg_74]
        in ErlangCons head_58 (ErlangCons head_60 tail_62)
      _ ->
        let    arg_84 = toErl 0
        in let
          matchExpr_87 =
            erlps__pp_element__8
              [e_1, col0_3, ll_5, m_6, tind_7, ind_8, ld1_14, arg_84]
        in
          case matchExpr_87 of
            (ErlangTuple [es_85, we_86]) ->
              let    head_88 = toErl 44
              in let head_90 = toErl 10
              in let arg_98 = BIF.erlang__op_plus [col0_3, we_86]
              in let
                tail_95 =
                  erlps__pp_tail__10
                    [es_2, col0_3, arg_98, ll_5, m_6, tind_7, ind_8, ld_9, s_10,
                     we_86]
              in
                ErlangCons head_88
                  (ErlangCons head_90
                     (ErlangCons ind_8 (ErlangCons es_85 tail_95)))
            _ -> EXC.badmatch matchExpr_87
...
erlps__pp_tail__10 [e_1@(ErlangTuple [_, len_0, _, _]), _col0_2,
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            let    rop_18 = toErl 1
            in let lop_16 = BIF.erlang__op_plus [len_0, rop_18]
            in let lop_20 = BIF.erlang__op_minus [ll_4, col_3]
            in let rop_25 = toErl 1
            in let rop_23 = BIF.erlang__op_plus [ld_8, rop_25]
            ...
            in let
              lop_14 =
                case lop_15 of
                  ...
                  (ErlangAtom "true") ->
                    let    rop_30 = toErl 1
                    in let lop_28 = BIF.erlang__op_plus [len_0, rop_30]
                    in let lop_27 = BIF.erlang__op_plus [lop_28, w_10]
                    in let rop_34 = toErl 1
                    in let rop_32 = BIF.erlang__op_plus [ld_8, rop_34]
            ...
            in
              case lop_14 of
                ...
                (ErlangAtom "true") ->
                  let    arg_37 = toErl 1
                  in let arg_36 = BIF.erlang__element__2 [arg_37, e_1]
...
erlps__pp_tail__10 [e_0, col0_1, _col_2, ll_3, m_4, tind_5,
                    ind_6, ld_7, s_8, _w_9]
  =
  let    head_12 = toErl 10
  in let rop_24 = toErl 1
  in let arg_22 = BIF.erlang__op_plus [ld_7, rop_24]
  in let arg_25 = toErl 0
  in let
    tail_15 =
      erlps__pp__8
        [e_0, col0_1, ll_3, m_4, tind_5, ind_6, arg_22, arg_25]
  in ErlangCons s_8 (ErlangCons head_12 (ErlangCons ind_6 tail_15))
erlps__pp_tail__10 [arg_26, arg_27, arg_28, arg_29, arg_30,
                    arg_31, arg_32, arg_33, arg_34, arg_35]
  =
  EXC.function_clause unit
erlps__pp_tail__10 args =
  EXC.badarity (ErlangFun 10 erlps__pp_tail__10) args
         ...
         (\ _ ->
            ...
            in
              case lop_12 of
                ...
                (ErlangAtom "true") ->
                  let    arg_27 = toErl 1
                  in let arg_26 = BIF.erlang__element__2 [arg_27, e_1]
...
erlps__pp_element__8 args =
  EXC.badarity (ErlangFun 8 erlps__pp_element__8) args
...
erlps__pp_binary__7 [(ErlangCons lt_0 (ErlangCons lt_1 (ErlangCons s_2 (ErlangCons gt_3 (ErlangCons gt_4 (ErlangEmptyList)))))),
  ...
  , gt_4 == gt_3 =
  let    arg_11 = toErl 8
  in let arg_14 = BIF.erlang__op_minus [ll_6, col_5]
  in let rop_20 = toErl 4
  in let lop_18 = BIF.erlang__op_minus [m_7, rop_20]
  ...
  in let n_23 = BIF.erlang__max__2 [arg_11, arg_12]
...
erlps__pp_binary__7 args =
  EXC.badarity (ErlangFun 7 erlps__pp_binary__7) args
...
erlps__pp_binary__4 [(ErlangCons bs_0 (ErlangCons (ErlangInt num_1) s_2)),
  ...
  in let len_9 = BIF.erlang__op_plus [lop_6, rop_8]
  in let case_10 = BIF.erlang__op_minus [n_3, len_9]
  in
    case case_10 of
      n1_13 | weakLt n1_13 (toErl 0) ->
        let    head_14 = toErl 10
        in let head_20 = toErl 44
        in let arg_23 = BIF.erlang__op_minus [n0_4, len_9]
        in let tail_21 = erlps__pp_binary__4 [s_2, arg_23, n0_4, ind_5]
        in
          ErlangCons head_14
            (ErlangCons ind_5 (ErlangCons bs_0 (ErlangCons head_20 tail_21)))
      n1_28 ->
        let    head_31 = toErl 44
        in let tail_32 = erlps__pp_binary__4 [s_2, n1_28, n0_4, ind_5]
        in ErlangCons bs_0 (ErlangCons head_31 tail_32)
  ...
  , (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            ...
            in let lop_13 = BIF.erlang__op_plus [lop_14, rop_19]
...
erlps__pp_binary__4 args =
  EXC.badarity (ErlangFun 4 erlps__pp_binary__4) args
...
erlps__write__1 [(ErlangTuple [(ErlangTuple [(ErlangAtom "tuple"),
                               ...
                               _, _, _])]
  =
  let    head_2 = toErl 123
  in let arg_6 = toErl 44
  in let head_4 = erlps__write_list__2 [l_1, arg_6]
  in let head_8 = toErl 125
  in
    ErlangCons head_2
...
erlps__write__1 [(ErlangTuple [(ErlangTuple [(ErlangAtom "list"),
  ...
  =
  let    head_1 = toErl 91
  in let arg_5 = toErl 124
  in let head_3 = erlps__write_list__2 [l_0, arg_5]
  in let head_7 = toErl 93
  in
    ErlangCons head_1
...
erlps__write__1 [(ErlangTuple [(ErlangTuple [(ErlangAtom "map"),
  ...
  =
  let    head_1 = toErl 35
  in let head_3 = toErl 123
  in let arg_7 = toErl 44
  in let head_5 = erlps__write_list__2 [pairs_0, arg_7]
  in let head_9 = toErl 125
  in
    ErlangCons head_1
      (ErlangCons head_3
...
erlps__write__1 [(ErlangTuple [(ErlangTuple [(ErlangAtom "record"),
                               ...
                               _, _, _])]
  =
  let    head_4 = toErl 123
  in let head_6 = erlps__write_fields__1 [l_1]
  in let head_9 = toErl 125
  in
    ErlangCons name_0
      (ErlangCons head_4
...
erlps__write_pair__1 args =
  EXC.badarity (ErlangFun 1 erlps__write_pair__1) args

erlps__write_fields__1 :: ErlangFun
erlps__write_fields__1 [(ErlangEmptyList)] = toErl ""
...
erlps__write_fields__1 args =
  EXC.badarity (ErlangFun 1 erlps__write_fields__1) args

erlps__write_fields_tail__1 :: ErlangFun
erlps__write_fields_tail__1 [(ErlangEmptyList)] = toErl ""
...
erlps__write_fields_tail__1 [(ErlangCons f_0 fs_1)] =
  let    head_2 = toErl 44
  in let head_4 = erlps__write_field__1 [f_0]
  in let tail_6 = erlps__write_fields_tail__1 [fs_1]
  in ErlangCons head_2 (ErlangCons head_4 tail_6)
erlps__write_fields_tail__1 [arg_8] = EXC.function_clause unit
erlps__write_fields_tail__1 args =
  EXC.badarity (ErlangFun 1 erlps__write_fields_tail__1) args
...
erlps__write_field__1 args =
  EXC.badarity (ErlangFun 1 erlps__write_field__1) args
...
erlps__write_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_list__2) args
...
erlps__write_tail__2 [(ErlangCons e_0 es_1), s_2] =
  let    head_3 = toErl 44
  in let head_5 = erlps__write__1 [e_0]
  in let tail_7 = erlps__write_tail__2 [es_1, s_2]
  in ErlangCons head_3 (ErlangCons head_5 tail_7)
...
erlps__write_tail__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_tail__2) args
...
erlps__intermediate__6 [term_0, d_1, t_2, rf_3, enc_4, str_5]
  ...
  in let
    if_13 =
      erlps__print_length__6 [term_0, d0_6, t_2, rf_3, enc_4, str_5]
  in
    case if_13 of
      (ErlangTuple [_, len_15, dots_16, _]) | (((==) dots_16
                                                  (toErl 0)) ||
                                                 (weakGt len_15 t_2)) ||
                                                ((==) d_1 (toErl 1)) ->
        if_13
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            ...
            in BIF.erlang__op_exactEq [lop_11, rop_14])) =
  case lower_0 of
...
erlps__search_depth__9 [lower_0, upper_1, term_2, t_3, dl_4,
  ...
  in let rop_12 = toErl 2
  in let d1_13 = BIF.erlang__op_div_strict [lop_9, rop_12]
...
erlps__search_depth__9 args =
  EXC.badarity (ErlangFun 9 erlps__search_depth__9) args
...
erlps__print_length__6 [(ErlangEmptyList), _d_0, _t_1, _rf_2,
  ...
  =
  let    tup_el_5 = toErl "[]"
  in let tup_el_6 = toErl 2
  in let tup_el_7 = toErl 0
  in
    ErlangTuple [tup_el_5, tup_el_6, tup_el_7, ErlangAtom "no_more"]
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            ...
            in let rop_13 = toErl 0
            in BIF.erlang__op_exactEq [lop_11, rop_13])) =
  let    tup_el_7 = toErl "#{}"
  in let tup_el_8 = toErl 3
  in let tup_el_9 = toErl 0
  in
    ErlangTuple [tup_el_7, tup_el_8, tup_el_9, ErlangAtom "no_more"]
erlps__print_length__6 [atom_0, _d_1, _t_2, _rf_3, enc_4, _str_5]
  ...
  in ErlangTuple [s_8, tup_el_10, tup_el_12, ErlangAtom "no_more"]
  ...
  in
    case case_6 of
      (ErlangAtom "true") ->
        ...
        in ErlangTuple [s_14, tup_el_16, tup_el_18, ErlangAtom "no_more"]
      (ErlangTuple [(ErlangAtom "true"), prefix_20]) ->
        let    s_23 = erlps__write_string__2 [prefix_20, enc_4]
        in let tail_26 = toErl "..."
        in let lop_28 = toErl 3
        in let
          rop_29 =
            BIF.do_remote_fun_call "Io.Lib" "erlps__chars_length__1" [s_23]
        in let tup_el_27 = BIF.erlang__op_plus [lop_28, rop_29]
        in let tup_el_31 = toErl 0
        in
          ErlangTuple
            [ErlangCons s_23 tail_26, tup_el_27, tup_el_31,
             ErlangAtom "no_more"]
      (ErlangAtom "false") ->
        let
          case_33 =
...
erlps__print_length__6 [fun_0, _d_1, _t_2, _rf_3, _enc_4, _str_5]
  ...
  in ErlangTuple [s_7, tup_el_9, tup_el_11, ErlangAtom "no_more"]
erlps__print_length__6 [r_0, d_1, t_2, rf_3, enc_4, str_5]
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            let    arg_31 = toErl 1
            in let arg_30 = BIF.erlang__element__2 [arg_31, r_0]
  ...
  let    arg_8 = toErl 1
  in let arg_7 = BIF.erlang__element__2 [arg_8, r_0]
  ...
  in
    case case_6 of
      (ErlangAtom "no") ->
        erlps__print_length_tuple__6 [r_0, d_1, t_2, rf_3, enc_4, str_5]
      rdefs_21 ->
...
erlps__print_length__6 [(ErlangBinary binEnd_0), _d_1, _t_2,
                        _rf_3, _enc_4, _str_5]
  | BIN.empty binEnd_0 =
  let    tup_el_6 = toErl "<<>>"
  in let tup_el_7 = toErl 4
  in let tup_el_8 = toErl 0
  in
    ErlangTuple [tup_el_6, tup_el_7, tup_el_8, ErlangAtom "no_more"]
erlps__print_length__6 [bin_1@(ErlangBinary binSeg_0),
      ...
      ErlangFun 2
        (let
           lambda_7 [t1_10, dd_11] =
             let    lop_14 = toErl 1
             in let arg_13 = BIF.erlang__op_plus [lop_14, dd_11]
             in
               erlps__print_length__6 [bin_1, arg_13, t1_10, rf_4, enc_5, str_6]
           lambda_7 [arg_8, arg_9] = EXC.function_clause unit
           lambda_7 args = EXC.badarity (ErlangFun 2 lambda_7) args
         in lambda_7)
  in let tup_el_21 = toErl "<<...>>"
  in let tup_el_22 = toErl 7
  in let tup_el_23 = toErl 3
  in ErlangTuple [tup_el_21, tup_el_22, tup_el_23, more_20]
erlps__print_length__6 [bin_1@(ErlangBinary binSeg_0), d_2, t_3,
                        rf_4, enc_5, str_6]
  =
  let    rop_8 = toErl 1
  in let d1_9 = BIF.erlang__op_minus [d_2, rop_8]
  in let
    case_10 =
      case str_6 of
        (ErlangAtom "false") -> ErlangAtom "false"
        (ErlangAtom "true") ->
          ...
          in let lop_13 = BIF.erlang__op_rem_strict [lop_14, rop_16]
          in let rop_17 = toErl 0
          in let lop_12 = BIF.erlang__op_exactEq [lop_13, rop_17]
          in
            case lop_12 of
              (ErlangAtom "false") -> ErlangAtom "false"
              (ErlangAtom "true") ->
                let    arg_22 = toErl 6
                in let arg_20 = erlps__tsub__2 [t_3, arg_22]
                in erlps__printable_bin0__4 [bin_1, d1_9, arg_20, enc_5]
              _ -> EXC.badarg1 lop_12
        _ -> EXC.badarg1 str_6
  in
    case case_10 of
      (ErlangTuple [(ErlangAtom "true"), list_24]) | isEList list_24 ->
        let    arg_26 = toErl 34
        in let
          s_27 =
            BIF.do_remote_fun_call "Io.Lib" "erlps__write_string__2"
              [list_24, arg_26]
        in let head_29 = toErl 60
        in let head_31 = toErl 60
        in let head_35 = toErl 62
        in let head_37 = toErl 62
        in let lop_40 = toErl 4
        in let rop_41 = BIF.erlang__length__1 [s_27]
        in let tup_el_39 = BIF.erlang__op_plus [lop_40, rop_41]
        ...
        in
          ErlangTuple
            [ErlangCons head_29
             ...
             tup_el_39, tup_el_43, ErlangAtom "no_more"]
      (ErlangTuple [(ErlangAtom "false"), list_45]) | isEList
                                                        list_45 ->
        let    arg_47 = toErl 34
        in let
          s_48 =
            BIF.do_remote_fun_call "Io.Lib" "erlps__write_string__2"
              [list_45, arg_47]
        in let head_50 = toErl 60
        in let head_52 = toErl 60
        in let head_56 = toErl "/utf8>>"
        in let lop_59 = toErl 9
        in let
          rop_60 =
            BIF.do_remote_fun_call "Io.Lib" "erlps__chars_length__1" [s_48]
        in let tup_el_58 = BIF.erlang__op_plus [lop_59, rop_60]
        ...
        in
          ErlangTuple
            [ErlangCons head_50
             ...
             tup_el_58, tup_el_62, ErlangAtom "no_more"]
          ...
          more_81 =
            ErlangFun 2
              (let
               ...
               in lambda_68)
        in let head_83 = toErl 60
        in let head_85 = toErl 60
        in let tail_88 = toErl "...>>"
        in let lop_90 = toErl 7
        in let rop_91 = BIF.erlang__length__1 [s_67]
        in let tup_el_89 = BIF.erlang__op_plus [lop_90, rop_91]
        in let tup_el_93 = toErl 3
        in
          ErlangTuple
            [ErlangCons head_83
               (ErlangCons head_85 (ErlangCons s_67 tail_88)),
             tup_el_89, tup_el_93, more_81]
          ...
          more_112 =
            ErlangFun 2
              (let
               ...
               in lambda_99)
        in let head_114 = toErl 60
        in let head_116 = toErl 60
        in let tail_119 = toErl "/utf8...>>"
        in let lop_121 = toErl 12
        in let
          rop_122 =
            BIF.do_remote_fun_call "Io.Lib" "erlps__chars_length__1" [s_98]
        in let tup_el_120 = BIF.erlang__op_plus [lop_121, rop_122]
        in let tup_el_124 = toErl 3
        in
          ErlangTuple
            [ErlangCons head_114
               (ErlangCons head_116 (ErlangCons s_98 tail_119)),
             tup_el_120, tup_el_124, more_112]
      (ErlangAtom "false") ->
        let
          case_126 =
        ...
        in
          case case_126 of
            (ErlangTuple [s_130, (ErlangBinary binEnd_131)]) | BIN.empty
                                                                 binEnd_131 ->
              let    tup_el_132 = ErlangTuple [ErlangAtom "bin", s_130]
              in let tup_el_135 = BIF.erlang__iolist_size__1 [s_130]
              in let tup_el_137 = toErl 0
              in
                ErlangTuple
                  [tup_el_132, tup_el_135, tup_el_137, ErlangAtom "no_more"]
            (ErlangTuple [s_139, _rest_140]) ->
                ...
                more_154 =
                  ErlangFun 2
                    (let
                       ...
                       lambda_141 [arg_142, arg_143] = EXC.function_clause unit
                       lambda_141 args =
              ...
              in let tup_el_160 = toErl 3
              in ErlangTuple [tup_el_155, tup_el_158, tup_el_160, more_154]
            something_else -> EXC.case_clause something_else
      something_else -> EXC.case_clause something_else
erlps__print_length__6 [term_0, _d_1, _t_2, _rf_3, _enc_4,
  ...
  =
  let   
    s_7 = BIF.do_remote_fun_call "Io.Lib" "erlps__write__1" [term_0]
  in let
    tup_el_9 =
...
erlps__print_length__6 args =
  EXC.badarity (ErlangFun 6 erlps__print_length__6) args
    ...
    more_19 =
      ErlangFun 2
        (let
           lambda_6 [t1_9, dd_10] =
             let    lop_13 = toErl 1
             in let arg_12 = BIF.erlang__op_plus [lop_13, dd_10]
             in
         ...
         in lambda_6)
  in let tup_el_20 = toErl "#{...}"
  in let tup_el_21 = toErl 6
  in let tup_el_22 = toErl 3
  in ErlangTuple [tup_el_20, tup_el_21, tup_el_22, more_19]
erlps__print_length_map__6 [map_0, d_1, t_2, rf_3, enc_4, str_5]
  | isEMap map_0 =
  let   
    arg_6 =
  ...
  in let rop_13 = toErl 1
  in let arg_11 = BIF.erlang__op_minus [d_1, rop_13]
  in let arg_16 = toErl 3
  in let arg_14 = erlps__tsub__2 [t_2, arg_16]
  in let
    pairss_20 =
      erlps__print_length_map_pairs__7
        [next_8, d_1, arg_11, arg_14, rf_3, enc_4, str_5]
  in let arg_22 = toErl 3
  in let arg_23 = toErl 0
  in let
    matchExpr_26 = erlps__list_length__3 [pairss_20, arg_22, arg_23]
  in
    case matchExpr_26 of
      (ErlangTuple [len_24, dots_25]) ->
        let tup_el_27 = ErlangTuple [ErlangAtom "map", pairss_20]
        in ErlangTuple [tup_el_27, len_24, dots_25, ErlangAtom "no_more"]
...
erlps__print_length_map__6 args =
  EXC.badarity (ErlangFun 6 erlps__print_length_map__6) args
    ...
    more_21 =
      ErlangFun 2
        (let
         ...
         in lambda_7)
  in let tup_el_23 = toErl 3
  in let tup_el_24 = toErl 3
  in ErlangTuple [ErlangAtom "dots", tup_el_23, tup_el_24, more_21]
...
erlps__print_length_map_pairs__7 args =
  EXC.badarity (ErlangFun 7 erlps__print_length_map_pairs__7) args
  ...
  in
    case p1_13 of
      (ErlangTuple [_, kl_14, kd_15, _]) ->
        let    rop_18 = toErl 4
        in let kl1_19 = BIF.erlang__op_plus [kl_14, rop_18]
        ...
        in
          case p2_28 of
            (ErlangTuple [_, vl_29, vd_30, _]) ->
              let   
                tup_el_32 = ErlangTuple [ErlangAtom "map_pair", p1_13, p2_28]
...
erlps__print_length_map_pair__7 args =
  EXC.badarity (ErlangFun 7 erlps__print_length_map_pair__7) args
...
erlps__print_length_tuple__6 [tuple_0, d_1, t_2, rf_3, enc_4,
  ...
  in let arg_9 = erlps__tsub__2 [t_2, arg_11]
  in let
    l_15 =
      erlps__print_length_tuple1__7
        [tuple_0, arg_7, d_1, arg_9, rf_3, enc_4, str_5]
  in let arg_18 = toErl 1
  in let arg_17 = BIF.erlang__element__2 [arg_18, tuple_0]
  in let lop_16 = BIF.erlang__is_atom__1 [arg_17]
  in let lop_21 = BIF.erlang__tuple_size__1 [tuple_0]
  in let rop_23 = toErl 1
  in let rop_20 = BIF.erlang__op_greater [lop_21, rop_23]
  in let istagged_24 = BIF.erlang__op_and [lop_16, rop_20]
  in let arg_26 = toErl 2
  in let arg_27 = toErl 0
  in let
    matchExpr_30 = erlps__list_length__3 [l_15, arg_26, arg_27]
  in
    case matchExpr_30 of
      (ErlangTuple [len_28, dots_29]) ->
        let
          tup_el_31 = ErlangTuple [ErlangAtom "tuple", istagged_24, l_15]
        in ErlangTuple [tup_el_31, len_28, dots_29, ErlangAtom "no_more"]
...
erlps__print_length_tuple__6 args =
  EXC.badarity (ErlangFun 6 erlps__print_length_tuple__6) args
...
erlps__print_length_tuple1__7 args =
  EXC.badarity (ErlangFun 7 erlps__print_length_tuple1__7) args
    ...
    more_21 =
      ErlangFun 2
        (let
           ...
           lambda_7 args = EXC.badarity (ErlangFun 2 lambda_7) args
         in lambda_7)
  in let tup_el_22 = toErl "{...}"
  in let tup_el_23 = toErl 5
  in let tup_el_24 = toErl 3
  in ErlangTuple [tup_el_22, tup_el_23, tup_el_24, more_21]
erlps__print_length_record__7 [tuple_0, d_1, t_2, rf_3, rdefs_4,
                               enc_5, str_6]
  =
  let    head_7 = toErl 35
  in let arg_10 = toErl 1
  in let arg_9 = BIF.erlang__element__2 [arg_10, tuple_0]
  in let tail_8 = erlps__write_atom__2 [arg_9, enc_5]
  in let
    namel_15 =
      BIF.do_remote_fun_call "Io.Lib" "erlps__chars_length__1"
        [ErlangCons head_7 tail_8]
  in let rop_19 = toErl 2
  in let arg_17 = BIF.erlang__op_plus [namel_15, rop_19]
  in let t1_20 = erlps__tsub__2 [t_2, arg_17]
  in let rop_24 = toErl 1
  in let arg_22 = BIF.erlang__op_minus [d_1, rop_24]
  in let arg_27 = toErl 2
  in let
    l_31 =
      erlps__print_length_fields__8
        [rdefs_4, arg_22, t1_20, tuple_0, arg_27, rf_3, enc_5, str_6]
  in let rop_35 = toErl 2
  in let arg_33 = BIF.erlang__op_plus [namel_15, rop_35]
  in let arg_36 = toErl 0
  in let
    matchExpr_39 = erlps__list_length__3 [l_31, arg_33, arg_36]
  in
    case matchExpr_39 of
      (ErlangTuple [len_37, dots_38]) ->
        let    head_43 = ErlangTuple [ErlangCons head_7 tail_8, namel_15]
        in let
          tup_el_40 =
            ErlangTuple [ErlangAtom "record", ErlangCons head_43 l_31]
        in ErlangTuple [tup_el_40, len_37, dots_38, ErlangAtom "no_more"]
...
erlps__print_length_record__7 args =
  EXC.badarity (ErlangFun 7 erlps__print_length_record__7) args
    ...
    more_23 =
      ErlangFun 2
        (let
         ...
         in lambda_8)
  in let tup_el_25 = toErl 3
  in let tup_el_26 = toErl 3
  in ErlangTuple [ErlangAtom "dots", tup_el_25, tup_el_26, more_23]
...
erlps__print_length_fields__8 args =
  EXC.badarity (ErlangFun 8 erlps__print_length_fields__8) args
...
erlps__print_length_field__7 [def_0, d_1, t_2, e_3, rf_4, enc_5,
  ...
  in let
    lop_10 =
      BIF.do_remote_fun_call "Io.Lib" "erlps__chars_length__1" [name_9]
  in let rop_12 = toErl 3
  in let namel_13 = BIF.erlang__op_plus [lop_10, rop_12]
  ...
  in
    case field_22 of
      (ErlangTuple [_, len_23, dots_24, _]) ->
        ...
        in
          ErlangTuple [tup_el_26, tup_el_31, dots_24, ErlangAtom "no_more"]
...
erlps__print_length_field__7 args =
  EXC.badarity (ErlangFun 7 erlps__print_length_field__7) args
...
erlps__print_length_list__6 [list_0, d_1, t_2, rf_3, enc_4,
  ...
  =
  let    arg_10 = toErl 2
  in let arg_8 = erlps__tsub__2 [t_2, arg_10]
  in let
    l_14 =
  ...
  in let
    matchExpr_20 = erlps__list_length__3 [l_14, arg_16, arg_17]
  in
    case matchExpr_20 of
      (ErlangTuple [len_18, dots_19]) ->
        let tup_el_21 = ErlangTuple [ErlangAtom "list", l_14]
        in ErlangTuple [tup_el_21, len_18, dots_19, ErlangAtom "no_more"]
...
erlps__print_length_list__6 args =
  EXC.badarity (ErlangFun 6 erlps__print_length_list__6) args
    ...
    more_19 =
      ErlangFun 2
        (let
           ...
           lambda_6 args = EXC.badarity (ErlangFun 2 lambda_6) args
         in lambda_6)
  in let tup_el_21 = toErl 3
  in let tup_el_22 = toErl 3
  in ErlangTuple [ErlangAtom "dots", tup_el_21, tup_el_22, more_19]
...
erlps__print_length_list1__6 [e_0, d_1, t_2, rf_3, enc_4, str_5]
  =
  let    rop_9 = toErl 1
  in let arg_7 = BIF.erlang__op_minus [d_1, rop_9]
...
erlps__print_length_list1__6 args =
  EXC.badarity (ErlangFun 6 erlps__print_length_list1__6) args
...
erlps__list_length__3 args =
  EXC.badarity (ErlangFun 3 erlps__list_length__3) args
...
erlps__list_length_tail__3 [(ErlangCons (ErlangTuple [_, len_0,
  ...
  =
  let    rop_9 = toErl 1
  in let lop_7 = BIF.erlang__op_plus [acc_3, rop_9]
...
erlps__list_length_tail__3 [(ErlangTuple [_, len_0, dots_1, _]),
  ...
  =
  let    rop_7 = toErl 1
  in let lop_5 = BIF.erlang__op_plus [acc_2, rop_7]
...
erlps__list_length_tail__3 args =
  EXC.badarity (ErlangFun 3 erlps__list_length_tail__3) args
...
erlps__printable_list__4 [l_0, _d_1, t_2, (ErlangAtom "latin1")]
  | weakLt t_2 (toErl 0) =
  BIF.do_remote_fun_call "Io.Lib" "erlps__printable_latin1_list__1"
    [l_0]
erlps__printable_list__4 [l_0, _d_1, t_2, (ErlangAtom "latin1")]
  | weakGeq t_2 (toErl 0) =
  let    arg_4 = toErl 2
  in let n_5 = erlps__tsub__2 [t_2, arg_4]
...
erlps__printable_list__4 [l_0, _d_1, t_2, _unicode_3]
  | weakGeq t_2 (toErl 0) =
  let    arg_5 = toErl 2
  in let n_6 = erlps__tsub__2 [t_2, arg_5]
  in
    EXC.tryOfCatch
      (\ _ ->
         let arg_8 = toErl 0
             ...
             let   
               arg_16 =
                 BIF.do_remote_fun_call "Lists" "erlps__flatlength__1"
                   [prefix_13]
             in let case_14 = erlps__is_flat__2 [l_0, arg_16]
             in
               case case_14 of
                 (ErlangAtom "true") ->
                   let
                     ...
                     case case_18 of
                       ...
                       (ErlangAtom "false") ->
                         let
                           lop_22 =
                             BIF.do_remote_fun_call "Io.Lib"
                               "erlps__printable_list__1" [prefix_13]
                         in
                           case lop_22 of
                             (ErlangAtom "false") -> ErlangAtom "false"
                             (ErlangAtom "true") ->
                               ErlangTuple [ErlangAtom "true", prefix_13]
...
erlps__printable_list__4 [l_0, _d_1, t_2, _uni_3]
  | weakLt t_2 (toErl 0) =
  BIF.do_remote_fun_call "Io.Lib" "erlps__printable_list__1" [l_0]
erlps__printable_list__4 [arg_5, arg_6, arg_7, arg_8] =
  EXC.function_clause unit
erlps__printable_list__4 args =
  EXC.badarity (ErlangFun 4 erlps__printable_list__4) args
...
erlps__printable_bin0__4 args =
  EXC.badarity (ErlangFun 4 erlps__printable_bin0__4) args
...
erlps__printable_bin__4 [bin_0, len_1, d_2,
  ...
  =
  let    arg_3 = toErl 20
  in let n_5 = BIF.erlang__min__2 [arg_3, len_1]
  in let arg_7 = toErl 1
  in let l_9 = BIF.erlang__binary_to_list__3 [bin_0, arg_7, n_5]
  ...
  in
    case case_10 of
      (ErlangAtom "all") | (ErlangAtom "true") ==
                             (falsifyErrors
                                (\ _ ->
                                   let rop_14 = BIF.erlang__byte_size__1 [bin_0]
                                   in BIF.erlang__op_exactEq [n_5, rop_14])) ->
        ErlangTuple [ErlangAtom "true", l_9]
      (ErlangAtom "all") | (==) n_5 len_1 ->
        ErlangTuple [ErlangAtom "true", ErlangAtom "true", l_9]
      (ErlangAtom "all") ->
        let    lop_24 = toErl 1
        in let arg_23 = BIF.erlang__op_plus [lop_24, n_5]
        in let arg_26 = BIF.erlang__op_minus [len_1, n_5]
        in let case_21 = erlps__printable_bin1__3 [bin_0, arg_23, arg_26]
        in
          case case_21 of
            ...
            nc_36 | (ErlangAtom "true") ==
                      (falsifyErrors
                         (\ _ ->
                            let    rop_39 = toErl 0
                            in let lop_37 = BIF.erlang__op_greater [d_2, rop_39]
                            in
                              case lop_37 of
                                (ErlangAtom "false") -> ErlangAtom "false"
                                (ErlangAtom "true") ->
                                  let
                                    lop_40 = BIF.erlang__op_minus [len_1, nc_36]
                                  in BIF.erlang__op_greaterEq [lop_40, d_2]
                                _ -> EXC.badarg1 lop_37)) ->
              let    arg_48 = toErl 1
              in let arg_49 = BIF.erlang__op_minus [len_1, nc_36]
              in let
                tup_el_46 =
                  BIF.erlang__binary_to_list__3 [bin_0, arg_48, arg_49]
              in ErlangTuple [ErlangAtom "true", ErlangAtom "true", tup_el_46]
      ...
      nc_53 | (ErlangAtom "true") ==
                      ...
                      in let
                        lop_54 =
                          case lop_55 of
                            ...
                            (ErlangAtom "true") ->
                              let rop_58 = toErl 0
                              in BIF.erlang__op_greater [d_2, rop_58]
        ...
        let    arg_67 = toErl 1
        in let arg_68 = BIF.erlang__op_minus [n_5, nc_53]
        in let
          tup_el_65 = BIF.erlang__binary_to_list__3 [bin_0, arg_67, arg_68]
        in ErlangTuple [ErlangAtom "true", ErlangAtom "true", tup_el_65]
  ...
  in
    case case_4 of
      (ErlangAtom "true") ->
        ...
        in
          case case_7 of
            (ErlangTuple [_, (ErlangBinary binEnd_12), l_13]) | BIN.empty
                                                                  binEnd_12 ->
            ...
            something_else -> EXC.case_clause something_else
      (ErlangAtom "false") ->
        erlps__printable_bin__4 [bin_0, len_1, d_2, ErlangAtom "latin1"]
      something_else -> EXC.case_clause something_else
erlps__printable_bin__4 [arg_47, arg_48, arg_49, arg_50] =
  EXC.function_clause unit
erlps__printable_bin__4 args =
  EXC.badarity (ErlangFun 4 erlps__printable_bin__4) args
...
erlps__printable_bin1__3 [bin_0, start_1, len_2] =
  let    arg_3 = toErl 10000
  in let n_5 = BIF.erlang__min__2 [arg_3, len_2]
  in let lop_9 = BIF.erlang__op_plus [start_1, n_5]
  in let rop_12 = toErl 1
  in let arg_8 = BIF.erlang__op_minus [lop_9, rop_12]
  in let
...
erlps__printable_bin1__3 args =
  EXC.badarity (ErlangFun 3 erlps__printable_bin1__3) args
...
erlps__printable_latin1_list__2 args =
  EXC.badarity (ErlangFun 2 erlps__printable_latin1_list__2) args

erlps__valid_utf8__2 :: ErlangFun
erlps__valid_utf8__2 [(ErlangBinary binEnd_0), _]
  | BIN.empty binEnd_0 =
  ErlangAtom "true"
erlps__valid_utf8__2 [_, (ErlangInt num_0)]
  | (ErlangInt num_0) == (toErl 0) =
  ErlangAtom "true"
erlps__valid_utf8__2 [(ErlangBinary binSeg_0), n_6]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok _ bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt size_3) <- (BIN.size bin_2)
  , (BIN.Ok r_5 bin_4) <- (BIN.chopBin bin_2 size_3 8)
  , BIN.empty bin_4 =
  let    rop_10 = toErl 1
  in let arg_8 = BIF.erlang__op_minus [n_6, rop_10]
...
erlps__valid_utf8__2 args =
  EXC.badarity (ErlangFun 2 erlps__valid_utf8__2) args

erlps__printable_unicode__4 :: ErlangFun
erlps__printable_unicode__4 [bin_7@(ErlangBinary binSeg_0), i_8,
                             l_9, range_10]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok c_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  ...
  in
    case case_11 of
      (ErlangAtom "true") ->
        let    rop_17 = toErl 1
        in let arg_15 = BIF.erlang__op_minus [i_8, rop_17]
        in
          erlps__printable_unicode__4
...
erlps__printable_unicode__4 args =
  EXC.badarity (ErlangFun 4 erlps__printable_unicode__4) args
...
erlps__printable_char__2 [c_0, (ErlangAtom "latin1")] =
  let    rop_4 = toErl 32
  in let lop_2 = BIF.erlang__op_greaterEq [c_0, rop_4]
  in let
    lop_1 =
      case lop_2 of
        (ErlangAtom "false") -> ErlangAtom "false"
        (ErlangAtom "true") ->
          let rop_6 = toErl 126
          in BIF.erlang__op_lesserEq [c_0, rop_6]
        _ -> EXC.badarg1 lop_2
  in
    case lop_1 of
      ...
      (ErlangAtom "false") ->
        let    rop_9 = toErl 160
        in let lop_7 = BIF.erlang__op_greaterEq [c_0, rop_9]
        in
          case lop_7 of
            (ErlangAtom "false") -> ErlangAtom "false"
            (ErlangAtom "true") ->
              let rop_11 = toErl 255
              in BIF.erlang__op_lesserEq [c_0, rop_11]
            _ -> EXC.badarg1 lop_7
      _ -> EXC.badarg1 lop_1
erlps__printable_char__2 [c_0, (ErlangAtom "unicode")] =
  ...
  in
    case lop_1 of
      (ErlangAtom "true") -> ErlangAtom "true"
      (ErlangAtom "false") ->
        let    rop_10 = toErl 160
        in let lop_8 = BIF.erlang__op_greaterEq [c_0, rop_10]
        in let
          lop_7 =
            case lop_8 of
              (ErlangAtom "false") -> ErlangAtom "false"
              (ErlangAtom "true") ->
                let rop_12 = toErl 55296
                in BIF.erlang__op_lesser [c_0, rop_12]
              _ -> EXC.badarg1 lop_8
        in
          case lop_7 of
            (ErlangAtom "true") -> ErlangAtom "true"
            (ErlangAtom "false") ->
              let    rop_16 = toErl 57343
              in let lop_14 = BIF.erlang__op_greater [c_0, rop_16]
              in let
                lop_13 =
                  case lop_14 of
                    (ErlangAtom "false") -> ErlangAtom "false"
                    (ErlangAtom "true") ->
                      let rop_18 = toErl 65534
                      in BIF.erlang__op_lesser [c_0, rop_18]
                    _ -> EXC.badarg1 lop_14
              in
                case lop_13 of
                  (ErlangAtom "true") -> ErlangAtom "true"
                  (ErlangAtom "false") ->
                    let    rop_21 = toErl 65535
                    in let lop_19 = BIF.erlang__op_greater [c_0, rop_21]
                    in
                      case lop_19 of
                        (ErlangAtom "false") -> ErlangAtom "false"
                        (ErlangAtom "true") ->
                          let rop_23 = toErl 1114111
                          in BIF.erlang__op_lesserEq [c_0, rop_23]
                        _ -> EXC.badarg1 lop_19
                  _ -> EXC.badarg1 lop_13
            _ -> EXC.badarg1 lop_7
      _ -> EXC.badarg1 lop_1
...
erlps__printable_char__2 args =
  EXC.badarity (ErlangFun 2 erlps__printable_char__2) args
...
erlps__write_atom__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_atom__2) args
...
erlps__write_string__2 [s_0, _uni_1] =
  ...
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__write_string__2"
      [s_0, arg_3]
erlps__write_string__2 [arg_4, arg_5] = EXC.function_clause unit
erlps__write_string__2 args =
  EXC.badarity (ErlangFun 2 erlps__write_string__2) args
...
erlps__expand__3 [(ErlangTuple [(ErlangTuple [(ErlangAtom "tuple"),
  ...
  let    arg_8 = toErl 2
  in let
    matchExpr_12 = erlps__expand_list__4 [l_1, t_3, dd_4, arg_8]
  in
    case matchExpr_12 of
      (ErlangTuple [nl_9, nlen_10, ndots_11]) ->
        let
          tup_el_13 = ErlangTuple [ErlangAtom "tuple", istagged_0, nl_9]
        in
          ErlangTuple [tup_el_13, nlen_10, ndots_11, ErlangAtom "no_more"]
...
erlps__expand__3 [(ErlangTuple [(ErlangTuple [(ErlangAtom "map"),
  ...
  let    arg_7 = toErl 3
  in let
    matchExpr_11 = erlps__expand_list__4 [pairs_0, t_2, dd_3, arg_7]
  in
    case matchExpr_11 of
      (ErlangTuple [npairs_8, nlen_9, ndots_10]) ->
        let tup_el_12 = ErlangTuple [ErlangAtom "map", npairs_8]
        in
          ErlangTuple [tup_el_12, nlen_9, ndots_10, ErlangAtom "no_more"]
...
erlps__expand__3 [(ErlangTuple [(ErlangTuple [(ErlangAtom "map_pair"),
  ...
  =
  let    arg_8 = toErl 1
  in let arg_6 = erlps__tsub__2 [t_3, arg_8]
  in let p1_10 = erlps__expand__3 [k_0, arg_6, dd_4]
  in
    case p1_10 of
      (ErlangTuple [_, kl_11, kd_12, _]) ->
        let    rop_15 = toErl 4
        in let kl1_16 = BIF.erlang__op_plus [kl_11, rop_15]
        ...
        in
          case p2_22 of
            (ErlangTuple [_, vl_23, vd_24, _]) ->
              let   
                tup_el_26 = ErlangTuple [ErlangAtom "map_pair", p1_10, p2_22]
...
erlps__expand__3 [(ErlangTuple [(ErlangTuple [(ErlangAtom "record"),
  ...
  =
  let    rop_11 = toErl 2
  in let arg_9 = BIF.erlang__op_plus [namel_1, rop_11]
  in let
    matchExpr_15 = erlps__expand_list__4 [l_2, t_4, dd_5, arg_9]
  in
    case matchExpr_15 of
      (ErlangTuple [nl_12, nlen_13, ndots_14]) ->
        ...
        in
          ErlangTuple [tup_el_16, nlen_13, ndots_14, ErlangAtom "no_more"]
...
erlps__expand__3 [(ErlangTuple [(ErlangTuple [(ErlangAtom "field"),
  ...
  in let matchExpr_14 = erlps__expand__3 [field_2, arg_7, dd_5]
  in
    case matchExpr_14 of
      (ErlangTuple [_s_11, l_12, dots_13, _]) ->
        let   
          tup_el_16 =
            ErlangTuple [ErlangAtom "field", name_0, namel_1, matchExpr_14]
        in let tup_el_21 = BIF.erlang__op_plus [namel_1, l_12]
        in
          ErlangTuple [tup_el_16, tup_el_21, dots_13, ErlangAtom "no_more"]
...
erlps__expand__3 [arg_6, arg_7, arg_8] = EXC.function_clause unit
erlps__expand__3 args =
  EXC.badarity (ErlangFun 3 erlps__expand__3) args
...
erlps__expand_list__4 [ifs_0, t_1, dd_2, l0_3] =
  ...
  in let matchExpr_15 = erlps__list_length__3 [l_9, l0_3, arg_12]
  in
    case matchExpr_15 of
...
erlps__expand_list__4 args =
  EXC.badarity (ErlangFun 4 erlps__expand_list__4) args
...
erlps__expand_list__3 args =
  EXC.badarity (ErlangFun 3 erlps__expand_list__3) args

erlps__tsub__2 :: ErlangFun
erlps__tsub__2 [t_0, _] | weakLt t_0 (toErl 0) = t_0
erlps__tsub__2 [t_0, e_1] | weakGeq t_0 e_1 =
  BIF.erlang__op_minus [t_0, e_1]
erlps__tsub__2 [_, _] = toErl 0
erlps__tsub__2 [arg_0, arg_1] = EXC.function_clause unit
erlps__tsub__2 args =
  EXC.badarity (ErlangFun 2 erlps__tsub__2) args
...
erlps__cind__7 [(ErlangTuple [(ErlangTuple [(ErlangAtom "list"),
  ...
  =
  let    rop_11 = toErl 1
  in let arg_9 = BIF.erlang__op_plus [col_2, rop_11]
  in let rop_18 = toErl 1
  in let arg_16 = BIF.erlang__op_plus [w_7, rop_18]
  in
    erlps__cind_list__7 [l_0, arg_9, ll_3, m_4, ind_5, ld_6, arg_16]
erlps__cind__7 [(ErlangTuple [(ErlangTuple [(ErlangAtom "tuple"),
  ...
  =
  let    rop_16 = toErl 1
  in let arg_14 = BIF.erlang__op_plus [w_7, rop_16]
  in
...
erlps__cind__7 [(ErlangTuple [(ErlangTuple [(ErlangAtom "record"),
  ...
  in let rop_21 = toErl 1
  in let arg_17 = BIF.erlang__op_plus [lop_18, rop_21]
  in
...
erlps__cind__7 [arg_8, arg_9, arg_10, arg_11, arg_12, arg_13,
  ...
  EXC.function_clause unit
erlps__cind__7 args =
  EXC.badarity (ErlangFun 7 erlps__cind__7) args
...
erlps__cind_tag_tuple__7 [(ErlangCons (ErlangTuple [_tag_0,
  ...
  =
  let    rop_10 = toErl 2
  in let tagind_11 = BIF.erlang__op_plus [tlen_1, rop_10]
  in let tcol_14 = BIF.erlang__op_plus [col_3, tagind_11]
  in
    case ErlangAtom "true" of
      _ | (weakGt ind_6 (toErl 0)) && (weakGt tagind_11 ind_6) ->
        ...
        in
          case ErlangAtom "true" of
            _ | ((ErlangAtom "true") ==
                   (falsifyErrors
                      (\ _ ->
                         let lop_18 = BIF.erlang__op_plus [m_5, col1_17]
                         in BIF.erlang__op_lesserEq [lop_18, ll_4]))) ||
                  ((ErlangAtom "true") ==
                     (falsifyErrors
                        (\ _ ->
                           let    rop_25 = toErl 2
                           in let
                             rop_23 = BIF.erlang__op_div_strict [ll_4, rop_25]
                           in BIF.erlang__op_lesserEq [col1_17, rop_23]))) ->
              let arg_33 = BIF.erlang__op_plus [w_8, tlen_1]
              in
                erlps__cind_tail__8
                  [l_2, col1_17, tcol_14, ll_4, m_5, ind_6, ld_7, arg_33]
            _ -> BIF.erlang__throw__1 [ErlangAtom "no_good"]
      _ | ((ErlangAtom "true") ==
             (falsifyErrors
                (\ _ ->
                   let lop_37 = BIF.erlang__op_plus [m_5, tcol_14]
                   in BIF.erlang__op_lesser [lop_37, ll_4]))) ||
            ((ErlangAtom "true") ==
               (falsifyErrors
                  (\ _ ->
                     let    rop_44 = toErl 2
                     in let rop_42 = BIF.erlang__op_div_strict [ll_4, rop_44]
                     in BIF.erlang__op_lesser [tcol_14, rop_42]))) ->
        let    lop_52 = BIF.erlang__op_plus [w_8, tlen_1]
        in let rop_55 = toErl 1
        in let arg_51 = BIF.erlang__op_plus [lop_52, rop_55]
        in
          erlps__cind_list__7
...
erlps__cind_tag_tuple__7 args =
  EXC.badarity (ErlangFun 7 erlps__cind_tag_tuple__7) args
...
erlps__cind_map__7 args =
  EXC.badarity (ErlangFun 7 erlps__cind_map__7) args
...
erlps__cind_pairs_tail__8 [(ErlangCons p_1@(ErlangTuple [_,
  ...
  in let elen_15 = BIF.erlang__op_plus [lop_13, len_0]
  in
    case ErlangAtom "true" of
      _ | ((ErlangAtom "true") ==
             (falsifyErrors
                (\ _ ->
                   let    rop_20 = toErl 0
                   in let lop_18 = BIF.erlang__op_exactEq [ld1_12, rop_20]
                   in let
                     lop_17 =
                       case lop_18 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           let    rop_23 = toErl 1
                           in let lop_21 = BIF.erlang__op_plus [elen_15, rop_23]
                           in let rop_24 = BIF.erlang__op_minus [ll_5, col_4]
                           in BIF.erlang__op_lesser [lop_21, rop_24]
                         _ -> EXC.badarg1 lop_18
                   in let
                     lop_16 =
                       case lop_17 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           let    lop_28 = BIF.erlang__op_plus [w_9, elen_15]
                           in let rop_31 = toErl 1
                           in let lop_27 = BIF.erlang__op_plus [lop_28, rop_31]
                           in BIF.erlang__op_lesserEq [lop_27, m_6]
                         _ -> EXC.badarg1 lop_17
                   in
                     case lop_16 of
                       (ErlangAtom "false") -> ErlangAtom "false"
                       (ErlangAtom "true") ->
                         ...
                         in let arg_39 = toErl 1
                         in let arg_38 = BIF.erlang__element__2 [arg_39, p_1]
                         in let arg_36 = BIF.erlang__element__2 [arg_37, arg_38]
                         in let arg_34 = BIF.erlang__element__2 [arg_35, arg_36]
                         in let lop_33 = BIF.erlang__is_list__1 [arg_34]
                         in
                           case lop_33 of
                             (ErlangAtom "false") -> ErlangAtom "false"
                             (ErlangAtom "true") ->
                               let    arg_42 = toErl 1
                               in let arg_44 = toErl 3
                               in let arg_46 = toErl 1
                               in let
                                 arg_45 = BIF.erlang__element__2 [arg_46, p_1]
                               in let
                                 arg_43 =
                                   BIF.erlang__element__2 [arg_44, arg_45]
                               in let
                                 arg_41 =
                                   BIF.erlang__element__2 [arg_42, arg_43]
                               in BIF.erlang__is_list__1 [arg_41]
            ...
            ((ErlangAtom "true") ==
               (falsifyErrors
                  (\ _ ->
                     let    rop_52 = toErl 0
                     in let lop_50 = BIF.erlang__op_greater [ld1_12, rop_52]
                     in let
                       lop_49 =
                         case lop_50 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_55 = BIF.erlang__op_minus [ll_5, col_4]
                             in let
                               rop_54 = BIF.erlang__op_minus [lop_55, ld1_12]
                             in BIF.erlang__op_lesser [elen_15, rop_54]
                           _ -> EXC.badarg1 lop_50
                     in let
                       lop_48 =
                         case lop_49 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_60 = BIF.erlang__op_plus [w_9, elen_15]
                             in let
                               lop_59 = BIF.erlang__op_plus [lop_60, ld1_12]
                             in BIF.erlang__op_lesserEq [lop_59, m_6]
                           _ -> EXC.badarg1 lop_49
                     in
                       case lop_48 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           ...
                           in let arg_71 = toErl 1
                           in let arg_70 = BIF.erlang__element__2 [arg_71, p_1]
                           in let
                             arg_68 = BIF.erlang__element__2 [arg_69, arg_70]
                           in let
                             arg_66 = BIF.erlang__element__2 [arg_67, arg_68]
                           in let lop_65 = BIF.erlang__is_list__1 [arg_66]
                           in
                             case lop_65 of
                               (ErlangAtom "false") -> ErlangAtom "false"
                               (ErlangAtom "true") ->
                                 let    arg_74 = toErl 1
                                 in let arg_76 = toErl 3
                                 in let arg_78 = toErl 1
                                 in let
                                   arg_77 = BIF.erlang__element__2 [arg_78, p_1]
                                 in let
                                   arg_75 =
                                     BIF.erlang__element__2 [arg_76, arg_77]
                                 in let
                                   arg_73 =
                                     BIF.erlang__element__2 [arg_74, arg_75]
                                 in BIF.erlang__is_list__1 [arg_73]
                               _ -> EXC.badarg1 lop_65
                         _ -> EXC.badarg1 lop_48))) ->
        let    arg_82 = BIF.erlang__op_plus [col_4, elen_15]
        in let arg_89 = BIF.erlang__op_plus [w_9, elen_15]
        in
          erlps__cind_pairs_tail__8
            [ps_2, col0_3, arg_82, ll_5, m_6, ind_7, ld_8, arg_89]
      _ ->
        let    arg_98 = toErl 0
        in let
          pw_99 =
            erlps__cind_pair__7
              [p_1, col0_3, ll_5, m_6, ind_7, ld1_12, arg_98]
        in let arg_102 = BIF.erlang__op_plus [col0_3, pw_99]
        in
          erlps__cind_pairs_tail__8
            [ps_2, col0_3, arg_102, ll_5, m_6, ind_7, ld_8, pw_99]
...
erlps__cind_pairs_tail__8 args =
  EXC.badarity (ErlangFun 8 erlps__cind_pairs_tail__8) args
    ...
    _ | (ErlangAtom "true") ==
          (falsifyErrors
             (\ _ ->
                ...
                in let arg_15 = BIF.erlang__element__2 [arg_16, pair_3]
                in let arg_13 = BIF.erlang__element__2 [arg_14, arg_15]
                ...
                in
                  case lop_10 of
                    ...
                    (ErlangAtom "true") ->
                      let    arg_19 = toErl 1
                      in let arg_21 = toErl 3
                      in let arg_23 = toErl 1
                      in let arg_22 = BIF.erlang__element__2 [arg_23, pair_3]
                      in let arg_20 = BIF.erlang__element__2 [arg_21, arg_22]
...
erlps__cind_pair__7 [(ErlangTuple [(ErlangTuple [(ErlangAtom "map_pair"),
  ...
  in let
    _ = erlps__cind__7 [v_1, arg_19, ll_4, m_5, ind_6, ld_7, arg_26]
  in ll_4
...
erlps__cind_record__8 [(ErlangCons f_0 fs_1), nlen_2, col0_3,
  ...
  =
  let    rop_10 = toErl 1
  in let nind_11 = BIF.erlang__op_plus [nlen_2, rop_10]
  in let
    matchExpr_20 =
...
erlps__cind_record__8 args =
  EXC.badarity (ErlangFun 8 erlps__cind_record__8) args
                ...
                (\ _ ->
                   ...
                   in
                     case lop_16 of
                       ...
                       (ErlangAtom "true") ->
                         let    arg_34 = toErl 1
                         in let arg_36 = toErl 4
                         in let arg_38 = toErl 1
                         in let arg_37 = BIF.erlang__element__2 [arg_38, f_1]
                         in let arg_35 = BIF.erlang__element__2 [arg_36, arg_37]
                         in let arg_33 = BIF.erlang__element__2 [arg_34, arg_35]
                         in BIF.erlang__is_list__1 [arg_33]
                       _ -> EXC.badarg1 lop_16))) ||
            ((ErlangAtom "true") ==
               (falsifyErrors
                  (\ _ ->
                     let    rop_44 = toErl 0
                     in let lop_42 = BIF.erlang__op_greater [ld1_12, rop_44]
                     in let
                       lop_41 =
                         case lop_42 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_47 = BIF.erlang__op_minus [ll_5, col_4]
                             in let
                               rop_46 = BIF.erlang__op_minus [lop_47, ld1_12]
                             in BIF.erlang__op_lesser [elen_15, rop_46]
                           _ -> EXC.badarg1 lop_42
                     in let
                       lop_40 =
                         case lop_41 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_52 = BIF.erlang__op_plus [w_9, elen_15]
                             in let
                               lop_51 = BIF.erlang__op_plus [lop_52, ld1_12]
                             in BIF.erlang__op_lesserEq [lop_51, m_6]
                           _ -> EXC.badarg1 lop_41
                     in
                       case lop_40 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           let    arg_58 = toErl 1
                           in let arg_60 = toErl 4
                           in let arg_62 = toErl 1
                           in let arg_61 = BIF.erlang__element__2 [arg_62, f_1]
                           in let
                             arg_59 = BIF.erlang__element__2 [arg_60, arg_61]
                           in let
                             arg_57 = BIF.erlang__element__2 [arg_58, arg_59]
                           in BIF.erlang__is_list__1 [arg_57]
                         _ -> EXC.badarg1 lop_40))) ->
        let    arg_66 = BIF.erlang__op_plus [col_4, elen_15]
        in let arg_73 = BIF.erlang__op_plus [w_9, elen_15]
        in
          erlps__cind_fields_tail__8
            [fs_2, col0_3, arg_66, ll_5, m_6, ind_7, ld_8, arg_73]
      _ ->
        let    arg_82 = toErl 0
        in let
          fw_83 =
            erlps__cind_field__7
              [f_1, col0_3, ll_5, m_6, ind_7, ld1_12, arg_82]
        in let arg_86 = BIF.erlang__op_plus [col_4, fw_83]
        in
          erlps__cind_fields_tail__8
            [fs_2, col0_3, arg_86, ll_5, m_6, ind_7, ld_8, fw_83]
...
erlps__cind_fields_tail__8 args =
  EXC.badarity (ErlangFun 8 erlps__cind_fields_tail__8) args
  ...
  case ErlangAtom "true" of
    _ | (ErlangAtom "true") ==
          (falsifyErrors
             (\ _ ->
                let    arg_12 = toErl 1
                in let arg_14 = toErl 4
                in let arg_16 = toErl 1
                in let arg_15 = BIF.erlang__element__2 [arg_16, fl_4]
                in let arg_13 = BIF.erlang__element__2 [arg_14, arg_15]
                in let arg_11 = BIF.erlang__element__2 [arg_12, arg_13]
...
erlps__cind_field__7 args =
  EXC.badarity (ErlangFun 7 erlps__cind_field__7) args

erlps__cind_rec__6 :: ErlangFun
erlps__cind_rec__6 [rind_0, col0_1, ll_2, m_3, ind_4, w0_5] =
  let    rop_8 = toErl 0
  in let lop_6 = BIF.erlang__op_greater [ind_4, rop_8]
  ...
  in
    case ErlangAtom "true" of
      _ | ((ErlangAtom "true") ==
             (falsifyErrors
                (\ _ ->
                   let lop_18 = BIF.erlang__op_plus [m_3, col_17]
                   in BIF.erlang__op_lesserEq [lop_18, ll_2]))) ||
            ((ErlangAtom "true") ==
               (falsifyErrors
                  (\ _ ->
                     let    rop_25 = toErl 2
                     in let rop_23 = BIF.erlang__op_div_strict [ll_2, rop_25]
                     in BIF.erlang__op_lesserEq [col_17, rop_23]))) ->
        let
          w_27 =
            case nl_12 of
              (ErlangAtom "true") -> toErl 0
              ...
              something_else -> EXC.case_clause something_else
        in ErlangTuple [col_17, w_27]
      _ -> BIF.erlang__throw__1 [ErlangAtom "no_good"]
erlps__cind_rec__6 [arg_31, arg_32, arg_33, arg_34, arg_35,
                    arg_36]
  =
  EXC.function_clause unit
erlps__cind_rec__6 args =
  EXC.badarity (ErlangFun 6 erlps__cind_rec__6) args
...
erlps__cind_list__7 args =
  EXC.badarity (ErlangFun 7 erlps__cind_list__7) args
                ...
                (\ _ ->
                   ...
                   in
                     case lop_16 of
                       ...
                       (ErlangAtom "true") ->
                         let    arg_34 = toErl 1
                         in let arg_33 = BIF.erlang__element__2 [arg_34, e_1]
                         in BIF.erlang__is_list__1 [arg_33]
                       _ -> EXC.badarg1 lop_16))) ||
            ((ErlangAtom "true") ==
               (falsifyErrors
                  (\ _ ->
                     let    rop_40 = toErl 0
                     in let lop_38 = BIF.erlang__op_greater [ld1_12, rop_40]
                     in let
                       lop_37 =
                         case lop_38 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_43 = BIF.erlang__op_minus [ll_5, col_4]
                             in let
                               rop_42 = BIF.erlang__op_minus [lop_43, ld1_12]
                             in BIF.erlang__op_lesser [elen_15, rop_42]
                           _ -> EXC.badarg1 lop_38
                     in let
                       lop_36 =
                         case lop_37 of
                           (ErlangAtom "false") -> ErlangAtom "false"
                           (ErlangAtom "true") ->
                             let    lop_48 = BIF.erlang__op_plus [w_9, elen_15]
                             in let
                               lop_47 = BIF.erlang__op_plus [lop_48, ld1_12]
                             in BIF.erlang__op_lesserEq [lop_47, m_6]
                           _ -> EXC.badarg1 lop_37
                     in
                       case lop_36 of
                         (ErlangAtom "false") -> ErlangAtom "false"
                         (ErlangAtom "true") ->
                           let    arg_54 = toErl 1
                           in let arg_53 = BIF.erlang__element__2 [arg_54, e_1]
                           in BIF.erlang__is_list__1 [arg_53]
                         _ -> EXC.badarg1 lop_36))) ->
        let    arg_58 = BIF.erlang__op_plus [col_4, elen_15]
        in let arg_65 = BIF.erlang__op_plus [w_9, elen_15]
        in
          erlps__cind_tail__8
            [es_2, col0_3, arg_58, ll_5, m_6, ind_7, ld_8, arg_65]
      _ ->
        let    arg_74 = toErl 0
        in let
          we_75 =
            erlps__cind_element__7
              [e_1, col0_3, ll_5, m_6, ind_7, ld1_12, arg_74]
        in let arg_78 = BIF.erlang__op_plus [col0_3, we_75]
        in
          erlps__cind_tail__8
            [es_2, col0_3, arg_78, ll_5, m_6, ind_7, ld_8, we_75]
...
erlps__cind_tail__8 [e_1@(ErlangTuple [_, len_0, _, _]), _col0_2,
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            let    rop_13 = toErl 1
            in let lop_11 = BIF.erlang__op_plus [len_0, rop_13]
            in let lop_15 = BIF.erlang__op_minus [ll_4, col_3]
            in let rop_20 = toErl 1
            in let rop_18 = BIF.erlang__op_plus [ld_7, rop_20]
            ...
            in let
              lop_9 =
                case lop_10 of
                  ...
                  (ErlangAtom "true") ->
                    let    rop_25 = toErl 1
                    in let lop_23 = BIF.erlang__op_plus [len_0, rop_25]
                    in let lop_22 = BIF.erlang__op_plus [lop_23, w_8]
                    in let rop_29 = toErl 1
                    in let rop_27 = BIF.erlang__op_plus [ld_7, rop_29]
            ...
            in
              case lop_9 of
                ...
                (ErlangAtom "true") ->
                  let    arg_32 = toErl 1
                  in let arg_31 = BIF.erlang__element__2 [arg_32, e_1]
...
erlps__cind_tail__8 [e_0, _col0_1, col_2, ll_3, m_4, ind_5, ld_6,
  ...
  =
  let    rop_15 = toErl 1
  in let arg_13 = BIF.erlang__op_plus [ld_6, rop_15]
  in let arg_16 = toErl 0
  in erlps__cind__7 [e_0, col_2, ll_3, m_4, ind_5, arg_13, arg_16]
erlps__cind_tail__8 [arg_17, arg_18, arg_19, arg_20, arg_21,
                     arg_22, arg_23, arg_24]
  =
  EXC.function_clause unit
erlps__cind_tail__8 args =
  EXC.badarity (ErlangFun 8 erlps__cind_tail__8) args
         ...
         (\ _ ->
            ...
            in
              case lop_8 of
                ...
                (ErlangAtom "true") ->
                  let    arg_23 = toErl 1
                  in let arg_22 = BIF.erlang__element__2 [arg_23, e_1]
                  in BIF.erlang__is_list__1 [arg_22]
                _ -> EXC.badarg1 lop_8)) =
  len_0
erlps__cind_element__7 [e_0, col_1, ll_2, m_3, ind_4, ld_5, w_6]
  =
  let _ = erlps__cind__7 [e_0, col_1, ll_2, m_3, ind_4, ld_5, w_6]
  in ll_2
...
erlps__cind_element__7 args =
  EXC.badarity (ErlangFun 7 erlps__cind_element__7) args

erlps__last_depth__2 :: ErlangFun
erlps__last_depth__2 [(ErlangCons _ _), _ld_0] = toErl 0
erlps__last_depth__2 [_, ld_0] =
  let rop_2 = toErl 1
  in BIF.erlang__op_plus [ld_0, rop_2]
erlps__last_depth__2 [arg_3, arg_4] = EXC.function_clause unit
erlps__last_depth__2 args =
  EXC.badarity (ErlangFun 2 erlps__last_depth__2) args
  ...
  EXC.tryCatch
    ...
    (\ ex_7 ->
       case ex_7 of
         ...
         ex_8 -> EXC.raise ex_8)
erlps__while_fail__3 [arg_12, arg_13, arg_14] =
  EXC.function_clause unit
erlps__while_fail__3 args =
  EXC.badarity (ErlangFun 3 erlps__while_fail__3) args

erlps__indent__1 :: ErlangFun
erlps__indent__1 [n_0] | (isEInt n_0) && (weakGt n_0 (toErl 0)) =
  let    arg_1 = toErl 32
  in let rop_4 = toErl 1
  in let arg_2 = BIF.erlang__op_minus [n_0, rop_4]
  in erlps__chars__2 [arg_1, arg_2]
...
erlps__indent__2 [(ErlangInt num_0), ind_1]
  ...
  let    head_2 = toErl 32
  in let head_4 = toErl 32
  in
    ErlangCons
      (ErlangCons head_2 (ErlangCons head_4 ErlangEmptyList))
      (ErlangCons
         (ErlangCons head_2 (ErlangCons head_4 ErlangEmptyList)) ind_1)
erlps__indent__2 [n_0, ind_1]
  | (isEInt n_0) && (weakGt n_0 (toErl 0)) =
  let    arg_3 = toErl 32
  in let head_2 = erlps__chars__2 [arg_3, n_0]
  in ErlangCons head_2 ind_1
erlps__indent__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__indent__2 args =
  EXC.badarity (ErlangFun 2 erlps__indent__2) args
...
erlps__chars__2 [c_0, (ErlangInt num_1)]
  | (ErlangInt num_1) == (toErl 3) =
  ErlangCons c_0 (ErlangCons c_0 (ErlangCons c_0 ErlangEmptyList))
erlps__chars__2 [c_0, n_1]
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            let    rop_11 = toErl 1
            in let lop_9 = BIF.erlang__band__2 [n_1, rop_11]
            in let rop_12 = toErl 0
            in BIF.erlang__op_exactEq [lop_9, rop_12])) =
  let    rop_5 = toErl 1
  in let arg_3 = BIF.erlang__bsr__2 [n_1, rop_5]
...
erlps__chars__2 args =
  EXC.badarity (ErlangFun 2 erlps__chars__2) args

erlps__get_option__3 :: ErlangFun
erlps__get_option__3 [key_0, tuplelist_1, default_2] =
  let    arg_5 = toErl 1
  in let case_3 = BIF.lists__keyfind__3 [key_0, arg_5, tuplelist_1]
  in
    case case_3 of
