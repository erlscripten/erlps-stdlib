module Proplists(erlps__property__1, erlps__property__2,
                 ...
                 erlps__expand__2, erlps__normalize__2, erlps__split__2,
                 erlps__from_map__1, erlps__to_map__1, erlps__to_map__2) where
{-
...
erlps__normalize__2 [l_0, stages_1] =
  let arg_2 = erlps__apply_stages__2 [l_0, stages_1]
  in erlps__compact__1 [arg_2]
erlps__normalize__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__normalize__2 args =
  EXC.badarity (ErlangFun 2 erlps__normalize__2) args

erlps__apply_stages__2 :: ErlangFun
erlps__apply_stages__2 [l_0,
                        (ErlangCons (ErlangTuple [(ErlangAtom "aliases"),
                                                  as_1]) xs_2)]
  =
  let arg_3 = erlps__substitute_aliases__2 [as_1, l_0]
  in erlps__apply_stages__2 [arg_3, xs_2]
erlps__apply_stages__2 [l_0,
...
erlps__apply_stages__2 [l_0,
  ...
  in erlps__apply_stages__2 [arg_3, xs_2]
erlps__apply_stages__2 [l_0, (ErlangEmptyList)] = l_0
erlps__apply_stages__2 [arg_1, arg_2] = EXC.function_clause unit
erlps__apply_stages__2 args =
  EXC.badarity (ErlangFun 2 erlps__apply_stages__2) args
...
erlps__to_map__1 :: ErlangFun
erlps__to_map__1 [list_0] =
  let   
    arg_1 =
      ErlangFun 2
        (let
           lambda_2 [(ErlangTuple [k_5, v_6]), m_7] =
             let mapExt_11 = ErlangMap (Map.singleton k_5 v_6)
             in BIF.maps__merge__2 [m_7, mapExt_11]
           lambda_2 [t_13, m_14]
             | (ErlangAtom "true") ==
                 (falsifyErrors
                    (\ _ ->
                       let    lop_15 = toErl 1
                       in let rop_16 = BIF.erlang__tuple_size__1 [t_13]
                       in BIF.erlang__op_lesserEq [lop_15, rop_16])) =
             let    arg_19 = toErl 1
             in let arg_18 = BIF.erlang__element__2 [arg_19, t_13]
             in BIF.maps__remove__2 [arg_18, m_14]
           lambda_2 [k_22, m_23] | isEAtom k_22 =
             let
               mapExt_27 = ErlangMap (Map.singleton k_22 (ErlangAtom "true"))
             in BIF.maps__merge__2 [m_23, mapExt_27]
           lambda_2 [_, m_29] = m_29
  ...
  in
    BIF.do_remote_fun_call "Lists" "erlps__foldr__3"
      [arg_1, arg_30, list_0]
erlps__to_map__1 [arg_32] = EXC.function_clause unit
erlps__to_map__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_map__1) args

erlps__to_map__2 :: ErlangFun
erlps__to_map__2 [list_0, stages_1] =
  let arg_2 = erlps__apply_stages__2 [list_0, stages_1]
  in erlps__to_map__1 [arg_2]
erlps__to_map__2 [arg_5, arg_6] = EXC.function_clause unit
erlps__to_map__2 args =
  EXC.badarity (ErlangFun 2 erlps__to_map__2) args

erlps__from_map__1 :: ErlangFun
erlps__from_map__1 [map_0] = BIF.maps__to_list__1 [map_0]
erlps__from_map__1 [arg_2] = EXC.function_clause unit
erlps__from_map__1 args =
  EXC.badarity (ErlangFun 1 erlps__from_map__1) args