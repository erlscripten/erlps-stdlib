...
erlps__insert__3 [key_0, val_1, (ErlangTuple [s_2, t_3])]
  | (isENum s_2) =
  let    s1_6 = (BIF.erlang__op_plus [s_2, (ErlangInt 1)])
...
erlps__insert_1__4 [key_0, value_1,
  ...
  | (key_0 < key1_2) =
  let    arg_11 = (BIF.erlang__bsr__2 [s_6, (ErlangInt 1)])
  in let
        ...
        in
          case match_expr_25 of
            (ErlangTuple [h2_23, s2_24]) ->
              ...
              in let h_30 = (BIF.erlang__bsl__2 [lop_26, (ErlangInt 1)])
              in let lop_31 = (BIF.erlang__op_plus [s1_16, s2_24])
              in let ss_35 = (BIF.erlang__op_plus [lop_31, (ErlangInt 1)])
              in let p_38 = (BIF.erlang__op_mult [ss_35, ss_35])
              in
                case (ErlangAtom "true") of
                  _ | (h_30 > p_38) -> (erlps__balance__2 [t_21, ss_35])
...
erlps__insert_1__4 [key_0, value_1, (ErlangAtom "nil"), s_2]
  ...
  in (ErlangTuple [tup_el_3, (ErlangInt 1), (ErlangInt 1)])
  ...
  in
    case match_expr_7 of
      (ErlangTuple [value_5, res_6]) ->
        let    tup_el_10 = (BIF.erlang__op_minus [s_1, (ErlangInt 1)])
  ...
  in
    case match_expr_6 of
      (ErlangTuple [key_3, value_4, larger_5]) ->
        let    tup_el_10 = (BIF.erlang__op_minus [size_0, (ErlangInt 1)])
