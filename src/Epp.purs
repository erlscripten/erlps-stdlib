...
erlps__expand_macros__2 [(ErlangCons (ErlangTuple [(ErlangAtom "?"),
  ...
  in let head_24 = toErl 63
  in let
    tup_el_21 =
      ErlangTuple [ErlangAtom "call", ErlangCons head_24 t_16]
  in let
    arg_17 = ErlangTuple [ErlangAtom "error", tup_el_19, tup_el_21]
