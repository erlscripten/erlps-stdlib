...
erlps__open__2 args =
  EXC.badarity (ErlangFun 2 erlps__open__2) args
...
erlps__open__3 [name_0, path_1, pdm_2] =
  ...
  in let
    arg_16 =
      ErlangTuple
        [ErlangAtom "epp", ErlangAtom "undefined", tup_el_19, tup_el_20,
...
erlps__open__3 args =
  EXC.badarity (ErlangFun 3 erlps__open__3) args
...
erlps__open__5 [name_0, file_1, startlocation_2, path_3, pdm_4] =
  ...
  in let tup_el_24 = toErl ""
  in let tup_el_28 = ErlangMap Map.empty
  in let tup_el_29 = ErlangMap Map.empty
  in let
    arg_18 =
      ErlangTuple
        [ErlangAtom "epp", file_1, startlocation_2, tup_el_22, tup_el_23,
         tup_el_24, ErlangEmptyList, ErlangEmptyList, ErlangEmptyList,
         tup_el_28, tup_el_29, ErlangAtom "utf8", ErlangAtom "true",
         ErlangEmptyList]
  in
    erlps__internal_open__2
      [ErlangCons head_6
...
erlps__open__1 args =
  EXC.badarity (ErlangFun 1 erlps__open__1) args
            ...
            (ErlangTuple [(ErlangAtom "ok"), pid_17, encoding_18]) ->
              ...
              in
                case case_19 of
                  (ErlangAtom "true") ->
                    let
                      head_25 = ErlangTuple [ErlangAtom "encoding", encoding_18]
                    in
                      ErlangTuple
...
erlps__internal_open__2 args =
  EXC.badarity (ErlangFun 2 erlps__internal_open__2) args

erlps__close__1 :: ErlangFun
erlps__close__1 [epp_0] =
  let   
    ref_3 = BIF.erlang__monitor__2 [ErlangAtom "process", epp_0]
  in let r_6 = erlps__epp_request__2 [epp_0, ErlangAtom "close"]
  in let matchExpr_7 = toErl 1
  in
    case matchExpr_7 of
...
erlps__close__1 args =
  EXC.badarity (ErlangFun 1 erlps__close__1) args
...
erlps__scan_erl_form__1 args =
  EXC.badarity (ErlangFun 1 erlps__scan_erl_form__1) args
...
erlps__parse_erl_form__1 args =
  EXC.badarity (ErlangFun 1 erlps__parse_erl_form__1) args
...
erlps__format_error__1 [(ErlangAtom "missing_parenthesis")] =
  let
    arg_0 =
      toErl "badly formed define: missing closing right parenthesis"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_0, ErlangEmptyList]
...
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "call"),
                                      what_0])]
  =
  let arg_1 = toErl "illegal macro call \'~ts\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "undefined"),
                                      m_0, (ErlangAtom "none")])]
  =
  let arg_1 = toErl "undefined macro \'~ts\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "undefined"),
                                      m_0, a_1])]
  =
  let arg_2 = toErl "undefined macro \'~ts/~p\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "mismatch"),
                                      m_0])]
  =
  let arg_1 = toErl "argument mismatch for macro \'~ts\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_1, ErlangCons m_0 ErlangEmptyList]
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "arg_error"),
                                      m_0])]
  =
  let arg_1 = toErl "badly formed argument for macro \'~ts\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_1, ErlangCons m_0 ErlangEmptyList]
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "redefine"),
                                      m_0])]
  =
  let arg_1 = toErl "redefining macro \'~ts\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_1, ErlangCons m_0 ErlangEmptyList]
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "redefine_predef"),
                                      m_0])]
  =
  let arg_1 = toErl "redefining predefined macro \'~s\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_1, ErlangCons m_0 ErlangEmptyList]
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "circular"),
                                      m_0, (ErlangAtom "none")])]
  =
  let arg_1 = toErl "circular macro \'~ts\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_1, ErlangCons m_0 ErlangEmptyList]
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "circular"),
                                      m_0, a_1])]
  =
  let arg_2 = toErl "circular macro \'~ts/~p\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_2, ErlangCons m_0 (ErlangCons a_1 ErlangEmptyList)]
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "include"),
                                      w_0, f_1])]
  =
  let arg_2 = toErl "can\'t find include ~s \"~ts\""
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "illegal_function"),
                                      macro_0])]
  =
  let arg_1 = toErl "?~s can only be used within a function"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "illegal_function_usage"),
                                      macro_0])]
  =
  let arg_1 = toErl "?~s must not begin a form"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_1, ErlangCons macro_0 ErlangEmptyList]
erlps__format_error__1 [(ErlangAtom "elif_after_else")] =
  toErl "\'elif\' following \'else\'"
erlps__format_error__1 [(ErlangTuple [(ErlangAtom "NYI"),
                                      what_0])]
  =
  let arg_1 = toErl "not yet implemented \'~s\'"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_1, ErlangCons what_0 ErlangEmptyList]
...
erlps__parse_file__3 [ifile_0, path_1, predefs_2] =
  ...
  in
    erlps__parse_file__2
      [ifile_0, ErlangCons head_5 (ErlangCons head_9 ErlangEmptyList)]
erlps__parse_file__3 [arg_13, arg_14, arg_15] =
  EXC.function_clause unit
erlps__parse_file__3 args =
  EXC.badarity (ErlangFun 3 erlps__parse_file__3) args
...
erlps__parse_file__2 [ifile_0, options_1] =
  ...
  in let tup_el_13 = toErl ""
  in let tup_el_14 = toErl ""
  in let tup_el_18 = ErlangMap Map.empty
  in let tup_el_19 = ErlangMap Map.empty
  in let
    arg_8 =
      ErlangTuple
        [ErlangAtom "epp", ErlangAtom "undefined", tup_el_11, tup_el_12,
  ...
  in
    case case_2 of
      ...
      (ErlangTuple [(ErlangAtom "error"), e_37]) ->
        ErlangTuple [ErlangAtom "error", e_37]
      something_else -> EXC.case_clause something_else
erlps__parse_file__2 [arg_40, arg_41] = EXC.function_clause unit
erlps__parse_file__2 args =
  EXC.badarity (ErlangFun 2 erlps__parse_file__2) args
...
erlps__encoding_to_string__1 args =
  EXC.badarity (ErlangFun 1 erlps__encoding_to_string__1) args
...
erlps__read_encoding__1 args =
  EXC.badarity (ErlangFun 1 erlps__read_encoding__1) args
  ...
  in
    case case_6 of
      (ErlangTuple [(ErlangAtom "ok"), file_11]) ->
        EXC.tryCatchFinally
          (\ _ -> erlps__read_encoding_from_file__2 [file_11, incomment_5])
          ...
          (\ _ ->
             ...
             in
               case match_final_17_19 of
                 (ErlangAtom "ok") -> match_final_17_19
                 _ -> EXC.badmatch match_final_17_19)
      _error_21 -> ErlangAtom "none"
erlps__read_encoding__2 [arg_22, arg_23] =
  EXC.function_clause unit
erlps__read_encoding__2 args =
  EXC.badarity (ErlangFun 2 erlps__read_encoding__2) args
...
erlps__set_encoding__1 args =
  EXC.badarity (ErlangFun 1 erlps__set_encoding__1) args
...
erlps__set_encoding__2 args =
  EXC.badarity (ErlangFun 2 erlps__set_encoding__2) args
...
erlps__read_encoding_from_binary__1 args =
  EXC.badarity (ErlangFun 1 erlps__read_encoding_from_binary__1)
    args
...
erlps__read_encoding_from_binary__2 [binary_0, options_1] =
  ...
  in
    EXC.tryCatch
      (\ _ ->
         let    arg_8 = toErl 0
         in let arg_7 = erlps__fake_reader__1 [arg_8]
         in let arg_9 = toErl 0
         in erlps__com_nl__4 [binary_0, arg_7, arg_9, incomment_5])
      (\ ex_12 ->
         case ex_12 of
           (ErlangTuple [(ErlangAtom "throw"), (ErlangAtom "no"), _]) ->
             ErlangAtom "none"
           ex_13 -> EXC.raise ex_13)
erlps__read_encoding_from_binary__2 [arg_14, arg_15] =
  EXC.function_clause unit
erlps__read_encoding_from_binary__2 args =
  EXC.badarity (ErlangFun 2 erlps__read_encoding_from_binary__2)
    args
...
erlps__fake_reader__1 args =
  EXC.badarity (ErlangFun 1 erlps__fake_reader__1) args
  ...
  in
    case matchExpr_5 of
      (ErlangTuple [(ErlangAtom "ok"), pos0_4]) ->
        ...
        in let
          encoding0_11 =
            BIF.lists__keyfind__3 [ErlangAtom "encoding", arg_9, opts_7]
        in let arg_13 = toErl 1
        in let
          binary0_15 =
            BIF.lists__keyfind__3 [ErlangAtom "binary", arg_13, opts_7]
        in let
          head_20 =
          ...
          case matchExpr_24 of
            (ErlangAtom "ok") ->
              EXC.tryCatchFinally
                (\ _ ->
                   let    arg_27 = toErl 0
                   in let fun_25 = erlps__reader__2 [file_0, arg_27]
                   in let
                     matchExpr_30 =
                   ...
                   in
                     case matchExpr_30 of
                       (ErlangTuple [b_28, fun_29]) ->
                         let arg_33 = toErl 0
                         in erlps__com_nl__4 [b_28, fun_29, arg_33, incomment_1]
                ...
                (\ _ ->
                   ...
                   in
                     case matchExpr_41 of
                       (ErlangTuple [(ErlangAtom "ok"), pos0_40]) | pos0_40 ==
                                                                      pos0_4 ->
                         let
                           match_final_42_49 =
                             BIF.do_remote_fun_call "Erlang.Io"
                               ...
                               [file_0,
                                ErlangCons binary0_15
                                  (ErlangCons encoding0_11 ErlangEmptyList)]
                         in
                           case match_final_42_49 of
                             (ErlangAtom "ok") -> match_final_42_49
                             _ -> EXC.badmatch match_final_42_49
                       _ -> EXC.badmatch matchExpr_41)
            _ -> EXC.badmatch matchExpr_24
      _ -> EXC.badmatch matchExpr_5
erlps__read_encoding_from_file__2 [arg_51, arg_52] =
  EXC.function_clause unit
erlps__read_encoding_from_file__2 args =
  EXC.badarity (ErlangFun 2 erlps__read_encoding_from_file__2)
    args
...
erlps__reader__2 [fd_0, n_1] =
  ErlangFun 0
    (let
       lambda_2 [] | (==) n_1 (toErl 16) =
         BIF.erlang__throw__1 [ErlangAtom "no"]
       lambda_2 [] =
         let    arg_6 = toErl 32
         in let
           case_4 =
             BIF.do_remote_fun_call "File" "erlps__read__2" [fd_0, arg_6]
         in
           case case_4 of
             (ErlangAtom "eof") ->
...
erlps__reader__2 args =
  EXC.badarity (ErlangFun 2 erlps__reader__2) args
...
erlps__com_nl__4 args =
  EXC.badarity (ErlangFun 4 erlps__com_nl__4) args

erlps__com__4 :: ErlangFun
erlps__com__4 [(ErlangBinary binSeg_0), fun_7, n_8, com_9]
  ...
  , BIN.empty bin_5 =
  let    rop_14 = toErl 1
  in let arg_12 = BIF.erlang__op_plus [n_8, rop_14]
...
erlps__com__4 [(ErlangBinary binSeg_0), fun_6, n_7, com_8]
  | (ErlangInt size_1) <- (toErl 1)
  , (BIN.Ok _ bin_2) <-
      (BIN.chopInt binSeg_0 size_1 8 BIN.Big BIN.Unsigned)
  , (ErlangInt size_3) <- (BIN.size bin_2)
  , (BIN.Ok b_5 bin_4) <- (BIN.chopBin bin_2 size_3 8)
  , BIN.empty bin_4 =
  erlps__com__4 [b_5, fun_6, n_7, com_8]
erlps__com__4 [(ErlangBinary binEnd_0), fun_1, n_2, com_3]
  | BIN.empty binEnd_0 =
  let matchExpr_7 = BIF.erlang__apply__2 [fun_1, ErlangEmptyList]
  in
    case matchExpr_7 of
...
erlps__com__4 [arg_12, arg_13, arg_14, arg_15] =
  EXC.function_clause unit
erlps__com__4 args =
  EXC.badarity (ErlangFun 4 erlps__com__4) args

erlps__com_c__4 :: ErlangFun
erlps__com_c__4 [(ErlangBinary binSeg_0), fun_7, n_8, com_9]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok (ErlangInt num_3) bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
...
erlps__com_c__4 [(ErlangBinary binSeg_0), fun_7, n_8, com_9]
  ...
  in let arg_12 = BIF.erlang__op_plus [n_8, rop_14]
  in erlps__com_nl__4 [b_6, fun_7, arg_12, com_9]
erlps__com_c__4 [(ErlangBinary binSeg_0), fun_6, n_7, com_8]
  | (ErlangInt size_1) <- (toErl 1)
  , (BIN.Ok _ bin_2) <-
      (BIN.chopInt binSeg_0 size_1 8 BIN.Big BIN.Unsigned)
  , (ErlangInt size_3) <- (BIN.size bin_2)
...
erlps__com_c__4 [(ErlangBinary binEnd_0), fun_1, n_2, com_3]
  | BIN.empty binEnd_0 =
  let matchExpr_7 = BIF.erlang__apply__2 [fun_1, ErlangEmptyList]
  in
    case matchExpr_7 of
...
erlps__com_c__4 args =
  EXC.badarity (ErlangFun 4 erlps__com_c__4) args

erlps__com_oding__4 :: ErlangFun
erlps__com_oding__4 [(ErlangBinary binSeg_0), fun_19, n_20,
                     com_21]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok (ErlangInt num_3) bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  ...
  , (BIN.Ok b_18 bin_17) <- (BIN.chopBin bin_14 size_16 8)
  , BIN.empty bin_17 =
...
erlps__com_oding__4 args =
  EXC.badarity (ErlangFun 4 erlps__com_oding__4) args

erlps__com_sep__4 :: ErlangFun
erlps__com_sep__4 [(ErlangBinary binSeg_0), fun_7, n_8, com_9]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok (ErlangInt num_3) bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
...
erlps__com_sep__4 [(ErlangBinary binEnd_0), fun_1, n_2, com_3]
  | BIN.empty binEnd_0 =
  let matchExpr_7 = BIF.erlang__apply__2 [fun_1, ErlangEmptyList]
  in
    case matchExpr_7 of
...
erlps__com_sep__4 args =
  EXC.badarity (ErlangFun 4 erlps__com_sep__4) args

erlps__com_space__4 :: ErlangFun
erlps__com_space__4 [(ErlangBinary binSeg_0), fun_7, n_8, com_9]
  | (ErlangInt size_1) <- (toErl 8)
  , (BIN.Ok (ErlangInt num_3) bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , (ErlangInt num_3) == (toErl 32)
  ...
  , BIN.empty bin_5 =
  erlps__com_space__4 [b_6, fun_7, n_8, com_9]
erlps__com_space__4 [(ErlangBinary binEnd_0), fun_1, n_2, com_3]
  | BIN.empty binEnd_0 =
  let matchExpr_7 = BIF.erlang__apply__2 [fun_1, ErlangEmptyList]
  in
    case matchExpr_7 of
...
erlps__com_space__4 args =
  EXC.badarity (ErlangFun 4 erlps__com_space__4) args

erlps__com_enc__5 :: ErlangFun
erlps__com_enc__5 [(ErlangBinary binSeg_0), fun_7, n_8, l_9,
                   ps_10]
  | (ErlangInt size_1) <- (toErl 1)
  , (BIN.Ok c_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 8 BIN.Big BIN.Unsigned)
...
erlps__com_enc__5 [(ErlangBinary binEnd_0), fun_1, n_2, l_3,
  ...
  in
    case case_5 of
      (ErlangTuple [(ErlangBinary binEnd_7), _]) | BIN.empty
                                                     binEnd_7 ->
...
erlps__com_enc__5 args =
  EXC.badarity (ErlangFun 5 erlps__com_enc__5) args
...
erlps__com_enc_end__1 [ps0_0] =
  let   
    arg_1 =
      flmap
        (\ lc_4 ->
           let    arg_6 = erlps__lowercase__1 [lc_4]
           in let
             lcRet_5 =
...
erlps__com_encoding__1 args =
  EXC.badarity (ErlangFun 1 erlps__com_encoding__1) args
...
erlps__normalize_typed_record_fields__1 args =
  EXC.badarity
    (ErlangFun 1 erlps__normalize_typed_record_fields__1) args
...
erlps__normalize_typed_record_fields__3 [(ErlangEmptyList),
  ...
  case typed_1 of
    (ErlangAtom "true") ->
      let
        tup_el_4 =
          BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [newfields_0]
...
erlps__normalize_typed_record_fields__3 args =
  EXC.badarity
    (ErlangFun 3 erlps__normalize_typed_record_fields__3) args
...
erlps__restore_typed_record_fields__1 [(ErlangCons (ErlangTuple [(ErlangAtom "attribute"),
  ...
  in let
    head_7 =
      ErlangTuple
        [ErlangAtom "attribute", la_0, ErlangAtom "record", tup_el_11]
  in let tail_14 = erlps__restore_typed_record_fields__1 [forms_6]
...
erlps__restore_typed_record_fields__1 [(ErlangCons (ErlangTuple [(ErlangAtom "attribute"),
  ...
  in let
    head_4 =
      ErlangTuple
        [ErlangAtom "attribute", la_0, ErlangAtom "record", tup_el_8]
  in let tail_11 = erlps__restore_typed_record_fields__1 [forms_3]
...
erlps__restore_typed_record_fields__1 args =
  EXC.badarity (ErlangFun 1 erlps__restore_typed_record_fields__1)
    args
                    ...
                    (ErlangTuple [(ErlangAtom "epp"), file_20, location_21,
                      ...
                      ErlangTuple
                        [ErlangAtom "epp", file_13, location_21, delta_22,
                         ...
                         uses_29, default_encoding_30, pre_opened_31, fname_32]
...
erlps__server__4 args =
  EXC.badarity (ErlangFun 4 erlps__server__4) args
        ...
        case st0_3 of
          (ErlangTuple [(ErlangAtom "epp"), file_18, atlocation_19, _, _,
            ...
            let   
              defencoding_24 =
                BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
                  [ErlangAtom "default_encoding", options_2, ErlangAtom "utf8"]
            in let
              encoding_27 = erlps__set_encoding__2 [file_18, defencoding_24]
            in let tup_el_31 = BIF.erlang__self__0 []
            in let
              arg_29 = ErlangTuple [ErlangAtom "ok", tup_el_31, encoding_27]
              ...
              st_60 =
                case st0_3 of
                  (ErlangTuple [(ErlangAtom "epp"), file_47, location_48,
                    ...
                    ErlangTuple
                      [ErlangAtom "epp", file_47, location_48, record_updt_41,
                       sourcename_7, sourcename_7, istk_52, sstk_53,
                       ErlangCons head_33 tail_35, ms1_17, uses_56,
                       defencoding_24, pre_opened_58, fname_59]
                  _ -> EXC.badrecord (ErlangAtom "epp")
            ...
            in let
              _ =
                erlps__enter_file_reply__5
                  [from_62, arg_66, anno_64, atlocation_19, ErlangAtom "code"]
...
erlps__init_server__4 args =
  EXC.badarity (ErlangFun 4 erlps__init_server__4) args

erlps__predef_macros__1 :: ErlangFun
erlps__predef_macros__1 [file_0] =
  let    arg_1 = BIF.erlang__system_info__1 [ErlangAtom "machine"]
  ...
  in let
    head_19 =
      ErlangTuple [ErlangAtom "FUNCTION_NAME", ErlangAtom "undefined"]
  in let
    head_23 =
      ErlangTuple [ErlangAtom "FUNCTION_ARITY", ErlangAtom "undefined"]
  in let tup_el_35 = toErl 1
  in let
    head_32 = ErlangTuple [ErlangAtom "integer", anno_4, tup_el_35]
  in let
    tup_el_29 =
      ErlangTuple
  ...
  in let
    head_42 =
      ErlangTuple [ErlangAtom "MODULE_STRING", ErlangAtom "undefined"]
  in let
    head_46 =
      ErlangTuple [ErlangAtom "BASE_MODULE", ErlangAtom "undefined"]
  in let
    head_50 =
      ErlangTuple
  ...
  in let head_54 = ErlangTuple [ErlangAtom "MACHINE", tup_el_56]
  in let
    head_70 =
...
erlps__predef_macros__1 args =
  EXC.badarity (ErlangFun 1 erlps__predef_macros__1) args
...
erlps__user_predef__2 [(ErlangCons (ErlangTuple [m_0, val_1,
  ...
  in let mapExt_14 = ErlangMap (Map.singleton m_0 val_11)
  in let arg_8 = BIF.maps__merge__2 [ms_3, mapExt_14]
...
erlps__user_predef__2 [(ErlangCons (ErlangTuple [m_0,
  ...
  case ms_3 of
    ...
    (ErlangMap map_11) | (DM.Just _defs_12) <-
      ...
      let tup_el_14 = ErlangTuple [ErlangAtom "redefine_predef", m_0]
    ...
    _ ->
      ...
      in let arg_21 = BIF.maps__merge__2 [ms_3, mapExt_31]
...
erlps__user_predef__2 args =
  EXC.badarity (ErlangFun 2 erlps__user_predef__2) args

erlps__wait_request__1 :: ErlangFun
erlps__wait_request__1 [st_0] =
  let match_final_1_2 = toErl 1
  in
    case match_final_1_2 of
      (ErlangAtom "processes_unsuported") -> match_final_1_2
      _ -> EXC.badmatch match_final_1_2
erlps__wait_request__1 [arg_4] = EXC.function_clause unit
erlps__wait_request__1 args =
  EXC.badarity (ErlangFun 1 erlps__wait_request__1) args
...
erlps__close_file__1 args =
  EXC.badarity (ErlangFun 1 erlps__close_file__1) args
...
erlps__wait_req_scan__1 args =
  EXC.badarity (ErlangFun 1 erlps__wait_req_scan__1) args
...
erlps__wait_req_skip__2 [arg_7, arg_8] = EXC.function_clause unit
erlps__wait_req_skip__2 args =
  EXC.badarity (ErlangFun 2 erlps__wait_req_skip__2) args
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            ...
            in let rop_20 = toErl 8
            in BIF.erlang__op_greaterEq [lop_15, rop_20])) =
  let    tup_el_8 = erlps__loc__1 [inc_1]
  in let tup_el_13 = toErl "include"
  in let tup_el_11 = ErlangTuple [ErlangAtom "depth", tup_el_13]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  ...
  in
    case case_4 of
      ...
      (ErlangTuple [(ErlangAtom "error"), _e_26]) ->
        ...
        in let
          tup_el_34 =
            ErlangTuple [ErlangAtom "include", ErlangAtom "file", newname_0]
        in let
          tup_el_30 = ErlangTuple [tup_el_31, ErlangAtom "epp", tup_el_34]
...
erlps__enter_file__4 args =
  EXC.badarity (ErlangFun 4 erlps__enter_file__4) args
...
erlps__enter_file2__5 [newf_0, pname_1, from_2, st0_3,
  ...
  let   
    anno_6 =
      BIF.do_remote_fun_call "Erl.Anno" "erlps__new__1" [atlocation_4]
  in let
    _ =
      erlps__enter_file_reply__5
  ...
  in let
    ms0_15 =
      case st0_3 of
        (ErlangTuple arr_14) | (DM.Just field_13) <- (arr_14 DA.!! 9) ->
          field_13
        _ -> EXC.badrecord (ErlangAtom "epp")
  in let
  ...
  in let
    mapExt_26 = ErlangMap (Map.singleton (ErlangAtom "FILE") val_18)
  in let
    ms_29 =
      case findMissingKey ms0_15 [ErlangAtom "FILE"] of
        (DM.Nothing) -> BIF.maps__merge__2 [ms0_15, mapExt_26]
  ...
  in let
    arg_33 =
      case st0_3 of
        (ErlangTuple arr_36) | (DM.Just field_35) <- (arr_36 DA.!! 8) ->
          field_35
        _ -> EXC.badrecord (ErlangAtom "epp")
  ...
  in let
    defencoding_41 =
      case st0_3 of
        (ErlangTuple arr_40) | (DM.Just field_39) <- (arr_40 DA.!! 11) ->
          field_39
        _ -> EXC.badrecord (ErlangAtom "epp")
  in let
    matchExpr_44 = erlps__set_encoding__2 [newf_0, defencoding_41]
  in let tup_el_48 = toErl 0
  in let
    tail_54 =
      case st0_3 of
        (ErlangTuple arr_57) | (DM.Just field_56) <- (arr_57 DA.!! 7) ->
          field_56
        _ -> EXC.badrecord (ErlangAtom "epp")
  in let tup_el_60 = ErlangMap Map.empty
  in
    ErlangTuple
      [ErlangAtom "epp", newf_0, atlocation_4, tup_el_48, pname_1,
       pname_1, ErlangEmptyList, ErlangCons st0_3 tail_54,
       ErlangCons head_30 tail_32, ms_29, tup_el_60, defencoding_41,
       ErlangAtom "false", ErlangEmptyList]
erlps__enter_file2__5 [arg_64, arg_65, arg_66, arg_67, arg_68] =
  EXC.function_clause unit
erlps__enter_file2__5 args =
  EXC.badarity (ErlangFun 5 erlps__enter_file2__5) args
...
erlps__enter_file_reply__5 [from_0, name_1, locationanno_2,
  ...
  in let
    head_35 = ErlangTuple [ErlangAtom "integer", anno_10, tup_el_38]
...
erlps__enter_file_reply__5 args =
  EXC.badarity (ErlangFun 5 erlps__enter_file_reply__5) args

erlps__file_name__1 :: ErlangFun
erlps__file_name__1 [(ErlangCons c_0 t_1)]
  | (isEInt c_0) && (weakGt c_0 (toErl 0)) =
...
erlps__file_name__1 args =
  EXC.badarity (ErlangFun 1 erlps__file_name__1) args
    ...
    case case_2 of
      (ErlangCons i_6 cis_7) ->
        let   
          tup_el_12 =
            case st_1 of
              (ErlangTuple arr_15) | (DM.Just field_14) <- (arr_15 DA.!! 2) ->
                field_14
              _ -> EXC.badrecord (ErlangAtom "epp")
        in let tup_el_19 = toErl "unterminated"
        in let
          tup_el_17 = ErlangTuple [ErlangAtom "illegal", tup_el_19, i_6]
        in let
          tup_el_11 = ErlangTuple [tup_el_12, ErlangAtom "epp", tup_el_17]
      ...
      (ErlangEmptyList) ->
        let
          case_39 =
            case st_1 of
              (ErlangTuple arr_42) | (DM.Just field_41) <- (arr_42 DA.!! 7) ->
                field_41
              _ -> EXC.badrecord (ErlangAtom "epp")
        in
          case case_39 of
              ...
              in
                case oldst_43 of
                  (ErlangTuple [(ErlangAtom "epp"), _, oldloc_46, delta_47,
                                ...
                                _]) ->
                    let    currloc_53 = erlps__add_line__2 [oldloc_46, delta_47]
                    in let
                      anno_55 =
                        BIF.do_remote_fun_call "Erl.Anno" "erlps__new__1"
                          [currloc_53]
                    ...
                    in let
                      head_65 =
                        ErlangTuple [ErlangAtom "string", anno_55, oldname2_49]
                    in let
                      val_62 =
                        ErlangTuple
                          [ErlangAtom "none",
                    ...
                    in let
                      ms_73 =
                        case findMissingKey ms0_59 [ErlangAtom "FILE"] of
                          (DM.Nothing) -> BIF.maps__merge__2 [ms0_59, mapExt_70]
                      ...
                      nextst_94 =
                        case oldst_43 of
                          (ErlangTuple [(ErlangAtom "epp"), file_81,
                            ...
                            ErlangTuple
                              [ErlangAtom "epp", file_81, location_82, delta_83,
                               name_84, name2_85, istk_86, sts_44, path_88,
                               ms_73, record_updt_77, default_encoding_91,
                               pre_opened_92, fname_93]
                          _ -> EXC.badrecord (ErlangAtom "epp")
                    in let
                      _ =
...
erlps__leave_file__2 args =
  EXC.badarity (ErlangFun 2 erlps__leave_file__2) args
    ...
    case case_2 of
      ...
      (ErlangTuple [(ErlangAtom "error"), _e_72]) ->
        let   
          tup_el_77 =
            case st_1 of
              (ErlangTuple arr_80) | (DM.Just field_79) <- (arr_80 DA.!! 2) ->
                field_79
              _ -> EXC.badrecord (ErlangAtom "epp")
        in let
          tup_el_76 =
...
erlps__scan_toks__2 args =
  EXC.badarity (ErlangFun 2 erlps__scan_toks__2) args
  ...
  let
    case_6 =
      EXC.tryCatch (\ _ -> erlps__expand_macros__2 [toks0_3, st_5])
        (\ ex_10 ->
           case ex_10 of
             (ErlangTuple [(ErlangAtom "throw"), payload_12, _]) -> payload_12
             (ErlangTuple [(ErlangAtom "error"), payload_13, stack_14]) ->
               let tup_el_16 = ErlangTuple [payload_13, stack_14]
               in ErlangTuple [ErlangAtom "EXIT", tup_el_16]
             (ErlangTuple [(ErlangAtom "exit"), payload_19, _]) ->
               ErlangTuple [ErlangAtom "EXIT", payload_19]
             ex_11 -> EXC.raise ex_11)
  in
    case case_6 of
      toks1_22 | isEList toks1_22 ->
        erlps__scan_file__4 [toks1_22, filetoken_2, from_4, st_5]
      (ErlangTuple [(ErlangAtom "error"), errl_27, what_28]) ->
        let   
          tup_el_32 = ErlangTuple [errl_27, ErlangAtom "epp", what_28]
        in let arg_30 = ErlangTuple [ErlangAtom "error", tup_el_32]
        in let _ = erlps__epp_reply__2 [from_4, arg_30]
...
erlps__scan_toks__3 [toks0_0, from_1, st_2] =
             ...
             arg_5 =
               case st_2 of
                 (ErlangTuple [(ErlangAtom "epp"), file_8, location_9, delta_10,
                   ...
                   ErlangTuple
                     [ErlangAtom "epp", file_8, location_9, delta_10, name_11,
                      name2_12, istk_13, sstk_14, path_15, macs_16, uses_17,
                      default_encoding_18, pre_opened_19, toks0_0]
                 _ -> EXC.badrecord (ErlangAtom "epp")
  ...
  in
    case case_3 of
      toks1_34 | isEList toks1_34 ->
        let    arg_36 = ErlangTuple [ErlangAtom "ok", toks1_34]
        in let _ = erlps__epp_reply__2 [from_1, arg_36]
        in let
          arg_43 =
            case st_2 of
              (ErlangTuple arr_46) | (DM.Just field_45) <- (arr_46 DA.!! 9) ->
                field_45
              _ -> EXC.badrecord (ErlangAtom "epp")
        in let record_updt_41 = erlps__scan_module__2 [toks1_34, arg_43]
        in let
          arg_39 =
            case st_2 of
              (ErlangTuple [(ErlangAtom "epp"), file_47, location_48, delta_49,
                            ...
                            pre_opened_58, fname_59]) ->
                ErlangTuple
                  [ErlangAtom "epp", file_47, location_48, delta_49, name_50,
                   name2_51, istk_52, sstk_53, path_54, record_updt_41, uses_56,
                   default_encoding_57, pre_opened_58, fname_59]
              _ -> EXC.badrecord (ErlangAtom "epp")
        in erlps__wait_req_scan__1 [arg_39]
      (ErlangTuple [(ErlangAtom "error"), errl_60, what_61]) ->
        let   
          tup_el_65 = ErlangTuple [errl_60, ErlangAtom "epp", what_61]
        in let arg_63 = ErlangTuple [ErlangAtom "error", tup_el_65]
        in let _ = erlps__epp_reply__2 [from_1, arg_63]
        in erlps__wait_req_scan__1 [st_2]
      something_else -> EXC.case_clause something_else
erlps__scan_toks__3 [arg_70, arg_71, arg_72] =
  EXC.function_clause unit
erlps__scan_toks__3 args =
  EXC.badarity (ErlangFun 3 erlps__scan_toks__3) args
...
erlps__scan_module__2 args =
  EXC.badarity (ErlangFun 2 erlps__scan_module__2) args
...
erlps__scan_module_1__2 [(ErlangCons modatom_2@(ErlangTuple [(ErlangAtom "atom"),
  ...
  in let
    ms_18 =
      case findMissingKey ms0_5 [ErlangAtom "MODULE"] of
        (DM.Nothing) -> BIF.maps__merge__2 [ms0_5, mapExt_15]
        (DM.Just missing_17) -> EXC.badkey missing_17
  in let
    head_24 = ErlangTuple [ErlangAtom "string", ln_0, modstring_7]
  in let
    val_21 =
      ErlangTuple
  ...
  in
    case findMissingKey ms_18 [ErlangAtom "MODULE_STRING"] of
      (DM.Nothing) -> BIF.maps__merge__2 [ms_18, mapExt_29]
      (DM.Just missing_31) -> EXC.badkey missing_31
erlps__scan_module_1__2 [_ts_0, ms_1] = ms_1
erlps__scan_module_1__2 [arg_2, arg_3] = EXC.function_clause unit
erlps__scan_module_1__2 args =
  EXC.badarity (ErlangFun 2 erlps__scan_module_1__2) args
...
erlps__scan_extends__2 [(ErlangCons modatom_2@(ErlangTuple [(ErlangAtom "atom"),
  ...
  in
    case findMissingKey ms_18 [ErlangAtom "BASE_MODULE_STRING"] of
      (DM.Nothing) -> BIF.maps__merge__2 [ms_18, mapExt_29]
      (DM.Just missing_31) -> EXC.badkey missing_31
erlps__scan_extends__2 [_ts_0, ms_1] = ms_1
erlps__scan_extends__2 [arg_2, arg_3] = EXC.function_clause unit
erlps__scan_extends__2 args =
  EXC.badarity (ErlangFun 2 erlps__scan_extends__2) args
...
erlps__scan_err_warn__4 [toks0_0@(ErlangCons (ErlangTuple [(ErlangAtom "("),
  ...
  let
    _ =
      EXC.tryOfCatch (\ _ -> erlps__expand_macros__2 [toks0_0, st_4])
        (\ of_7 ->
           case of_7 of
             toks_10 | isEList toks_10 ->
               let
                 case_11 =
               ...
               in
                 case case_11 of
                   (ErlangTuple [(ErlangAtom "ok"), term_13]) ->
                     let    tup_el_18 = erlps__loc__1 [token_2]
                     in let tup_el_21 = ErlangTuple [tag_1, term_13]
                     in let
                       tup_el_17 =
                         ErlangTuple [tup_el_18, ErlangAtom "epp", tup_el_21]
                     in let arg_15 = ErlangTuple [tag_1, tup_el_17]
                     in erlps__epp_reply__2 [from_3, arg_15]
                   (ErlangTuple [(ErlangAtom "error"), _]) ->
                     let    tup_el_28 = erlps__loc__1 [token_2]
                     in let tup_el_31 = ErlangTuple [ErlangAtom "bad", tag_1]
                     in let
                       tup_el_27 =
                         ErlangTuple [tup_el_28, ErlangAtom "epp", tup_el_31]
                     in let arg_25 = ErlangTuple [ErlangAtom "error", tup_el_27]
                     in erlps__epp_reply__2 [from_3, arg_25]
                   something_else -> EXC.case_clause something_else
             something_else -> EXC.try_clause something_else)
        (\ ex_8 ->
           case ex_8 of
             (ErlangTuple [_, _, _]) ->
               let    tup_el_38 = erlps__loc__1 [token_2]
               in let tup_el_41 = ErlangTuple [ErlangAtom "bad", tag_1]
               in let
                 tup_el_37 =
                   ErlangTuple [tup_el_38, ErlangAtom "epp", tup_el_41]
               in let arg_35 = ErlangTuple [ErlangAtom "error", tup_el_37]
               in erlps__epp_reply__2 [from_3, arg_35]
             ex_9 -> EXC.raise ex_9)
...
erlps__scan_err_warn__4 [_toks_0,
  ...
  in let
    tup_el_8 = ErlangTuple [tup_el_9, ErlangAtom "epp", tup_el_12]
...
erlps__scan_err_warn__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_err_warn__4) args
...
erlps__scan_define__4 [_toks_0, def_1, from_2, st_3] =
  ...
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "bad", ErlangAtom "define"]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  in let arg_5 = ErlangTuple [ErlangAtom "error", tup_el_7]
  in let _ = erlps__epp_reply__2 [from_2, arg_5]
...
erlps__scan_define__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_define__4) args
...
erlps__scan_define_1__5 [(ErlangCons comma_0@(ErlangTuple [(ErlangAtom ","),
  ...
  let
    case_6 =
      EXC.tryCatch (\ _ -> erlps__macro_expansion__2 [toks_1, comma_0])
        (\ ex_10 ->
           case ex_10 of
             (ErlangTuple [(ErlangAtom "throw"), payload_12, _]) -> payload_12
             (ErlangTuple [(ErlangAtom "error"), payload_13, stack_14]) ->
  ...
  in
    case case_6 of
      expansion_22 | isEList expansion_22 ->
        let arg_24 = ErlangTuple [ErlangAtom "none", expansion_22]
        in
          erlps__scan_define_2__5
            [ErlangAtom "none", arg_24, mac_2, from_4, st_5]
  ...
  in
    case case_6 of
      (ErlangTuple [(ErlangAtom "ok"),
                    macrodef_23@(ErlangTuple [as_22, _])]) ->
        let len_25 = BIF.erlang__length__1 [as_22]
        in
          erlps__scan_define_2__5
            [len_25, macrodef_23, mac_2, from_4, st_5]
      (ErlangTuple [(ErlangAtom "error"), errl_31, what_32]) ->
        let   
          tup_el_36 = ErlangTuple [errl_31, ErlangAtom "epp", what_32]
        in let arg_34 = ErlangTuple [ErlangAtom "error", tup_el_36]
        in let _ = erlps__epp_reply__2 [from_4, arg_34]
        in erlps__wait_req_scan__1 [st_5]
      _ ->
        let    tup_el_45 = erlps__loc__1 [def_3]
        in let
          tup_el_48 = ErlangTuple [ErlangAtom "bad", ErlangAtom "define"]
        in let
          tup_el_44 = ErlangTuple [tup_el_45, ErlangAtom "epp", tup_el_48]
        in let arg_42 = ErlangTuple [ErlangAtom "error", tup_el_44]
        in let _ = erlps__epp_reply__2 [from_4, arg_42]
        in erlps__wait_req_scan__1 [st_5]
erlps__scan_define_1__5 [_toks_0, _mac_1, def_2, from_3, st_4] =
  let    tup_el_9 = erlps__loc__1 [def_2]
  in let
    tup_el_12 = ErlangTuple [ErlangAtom "bad", ErlangAtom "define"]
  in let
    tup_el_8 = ErlangTuple [tup_el_9, ErlangAtom "epp", tup_el_12]
  in let arg_6 = ErlangTuple [ErlangAtom "error", tup_el_8]
  in let _ = erlps__epp_reply__2 [from_3, arg_6]
...
erlps__scan_define_1__5 args =
  EXC.badarity (ErlangFun 5 erlps__scan_define_1__5) args
...
erlps__scan_define_2__5 [arity_0, def_1,
  ...
  =
  case ms_5 of
    (ErlangMap map_8) | (DM.Just defs_9) <- (Map.lookup key_2 map_8)
                      , isEList defs_9 ->
      let
        case_10 =
      ...
      in
        case case_10 of
          (ErlangAtom "true") ->
            ...
            in let
              tup_el_16 = ErlangTuple [tup_el_17, ErlangAtom "epp", tup_el_20]
          ...
          something_else -> EXC.case_clause something_else
    (ErlangMap map_30) | (DM.Just _) <- (Map.lookup key_2 map_30) ->
      let    tup_el_35 = erlps__loc__1 [mac_3]
      in let
        tup_el_38 = ErlangTuple [ErlangAtom "redefine_predef", key_2]
      in let
        tup_el_34 = ErlangTuple [tup_el_35, ErlangAtom "epp", tup_el_38]
...
erlps__scan_define_2__5 args =
  EXC.badarity (ErlangFun 5 erlps__scan_define_2__5) args
...
erlps__scan_define_cont__6 [f_0,
  ...
  in let ms_16 = BIF.maps__merge__2 [ms0_1, mapExt_14]
  in
    EXC.tryOfCatch (\ _ -> erlps__macro_uses__1 [def_6])
      (\ of_18 ->
         let   
           uses0_25 =
             case st_2 of
               (ErlangTuple arr_24) | (DM.Just field_23) <- (arr_24 DA.!! 10) ->
                 field_23
               _ -> EXC.badrecord (ErlangAtom "epp")
         in let head_26 = ErlangTuple [arity_5, of_18]
         in let
           tail_29 =
             case uses0_25 of
               (ErlangMap map_31) | (DM.Just uselist_32) <-
                                      (Map.lookup m_3 map_31) ->
                 uselist_32
               _ -> ErlangEmptyList
         in let
           mapExt_37 =
             ErlangMap (Map.singleton m_3 (ErlangCons head_26 tail_29))
         in let uses_39 = BIF.maps__merge__2 [uses0_25, mapExt_37]
         in let
           arg_41 =
             case st_2 of
               (ErlangTuple [(ErlangAtom "epp"), file_45, location_46, delta_47,
                 ...
                 ErlangTuple
                   [ErlangAtom "epp", file_45, location_46, delta_47, name_48,
                    name2_49, istk_50, sstk_51, path_52, ms_16, uses_39,
                    default_encoding_55, pre_opened_56, fname_57]
               _ -> EXC.badrecord (ErlangAtom "epp")
         in erlps__scan_toks__2 [f_0, arg_41])
      (\ ex_19 ->
         case ex_19 of
           (ErlangTuple [(ErlangAtom "throw"),
                         (ErlangTuple [(ErlangAtom "error"), line_58,
                                       reason_59]),
                         _]) ->
             let   
               tup_el_63 = ErlangTuple [line_58, ErlangAtom "epp", reason_59]
             in let arg_61 = ErlangTuple [ErlangAtom "error", tup_el_63]
             in let _ = erlps__epp_reply__2 [f_0, arg_61]
             in erlps__wait_req_scan__1 [st_2]
           ex_20 -> EXC.raise ex_20)
erlps__scan_define_cont__6 [arg_68, arg_69, arg_70, arg_71,
                            arg_72, arg_73]
  =
  EXC.function_clause unit
erlps__scan_define_cont__6 args =
  EXC.badarity (ErlangFun 6 erlps__scan_define_cont__6) args
...
erlps__macro_uses__1 args =
  EXC.badarity (ErlangFun 1 erlps__macro_uses__1) args
...
erlps__macro_ref__1 args =
  EXC.badarity (ErlangFun 1 erlps__macro_ref__1) args
...
erlps__scan_undef__4 [(ErlangCons (ErlangTuple [(ErlangAtom "("),
  ...
  let   
    arg_9 =
      case st_7 of
        (ErlangTuple arr_12) | (DM.Just field_11) <- (arr_12 DA.!! 9) ->
          field_11
        _ -> EXC.badrecord (ErlangAtom "epp")
  ...
  in let
    arg_15 =
      case st_7 of
        (ErlangTuple arr_18) | (DM.Just field_17) <- (arr_18 DA.!! 10) ->
          field_17
        _ -> EXC.badrecord (ErlangAtom "epp")
...
erlps__scan_undef__4 [_toks_0, undef_1, from_2, st_3] =
  ...
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "bad", ErlangAtom "undef"]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  in let arg_5 = ErlangTuple [ErlangAtom "error", tup_el_7]
  in let _ = erlps__epp_reply__2 [from_2, arg_5]
...
erlps__scan_undef__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_undef__4) args
...
erlps__scan_include__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_include__4) args
...
erlps__scan_include1__4 [_toks_0, inc_1, from_2, st_3] =
  let    tup_el_8 = erlps__loc__1 [inc_1]
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "bad", ErlangAtom "include"]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  in let arg_5 = ErlangTuple [ErlangAtom "error", tup_el_7]
  in let _ = erlps__epp_reply__2 [from_2, arg_5]
...
erlps__scan_include1__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_include1__4) args
  ...
  EXC.tryCatch
    ...
    (\ ex_14 ->
       case ex_14 of
         ...
         ex_15 -> EXC.raise ex_15)
erlps__expand_lib_dir__1 [arg_16] = EXC.function_clause unit
erlps__expand_lib_dir__1 args =
  EXC.badarity (ErlangFun 1 erlps__expand_lib_dir__1) args
...
erlps__scan_include_lib__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_include_lib__4) args
  ...
  | (ErlangAtom "true") ==
      (falsifyErrors
         (\ _ ->
            ...
            in let rop_24 = toErl 8
            in BIF.erlang__op_greaterEq [lop_19, rop_24])) =
  let    tup_el_12 = erlps__loc__1 [inc_5]
  in let tup_el_17 = toErl "include_lib"
  in let tup_el_15 = ErlangTuple [ErlangAtom "depth", tup_el_17]
  in let
    tup_el_11 = ErlangTuple [tup_el_12, ErlangAtom "epp", tup_el_15]
  in let arg_9 = ErlangTuple [ErlangAtom "error", tup_el_11]
...
erlps__scan_include_lib1__4 [(ErlangCons (ErlangTuple [(ErlangAtom "("),
  ...
  in let
    arg_10 =
      case st_7 of
        (ErlangTuple arr_13) | (DM.Just field_12) <- (arr_13 DA.!! 2) ->
          field_12
        _ -> EXC.badrecord (ErlangAtom "epp")
          ...
          case case_33 of
            (ErlangTuple [(ErlangAtom "ok"), header_35]) ->
              let
                case_36 =
                  BIF.do_remote_fun_call "File" "erlps__open__2"
                    [header_35, ErlangCons (ErlangAtom "read") ErlangEmptyList]
              in
                case case_36 of
              ...
              in let
                tup_el_68 =
                  ErlangTuple
                    [ErlangAtom "include", ErlangAtom "lib", newname_9]
              in let
                tup_el_64 = ErlangTuple [tup_el_65, ErlangAtom "epp", tup_el_68]
...
erlps__scan_include_lib1__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_include_lib1__4) args
...
erlps__scan_ifdef__4 [(ErlangCons (ErlangTuple [(ErlangAtom "("),
  ...
  let
    case_8 =
      case st_7 of
        (ErlangTuple arr_11) | (DM.Just field_10) <- (arr_11 DA.!! 9) ->
          field_10
        _ -> EXC.badrecord (ErlangAtom "epp")
  in
    case case_8 of
      (ErlangMap map_12) | (DM.Just _def_13) <-
        ...
        let   
          tail_19 =
            case st_7 of
              (ErlangTuple arr_22) | (DM.Just field_21) <- (arr_22 DA.!! 6) ->
                field_21
              _ -> EXC.badrecord (ErlangAtom "epp")
        in let
          arg_15 =
              ...
              (ErlangTuple [(ErlangAtom "epp"), file_23, location_24, delta_25,
                ...
                ErlangTuple
                  [ErlangAtom "epp", file_23, location_24, delta_25, name_26,
                   name2_27, ErlangCons (ErlangAtom "ifdef") tail_19, sstk_29,
                   path_30, macs_31, uses_32, default_encoding_33,
                   pre_opened_34, fname_35]
              _ -> EXC.badrecord (ErlangAtom "epp")
        in erlps__scan_toks__2 [from_6, arg_15]
      _ ->
        erlps__skip_toks__3
          [from_6, st_7, ErlangCons (ErlangAtom "ifdef") ErlangEmptyList]
erlps__scan_ifdef__4 [(ErlangCons (ErlangTuple [(ErlangAtom "("),
                                                _llp_0]) (ErlangCons (ErlangTuple [(ErlangAtom "var"),
                                                                                   _lm_1,
                                                                                   m_2]) (ErlangCons (ErlangTuple [(ErlangAtom ")"),
...
erlps__scan_ifdef__4 [_toks_0, ifdef_1, from_2, st_3] =
  ...
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "bad", ErlangAtom "ifdef"]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  in let arg_5 = ErlangTuple [ErlangAtom "error", tup_el_7]
  in let _ = erlps__epp_reply__2 [from_2, arg_5]
...
erlps__scan_ifdef__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_ifdef__4) args
  ...
  in
    case case_8 of
      (ErlangMap map_12) | (DM.Just _def_13) <-
                             (Map.lookup m_2 map_12) ->
        erlps__skip_toks__3
          [from_6, st_7, ErlangCons (ErlangAtom "ifndef") ErlangEmptyList]
      _ ->
        let   
          tail_24 =
            case st_7 of
              ...
              (ErlangTuple [(ErlangAtom "epp"), file_28, location_29, delta_30,
                ...
                ErlangTuple
                  [ErlangAtom "epp", file_28, location_29, delta_30, name_31,
                   name2_32, ErlangCons (ErlangAtom "ifndef") tail_24, sstk_34,
                   path_35, macs_36, uses_37, default_encoding_38,
                   pre_opened_39, fname_40]
              _ -> EXC.badrecord (ErlangAtom "epp")
...
erlps__scan_ifndef__4 [_toks_0, ifndef_1, from_2, st_3] =
  ...
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "bad", ErlangAtom "ifndef"]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  in let arg_5 = ErlangTuple [ErlangAtom "error", tup_el_7]
  in let _ = erlps__epp_reply__2 [from_2, arg_5]
...
erlps__scan_ifndef__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_ifndef__4) args
  ...
  in
    case case_4 of
      (ErlangCons (ErlangAtom "else") cis_8) ->
        ...
        in let tup_el_18 = toErl "repeated"
        in let
          tup_el_16 =
            ErlangTuple [ErlangAtom "illegal", tup_el_18, ErlangAtom "else"]
        in let
          tup_el_12 = ErlangTuple [tup_el_13, ErlangAtom "epp", tup_el_16]
      ...
      (ErlangCons _i_39 cis_40) ->
        ...
        in
          erlps__skip_toks__3
            [from_2, arg_42, ErlangCons (ErlangAtom "else") ErlangEmptyList]
      (ErlangEmptyList) ->
        let    tup_el_65 = erlps__loc__1 [else_1]
        in let tup_el_70 = toErl "unbalanced"
        in let
          tup_el_68 =
            ErlangTuple [ErlangAtom "illegal", tup_el_70, ErlangAtom "else"]
        in let
          tup_el_64 = ErlangTuple [tup_el_65, ErlangAtom "epp", tup_el_68]
        in let arg_62 = ErlangTuple [ErlangAtom "error", tup_el_64]
...
erlps__scan_else__4 [_toks_0, else_1, from_2, st_3] =
  ...
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "bad", ErlangAtom "else"]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  in let arg_5 = ErlangTuple [ErlangAtom "error", tup_el_7]
  in let _ = erlps__epp_reply__2 [from_2, arg_5]
...
erlps__scan_else__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_else__4) args
       ...
       case of_6 of
         (ErlangAtom "true") ->
           ...
           in let
             arg_10 =
               case st_3 of
                 (ErlangTuple [(ErlangAtom "epp"), file_18, location_19,
                               delta_20, name_21, name2_22, istk_23, sstk_24,
                               path_25, macs_26, uses_27, default_encoding_28,
                               pre_opened_29, fname_30]) ->
                   ErlangTuple
                     [ErlangAtom "epp", file_18, location_19, delta_20, name_21,
                      name2_22, ErlangCons (ErlangAtom "if") tail_14, sstk_24,
                      path_25, macs_26, uses_27, default_encoding_28,
                      pre_opened_29, fname_30]
                 _ -> EXC.badrecord (ErlangAtom "epp")
           in erlps__scan_toks__2 [from_2, arg_10]
         _ ->
           erlps__skip_toks__3
             [from_2, st_3, ErlangCons (ErlangAtom "if") ErlangEmptyList])
    (\ ex_7 ->
       case ex_7 of
         (ErlangTuple [(ErlangAtom "throw"), error0_36, _]) ->
           let   
             error_53 =
               case error0_36 of
                 (ErlangTuple [_, (ErlangAtom "erl_parse"), _]) ->
                   ErlangTuple [ErlangAtom "error", error0_36]
                 (ErlangTuple [(ErlangAtom "error"), errl_40, what_41]) ->
                   let
                     tup_el_43 =
                       ErlangTuple [errl_40, ErlangAtom "epp", what_41]
                   in ErlangTuple [ErlangAtom "error", tup_el_43]
                 _ ->
                   let    tup_el_49 = erlps__loc__1 [if_1]
                   in let
                     tup_el_48 =
                       ErlangTuple [tup_el_49, ErlangAtom "epp", error0_36]
                   in ErlangTuple [ErlangAtom "error", tup_el_48]
           in let _ = erlps__epp_reply__2 [from_2, error_53]
           in
             erlps__wait_req_skip__2
...
erlps__scan_if__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_if__4) args
...
erlps__eval_if__2 [toks0_0, st_1] =
  ...
  in
    EXC.tryOfCatch
      ...
      (\ of_28 ->
         case of_28 of
           (ErlangTuple [(ErlangAtom "value"), res_31, _]) -> res_31
           something_else -> EXC.try_clause something_else)
      (\ ex_29 ->
         case ex_29 of
           (ErlangTuple [_, _, _]) -> ErlangAtom "false"
           ex_30 -> EXC.raise ex_30)
erlps__eval_if__2 [arg_32, arg_33] = EXC.function_clause unit
erlps__eval_if__2 args =
  EXC.badarity (ErlangFun 2 erlps__eval_if__2) args
...
erlps__assert_guard_expr__1 [(ErlangCons e0_0 (ErlangEmptyList))]
  ...
  in let
    case_4 =
      BIF.do_remote_fun_call "Erl.Lint" "erlps__is_guard_expr__1" [e_3]
  in
    case case_4 of
      (ErlangAtom "false") ->
...
erlps__assert_guard_expr__1 args =
  EXC.badarity (ErlangFun 1 erlps__assert_guard_expr__1) args
...
erlps__rewrite_expr__2 [(ErlangTuple [(ErlangAtom "call"), _,
  ...
  in ErlangTuple [ErlangAtom "atom", tup_el_10, tup_el_11]
erlps__rewrite_expr__2 [(ErlangTuple [(ErlangAtom "call"), _,
                                      (ErlangTuple [(ErlangAtom "atom"), _,
                                                    name_0]),
                                      as0_1]),
                        (ErlangAtom "none")]
  =
  let    as_4 = erlps__rewrite_expr__2 [as0_1, ErlangAtom "none"]
  ...
  in
    case case_7 of
      ...
      (ErlangAtom "true") ->
        let arg_15 = ErlangTuple [ErlangAtom "bad", ErlangAtom "if"]
...
erlps__rewrite_expr__2 [arg_1, arg_2] = EXC.function_clause unit
erlps__rewrite_expr__2 args =
  EXC.badarity (ErlangFun 2 erlps__rewrite_expr__2) args

erlps__to_conses__1 :: ErlangFun
erlps__to_conses__1 [(ErlangCons h_0 t_1)] =
  let    tup_el_3 = toErl 0
  in let tup_el_5 = erlps__to_conses__1 [t_1]
  in ErlangTuple [ErlangAtom "cons", tup_el_3, h_0, tup_el_5]
erlps__to_conses__1 [(ErlangEmptyList)] =
  let tup_el_1 = toErl 0
  in ErlangTuple [ErlangAtom "nil", tup_el_1]
erlps__to_conses__1 [arg_2] = EXC.function_clause unit
erlps__to_conses__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_conses__1) args
  ...
  in
    case case_4 of
      (ErlangCons (ErlangAtom "else") cis_8) ->
        ...
        in let tup_el_18 = toErl "unbalanced"
        in let
          tup_el_16 =
            ErlangTuple [ErlangAtom "illegal", tup_el_18, ErlangAtom "elif"]
        in let
          tup_el_12 = ErlangTuple [tup_el_13, ErlangAtom "epp", tup_el_16]
        in let arg_10 = ErlangTuple [ErlangAtom "error", tup_el_12]
        in let _ = erlps__epp_reply__2 [from_2, arg_10]
      ...
      (ErlangCons _i_39 cis_40) ->
        ...
        in
          erlps__skip_toks__3
            [from_2, arg_42, ErlangCons (ErlangAtom "elif") ErlangEmptyList]
      (ErlangEmptyList) ->
        let    tup_el_65 = erlps__loc__1 [elif_1]
        in let tup_el_70 = toErl "unbalanced"
        in let
          tup_el_68 =
            ErlangTuple [ErlangAtom "illegal", tup_el_70, ErlangAtom "elif"]
        in let
          tup_el_64 = ErlangTuple [tup_el_65, ErlangAtom "epp", tup_el_68]
        in let arg_62 = ErlangTuple [ErlangAtom "error", tup_el_64]
        in let _ = erlps__epp_reply__2 [from_2, arg_62]
...
erlps__scan_elif__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_elif__4) args
  ...
  in
    case case_4 of
      ...
      (ErlangEmptyList) ->
        ...
        in let tup_el_36 = toErl "unbalanced"
        in let
          tup_el_34 =
            ErlangTuple [ErlangAtom "illegal", tup_el_36, ErlangAtom "endif"]
        in let
          tup_el_30 = ErlangTuple [tup_el_31, ErlangAtom "epp", tup_el_34]
        in let arg_28 = ErlangTuple [ErlangAtom "error", tup_el_30]
        in let _ = erlps__epp_reply__2 [from_2, arg_28]
...
erlps__scan_endif__4 [_toks_0, endif_1, from_2, st_3] =
  ...
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "bad", ErlangAtom "endif"]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  in let arg_5 = ErlangTuple [ErlangAtom "error", tup_el_7]
  in let _ = erlps__epp_reply__2 [from_2, arg_5]
...
erlps__scan_endif__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_endif__4) args
...
erlps__scan_file__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_file__4) args
...
erlps__scan_file1__4 [(ErlangCons (ErlangTuple [(ErlangAtom "("),
  ...
  in let
    ms0_22 =
      case st_10 of
        (ErlangTuple arr_21) | (DM.Just field_20) <- (arr_21 DA.!! 9) ->
          field_20
        _ -> EXC.badrecord (ErlangAtom "epp")
  in let tup_el_30 = erlps__line1__0 []
  in let
    head_28 = ErlangTuple [ErlangAtom "string", tup_el_30, name_2]
  in let
    val_25 =
      ErlangTuple
        [ErlangAtom "none", ErlangCons head_28 ErlangEmptyList]
  in let
    mapExt_33 = ErlangMap (Map.singleton (ErlangAtom "FILE") val_25)
  in let
    ms_36 =
      case findMissingKey ms0_22 [ErlangAtom "FILE"] of
        (DM.Nothing) -> BIF.maps__merge__2 [ms0_22, mapExt_33]
        (DM.Just missing_35) -> EXC.badkey missing_35
  in let locf_38 = erlps__loc__1 [tf_8]
  in let
    arg_40 =
      case st_10 of
        (ErlangTuple arr_43) | (DM.Just field_42) <- (arr_43 DA.!! 2) ->
          field_42
        _ -> EXC.badrecord (ErlangAtom "epp")
  in let newloc_45 = erlps__new_location__3 [ln_5, arg_40, locf_38]
  in let arg_49 = toErl 2
  in let arg_48 = BIF.erlang__element__2 [arg_49, tf_8]
  in let lop_47 = erlps__get_line__1 [arg_48]
  in let lop_46 = BIF.erlang__op_minus [lop_47, ln_5]
  in let
    rop_52 =
      case st_10 of
        (ErlangTuple arr_55) | (DM.Just field_54) <- (arr_55 DA.!! 3) ->
          field_54
        _ -> EXC.badrecord (ErlangAtom "epp")
    ...
    arg_57 =
      case st_10 of
        (ErlangTuple [(ErlangAtom "epp"), file_63, location_64, delta_65,
          ...
          ErlangTuple
            [ErlangAtom "epp", file_63, newloc_45, delta_56, name_66, name_2,
             istk_68, sstk_69, path_70, ms_36, uses_72, default_encoding_73,
             pre_opened_74, fname_75]
        _ -> EXC.badrecord (ErlangAtom "epp")
  in erlps__wait_req_scan__1 [arg_57]
erlps__scan_file1__4 [_toks_0, tf_1, from_2, st_3] =
  let    tup_el_8 = erlps__loc__1 [tf_1]
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "bad", ErlangAtom "file"]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  in let arg_5 = ErlangTuple [ErlangAtom "error", tup_el_7]
  in let _ = erlps__epp_reply__2 [from_2, arg_5]
...
erlps__scan_file1__4 args =
  EXC.badarity (ErlangFun 4 erlps__scan_file1__4) args
...
erlps__new_location__3 [ln_0, (ErlangTuple [le_1, _]),
  ...
  in ErlangTuple [tup_el_3, tup_el_8]
erlps__new_location__3 [arg_9, arg_10, arg_11] =
  EXC.function_clause unit
erlps__new_location__3 args =
  EXC.badarity (ErlangFun 3 erlps__new_location__3) args
        ...
        let
          arg_170 =
            case st_1 of
              ...
              _ -> EXC.badrecord (ErlangAtom "epp")
        in erlps__skip_toks__3 [from_0, arg_170, ErlangCons i_2 sis_3]
              ...
              arg_200 =
                case st_1 of
                  (ErlangTuple [(ErlangAtom "epp"), file_203, location_204,
                                ...
                                fname_215]) ->
                    ErlangTuple
                      [ErlangAtom "epp", file_203, cl_190, delta_205, name_206,
                       name2_207, istk_208, sstk_209, path_210, macs_211,
                       uses_212, default_encoding_213, pre_opened_214,
                       fname_215]
                  _ -> EXC.badrecord (ErlangAtom "epp")
            in erlps__skip_toks__3 [from_0, arg_200, ErlangCons i_2 sis_3]
...
erlps__skip_toks__3 args =
  EXC.badarity (ErlangFun 3 erlps__skip_toks__3) args
...
erlps__skip_else__4 [else_0, from_1, st_2,
  ...
  in let tup_el_13 = toErl "repeated"
  in let
    tup_el_11 =
      ErlangTuple [ErlangAtom "illegal", tup_el_13, ErlangAtom "else"]
  in let
    tup_el_7 = ErlangTuple [tup_el_8, ErlangAtom "epp", tup_el_11]
  in let arg_5 = ErlangTuple [ErlangAtom "error", tup_el_7]
...
erlps__skip_else__4 [_else_0, from_1, st_2,
  ...
  let   
    tail_9 =
      case st_2 of
        (ErlangTuple arr_12) | (DM.Just field_11) <- (arr_12 DA.!! 6) ->
          field_11
        _ -> EXC.badrecord (ErlangAtom "epp")
  in let
    arg_5 =
...
erlps__skip_else__4 args =
  EXC.badarity (ErlangFun 4 erlps__skip_else__4) args
...
erlps__skip_elif__5 args =
  EXC.badarity (ErlangFun 5 erlps__skip_elif__5) args
...
erlps__macro_pars__2 [(ErlangCons (ErlangTuple [(ErlangAtom "var"),
                      ...
                      args_5]
  =
  let matchExpr_8 = BIF.lists__member__2 [name_0, args_5]
  in
    case matchExpr_8 of
      (ErlangAtom "false") ->
        let   
...
erlps__macro_pars__2 [(ErlangCons (ErlangTuple [(ErlangAtom "var"),
                      ...
                      args_3]
  =
  let matchExpr_6 = BIF.lists__member__2 [name_1, args_3]
  in
    case matchExpr_6 of
      (ErlangAtom "false") ->
        erlps__macro_pars__2 [ts_2, ErlangCons name_1 args_3]
      _ -> EXC.badmatch matchExpr_6
erlps__macro_pars__2 [arg_11, arg_12] = EXC.function_clause unit
erlps__macro_pars__2 args =
  EXC.badarity (ErlangFun 2 erlps__macro_pars__2) args
...
erlps__macro_expansion__2 [(ErlangCons dot_0@(ErlangTuple [(ErlangAtom "dot"),
  ...
  in let
    arg_2 =
      ErlangTuple
        [ErlangAtom "error", tup_el_4, ErlangAtom "missing_parenthesis"]
...
erlps__macro_expansion__2 args =
  EXC.badarity (ErlangFun 2 erlps__macro_expansion__2) args
...
erlps__expand_macros__4 [mact_0, m_1, toks_2, st_3] =
  case st_3 of
    (ErlangTuple [(ErlangAtom "epp"), _, _, _, _, _, _, _, _, ms_4,
      ...
      in let tinfo_11 = BIF.erlang__element__2 [arg_9, mact_0]
      in let
      ...
      in
        case case_12 of
          ...
          (ErlangTuple [(ErlangAtom "ok"),
            ...
            in
              case matchExpr_55 of
                (ErlangTuple [bs_53, toks1_54]) ->
                  let
                    arg_56 =
                      erlps__expand_macro__4 [exp_38, tinfo_11, toks1_54, bs_53]
                  in erlps__expand_macros__2 [arg_56, st_3]
                _ -> EXC.badmatch matchExpr_55
          something_else -> EXC.case_clause something_else
    _ -> EXC.badmatch st_3
erlps__expand_macros__4 [arg_62, arg_63, arg_64, arg_65] =
  EXC.function_clause unit
erlps__expand_macros__4 args =
  EXC.badarity (ErlangFun 4 erlps__expand_macros__4) args
  ...
  in
    case ms_3 of
      (ErlangMap map_9) | (DM.Just (ErlangAtom "undefined")) <-
        ...
        let   
          tup_el_13 = ErlangTuple [ErlangAtom "undefined", m_1, arity_7]
        in let arg_10 = ErlangTuple [ErlangAtom "error", lm_0, tup_el_13]
      ...
      (ErlangMap map_21) | (DM.Just defs_22) <- (Map.lookup m_1 map_21)
                         , isEList defs_22 ->
        let
          case_23 =
            BIF.do_remote_fun_call "Proplists" "erlps__get_value__2"
        ...
        in
          case case_23 of
            (ErlangAtom "undefined") ->
              ...
              in let arg_26 = ErlangTuple [ErlangAtom "error", lm_0, tup_el_29]
      ...
      _ ->
        let   
          tup_el_42 = ErlangTuple [ErlangAtom "undefined", m_1, arity_7]
        in let arg_39 = ErlangTuple [ErlangAtom "error", lm_0, tup_el_42]
        in BIF.erlang__throw__1 [arg_39]
erlps__expand_macro1__4 [arg_46, arg_47, arg_48, arg_49] =
  EXC.function_clause unit
erlps__expand_macro1__4 args =
  EXC.badarity (ErlangFun 4 erlps__expand_macro1__4) args
      ...
      (ErlangAtom "true") ->
        case m_0 of
          (ErlangTuple [name_8, arity_9]) ->
            let   
              tup_el_14 = ErlangTuple [ErlangAtom "circular", name_8, arity_9]
            in let arg_11 = ErlangTuple [ErlangAtom "error", lm_4, tup_el_14]
            in BIF.erlang__throw__1 [arg_11]
          _ -> EXC.badmatch m_0
      (ErlangAtom "false") ->
        let    l_20 = erlps__get_macro_uses__2 [m_0, u_3]
        in let
          _ = erlps__check_uses__4 [l_20, ErlangCons m_0 anc_2, u_3, lm_4]
        in erlps__check_uses__4 [rest_1, anc_2, u_3, lm_4]
      something_else -> EXC.case_clause something_else
erlps__check_uses__4 [arg_31, arg_32, arg_33, arg_34] =
  EXC.function_clause unit
erlps__check_uses__4 args =
  EXC.badarity (ErlangFun 4 erlps__check_uses__4) args
...
erlps__get_macro_uses__2 args =
  EXC.badarity (ErlangFun 2 erlps__get_macro_uses__2) args
...
erlps__expand_macros__2 [(ErlangCons (ErlangTuple [(ErlangAtom "?"),
  ...
  in let
    case_9 =
      case st_7 of
        (ErlangTuple arr_12) | (DM.Just field_11) <- (arr_12 DA.!! 13) ->
          field_11
        _ -> EXC.badrecord (ErlangAtom "epp")
  in let
    lop_8 =
    ...
    lop_8 =
      case case_9 of
        ...
        (ErlangTuple [_, arity_19]) ->
          let head_20 = ErlangTuple [ErlangAtom "integer", lm_1, arity_19]
          in ErlangCons head_20 ErlangEmptyList
        something_else -> EXC.case_clause something_else
  in let rop_25 = erlps__expand_macros__2 [toks_3, st_7]
  in BIF.erlang__op_append [lop_8, rop_25]
erlps__expand_macros__2 [(ErlangCons (ErlangTuple [(ErlangAtom "?"),
  ...
  in let head_7 = ErlangTuple [ErlangAtom "integer", lm_1, line_6]
    ...
    t_13 =
      case case_4 of
        ...
        (ErlangAtom "undefined") ->
          ...
          in let
            arg_9 =
              ErlangBinary (BIN.fromInts (toErl "~tp") (toErl 8) 1 BIN.Big)
          in
            BIF.do_remote_fun_call "Io.Lib" "erlps__fwrite__2"
              [arg_9, ErlangCons symbol_8 ErlangEmptyList]
        something_else -> EXC.case_clause something_else
  in let tup_el_16 = erlps__loc__1 [token_1]
  in let head_21 = toErl 63
  in let
    tup_el_18 =
      ErlangTuple [ErlangAtom "call", ErlangCons head_21 t_13]
  in let
    arg_14 = ErlangTuple [ErlangAtom "error", tup_el_16, tup_el_18]
  in BIF.erlang__throw__1 [arg_14]
...
erlps__expand_macros__2 [(ErlangEmptyList), _st_0] =
  ErlangEmptyList
erlps__expand_macros__2 [arg_1, arg_2] = EXC.function_clause unit
erlps__expand_macros__2 args =
  EXC.badarity (ErlangFun 2 erlps__expand_macros__2) args
...
erlps__bind_args__5 [_toks_0, lm_1, m_2, _as_3, _bs_4] =
  ...
  in let arg_5 = ErlangTuple [ErlangAtom "error", lm_1, tup_el_8]
  in BIF.erlang__throw__1 [arg_5]
erlps__bind_args__5 [arg_11, arg_12, arg_13, arg_14, arg_15] =
  EXC.function_clause unit
erlps__bind_args__5 args =
  EXC.badarity (ErlangFun 5 erlps__bind_args__5) args
...
erlps__macro_args__5 [(ErlangEmptyList), lm_0, m_1, _as_2, _bs_3]
  ...
  in let arg_4 = ErlangTuple [ErlangAtom "error", lm_0, tup_el_7]
...
erlps__macro_args__5 args =
  EXC.badarity (ErlangFun 5 erlps__macro_args__5) args
...
erlps__store_arg__5 [l_0, m_1, _a_2, (ErlangEmptyList), _bs_3] =
  ...
  in let arg_4 = ErlangTuple [ErlangAtom "error", l_0, tup_el_7]
  in BIF.erlang__throw__1 [arg_4]
erlps__store_arg__5 [_l_0, _m_1, a_2, arg_3, bs_4] =
  let mapExt_8 = ErlangMap (Map.singleton a_2 arg_3)
  in BIF.maps__merge__2 [bs_4, mapExt_8]
erlps__store_arg__5 [arg_10, arg_11, arg_12, arg_13, arg_14] =
  EXC.function_clause unit
erlps__store_arg__5 args =
  EXC.badarity (ErlangFun 5 erlps__store_arg__5) args
...
erlps__count_args__3 [(ErlangCons (ErlangTuple [(ErlangAtom "("),
  ...
  in let arg_5 = ErlangTuple [ErlangAtom "error", lm_3, tup_el_8]
  in BIF.erlang__throw__1 [arg_5]
erlps__count_args__3 [(ErlangCons (ErlangTuple [(ErlangAtom "("),
                                                _llp_0]) toks0_1),
                      lm_2, m_3]
  ...
  in
    case matchExpr_9 of
      (ErlangTuple [_arg_7, toks1_8]) ->
        let arg_13 = toErl 1
        in erlps__count_args__4 [toks1_8, lm_2, m_3, arg_13]
...
erlps__count_args__3 args =
  EXC.badarity (ErlangFun 3 erlps__count_args__3) args
...
erlps__count_args__4 [(ErlangCons (ErlangTuple [(ErlangAtom ","),
  ...
  in let arg_6 = ErlangTuple [ErlangAtom "error", lm_3, tup_el_9]
  in BIF.erlang__throw__1 [arg_6]
erlps__count_args__4 [(ErlangCons (ErlangTuple [(ErlangAtom ","),
                                                _lc_0]) toks0_1),
                      lm_2, m_3, nbargs_4]
  ...
  in
    case matchExpr_10 of
      (ErlangTuple [_arg_8, toks1_9]) ->
        let    rop_16 = toErl 1
        in let arg_14 = BIF.erlang__op_plus [nbargs_4, rop_16]
...
erlps__count_args__4 [(ErlangEmptyList), lm_0, m_1, _nbargs_2] =
  ...
  in let arg_3 = ErlangTuple [ErlangAtom "error", lm_0, tup_el_6]
...
erlps__count_args__4 [_toks_0, lm_1, m_2, _nbargs_3] =
  ...
  in let arg_4 = ErlangTuple [ErlangAtom "error", lm_1, tup_el_7]
  in BIF.erlang__throw__1 [arg_4]
erlps__count_args__4 [arg_10, arg_11, arg_12, arg_13] =
  EXC.function_clause unit
erlps__count_args__4 args =
  EXC.badarity (ErlangFun 4 erlps__count_args__4) args
...
erlps__macro_arg__3 args =
  EXC.badarity (ErlangFun 3 erlps__macro_arg__3) args
...
erlps__expand_macro__4 [(ErlangCons (ErlangTuple [(ErlangAtom "var"),
  ...
  =
  case bs_5 of
    (ErlangMap map_7) | (DM.Just val_8) <- (Map.lookup v_1 map_7) ->
      erlps__expand_arg__5 [val_8, ts_2, l_3, rest_4, bs_5]
    _ ->
      let    head_14 = ErlangTuple [ErlangAtom "var", l_3, v_1]
      in let tail_18 = erlps__expand_macro__4 [ts_2, l_3, rest_4, bs_5]
...
erlps__expand_macro__4 [(ErlangCons (ErlangTuple [(ErlangAtom "?"),
  ...
  case bs_5 of
    ...
    _ ->
      ...
      in let tail_20 = erlps__expand_macro__4 [ts_2, l_3, rest_4, bs_5]
      in ErlangCons head_16 tail_20
erlps__expand_macro__4 [(ErlangCons t_0 ts_1), l_2, rest_3, bs_4]
  =
  let    arg_6 = toErl 2
  in let head_5 = BIF.erlang__setelement__3 [arg_6, t_0, l_2]
  in let tail_9 = erlps__expand_macro__4 [ts_1, l_2, rest_3, bs_4]
...
erlps__expand_macro__4 args =
  EXC.badarity (ErlangFun 4 erlps__expand_macro__4) args
...
erlps__expand_arg__5 [(ErlangCons a_0 as_1), ts_2, _l_3, rest_4,
  ...
  =
  let    arg_6 = toErl 2
  in let nextl_8 = BIF.erlang__element__2 [arg_6, a_0]
  in let
    tail_10 =
...
erlps__expand_arg__5 args =
  EXC.badarity (ErlangFun 5 erlps__expand_arg__5) args
             ...
             arg_4 =
               case st_2 of
                 (ErlangTuple [(ErlangAtom "epp"), file_7, location_8, delta_9,
                   ...
                   ErlangTuple
                     [ErlangAtom "epp", file_7, location_8, delta_9, name_10,
                      name2_11, istk_12, sstk_13, path_14, macs_15, uses_16,
                      default_encoding_17, pre_opened_18,
                      ErlangAtom "undefined"]
                 _ -> EXC.badrecord (ErlangAtom "epp")
  ...
  in
    case toks1_33 of
      (ErlangCons (ErlangTuple [(ErlangAtom "atom"), _,
                                name_35]) (ErlangCons (ErlangTuple [(ErlangAtom "("),
                                                                    _]) toks_36)) ->
        let    arg_38 = toErl 1
        in let tup_el_41 = toErl 0
        in let arg_39 = ErlangTuple [name_35, tup_el_41]
        in let
          fa_43 =
            erlps__update_fun_name_1__4 [toks_36, arg_38, arg_39, st_2]
        in
          case st_2 of
            (ErlangTuple [(ErlangAtom "epp"), file_46, location_47, delta_48,
                          name_49, name2_50, istk_51, sstk_52, path_53, macs_54,
                          uses_55, default_encoding_56, pre_opened_57,
                          fname_58]) ->
              ErlangTuple
                [ErlangAtom "epp", file_46, location_47, delta_48, name_49,
                 name2_50, istk_51, sstk_52, path_53, macs_54, uses_55,
                 default_encoding_56, pre_opened_57, fa_43]
            _ -> EXC.badrecord (ErlangAtom "epp")
      (ErlangCons (ErlangTuple [(ErlangAtom "?"), _]) _) ->
        case token_0 of
          (ErlangTuple [(ErlangAtom "var"), _, macro_59]) ->
            let    tup_el_63 = erlps__loc__1 [token_0]
            in let
              tup_el_65 =
                ErlangTuple [ErlangAtom "illegal_function_usage", macro_59]
            in let
              arg_61 = ErlangTuple [ErlangAtom "error", tup_el_63, tup_el_65]
            in BIF.erlang__throw__1 [arg_61]
          _ -> EXC.badmatch token_0
      _ | isEList toks1_33 ->
        case token_0 of
          (ErlangTuple [(ErlangAtom "var"), _, macro_68]) ->
            let    tup_el_72 = erlps__loc__1 [token_0]
            in let
              tup_el_74 = ErlangTuple [ErlangAtom "illegal_function", macro_68]
            in let
              arg_70 = ErlangTuple [ErlangAtom "error", tup_el_72, tup_el_74]
            in BIF.erlang__throw__1 [arg_70]
          _ -> EXC.badmatch token_0
      _ ->
        let    tup_el_80 = toErl 0
        in let record_updt_78 = ErlangTuple [ErlangAtom "_", tup_el_80]
        in
          case st_2 of
            (ErlangTuple [(ErlangAtom "epp"), file_81, location_82, delta_83,
                          name_84, name2_85, istk_86, sstk_87, path_88, macs_89,
                          uses_90, default_encoding_91, pre_opened_92,
                          fname_93]) ->
              ErlangTuple
                [ErlangAtom "epp", file_81, location_82, delta_83, name_84,
                 name2_85, istk_86, sstk_87, path_88, macs_89, uses_90,
                 default_encoding_91, pre_opened_92, record_updt_78]
            _ -> EXC.badrecord (ErlangAtom "epp")
erlps__update_fun_name__2 [_token_0, st_1] = st_1
erlps__update_fun_name__2 [arg_2, arg_3] =
  EXC.function_clause unit
erlps__update_fun_name__2 args =
  EXC.badarity (ErlangFun 2 erlps__update_fun_name__2) args
...
erlps__update_fun_name_1__4 [(ErlangCons tok_0 toks_1), l_2,
  ...
  in
    case case_5 of
          ...
          _ | (==) l_2 (toErl 1) ->
            case fa_3 of
              (ErlangTuple [name_7, arity_8]) ->
                let    rop_16 = toErl 1
                in let tup_el_14 = BIF.erlang__op_plus [arity_8, rop_16]
      ...
      (ErlangAtom "left") ->
        let    rop_25 = toErl 1
        in let arg_23 = BIF.erlang__op_plus [l_2, rop_25]
        in erlps__update_fun_name_1__4 [toks_1, arg_23, fa_3, st_4]
      (ErlangAtom "right") | (==) l_2 (toErl 1) -> fa_3
      (ErlangAtom "right") ->
        let    rop_31 = toErl 1
        in let arg_29 = BIF.erlang__op_minus [l_2, rop_31]
...
erlps__update_fun_name_1__4 args =
  EXC.badarity (ErlangFun 4 erlps__update_fun_name_1__4) args
...
erlps__classify_token__1 args =
  EXC.badarity (ErlangFun 1 erlps__classify_token__1) args
...
erlps__classify_token_1__1 args =
  EXC.badarity (ErlangFun 1 erlps__classify_token_1__1) args
...
erlps__token_src__1 args =
  EXC.badarity (ErlangFun 1 erlps__token_src__1) args
...
erlps__stringify1__1 args =
  EXC.badarity (ErlangFun 1 erlps__stringify1__1) args
...
erlps__stringify__2 args =
  EXC.badarity (ErlangFun 2 erlps__stringify__2) args
...
erlps__coalesce_strings__1 args =
  EXC.badarity (ErlangFun 1 erlps__coalesce_strings__1) args
...
erlps__coalesce_strings__3 [(ErlangCons (ErlangTuple [(ErlangAtom "string"),
                            ...
                            a_2, s0_3]
  =
  erlps__coalesce_strings__3 [tokens_1, a_2, ErlangCons s_0 s0_3]
erlps__coalesce_strings__3 [tokens_0, a_1, s_2] =
  let   
    arg_7 = BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [s_2]
  in let
    tup_el_6 =
      BIF.do_remote_fun_call "Lists" "erlps__append__1" [arg_7]
  in let head_3 = ErlangTuple [ErlangAtom "string", a_1, tup_el_6]
...
erlps__epp_request__2 [arg_11, arg_12] = EXC.function_clause unit
erlps__epp_request__2 args =
  EXC.badarity (ErlangFun 2 erlps__epp_request__2) args
...
erlps__epp_reply__2 args =
  EXC.badarity (ErlangFun 2 erlps__epp_reply__2) args

erlps__wait_epp_reply__2 :: ErlangFun
erlps__wait_epp_reply__2 [epp_0, mref_1] =
  let match_final_2_3 = toErl 1
  in
    case match_final_2_3 of
      (ErlangAtom "processes_unsuported") -> match_final_2_3
      _ -> EXC.badmatch match_final_2_3
erlps__wait_epp_reply__2 [arg_5, arg_6] =
  EXC.function_clause unit
erlps__wait_epp_reply__2 args =
  EXC.badarity (ErlangFun 2 erlps__wait_epp_reply__2) args
  ...
  in
    case matchExpr_5 of
      (ErlangCons (ErlangCons (ErlangInt num_2) var_3) rest_4) | (ErlangInt
                                                                   ...
                                                                   (toErl 36) ->
        let   
          value_7 = BIF.do_remote_fun_call "Os" "erlps__getenv__1" [var_3]
        in let
          matchExpr_10 =
...
erlps__fname_join__1 [components_0] =
  BIF.do_remote_fun_call "Filename" "erlps__join__1" [components_0]
erlps__fname_join__1 [arg_2] = EXC.function_clause unit
erlps__fname_join__1 args =
  EXC.badarity (ErlangFun 1 erlps__fname_join__1) args
...
erlps__loc_anno__1 args =
  EXC.badarity (ErlangFun 1 erlps__loc_anno__1) args

erlps__loc__1 :: ErlangFun
erlps__loc__1 [token_0] =
  BIF.do_remote_fun_call "Erl.Scan" "erlps__location__1" [token_0]
...
erlps__line1__0 args =
  EXC.badarity (ErlangFun 0 erlps__line1__0) args
...
erlps__interpret_file_attribute__1 [forms_0] =
  let arg_2 = toErl 0
  in
    erlps__interpret_file_attr__3 [forms_0, arg_2, ErlangEmptyList]
erlps__interpret_file_attribute__1 [arg_4] =
  EXC.function_clause unit
erlps__interpret_file_attribute__1 args =
  EXC.badarity (ErlangFun 1 erlps__interpret_file_attribute__1)
    args
  ...
  in
    case ErlangAtom "true" of
      ...
      _ | (ErlangAtom "true") ==
        ...
        case fs_6 of
          (ErlangCons _ (ErlangCons file_20 fs1_21)) | file_20 == file_1 ->
            let    arg_25 = toErl 0
            in let
              tail_23 =
                erlps__interpret_file_attr__3
                  [forms_4, arg_25, ErlangCons file_1 fs1_21]
          ...
          _ ->
            ...
            in let
              tail_30 =
                erlps__interpret_file_attr__3
                  [forms_4, arg_32, ErlangCons file_1 fs_6]
  ...
  in let
    form_16 =
      BIF.do_remote_fun_call "Erl.Parse" "erlps__map_anno__2"
        [f_13, form0_0]
  in let
    tail_18 = erlps__interpret_file_attr__3 [forms_1, delta_2, fs_3]
...
erlps__interpret_file_attr__3 args =
  EXC.badarity (ErlangFun 3 erlps__interpret_file_attr__3) args