...
erlps__mktext__1 args =
  EXC.badarity (ErlangFun 1 erlps__mktext__1) args
...
erlps__null_text__1 args =
  EXC.badarity (ErlangFun 1 erlps__null_text__1) args

erlps__text_par__1 :: ErlangFun
erlps__text_par__1 [s_0] =
  let arg_2 = toErl 0
  in erlps__text_par__2 [s_0, arg_2]
erlps__text_par__1 [arg_3] = EXC.function_clause unit
erlps__text_par__1 args =
  EXC.badarity (ErlangFun 1 erlps__text_par__1) args
...
erlps__text_par__2 [s_0, n_1] | weakGt n_1 (toErl 0) =
...
erlps__text_par__2 [s_0, n_1] | weakLt n_1 (toErl 0) =
  let    arg_2 = erlps__words__1 [s_0]
...
erlps__text_par__2 args =
  EXC.badarity (ErlangFun 2 erlps__text_par__2) args
...
erlps__words__3 [arg_5, arg_6, arg_7] = EXC.function_clause unit
erlps__words__3 args =
  EXC.badarity (ErlangFun 3 erlps__words__3) args
...
erlps__words_1__3 [cs_0, as_1, ws_2] =
  let   
    arg_7 = BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [as_1]
  in let head_6 = erlps__text__1 [arg_7]
  in
    erlps__words__3 [cs_0, ErlangEmptyList, ErlangCons head_6 ws_2]
erlps__words_1__3 [arg_10, arg_11, arg_12] =
  EXC.function_clause unit
erlps__words_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__words_1__3) args
...
erlps__break__1 args =
  EXC.badarity (ErlangFun 1 erlps__break__1) args
...
erlps__nest__2 args =
  EXC.badarity (ErlangFun 2 erlps__nest__2) args
...
erlps__beside__2 args =
  EXC.badarity (ErlangFun 2 erlps__beside__2) args
...
erlps__above__2 args =
  EXC.badarity (ErlangFun 2 erlps__above__2) args
...
erlps__sep__1 [ds_0] =
  ...
  in
    ErlangTuple
      [ErlangAtom "sep", ds_0, tup_el_3, ErlangAtom "false"]
...
erlps__mksep__3 [ds_0, n_1, p_2] | isEInt n_1 =
  ErlangTuple [ErlangAtom "sep", ds_0, n_1, p_2]
erlps__mksep__3 [arg_7, arg_8, arg_9] = EXC.function_clause unit
erlps__mksep__3 args =
  EXC.badarity (ErlangFun 3 erlps__mksep__3) args

erlps__follow__2 :: ErlangFun
erlps__follow__2 [d1_0, d2_1] =
  let arg_4 = toErl 0
  in erlps__follow__3 [d1_0, d2_1, arg_4]
...
erlps__follow__3 [d1_0, d2_1, n_2] | isEInt n_2 =
...
erlps__format__2 [d_0, w_1] =
  let arg_4 = toErl 65
  in erlps__format__3 [d_0, w_1, arg_4]
...
erlps__layout__1 [l_0] =
  let    arg_2 = toErl 0
  in let arg_1 = erlps__layout__3 [arg_2, l_0, ErlangEmptyList]
...
erlps__layout__1 args =
  EXC.badarity (ErlangFun 1 erlps__layout__1) args
...
erlps__layout__3 [n_0,
  ...
  =
  let head_6 = toErl 10
  in erlps__layout__3 [n_0, l_1, ErlangCons head_6 cs_2]
erlps__layout__3 [n_0,
                  (ErlangTuple [(ErlangAtom "above"),
  ...
  =
  let    head_7 = toErl 10
  in let arg_9 = erlps__string_chars__1 [s_1]
  in let arg_11 = erlps__indent__2 [n_0, cs_3]
  in let tail_8 = erlps__flatrev__2 [arg_9, arg_11]
  in erlps__layout__3 [n_0, l_2, ErlangCons head_7 tail_8]
erlps__layout__3 [n_0,
...
erlps__layout__3 [arg_2, arg_3, arg_4] = EXC.function_clause unit
erlps__layout__3 args =
  EXC.badarity (ErlangFun 3 erlps__layout__3) args

erlps__indent__2 :: ErlangFun
erlps__indent__2 [n_0, cs_1] | weakGt n_0 (toErl 0) =
  let    rop_4 = toErl 1
  in let arg_2 = BIF.erlang__op_minus [n_0, rop_4]
  in let head_6 = toErl 32
  in erlps__indent__2 [arg_2, ErlangCons head_6 cs_1]
...
erlps__flatrev__2 args =
  EXC.badarity (ErlangFun 2 erlps__flatrev__2) args
...
erlps__flatrev__3 args =
  EXC.badarity (ErlangFun 3 erlps__flatrev__3) args

erlps__best__3 :: ErlangFun
erlps__best__3 [d_0, w_1, r_2] =
  let    tup_el_8 = toErl 0
  in let
    arg_4 =
      ErlangTuple [ErlangAtom "c_best_nest", w_1, r_2, tup_el_8]
  in erlps__rewrite__2 [d_0, arg_4]
erlps__best__3 [arg_9, arg_10, arg_11] = EXC.function_clause unit
erlps__best__3 args =
  EXC.badarity (ErlangFun 3 erlps__best__3) args
  ...
  case c_1 of
          ...
          in
            case case_55 of
              (ErlangAtom "false") ->
                ...
                in let
                  arg_62 =
                    erlps__mksep__3 [ErlangCons head_64 ds_52, arg_72, arg_75]
                ...
                in
                  case case_80 of
                    (ErlangAtom "false") ->
                      ...
                      in let arg_84 = erlps__expand_sep__3 [arg_85, ds_52, n_53]
                    ...
                    (ErlangAtom "true") ->
                      ...
                      in let arg_93 = erlps__expand_par__3 [arg_94, ds_52, n_53]
          ...
          in
            case case_108 of
              (ErlangAtom "true") ->
                let
                  arg_118 =
                    ErlangTuple [ErlangAtom "c_best_nest", w_102, r_103, n_104]
    ...
    (ErlangTuple [(ErlangAtom "c_beside"), d1_161, c1_162]) ->
      case c1_162 of
          ...
          in
            case case_233 of
              (ErlangAtom "true") ->
                let
                  arg_243 =
                    ErlangTuple [ErlangAtom "c_best_nest", w_227, r_228, n_229]
        ...
        _ ->
          let
            arg_275 = ErlangTuple [ErlangAtom "c_text_beside", s_0, c1_162]
      ...
      in
        case case_289 of
          (ErlangAtom "false") ->
            ...
            in let
              arg_294 =
                erlps__mksep__3 [ErlangCons head_296 ds_286, arg_298, arg_302]
            ...
            in
              case case_307 of
                (ErlangAtom "false") ->
                  ...
                  in let arg_311 = erlps__expand_sep__3 [arg_312, ds_286, n_287]
                  in erlps__rewrite__2 [arg_311, c1_288]
                (ErlangAtom "true") ->
                  let    arg_317 = erlps__nil__0 []
                  in let arg_316 = erlps__expand_par__3 [arg_317, ds_286, n_287]
  ...
  case c_2 of
    ...
    (ErlangTuple [(ErlangAtom "c_sep_nest"), ds_38, n1_39, _,
      ...
      in let
        arg_50 =
          case c_2 of
            (ErlangTuple arr_53) | (DM.Just field_52) <- (arr_53 DA.!! 3) ->
              field_52
            _ -> EXC.badrecord (ErlangAtom "c_sep_nest")
      in let
        arg_43 = erlps__mksep__3 [ErlangCons d_1 ds_38, arg_47, arg_50]
  ...
  case c_2 of
    (ErlangTuple [(ErlangAtom "c_above_nest"), d3_4, n_5, c1_6]) ->
      ...
      in let
        arg_8 =
          ErlangTuple
            [ErlangAtom "c_above_nest", tup_el_10, tup_el_15, c1_6]
    ...
    _ ->
      ...
      in let
        arg_29 =
          ErlangTuple [ErlangAtom "c_above_nest", d2_1, tup_el_32, c_2]
...
erlps__rewrite__2 [(ErlangTuple [(ErlangAtom "union"), d1_0,
  ...
  case c_2 of
    (ErlangTuple [(ErlangAtom "c_best_nest"), w_4, r_5, n_6]) ->
      let
        arg_8 =
          ErlangTuple [ErlangAtom "c_best_nest_or", w_4, r_5, n_6, d2_1]
      in erlps__rewrite__2 [d1_0, arg_8]
    ...
    (ErlangTuple [(ErlangAtom "c_sep_nest"), ds_51, n_52, _,
      ...
      let   
        arg_60 =
          case c_2 of
            (ErlangTuple arr_63) | (DM.Just field_62) <- (arr_63 DA.!! 3) ->
              field_62
            _ -> EXC.badrecord (ErlangAtom "c_sep_nest")
      in let
        arg_55 = erlps__mksep__3 [ErlangCons d1_0 ds_51, n_52, arg_60]
      in let
        arg_69 =
          case c_2 of
            (ErlangTuple arr_72) | (DM.Just field_71) <- (arr_72 DA.!! 3) ->
              field_71
            _ -> EXC.badrecord (ErlangAtom "c_sep_nest")
      in let
        arg_64 = erlps__mksep__3 [ErlangCons d2_1 ds_51, n_52, arg_69]
...
erlps__rewrite__2 [(ErlangAtom "empty"), c_0] =
  case c_0 of
    ...
    (ErlangTuple [(ErlangAtom "c_best_nest_or"), w_14, r_15, n_16,
                  d_17]) ->
      let
        arg_19 = ErlangTuple [ErlangAtom "c_best_nest", w_14, r_15, n_16]
    ...
    (ErlangTuple [(ErlangAtom "c_beside"), d1_5, c1_6]) ->
      case c1_6 of
        ...
        _ ->
          let
            arg_77 =
              ErlangTuple [ErlangAtom "c_float_beside", d_0, h_1, v_2, c1_6]
      ...
      case c1_85 of
        ...
        _ ->
          let
            arg_164 =
              ErlangTuple
                [ErlangAtom "c_float_above_nest", d_0, h_1, v_2, n_84, c1_85]
...
erlps__rewrite__2 [(ErlangAtom "null"), c_0] =
  case c_0 of
    ...
    (ErlangTuple [(ErlangAtom "c_best_nest_or"), w_20, r_21, n_22,
                  _]) ->
      let
        arg_24 = ErlangTuple [ErlangAtom "c_best_nest", w_20, r_21, n_22]
...
erlps__rewrite__2 args =
  EXC.badarity (ErlangFun 2 erlps__rewrite__2) args
...
erlps__nil__0 args =
  EXC.badarity (ErlangFun 0 erlps__nil__0) args

erlps__hspace__0 :: ErlangFun
erlps__hspace__0 [] =
  let head_1 = toErl 32
  in erlps__text__1 [ErlangCons head_1 ErlangEmptyList]
erlps__hspace__0 args =
  EXC.badarity (ErlangFun 0 erlps__hspace__0) args
...
erlps__expand_sep__3 [d_0, ds_1, n_2] =
  ...
  in let
    tail_11 =
      flmap
        (\ lc_14 ->
           let lcRet_15 = erlps__nest__2 [n_2, lc_14]
...
erlps__expand_sep__3 args =
  EXC.badarity (ErlangFun 3 erlps__expand_sep__3) args
...
erlps__expand_par__3 [d_0, dl_3@(ErlangCons d1_1 ds_2), n_4] =
  ...
  in let arg_15 = BIF.erlang__op_minus [n_4, rop_17]
  in let
    arg_10 =
      erlps__mksep__3
...
erlps__expand_par__3 args =
  EXC.badarity (ErlangFun 3 erlps__expand_par__3) args
...
erlps__horizontal__1 args =
  EXC.badarity (ErlangFun 1 erlps__horizontal__1) args
...
erlps__vertical__1 args =
  EXC.badarity (ErlangFun 1 erlps__vertical__1) args
...
erlps__foldr1__2 args =
  EXC.badarity (ErlangFun 2 erlps__foldr1__2) args
...
erlps__null_string__1 args =
  EXC.badarity (ErlangFun 1 erlps__null_string__1) args
...
erlps__string_chars__1 args =
  EXC.badarity (ErlangFun 1 erlps__string_chars__1) args
...
erlps__strwidth__2 args =
  EXC.badarity (ErlangFun 2 erlps__strwidth__2) args