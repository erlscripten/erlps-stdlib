...
erlps__predefined_functions__1 [forms_0] =
        ...
        (\ lc_4 ->
           case lc_4 of
             (ErlangTuple [(ErlangAtom "attribute"), _, name_2, val_3]) ->
               let lcRet_5 = ErlangTuple [name_2, val_3]
  ...
  in let
    matchExpr_13 =
      BIF.lists__keyfind__3 [ErlangAtom "module", arg_10, attrs_8]
  in
    case matchExpr_13 of
      (ErlangTuple [(ErlangAtom "module"), mod_12]) ->
        let   
          callbacks_18 =
            flmap
              ...
              attrs_8
        in let
          optionalcallbacks_20 = erlps__get_optional_callbacks__1 [attrs_8]
        in let
          mpf1_23 =
            erlps__module_predef_func_beh_info__2
              [callbacks_18, optionalcallbacks_20]
        in let mpf2_25 = erlps__module_predef_funcs_mod_info__1 [mod_12]
        in let lcSrc_26 = BIF.erlang__op_append [mpf1_23, mpf2_25]
        in let
          mpf_33 =
            flmap
              (\ lc_30 ->
              ...
              (\ lc_37 ->
                 case lc_37 of
                   (ErlangTuple [(ErlangAtom "function"), _, f_35, a_36, _]) ->
                     let lcRet_38 = ErlangTuple [f_35, a_36]
        ...
        in let
          head_42 =
            ErlangTuple
              [ErlangAtom "attribute", tup_el_44, ErlangAtom "export", exp_41]
...
erlps__module_predef_func_beh_info__2 [callbacks0_0,
  ...
  in let
    head_21 =
      ErlangTuple
        [ErlangAtom "atom", tup_el_23, ErlangAtom "callbacks"]
  in let
    head_17 =
      ErlangTuple
        [ErlangAtom "clause", tup_el_19,
  ...
  in let
    head_35 =
      ErlangTuple
        [ErlangAtom "atom", tup_el_37, ErlangAtom "optional_callbacks"]
  in let
    head_31 =
      ErlangTuple
        [ErlangAtom "clause", tup_el_33,
         ErlangCons head_35 ErlangEmptyList, ErlangEmptyList,
         ErlangCons optionallist_10 ErlangEmptyList]
  in let
    head_11 =
      ErlangTuple
        [ErlangAtom "function", tup_el_13, ErlangAtom "behaviour_info",
         tup_el_15,
...
erlps__make_list__1 [(ErlangCons (ErlangTuple [name_0,
  ...
  in let
    head_9 = ErlangTuple [ErlangAtom "atom", tup_el_11, name_0]
  in let tup_el_16 = toErl 0
  in let
    head_14 = ErlangTuple [ErlangAtom "integer", tup_el_16, arity_1]
  in let
    tup_el_5 =
      ErlangTuple
        [ErlangAtom "tuple", tup_el_7,
...
erlps__module_predef_funcs_mod_info__1 [mod_0] =
  ...
  in let
    modatom_4 = ErlangTuple [ErlangAtom "atom", tup_el_2, mod_0]
  in let tup_el_7 = toErl 0
  ...
  in let
    tup_el_23 =
      ErlangTuple [ErlangAtom "atom", tup_el_25, ErlangAtom "erlang"]
  in let tup_el_29 = toErl 0
  in let
    tup_el_27 =
      ErlangTuple
        [ErlangAtom "atom", tup_el_29, ErlangAtom "get_module_info"]
  in let
    tup_el_20 =
      ErlangTuple
        [ErlangAtom "remote", tup_el_22, tup_el_23, tup_el_27]
  in let
    head_17 =
      ErlangTuple
        [ErlangAtom "call", tup_el_19, tup_el_20,
         ErlangCons modatom_4 ErlangEmptyList]
  in let
    head_11 =
      ErlangTuple
        [ErlangAtom "clause", tup_el_13, ErlangEmptyList,
         ErlangEmptyList, ErlangCons head_17 ErlangEmptyList]
  in let
    head_5 =
      ErlangTuple
        [ErlangAtom "function", tup_el_7, ErlangAtom "module_info",
         tup_el_9, ErlangCons head_11 ErlangEmptyList]
  in let tup_el_39 = toErl 0
  in let tup_el_41 = toErl 1
  in let tup_el_45 = toErl 0
  in let tup_el_49 = toErl 0
  in let
    head_47 =
      ErlangTuple [ErlangAtom "var", tup_el_49, ErlangAtom "X"]
  in let tup_el_56 = toErl 0
  in let tup_el_59 = toErl 0
  in let tup_el_62 = toErl 0
  in let
    tup_el_60 =
      ErlangTuple [ErlangAtom "atom", tup_el_62, ErlangAtom "erlang"]
  in let tup_el_66 = toErl 0
  in let
    tup_el_64 =
      ErlangTuple
        [ErlangAtom "atom", tup_el_66, ErlangAtom "get_module_info"]
  in let
    tup_el_57 =
      ErlangTuple
        [ErlangAtom "remote", tup_el_59, tup_el_60, tup_el_64]
  in let tup_el_73 = toErl 0
  in let
    head_71 =
      ErlangTuple [ErlangAtom "var", tup_el_73, ErlangAtom "X"]
  in let
    head_54 =
      ErlangTuple
        [ErlangAtom "call", tup_el_56, tup_el_57,
         ErlangCons modatom_4 (ErlangCons head_71 ErlangEmptyList)]
  in let
    head_43 =
      ErlangTuple
        [ErlangAtom "clause", tup_el_45,
         ErlangCons head_47 ErlangEmptyList, ErlangEmptyList,
         ErlangCons head_54 ErlangEmptyList]
  in let
    head_37 =
      ErlangTuple
        [ErlangAtom "function", tup_el_39, ErlangAtom "module_info",
         tup_el_41, ErlangCons head_43 ErlangEmptyList]
