...
erlps__new__1 [options_0] =
  let arg_2 = toErl 0
  in erlps__new_0__3 [options_0, arg_2, ErlangAtom "false"]
...
erlps__new__2 [size_0, options_1]
  | (isEInt size_0) && (weakGeq size_0 (toErl 0)) =
  erlps__new_0__3 [options_1, size_0, ErlangAtom "true"]
erlps__new__2 [_, _] = BIF.erlang__error__1 [ErlangAtom "badarg"]
...
erlps__new_0__3 args =
  EXC.badarity (ErlangFun 3 erlps__new_0__3) args

erlps__new_1__4 :: ErlangFun
erlps__new_1__4 [(ErlangCons (ErlangAtom "fixed") options_0),
                 size_1, _, default_2]
  =
  erlps__new_1__4 [options_0, size_1, ErlangAtom "true", default_2]
...
erlps__new_1__4 args =
  EXC.badarity (ErlangFun 4 erlps__new_1__4) args
...
erlps__new__3 [(ErlangInt num_0), (ErlangAtom "false"),
  ...
  in let tup_el_3 = toErl 10
  in let tup_el_5 = toErl 10
  in
    ErlangTuple
      [ErlangAtom "array", tup_el_2, tup_el_3, ErlangAtom "undefined",
       tup_el_5]
erlps__new__3 [size_0, fixed_1, default_2] =
  let    rop_5 = toErl 1
  in let arg_3 = BIF.erlang__op_minus [size_0, rop_5]
  in let arg_6 = toErl 10
  in let e_7 = erlps__find_max__2 [arg_3, arg_6]
  in let
    m_8 =
...
erlps__find_max__2 [i_0, m_1] | weakGeq i_0 m_1 =
  let    rop_5 = toErl 10
  in let arg_3 = BIF.erlang__op_mult [m_1, rop_5]
...
erlps__find_max__2 args =
  EXC.badarity (ErlangFun 2 erlps__find_max__2) args
...
erlps__is_array__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_array__1) args
...
erlps__size__1 [(ErlangTuple [(ErlangAtom "array"), n_0, _, _,
  ...
  =
  n_0
erlps__size__1 [_] = BIF.erlang__error__1 [ErlangAtom "badarg"]
...
erlps__is_fix__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_fix__1) args
...
erlps__relax__1 [a_1@(ErlangTuple [(ErlangAtom "array"), n_0, _,
  ...
  in let record_updt_3 = erlps__find_max__2 [arg_4, arg_7]
  in
    case a_1 of
...
erlps__relax__1 args =
  EXC.badarity (ErlangFun 1 erlps__relax__1) args
...
erlps__resize__2 [size_0,
  ...
  case ErlangAtom "true" of
    _ | weakGt size_0 n_1 ->
      let    rop_7 = toErl 1
      in let arg_5 = BIF.erlang__op_minus [size_0, rop_7]
      in let
        arg_9 =
          case ErlangAtom "true" of
            _ | weakGt m_2 (toErl 0) -> m_2
            _ ->
              let    rop_12 = toErl 1
              in let arg_10 = BIF.erlang__op_minus [n_1, rop_12]
              in let arg_13 = toErl 10
              in erlps__find_max__2 [arg_10, arg_13]
      in let matchExpr_16 = erlps__grow__3 [arg_5, e_3, arg_9]
      in
...
erlps__resize__2 args =
  EXC.badarity (ErlangFun 2 erlps__resize__2) args
      ...
      in
        case a_6 of
          (ErlangTuple [(ErlangAtom "array"), size_13, max_14, default_15,
                        elements_16]) ->
            ErlangTuple
              [ErlangAtom "array", size_13, max_14, default_15, record_updt_8]
          _ -> EXC.badrecord (ErlangAtom "array")
    _ | weakLt i_0 m_3 ->
      let    rop_20 = toErl 1
      in let record_updt_18 = BIF.erlang__op_plus [i_0, rop_20]
      in let record_updt_21 = erlps__set_1__4 [i_0, e_5, value_1, d_4]
      in
        case a_6 of
          (ErlangTuple [(ErlangAtom "array"), size_26, max_27, default_28,
            ...
            ErlangTuple
              [ErlangAtom "array", record_updt_18, max_27, default_28,
               record_updt_21]
          _ -> EXC.badrecord (ErlangAtom "array")
    _ | weakGt m_3 (toErl 0) ->
      let matchExpr_35 = erlps__grow__3 [i_0, e_5, m_3]
      in
        case matchExpr_35 of
          (ErlangTuple [e1_33, m1_34]) ->
            let    rop_39 = toErl 1
            in let record_updt_37 = BIF.erlang__op_plus [i_0, rop_39]
            in let
...
erlps__set_1__4 [i_0,
  ...
  in let i1_9 = BIF.erlang__op_plus [lop_5, rop_8]
...
erlps__grow__3 [i_0, e_1, m_2] = erlps__grow_1__3 [i_0, e_1, m_2]
erlps__grow__3 [arg_6, arg_7, arg_8] = EXC.function_clause unit
erlps__grow__3 args =
  EXC.badarity (ErlangFun 3 erlps__grow__3) args

erlps__grow_1__3 :: ErlangFun
erlps__grow_1__3 [i_0, e_1, m_2] | weakGeq i_0 m_2 =
  let    arg_5 = toErl 1
  in let lop_8 = toErl 10
  in let rop_9 = toErl 1
  in let arg_7 = BIF.erlang__op_plus [lop_8, rop_9]
  in let arg_6 = BIF.erlang__make_tuple__2 [arg_7, m_2]
  in let arg_4 = BIF.erlang__setelement__3 [arg_5, arg_6, e_1]
  in let rop_14 = toErl 10
  in let arg_12 = BIF.erlang__op_mult [m_2, rop_14]
  in erlps__grow_1__3 [i_0, arg_4, arg_12]
erlps__grow_1__3 [_i_0, e_1, m_2] = ErlangTuple [e_1, m_2]
erlps__grow_1__3 [arg_5, arg_6, arg_7] = EXC.function_clause unit
erlps__grow_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__grow_1__3) args

erlps__expand__4 :: ErlangFun
erlps__expand__4 [i_0, s_1, x_2, d_3] | weakGt s_1 (toErl 10) =
  let    rop_5 = toErl 10
  in let s1_6 = BIF.erlang__op_div_strict [s_1, rop_5]
  in let lop_8 = BIF.erlang__op_div_strict [i_0, s1_6]
  in let rop_11 = toErl 1
  in let arg_7 = BIF.erlang__op_plus [lop_8, rop_11]
  in let lop_14 = toErl 10
...
erlps__expand__4 [i_0, _s_1, x_2, d_3] =
  let    rop_6 = toErl 1
  in let arg_4 = BIF.erlang__op_plus [i_0, rop_6]
  in let arg_8 = toErl 10
  in let arg_7 = BIF.erlang__make_tuple__2 [arg_8, d_3]
  in BIF.erlang__setelement__3 [arg_4, arg_7, x_2]
erlps__expand__4 [arg_11, arg_12, arg_13, arg_14] =
  EXC.function_clause unit
erlps__expand__4 args =
  EXC.badarity (ErlangFun 4 erlps__expand__4) args
...
erlps__get_1__3 [i_0,
  ...
  in let arg_8 = BIF.erlang__op_plus [lop_9, rop_12]
...
erlps__get_1__3 [i_0, e_1, _d_2] =
  let    rop_5 = toErl 1
  in let arg_3 = BIF.erlang__op_plus [i_0, rop_5]
  in BIF.erlang__element__2 [arg_3, e_1]
erlps__get_1__3 [arg_7, arg_8, arg_9] = EXC.function_clause unit
erlps__get_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__get_1__3) args
...
erlps__reset_1__3 [i_0,
  ...
  in let i1_8 = BIF.erlang__op_plus [lop_4, rop_7]
...
erlps__reset_1__3 [i_0, e_1, d_2] =
  let    rop_4 = toErl 1
  in let indx_5 = BIF.erlang__op_plus [i_0, rop_4]
  in let case_6 = BIF.erlang__element__2 [indx_5, e_1]
  in
    case case_6 of
      d_9 | d_9 == d_2 -> BIF.erlang__throw__1 [ErlangAtom "default"]
      _ ->
        let    rop_13 = toErl 1
        in let arg_11 = BIF.erlang__op_plus [i_0, rop_13]
        in BIF.erlang__setelement__3 [arg_11, e_1, d_2]
erlps__reset_1__3 [arg_16, arg_17, arg_18] =
  EXC.function_clause unit
erlps__reset_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__reset_1__3) args
...
erlps__to_list__1 [(ErlangTuple [(ErlangAtom "array"), n_0, _,
  ...
  =
  let    rop_7 = toErl 1
  in let arg_5 = BIF.erlang__op_minus [n_0, rop_7]
...
erlps__to_list_1__3 [e_1@(ErlangTuple [_, _, _, _, _, _, _, _, _,
  ...
  in let arg_11 = BIF.erlang__op_plus [n_6, rop_13]
...
erlps__to_list_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__to_list_1__3) args
...
erlps__to_list_3__4 args =
  EXC.badarity (ErlangFun 4 erlps__to_list_3__4) args
...
erlps__push__3 [arg_10, arg_11, arg_12] =
  EXC.function_clause unit
erlps__push__3 args =
  EXC.badarity (ErlangFun 3 erlps__push__3) args
...
erlps__push_tuple__3 args =
  EXC.badarity (ErlangFun 3 erlps__push_tuple__3) args
...
erlps__sparse_to_list__1 args =
  EXC.badarity (ErlangFun 1 erlps__sparse_to_list__1) args
...
erlps__sparse_to_list_1__3 [e_0, d_1, i_2] =
  let    rop_5 = toErl 1
  in let arg_3 = BIF.erlang__op_plus [i_2, rop_5]
  in erlps__sparse_push_tuple__4 [arg_3, d_1, e_0, ErlangEmptyList]
erlps__sparse_to_list_1__3 [arg_9, arg_10, arg_11] =
  EXC.function_clause unit
erlps__sparse_to_list_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__sparse_to_list_1__3) args
...
erlps__sparse_to_list_3__4 args =
  EXC.badarity (ErlangFun 4 erlps__sparse_to_list_3__4) args
...
erlps__sparse_push_tuple__4 [n_0, d_1, t_2, l_3] =
  ...
  in
    case case_4 of
      ...
      e_14 ->
        let    rop_17 = toErl 1
        in let arg_15 = BIF.erlang__op_minus [n_0, rop_17]
        in
...
erlps__sparse_push_tuple__4 args =
  EXC.badarity (ErlangFun 4 erlps__sparse_push_tuple__4) args
  ...
  in let
    matchExpr_11 =
      erlps__from_list_1__6
        [arg_2, list_0, default_1, arg_5, ErlangEmptyList,
         ErlangEmptyList]
  in
...
erlps__from_list_1__6 [(ErlangInt num_0), xs_1, d_2, n_3, as_4,
  ...
  | (ErlangInt num_0) == (toErl 0) =
  let   
    arg_6 = BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [as_4]
  ...
  in
    case xs_1 of
      (ErlangEmptyList) ->
        case es_5 of
          (ErlangEmptyList) ->
            let tup_el_13 = toErl 10
            in ErlangTuple [e_8, n_3, tup_el_13]
          _ ->
            let arg_18 = toErl 10
            in erlps__from_list_2_0__3 [n_3, ErlangCons e_8 es_5, arg_18]
      (ErlangCons _ _) ->
        let arg_19 = toErl 10
        in
          erlps__from_list_1__6
            [arg_19, xs_1, d_2, n_3, ErlangEmptyList, ErlangCons e_8 es_5]
      _ -> BIF.erlang__error__1 [ErlangAtom "badarg"]
erlps__from_list_1__6 [i_0, xs_1, d_2, n_3, as_4, es_5] =
  case xs_1 of
    (ErlangCons x_7 xs1_8) ->
      let    rop_11 = toErl 1
      in let arg_9 = BIF.erlang__op_minus [i_0, rop_11]
      in let rop_16 = toErl 1
      in let arg_14 = BIF.erlang__op_plus [n_3, rop_16]
      in
        erlps__from_list_1__6
          [arg_9, xs1_8, d_2, arg_14, ErlangCons x_7 as_4, es_5]
    _ ->
      let    rop_23 = toErl 1
      in let arg_21 = BIF.erlang__op_minus [i_0, rop_23]
      in
        erlps__from_list_1__6
...
erlps__from_list_1__6 args =
  EXC.badarity (ErlangFun 6 erlps__from_list_1__6) args

erlps__from_list_2_0__3 :: ErlangFun
erlps__from_list_2_0__3 [n_0, es_1, s_2] =
  let    arg_3 = toErl 10
  in let rop_9 = toErl 1
  in let lop_7 = BIF.erlang__op_minus [n_0, rop_9]
  in let lop_6 = BIF.erlang__op_div_strict [lop_7, s_2]
  in let rop_11 = toErl 1
  in let arg_5 = BIF.erlang__op_plus [lop_6, rop_11]
  in let arg_12 = toErl 10
  in let arg_4 = erlps__pad__4 [arg_5, arg_12, s_2, es_1]
  in
    erlps__from_list_2__6
      [arg_3, arg_4, s_2, n_0, ErlangCons s_2 ErlangEmptyList,
       ErlangEmptyList]
erlps__from_list_2_0__3 [arg_21, arg_22, arg_23] =
  EXC.function_clause unit
erlps__from_list_2_0__3 args =
  EXC.badarity (ErlangFun 3 erlps__from_list_2_0__3) args
    ...
    case xs_1 of
      (ErlangEmptyList) ->
        case es_5 of
          (ErlangEmptyList) ->
            let    rop_14 = toErl 10
            in let tup_el_12 = BIF.erlang__op_mult [s_2, rop_14]
            ...
            let   
              arg_16 =
                BIF.do_remote_fun_call "Lists" "erlps__reverse__1"
                  [ErlangCons e_7 es_5]
            in let rop_22 = toErl 10
            in let arg_20 = BIF.erlang__op_mult [s_2, rop_22]
            in erlps__from_list_2_0__3 [n_3, arg_16, arg_20]
      _ ->
        let arg_23 = toErl 10
        in
          erlps__from_list_2__6
            [arg_23, xs_1, s_2, n_3, ErlangCons s_2 ErlangEmptyList,
             ErlangCons e_7 es_5]
...
erlps__from_list_2__6 args =
  EXC.badarity (ErlangFun 6 erlps__from_list_2__6) args
...
erlps__to_orddict__1 [(ErlangTuple [(ErlangAtom "array"), n_0, _,
  ...
  =
  let    rop_4 = toErl 1
  in let i_5 = BIF.erlang__op_minus [n_0, rop_4]
...
erlps__to_orddict__1 args =
  EXC.badarity (ErlangFun 1 erlps__to_orddict__1) args
...
erlps__to_orddict_2__4 [e_1@(ErlangTuple [_, _, _, _, _, _, _, _,
  ...
  =
  let arg_5 = toErl 10
  in erlps__to_orddict_3__6 [arg_5, r_2, d_3, l_4, e_1, s_0]
...
erlps__to_orddict_2__4 [e_0, r_1, _d_2, l_3] =
  let arg_4 = toErl 10
  in erlps__push_tuple_pairs__4 [arg_4, r_1, e_0, l_3]
erlps__to_orddict_2__4 [arg_8, arg_9, arg_10, arg_11] =
  EXC.function_clause unit
erlps__to_orddict_2__4 args =
  EXC.badarity (ErlangFun 4 erlps__to_orddict_2__4) args
...
erlps__to_orddict_3__6 args =
  EXC.badarity (ErlangFun 6 erlps__to_orddict_3__6) args
...
erlps__push_pairs__4 [n_0, i_1, e_2, l_3] =
  ...
  in let arg_4 = BIF.erlang__op_minus [n_0, rop_6]
  in let rop_9 = toErl 1
  in let arg_7 = BIF.erlang__op_minus [i_1, rop_9]
  in let head_12 = ErlangTuple [i_1, e_2]
  in
    erlps__push_pairs__4 [arg_4, arg_7, e_2, ErlangCons head_12 l_3]
erlps__push_pairs__4 [arg_16, arg_17, arg_18, arg_19] =
  EXC.function_clause unit
erlps__push_pairs__4 args =
  EXC.badarity (ErlangFun 4 erlps__push_pairs__4) args
...
erlps__push_tuple_pairs__4 args =
  EXC.badarity (ErlangFun 4 erlps__push_tuple_pairs__4) args
...
erlps__sparse_to_orddict__1 args =
  EXC.badarity (ErlangFun 1 erlps__sparse_to_orddict__1) args
...
erlps__sparse_to_orddict_1__4 [e_1@(ErlangTuple [_, _, _, _, _,
  ...
  in let arg_19 = BIF.erlang__element__2 [arg_20, e_1]
  in let
    arg_18 = erlps__sparse_to_orddict_1__4 [arg_19, r_2, d_3, i1_10]
  in
...
erlps__sparse_to_orddict_1__4 args =
  EXC.badarity (ErlangFun 4 erlps__sparse_to_orddict_1__4) args
...
erlps__sparse_to_orddict_3__6 args =
  EXC.badarity (ErlangFun 6 erlps__sparse_to_orddict_3__6) args
  ...
  in
    case case_5 of
      d_8 | d_8 == d_2 ->
        ...
        in let arg_12 = BIF.erlang__op_minus [i_1, rop_14]
        in
          erlps__sparse_push_tuple_pairs__5 [arg_9, arg_12, d_2, t_3, l_4]
      e_18 ->
        let    rop_21 = toErl 1
        in let arg_19 = BIF.erlang__op_minus [n_0, rop_21]
        in let rop_24 = toErl 1
        in let arg_22 = BIF.erlang__op_minus [i_1, rop_24]
...
erlps__sparse_push_tuple_pairs__5 args =
  EXC.badarity (ErlangFun 5 erlps__sparse_push_tuple_pairs__5)
    args
...
erlps__from_orddict__1 args =
  EXC.badarity (ErlangFun 1 erlps__from_orddict__1) args
...
erlps__from_orddict__2 [list_0, default_1] | isEList list_0 =
  let    arg_3 = toErl 0
  in let arg_4 = toErl 10
  in let
    matchExpr_10 =
      erlps__from_orddict_0__5
        [list_0, arg_3, arg_4, default_1, ErlangEmptyList]
  in
...
erlps__from_orddict__2 [_, _] =
  BIF.erlang__error__1 [ErlangAtom "badarg"]
erlps__from_orddict__2 [arg_1, arg_2] = EXC.function_clause unit
erlps__from_orddict__2 args =
  EXC.badarity (ErlangFun 2 erlps__from_orddict__2) args
...
erlps__from_orddict_0__5 [(ErlangEmptyList), n_0, _max_1, _d_2,
  ...
  case es_3 of
    (ErlangCons e_5 (ErlangEmptyList)) ->
      let tup_el_8 = toErl 10
      in ErlangTuple [e_5, n_0, tup_el_8]
    _ ->
      let arg_11 = toErl 10
      in erlps__collect_leafs__3 [n_0, es_3, arg_11]
erlps__from_orddict_0__5 [xs_1@(ErlangCons (ErlangTuple [ix1_0,
  ...
  in let rop_12 = toErl 10
  in let rop_10 = BIF.erlang__op_rem_strict [hole_8, rop_12]
  in let step_13 = BIF.erlang__op_minus [hole_8, rop_10]
  in let next_16 = BIF.erlang__op_plus [ix_2, step_13]
  in let rop_21 = toErl 10
  in let arg_19 = BIF.erlang__op_plus [next_16, rop_21]
  in
    erlps__from_orddict_0__5
  ...
  in
    case matchExpr_14 of
      (ErlangTuple [xs_11, e_12, ix_13]) ->
        let    rop_19 = toErl 10
        in let arg_17 = BIF.erlang__op_plus [ix_13, rop_19]
        in
          erlps__from_orddict_0__5
...
erlps__from_orddict_0__5 args =
  EXC.badarity (ErlangFun 5 erlps__from_orddict_0__5) args

erlps__from_orddict_1__6 :: ErlangFun
erlps__from_orddict_1__6 [ix_0, ix_1, xs_2, n_3, _d_4, as_5]
  | ix_1 == ix_0 =
  let   
    arg_6 = BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [as_5]
  in let e_8 = BIF.erlang__list_to_tuple__1 [arg_6]
  in ErlangTuple [xs_2, e_8, n_3]
erlps__from_orddict_1__6 [ix_0, max_1, xs_2, n0_3, d_4, as_5] =
  case xs_2 of
    (ErlangCons (ErlangTuple [ix_7, val_8]) xs1_9) | ix_7 == ix_0 ->
      let    rop_11 = toErl 1
      in let n_12 = BIF.erlang__op_plus [ix_0, rop_11]
      in
        erlps__from_orddict_1__6
    ...
    (ErlangCons (ErlangTuple [ix1_21, _]) _) | (isEInt ix1_21) &&
                                                 (weakGt ix1_21 ix_0) ->
      let    rop_23 = toErl 1
      in let n_24 = BIF.erlang__op_plus [ix_0, rop_23]
      in
        erlps__from_orddict_1__6
    ...
    _ ->
      let    rop_38 = toErl 1
      in let arg_36 = BIF.erlang__op_plus [ix_0, rop_38]
      in
        erlps__from_orddict_1__6
...
erlps__from_orddict_1__6 args =
  EXC.badarity (ErlangFun 6 erlps__from_orddict_1__6) args

erlps__collect_leafs__3 :: ErlangFun
erlps__collect_leafs__3 [n_0, es_1, s_2] =
  let    rop_6 = toErl 1
  in let lop_4 = BIF.erlang__op_minus [n_0, rop_6]
  in let lop_3 = BIF.erlang__op_div_strict [lop_4, s_2]
  in let rop_8 = toErl 1
  in let i_9 = BIF.erlang__op_plus [lop_3, rop_8]
  in let lop_12 = toErl 10
  in let rop_15 = toErl 10
  in let rop_13 = BIF.erlang__op_rem_strict [i_9, rop_15]
  in let lop_11 = BIF.erlang__op_minus [lop_12, rop_13]
  in let rop_16 = toErl 10
  in let lop_10 = BIF.erlang__op_rem_strict [lop_11, rop_16]
      ...
      (ErlangInt num_20) | (ErlangInt num_20) == (toErl 0) ->
        ...
        in
          erlps__collect_leafs__6
            [arg_21, es_1, s_2, n_0, ErlangCons s_2 ErlangEmptyList,
             ErlangEmptyList]
      _ ->
        let arg_29 = toErl 10
        in
          erlps__collect_leafs__6
            [arg_29, ErlangCons pad_18 es_1, s_2, n_0,
             ErlangCons s_2 ErlangEmptyList, ErlangEmptyList]
erlps__collect_leafs__3 [arg_39, arg_40, arg_41] =
  EXC.function_clause unit
erlps__collect_leafs__3 args =
  EXC.badarity (ErlangFun 3 erlps__collect_leafs__3) args
  ...
  in
    case ErlangAtom "true" of
      _ | weakLt step0_9 i_0 ->
        ...
        in erlps__collect_leafs__6 [arg_14, xs_2, s_3, n_4, as_13, es0_6]
      _ | (==) i_0 (toErl 10) ->
        let    rop_23 = toErl 10
        in let step_24 = BIF.erlang__op_rem_strict [step0_9, rop_23]
      ...
      _ | (==) i_0 step0_9 ->
        ...
        in let arg_43 = toErl 0
        in erlps__collect_leafs__6 [arg_43, xs_2, s_3, n_4, as_42, es0_6]
      _ ->
        ...
        in
          erlps__collect_leafs__6
            [arg_56, ErlangCons head_58 xs_2, s_3, n_4, as_52, es0_6]
erlps__collect_leafs__6 [i_0, (ErlangCons x_1 xs_2), s_3, n_4,
                         as_5, es_6]
  =
  let    rop_9 = toErl 1
...
erlps__collect_leafs__6 [(ErlangInt num_0), (ErlangEmptyList),
  ...
  let   
    arg_5 = BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [es_3]
  in let rop_9 = toErl 10
  in let arg_7 = BIF.erlang__op_mult [s_1, rop_9]
...
erlps__collect_leafs__6 args =
  EXC.badarity (ErlangFun 6 erlps__collect_leafs__6) args

erlps__map__2 :: ErlangFun
erlps__map__2 [function_0,
               array_4@(ErlangTuple [(ErlangAtom "array"), n_1, _, d_2, e_3])]
  | isEFunA function_0 (toErl 2) =
  case ErlangAtom "true" of
    _ | weakGt n_1 (toErl 0) ->
      let   
        a_11 =
          case array_4 of
            (ErlangTuple [(ErlangAtom "array"), size_7, max_8, default_9,
                          elements_10]) ->
              ErlangTuple
                [ErlangAtom "array", size_7, max_8, default_9, ErlangEmptyList]
            _ -> EXC.badrecord (ErlangAtom "array")
      in let rop_16 = toErl 1
      in let arg_14 = BIF.erlang__op_minus [n_1, rop_16]
      in let arg_18 = toErl 0
      in let
        record_updt_13 =
          erlps__map_1__5 [arg_14, e_3, arg_18, function_0, d_2]
      in
        case a_11 of
          (ErlangTuple [(ErlangAtom "array"), size_21, max_22, default_23,
                        elements_24]) ->
            ErlangTuple
              [ErlangAtom "array", size_21, max_22, default_23, record_updt_13]
          _ -> EXC.badrecord (ErlangAtom "array")
    _ -> array_4
erlps__map__2 [_, _] = BIF.erlang__error__1 [ErlangAtom "badarg"]
...
erlps__map_1__5 [n_0,
  ...
  =
  let    arg_10 = toErl 1
  in let lop_17 = BIF.erlang__op_div_strict [n_0, s_1]
  in let rop_20 = toErl 1
  in let arg_16 = BIF.erlang__op_plus [lop_17, rop_20]
  in let arg_21 = BIF.erlang__op_rem_strict [n_0, s_1]
  in let
    tail_9 =
      erlps__map_2__9
        [arg_10, e_2, ix_3, f_4, d_5, ErlangEmptyList, arg_16, arg_21,
         s_1]
  in let
    arg_6 =
      BIF.do_remote_fun_call "Lists" "erlps__reverse__1"
...
erlps__map_1__5 [n_0, e_1, ix_2, f_3, d_4] =
  let    arg_7 = toErl 1
  in let rop_14 = toErl 1
  in let arg_12 = BIF.erlang__op_plus [n_0, rop_14]
  in let
    arg_6 =
      erlps__map_3__7
        [arg_7, e_1, ix_2, f_3, d_4, arg_12, ErlangEmptyList]
  in let
    arg_5 =
...
erlps__map_1__5 args =
  EXC.badarity (ErlangFun 5 erlps__map_1__5) args

erlps__map_2__9 :: ErlangFun
erlps__map_2__9 [i_0, e_1, ix_2, f_3, d_4, l_5, i_6, r_7, _s_8]
  | i_6 == i_0 =
  let    rop_11 = toErl 1
  in let arg_9 = BIF.erlang__op_plus [i_0, rop_11]
...
erlps__map_2__9 [i_0, e_1, ix_2, f_3, d_4, l_5, n_6, r_7, s_8] =
  ...
  in let rop_22 = toErl 1
  in let arg_20 = BIF.erlang__op_minus [s_8, rop_22]
  in let arg_23 = BIF.erlang__element__2 [i_0, e_1]
  in let head_19 = erlps__map_1__5 [arg_20, arg_23, ix_2, f_3, d_4]
  in
    erlps__map_2__9
      [arg_9, e_1, arg_13, f_3, d_4, ErlangCons head_19 l_5, n_6, r_7,
       s_8]
...
erlps__map_2__9 args =
  EXC.badarity (ErlangFun 9 erlps__map_2__9) args

erlps__map_2_1__3 :: ErlangFun
erlps__map_2_1__3 [i_0, e_1, l_2] | weakLeq i_0 (toErl 10) =
  let    rop_5 = toErl 1
  in let arg_3 = BIF.erlang__op_plus [i_0, rop_5]
...
erlps__map_2_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__map_2_1__3) args

erlps__map_3__7 :: ErlangFun
erlps__map_3__7 [i_0, e_1, ix_2, f_3, d_4, n_5, l_6]
  | weakLeq i_0 n_5 =
  let    rop_9 = toErl 1
  in let arg_7 = BIF.erlang__op_plus [i_0, rop_9]
  in let rop_13 = toErl 1
  in let arg_11 = BIF.erlang__op_plus [ix_2, rop_13]
...
erlps__map_3__7 args =
  EXC.badarity (ErlangFun 7 erlps__map_3__7) args

erlps__unfold__2 :: ErlangFun
erlps__unfold__2 [s_0, _d_1] | weakGt s_0 (toErl 10) =
  let    lop_3 = toErl 10
  in let rop_4 = toErl 1
  in let arg_2 = BIF.erlang__op_plus [lop_3, rop_4]
  in let rop_7 = toErl 10
  in let arg_5 = BIF.erlang__op_div_strict [s_0, rop_7]
  in BIF.erlang__make_tuple__2 [arg_2, arg_5]
erlps__unfold__2 [_s_0, d_1] =
  let arg_2 = toErl 10
  in BIF.erlang__make_tuple__2 [arg_2, d_1]
erlps__unfold__2 [arg_4, arg_5] = EXC.function_clause unit
erlps__unfold__2 args =
  EXC.badarity (ErlangFun 2 erlps__unfold__2) args
...
erlps__sparse_map__2 [function_0,
  ...
  case ErlangAtom "true" of
    _ | weakGt n_1 (toErl 0) ->
      ...
      in let
        record_updt_13 =
          erlps__sparse_map_1__5 [arg_14, e_3, arg_18, function_0, d_2]
      in
        case a_11 of
          (ErlangTuple [(ErlangAtom "array"), size_21, max_22, default_23,
                        elements_24]) ->
...
erlps__sparse_map__2 args =
  EXC.badarity (ErlangFun 2 erlps__sparse_map__2) args
  ...
  in let
    arg_6 =
      erlps__sparse_map_3__6
        [arg_7, e_1, ix_2, f_3, d_4, ErlangEmptyList]
  in let
    arg_5 =
      BIF.do_remote_fun_call "Lists" "erlps__reverse__1" [arg_6]
  in BIF.erlang__list_to_tuple__1 [arg_5]
...
erlps__sparse_map_1__5 args =
  EXC.badarity (ErlangFun 5 erlps__sparse_map_1__5) args
...
erlps__sparse_map_2__9 [i_0, e_1, ix_2, f_3, d_4, l_5, i_6, r_7,
  ...
  in erlps__sparse_map_2_1__3 [arg_9, e_1, ErlangCons head_14 l_5]
erlps__sparse_map_2__9 [i_0, e_1, ix_2, f_3, d_4, l_5, n_6, r_7,
  ...
  in let arg_23 = BIF.erlang__element__2 [i_0, e_1]
  in let
    head_19 = erlps__sparse_map_1__5 [arg_20, arg_23, ix_2, f_3, d_4]
  in
    erlps__sparse_map_2__9
      [arg_9, e_1, arg_13, f_3, d_4, ErlangCons head_19 l_5, n_6, r_7,
       s_8]
...
erlps__sparse_map_2__9 args =
  EXC.badarity (ErlangFun 9 erlps__sparse_map_2__9) args
...
erlps__sparse_map_2_1__3 [i_0, e_1, l_2]
  ...
  in let arg_3 = BIF.erlang__op_plus [i_0, rop_5]
  in let head_8 = BIF.erlang__element__2 [i_0, e_1]
  in erlps__sparse_map_2_1__3 [arg_3, e_1, ErlangCons head_8 l_2]
erlps__sparse_map_2_1__3 [_i_0, _e_1, l_2] = l_2
erlps__sparse_map_2_1__3 [arg_3, arg_4, arg_5] =
  EXC.function_clause unit
erlps__sparse_map_2_1__3 args =
  EXC.badarity (ErlangFun 3 erlps__sparse_map_2_1__3) args
...
erlps__sparse_map_3__6 [i_0, t_1, ix_2, f_3, d_4, l_5]
  ...
  in
    case case_6 of
      d_9 | d_9 == d_4 ->
        let    rop_12 = toErl 1
        in let arg_10 = BIF.erlang__op_plus [i_0, rop_12]
        in let rop_16 = toErl 1
        in let arg_14 = BIF.erlang__op_plus [ix_2, rop_16]
        in
          erlps__sparse_map_3__6
            [arg_10, t_1, arg_14, f_3, d_4, ErlangCons d_4 l_5]
      e_22 ->
        let    rop_25 = toErl 1
        in let arg_23 = BIF.erlang__op_plus [i_0, rop_25]
        in let rop_29 = toErl 1
        in let arg_27 = BIF.erlang__op_plus [ix_2, rop_29]
        in let
          head_33 =
            BIF.erlang__apply__2
...
erlps__sparse_map_3__6 args =
  EXC.badarity (ErlangFun 6 erlps__sparse_map_3__6) args

erlps__foldl__3 :: ErlangFun
erlps__foldl__3 [function_0, a_1,
                 (ErlangTuple [(ErlangAtom "array"), n_2, _, d_3, e_4])]
  | isEFunA function_0 (toErl 3) =
  case ErlangAtom "true" of
    _ | weakGt n_2 (toErl 0) ->
      let    rop_7 = toErl 1
      in let arg_5 = BIF.erlang__op_minus [n_2, rop_7]
      in let arg_10 = toErl 0
      in erlps__foldl_1__6 [arg_5, e_4, a_1, arg_10, function_0, d_3]
    _ -> a_1
erlps__foldl__3 [_, _, _] =
  BIF.erlang__error__1 [ErlangAtom "badarg"]
erlps__foldl__3 [arg_1, arg_2, arg_3] = EXC.function_clause unit
...
erlps__foldl_1__6 [n_0,
  ...
  =
  let    arg_7 = toErl 1
  in let lop_14 = BIF.erlang__op_div_strict [n_0, s_1]
  in let rop_17 = toErl 1
  in let arg_13 = BIF.erlang__op_plus [lop_14, rop_17]
  in let arg_18 = BIF.erlang__op_rem_strict [n_0, s_1]
  in
    erlps__foldl_2__9
      [arg_7, e_2, a_3, ix_4, f_5, d_6, arg_13, arg_18, s_1]
erlps__foldl_1__6 [n_0, e_1, a_2, ix_3, f_4, d_5] | isEInt e_1 =
...
erlps__foldl_1__6 [n_0, e_1, a_2, ix_3, f_4, _d_5] =
  let    arg_6 = toErl 1
  in let rop_13 = toErl 1
  in let arg_11 = BIF.erlang__op_plus [n_0, rop_13]
  in erlps__foldl_3__6 [arg_6, e_1, a_2, ix_3, f_4, arg_11]
erlps__foldl_1__6 [arg_14, arg_15, arg_16, arg_17, arg_18,
                   arg_19]
  =
  EXC.function_clause unit
erlps__foldl_1__6 args =
  EXC.badarity (ErlangFun 6 erlps__foldl_1__6) args
...
erlps__foldl_2__9 [i_0, e_1, a_2, ix_3, f_4, d_5, n_6, r_7, s_8]
  ...
  in let arg_9 = BIF.erlang__op_plus [i_0, rop_11]
  in let rop_16 = toErl 1
  in let arg_14 = BIF.erlang__op_minus [s_8, rop_16]
  in let arg_17 = BIF.erlang__element__2 [i_0, e_1]
  in let
    arg_13 = erlps__foldl_1__6 [arg_14, arg_17, a_2, ix_3, f_4, d_5]
...
erlps__foldl_2__9 args =
  EXC.badarity (ErlangFun 9 erlps__foldl_2__9) args

erlps__foldl_3__6 :: ErlangFun
erlps__foldl_3__6 [i_0, e_1, a_2, ix_3, f_4, n_5]
  | weakLeq i_0 n_5 =
  let    rop_8 = toErl 1
  in let arg_6 = BIF.erlang__op_plus [i_0, rop_8]
  ...
  in let arg_17 = BIF.erlang__op_plus [ix_3, rop_19]
...
erlps__foldl_3__6 args =
  EXC.badarity (ErlangFun 6 erlps__foldl_3__6) args
    ...
    _ | weakGt n_2 (toErl 0) ->
      ...
      in
        erlps__sparse_foldl_1__6
          [arg_5, e_4, a_1, arg_10, function_0, d_3]
    _ -> a_1
...
erlps__sparse_foldl__3 args =
  EXC.badarity (ErlangFun 3 erlps__sparse_foldl__3) args
...
erlps__sparse_foldl_2__9 args =
  EXC.badarity (ErlangFun 9 erlps__sparse_foldl_2__9) args
  ...
  in
    case case_7 of
      d_10 | d_10 == d_5 ->
        ...
        in let arg_16 = BIF.erlang__op_plus [ix_3, rop_18]
        in
          erlps__sparse_foldl_3__7
      ...
      e_22 ->
        ...
        in let arg_32 = BIF.erlang__op_plus [ix_3, rop_34]
        in
          erlps__sparse_foldl_3__7
...
erlps__sparse_foldl_3__7 args =
  EXC.badarity (ErlangFun 7 erlps__sparse_foldl_3__7) args
...
erlps__foldr__3 [function_0, a_1,
  ...
  case ErlangAtom "true" of
    _ | weakGt n_2 (toErl 0) ->
      let    rop_6 = toErl 1
      in let i_7 = BIF.erlang__op_minus [n_2, rop_6]
      in erlps__foldr_1__6 [i_7, e_4, i_7, a_1, function_0, d_3]
    _ -> a_1
erlps__foldr__3 [_, _, _] =
  BIF.erlang__error__1 [ErlangAtom "badarg"]
erlps__foldr__3 [arg_1, arg_2, arg_3] = EXC.function_clause unit
...
erlps__foldr_1__6 [i_0,
  ...
  in let rop_22 = toErl 1
  in let arg_20 = BIF.erlang__op_minus [s_1, rop_22]
  in
    erlps__foldr_2__8
      [arg_7, e_2, ix_3, a_4, f_5, d_6, arg_17, arg_20]
erlps__foldr_1__6 [i_0, e_1, ix_2, a_3, f_4, d_5] | isEInt e_1 =
  let arg_7 = erlps__unfold__2 [e_1, d_5]
  in erlps__foldr_1__6 [i_0, arg_7, ix_2, a_3, f_4, d_5]
erlps__foldr_1__6 [i_0, e_1, ix_2, a_3, f_4, _d_5] =
  let    rop_7 = toErl 1
  in let i1_8 = BIF.erlang__op_plus [i_0, rop_7]
...
erlps__foldr_1__6 args =
  EXC.badarity (ErlangFun 6 erlps__foldr_1__6) args
...
erlps__foldr_2__8 [i_0, e_1, ix_2, a_3, f_4, d_5, r_6, r0_7] =
  let    rop_10 = toErl 1
  in let arg_8 = BIF.erlang__op_minus [i_0, rop_10]
...
erlps__foldr_2__8 args =
  EXC.badarity (ErlangFun 8 erlps__foldr_2__8) args
...
erlps__foldr_3__5 [i_0, e_1, ix_2, a_3, f_4] =
  let    rop_7 = toErl 1
  in let arg_5 = BIF.erlang__op_minus [i_0, rop_7]
...
erlps__foldr_3__5 args =
  EXC.badarity (ErlangFun 5 erlps__foldr_3__5) args
...
erlps__sparse_foldr__3 [function_0, a_1,
  ...
  case ErlangAtom "true" of
    _ | weakGt n_2 (toErl 0) ->
      let    rop_6 = toErl 1
      in let i_7 = BIF.erlang__op_minus [n_2, rop_6]
      in erlps__sparse_foldr_1__6 [i_7, e_4, i_7, a_1, function_0, d_3]
    _ -> a_1
...
erlps__sparse_foldr__3 args =
  EXC.badarity (ErlangFun 3 erlps__sparse_foldr__3) args
...
erlps__sparse_foldr_1__6 args =
  EXC.badarity (ErlangFun 6 erlps__sparse_foldr_1__6) args
...
erlps__sparse_foldr_2__8 args =
  EXC.badarity (ErlangFun 8 erlps__sparse_foldr_2__8) args
...
erlps__sparse_foldr_3__6 [i_0, t_1, ix_2, a_3, f_4, d_5] =
  ...
  in
    case case_6 of
      d_9 | d_9 == d_5 ->
        let    rop_12 = toErl 1
        in let arg_10 = BIF.erlang__op_minus [i_0, rop_12]
        in erlps__sparse_foldr_3__6 [arg_10, t_1, ix_2, a_3, f_4, d_5]
      e_18 ->
        let    rop_21 = toErl 1
        in let arg_19 = BIF.erlang__op_minus [i_0, rop_21]
        ...
        in erlps__sparse_foldr_3__6 [arg_19, t_1, ix_2, arg_24, f_4, d_5]
erlps__sparse_foldr_3__6 [arg_33, arg_34, arg_35, arg_36, arg_37,
                          arg_38]
  =
  EXC.function_clause unit
erlps__sparse_foldr_3__6 args =
  EXC.badarity (ErlangFun 6 erlps__sparse_foldr_3__6) args
      ...
      (\ ex_16 ->
         case ex_16 of
           (ErlangTuple [(ErlangAtom "throw"),
             ...
             let rop_20 = toErl 1
             in BIF.erlang__op_plus [i_18, rop_20]
           ex_17 -> EXC.raise ex_17)
erlps__sparse_size__1 [arg_21] = EXC.function_clause unit
erlps__sparse_size__1 args =
  EXC.badarity (ErlangFun 1 erlps__sparse_size__1) args