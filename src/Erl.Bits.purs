...
erlps__set_bit_type__2 [size_0, typelist_1] =
  EXC.tryCatch
    (\ _ ->
       let matchExpr_7 = erlps__set_bit__1 [typelist_1]
       in
         case matchExpr_7 of
...
erlps__type_to_record__1 [(ErlangAtom "utf8")] =
  ErlangTuple
    [ErlangAtom "bittype", ErlangAtom "utf8", ErlangAtom "undefined",
     ErlangAtom "undefined", ErlangAtom "undefined"]
...
erlps__type_to_record__1 [(ErlangAtom "bytes")] =
  ...
  in
    ErlangTuple
      [ErlangAtom "bittype", ErlangAtom "binary", tup_el_2,
       ErlangAtom "undefined", ErlangAtom "undefined"]
...
erlps__type_to_record__1 [(ErlangAtom "big")] =
  ErlangTuple
    [ErlangAtom "bittype", ErlangAtom "undefined",
     ErlangAtom "undefined", ErlangAtom "undefined", ErlangAtom "big"]
...
erlps__type_to_record__1 [name_0] =
  let   
    tup_el_3 = ErlangTuple [ErlangAtom "undefined_bittype", name_0]
...
erlps__merge_field__3 [x_0, y_1, what_2] =
  ...
  in let
    tup_el_5 =
      ErlangTuple [ErlangAtom "bittype_mismatch", x_0, y_1, tup_el_9]
...
erlps__apply_defaults__5 [(ErlangAtom "binary"),
  ...
  =
  erlps__apply_defaults__5
    [ErlangAtom "binary", ErlangAtom "all", unit_0, sign_1, endian_2]
erlps__apply_defaults__5 [(ErlangAtom "integer"),
                          (ErlangAtom "default"), unit_0, sign_1, endian_2]
  =
  let    _ = erlps__check_unit__1 [unit_0]
  in let arg_5 = toErl 8
  in let arg_6 = toErl 1
  in
    erlps__apply_defaults__5
      [ErlangAtom "integer", arg_5, arg_6, sign_1, endian_2]
...
erlps__apply_defaults__5 [(ErlangAtom "float"),
  ...
  =
  let    _ = erlps__check_unit__1 [unit_0]
  in let arg_5 = toErl 64
  in let arg_6 = toErl 1
  in
    erlps__apply_defaults__5
      [ErlangAtom "float", arg_5, arg_6, sign_1, endian_2]
erlps__apply_defaults__5 [(ErlangAtom "binary"), size_0,
  ...
  in
    erlps__apply_defaults__5
      [ErlangAtom "binary", size_0, arg_5, sign_1, endian_2]
erlps__apply_defaults__5 [(ErlangAtom "integer"), size_0,
  ...
  in
    erlps__apply_defaults__5
      [ErlangAtom "integer", size_0, arg_5, sign_1, endian_2]
erlps__apply_defaults__5 [(ErlangAtom "float"), size_0,
  ...
  in
    erlps__apply_defaults__5
      [ErlangAtom "float", size_0, arg_5, sign_1, endian_2]
